...
import { LanguageModelClient, ChatMessage } from './languageModelClient';

export class ChatPanel {
    public static currentPanel: ChatPanel | undefined;
    private readonly panel: vscode.WebviewPanel;
    private readonly lmClient: LanguageModelClient;
     ...
     */
    public static show(extensionUri: vscode.Uri, lmClient: LanguageModelClient) {
     ...
     */
    private async handleReviewSelection() {
        const editor = vscode.window.activeTextEditor;
        if (!editor) {
            this.sendMessage({ type: 'error', text: 'No active editor' });
            return;
