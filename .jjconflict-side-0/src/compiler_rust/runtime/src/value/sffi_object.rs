//! SFFI object support for object-based SFFI system.
//!
...
/// Entry in the SFFI method vtable.
///
...
/// Virtual table for SFFI objects.
///
...
pub struct FfiVtable {
    ...
    /// Destructor function (called when the SFFI object is dropped)
...
/// SFFI object representation on the heap.
///
/// This structure wraps a Rust object that has been registered with the SFFI system.
...
// ============================================================================
// SFFI Functions for RuntimeFfiObject
// ============================================================================

use std::alloc::{Layout, alloc_zeroed, dealloc};

/// Allocate a new SFFI object on the heap.
///
/// # Safety
/// The vtable pointer must be valid and live for the lifetime of the object.
///
/// # Returns
/// A RuntimeValue containing the SFFI object, or NIL on allocation failure.
#[no_mangle]
pub unsafe extern "C" fn rt_sffi_object_new(type_id: u32, handle: u32, vtable: *const FfiVtable) -> RuntimeValue {
    if vtable.is_null() {
...
/// Get the type ID of an SFFI object.
///
/// # Returns
/// The type ID, or 0 if the value is not an SFFI object.
#[no_mangle]
pub extern "C" fn rt_sffi_object_type_id(value: RuntimeValue) -> u32 {
    get_sffi_object(value).map(|obj| obj.type_id).unwrap_or(0)
}

/// Get the handle of an SFFI object.
///
/// # Returns
/// The handle, or 0 if the value is not an SFFI object.
#[no_mangle]
pub extern "C" fn rt_sffi_object_handle(value: RuntimeValue) -> u32 {
    get_sffi_object(value).map(|obj| obj.handle).unwrap_or(0)
}

/// Get the vtable pointer of an SFFI object.
///
/// # Returns
/// The vtable pointer, or null if the value is not an SFFI object.
#[no_mangle]
pub extern "C" fn rt_sffi_object_vtable(value: RuntimeValue) -> *const FfiVtable {
    get_sffi_object(value).map(|obj| obj.vtable).unwrap_or(std::ptr::null())
}

/// Check if a value is an SFFI object.
#[no_mangle]
pub extern "C" fn rt_sffi_object_is_ffi(value: RuntimeValue) -> bool {
    get_sffi_object(value).is_some()
}

/// Get the type name of an SFFI object as a RuntimeValue string.
///
/// # Returns
/// A RuntimeValue containing the type name string, or NIL if not an SFFI object.
#[no_mangle]
pub extern "C" fn rt_sffi_object_type_name(value: RuntimeValue) -> RuntimeValue {
    let Some(obj) = get_sffi_object(value) else {
        return RuntimeValue::NIL;
    };
...
#[no_mangle]
pub extern "C" fn rt_sffi_object_has_method(value: RuntimeValue, name_ptr: *const u8, name_len: u32) -> bool {
    let Some(obj) = get_sffi_object(value) else {
        return false;
    };
...
#[no_mangle]
pub unsafe extern "C" fn rt_sffi_object_call_method(
    value: RuntimeValue,
    name_ptr: *const u8,
    name_len: u32,
    argc: u32,
