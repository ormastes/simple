...
In `test/unit/std/mock_phase3_spec.spl`, changing this supported long form:
...
```text
simple check test/unit/std/mock_phase3_spec.spl
# OK

simple test test/unit/std/mock_phase3_spec.spl --mode=interpreter --clean
# Failed: 1
```
