...
```bash
SIMPLE_BENCH_SAMPLES=3 SIMPLE_BIN=src/compiler_rust/target/release/simple SIMPLE_RUNTIME_PATH=src/compiler_rust/target/release SIMPLE_NATIVE_ALL_PATH=src/compiler_rust/target/release test/05_perf/port_algorithms/run_port_algorithm_benchmarks.shs
```
