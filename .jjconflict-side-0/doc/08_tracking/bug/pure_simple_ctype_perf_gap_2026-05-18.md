...
- `test/05_perf/ctype/bench_ctype_ref.c` — C reference (gcc -O2)
- `test/05_perf/ctype/bench_ctype.spl` — Simple (cross-module, interpreter only)
- `test/05_perf/ctype/bench_ctype_inline.spl` — Simple (same-file, native-safe)

## 2026-05-27 Follow-up

The benchmark harness itself had drifted:

- `sh test/05_perf/ctype/run_ctype_benchmarks.shs` failed because the script uses
  Bash arrays and `pipefail`.
- `bash test/05_perf/ctype/run_ctype_benchmarks.shs` failed because `run_samples`
...
SIMPLE_CTYPE_BENCH_SAMPLES=1 bash test/05_perf/ctype/run_ctype_benchmarks.shs`:
...
**Benchmark:** `test/05_perf/ctype/bench_ctype_lut.spl` — same structure as
...
```bash
SIMPLE_LIB=src bin/simple check src/lib/common/ctype.spl test/05_perf/ctype/bench_ctype.spl test/05_perf/ctype/bench_ctype_inline.spl test/05_perf/ctype/bench_ctype_lut.spl
```
...
```bash
bin/simple native-build --entry test/05_perf/ctype/bench_ctype_inline.spl --entry-closure --backend cranelift --runtime-bundle core-c-bootstrap -o build/perf/ctype/bench_ctype_inline
build/perf/ctype/bench_ctype_inline > build/perf/ctype/simple_inline.out
bin/simple native-build --entry test/05_perf/ctype/bench_ctype_lut.spl --entry-closure --backend cranelift --runtime-bundle core-c-bootstrap -o build/perf/ctype/bench_ctype_lut
build/perf/ctype/bench_ctype_lut > build/perf/ctype/simple_lut.out
gcc -O2 -DITERS=1000000 -o build/perf/ctype/bench_ctype_ref_1m test/05_perf/ctype/bench_ctype_ref.c
...
- `test/05_perf/ctype/run_ctype_benchmarks.shs` gained
...
```bash
SIMPLE_CTYPE_BENCH_SAMPLES=1 SIMPLE_CTYPE_BENCH_ENFORCE=0 SIMPLE_CTYPE_BENCH_CLEAN=1 SIMPLE_LIB=src bash test/05_perf/ctype/run_ctype_benchmarks.shs
```
...
- `test/05_perf/ctype/ctype_lut_tables.spl` — benchmark-local module-level
  `CTYPE_FLAG_TABLE`.
- `test/05_perf/ctype/bench_ctype_static_lut.spl` — guarded cross-module static
...
```bash
SIMPLE_LIB=/tmp/simple-ctype-perf/src /home/ormastes/dev/pub/simple/src/compiler_rust/target/debug/simple check test/05_perf/ctype/ctype_lut_tables.spl test/05_perf/ctype/bench_ctype_static_lut.spl
SIMPLE_LIB=/tmp/simple-ctype-perf/src /home/ormastes/dev/pub/simple/src/compiler_rust/target/debug/simple check src/lib/common/ctype.spl test/05_perf/ctype/bench_ctype.spl test/05_perf/ctype/bench_ctype_inline.spl test/05_perf/ctype/bench_ctype_lut.spl
SIMPLE_LIB=/tmp/simple-ctype-perf/src /home/ormastes/dev/pub/simple/src/compiler_rust/target/debug/simple native-build --entry test/05_perf/ctype/bench_ctype_static_lut.spl --source src/lib --source test/05_perf/ctype --entry-closure --backend cranelift --runtime-bundle core-c-bootstrap -o build/perf/ctype/bench_ctype_static_lut
build/perf/ctype/bench_ctype_static_lut
SIMPLE_CTYPE_BENCH_SAMPLES=1 SIMPLE_CTYPE_BENCH_ENFORCE=0 SIMPLE_CTYPE_BENCH_CLEAN=1 SIMPLE_BIN=/home/ormastes/dev/pub/simple/src/compiler_rust/target/debug/simple SIMPLE_LIB=/tmp/simple-ctype-perf/src bash test/05_perf/ctype/run_ctype_benchmarks.shs
git diff --check
```
