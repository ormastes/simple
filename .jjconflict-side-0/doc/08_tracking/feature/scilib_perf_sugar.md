...
- **Notes:** Fixed 2026-05-30. `NDArray` now carries `shape`, `strides`,
  ...
  `SIMPLE_LIB=src src/compiler_rust/target/debug/simple check src/lib/common/science_math/ndarray.spl src/lib/nogc_async_mut/ndarray/mod.spl src/lib/nogc_async_mut/ndarray/ndarray_impl_ops.spl test/03_system/feature/scilib/ndarray_slice_spec.spl`
  and
  `SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/03_system/feature/scilib/ndarray_slice_spec.spl --mode=interpreter --clean --fail-fast`.
...
- **Notes:** Fixed 2026-05-30. `rt_intern_symbol(text) -> i64` is registered in
  ...
  Verification:
  `SIMPLE_LIB=src src/compiler_rust/target/debug/simple check src/lib/nogc_sync_mut/df/mod.spl src/lib/nogc_sync_mut/df/df_transform.spl src/lib/nogc_async_mut/df/mod.spl src/lib/nogc_async_mut/df/df_transform.spl test/03_system/feature/scilib/df_symbol_intern_spec.spl`
  and
  `SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/03_system/feature/scilib/df_symbol_intern_spec.spl --mode=interpreter --clean --fail-fast`.
...
- **Notes:** NumPy broadcasting is one of its most-used ergonomic features.
  ...
  **Partial progress (2026-05-29):** `HirBinOp.BroadcastAdd/Sub/Mul/Div` and
  ...
  Verification:
  `SIMPLE_LIB=src src/compiler_rust/target/debug/simple check src/lib/nogc_async_mut/ndarray/mod.spl test/03_system/feature/scilib/ndarray_broadcast_spec.spl`,
  `cargo check -p simple-compiler --manifest-path src/compiler_rust/Cargo.toml`,
  and
  `SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/03_system/feature/scilib/ndarray_broadcast_spec.spl --mode=interpreter --clean --fail-fast`.
