...
- `test/unit/hardware/fpga_linux/` -- Board-specific RTL validation specs
...
| Document | Scope |
|----------|-------|
| `doc/04_architecture/riscv_fpga_linux.md` | FPGA Linux dual-arch architecture |
| `doc/04_architecture/riscv_generated_core_migration.md` | Generated core migration path |
| `doc/04_architecture/riscv_linux_rtl_dual_arch_completion.md` | RTL dual-arch completion plan |
