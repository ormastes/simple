...
| Check | Artefact |
|---|---|
| HAL trait surface + per-arch file presence | `test/01_unit/os/multiarch/hal_trait_surface_spec.spl` |
| inventory + owned-C policy chain | `test/01_unit/os/multiarch/c_port_inventory_spec.spl` |
| platform/lane/board contract | `test/01_unit/os/port/simpleos_multiplatform_build_spec.spl` |
...
(`doc/08_tracking/feature/riscv_hal_smp_cache_prod_wiring_2026-05-02.md`).
...
into the `test/03_system/os/port/e2e_qemu_smoke_spec.spl` parameterization.
...
| `test/03_system/os/port/e2e_qemu_smoke_spec.spl` | MODIFY — parameterize over 6 archs |
| `test/01_unit/os/kernel/arch/hal_x86_64_phase_a_spec.spl` | CREATE |
| `test/01_unit/os/kernel/arch/hal_x86_32_phase_a_spec.spl` | CREATE |
| `test/01_unit/os/kernel/arch/hal_arm32_phase_a_spec.spl` | CREATE |
| `test/01_unit/os/kernel/arch/hal_riscv32_phase_a_spec.spl` | CREATE |
| `doc/04_architecture/compiler/mdsoc/mdsoc_architecture_tobe.md` | MODIFY — link to this doc |
...
[src/os/kernel/boot/kernel_entry.spl: kernel_main]             <-- arch-neutral
    ...
    ▼
[smoke harness: test/01_unit/os/smoke/*.spl]
...
| `doc/04_architecture/compiler/mdsoc/mdsoc_architecture_tobe.md` | Existing | Add link to this doc + note HAL is the kernel's MDSOC outer-edge |
