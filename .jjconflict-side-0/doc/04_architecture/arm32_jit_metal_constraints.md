...
1. **ARM32 GPU work**: target Vulkan. `test/perf/graphics_2d/bench_2d_vulkan.spl`
...
3. **Apple GPU work**: arm64 only. The Metal parity work in
   `test/perf/graphics_2d/bench_2d_metal_simple.spl` and
   `test/perf/graphics_2d/c_reference/bench_2d_metal.m` is the canonical
