# compiler_shared Layer Expert

## Role

Maintain process knowledge for the `compiler_shared` layer: owned source, architecture links, expected tests, and boundary rules. Use this skill when a task changes `src/compiler_shared` or depends on its public behavior.
