...
> ```bash
> bin/simple spipe-docgen test/feature/usage/metaprogramming_spec.spl
> ```
...
**View full specification:** [metaprogramming_spec.spl](../../test/feature/usage/metaprogramming_spec.spl)
