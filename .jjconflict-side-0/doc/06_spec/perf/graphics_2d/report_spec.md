...
Integration workflow:
  1. cd test/05_perf/graphics_2d/c_reference && make && ./bench_2d > /tmp/c_out.txt
  2. SIMPLE_ENGINE2D_RUNNER_MODE=full bin/simple test/05_perf/graphics_2d/simple_runner.spl > /tmp/s_out.txt
