# Task Gen Log Modes Specification

> 1.  setup fixture

<!-- sdn-diagram:id=task_gen_log_modes_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=task_gen_log_modes_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

task_gen_log_modes_spec -> std
```
...
```ascii generated-from=task_gen_log_modes_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/02_integration/app/task_gen_log_modes_spec.spl` |
| Updated | 2026-06-01 |
