...
<!-- sdn-diagram:id=compile_run_integration_8_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compile_run_integration_8_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compile_run_integration_8_spec -> std
```
...
```ascii generated-from=compile_run_integration_8_spec.arch hash=sha256:auto
