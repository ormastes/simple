...
<!-- sdn-diagram:id=lexer_parser_integration_8_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lexer_parser_integration_8_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lexer_parser_integration_8_spec -> std
```
...
```ascii generated-from=lexer_parser_integration_8_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/02_integration/e2e/lexer_parser_integration_8_spec.spl` |
| Updated | 2026-06-01 |
