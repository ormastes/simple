...
<!-- sdn-diagram:id=error_report_integration_7_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=error_report_integration_7_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

error_report_integration_7_spec -> std
```
...
```ascii generated-from=error_report_integration_7_spec.arch hash=sha256:auto
