...
<!-- sdn-diagram:id=compile_run_integration_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compile_run_integration_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compile_run_integration_10_spec -> std
```
...
```ascii generated-from=compile_run_integration_10_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/02_integration/e2e/compile_run_integration_10_spec.spl` |
| Updated | 2026-06-01 |
