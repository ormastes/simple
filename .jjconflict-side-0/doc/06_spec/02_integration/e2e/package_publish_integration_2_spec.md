...
<!-- sdn-diagram:id=package_publish_integration_2_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=package_publish_integration_2_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

package_publish_integration_2_spec -> std
```
...
```ascii generated-from=package_publish_integration_2_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/02_integration/e2e/package_publish_integration_2_spec.spl` |
| Updated | 2026-06-01 |
