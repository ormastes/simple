...
<!-- sdn-diagram:id=lexer_parser_integration_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lexer_parser_integration_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lexer_parser_integration_10_spec -> std
```
...
```ascii generated-from=lexer_parser_integration_10_spec.arch hash=sha256:auto
