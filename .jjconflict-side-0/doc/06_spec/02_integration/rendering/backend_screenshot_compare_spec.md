...
<!-- sdn-diagram:id=backend_screenshot_compare_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=backend_screenshot_compare_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

backend_screenshot_compare_spec -> std
backend_screenshot_compare_spec -> os
```
...
```ascii generated-from=backend_screenshot_compare_spec.arch hash=sha256:auto
