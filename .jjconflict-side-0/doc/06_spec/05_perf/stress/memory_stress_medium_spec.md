...
<!-- sdn-diagram:id=memory_stress_medium_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=memory_stress_medium_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

memory_stress_medium_spec -> std
```
...
```ascii generated-from=memory_stress_medium_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/05_perf/stress/memory_stress_medium_spec.spl` |
| Updated | 2026-06-01 |
