...
<!-- sdn-diagram:id=famous_site_corpus_div_geometry_simple_bin_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=famous_site_corpus_div_geometry_simple_bin_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

famous_site_corpus_div_geometry_simple_bin_spec -> std
```
...
```ascii generated-from=famous_site_corpus_div_geometry_simple_bin_spec.arch hash=sha256:auto
