...
> Tests covering scv git interchange.
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports fast-import blob payloads by byte count including multiline and empty files")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("records chunk lists for large fast-import blob payloads")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports executable fast-import file updates as byte content")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("ignores command-looking text inside fast-import data payloads")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports delete-only fast-import commits as valid tree changes")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-delete-only.XXXXXX)\nprintf 'old\\n' > \"$TMP/a.txt\"\nprintf 'keep\\n' > \"$TMP/keep.txt\"\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\ncat > delete.fi <<'EOF'\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 7\ndelete\nD a.txt\nEOF\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import delete.fi\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" fsck\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" export-tree out >/dev/null\ntest ! -e out/a.txt\nprintf 'keep=%s\\n' \"$(cat out/keep.txt | tr '\\n' '|')\"\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports deleteall as a replacement tree reset")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-deleteall.XXXXXX)\nprintf 'old\\n' > \"$TMP/a.txt\"\nprintf 'keep\\n' > \"$TMP/keep.txt\"\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\ncat > replace.fi <<'EOF'\nblob\nmark :1\ndata 4\nnew\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 8\nreplace\ndeleteall\nM 100644 :1 new.txt\nEOF\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import replace.fi\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" fsck\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" export-tree out >/dev/null\ntest ! -e out/a.txt\ntest ! -e out/keep.txt\nprintf 'new=%s\\n' \"$(cat out/new.txt | tr '\\n' '|')\"\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports fast-import rename commands as path moves")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-rename.XXXXXX)\nprintf 'old\\n' > \"$TMP/a.txt\"\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\ncat > rename.fi <<'EOF'\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 7\nrename\nR a.txt renamed.txt\nEOF\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import rename.fi\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" fsck\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" export-tree out >/dev/null\ntest ! -e out/a.txt\ntest -e out/renamed.txt\nprintf 'renamed=%s\\n' \"$(cat out/renamed.txt | tr '\\n' '|')\"\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports fast-import copy commands as duplicated paths")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-copy.XXXXXX)\nprintf 'base\\n' > \"$TMP/a.txt\"\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\ncat > copy.fi <<'EOF'\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 5\ncopy\nC a.txt copy.txt\nEOF\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import copy.fi\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" fsck\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" export-tree out >/dev/null\ntest -e out/a.txt\ntest -e out/copy.txt\nprintf 'a=%s\\ncopy=%s\\n' \"$(cat out/a.txt | tr '\\n' '|')\" \"$(cat out/copy.txt | tr '\\n' '|')\"\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects rename and copy commands whose source path is not tracked")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-missing-move-source.XXXXXX)\nprintf 'base\\n' > \"$TMP/a.txt\"\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\ncat > rename.fi <<'EOF'\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 7\nrename\nR missing.txt renamed.txt\nEOF\ncat > copy.fi <<'EOF'\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 5\ncopy\nC missing.txt copy.txt\nEOF\nset +e\nRENAME=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import rename.fi)\nRENAME_CODE=$?\nCOPY=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import copy.fi)\nCOPY_CODE=$?\nset -e\nprintf '%s\\nrename_code=%s\\n%s\\ncopy_code=%s\\n' \"$RENAME\" \"$RENAME_CODE\" \"$COPY\" \"$COPY_CODE\"\ntest \"$RENAME_CODE\" -ne 0\ntest \"$COPY_CODE\" -ne 0\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects delete-only streams that do not remove any tracked path")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-delete-missing.XXXXXX)\nprintf 'keep\\n' > \"$TMP/keep.txt\"\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\ncat > delete.fi <<'EOF'\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 7\ndelete\nD missing.txt\nEOF\nset +e\nBAD=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import delete.fi)\nBAD_CODE=$?\nset -e\nprintf '%s\\nbad_code=%s\\n' \"$BAD\" \"$BAD_CODE\"\ntest \"$BAD_CODE\" -ne 0\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects unsupported fast-import file modes")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-bad-mode.XXXXXX)\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\ncat > bad.fi <<'EOF'\nblob\nmark :1\ndata 2\nx\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 4\nmode\nM 120000 :1 link.txt\nEOF\nset +e\nBAD=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import bad.fi)\nBAD_CODE=$?\nset -e\nprintf '%s\\nbad_code=%s\\n' \"$BAD\" \"$BAD_CODE\"\ntest \"$BAD_CODE\" -ne 0\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects unsafe fast-import commit refs")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-bad-ref.XXXXXX)\nPUB=$(mktemp -d /tmp/scv-fast-import-bad-ref-pub.XXXXXX)\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\ncat > bad.fi <<'EOF'\nblob\nmark :1\ndata 2\nx\ncommit refs/heads/bad branch\ncommitter scv <scv@example.invalid> 0 +0000\ndata 3\nbad\nM 100644 :1 a.txt\nEOF\nset +e\nBAD_IMPORT=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import bad.fi)\nBAD_IMPORT_CODE=$?\nset -e\nprintf '%s\\nbad_import_code=%s\\n' \"$BAD_IMPORT\" \"$BAD_IMPORT_CODE\"\ntest \"$BAD_IMPORT_CODE\" -ne 0\nprintf 'payload\\n' > a.txt\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" snapshot >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" test-gate true >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" public-ready >/dev/null\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" public-export \"$PUB\" main >/dev/null\ncat > \"$PUB/export.fi\" <<'EOF'\nblob\nmark :1\ndata 2\nx\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 4\ngood\nM 100644 :1 a.txt\ncommit refs/heads/bad branch\ncommitter scv <scv@example.invalid> 0 +0000\ndata 3\nbad\nM 100644 :1 b.txt\nEOF\nset +e\nBAD_VERIFY=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" public-export-verify \"$PUB\")\nBAD_VERIFY_CODE=$?\nset -e\nprintf '%s\\nbad_verify_code=%s\\n' \"$BAD_VERIFY\" \"$BAD_VERIFY_CODE\"\ntest \"$BAD_VERIFY_CODE\" -ne 0\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("imports and exports quoted fast-import paths with escaped characters")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects unquoted fast-import paths with spaces")
val script = "set -eu\nREPO=$(pwd)\nTMP=$(mktemp -d /tmp/scv-fast-import-unquoted-space.XXXXXX)\ncd \"$TMP\"\nSIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" init >/dev/null\ncat > import.fi <<'EOF'\nblob\nmark :1\ndata 2\nx\ncommit refs/heads/main\ncommitter scv <scv@example.invalid> 0 +0000\ndata 5\nspace\nM 100644 :1 bad name.txt\nEOF\nset +e\nBAD=$(SIMPLE_LIB=\"$REPO/src\" \"$REPO/bin/simple\" run \"$REPO/src/app/scv/main.spl\" import-git-fast-import import.fi)\nBAD_CODE=$?\nset -e\nprintf '%s\\nbad_code=%s\\n' \"$BAD\" \"$BAD_CODE\"\ntest \"$BAD_CODE\" -ne 0\n"
val out = _run_git_interop_script(script)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects malformed quoted fast-import paths")
...
| Status | Active |
| Source | `test/integration/app/scv_git_interop_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `7e3c50191bd2ae269596c3eeb5845a9937ba8e146e198d3ba1c171e0130fc028`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `7e3c50191bd2ae269596c3eeb5845a9937ba8e146e198d3ba1c171e0130fc028`.
...
source: test/integration/app/scv_git_interop_spec.spl
mirror: doc/06_spec/integration/app/scv_git_interop_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/integration/app/scv_git_interop_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/integration/app/scv_git_interop_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/integration/app/scv_git_interop_spec.spl:30:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'exports delete commands for paths removed since the parent commit' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/integration/app/scv_git_interop_spec.spl:41:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'imports fast-import modify commands as replacements and delete commands as removals' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/integration/app/scv_git_interop_spec.spl:51:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'imports fast-import blob payloads by byte count including multiline and empty files' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
