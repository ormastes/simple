...
<!-- sdn-diagram:id=math_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=math_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

math_system_spec -> std
```
...
```ascii generated-from=math_system_spec.arch hash=sha256:auto
