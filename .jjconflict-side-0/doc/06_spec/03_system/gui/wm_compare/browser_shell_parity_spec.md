...
<!-- sdn-diagram:id=browser_shell_parity_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=browser_shell_parity_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

browser_shell_parity_spec -> std
browser_shell_parity_spec -> app
```
...
```ascii generated-from=browser_shell_parity_spec.arch hash=sha256:auto
