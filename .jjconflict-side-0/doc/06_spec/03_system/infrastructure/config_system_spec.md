...
<!-- sdn-diagram:id=config_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=config_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

config_system_spec -> std
```
...
```ascii generated-from=config_system_spec.arch hash=sha256:auto
