...
<!-- sdn-diagram:id=smoke_2_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=smoke_2_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

smoke_2_system_spec -> std
```
...
```ascii generated-from=smoke_2_system_spec.arch hash=sha256:auto
