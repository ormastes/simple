...
<!-- sdn-diagram:id=lexer_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lexer_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lexer_system_spec -> std
```
...
```ascii generated-from=lexer_system_spec.arch hash=sha256:auto
