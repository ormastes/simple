...
<!-- sdn-diagram:id=acceptance_4_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=acceptance_4_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

acceptance_4_system_spec -> std
```
...
```ascii generated-from=acceptance_4_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/acceptance/acceptance_4_system_spec.spl` |
| Updated | 2026-06-01 |
