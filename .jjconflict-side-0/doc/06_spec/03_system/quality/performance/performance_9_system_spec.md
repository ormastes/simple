...
<!-- sdn-diagram:id=performance_9_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=performance_9_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

performance_9_system_spec -> std
```
...
```ascii generated-from=performance_9_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/quality/performance/performance_9_system_spec.spl` |
| Updated | 2026-06-01 |
