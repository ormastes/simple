...
<!-- sdn-diagram:id=interpreter_sample_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=interpreter_sample_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=interpreter_sample_spec.arch hash=sha256:auto
