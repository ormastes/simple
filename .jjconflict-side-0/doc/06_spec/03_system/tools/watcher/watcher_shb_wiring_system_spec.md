# Watcher Shb Wiring System Specification

> <details>

<!-- sdn-diagram:id=watcher_shb_wiring_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=watcher_shb_wiring_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

watcher_shb_wiring_system_spec -> std
```
...
```ascii generated-from=watcher_shb_wiring_system_spec.arch hash=sha256:auto
...
| Category | Tooling |
| Status | Active |
| Source | `test/03_system/tools/watcher/watcher_shb_wiring_system_spec.spl` |
| Updated | 2026-06-01 |
