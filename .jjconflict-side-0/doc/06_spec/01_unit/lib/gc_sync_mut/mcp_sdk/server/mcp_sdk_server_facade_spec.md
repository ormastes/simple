...
> Tests covering gc_sync_mut mcp sdk server facade.
...
### gc_sync_mut mcp sdk server facade
...
- re-exports builder, pagination, method detection, and router helpers
   ...
   - Expected: package_parse_cursor("offset:5") equals `5`
   ...
   - Expected: package_dispatch_method(cfg, "tools/call", "1") equals `DISPATCH_TOOL`
...
| Status | Active |
| Source | `test/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `5f654e417a07be7ddde0b937606a0c7c4e8102b79864582eabbd46d3d84278e5`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `5f654e417a07be7ddde0b937606a0c7c4e8102b79864582eabbd46d3d84278e5`.
...
source: test/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.spl
mirror: doc/06_spec/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=80 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 3 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.spl:22:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 're-exports builder, pagination, method detection, and router helpers' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/gc_sync_mut/mcp_sdk/server/mcp_sdk_server_facade_spec.spl:43:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 're-exports protocol state helpers' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
