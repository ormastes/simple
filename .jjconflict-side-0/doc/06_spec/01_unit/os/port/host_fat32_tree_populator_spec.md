...
<!-- sdn-diagram:id=host_fat32_tree_populator_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=host_fat32_tree_populator_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

host_fat32_tree_populator_spec -> std
host_fat32_tree_populator_spec -> os
```
...
```ascii generated-from=host_fat32_tree_populator_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/os/port/host_fat32_tree_populator_spec.spl` |
| Updated | 2026-06-01 |
