...
> Tests covering COLL001 - Array concat in loop, COLL002 - .contains() on array in loop, COLL003 - .remove(0) queue drain, COLL004 - Loop-invariant method call, COLL005 - Chained .filter().filter(), COLL008 - Bounded global growth.
...
### COLL008 - Bounded global growth

#### warns on an unbounded global push

- warns on an unbounded global push
   - Expected: has_code(warnings, "COLL008") is true
...
```simple
# @req REQ-SSPEC-UNIT
step("warns on an unbounded global push")
val code = "var handlers: [i64] = []\nfn add(value: i64):\n    handlers.push(value)\n"
val warnings = analyze(code)
expect(has_code(warnings, "COLL008")).to_equal(true)
```

</details>

#### accepts a dominating capacity-return guard

- accepts a dominating capacity-return guard
   - Expected: has_code(warnings, "COLL008") is false
...
```simple
# @req REQ-SSPEC-UNIT
step("accepts a dominating capacity-return guard")
val code = "var handlers: [i64] = []\nval CAP: i64 = 4\nfn add(value: i64) -> bool:\n    if handlers.len() >= CAP:\n        return false\n    handlers.push(value)\n    true\n"
val warnings = analyze(code)
expect(has_code(warnings, "COLL008")).to_equal(false)
```

</details>

#### still warns when the capacity guard follows the push
...
```simple
# @req REQ-SSPEC-UNIT
step("still warns when the capacity guard follows the push")
val code = "var handlers: [i64] = []\nval CAP: i64 = 4\nfn add(value: i64) -> bool:\n    handlers.push(value)\n    if handlers.len() >= CAP:\n        return false\n    true\n"
val warnings = analyze(code)
expect(has_code(warnings, "COLL008")).to_equal(true)
```
...
| Category | Compiler |
| Status | Active |
| Source | `test/01_unit/compiler/semantics/collection_patterns_lint_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `62e5c709e04c0b00b0dbe075908f9ec115d146a736bde6f54cd40efbd14d9f8f`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `62e5c709e04c0b00b0dbe075908f9ec115d146a736bde6f54cd40efbd14d9f8f`.
...
source: test/01_unit/compiler/semantics/collection_patterns_lint_spec.spl
mirror: doc/06_spec/01_unit/compiler/semantics/collection_patterns_lint_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/compiler/semantics/collection_patterns_lint_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/compiler/semantics/collection_patterns_lint_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/compiler/semantics/collection_patterns_lint_spec.spl:31:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'warns on arr = arr + [x] in while loop' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/semantics/collection_patterns_lint_spec.spl:38:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'warns on arr = arr + [x] in for loop' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/semantics/collection_patterns_lint_spec.spl:45:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'does not warn outside loop' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
