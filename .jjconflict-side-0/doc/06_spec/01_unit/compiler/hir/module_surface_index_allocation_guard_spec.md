...
- uses the aligned arrays in the module lowering lookup
   ...
   - Expected: source.index_of(".composites.keys()") equals `-1`
   - Expected: source.index_of(".enums.keys()") equals `-1`
   - Expected: source.index_of(".traits.keys()") equals `-1`
   - Expected: source.index_of(".callables.keys()") equals `-1`
   - Expected: source.index_of(".type_aliases.keys()") equals `-1`
   - Expected: source.index_of(".constants.keys()") equals `-1`
...
expect(source.index_of(".composites.keys()")).to_equal(-1)
expect(source.index_of(".enums.keys()")).to_equal(-1)
expect(source.index_of(".traits.keys()")).to_equal(-1)
expect(source.index_of(".callables.keys()")).to_equal(-1)
expect(source.index_of(".type_aliases.keys()")).to_equal(-1)
expect(source.index_of(".constants.keys()")).to_equal(-1)
...
| Category | Compiler |
| Status | Active |
| Source | `test/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `9c0036d2c377f88ea84d09231a16eb9053c5606fa88548f4f084588a32fdd2bd`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `9c0036d2c377f88ea84d09231a16eb9053c5606fa88548f4f084588a32fdd2bd`.
...
source: test/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.spl
mirror: doc/06_spec/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=80 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 20 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.spl:17:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'does not rebuild Dict key/value arrays in module surface lookup' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/hir/module_surface_index_allocation_guard_spec.spl:56:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'uses the aligned arrays in the module lowering lookup' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
