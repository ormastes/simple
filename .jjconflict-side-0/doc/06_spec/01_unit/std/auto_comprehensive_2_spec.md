...
<!-- sdn-diagram:id=auto_comprehensive_2_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=auto_comprehensive_2_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

auto_comprehensive_2_spec
```
...
```ascii generated-from=auto_comprehensive_2_spec.arch hash=sha256:auto
