...
<!-- sdn-diagram:id=json_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=json_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

json_integration_spec -> std
```
...
```ascii generated-from=json_integration_spec.arch hash=sha256:auto
