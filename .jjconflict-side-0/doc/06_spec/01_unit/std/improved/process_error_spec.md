...
<!-- sdn-diagram:id=process_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=process_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

process_error_spec -> std
```
...
```ascii generated-from=process_error_spec.arch hash=sha256:auto
