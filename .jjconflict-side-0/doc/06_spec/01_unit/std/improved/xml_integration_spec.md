...
<!-- sdn-diagram:id=xml_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=xml_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

xml_integration_spec -> std
```
...
```ascii generated-from=xml_integration_spec.arch hash=sha256:auto
