...
<!-- sdn-diagram:id=mutex_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=mutex_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

mutex_error_spec -> std
```
...
```ascii generated-from=mutex_error_spec.arch hash=sha256:auto
