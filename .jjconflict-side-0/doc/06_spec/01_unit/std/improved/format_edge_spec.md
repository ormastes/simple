...
<!-- sdn-diagram:id=format_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=format_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

format_edge_spec -> std
```
...
```ascii generated-from=format_edge_spec.arch hash=sha256:auto
