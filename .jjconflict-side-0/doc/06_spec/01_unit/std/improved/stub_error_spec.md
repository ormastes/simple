...
<!-- sdn-diagram:id=stub_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stub_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=stub_error_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/stub_error_spec.spl` |
| Updated | 2026-06-01 |
