...
<!-- sdn-diagram:id=convert_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=convert_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

convert_unit_spec -> std
```
...
```ascii generated-from=convert_unit_spec.arch hash=sha256:auto
