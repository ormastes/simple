...
<!-- sdn-diagram:id=pattern_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=pattern_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

pattern_error_spec -> std
```
...
```ascii generated-from=pattern_error_spec.arch hash=sha256:auto
