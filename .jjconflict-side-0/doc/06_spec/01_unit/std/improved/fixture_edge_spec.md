...
<!-- sdn-diagram:id=fixture_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=fixture_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

fixture_edge_spec -> std
```
...
```ascii generated-from=fixture_edge_spec.arch hash=sha256:auto
