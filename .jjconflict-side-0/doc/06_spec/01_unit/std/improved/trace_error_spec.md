...
<!-- sdn-diagram:id=trace_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=trace_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

trace_error_spec -> std
```
...
```ascii generated-from=trace_error_spec.arch hash=sha256:auto
