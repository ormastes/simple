...
How to write async code that works across GC and NoGC memory modes in Simple. References the cross-language async research (`doc/01_research/async_patterns_cross_language.md`) and the nogc_async_mut architecture (`doc/07_guide/sync_async/async/nogc_async_mut_architecture.md`).
...
- **Cross-language patterns:** [`doc/01_research/async_patterns_cross_language.md`](../research/async_patterns_cross_language.md)
- **nogc_async_mut architecture:** [`doc/07_guide/sync_async/async/nogc_async_mut_architecture.md`](../guide/sync_async/async/nogc_async_mut_architecture.md)
- **Module parity:** [`doc/05_design/gc_nogc_module_parity.md`](gc_nogc_module_parity.md)
- **Resource lifecycle:** [`doc/05_design/resource_lifecycle_manager_design.md`](resource_lifecycle_manager_design.md)
