...
- `doc/05_design/custom_blocks_proposal.md` - Original proposal
- `doc/05_design/math_block_design.md` - Math block reference
- `doc/05_design/lean_block_design.md` - Verification blocks
- `doc/01_research/custom_string_literals_2026-01-24.md` - Literal syntax comparison
