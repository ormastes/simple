...
- **Test Suite**: `test/01_unit/ml/torch/typed_tensor_spec.spl` (367 LOC)
  - BDD-style tests
...
`test/01_unit/ml/torch/typed_tensor_spec.spl`:
...
```simple
# test/02_integration/ml/tensor_inference_integration.spl
...
- Test Suite: `simple/std_lib/test/01_unit/ml/torch/typed_tensor_spec.spl`
