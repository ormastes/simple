...
These traits were reserved ("impl deferred") in `doc/04_architecture/os/simpleos/kernel/simpleos_multiarch_hal.md`
...
| `doc/04_architecture/os/simpleos/kernel/simpleos_multiarch_hal.md` | Flip RESERVED → DONE for HalSmp + HalCache | Modified |
...
| SA-4 | `test/01_unit/os/kernel/arch/hal_riscv64_smp_cache_spec.spl`, `test/01_unit/os/kernel/arch/hal_riscv32_smp_cache_spec.spl` | Parallel; uses stub impls |
