...
**Tasks:**
1. Test tag classification logic - `test/01_unit/app/stats/tag_classifier_spec.spl`
2. Test doc coverage aggregation - `test/01_unit/app/stats/doc_coverage_spec.spl`
3. Test compiler warnings - `test/01_unit/app/build/doc_warnings_spec.spl`
4. Test JSON export - `test/01_unit/app/stats/json_export_spec.spl`
