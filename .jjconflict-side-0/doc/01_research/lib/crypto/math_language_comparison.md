...
**Related:** `doc/05_design/math_block_design.md`, `doc/01_research/math.md`
...
- `doc/05_design/math_block_design.md` - Implementation design
- `doc/01_research/math.md` - PyTorch integration spec
