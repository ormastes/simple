...
| Document | Path |
|----------|------|
| FPGA RTL guide | `doc/07_guide/hardware/riscv/simple_generated_fpga_rtl.md` |
| SFFI VHDL guide | `doc/07_guide/hardware/misc/sffi_vhdl_guide.md` |
| Xilinx FPGA bringup | `doc/07_guide/hardware/fpga/xilinx_fpga_board_bringup.md` |
| K26 NaxRiscv | `doc/07_guide/hardware/fpga/k26_naxriscv_rv64_product.md` |
| KV260 boot | `doc/07_guide/hardware/fpga/kv260_rv64gc_fpga_boot.md` |
| Kria K26 bringup | `doc/07_guide/hardware/fpga/kria_k26_fpga_bringup.md` |
...
- `doc/07_guide/hardware/riscv/simple_generated_fpga_rtl.md`
- `doc/07_guide/hardware/misc/sffi_vhdl_guide.md`
