...
├─────────────────────────────────────────────────────────────┤
│ test/01_unit/lib/std/type_checker/type_inference_spec.spl          │
│                                                             │
│ - 60+ test scenarios                                        │
...
simple test test/01_unit/lib/std/type_checker/type_inference_spec.spl

# Run with verbose output
simple test test/01_unit/lib/std/type_checker/type_inference_spec.spl --verbose

# Run specific feature
simple test test/01_unit/lib/std/type_checker/type_inference_spec.spl --feature "DynTrait"
