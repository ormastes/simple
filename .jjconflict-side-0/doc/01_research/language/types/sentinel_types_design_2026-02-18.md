...
**Related docs:**
- `doc/01_research/zig_embedded_features_2026-02-18.md` — overview of 10 Zig embedded features (sentinel = item #10)
- `doc/01_research/missing_language_features_2026-02-17.md` — grammar analysis, safety profiles
- `doc/01_research/introspection_phantom_types_2026-02-17.md` — phantom types (relevant to sentinel marker design)
- `doc/01_research/baremetal_embedded_research_2026-02-05.md` — embedded context: bitfields, volatile, ISR
...
From `MEMORY.md` and `test/01_unit/parser/newtype_spec.spl`, `newtype` is implemented as a parser feature:
...
From `doc/01_research/zig_embedded_features_2026-02-18.md` (item #1):
...
From `doc/01_research/missing_language_features_2026-02-17.md` — safety profile analysis:
...
Test file: `test/01_unit/std/cstr_spec.spl`
...
| 1 (now) | Create `test/01_unit/std/cstr_spec.spl` | Low | None |
...
- `doc/01_research/zig_embedded_features_2026-02-18.md` — item #10 (sentinel types) + item #1 (comptime, prerequisite for value-generic sentinel)
- `doc/01_research/introspection_phantom_types_2026-02-17.md` — phantom type patterns (newtype wrapper technique)
- `doc/01_research/missing_language_features_2026-02-17.md` — grammar analysis, safety profiles
- `doc/01_research/baremetal_embedded_research_2026-02-05.md` — embedded context motivating sentinel types
- `doc/05_design/compile_time_features_design_2026-02-18.md` — comptime design (value-in-type-position prerequisite)
