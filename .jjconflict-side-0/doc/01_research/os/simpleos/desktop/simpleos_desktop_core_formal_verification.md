...
- `doc/04_architecture/hardware/riscv/rv64_user_mode_exec.md`
- `doc/05_design/rv64_user_mode_exec.md`
- `test/03_system/app/os/feature/rv64_user_mode_exec_spec.spl`
...
- `test/03_system/app/os/feature/rv64_user_mode_exec_spec.spl` passes
- local SimpleOS research already exists:
  - `doc/01_research/os/simpleos/platform/simpleos_l4_exokernel_platform.md`
  - `doc/01_research/os/simpleos/simpleos_qemu_validation.md`
