...
| Spec | Purpose |
|------|---------|
| `test/03_system/os_tls_system_spec.spl` | TLS 1.3 integration vs rustls |
| `test/03_system/os_tls_spec.spl` | TLS 1.3 unit in QEMU |
| `test/03_system/os_full_stack_spec.spl` | Full OS stack smoke test |
| `test/03_system/os_network_spec.spl` | Network stack |
| `test/03_system/os_shell_spec.spl` | Shell in SimpleOS |
| `test/03_system/os_storage_spec.spl` | Storage / FAT32 |
| `test/03_system/os_boot_integration_spec.spl` | Boot integration |
| `test/03_system/os_compiler_bootstrap_spec.spl` | Compiler bootstrap in OS |
| `test/03_system/os_ssh_spec.spl` | SSH inside OS |
| `test/03_system/os_crypto_spec.spl` | Crypto primitives |
| `test/03_system/os_desktop_integration_spec.spl` | Desktop / GUI integration |
