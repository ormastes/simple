...
- Architecture context:
  - `doc/04_architecture/ui/simple_gui_stack.md` separates Simple GUI model, WM/desktop shell, compositor, host/web adapters, Simple Web Renderer, and Engine2D.
  - `doc/04_architecture/compiler/graphics/gui_layer_contract.md` locks `CompositorBackend`, `InputBackend`, and Engine2D boundaries.
  - `doc/04_architecture/hardware/arm32_jit_metal_constraints.md` records that Metal is an AArch64/macOS path, not ARM32.
  - `doc/04_architecture/os/simpleos/desktop/simpleos_arm_qemu_fs_toolchain_verification.md` covers ARM QEMU verification boundaries.
- Prior related research: `doc/01_research/ui/graphics/gui/gui_color_image_pipeline_8k.md`, `doc/01_research/ui/graphics/gui/gui_color_image_pipeline_8k.md`, and `doc/01_research/compiler/performance/performance_visual_comparison.md`.
