...
- Location: `simple/std_lib/test/` (working tests) + `simple/test/03_system/` (empty placeholders)
...
|----------|----------|-------|-------|--------|
| **Stdlib Unit** | `simple/std_lib/test/01_unit/` | 20 | 31 | ✅ Working |
| **Stdlib System** | `simple/std_lib/test/03_system/` | 6 | 400+ | ✅ Working |
| **Stdlib Integration** | `simple/std_lib/test/02_integration/` | 1 | - | ✅ Working |
| **Terminal System Tests** | `simple/test/03_system/` | 65 | 0 | ❌ Empty placeholders |

**Key Distinction:**
- **simple/std_lib/test/** - Real tests (Simple code testing Simple stdlib)
- **simple/test/03_system/** - Placeholder files for Rust terminal tests (Rust code testing Rust compiler)
...
```simple
# simple/std_lib/test/01_unit/compiler_core/array_spec.spl
describe "Array.push":
    it "adds element":
        let arr = [1, 2, 3]
        arr.push(4)
...
┌───────────────────────────────────────────────────────────────┐
│     Terminal Tests (65 files in simple/test/03_system/)          │
  ...
  "gaps": [
    {
      ...
      "recommendation": "Add test to simple/std_lib/test/01_unit/compiler_core/array_spec.spl"
    }
  ]
}
```
...
<body>
    ...
    <ul class="gaps">
        <li class="ffi-gap">
            ...
            <a href="#simple/std_lib/test/01_unit/compiler_core/array_spec.spl">Add test</a>
        </li>
    </ul>
...
Recommendations:
  1. Add test to simple/std_lib/test/01_unit/compiler_core/array_spec.spl for Array.filter
  2. Add system test for Actor.send in simple/test/03_system/features/actors/
