...
**Note:** Research documents are exploratory. See [doc/06_spec/](../spec/) for stable specifications and [doc/status/](../status/) for implementation status.
...
| **Specification** | Formal specification (consider moving to doc/06_spec/) |
...
- **[doc/05_design/](../design/)** — Design documents (where research conclusions land)
- **[doc/adr/](../architecture/adr/)** — Architecture Decision Records (extracted from design)
- **[doc/03_plan/](../plan/)** — Implementation roadmaps
- **[doc/requirement/](../plan/requirement/)** — Functional requirements that drive research topics
- **[doc/04_architecture/](../architecture/)** — Architecture principles
- **[doc/06_spec/](../spec/)** — Stable language specifications
...
- Session notes (those go in `doc/09_report/`)
- Status tracking (use `doc/02_requirements/feature/` for feature status, `doc/05_design/` for implementation status)
