...
```bash
bin/simple test test/integration/core/common_compression_framework_facade_spec.spl --mode=interpreter --clean
bin/simple test test/perf/port_algorithms/lz4_pure_simple_parity_spec.spl --mode=interpreter --clean
```
...
```bash
bin/simple test test/unit/os/kernel/loader/zstd_decompress_spec.spl --mode=interpreter --clean
bin/simple test test/perf/port_algorithms/zstd_pure_simple_parity_spec.spl --mode=interpreter --clean
```
...
```bash
bin/simple test test/perf/port_algorithms/zstd_pure_simple_encode_spec.spl --mode=interpreter --clean
```
...
- Add C reference benchmarks under `test/perf/port_algorithms/c_reference/`:
...
```bash
SIMPLE_OPT_PROVIDER=compression bin/simple test test/perf/port_algorithms/lz4_pure_simple_parity_spec.spl --mode=interpreter --clean
SIMPLE_OPT_PROVIDER=compression bin/simple test test/perf/port_algorithms/zstd_pure_simple_parity_spec.spl --mode=interpreter --clean
...
- Update `doc/04_architecture/simple_optimization_plugin.md` when the
