...
Validation:
- `bin/simple test test/01_unit/app/duplicate_check/duplicate_check_spec.spl --mode=interpreter`
- `bin/simple test test/01_unit/app/duplicate_check/phase1_integration_spec.spl --mode=interpreter`
- `bin/simple test test/03_system/duplicate_check/duplicate_check_regression_system_spec.spl --mode=interpreter`
