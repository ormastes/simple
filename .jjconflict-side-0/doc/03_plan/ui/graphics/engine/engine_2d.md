...
- `bin/simple test test/02_integration/rendering/engine2d_backend_spec.spl`
- `bin/simple test test/02_integration/rendering/engine2d_primitives_spec.spl`
- `bin/simple test test/01_unit/os/compositor/engine2d_glass_spec.spl`
- `bin/simple test test/03_system/engine_2d_spec.spl`

## Live QEMU Specs

Run the live QEMU specs:

- `bin/simple test test/03_system/engine2d_in_qemu_spec.spl '--mode=remote(baremetal(x86_64))'`
- `bin/simple test test/03_system/engine2d_primitives_spec.spl '--mode=remote(baremetal(x86_64))'`
- `bin/simple test test/03_system/gui_entry_engine2d_virtio_spec.spl '--mode=remote(baremetal(x86_64))'`
- `bin/simple test test/03_system/gui_entry_engine2d_wm_simple_web_spec.spl`
...
|-------------|----------|
| `REQ-ENG-003` Engine2D backend lifecycle/discovery works on host | `test/02_integration/rendering/engine2d_backend_spec.spl` |
| `REQ-ENG-008` Engine2D primitives draw deterministic pixels | Host primitive spec plus `test/03_system/engine2d_primitives_spec.spl` |
