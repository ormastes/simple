...
- `test/01_unit/hardware/riscv_common/riscv_linux_profile_spec.spl`
- `test/01_unit/hardware/fpga_linux/riscv_fpga_linux_spec.spl`
- `test/01_unit/compiler/backend/riscv_target_spec.spl`
- `test/03_system/feature/usage/llvm_backend_riscv64_spec.spl`
- `test/03_system/feature/baremetal/ghdl_generated_riscv64_linux_smoke_spec.spl`
- `test/03_system/app/hardware/feature/rv64_linux_rtl_pipeline_spec.spl`
