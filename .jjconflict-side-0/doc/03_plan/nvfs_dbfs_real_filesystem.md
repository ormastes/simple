...
- Gated DBFS-marked FAT32 carrier image smoke passes at `test/03_system/os/port/dbfs_disk_boot_spec.spl`
- Hosted DBFS/NVFS rootfs file I/O coverage exists at `test/01_unit/os/services/vfs/vfs_rootfs_porting_spec.spl`

## Verification

- `bin/simple test test/02_integration/storage/dbfs/dbfs_engine_wal_spec.spl`
- `bin/simple test test/02_integration/storage/dbfs/dbfs_nvme_callback_spec.spl`
- `bin/simple test test/02_integration/storage/dbfs/dbfs_recovery_spec.spl`
- `bin/simple test test/02_integration/storage/dbfs/samsung_nvme_feature_policy_spec.spl`
- `bin/simple test test/02_integration/storage/dbfs/bench_harness_smoke_spec.spl`
- `bin/simple test test/02_integration/storage/dbfs/dbfs_driver_spec.spl`
