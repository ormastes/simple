...
3. User reads: doc/07_guide/mocking_guide.md
...
Documentation: doc/07_guide/dependency_injection_guide.md
```
...
### Documentation
- [ ] `doc/07_guide/quick_reference/stdlib_quick_reference.md` created
- [ ] `doc/07_guide/dependency_injection_guide.md` created
- [ ] `doc/07_guide/mocking_guide.md` created
- [ ] `doc/07_guide/module_discovery_guide.md` created
