...
- `test/unit/lib/gc_async_mut/gpu/browser_engine/browser_renderer_smoke_spec.spl`
...
```bash
SIMPLE_LIB=src bin/simple check src/lib/gc_async_mut/gpu/browser_engine/simple_web_engine2d_renderer.spl test/unit/lib/gc_async_mut/gpu/browser_engine/simple_web_renderer_spec.spl src/app/wm_compare/html_compat_part3.spl test/system/wm_compare/html_compat_spec.spl test/unit/lib/gc_async_mut/gpu/browser_engine/browser_renderer_smoke_spec.spl
...
SIMPLE_LIB=src timeout 60s bin/simple test test/unit/lib/gc_async_mut/gpu/browser_engine/browser_renderer_smoke_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/system/wm_compare/html_compat_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 180s src/compiler_rust/target/debug/simple test test/system/editor_gui_spec.spl --mode=interpreter --clean --format json
```
...
- `test/integration/rendering/engine2d_backend_spec.spl` was narrowed to a
...
Verification:
```bash
SIMPLE_LIB=src bin/simple check test/integration/rendering/engine2d_backend_spec.spl
...
Verification:
```bash
SIMPLE_LIB=src bin/simple check src/app/ui.tauri/async_app.spl test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl test/unit/app/ui/tauri_surface_registry_spec.spl
SIMPLE_LIB=src bin/simple test test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src bin/simple test test/unit/app/ui/tauri_surface_registry_spec.spl --mode=interpreter --clean --format json
```
...
Combined check:
```bash
SIMPLE_LIB=src bin/simple check src/lib/common/ui/web_render_api.spl src/lib/gc_async_mut/ui/web_render_pixel_backend.spl src/app/ui.browser/renderer.spl test/unit/app/ui/web_render_backend_api_spec.spl src/app/ui.tauri/backend.spl test/unit/app/ui/tauri_backend_spec.spl src/lib/gc_async_mut/gpu/browser_engine/simple_web_engine2d_renderer.spl test/unit/lib/gc_async_mut/gpu/browser_engine/simple_web_renderer_spec.spl test/unit/lib/gc_async_mut/gpu/browser_engine/browser_renderer_smoke_spec.spl src/app/wm_compare/html_compat_part3.spl test/system/wm_compare/html_compat_spec.spl src/app/editor/tui_shell_panels.spl test/system/editor_tui_polish_spec.spl src/lib/gc_async_mut/gpu/engine2d/backend_cpu.spl src/lib/gc_async_mut/gpu/engine2d/backend_vulkan.spl test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl test/integration/rendering/engine2d_backend_spec.spl test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl
```
...
```bash
SIMPLE_LIB=src bin/simple check src/lib/gc_async_mut/gpu/engine2d/backend_cpu.spl src/lib/gc_async_mut/gpu/engine2d/backend_vulkan.spl test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl test/integration/rendering/engine2d_backend_spec.spl
...
```bash
SIMPLE_LIB=src timeout 120s bin/simple check src/lib/gc_async_mut/gpu/engine2d/backend_software.spl src/lib/gc_async_mut/gpu/engine2d/backend_cpu.spl src/lib/gc_async_mut/gpu/engine2d/backend_cuda.spl test/integration/rendering/cuda_strict_spec.spl test/integration/rendering/engine2d_mask_spec.spl test/integration/rendering/engine2d_primitives_spec.spl
SIMPLE_LIB=src timeout 240s bin/simple test test/integration/rendering/cuda_strict_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/integration/rendering/engine2d_mask_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/integration/rendering/engine2d_primitives_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 60s bin/simple check src/lib/gc_async_mut/gpu/engine2d/backend_vulkan_spirv.spl test/perf/graphics_2d/vulkan_spirv_spec.spl test/integration/rendering/vulkan_strict_spec.spl
SIMPLE_LIB=src timeout 60s bin/simple test test/perf/graphics_2d/vulkan_spirv_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/integration/rendering/vulkan_strict_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 120s bin/simple check src/lib/gc_async_mut/gpu/engine2d/backend_vulkan_spirv.spl test/perf/graphics_2d/vulkan_spirv_spec.spl test/integration/rendering/vulkan_strict_spec.spl
SIMPLE_LIB=src timeout 60s bin/simple test test/perf/graphics_2d/vulkan_spirv_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/integration/rendering/vulkan_strict_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/integration/rendering/engine2d_backend_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl --mode=interpreter --clean --format json
...
timeout 180s src/compiler_rust/target/debug/simple test test/integration/rendering/vulkan_strict_spec.spl --mode=interpreter --clean --format json

SIMPLE_LIB=/home/ormastes/dev/pub/simple/src \
VK_ICD_FILENAMES=/usr/share/vulkan/icd.d/nvidia_icd.json \
__EGL_VENDOR_LIBRARY_FILENAMES=/usr/share/glvnd/egl_vendor.d/10_nvidia.json \
timeout 180s src/compiler_rust/target/debug/simple test test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 120s bin/simple check test/integration/rendering/vulkan_strict_spec.spl test/perf/graphics_2d/vulkan_spirv_spec.spl
SIMPLE_LIB=src timeout 80s bin/simple test test/perf/graphics_2d/vulkan_spirv_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 120s bin/simple test test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl --mode=interpreter --clean --format json
...
```bash
SIMPLE_LIB=src bin/simple check src/lib/common/ui/web_render_api.spl src/lib/gc_async_mut/ui/web_render_pixel_backend.spl src/app/ui.browser/renderer.spl test/unit/app/ui/web_render_backend_api_spec.spl
SIMPLE_LIB=src timeout 60s bin/simple test test/unit/app/ui/web_render_backend_api_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 120s bin/simple test test/unit/lib/gc_async_mut/gpu/browser_engine/simple_web_renderer_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/unit/lib/gc_async_mut/gpu/browser_engine/browser_renderer_smoke_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 120s bin/simple check src/app/ui.tauri/app.spl src/app/ui.tauri/async_app.spl src/app/ui.tauri/backend.spl test/unit/app/ui/web_render_backend_api_spec.spl test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl
SIMPLE_LIB=src timeout 80s bin/simple test test/unit/app/ui/web_render_backend_api_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 80s bin/simple test test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 120s bin/simple check src/app/ui.tauri/tauri_entry.spl src/app/ui.ipc/protocol.spl test/unit/app/ui/tauri_entry_common_envelope_spec.spl test/unit/app/ui/async_ipc_spec.spl
SIMPLE_LIB=src timeout 120s bin/simple test test/unit/app/ui/tauri_entry_common_envelope_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 120s bin/simple test test/unit/app/ui/async_ipc_spec.spl --mode=interpreter --clean --format json
...
node --check test/unit/app/ui/electron_bridge_common_envelope_test.js
node test/unit/app/ui/electron_bridge_common_envelope_test.js
SIMPLE_LIB=src timeout 120s bin/simple check src/app/ui.electron/backend.spl src/app/ui.electron/app.spl test/unit/app/ui/web_render_backend_api_spec.spl test/unit/app/ui/async_ipc_spec.spl
SIMPLE_LIB=src timeout 120s bin/simple test test/unit/app/ui/web_render_backend_api_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src bin/simple check test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl src/app/ui.tauri/backend.spl src/app/ui.tauri/async_app.spl test/unit/app/ui/tauri_backend_spec.spl test/unit/app/ui/tauri_surface_registry_spec.spl
SIMPLE_LIB=src timeout 60s bin/simple test test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/unit/app/ui/tauri_backend_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 60s bin/simple test test/unit/app/ui/tauri_surface_registry_spec.spl --mode=interpreter --clean --format json
```
...
```bash
SIMPLE_LIB=src timeout 180s bin/simple check src/lib/gc_async_mut/gpu/engine2d/backend_cpu.spl src/lib/gc_async_mut/gpu/engine2d/backend_vulkan.spl test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl test/integration/rendering/engine2d_backend_spec.spl
SIMPLE_LIB=src timeout 180s bin/simple check src/lib/common/ui/web_render_api.spl src/lib/gc_async_mut/ui/web_render_pixel_backend.spl src/app/ui.browser/renderer.spl test/unit/app/ui/web_render_backend_api_spec.spl src/app/ui.tauri/backend.spl test/unit/app/ui/tauri_backend_spec.spl
SIMPLE_LIB=src timeout 180s bin/simple check src/lib/common/ui/web_render_api.spl src/lib/gc_async_mut/ui/web_render_pixel_backend.spl src/app/ui.tauri/async_app.spl test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl test/unit/app/ui/tauri_surface_registry_spec.spl
SIMPLE_LIB=src timeout 180s bin/simple test test/integration/rendering/engine2d_cpu_vulkan_parity_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/integration/rendering/engine2d_backend_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/unit/app/ui/web_render_backend_api_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/unit/app/ui/tauri_backend_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/unit/app/ui/ui_layer_web_tauri_contract_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/unit/app/ui/tauri_surface_registry_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 180s bin/simple test test/unit/lib/gc_async_mut/gpu/browser_engine/simple_web_renderer_spec.spl --mode=interpreter --clean --format json
SIMPLE_LIB=src timeout 90s bin/simple test test/unit/lib/gc_async_mut/gpu/browser_engine/browser_renderer_smoke_spec.spl --mode=interpreter --clean --format json
```
