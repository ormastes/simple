...
- regression spec covering all four: `test/05_perf/bench/db_accel_index/db_accel_index_spec.spl`
...
- Phase 1 reports real SIMD capability but still uses scalar kernels; perf
  ...
  intrinsics
- Current benchmark evidence in `test/05_perf/bench/simple_db_shared_accel.spl`
...
- benchmark script exists at `test/05_perf/bench/simple_db_shared_accel.spl`, but
