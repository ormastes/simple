...
bin/simple test test/02_integration/baremetal/qemu_baremetal_lib_smoke_spec.spl \
...
| `test/02_integration/debug/hardware/stm32wb_openocd_spec.spl` | STM32WB + OpenOCD | Repo-ready readiness spec |
| `test/02_integration/debug/hardware/stm32h7_openocd_spec.spl` | STM32H7 + OpenOCD | Repo-ready readiness spec |
| `test/02_integration/debug/hardware/t32_native_spec.spl` | STM32WB/STM32H7 + TRACE32 Remote API | Repo-ready readiness spec, waiting for usable TRACE32 session |
| `test/02_integration/debug/hardware/t32_gdb_bridge_spec.spl` | STM32WB/STM32H7 + TRACE32 GDB bridge | Repo-ready readiness spec, waiting for usable TRACE32 session |
