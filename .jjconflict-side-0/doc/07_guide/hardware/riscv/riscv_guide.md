...
Located in `test/01_unit/hardware/`:

**RV32IMAC** (`test/01_unit/hardware/rv32imac/`):
...
**RV64GC** (`test/01_unit/hardware/rv64gc/`):
...
**riscv_common** (`test/01_unit/hardware/riscv_common/`):
- `riscv_formal_contract_spec.spl`
- `riscv_generated_core_spec.spl`
- `riscv_linux_profile_spec.spl`

**FPGA Linux** (`test/01_unit/hardware/fpga_linux/`):
...
Located in `test/02_integration/hardware/`:
...
- `test/03_system/hardware/rv32_external_formal_harness_spec.spl`
...
bin/simple test test/01_unit/hardware/rv32imac/rv32_decode_spec.spl
...
- `doc/04_architecture/hardware/riscv/riscv_fpga_linux.md` -- FPGA Linux architecture
- `doc/04_architecture/hardware/riscv/riscv_generated_core_migration.md` -- Generated core migration
- `doc/04_architecture/hardware/riscv/riscv_linux_rtl_dual_arch_completion.md` -- Dual-arch completion
