...
For `test/03_system/feature/**` and `test/03_system/**`, include:
...
- Source file expectation: sibling logical unit spec under `test/01_unit/.../<name>_spec.spl`
- Module expectation: each `__init__.spl` or leaf source directory has an integration/module spec under `test/02_integration/...`
