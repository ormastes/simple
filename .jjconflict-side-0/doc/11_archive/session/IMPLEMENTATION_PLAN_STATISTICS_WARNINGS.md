...
- **File:** `test/01_unit/parser/multiline_bool_spec.spl` (143 lines, 18 tests)
- **Status:** PASSING
- **Solution:** Lexer suppresses newlines when `lex_paren_depth > 0`

### 2. Module Function Closures ✅
- **File:** `test/01_unit/runtime/module_closure_spec.spl` (85 lines, 10 tests)
- **Status:** PASSING
...
**Test File:** `test/01_unit/app/doc_coverage/inline_comment_coverage_spec.spl`
...
**Test File:** `test/01_unit/app/doc_coverage/group_comment_detection_spec.spl`
...
**Test File:** `test/01_unit/app/doc_coverage/sdoctest_comparison_spec.spl`
...
**Test Command:**
```bash
bin/simple test test/01_unit/ --closure-warnings --return-warnings
```
...
- `test/01_unit/app/doc_coverage/inline_comment_coverage_spec.spl`
...
- `test/01_unit/app/doc_coverage/group_comment_detection_spec.spl`
...
1. **Existing (Verify):**
   - `test/01_unit/compiler/closure_capture_warning_spec.spl` (177 lines) ✅
   - `test/01_unit/compiler_core/ignored_return_warning_spec.spl` (130 lines) ✅
   - `test/01_unit/compiler_core/generic_syntax_spec.spl` (191 lines) ✅
   - `test/01_unit/runtime/module_closure_spec.spl` (85 lines) ✅
   - `test/01_unit/parser/multiline_bool_spec.spl` (143 lines) ✅

2. **New (Create):**
   - `test/01_unit/app/doc_coverage/inline_comment_coverage_spec.spl` (150+ lines)
   - `test/01_unit/app/doc_coverage/group_comment_detection_spec.spl` (100+ lines)
   - `test/01_unit/app/doc_coverage/sdoctest_comparison_spec.spl` (100+ lines)
   - `test/01_unit/app/cli/doc_coverage_command_spec.spl` (120+ lines)

### Integration Tests

Create `test/02_integration/warnings_integration_spec.spl`:
```simple
...
Create `test/02_integration/doc_coverage_integration_spec.spl`:
```simple
...
- Files: `test/01_unit/app/doc_coverage/*.spl`, `test/02_integration/*.spl`
