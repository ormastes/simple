...
4. `test/01_unit/app/mcp/prompts_spec.spl` - Import fix
5. `test/01_unit/app/diagram/call_flow_profiling_spec.spl` - Extern decl
...
- **Quick Reference:** `doc/07_guide/quick_reference/syntax_quick_reference.md`
