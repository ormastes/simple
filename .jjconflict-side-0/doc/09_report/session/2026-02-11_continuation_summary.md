...
- `test/03_system/compiler/compiler_basics_spec.spl` - Timeout
- `test/03_system/runner_spec.spl` - ✅ Already enabled (previous session)
...
- Existing tests in `test/01_unit/compiler/` work fine
