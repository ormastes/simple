...
#### 1. `test/01_unit/std/env_spec.spl` - TIMEOUT
...
#### 2. `test/01_unit/std/log_spec.spl` - TIMEOUT
...
#### 3. `test/01_unit/app/diagram/call_flow_profiling_spec.spl` - TIMEOUT
...
#### 4. `test/01_unit/app/package/semver_spec.spl` - TIMEOUT
...
#### 5. `test/01_unit/app/mcp/prompts_spec.spl` - TIMEOUT
...
#### 6. `test/01_unit/std/mock_phase5_spec.spl` - TIMEOUT
...
#### 7. `test/01_unit/app/tooling/arg_parsing_spec.spl` - NOT A BUG
**Reason:** "Static methods unsupported in bootstrap runtime"
**Status:** ✅ Correctly skipped

#### 8. `test/01_unit/app/mcp/failure_analysis_spec.spl` - NOT A BUG
