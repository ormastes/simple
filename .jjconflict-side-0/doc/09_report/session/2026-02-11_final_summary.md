...
**Created:** `test/01_unit/compiler/uncovered_branches_spec.spl`
...
**Enabled:** `test/03_system/runner_spec.spl`
...
- `test/03_system/shrinking_spec.spl` - Causes timeout
- `test/03_system/generators_spec.spl` - Causes timeout
...
### Created
- `test/01_unit/compiler/uncovered_branches_spec.spl` - Branch coverage tests
...
### Modified
- `test/03_system/runner_spec.spl` - Removed `@pending` marker
...
- Added test/01_unit/compiler/uncovered_branches_spec.spl
- Enabled test/03_system/runner_spec.spl
...
1. **Try more pending tests** - Several candidates identified
   - `test/03_system/parser_spec.spl`
   - Tests in `test/01_unit/std/` directory
