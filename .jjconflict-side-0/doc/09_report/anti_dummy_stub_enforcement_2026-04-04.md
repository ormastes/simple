...
- [sspec_quality_lint_spec.spl](test/02_integration/app/sspec_quality_lint_spec.spl)
- [verify_test_quality_gate_spec.spl](test/02_integration/app/verify_test_quality_gate_spec.spl)
...
- `./bin/simple check src/compiler/35.semantics/lint/stub_impl.spl src/compiler/90.tools/lint/main.spl src/app/verify/test_quality_gate.spl src/app/verify/main.spl test/02_integration/app/sspec_quality_lint_spec.spl test/02_integration/app/verify_test_quality_gate_spec.spl test/01_unit/compiler/lint/stub_impl_spec.spl`
- `./bin/simple test test/02_integration/app/sspec_quality_lint_spec.spl`
- `./bin/simple test test/02_integration/app/verify_test_quality_gate_spec.spl`
- `./bin/simple test test/01_unit/compiler/lint/stub_impl_spec.spl`
...
- `test/02_integration/t32_hw/22_action_list_invoke_spec.spl`
- `test/02_integration/t32_hw/23_screenshot_spec.spl`
- `test/02_integration/t32_hw/30_dialog_tools_spec.spl`
- `test/03_system/async_promise_system_spec.spl`
...
- `test/02_integration/t32_hw/11_session_list_info_spec.spl`
- `test/02_integration/t32_hw/12_core_tools_spec.spl`
- `test/02_integration/t32_hw/13_cmd_run_spec.spl`
- `test/02_integration/t32_hw/14_cmm_run_spec.spl`
- `test/02_integration/t32_hw/15_eval_spec.spl`
- `test/02_integration/t32_hw/16_error_check_spec.spl`
- `test/02_integration/t32_hw/17_window_list_describe_spec.spl`
- `test/02_integration/t32_hw/18_window_open_capture_spec.spl`
- `test/02_integration/t32_hw/20_power_cycle_for_new_spec.spl`
- `test/02_integration/t32_hw/21_field_get_set_spec.spl`
- `test/02_integration/t32_hw/24_history_tail_spec.spl`
- `test/02_integration/t32_hw/26_cmm_commands_validate_spec.spl`
- `test/02_integration/t32_hw/27_area_read_spec.spl`
- `test/02_integration/t32_hw/28_setup_headless_spec.spl`
...
All 16 T32 hardware specs in `test/02_integration/t32_hw/` have been cleaned:
