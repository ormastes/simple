...
- best baseline frame us: 120
- baseline/simple speedup x1000: 20000
...
-   --> /home/yoon/simple/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4081:58
-    |
- 4081 |         if ri >= right_count or (li < left_count and left[li] <= right[ri]):
-    |                                                          ^
- 
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /home/yoon/simple/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4099:58
-    |
- 4099 |         if ri >= right_count or (li < left_count and left[li] <= right[ri]):
-    |                                                          ^
- 
- Use angle brackets: left<...> instead of left[...]
- 
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /home/yoon/simple/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4132:58
-    |
- 4132 |             while pos < rule_count and has_last and rules[pos] == last:
-    |                                                          ^
- 
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /home/yoon/simple/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4135:42
-    |
- 4135 |             if pos < rule_count and rules[pos] < min_rule:
-    |                                          ^
- 
- Use angle brackets: rules<...> instead of rules[...]
- 
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /home/yoon/simple/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4159:58
-    |
- 4159 |             while pos < rule_count and has_last and rules[pos] == last:
-    |                                                          ^
- 
- Use angle brackets: rules<...> instead of rules[...]
- 
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /home/yoon/simple/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4162:42
-    |
- 4162 |             if pos < rule_count and rules[pos] < min_rule:
-    |                                          ^
- 
- Use angle brackets: rules<...> instead of rules[...]
- 
