...
|----------|-------|--------|
| Basic args | `test/03_system/feature/usage/cli_args_basic_spec.spl` | Active |
| Default values | `test/03_system/feature/usage/cli_args_default_spec.spl` | Active |
| File detection | `test/03_system/feature/usage/cli_args_file_spec.spl` | Active |
| Help generation | `test/03_system/feature/usage/cli_args_help_spec.spl` | Active |
| Type inference | `test/03_system/feature/usage/cli_args_inference_spec.spl` | Active |
| Short flags | `test/03_system/feature/usage/cli_args_short_spec.spl` | Active |
| Subcommands | `test/03_system/feature/usage/cli_args_subcommand_spec.spl` | Active |
| Type system | `test/03_system/feature/usage/cli_args_types_spec.spl` | Active |
| Error handling | `test/03_system/feature/usage/cli_args_error_spec.spl` | Active |
| Migration | `test/03_system/feature/usage/cli_args_migration_spec.spl` | Active |
| Codegen unit | `test/01_unit/app/cli/cli_codegen_spec.spl` | Active |
| Validation | `test/01_unit/app/cli/cli_validation_spec.spl` | Active |
| System | `test/03_system/infrastructure/cli_system_spec.spl` | Active |
| Dispatch | `test/02_integration/app/cli_dispatch_spec.spl` | Active |
| Perf | `test/02_integration/app/startup_argparse_mmap_perf_spec.spl` | Active |
| **Total** | **35+ files** | |

## Proof Evidence

`test/02_integration/app/startup_argparse_mmap_perf_spec.spl` provides end-to-end proof:
