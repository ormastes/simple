...
- `test/03_system/feature/language/placeholder_lambda_spec.spl`: 47 passed, 0 failed
- `test/01_unit/compiler_core/parser/short_grammar_interpreter_spec.spl`: 19 passed, 0 failed
- `test/01_unit/compiler_core/parser/short_grammar_native_spec.spl`: 1 passed, 0 failed
- `test/01_unit/app/fix/short_grammar_fix_spec.spl`: 64 passed, 0 failed
- `test/05_perf/graphics_2d/optimization_plugin_spec.spl --mode=interpreter`: 14 passed, 0 failed
- `test/05_perf/graphics_2d/optimization_plugin_spec.spl --mode=native`: 1 passed, 0 failed
