...
| `test/03_system/sffi_bidirectional_interop_spec.spl` | 15 it | System-level interop spec |
| `test/02_integration/sffi/direction_a_c_roundtrip_spec.spl` | -- | Simple-to-C round-trip proof |
| `test/02_integration/sffi/direction_a_cpp_roundtrip_spec.spl` | -- | Simple-to-C++ round-trip proof |
| `test/02_integration/sffi/direction_b_import_roundtrip_spec.spl` | -- | C-to-Simple import proof |
| `test/02_integration/sffi/callback_roundtrip_spec.spl` | -- | Callback trampoline proof |
| `test/02_integration/sffi/layout_verification_roundtrip_spec.spl` | -- | ABI layout verification proof |
| `test/02_integration/sffi/fixtures/calculator.spl` | -- | Simple library fixture |
| `test/02_integration/sffi/fixtures/test_calculator.c` | -- | C test fixture |
| `test/02_integration/sffi/fixtures/test_calculator.cpp` | -- | C++ test fixture |
...
| File | Coverage |
|------|----------|
| `test/03_system/sffi_bidirectional_interop_spec.spl` | 15 it blocks, full feature coverage |
| `test/02_integration/sffi/direction_a_c_roundtrip_spec.spl` | Compile .so, gen header, gcc, link, execute |
| `test/02_integration/sffi/direction_a_cpp_roundtrip_spec.spl` | Compile .so, gen C++ header, g++, link, execute |
| `test/02_integration/sffi/direction_b_import_roundtrip_spec.spl` | extern fn import, plugin manifest, execute |
| `test/02_integration/sffi/callback_roundtrip_spec.spl` | Bidirectional callback trampoline proof |
| `test/02_integration/sffi/layout_verification_roundtrip_spec.spl` | ABI layout compile-time + runtime check |
