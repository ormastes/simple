...
**Date:** 2026-07-10T10:19:41+00:00
**Resolution:** 7680x4320
**Frames:** 1
**DPI:** 300
**Simple Web CPU mode:** native
**Profile script:** `tools/gui_perf_bench/run_all_benchmarks.shs`
**Report path:** `doc/09_report/gui_perf_benchmark_2026-07-10.md`
...
gui_perf_benchmark_cold_startup_ms=94.44
...
--- javascript_node: SKIPPED (canvas module unavailable) ---
gui_perf_benchmark_backend=javascript_node
gui_perf_benchmark_status=unavailable
gui_perf_benchmark_reason=node canvas module not installable
...
[33mwarning[0m: Deprecated syntax for type parameters
  --> /tmp/simple-simd-aot-next/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:3733:24
   |
...
[33mwarning[0m: Deprecated syntax for type parameters
  --> /tmp/simple-simd-aot-next/src/lib/gc_async_mut/gpu/browser_engine/simple_web_html_layout_renderer.spl:4753:58
   |
...
(backend_comparison_samples sample_count: 1 scalar_baseline_p50_us: 0 backend_faster_than_scalar_count: 0 backend_equal_to_scalar_count: 0 backend_slower_than_scalar_count: 0 offload_overhead_contained_count: 0 offload_overhead_dominates_count: 0 offload_useful_count: 0 offload_faster_but_overhead_dominates_count: 0 offload_break_even_count: 0 offload_slower_communication_overhead_count: 0 offload_slower_compute_bound_count: 0 offload_missing_scalar_baseline_count: 0 valid: true
  (backend_comparison_sample fixture_id: "gui-perf-8k-cpu-simd" backend_family: "cpu_simd" shell: "simple-web" requested: "cpu_simd" selected: "cpu_simd" device_id: "host-software" status: "Initialized" command: "bench-8k" host: "dl" warmup_count: 1 sample_count: 1 cold_start_us: 2389121 warm_start_us: 2389121 p50_frame_us: 2389121 p95_frame_us: 2389121 p95_input_to_paint_us: 2389121 max_rss_kb: 1 binary_size_bytes: 54795064 baseline_binary_size_bytes: 54795064 binary_size_delta_bytes: 0 package_size_bytes: 54795064 artifact_build_us: 0 artifact_load_us: 0 artifact_submit_us: 2389121 artifact_sync_us: 0 artifact_readback_us: 0 artifact_total_us: 2389121 offload_overhead_verdict: "not-gpu-offload" speed_verdict: "missing-scalar-baseline" offload_efficiency_verdict: "not-gpu-offload" render_readback_scope: "software-render-loop" offload_tag_kind: "@gpu" operation_family: "text_blit" generated_operation: "" generated_entry_symbol: "" generated_source_format: "none" generated_binary_format: "none" generated_artifact_path_suffix: "" runtime_compute_target: "cpu_simd" runtime_execution_path: "simple_web_layout_engine2d_cpu_simd" runtime_launch_api: "RenderBackend" runtime_entry_symbol: "RenderBackend.draw_text_or_text_blit" runtime_artifact_name: "" runtime_status: "cpu-simd-render-loop-ready" simd_provider_hits: 0 native_simd_hits: 0 native_simd_executed: false checksum: "sum32:17761116667698048" pixel_proof: "nonzero_pixels:33177600" scalar_baseline_compared: true fallback_used: false fallback_reason: "" unavailable_reason: "")
)
...
gui_perf_benchmark_simd_provider_hits=0
gui_perf_benchmark_native_simd_hits=0
gui_perf_benchmark_native_simd_executed=false
gui_perf_benchmark_screen_size_reduced=false
```
gui_perf_benchmark_max_rss_kb=732768
gui_perf_benchmark_exit_code=0

### simple_web_software

```text
(backend_comparison_samples sample_count: 1 scalar_baseline_p50_us: 1461001 backend_faster_than_scalar_count: 0 backend_equal_to_scalar_count: 0 backend_slower_than_scalar_count: 0 offload_overhead_contained_count: 0 offload_overhead_dominates_count: 0 offload_useful_count: 0 offload_faster_but_overhead_dominates_count: 0 offload_break_even_count: 0 offload_slower_communication_overhead_count: 0 offload_slower_compute_bound_count: 0 offload_missing_scalar_baseline_count: 0 valid: true
  (backend_comparison_sample fixture_id: "gui-perf-8k-software" backend_family: "software" shell: "simple-web" requested: "software" selected: "software" device_id: "host-software" status: "Initialized" command: "bench-8k" host: "dl" warmup_count: 1 sample_count: 1 cold_start_us: 1461001 warm_start_us: 1461001 p50_frame_us: 1461001 p95_frame_us: 1461001 p95_input_to_paint_us: 1461001 max_rss_kb: 1 binary_size_bytes: 54795064 baseline_binary_size_bytes: 54795064 binary_size_delta_bytes: 0 package_size_bytes: 54795064 artifact_build_us: 0 artifact_load_us: 0 artifact_submit_us: 1461001 artifact_sync_us: 0 artifact_readback_us: 0 artifact_total_us: 1461001 offload_overhead_verdict: "not-gpu-offload" speed_verdict: "missing-scalar-baseline" offload_efficiency_verdict: "not-gpu-offload" render_readback_scope: "software-render-loop" offload_tag_kind: "@gpu" operation_family: "text_blit" generated_operation: "" generated_entry_symbol: "" generated_source_format: "none" generated_binary_format: "none" generated_artifact_path_suffix: "" runtime_compute_target: "cpu_scalar" runtime_execution_path: "simple_web_layout_software" runtime_launch_api: "RenderBackend" runtime_entry_symbol: "RenderBackend.draw_text_or_text_blit" runtime_artifact_name: "" runtime_status: "cpu-scalar-baseline-ready" simd_provider_hits: 0 native_simd_hits: 0 native_simd_executed: false checksum: "sum32:17761116667698048" pixel_proof: "nonzero_pixels:33177600" scalar_baseline_compared: true fallback_used: false fallback_reason: "" unavailable_reason: "")
)
gui_perf_benchmark_dpi=300
gui_perf_benchmark_dpi_default=300
gui_perf_benchmark_dpi_source=default
...
gui_perf_benchmark_screen_size_reduced=false
```
gui_perf_benchmark_max_rss_kb=727832
gui_perf_benchmark_exit_code=0

## CPU Drawing Library Baseline Compare

> The GTK3/Cairo row measures draw-call time without equivalent Simple layout,
> present, or readback work. The generated `target_met` field below is retained
> as harness output but is not a semantic parity verdict.
...
gui_perf_cpu_base_compare_simple_checksum=sum32:17761116667698048
...
gui_perf_cpu_base_compare_simd_provider_hits=0
gui_perf_cpu_base_compare_native_simd_executed=false
...
gui_perf_cpu_base_compare_simple_p50_ms=2389.121
gui_perf_cpu_base_compare_baseline_backend=gtk3_cairo
gui_perf_cpu_base_compare_baseline_metric=draw_only_avg_ms
gui_perf_cpu_base_compare_baseline_ms=0.032
gui_perf_cpu_base_compare_baseline_over_simple_ratio=0.000
...
- The Cairo draw-only and Simple full-loop rows are not directly comparable.

Benchmark complete. Full report: `doc/09_report/gui_perf_benchmark_2026-07-10.md`
