...
|-----------|-------|-------|
| `test/03_system/remote_baremetal_lane_status_spec.spl` | 6 it | System-level lane status |
| `test/03_system/feature/app/remote_baremetal/remote_baremetal_library_spec.spl` | 24 it | Library-level adapter and probe tests |
| `test/03_system/feature/app/remote_baremetal/remote_baremetal_runtime_spec.spl` | 16 it | Runtime execution and result collection |
| `test/03_system/feature/app/remote_baremetal/remote_baremetal_qemu_hello_spec.spl` | 4 it | QEMU hello-world end-to-end |
| `test/03_system/feature/baremetal/ghdl_riscv32_semihost_spec.spl` | 3 slow_it | GHDL semihosting (requires GHDL) |
...
|-----------|--------|-------|
| `test/03_system/baremetal_test_runner_spec.spl` | pass | Baremetal runner surface and orchestration smoke |
| `test/02_integration/remote_jit/qemu_rv32_library_semihost_spec.spl` | pass | Stable RV32 semihost lane |
| `test/02_integration/remote_jit/qemu_arm_composite_runner_spec.spl` | pass | Stable ARM semihost lane |
| `test/03_system/remote_baremetal_lane_status_spec.spl` | pass | Lane status publication and classification |
| `test/02_integration/remote_jit/stm32h7_composite_runner_spec.spl` | pass | OpenOCD-backed host-aware STM32H7 lane |
| `test/03_system/t32_terminal_power_remote_spec.spl` | pass | TRACE32-backed host-aware STM32H7 lane |
