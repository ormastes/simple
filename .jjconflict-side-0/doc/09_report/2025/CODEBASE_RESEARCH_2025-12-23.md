...
- Specs: doc/06_spec/{sdn.md, language.md, syntax.md, lexer_parser.md, testing/testing_bdd_framework.md}
- Research: doc/01_research/{aop.md, sdn_self_hosting.md}
...
- Tree-sitter grammar documents:
  - doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar.md
  - doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_definitions.md (contains `module.exports = grammar({ ... })` inlined)
  - doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_expressions.md
  - doc/06_spec/app/compiler/modules/parser/overview.md, lexer_parser_scanner.md (scanner/build.rs notes)
...
- Adopt “Single Source of Truth” for grammar:
  ...
  - Add short “Implementation Status” banner to doc/06_spec/app/compiler/modules/parser/* pages: “Current implementation: Rust recursive descent + Pratt (see src/parser). Tree-sitter is planned.”
...
- Spec: doc/06_spec/sdn.md (syntax, grammar, CLI examples, crate structure)
- Project usage:
...
- SDN vs TOML/JSON/YAML: doc/06_spec/sdn.md includes comparison table and conversion commands.
- Pragmatic stance:
...
- Add a small “authoritative index” in doc/06_spec/sdn.md pointing to src/sdn/* and CLI.
...
### Documentation
- Primary spec: doc/01_research/aop.md — Unified predicate grammar, contexts (weaving/DI/mock/arch), semantics
...
- For cross-cutting concerns in Rust-hosted components (compiler code), continue using tracing (`#[tracing::instrument]`) — doc/04_architecture/dev.md endorses this as a pragmatic AOP alternative.
...
- Documentation hygiene:
  ...
  - Introduce doc/09_report/authoritative_indexes.md that links to canonical implementation locations.
- Automation:
...
- Editor support:
  - If Tree-sitter is pursued, create tree-sitter-simple/ crate with rules excerpted from Rust parser; use doc/06_spec/app/compiler/modules/parser/* as seed, then keep a sync script.
- Interop:
...
- Parser/Lexer
  ...
  - Spec: doc/06_spec/{lexer_parser.md, syntax.md, language.md}
  - Tree-sitter docs: doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_*.md (design-only)
- AOP & Predicates
  - Spec: doc/01_research/aop.md
...
1. Add “implementation status” banners to doc/06_spec/app/compiler/modules/parser/* indicating Rust parser is the authoritative implementation.
...
- SDN implementation references:
  - src/sdn/src/{lexer.rs, parser.rs, document.rs, bin/sdn.rs}, doc/06_spec/sdn.md, simple/BUILD.md
...
- Grammar docs referencing Tree-sitter without code:
  - doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_{definitions,expressions}.md include grammar.js sections; actual parser is Rust.
