...
All tests located in `simple/std_lib/test/01_unit/game_engine/`:
...
./target/debug/simple simple/std_lib/test/01_unit/game_engine/actor_model_spec.spl
./target/debug/simple simple/std_lib/test/01_unit/game_engine/effects_spec.spl
./target/debug/simple simple/std_lib/test/01_unit/game_engine/scene_node_spec.spl
```
