...
- `doc/09_report/TUI_SYNTAX_FINDINGS_2025-12-27.md` - Syntax pattern discoveries
- `doc/09_report/TUI_FFI_MODULE_BLOCKER_2025-12-27.md` - FFI blocker (now resolved)
- `doc/09_report/FFI_EXTERN_FN_PROGRESS_2025-12-27.md` - extern fn conversion progress
