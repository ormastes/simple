...
```
✓ Removed: test/02_integration/e2e/full_compilation_pipeline_{2..10}_spec.spl
✓ Kept: test/02_integration/e2e/full_compilation_pipeline_1_spec.spl
```

#### 3. full_test_pipeline duplicates (9 files)
```
✓ Removed: test/02_integration/e2e/full_test_pipeline_{2..10}_spec.spl
✓ Kept: test/02_integration/e2e/full_test_pipeline_1_spec.spl
```
