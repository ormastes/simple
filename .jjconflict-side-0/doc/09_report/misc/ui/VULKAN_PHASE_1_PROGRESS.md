...
**File Created:** `simple/std_lib/test/03_system/ui/vulkan_phase1_validation.spl`
...
Following the DSL research (`doc/01_research/vulkan_dsl.md`), all types use the builder pattern:
...
- `simple/std_lib/test/03_system/ui/vulkan_phase1_validation.spl` (~150 lines) - Test suite
- `doc/09_report/VULKAN_PHASE_1_PROGRESS.md` (this file)
