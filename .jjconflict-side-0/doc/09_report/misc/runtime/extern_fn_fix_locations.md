...
Create `test/01_unit/interpreter/extern_fn_spec.spl`:
...
# 2. Run minimal test
bin/simple test test/01_unit/interpreter/extern_fn_spec.spl

# 3. Run full regression
bin/simple test

# 4. Check package tests (currently timeout)
bin/simple test test/01_unit/app/package/
```
...
2. `doc/07_guide/ffi_guide.md` - Add extern fn usage examples
3. `doc/02_requirements/feature/feature.md` - Mark extern support as complete
...
TESTING:
- Created test/01_unit/interpreter/extern_fn_spec.spl
