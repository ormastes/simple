...
- **Investigation Report:** `doc/09_report/extern_fn_validation_investigation_2026-02-15.md`
- **Call Flow Analysis:** `doc/09_report/extern_fn_call_flow.md`
- **Fix Locations:** `doc/09_report/extern_fn_fix_locations.md`
- **This Summary:** `doc/09_report/EXTERN_FN_BUG_SUMMARY.md`
