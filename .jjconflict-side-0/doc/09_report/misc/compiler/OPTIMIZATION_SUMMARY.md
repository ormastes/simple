...
**Evidence:**
- All 132 `test/02_integration/e2e/*_{2-10}_spec.spl` files were IDENTICAL (hash: 6fb75f4a0474754e2a4e32a0176db569)
- All 25 `test/03_system/stress_{2-25}_system_spec.spl` files were IDENTICAL (hash: 4e666ae6941e8a34ebd27f12b4e59cc2)
...
**Deleted (141 files):**
```bash
test/02_integration/e2e/*_{2,3,4,5,6,7,8,9,10}_spec.spl  # 117 files
test/03_system/stress_{2..25}_system_spec.spl            # 24 files
```

**Modified (16 files) - `slow_it` → `it`:**
```bash
test/02_integration/e2e/*_1_spec.spl  # 15 files
test/03_system/stress_1_system_spec.spl
```
