...
**Guide:** `doc/07_guide/ffi_syscalls_phase3_guide.md`
...
| `test/03_system/ffi/syscalls_test.spl` | Integration tests | 150 |

### Documentation

| File | Type | Purpose |
|------|------|---------|
| `doc/07_guide/quick_reference/ffi_syscalls_quick_reference.md` | Reference | Quick lookup for all functions |
| `doc/07_guide/ffi_syscalls_phase3_guide.md` | Guide | Step-by-step Phase 3 instructions |
| `doc/09_report/ffi_syscalls_phases_1_2_summary.md` | Report | Complete Phase 1-2 summary |
| `doc/09_report/ffi_dependency_reduction_plan.md` | Plan | Full 4-phase plan with estimates |
...
- Phase 3 Guide: `doc/07_guide/ffi_syscalls_phase3_guide.md`
- Full Summary: `doc/09_report/ffi_syscalls_phases_1_2_summary.md`
...
### Tests
- Integration tests: `test/03_system/ffi/syscalls_test.spl`
...
5. Test: Add to `test/03_system/ffi/syscalls_test.spl`
...
1. Read Phase 3 guide: `doc/07_guide/ffi_syscalls_phase3_guide.md`
2. Audit FFI wrappers: `src/app/io/mod.spl`
3. Run integration tests: `simple test test/03_system/ffi/syscalls_test.spl`
