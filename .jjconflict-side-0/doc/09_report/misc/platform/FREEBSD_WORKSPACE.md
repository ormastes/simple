...
| Guide | Purpose |
|-------|---------|
| **[FreeBSD Workspace Setup](doc/07_guide/freebsd_workspace_setup.md)** | Complete setup guide (VM, bootstrap, cross-compile, testing) |
| **[FreeBSD Quick Reference](doc/07_guide/quick_reference/freebsd_quick_reference.md)** | Command cheat sheet and tips |
| **[QEMU Setup Guide](doc/07_guide/qemu_setup.md)** | QEMU installation and configuration |
...
- **[QEMU Setup Guide](doc/07_guide/qemu_setup.md)** - Install QEMU for all architectures
- **[macOS Workspace](doc/07_guide/macos_workspace_setup.md)** - macOS VM setup
- **[Windows Workspace](doc/07_guide/windows_workspace_setup.md)** - Windows VM setup
...
**See:** [FreeBSD Quick Reference](doc/07_guide/quick_reference/freebsd_quick_reference.md)
