...
|------|--------|-------|-------|
| `test/03_system/features/collections_spec.spl` | 57/60 | **60/60** ✅ | **+3** |
...
```bash
$ bin/simple_runtime test/03_system/features/collections_spec.spl
...
**Related:** `doc/09_report/collections_runtime_bugs_fixed_2026-02-07.md`
