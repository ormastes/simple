...
1. `test/03_system/features/sdoctest/sdoctest_spec.spl.skip`
   - Feature: SDN documentation tests
   - Status: Future feature

2. `test/03_system/features/traits/trait_coherence_spec.spl.skip`
   - Feature: Trait system coherence rules
   - Status: Advanced feature, not yet implemented

3. `test/03_system/features/ui_dynamic_structure/ui_dynamic_structure_spec.spl.skip`
   - Feature: UI framework dynamic structures
   - Status: Future UI framework feature

4. `test/03_system/features/ui_ssr_hydration/ui_ssr_hydration_spec.spl.skip`
   - Feature: Server-side rendering hydration
   - Status: Future UI framework feature

5. `test/03_system/features/ui_structural_patchset/ui_structural_patchset_spec.spl.skip`
   - Feature: UI structural patching
   - Status: Future UI framework feature

#### AOP Features (3 files - OLD BACKUPS)
6. `test/03_system/features/aop/aop_pointcut_spec.spl.skip`
7. `test/03_system/features/aop/aop_spec.spl.skip`
8. `test/03_system/features/aop/aop_around_advice_spec.spl.skip`
...
9. `test/03_system/features/parser/parser_type_annotations_spec.spl.skip`
   - Feature: Type annotation parsing
   - Status: Future enhancement

10. `test/03_system/features/parser/parser_deprecation_warnings_spec.spl.skip`
    - Feature: Deprecation warning system
    - Status: Future enhancement

11. `test/03_system/features/parser/parser_declarations_spec.spl.skip`
    - Feature: Advanced declaration parsing
    - Status: Future enhancement

#### Tree-sitter (1 file)
12. `test/03_system/features/treesitter/treesitter_parser_spec.spl.skip`
...
1. **Delete old backups** (3 files):
   ```bash
   rm test/03_system/features/aop/*.spl.skip
   ```
