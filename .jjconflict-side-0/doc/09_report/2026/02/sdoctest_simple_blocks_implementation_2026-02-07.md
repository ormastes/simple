...
**File:** `doc/06_spec/testing/sdoctest.md`
...
**File:** `doc/03_plan/sdoctest_simple_blocks_no_validation_plan.md`
...
| `doc/06_spec/testing/sdoctest.md` | +65 | Documentation |
| `doc/03_plan/sdoctest_simple_blocks_no_validation_plan.md` | +450 | Design |
...
- **Design:** `doc/03_plan/sdoctest_simple_blocks_no_validation_plan.md`
- **Spec:** `doc/06_spec/testing/sdoctest.md`
...
3. **Extend to other doc files** - remove skip markers from `doc/07_guide/*.md`
