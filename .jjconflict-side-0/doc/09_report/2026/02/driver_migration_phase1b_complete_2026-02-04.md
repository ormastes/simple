...
**File:** `test/02_integration/cli_dispatch_spec.spl` (167 lines)
...
| `test/02_integration/cli_dispatch_spec.spl` | +167 | New | Integration tests |
...
3. `test/02_integration/cli_dispatch_spec.spl` (167 lines) - Integration tests
