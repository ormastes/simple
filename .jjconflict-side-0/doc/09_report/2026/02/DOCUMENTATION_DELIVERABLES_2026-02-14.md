...
### 3. doc/07_guide/type_registry_api.md (~350 lines)
...
### 4. doc/07_guide/simd_api_reference.md (~520 lines)
...
| doc/07_guide/type_registry_api.md | ~350 | ✅ Complete | Type registry API reference |
| doc/07_guide/simd_api_reference.md | ~520 | ✅ Complete | SIMD API reference (design) |
