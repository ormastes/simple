...
```simple
# test/05_perf/bench/opt/fibonacci.spl
fn fib(n: i64) -> i64:
    if n <= 1:
        return n
...
```bash
# Unoptimized
simple build test/05_perf/bench/opt/fibonacci.spl -O0
time ./fibonacci  # Record

# Speed optimization
simple build test/05_perf/bench/opt/fibonacci.spl -O2
time ./fibonacci  # Should be faster

# Aggressive
simple build test/05_perf/bench/opt/fibonacci.spl -O3
time ./fibonacci  # Should be fastest
```

### 4. Document Results

Create `doc/09_report/mir_optimization_benchmarks_2026-02-03.md` with results.
...
- `doc/09_report/session_complete_2026-02-03.md` - Complete summary
- `doc/09_report/mir_optimization_cli_complete_2026-02-03.md` - CLI guide
- `doc/07_guide/mir_optimization_integration.md` - Integration guide
