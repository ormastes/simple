...
### 4. Integration Tests
**File:** `test/03_system/ffi/syscalls_test.spl`
...
1. **Implementation Report:** `doc/09_report/ffi_syscalls_implementation_2026-02-04.md`
   - Detailed function inventory
   - Symbol verification
   - Build instructions
   - Next steps

2. **Dependency Reduction Plan:** `doc/09_report/ffi_dependency_reduction_plan.md`
   - 7 crates that can be removed
   - 16 crates to keep (complex libs)
   - Phase-by-phase migration plan
   - Binary size impact estimates

3. **This Summary:** `doc/09_report/minimal_nostd_ffi_completion_2026-02-04.md`
   - High-level overview
   - Achievement summary
   - Next steps
...
4. `test/03_system/ffi/syscalls_test.spl` - Tests

### Modified (1 file)
1. `rust/Cargo.toml` - Added ffi_syscalls to workspace

### Documentation (3 files)
1. `doc/09_report/ffi_syscalls_implementation_2026-02-04.md`
2. `doc/09_report/ffi_dependency_reduction_plan.md`
3. `doc/09_report/minimal_nostd_ffi_completion_2026-02-04.md`
