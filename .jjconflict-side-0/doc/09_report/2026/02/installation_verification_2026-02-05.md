...
| `test/02_integration/database_atomic_spec.spl` | 13 | Atomic operations, file locking |
| `test/02_integration/database_query_spec.spl` | 13 | Query builder fluent API |
...
**Impact:** Integration tests in `test/02_integration/` may need adjustments to work with current interpreter limitations.
...
2. **Run integration tests** - Execute all 80+ tests in `test/02_integration/`
...
- MCP fixes report: `doc/09_report/mcp_fixes_and_tests_2026-02-05.md`
- Integration report: `doc/09_report/mcp_database_integration_2026-02-05.md`
