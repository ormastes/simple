...
**Categories:**
- System tests: `test/03_system/` (~400 files)
- Feature tests: `test/03_system/features/` (~200 files)
- Unit tests: `test/01_unit/` (~50 files)
- Integration tests: `test/02_integration/` (~20 files)
...
- `test/03_system/features/collections/collections_spec.spl`
- `test/03_system/compiler/sample/python_inspired_sample/collections_spec.spl`
...
**Simple:**
- Likely has feature tests in `test/03_system/features/`
...
**Found:**
- `test/03_system/interpreter/sample/python_inspired_sample/` - Has both `.py`, `.sdt`, `.spl` versions
- `test/03_system/compiler/sample/python_inspired_sample/` - Duplicate of above
...
find test/03_system/ -name "*.py" -o -name "*.sdt" | xargs rm
...
- Keep: `test/03_system/features/` (primary location)
...
**Categories:**
- `test/03_system/features/` - Feature tests (primary)
- `test/std/` - Standard library tests
- `test/01_unit/` - Unit tests for Simple modules
...
diff -r test/03_system/interpreter/sample/python_inspired_sample/ \
        test/03_system/compiler/sample/python_inspired_sample/

# If identical, remove one
rm -rf test/03_system/compiler/sample/python_inspired_sample/
```
