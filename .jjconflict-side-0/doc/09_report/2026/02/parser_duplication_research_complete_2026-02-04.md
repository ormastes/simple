...
**File:** `doc/01_research/parser_duplication_analysis_2026-02-04.md` (327 lines)
...
**File:** `doc/05_design/parser_architecture_unified_2026-02-04.md` (524 lines)
...
**File:** `doc/03_plan/parser_merge_plan_2026-02-04.md` (756 lines)
...
**Tasks:**
1. Create `doc/04_architecture/parser_lexer_structure.md` ✅ Done (as parser_file_locations)
2. Update `doc/04_architecture/file_tree.md` (if exists)
