...
/usr/bin/time -v bin/simple test test/01_unit/app/duplicate_check/cache_spec.spl
```
...
See `doc/09_report/slow_test_optimization_2026-02-14.md` for complete analysis.

---

## Related Documentation

- **Full Analysis:** `doc/09_report/slow_test_optimization_2026-02-14.md`
...
4. **Optional Cleanup:**
   - Move 9 stub test files to `doc/05_design/*.pending.spl`
