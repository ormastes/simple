...
**Action Required:** Apply doc-test fix methodology from `doc/09_report/doctest_fixes_final_2026-01-21.md`
...
### Doc-Tests
- Follow methodology from `doc/09_report/doctest_fixes_final_2026-01-21.md`
...
- `doc/09_report/implementable_skipped_tests_2026-01-21.md` - Original analysis
- `doc/09_report/doctest_fixes_final_2026-01-21.md` - Doc-test fix methodology
- `doc/09_report/ignored_tests_feature_2026-01-21.md` - Rust #[ignore] tests
- `doc/test/test_result.md` - Current test results
- `doc/02_requirements/feature/pending_feature.md` - All incomplete features
