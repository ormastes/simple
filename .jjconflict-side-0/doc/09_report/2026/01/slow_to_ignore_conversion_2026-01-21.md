...
### Files Modified
1. `test/01_unit/spec/dsl_spec.spl` - Converted 2 slow_it → ignore_it
2. `test/02_integration/spec/runner_spec.spl` - Converted 2 slow_it → ignore_it
...
|---|------------------|------|-------------|
| 1 | "registers an ignored example" | test/01_unit/spec/dsl_spec.spl | ❌ No |
| 2 | **"takes a long time"** | test/01_unit/spec/dsl_spec.spl | ✅ **YES** |
| 3 | "ignored tests are never run" | test/01_unit/spec/dsl_spec.spl | ❌ No |
| 4 | "takes forever" | test/01_unit/spec/dsl_spec.spl | ❌ No |
| 5 | "skips ignored tests" | test/02_integration/spec/runner_spec.spl | ❌ No |
| 6 | "ignored test" | test/02_integration/spec/runner_spec.spl | ❌ No |
| 7 | "ignored tests never run" | test/02_integration/spec/runner_spec.spl | ❌ No |
| 8 | "ignored test" | test/02_integration/spec/runner_spec.spl | ❌ No |
...
1. **test/01_unit/spec/dsl_spec.spl**
...
2. **test/02_integration/spec/runner_spec.spl**
   - Converted 2 slow_it tests to ignore_it
