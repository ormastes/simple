...
- `simple/std_lib/test/01_unit/ui/vulkan_renderer_spec.spl:29,78`

**Verification**:
```bash
./target/release/simple simple/std_lib/test/01_unit/ui/vulkan_renderer_spec.spl
...
**Verification**:
```bash
./target/release/simple simple/std_lib/test/01_unit/mcp/symbol_table_spec.spl
...
### Tests (1 file)
1. `simple/std_lib/test/01_unit/ui/vulkan_renderer_spec.spl` - Updated method calls
