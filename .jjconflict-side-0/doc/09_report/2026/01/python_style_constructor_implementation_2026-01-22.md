...
### Documentation
5. **`doc/07_guide/constructor_patterns.md`**
   - Complete guide on Python-style constructors
   - Examples for all common patterns
   - Comparison table

6. **`doc/09_report/python_style_constructor_implementation_2026-01-22.md`**
...
- See: `doc/09_report/concurrency_ffi_implementation_2026-01-22.md`
