...
### 2. Tests
**File:** `simple/std_lib/test/01_unit/tooling/pkg_commands_spec.spl` (171 lines)
...
```bash
$ ./target/debug/simple test simple/std_lib/test/01_unit/tooling/pkg_commands_spec.spl
...
