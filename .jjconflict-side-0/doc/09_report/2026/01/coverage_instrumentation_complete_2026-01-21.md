...
1. **`doc/07_guide/source_coverage.md`** (UPDATED)
...
2. **`doc/07_guide/coverage_ci_cd.md`** (NEW - 387 lines)
...
3. **`doc/05_design/coverage_architecture.md`** (UPDATED)
...
1. `doc/07_guide/coverage_ci_cd.md` (387 lines)
...
### Documentation Files
1. `doc/07_guide/source_coverage.md`
...
2. `doc/05_design/coverage_architecture.md`
