...
### Test Files
- `simple/std_lib/test/01_unit/compiler_core/regex_spec.spl` - Remove SKIPPED comment, enable tests
- `simple/std_lib/test/01_unit/tooling/regex_utils_spec.spl` - Check if needs updates
...
| Tests | ⚠️ Skipped | `simple/std_lib/test/01_unit/compiler_core/regex_spec.spl` |
...
**Tests:**
- `simple/std_lib/test/01_unit/compiler_core/regex_spec.spl` - BDD tests (currently skipped)
- `simple/std_lib/test/01_unit/tooling/regex_utils_spec.spl` - Utility tests
