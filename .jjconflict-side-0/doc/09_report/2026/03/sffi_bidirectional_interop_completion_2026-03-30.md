...
- `test/01_unit/app/plugin/manifest_spec.spl`
- `test/01_unit/app/wrapper_gen/plugin_manifest_spec.spl`
- `test/01_unit/compiler/tools/header_gen_spec.spl`
- `test/01_unit/compiler/semantics/sffi_lint_spec.spl`
- `test/01_unit/compiler/types/layout_verification_spec.spl`
- `test/01_unit/compiler/common/export_attr_spec.spl`
- `test/03_system/sffi_bidirectional_interop_spec.spl`
