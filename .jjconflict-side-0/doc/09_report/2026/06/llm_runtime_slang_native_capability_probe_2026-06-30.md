# LLM Runtime Slang Native Capability Probe

- status: `pass`
- source: `local_simple_slang_capability_probe`
...
- std_fs_spec_exit: `0`
- std_fs_spec_log: `build/llm_runtime_slang_native_capability_probe/std_fs_nvfs_client_spec.log`
...
- surface_manifest: `build/llm_runtime_slang_native_capability_probe/slang_native_capability_probe_surface_manifest.tsv`
...
- env: `build/llm_runtime_slang_native_capability_probe/evidence.env`
