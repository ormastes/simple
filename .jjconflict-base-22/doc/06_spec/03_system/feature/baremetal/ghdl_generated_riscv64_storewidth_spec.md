...
<!-- sdn-diagram:id=ghdl_generated_riscv64_storewidth_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=ghdl_generated_riscv64_storewidth_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

ghdl_generated_riscv64_storewidth_spec -> std
```
...
```ascii generated-from=ghdl_generated_riscv64_storewidth_spec.arch hash=sha256:auto
