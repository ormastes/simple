...
<!-- sdn-diagram:id=gui_web_2d_freshness_metadata_emitters_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=gui_web_2d_freshness_metadata_emitters_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

gui_web_2d_freshness_metadata_emitters_spec -> std
```
...
```ascii generated-from=gui_web_2d_freshness_metadata_emitters_spec.arch hash=sha256:auto
