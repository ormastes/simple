...
*Source: `simple/std_lib/test/features/control_flow/loops_spec.spl`*
...
**Implemented (See Related Features):**
- Comprehensions: `[x * 2 for x in items if x > 0]` (See #52)
- Enumerate shorthand: `for i, item in items:` (See #53)
