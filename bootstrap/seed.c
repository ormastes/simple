 ...
 *
 * Bootstrap chain:
 *   1. gcc compiles seed.c → seed binary
 *   2. seed compiles bootstrap compiler (Simple) → C code
 *   3. gcc compiles C code + runtime.c → native bootstrap compiler
 ...
 *
 * Usage:
 *   gcc -o build/seed bootstrap/seed.c
 *   build/seed input.spl > output.c
 *   gcc -o output output.c bootstrap/runtime.c
 */
