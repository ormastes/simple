 ...
 *
 * Build: gcc -c bootstrap/runtime.c -o bootstrap/runtime.o -std=c11 -O2
 * Test:  gcc -o /tmp/runtime_test bootstrap/runtime_test.c bootstrap/runtime.c -std=c11 && /tmp/runtime_test
 */
