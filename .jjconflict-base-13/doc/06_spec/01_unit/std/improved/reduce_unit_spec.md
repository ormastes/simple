...
<!-- sdn-diagram:id=reduce_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reduce_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reduce_unit_spec -> std
```
...
```ascii generated-from=reduce_unit_spec.arch hash=sha256:auto
