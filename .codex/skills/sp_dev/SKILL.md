...
`simpleos_hardening_matrix_passed=22/22`,
...
`simpleos_hardening_formal_memory_safety_status=pass`,
`simpleos_hardening_formal_storage_integrity_status=pass`,
`simpleos_hardening_formal_boundary_integrity_status=pass`,
`simpleos_hardening_formal_compiler_language_status=pass`,
`simpleos_hardening_formal_ui_policy_status=pass`, and
`simpleos_hardening_formal_coverage_status=pass`, plus
