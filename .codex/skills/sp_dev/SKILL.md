...
Vulkan-backed browser proof. Read current macOS blocker lanes from
...
Electron, or Chrome Vulkan-backed capture is ready. GUI widget fixture evidence must
...
temporary helpers must fail explicitly with `assert(false)` or equivalent.
