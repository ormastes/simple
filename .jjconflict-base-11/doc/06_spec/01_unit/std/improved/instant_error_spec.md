...
<!-- sdn-diagram:id=instant_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=instant_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

instant_error_spec -> std
```
...
```ascii generated-from=instant_error_spec.arch hash=sha256:auto
