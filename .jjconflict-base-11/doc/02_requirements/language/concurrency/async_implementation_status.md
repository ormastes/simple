...
1. **Unit Tests (std):**
   - `test/01_unit/std/async_spec.spl` - ALL SKIPPED (basic async/await)
   - `test/01_unit/std/async_host_spec.spl` - ALL SKIPPED (host runtime)
   - `test/01_unit/std/async_embedded_spec.spl` - ALL SKIPPED (embedded runtime)

2. **Compiler Tests:**
   - `test/01_unit/compiler/async_pipeline_spec.spl` - FAILS/TIMEOUT
   - `test/01_unit/compiler/async_state_machine_spec.spl` - Unknown status
   - `test/01_unit/compiler/async_integration_spec.spl` - ALL TRIVIAL (expect 1 == 1)
   - `test/01_unit/compiler/async_desugar_integration_spec.spl` - Exists
   - `test/01_unit/compiler/async_mir_spec.spl` - Exists
   - `test/01_unit/compiler/async_mir_interpreter_spec.spl` - Exists

3. **Feature Tests:**
   - `test/03_system/feature/async_features_spec.spl` - PARTIAL (lambdas work, async skipped)
   - `test/03_system/feature/async_effects_spec.spl` - Unknown status
   - `test/03_system/feature/async_file_io_spec.spl` - Unknown status
...
From `test/03_system/feature/async_features_spec.spl`:
...
```simple
# test/01_unit/compiler_core_legacy/future_type_spec.spl
...
Target: `test/03_system/feature/async_features_spec.spl`
