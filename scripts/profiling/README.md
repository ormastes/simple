...
./scripts/profiling/profile-interpreter.sh examples/fibonacci.spl

# Profile with custom settings
./scripts/profiling/profile-interpreter.sh test.spl --freq=999 --time=20

# Profile benchmark workload
./scripts/profiling/profile-interpreter.sh --benchmark --time=30
```
...
./scripts/profiling/analyze-hotspots.sh perf.data
...
cd ..
./scripts/profiling/profile-interpreter.sh --benchmark --output=before.svg
```
...
cd ..
./scripts/profiling/profile-interpreter.sh --benchmark --output=after.svg
...
sudo ./scripts/profiling/profile-interpreter.sh script.spl
