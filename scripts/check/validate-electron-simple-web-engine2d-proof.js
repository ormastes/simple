...
emit('electron_simple_web_engine2d_electron_frame_us', jsonIntegerTextOrClean(proof.frame_us));
emit('electron_simple_web_engine2d_requested_width', jsonIntegerTextOrClean(proof.width));
emit('electron_simple_web_engine2d_requested_height', jsonIntegerTextOrClean(proof.height));
emit('electron_simple_web_engine2d_capture_native_width', jsonIntegerTextOrClean(proof.capture_native_width));
emit('electron_simple_web_engine2d_capture_native_height', jsonIntegerTextOrClean(proof.capture_native_height));
...
emit('electron_simple_web_engine2d_captured_argb_width', jsonIntegerTextOrClean(capturedArgb.width));
emit('electron_simple_web_engine2d_captured_argb_height', jsonIntegerTextOrClean(capturedArgb.height));
