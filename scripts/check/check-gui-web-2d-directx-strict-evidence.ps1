...
$width = Value-Or $evidence "gui_web_2d_directx_width" "0"
$height = Value-Or $evidence "gui_web_2d_directx_height" "0"
...
$electronArgbStatus = Value-Or $evidence "gui_web_2d_directx_electron_argb_status" "missing"
$electronArgbWidth = Value-Or $evidence "gui_web_2d_directx_electron_argb_width" "0"
$electronArgbHeight = Value-Or $evidence "gui_web_2d_directx_electron_argb_height" "0"
$electronArgbPixels = Value-Or $evidence "gui_web_2d_directx_electron_argb_pixel_count" "0"
$electronArgbNonblank = Value-Or $evidence "gui_web_2d_directx_electron_argb_nonblank_pixel_count" "0"
$chromeArgbStatus = Value-Or $evidence "gui_web_2d_directx_chrome_argb_status" "missing"
$chromeArgbWidth = Value-Or $evidence "gui_web_2d_directx_chrome_argb_width" "0"
$chromeArgbHeight = Value-Or $evidence "gui_web_2d_directx_chrome_argb_height" "0"
$chromeArgbPixels = Value-Or $evidence "gui_web_2d_directx_chrome_argb_pixel_count" "0"
$chromeArgbNonblank = Value-Or $evidence "gui_web_2d_directx_chrome_argb_nonblank_pixel_count" "0"
$argbMetricsStatus = "pass"
if (
    -not (Is-PositiveInt $width) -or
    -not (Is-PositiveInt $height) -or
    ...
    $electronArgbWidth -ne $width -or
    $electronArgbHeight -ne $height -or
    $chromeArgbWidth -ne $width -or
    $chromeArgbHeight -ne $height
) {
    $argbMetricsStatus = "invalid-browser-argb-metrics"
}
...
if ($argbMetricsStatus -ne "pass") { $failures.Add("browser-argb-source-metrics") | Out-Null }
...
Write-Output "gui_web_2d_directx_strict_evidence_argb_metrics_status=$argbMetricsStatus"
Write-Output "gui_web_2d_directx_strict_evidence_electron_argb_width=$electronArgbWidth"
Write-Output "gui_web_2d_directx_strict_evidence_electron_argb_height=$electronArgbHeight"
Write-Output "gui_web_2d_directx_strict_evidence_electron_argb_pixel_count=$electronArgbPixels"
Write-Output "gui_web_2d_directx_strict_evidence_electron_argb_nonblank_pixel_count=$electronArgbNonblank"
Write-Output "gui_web_2d_directx_strict_evidence_chrome_argb_width=$chromeArgbWidth"
Write-Output "gui_web_2d_directx_strict_evidence_chrome_argb_height=$chromeArgbHeight"
Write-Output "gui_web_2d_directx_strict_evidence_chrome_argb_pixel_count=$chromeArgbPixels"
Write-Output "gui_web_2d_directx_strict_evidence_chrome_argb_nonblank_pixel_count=$chromeArgbNonblank"
