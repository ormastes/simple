...
`test/03_system/wm_compare`, focused SPipe runs exposed existing system-spec
failures that should not be hidden by layout migration.

Passing moved specs:

- `test/03_system/wm_compare/html_compat_spec.spl`
- `test/03_system/wm_compare/emulated_capture_spec.spl`
- `test/03_system/wm_compare/famous_site_engine2d_backend_spec.spl`

Previously failing moved specs (all now fixed):

- `test/03_system/wm_compare/backend_parity_spec.spl`: 8/8 passing.
- `test/03_system/wm_compare/golden_gate_spec.spl`: 10/10 passing.
- `test/03_system/wm_compare/browser_shell_parity_spec.spl`: 6/6 passing.
- `test/03_system/wm_compare/electron_reference_parity_spec.spl`: 6/6 passing.
