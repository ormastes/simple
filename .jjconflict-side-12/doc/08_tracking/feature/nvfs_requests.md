...
- **Acceptance-criteria:**
  - [x] `test/fixtures/features/nvfs/encryption.feature` — 5 scenarios (N6a-001/002/003)
  - [x] `test/fixtures/features/nvfs/raw_send.feature` — 5 scenarios (N6b)
  - [x] `test/fixtures/features/nvfs/scrub_repair.feature` — 5 scenarios (N4a/N4b)
  - [x] `test/fixtures/features/simple_db/hot_slack.feature` — 5 scenarios (FR-HOT-001)
  - [x] `test/fixtures/features/simple_db/tier_cache.feature` — 5 scenarios (M4)
  - [x] `test/fixtures/features/simple_db/vacuum.feature` — 5 scenarios (M5)
  - [x] `test/fixtures/features/os/vfs_cursor.feature` — 5 scenarios (FR-SIMPLEOS-M5-001)
  - [x] `test/fixtures/features/bench/clock_extern.feature` — 5 scenarios (rt_time_now_ns)
