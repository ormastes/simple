...
<!-- sdn-diagram:id=optimizer_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=optimizer_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

optimizer_system_spec -> std
```
...
```ascii generated-from=optimizer_system_spec.arch hash=sha256:auto
