...
|-----------|-------|------|
| `test/01_unit/app/cli/query_ast_query_spec.spl` | 25 | Unit — pattern parsing, predicate eval |
| `test/01_unit/app/cli/query_sem_query_spec.spl` | 34 | Unit — query parsing, field matching |
| `test/01_unit/app/cli/query_schema_spec.spl` | 6 | Unit — schema content |
| `test/01_unit/app/cli/query_ast_query_integration_spec.spl` | 21 | Integration — full CLI pipeline |
| `test/01_unit/app/cli/query_sem_query_integration_spec.spl` | 32 | Integration — full CLI pipeline |
| `test/01_unit/app/cli/query_engine_spec.spl` | 51 | Unit — outline parser engine |
| `test/01_unit/app/cli/query_upgrade_spec.spl` | 33 | Unit — query upgrade helpers |
| `test/01_unit/app/cli/query_sanitize_spec.spl` | 30 | Unit — input sanitization |
