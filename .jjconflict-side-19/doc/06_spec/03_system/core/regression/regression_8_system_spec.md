...
<!-- sdn-diagram:id=regression_8_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=regression_8_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

regression_8_system_spec -> std
```
...
```ascii generated-from=regression_8_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/core/regression/regression_8_system_spec.spl` |
| Updated | 2026-06-01 |
