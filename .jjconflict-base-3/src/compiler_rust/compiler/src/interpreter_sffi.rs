//! SFFI interface for the interpreter.
//!
...
/// Initialize interpreter state from AST (SFFI-safe wrapper).
///
/// # Safety
...
fn call_interpreted_function(
    ...
    // Diagram tracing for interpreted function call via SFFI bridge
...
// ============================================================================
// RuntimeValue SFFI bridge (for hybrid execution)
// ============================================================================
...
extern "C" fn interp_eval_handler(expr_index: i64) -> simple_runtime::RuntimeValue {
    ...
    if diagram_sffi::is_diagram_enabled() {
        diagram_sffi::trace_call(&format!("<expr:{}>", expr_index));
    }
