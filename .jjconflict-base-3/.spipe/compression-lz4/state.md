...
- Test spec at `test/01_unit/lib/common/compress/lz4_spec.spl` imports three symbols via
...
```bash
bin/simple test test/01_unit/lib/common/compress/lz4_spec.spl --mode=interpreter --clean
```
