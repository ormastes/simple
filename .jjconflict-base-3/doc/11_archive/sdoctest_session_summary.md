...
**Integration Tests:** `test/02_integration/doctest/discovery_spec.spl`
...
1. Run `test/02_integration/doctest/discovery_spec.spl`
...
- `test/02_integration/doctest/discovery_spec.spl` (158 lines)
