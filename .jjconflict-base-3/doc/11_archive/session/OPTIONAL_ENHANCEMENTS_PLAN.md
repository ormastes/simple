...
1. **`test/01_unit/app/cli/doc_coverage_command_spec.spl`** (~40 lines)
   - Test CLI argument parsing
   - Test exit codes
   - Test format options

2. **`test/01_unit/app/stats/public_api_stats_spec.spl`** (~30 lines)
   - Test stats computation
   - Test coverage % calculation

3. **`test/01_unit/app/doc_coverage/public_api_warnings_spec.spl`** (~30 lines)
   - Test warning generation
   - Test message formatting

4. **`test/01_unit/app/doc_coverage/public_api_thresholds_spec.spl`** (~30 lines)
   - Test threshold validation
   - Test config parsing

5. **`test/01_unit/app/doc_coverage/public_api_tagging_spec.spl`** (~30 lines)
   - Test tag generation
