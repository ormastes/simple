...
<!-- sdn-diagram:id=host_compositor_entry_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=host_compositor_entry_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

host_compositor_entry_spec -> std
host_compositor_entry_spec -> common
host_compositor_entry_spec -> os
```
...
```ascii generated-from=host_compositor_entry_spec.arch hash=sha256:auto
...
- comp apply bridge request
- comp = host compositor pointer move
- comp = host compositor left button
...
- comp apply bridge request
- comp handle mouse move
- comp handle left button
   - Expected: comp.resizing is true
- comp handle mouse move
   - Expected: comp.windows[0].w equals `242`
   - Expected: comp.windows[0].h equals `192`
...
- adapter deliver bridge request
- adapter deliver pointer move
- adapter deliver left button
- adapter deliver pointer move
- adapter deliver left button
- adapter render framebuffer frame
