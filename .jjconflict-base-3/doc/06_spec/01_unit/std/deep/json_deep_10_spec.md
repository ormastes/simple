...
<!-- sdn-diagram:id=json_deep_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=json_deep_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

json_deep_10_spec -> std
```
...
```ascii generated-from=json_deep_10_spec.arch hash=sha256:auto
