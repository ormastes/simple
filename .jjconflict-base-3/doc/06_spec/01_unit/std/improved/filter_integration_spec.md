...
<!-- sdn-diagram:id=filter_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=filter_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

filter_integration_spec -> std
```
...
```ascii generated-from=filter_integration_spec.arch hash=sha256:auto
