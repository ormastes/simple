...
**File:** `simple/std_lib/test/01_unit/ml/torch/simple_math_spec.spl`
**Size:** ~170 lines
...
**File:** `simple/std_lib/test/01_unit/ml/torch/linalg_spec.spl`
**Size:** ~200 lines
...
**File:** `simple/std_lib/test/01_unit/ml/torch/fft_spec.spl`
**Size:** ~215 lines
...
**File:** `simple/std_lib/test/02_integration/ml/simple_math_integration_spec.spl`
**Size:** ~230 lines
...
### Test Organization
- ✅ Unit tests in `simple/std_lib/test/01_unit/ml/torch/`
- ✅ Integration tests in `simple/std_lib/test/02_integration/ml/`
...
### Test Files (4)
1. `simple/std_lib/test/01_unit/ml/torch/simple_math_spec.spl` - Math methods
2. `simple/std_lib/test/01_unit/ml/torch/linalg_spec.spl` - Linear algebra
3. `simple/std_lib/test/01_unit/ml/torch/fft_spec.spl` - FFT operations
4. `simple/std_lib/test/02_integration/ml/simple_math_integration_spec.spl` - Integration
...
### Documentation
1. Update `doc/06_spec/simple_math.md` with complete specification
