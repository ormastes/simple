...
**File:** `test/03_system/features/operators/matrix_multiplication_spec.spl`
...
1. **test/03_system/features/operators/matrix_multiplication_spec.spl** (37 tests)
   - Comprehensive test suite for @ operator

2. **doc/09_report/matmul_operator_complete_2026-01-30.md** (this file)
...
2. **doc/07_guide/quick_reference/syntax_quick_reference.md**
