//! File I/O SFFI functions for Simple runtime.
//!
...
pub use file_ops::{
    ...
    rt_file_append_text, rt_file_read_bytes, rt_file_write_bytes, rt_file_move, rt_file_lock, rt_file_unlock,
    rt_file_mmap_read_text, rt_file_mmap_len, rt_file_mmap_read_text_rv, rt_file_mmap_read_bytes,
    rt_file_mmap_read_bytes_rv, rt_file_read_text_at, rt_file_write_text_at, rt_file_write_text_at_cached,
    rt_file_write_text_at_cached_repeat, rt_mmap, rt_munmap, rt_madvise, rt_msync, rt_getpid, rt_bytes_from_raw,
