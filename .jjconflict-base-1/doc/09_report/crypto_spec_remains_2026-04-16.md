...
|------|-----:|-----:|-------|
| `test/03_system/os_crypto_spec.spl` | 1 | 0 | ✓ no regression |
| `test/01_unit/os/apps/sshd/ssh_kex_hostkey_matrix_spec.spl` | 22 | 0 | ✓ all 4 host-key algos pass |
| `test/03_system/os_crypto_ref_primitives_spec.spl` | 26 | **1** | poly1305 RFC 7539 §2.5.2 byte[0] |
| `test/03_system/os_crypto_ref_signature_spec.spl` | 22 | **17** | Simple interp Option<[u8]> wrapping |
...
**Failing test:** `test/03_system/os_crypto_ref_primitives_spec.spl:227` "Poly1305 RFC 7539 §2.5.2: MAC byte[0] == 0xa8"
...
Once fixed, `test/03_system/os_crypto_ref_primitives_spec.spl` should report 27/27 passing.
...
**Failing tests:** 17 of 39 in `test/03_system/os_crypto_ref_signature_spec.spl`
...
Once fixed, `test/03_system/os_crypto_ref_signature_spec.spl` should report 39/39 passing.
