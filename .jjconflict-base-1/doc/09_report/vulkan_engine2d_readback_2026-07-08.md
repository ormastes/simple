...
-   --> /tmp/simple-vulkan-sync/src/lib/common/string_core.spl:89:44
-    |
...
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/time_ops.spl:7:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/gpu/engine2d/sffi_vulkan.spl:3:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/vulkan_sffi.spl:3:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/platform.spl:3:1
-    |
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /tmp/simple-vulkan-sync/src/lib/nogc_sync_mut/path.spl:142:31
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/gpu/engine2d/sffi_opencl.spl:3:1
-    |
...
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/gpu/engine2d/backend_metal_runtime_ops.spl:1:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/env/platform.spl:3:1
-    |
...
- 
- [33mwarning[0m: Deprecated syntax for type parameters
-   --> /tmp/simple-vulkan-sync/src/lib/nogc_async_mut/path.spl:142:31
-    |
- 142 |         if c < bp.len() and pp[c] == bp[c]:
-    |                               ^
- 
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/metal_sffi.spl:3:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/gpu/engine2d/sffi_rocm.spl:3:1
-    |
...
- 
- [33mwarning[0m: '#[runtime_intrinsics]' uses deprecated syntax, use '@runtime_intrinsics' instead
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/gpu/engine2d/backend_rocm_runtime_ops.spl:1:1
-    |
-   1 | #[runtime_intrinsics]
-    | ^
- 
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/oneapi_ffi.spl:3:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/oneapi_sffi.spl:3:1
-    |
...
- 
- [33mwarning[0m: '#[runtime_intrinsics]' uses deprecated syntax, use '@runtime_intrinsics' instead
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/gpu/engine2d/host_ops.spl:1:1
-    |
-   1 | #[runtime_intrinsics]
-    | ^
- 
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/env_ops.spl:7:1
-    |
...
- 
- [33mwarning[0m: Avoid 'export use *' - exposes unnecessary interfaces
-   --> /tmp/simple-vulkan-sync/src/lib/gc_async_mut/io/process_ops.spl:7:1
-    |
