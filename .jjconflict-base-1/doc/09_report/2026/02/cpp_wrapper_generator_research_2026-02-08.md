...
- ✅ **Three-tier SFFI pattern** (external libraries): `doc/05_design/sffi_external_library_pattern.md`
...
1. **Approve design document** - Review and approve `doc/05_design/cpp_wrapper_generator_design.md`
...
1. **`doc/05_design/cpp_wrapper_generator_design.md`** (350+ lines)
...
2. **`doc/09_report/cpp_wrapper_generator_research_2026-02-08.md`** (this file)
   - Research findings
   - Tool comparisons
   - Benefits analysis
   - Recommendations
