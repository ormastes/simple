...
| File | Tests | Status |
|------|-------|--------|
| test/03_system/dl_examples_system_spec.spl | 55 | 100% passing |
...
```bash
bin/simple test/03_system/dl_examples_system_spec.spl  # 55 tests, all passing
```
...
**test/03_system/dl_examples_system_spec.spl** (304 lines, 55 tests):
...
bin/simple test/03_system/dl_examples_system_spec.spl
```
...
- `test/03_system/dl_examples_system_spec.spl` - 55 tests (304 lines)
