...
**Location:** `test/01_unit/std/thread_sffi_spec.spl` (145 tests)
...
**Location:** `test/02_integration/thread_pool_spec.spl` (45 tests)
...
2. **Run Thread Tests**
   ...
   bin/simple test test/02_integration/thread_pool_spec.spl
   ```
