...
### 1. `test/03_system/feature/language/placeholder_lambda_spec.spl`
...
### 2. `test/01_unit/lib/std/type_checker/type_inference_v2_spec.spl`
...
2. **Pattern Guide:** `doc/07_guide/quick_reference/import_quick_reference.md`
3. **Full Analysis:** `doc/09_report/import_errors_analysis_2026-02-07.md`
...
bin/simple_runtime test \
  test/03_system/feature/language/placeholder_lambda_spec.spl \
...
- **Pattern Reference:** `doc/07_guide/quick_reference/import_quick_reference.md`
- **Complete Analysis:** `doc/09_report/import_errors_analysis_2026-02-07.md`
