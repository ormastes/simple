...
3. **`doc/07_guide/signal_handler_sffi_spec.md`** (300 lines)
...
See `doc/07_guide/signal_handler_sffi_spec.md` for complete implementation guide.
...
bin/simple test --parallel test/01_unit/

# Output:
# Running 150 test file(s) [mode: interpreter, parallel: 7 workers]...
# Signal handlers not available - using resource monitoring
#
# PASS test/01_unit/std/array_spec.spl (12 passed, 8ms)
# PASS test/01_unit/std/string_spec.spl (15 passed, 6ms)
# ...
# =========================================
...
**Fix:** Implement SFFI in `src/compiler_seed/runtime.c` per spec in `doc/07_guide/signal_handler_sffi_spec.md`
...
2. **Run Long-Running Tests**
   ...
   bin/simple test --parallel --self-protect test/01_unit/
   ```
