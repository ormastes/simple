...
- Fixed broken links in `.claude/skills/todo.md`
  ...
  - `doc/status/` → `doc/02_requirements/feature/`
...
**Design Document:** `doc/05_design/markdown_todo_skip_design.md`
...
- `doc/05_design/IMPLEMENTATION_SUMMARY.md`
- `doc/05_design/TODO_CONTRIBUTING_UPDATE.md`
- `doc/05_design/TODO_QUICKSTART.md`
- `doc/05_design/TODO_SYSTEM_COMPLETE.md`
- `doc/05_design/dual_language_parsing_summary.md`
- `doc/05_design/dual_language_todo_parsing.md`
- `doc/05_design/markdown_todo_skip_design.md`
...
| `doc/05_design/*.md` (8 files) | Doc | Added skip_todo markers |
