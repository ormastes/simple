# System Test Plan — simple_db_nvfs_constants
...
- AC2/AC3: Simple DB modules no longer redeclare the ordinals.
- AC4/AC5: existing Simple DB unit and storage integration tests remain green.
