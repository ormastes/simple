...
- [ ] Create `doc/04_architecture/parser_lexer_structure.md`
- [ ] Update `doc/04_architecture/file_tree.md` (if exists)
- [ ] Update `doc/07_guide/compiler_architecture.md` (if exists)
...
**Related Documents:**
- `doc/09_report/compiler_components_found_2026-02-04.md` - Compiler component inventory
- `doc/09_report/runtime_minimal_2026-02-04.md` - Runtime architecture analysis
