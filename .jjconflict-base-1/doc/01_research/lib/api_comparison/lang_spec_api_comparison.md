...
| Unit tests | ❌ Skipped | `simple/std_lib/test/01_unit/compiler_core/regex_spec.spl` (all 21 tests skipped) |
...
| Regex tests (skipped) | `simple/std_lib/test/01_unit/compiler_core/regex_spec.spl` |
