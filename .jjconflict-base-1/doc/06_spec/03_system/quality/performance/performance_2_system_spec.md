...
<!-- sdn-diagram:id=performance_2_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=performance_2_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

performance_2_system_spec -> std
```
...
```ascii generated-from=performance_2_system_spec.arch hash=sha256:auto
