...
<!-- sdn-diagram:id=stress_24_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stress_24_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stress_24_system_spec -> std
```
...
```ascii generated-from=stress_24_system_spec.arch hash=sha256:auto
