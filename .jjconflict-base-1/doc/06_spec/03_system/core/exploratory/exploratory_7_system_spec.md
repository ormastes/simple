...
<!-- sdn-diagram:id=exploratory_7_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=exploratory_7_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

exploratory_7_system_spec -> std
```
...
```ascii generated-from=exploratory_7_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/core/exploratory/exploratory_7_system_spec.spl` |
| Updated | 2026-06-01 |
