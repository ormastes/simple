...
<!-- sdn-diagram:id=x25519_wrapper_probe_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=x25519_wrapper_probe_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

x25519_wrapper_probe_spec -> std
```
...
```ascii generated-from=x25519_wrapper_probe_spec.arch hash=sha256:auto
