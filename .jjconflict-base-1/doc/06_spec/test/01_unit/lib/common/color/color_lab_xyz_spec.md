...
<!-- sdn-diagram:id=color_lab_xyz_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=color_lab_xyz_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

color_lab_xyz_spec -> std
```
...
```ascii generated-from=color_lab_xyz_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/lib/common/color/color_lab_xyz_spec.spl` |
| Updated | 2026-06-01 |
