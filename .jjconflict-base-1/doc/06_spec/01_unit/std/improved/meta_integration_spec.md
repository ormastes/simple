...
<!-- sdn-diagram:id=meta_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=meta_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

meta_integration_spec -> std
```
...
```ascii generated-from=meta_integration_spec.arch hash=sha256:auto
