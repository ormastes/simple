...
<!-- sdn-diagram:id=validate_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=validate_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

validate_edge_spec -> std
```
...
```ascii generated-from=validate_edge_spec.arch hash=sha256:auto
