...
<!-- sdn-diagram:id=process_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=process_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

process_integration_spec -> std
```
...
```ascii generated-from=process_integration_spec.arch hash=sha256:auto
