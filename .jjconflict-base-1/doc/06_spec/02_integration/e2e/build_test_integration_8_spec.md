...
<!-- sdn-diagram:id=build_test_integration_8_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=build_test_integration_8_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

build_test_integration_8_spec -> std
```
...
```ascii generated-from=build_test_integration_8_spec.arch hash=sha256:auto
