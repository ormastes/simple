...
<!-- sdn-diagram:id=qemu_rv64_semihost_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=qemu_rv64_semihost_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

qemu_rv64_semihost_spec
```
...
```ascii generated-from=qemu_rv64_semihost_spec.arch hash=sha256:auto
...
| Category | Other |
| Status | Active |
| Source | `test/02_integration/remote_jit/qemu_rv64_semihost_spec.spl` |
| Updated | 2026-06-01 |
