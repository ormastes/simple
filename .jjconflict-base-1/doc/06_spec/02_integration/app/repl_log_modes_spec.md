# Repl Log Modes Specification

> <details>

<!-- sdn-diagram:id=repl_log_modes_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=repl_log_modes_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

repl_log_modes_spec -> std
```
...
```ascii generated-from=repl_log_modes_spec.arch hash=sha256:auto
