...
- ✅ Created `test/02_integration/doctest/discovery_spec.spl`
...
- ⏳ Run `test/02_integration/doctest/discovery_spec.spl`
...
- **Tests:** `test/02_integration/doctest/discovery_spec.spl`
