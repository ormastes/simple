...
<!-- sdn-diagram:id=buffer_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=buffer_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

buffer_unit_spec -> std
```
...
```ascii generated-from=buffer_unit_spec.arch hash=sha256:auto
