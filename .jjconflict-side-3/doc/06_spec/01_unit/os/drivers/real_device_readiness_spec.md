...
expect(real_device_physical_nvme_validation_script()).to_equal("scripts/os/run_simpleos_physical_nvme_perf.shs")
expect(real_device_physical_nvme_validation_command("build/serial/physical-nvme.log")).to_equal([
    "sh",
    "scripts/os/run_simpleos_physical_nvme_perf.shs",
    "--serial-log", "build/serial/physical-nvme.log",
    "--validate-log-only"
])
