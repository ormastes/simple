...
<!-- sdn-diagram:id=stm32h7_jit_e2e_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stm32h7_jit_e2e_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stm32h7_jit_e2e_spec -> std
```
...
```ascii generated-from=stm32h7_jit_e2e_spec.arch hash=sha256:auto
...
1. var adapter = Stm32H7Adapter new
