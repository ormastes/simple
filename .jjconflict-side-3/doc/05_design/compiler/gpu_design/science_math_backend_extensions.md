...
**Related:** `doc/03_plan/science_math_backend_extension_research_plan.md`, `doc/04_architecture/lib/science_math_lib_set.md`, `doc/05_design/science_math_lib_set.md`.
...
```text
SIMPLE_BLAS_BACKEND=mock bin/simple test test/03_system/feature/scilib/linalg_torch_backend_spec.spl --mode=interpreter --no-cache
g++ -std=c++17 -O2 -fPIC -shared src/runtime/torch_ffi.cpp -o build/scilib/libspl_torch.so ...
SIMPLE_SFFI_PATH=build/scilib SIMPLE_BLAS_BACKEND=mock bin/simple test test/03_system/feature/scilib/linalg_torch_backend_spec.spl --mode=interpreter --no-cache
```

Current CUDA probe gates:

```text
SIMPLE_BLAS_BACKEND=mock bin/simple test test/03_system/feature/scilib/cuda_device_buffer_spec.spl --mode=interpreter --no-cache
SIMPLE_SFFI_PATH=/tmp/simple-no-sffi SIMPLE_BLAS_BACKEND=mock bin/simple test test/03_system/feature/scilib/linalg_cuda_backend_spec.spl --mode=interpreter --no-cache
...
SIMPLE_SFFI_PATH=build/scilib SIMPLE_BLAS_BACKEND=mock bin/simple test test/03_system/feature/scilib/linalg_cuda_backend_spec.spl --mode=interpreter --no-cache
```
