...
2. `/test/03_system/collections/hashmap_basic_spec.spl` - 8 failures
3. `/test/03_system/collections/hashset_basic_spec.spl` - 7 failures
4. `/test/03_system/collections/btree_basic_spec.spl` - 7 failures
