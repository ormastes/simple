...
│
└── test/01_unit/parser/treesitter/
...
### Test Files
- `simple/std_lib/test/01_unit/parser/treesitter/cli_spec.spl` - CLI tests (50+ tests)

### Related Reports
- `doc/09_report/TREESITTER_PHASES_1-4_COMPLETE_2025-12-24.md` - Phases 1-4 completion
- `doc/09_report/TREESITTER_PHASE7_COMPLETE_2025-12-25.md` - Phase 7 (optimization)
- `doc/09_report/TREESITTER_PHASE8_COMPLETE_2025-12-25.md` - Phase 8 (multi-language)
- `doc/09_report/TREESITTER_CLI_2025-12-25.md` - **This document** (CLI tools)
