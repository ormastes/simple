...
**Specs:**
- `test/01_unit/browser_engine/script/dom_query_spec.spl` — 14 specs (AC-2)
- `test/01_unit/browser_engine/script/console_buffer_spec.spl` — 11 specs (AC-4)
- `test/01_unit/browser_engine/script/event_loop_spec.spl` — 5 specs (AC-3)
- `test/01_unit/browser_engine/script/script_host_spec.spl` — 9 specs (AC-1)
- `test/01_unit/browser_engine/js_integration_spec.spl` — 12 specs (AC-1, AC-2, AC-3, AC-4, AC-6)
