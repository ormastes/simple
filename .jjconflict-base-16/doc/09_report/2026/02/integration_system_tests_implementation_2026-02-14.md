...
|------------|------|-------|-------|--------|
| **Advanced Types Integration** | test/02_integration/advanced_types_spec.spl | 40 | 237 | ✅ Created |
| **SIMD Stdlib Integration** | test/02_integration/simd_stdlib_spec.spl | 30 | 201 | ✅ Created |
| **Baremetal Full Integration** | test/02_integration/baremetal_full_spec.spl | 40 | 311 | ✅ Created |
| **Thread Pool Async Integration** | test/02_integration/thread_pool_async_spec.spl | 20 | 164 | ✅ Created |
| **Compiler Full System** | test/03_system/compiler_full_spec.spl | 60 | 355 | ✅ Created |
...
**File:** `test/02_integration/advanced_types_spec.spl`
**Lines:** 237
...
**File:** `test/02_integration/simd_stdlib_spec.spl`
**Lines:** 201
...
**File:** `test/02_integration/baremetal_full_spec.spl`
**Lines:** 311
...
**File:** `test/02_integration/thread_pool_async_spec.spl`
**Lines:** 164
...
**File:** `test/03_system/compiler_full_spec.spl`
**Lines:** 355
...
bin/simple test test/02_integration/advanced_types_spec.spl
bin/simple test test/02_integration/simd_stdlib_spec.spl

# Run baremetal tests (requires QEMU)
bin/simple test --only-slow test/02_integration/baremetal_full_spec.spl

# Run thread pool tests
bin/simple test test/02_integration/thread_pool_async_spec.spl
```
...
bin/simple test test/03_system/compiler_full_spec.spl

# Run with benchmarks (slow tests)
bin/simple test --only-slow test/03_system/compiler_full_spec.spl
```
...
docker-compose run integration-tests \
  test test/02_integration/simd_stdlib_spec.spl
```
...
1. **Locate relevant test suite**
   - Advanced types → `test/02_integration/advanced_types_spec.spl`
   - SIMD → `test/02_integration/simd_stdlib_spec.spl`
   - Baremetal → `test/02_integration/baremetal_full_spec.spl`
   - Thread pool → `test/02_integration/thread_pool_async_spec.spl`
...
3. **Run tests and fix issues**
   ```bash
   bin/simple test test/02_integration/your_spec.spl
   ```
...
3. **Run performance benchmarks**
   ```bash
   bin/simple test --only-slow test/02_integration/
   bin/simple test --only-slow test/03_system/
   ```
