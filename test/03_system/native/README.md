...
| `stage4_preprocessor_empty_line_contract.spl` | Stage4 conditional-source empty-line reconstruction | — | **30** | SOURCE FIX / execution pending | empty text slots render as generated `nilnil` identifiers or source termination changes |
