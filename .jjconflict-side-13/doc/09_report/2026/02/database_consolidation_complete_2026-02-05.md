...
var fdb = if fdb_opt.?: fdb_opt? else: create_feature_database("doc/02_requirements/feature/feature_db.sdn")
...
- Documentation generation:
  ...
  - Feature index (`doc/02_requirements/feature/feature.md`)
  - Pending features (`doc/02_requirements/feature/pending_feature.md`)
  - Per-category docs (`doc/02_requirements/feature/category/*.md`)
...
ls -lh doc/02_requirements/feature/feature_db.sdn    # Feature database
```
