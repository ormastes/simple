...
<!-- sdn-diagram:id=profile_optimize_integration_3_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=profile_optimize_integration_3_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

profile_optimize_integration_3_spec -> std
```
...
```ascii generated-from=profile_optimize_integration_3_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/02_integration/e2e/profile_optimize_integration_3_spec.spl` |
| Updated | 2026-06-01 |
