...
|-----------|-------|---------|
| `test/01_unit/` | 1,318 | Unit tests |
| `test/03_system/feature/` | 326 | Feature tests |
| `test/02_integration/` | 47 | Integration tests |
| `test/03_system/` | 10 | System tests (including LLM live tests) |
| `test/05_perf/` | 7 | Performance benchmarks |
| `test/03_system/feature/language/fuzz/` | 3 | Fuzz tests |
...
2. **Start String Consolidation Test Suite** (2 days)
   - Create `test/01_unit/std/string_comprehensive_spec.spl`
