...
4. **Validate shapes** -- Use tensor dimension inference (see `doc/07_guide/deep_learning/tensor_dimensions.md`)
...
- Tensor dimensions: `doc/07_guide/deep_learning/tensor_dimensions.md`
- GPU programming: `doc/07_guide/backend/gpu_programming.md`
- SFFI (for PyTorch FFI): `doc/07_guide/ffi/sffi.md`
