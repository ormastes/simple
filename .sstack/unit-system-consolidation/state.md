...
- **Moved** `.sstack/unit-system-consolidation/gen_units.shs` → `scripts/gen_units.shs` and updated its internal `# Usage:` line. Per task directive: one-shot generators don't live in `.sstack/`. Also noted the relocation inline in the 5-implement "Generator:" bullet above.
...
- `.sstack/unit-system-consolidation/state.md` (this report).
