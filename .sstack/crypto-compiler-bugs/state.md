State file: .sstack/crypto-compiler-bugs/state.md
...
`test/unit/compiler/codegen/match_switch_codegen_spec.spl` ran 7/7 in BOTH
...
`test/unit/compiler/r2_pending_helper_spec.spl` (interpreter-mode only).
...
Spec: test/unit/lib/bitwise_byte_helpers_spec.spl (8 tests):
...
Spec: test/unit/lib/crypto/black_box_spec.spl (5 tests):
...
Spec: test/unit/compiler/codegen/match_switch_codegen_spec.spl (7 tests):
...
Added `extern fn rt_bytes_alloc(len: u64) -> [u8]` to interpreter:
  - src/compiler_rust/compiler/src/interpreter_extern/file_io.rs (impl)
  - src/compiler_rust/compiler/src/interpreter_extern/mod.rs (dispatch)
Perf test: test/perf/bytes_push_1mib.spl
...
Verification (this session):
  - test/smoke/compile_smoke_spec.spl --mode=smf : PASSED (2 examples)
...
Regression test: test/unit/app/cli_wrapper_error_detail_spec.spl (4 cases, all pass)
...
- B1: 4/4 PASS (test/unit/app/cli_wrapper_error_detail_spec.spl)
- B4: 8/8 PASS (test/unit/lib/bitwise_byte_helpers_spec.spl — restored from git; was deleted during repo cleanup)
- B5: 7/7 PASS (test/unit/compiler/codegen/match_switch_codegen_spec.spl)
- B6: 5/5 PASS (test/unit/lib/crypto/black_box_spec.spl)
- B2: acceptance via test/perf/bytes_push_1mib.spl (verified 2026-04-25; no re-run needed — perf test)
