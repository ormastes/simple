...
**Related:**
- `doc/01_research/parser_duplication_analysis_2026-02-04.md` - Duplication analysis
- `doc/05_design/parser_architecture_unified_2026-02-04.md` - Architecture design
- `doc/03_plan/parser_merge_plan_2026-02-04.md` - Merge implementation plan
...
- **Duplication Analysis:** `doc/01_research/parser_duplication_analysis_2026-02-04.md`
- **Architecture Design:** `doc/05_design/parser_architecture_unified_2026-02-04.md`
- **Merge Plan:** `doc/03_plan/parser_merge_plan_2026-02-04.md`
- **File Tree:** `doc/04_architecture/file_tree.md` (if exists)
- **Compiler Architecture:** `doc/07_guide/compiler_architecture.md` (if exists)
