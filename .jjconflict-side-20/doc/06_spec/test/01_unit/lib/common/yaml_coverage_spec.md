...
<!-- sdn-diagram:id=yaml_coverage_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=yaml_coverage_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

yaml_coverage_spec -> lib
```
...
```ascii generated-from=yaml_coverage_spec.arch hash=sha256:auto
