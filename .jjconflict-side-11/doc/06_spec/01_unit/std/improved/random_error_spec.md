...
<!-- sdn-diagram:id=random_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=random_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

random_error_spec -> std
```
...
```ascii generated-from=random_error_spec.arch hash=sha256:auto
