...
<!-- sdn-diagram:id=backtrace_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=backtrace_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

backtrace_error_spec -> std
```
...
```ascii generated-from=backtrace_error_spec.arch hash=sha256:auto
