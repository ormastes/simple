...
Configuration files for build, test, packaging, and tooling.
...
| `sdoctest.sdn` | Documentation test configuration |
| `simple.intensive.sdn` | Intensive test configuration |
