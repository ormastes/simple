...
- `bin/simple test test/unit/os/drivers/driver_platform_contract_spec.spl --mode=interpreter`
- `bin/simple test test/unit/os/qemu_runner_spec.spl --mode=interpreter`
