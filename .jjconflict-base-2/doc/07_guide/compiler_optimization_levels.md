...
```bash
src/compiler_rust/target/release/simple compile test/perf/net_driver_logic_native_bench.spl \
...
The parity wrapper `test/perf/run_net_driver_logic_parity_bench.shs` covers
