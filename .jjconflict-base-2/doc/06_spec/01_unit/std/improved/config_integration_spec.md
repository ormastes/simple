...
<!-- sdn-diagram:id=config_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=config_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

config_integration_spec -> std
```
...
```ascii generated-from=config_integration_spec.arch hash=sha256:auto
