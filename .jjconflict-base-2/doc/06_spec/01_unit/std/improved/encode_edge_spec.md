...
<!-- sdn-diagram:id=encode_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=encode_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

encode_edge_spec -> std
```
...
```ascii generated-from=encode_edge_spec.arch hash=sha256:auto
