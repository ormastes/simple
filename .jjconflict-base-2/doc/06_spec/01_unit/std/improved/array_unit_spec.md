...
<!-- sdn-diagram:id=array_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=array_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=array_unit_spec.arch hash=sha256:auto
