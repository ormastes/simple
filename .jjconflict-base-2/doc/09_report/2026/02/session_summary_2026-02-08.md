...
**Target:** test/02_integration/cli_dispatch_spec.spl (18 failing tests)
...
- `test/02_integration/cli_dispatch_spec.spl` (import fix)
...
7. ✅ `test/02_integration/cli_dispatch_spec.spl`
