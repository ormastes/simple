...
- **Contract document**: `doc/04_architecture/infra/misc/lean_verification_contract.md` (created in Phase 0, referenced throughout)
...
| File | Purpose |
|------|---------|
| `test/03_system/compiler/lean_verify_cli_spec.spl` | CLI integration tests for verify/gen-lean commands |
| `test/03_system/compiler/lean_verification_workflow_spec.spl` | E2E workflow tests |
| `test/03_system/compiler/lean_auto_gen_spec.spl` | Auto-generation tests |
| `test/00_formal_verification/compiler/lean_basic_spec.spl` | Basic Lean generation tests |
| `test/00_formal_verification/compiler/lean_codegen_spec.spl` | Codegen pipeline tests |
| `test/00_formal_verification/compiler/lean_workflow_spec.spl` | Workflow unit tests (results, obligations, regeneration) |
| `test/00_formal_verification/compiler/lean_block_integration_spec.spl` | lean{} block integration tests |
| `test/00_formal_verification/compiler/verification_diagnostics_spec.spl` | Diagnostics tests |

### Documentation

| File | Purpose |
|------|---------|
| `doc/04_architecture/infra/misc/lean_verification_contract.md` | Authoritative contract (feature matrix, state model, commands) |
...
simple test test/03_system/compiler/lean_verify_cli_spec.spl

# Run lean{} block integration tests
simple test test/00_formal_verification/compiler/lean_block_integration_spec.spl

# Run workflow unit tests
simple test test/00_formal_verification/compiler/lean_workflow_spec.spl

# Run basic and codegen tests
simple test test/00_formal_verification/compiler/lean_basic_spec.spl
simple test test/00_formal_verification/compiler/lean_codegen_spec.spl
