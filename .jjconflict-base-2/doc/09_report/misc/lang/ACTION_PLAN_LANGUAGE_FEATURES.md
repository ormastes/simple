...
- **Tests:** `test/01_unit/parser/multiline_bool_spec.spl` - 18 tests
...
- **Tests:** `test/01_unit/compiler/closure_capture_warning_spec.spl` - 22 tests
- **Status:** PRODUCTION READY
- **API:**
  ```simple
...
- **Tests:** `test/01_unit/compiler_core/ignored_return_warning_spec.spl` - 18 tests
- **Status:** PRODUCTION READY
- **API:**
  ```simple
...
- **Tests:** `test/01_unit/runtime/module_closure_spec.spl` - 10 tests
...
- **Tests:** `test/01_unit/compiler_core/generic_syntax_spec.spl` - 30 tests
...
- `doc/07_guide/warnings.md` - All warning types with examples
- `doc/07_guide/quick_reference/syntax_quick_reference.md` - Add warning section
...
### Tests
- `test/01_unit/compiler/closure_capture_warning_spec.spl`
- `test/01_unit/compiler_core/ignored_return_warning_spec.spl`
- `test/01_unit/runtime/module_closure_spec.spl`
- `test/01_unit/compiler_core/generic_syntax_spec.spl`
- `test/01_unit/parser/multiline_bool_spec.spl`
