...
5. Run tests: `bin/simple test test/03_system/feature/llvm_backend*`
...
4. Run full test suite:
   - Unit tests: `test/01_unit/compiler/backend/llvm_*`
   - Feature tests: `test/03_system/feature/llvm_backend_*`
   - Integration tests: `test/02_integration/llvm_backend_e2e_spec.spl`
...
bin/simple test test/01_unit/compiler/backend/llvm_*

# 2. Feature tests for all architectures
bin/simple test test/03_system/feature/llvm_backend_*

# 3. Integration test
bin/simple test test/02_integration/llvm_backend_e2e_spec.spl
...
Create new tests:
1. **test/03_system/shared_llvm_backend_spec.spl**
...
2. **test/03_system/backend_parity_spec.spl**
