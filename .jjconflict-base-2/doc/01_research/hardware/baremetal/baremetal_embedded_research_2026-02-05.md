...
**Grammar Definition** (`doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_definitions.md`):
```javascript
...
**Proposed Syntax** (`doc/05_design/type_system_features.md`):
```simple
...
Simple already has a layout configuration format (`doc/06_spec/layout.sdn`):
...
2. `doc/05_design/type_system_features.md` - Bitfield design
3. `doc/05_design/embedded_immutable_defaults.md` - Embedded target configuration
4. `doc/06_spec/layout.sdn` - Layout configuration format
