...
of `FixedVec<T, N>` type aliases. This document supersedes `doc/04_architecture/language/portable_simd_fp_modules.md`
...
- Existing architecture: `doc/04_architecture/language/portable_simd_fp_modules.md` — superseded by this doc
- GPU acceleration: `doc/04_architecture/ml/gpu_acceleration_plan.md`
- B2 strict-emit op tables: `doc/04_architecture/compiler/simd/simd_backend_strict_emit.md`
