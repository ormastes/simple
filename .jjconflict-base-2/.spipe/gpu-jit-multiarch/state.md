...
- `test/unit/jit/jit_opt_x86_mixed.spl` — verification test
...
- `test/unit/gpu/render_2d_x86_cuda_vulkan.spl` — 4-combo verification
...
- `test/unit/gpu/render_2d_riscv_cuda.spl` — verification
