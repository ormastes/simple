...
| `test/02_integration/app/scv_pack_import_spec.spl` | Import + private-sync tests |
| `test/02_integration/app/scv_pack_verify_safety_spec.spl` | Verify safety rejection tests |
