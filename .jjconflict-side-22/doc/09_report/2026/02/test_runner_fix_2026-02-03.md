...
```
Running: test/01_unit/spec/expect_spec.spl
...
...
- ✅ `test/01_unit/spec/expect_spec.spl` (21/21 passing)
...
**Documentation:**
- `doc/09_report/test_fixes_2026-02-03.md`
- `doc/09_report/test_runner_fix_2026-02-03.md` (this file)
