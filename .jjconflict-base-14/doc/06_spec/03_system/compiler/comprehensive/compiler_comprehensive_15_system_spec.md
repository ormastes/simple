...
<!-- sdn-diagram:id=compiler_comprehensive_15_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compiler_comprehensive_15_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compiler_comprehensive_15_system_spec -> std
```
...
```ascii generated-from=compiler_comprehensive_15_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/compiler/comprehensive/compiler_comprehensive_15_system_spec.spl` |
| Updated | 2026-06-01 |
