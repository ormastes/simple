...
- implementation: The fastest-comparator evidence audit now exists at
  ...
  `build/perf/gpu_web_db_offload/fastest-comparator-coverage.tsv` through
  `--write-coverage-tsv`, persists
  `build/perf/gpu_web_db_offload/fastest-comparator-coverage.md` through
  `--write-coverage-md`, persists
...
- implementation: The reference-comparator handoff now exists at
  ...
  `build/perf/gpu_web_db_offload/external-fixtures.env` target. The external
  suite handoff map now advertises both guarded transfer paths.
