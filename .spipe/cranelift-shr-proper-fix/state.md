...
`test/unit/compiler/shr_signedness_test.spl` (147 lines) covers signed/unsigned local
...
4. **`test/unit/compiler/shr_signedness_param_callret_spec.spl`** — New test file covering
