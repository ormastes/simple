...
### Spec Files
- `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` — 14 specs covering AC-1
- `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` — 11 specs covering AC-3
- `test/01_unit/doc/feature_requests_spec.spl` — 4 specs covering AC-4

### AC Coverage Matrix
| AC | Spec File | it block | Status |
|----|-----------|----------|--------|
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: returns elapsed microseconds greater than zero for RamFS open" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: returns elapsed microseconds within reasonable range for RamFS open" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: returns elapsed microseconds greater than zero for RamFS stat" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: returns elapsed microseconds greater than zero for RamFS close" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: returns elapsed microseconds greater than zero for FAT32 parse" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: returns elapsed microseconds greater than zero for FAT32 fat_search_long" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: creates a suite with a non-empty name" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: new suite has zero recorded timings" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: adds a timing entry and increments count" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` | "AC-1: recorded timing value matches inserted value" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: alloc_zeroed_bytes(64) returns array of length 64" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: alloc_zeroed_bytes(64) first element is zero" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: alloc_zeroed_bytes(0) returns empty array" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: text_to_bytes_pure(\"ABC\") first byte is 65 (A)" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: text_to_bytes_pure(\"ABC\") second byte is 66 (B)" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: text_to_bytes_pure(\"ABC\") third byte is 67 (C)" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` | "AC-3: text_to_bytes_pure(\"\") returns empty array" | Failing (no impl) |
| AC-4 | `test/01_unit/doc/feature_requests_spec.spl` | "AC-4: TODO.md contains FR-INTERP-001 (me fn mutation loss)" | Failing (no impl) |
| AC-4 | `test/01_unit/doc/feature_requests_spec.spl` | "AC-4: TODO.md contains FR-INTERP-002 (deeply nested assignment)" | Failing (no impl) |
...
- `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` (MODIFIED — added use import)
- `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` (MODIFIED — added use import)
...
- `test/01_unit/lib/fs_driver/nvfs_pure_simple_spec.spl` — 11/11 passed (AC-3)
- `test/01_unit/lib/fs_driver/fs_profile_harness_spec.spl` — 14/14 passed (AC-1)
- `test/01_unit/lib/fs_driver/fs_hardening_spec.spl` — 15/15 passed (regression)
