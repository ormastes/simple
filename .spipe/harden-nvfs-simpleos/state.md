...
- New/updated specs under `test/01_unit/os/services/vfs/`
...
- [x] AC-6: **Regression-safe.** Existing `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` and `test/03_system/spostgre_nvfs_constants_spec.spl` still pass under `bin/simple test <spec>`; new specs covering AC-1..AC-5 are added and pass.
...
- `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl`
...
**Existing spec (do NOT duplicate in Phase 4):** `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` has 2 cases:
...
- `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` — extend with the 12 cases above; keep the 2 existing cases (adjusted for Result return shape).
...
**File touched:** `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` (157 LOC)
...
**Import audit:** only `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` imports any connector fn. No live production caller exists in `src/` (Phase 2 finding confirmed post-change). Change blast radius is limited to the spec file.

**Target spec (AC-1..AC-5 new + 2 existing):**
`test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` — **14/14 pass** (31ms)
...
- `test/01_unit/os/services/vfs/vfs_chmod_symlink_spec.spl` — pass
- `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` — pass
- `test/01_unit/os/services/fat32/fat32_spec.spl` — pass (adjacent fs driver)
...
**Spec file (already landed via wip-snapshot `a72242e4f8`):** `test/01_unit/os/services/vfs/vfs_nvfs_connector_spec.spl` (217 LOC).
