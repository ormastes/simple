...
**Tasks**:
1. Create `test/01_unit/jit/jit_x86_32_correctness.spl` — arithmetic + pointer ops
...
**Tasks**:
1. Create `test/01_unit/jit/jit_rv32_correctness.spl`
...
**Tasks**:
1. Create `test/01_unit/jit/jit_rv64_correctness.spl` (or verify existing)
...
**Tasks**:
1. Create `test/01_unit/jit/jit_arm32_correctness.spl`
...
- **V-***: `test/01_unit/jit/` (new files only)
