...
- verification: `SIMPLE_LIB=src bin/simple check src/lib/gc_async_mut/gpu/browser_engine/browser_script_execute.spl src/lib/gc_async_mut/gpu/browser_engine/browser_script_render.spl test/unit/browser_engine/script/browser_script_execute_spec.spl` passes; `SIMPLE_LIB=src bin/simple test test/unit/browser_engine/script/browser_script_execute_spec.spl --mode=interpreter --clean` passes with 3 scenarios; regenerated `doc/06_spec/unit/browser_engine/script/browser_script_execute_spec.md`.
