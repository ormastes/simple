...
- AC-6 needs a focused fallback/unavailable-backend evidence command in the tracked report, beyond the GTK unavailable handling already present in the script.
