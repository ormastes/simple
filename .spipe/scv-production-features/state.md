...
- `test/integration/app/scv_wasm_executor_spec.spl` — 6 it-blocks (AC-1)
- `test/integration/app/scv_parser_rebuild_spec.spl` — 5 it-blocks (AC-2)
- `test/integration/app/scv_structural_match_spec.spl` — 8 it-blocks (AC-3)
- `test/integration/app/scv_git_full_interop_spec.spl` — 21 it-blocks (AC-4)
- `test/integration/app/scv_network_remote_spec.spl` — 17 it-blocks (AC-5)
- `test/integration/app/scv_delta_pack_spec.spl` — 8 it-blocks (AC-6)
