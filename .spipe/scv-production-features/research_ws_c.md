...
- `test/02_integration/app/scv_git_interop_spec.spl` — integration tests for import
- `test/02_integration/app/scv_fast_import_safety_spec.spl` — rejection/safety tests
