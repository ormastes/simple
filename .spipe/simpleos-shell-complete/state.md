...
- [x] AC-8: Tests in `test/03_system/os_shell_spec.spl` and `test/01_unit/os/apps/sshd/` extended; new script-engine spec at `test/01_unit/os/shell/shell_script_spec.spl`
...
**New files:**
- `test/01_unit/os/shell/shell_script_spec.spl` — 7 describe groups, 32 `it` blocks covering
...
- `test/01_unit/os/shell/shell_starship_spec.spl` — 6 describe groups, 16 `it` blocks covering
...
- `test/01_unit/os/shell/awk_spec.spl` — 7 describe groups, 22 `it` blocks covering tool_awk:
...
**Extended file:**
- `test/03_system/os_shell_spec.spl` — added Tests 24-29:
...
- AC-8 PASS: 3 unit spec files in `test/01_unit/os/shell/` (42 + 35 + 29 = 106 `it` blocks); system tests 24-29 added to `test/03_system/os_shell_spec.spl`.
...
- **REQ-8** (from AC-8): Add tests for scripting engine (`test/01_unit/os/shell/shell_script_spec.spl`), extend shell tests in `test/03_system/os_shell_spec.spl` — area: `test/` directory structure
