...
- AC-7: `to_contiguous` materializes strided I64 and Bool views into dense row-major arrays.
...
## Log
- dev: Added focused metadata assertions to `test/03_system/feature/scilib/ndarray_slice_spec.spl`.
...
- dev: Implemented I64 and Bool materialization in `ndarray_to_contiguous` and covered both with strided view tests.
