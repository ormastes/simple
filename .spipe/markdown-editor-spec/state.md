...
| File | Tests |
|---|---|
| `test/03_system/editor_markdown_spec.spl` | 84 |
| `test/03_system/editor_markdown_document_decor_spec.spl` | 6 |
| `test/03_system/editor_markdown_office_layout_spec.spl` | 17 |
...
- To run the actual markdown editor tests: `bin/simple test test/03_system/editor_markdown_spec.spl`
