...
### Spec Files
- `test/03_system/stage3_segfault_fix_spec.spl` — 15 specs covering AC-1 through AC-6

### AC Coverage Matrix
| AC | Spec File | it block | Status |
|----|-----------|----------|--------|
| AC-1 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: tools.rs exists for strip_llvm_constructors changes" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: tools.rs contains StripError enum definition" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: StripError has ObjcopyNotFound variant" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: StripError has ObjcopyFailed variant" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: StripError has VerificationFailed variant" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: strip_llvm_constructors returns Result" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: config.rs no longer uses unwrap_or for strip results" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: config.rs contains LIM-010 in warning messages" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: verify_stripped_archive function exists in tools.rs" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: find_objdump_tool function exists in tools.rs" | Failing (no impl) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: verification checks for .init_array section" | Passing (already in code) |
| AC-2 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-2: verification checks for .ctors section" | Passing (already in code) |
...
| AC-6 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-6: compile_stage detects exit code 139" | Failing (no impl) |
| AC-6 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-6: SIGSEGV diagnostic references LIM-010" | Failing (no impl) |
| AC-6 | `test/03_system/stage3_segfault_fix_spec.spl` | "AC-6: diagnostic mentions SEGFAULT" | Failing (no impl) |
...
**Spec verification:** `test/03_system/stage3_segfault_fix_spec.spl` — all specs pass (exit 0).
