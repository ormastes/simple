...
- `test/01_unit/os/sosix/process_sharing_spec.spl` — 23 self-contained tests (originally stated 20)

### 7-verify (Wave 16 re-check — 2026-05-19)
Ran spec with `bin/release/linux-x86_64/simple test test/01_unit/os/sosix/process_sharing_spec.spl`:
