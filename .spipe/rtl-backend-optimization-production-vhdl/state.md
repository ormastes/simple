...
- Focused checks passed:
  - `bin/simple test test/unit/app/rtl/rtl_command_spec.spl`
  - `bin/simple test test/unit/hardware/qor/rtl_qor_spec.spl`
  - `bin/simple test test/unit/compiler/backend/vhdl_backend_spec.spl`
  - `bin/simple test test/system/compiler/vhdl_backend_cli_smoke_spec.spl`
  - `bin/simple check src/app/rtl src/os/drivers/nvme src/os/services/vfs/q35_pure_nvme_perf_boot.spl`
  - `bin/simple test test/system/os_desktop_integration_spec.spl`
  - `bin/simple test test/system/database/database_system_spec.spl`
