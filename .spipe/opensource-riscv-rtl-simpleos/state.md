...
### Spec Files
- `test/01_unit/lib/hardware/opensource_rtl/vexriscv_smp/vexriscv_smp_import_spec.spl` — 13 specs covering AC-1 (VexRiscv-SMP port map, filename resolution, import path)
- `test/01_unit/lib/hardware/fpga_k26/k26_axi_hp_bridge_spec.spl` — 10 specs covering AC-2 (AXI-HP bridge SV generation: ports, AXI signals, HP0 reference)
- `test/01_unit/lib/hardware/fpga_k26/k26_soc_top_vexriscv_spec.spl` — 8 specs covering AC-2 (SoC top wiring: VexRiscv + CLINT + PLIC + UART + AXI-HP)
- `test/01_unit/lib/hardware/fpga_linux/synthesis_wrapper_vexriscv_spec.spl` — 8 specs covering AC-3 (Vivado TCL: add_verilog_sources, enable_axi_hp_port, K26 part, synth)
- `test/01_unit/os/kernel/arch/riscv64/platform/board_memory_map_spec.spl` — 14 specs covering AC-5 (KriaFpgaMemoryMap + LitexFpgaMemoryMap constants: uart, ram, heap, clint, plic)
- `test/01_unit/os/kernel/arch/riscv64/platform/litex_fpga_spec.spl` — 5 specs covering AC-6 (LiteX platform capsule name, memory map composition)
- `test/01_unit/os/kernel/boot/riscv_noalloc_handoff_vexriscv_spec.spl` — 8 specs covering AC-6 (handoff layout from Kria and LiteX maps, heap/uart/ram fields)
- `test/01_unit/doc/de10nano_quartus_setup_spec.spl` — 11 specs covering AC-4 (guide content: version, device 5CSEBA6U23I7, LiteX build command, VexRiscv)
- `test/01_unit/doc/riscv_fpga_bug_tracking_spec.spl` — 8 specs covering AC-7 (bug ID prefix BUG-RISCV-FPGA, doc path convention, entry template)

### AC Coverage Matrix
| AC | Spec File | it block (representative) | Status |
|----|-----------|--------------------------|--------|
| AC-1 | `test/01_unit/lib/hardware/opensource_rtl/vexriscv_smp/vexriscv_smp_import_spec.spl` | "AC-1: filename contains Cc1 (1 core)" | Failing (no impl) |
| AC-1 | `test/01_unit/lib/hardware/opensource_rtl/vexriscv_smp/vexriscv_smp_import_spec.spl` | "AC-1: import path contains vexriscv_smp" | Failing (no impl) |
| AC-2 | `test/01_unit/lib/hardware/fpga_k26/k26_axi_hp_bridge_spec.spl` | "AC-2: generated SV contains AWADDR" | Failing (no impl) |
| AC-2 | `test/01_unit/lib/hardware/fpga_k26/k26_soc_top_vexriscv_spec.spl` | "AC-2: generated text references CLINT" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/hardware/fpga_linux/synthesis_wrapper_vexriscv_spec.spl` | "AC-3: TCL contains S_AXI_HP0 enable directive" | Failing (no impl) |
| AC-3 | `test/01_unit/lib/hardware/fpga_linux/synthesis_wrapper_vexriscv_spec.spl` | "AC-3: TCL contains VexRiscv filename" | Failing (no impl) |
| AC-4 | `test/01_unit/doc/de10nano_quartus_setup_spec.spl` | "AC-4: guide contains device string 5CSEBA6U23I7" | Failing (no impl) |
| AC-4 | `test/01_unit/doc/de10nano_quartus_setup_spec.spl` | "AC-4: litex_de10nano_build_command contains make.py" | Failing (no impl) |
| AC-5 | `test/01_unit/os/kernel/arch/riscv64/platform/board_memory_map_spec.spl` | "AC-5: uart_base returns 0x10000000" | Failing (no impl) |
| AC-5 | `test/01_unit/os/kernel/arch/riscv64/platform/board_memory_map_spec.spl` | "AC-5: LiteX uart_base returns 0xf0001000" | Failing (no impl) |
| AC-6 | `test/01_unit/os/kernel/arch/riscv64/platform/litex_fpga_spec.spl` | "AC-6: platform name contains litex" | Failing (no impl) |
| AC-6 | `test/01_unit/os/kernel/boot/riscv_noalloc_handoff_vexriscv_spec.spl` | "AC-6: Kria layout uart_base matches KriaFpgaMemoryMap" | Failing (no impl) |
| AC-6 | `test/01_unit/os/kernel/boot/riscv_noalloc_handoff_vexriscv_spec.spl` | "AC-6: LiteX layout ram_base is 0x40000000" | Failing (no impl) |
| AC-7 | `test/01_unit/doc/riscv_fpga_bug_tracking_spec.spl` | "AC-7: bug id prefix is BUG-RISCV-FPGA" | Failing (no impl) |
| AC-7 | `test/01_unit/doc/riscv_fpga_bug_tracking_spec.spl` | "AC-7: entry template contains BUG-RISCV-FPGA-001" | Failing (no impl) |
...
- `test/01_unit/os/kernel/boot/riscv_noalloc_handoff_vexriscv_spec.spl` times out (120s) in interpreter mode
...
- `bin/simple run test/01_unit/os/kernel/arch/riscv64/platform/board_memory_map_spec.spl` passes all 14 examples.
- `bin/simple run test/01_unit/os/kernel/boot/riscv_noalloc_handoff_vexriscv_spec.spl` passes all 8 examples.
- `bin/simple run test/01_unit/os/kernel/arch/riscv64/platform/litex_fpga_spec.spl` passes all 5 examples.
...
- Bounded targeted repros all passed with no process leftovers:
  - `bin/simple test test/01_unit/lib/test_runner/_throwaway_import_test_spec.spl --mode=interpreter --sequential --timeout 30 --clean`
  - `bin/simple test test/01_unit/lib/test_runner/_throwaway_broker_test_spec.spl --mode=interpreter --sequential --timeout 30 --clean`
  - `bin/simple test test/01_unit/lib/test_runner --mode=interpreter --parallel -j 2 --timeout 30 --clean`
- Final test-runner process check after those repros: `active_simple=0`, `zombie_simple=0`.

**Broader bounded verification:**
- `test/01_unit/app/test_runner_coverage_spec.spl` passed (10 examples).
- `test/01_unit/app/cli_parser_spec.spl` passed.
- `test/01_unit/app/test_incremental_state_shared_spec.spl` failed normally with missing symbols (`discover_tests`, `TestDaemon`), without crash or process leak.
- `test/01_unit/app/lifecycle_spec.spl` failed normally with unresolved module `nogc_sync_mut.src.app.config`, without crash or process leak.
- `bin/simple test test/01_unit/app --tag cli --mode=interpreter --parallel -j 2 --timeout 30 --clean` completed without process leaks. It failed normally in 15 CLI-related files (59 failed assertions/semantic failures), not by process kill.
- Final process check after broader verification: `active_simple=0`, `zombie_simple=0`.

**Integration/app bounded verification:**
- `test/02_integration/app/cli_dispatch_spec.spl` completed without process leak; failed normally (command-count mismatch, empty app path assertion, missing `compiler_driver_create`).
- `test/02_integration/app/loader_run_function_spec.spl` completed without process leak; failed normally with missing `compiler_driver_create` after one example passed.
- `test/02_integration/app/mcp_stdio_integration_spec.spl` completed without process leak; failed normally with unknown extern `spl_thread_cpu_count`.
...
- `test/02_integration/app/mcp_bugdb_spec.spl` passed without process leak.
- `test/02_integration/app/mcp_debug_log_tree_stdio_spec.spl` completed without process leak; failed normally with unknown extern `spl_thread_cpu_count`.
- `test/02_integration/app/simple_lsp_mcp_stdio_spec.spl` completed without process leak; failed normally with unknown extern `spl_thread_cpu_count`.
- `test/02_integration/app/query_visibility_workspace_symbols_spec.spl` completed without process leak; failed normally with visibility assertion mismatches.
- `test/02_integration/app/lsp_query_visibility_symbols_spec.spl` completed without process leak; failed normally with visibility assertion mismatch.
...
- Historical report paths for `test/01_unit/std/thread_sffi_spec.spl`, `test/01_unit/std/thread_pool_spec.spl`, `test/01_unit/lib/process_manager_spec.spl`, and `test/01_unit/lib/process_governor_spec.spl` no longer exist at those locations; those probes failed immediately with file-not-found and did not exercise runtime behavior.
- Current equivalent bounded probes:
  - `test/os/kernel/wine/thread_sffi_extensions_spec.spl` passed all 19 examples.
  - `test/02_integration/lib/thread_pool_async_spec.spl` completed without kill/leak; failed normally with 4 `Option::Some(...)` assertion mismatches.
...
- Historical crash-regression probes:
  - `test/03_system/stage3_segfault_fix_spec.spl` passed.
...
- Fixed `src/lib/common/science_math/perf_sugar.spl` checker failure caused by blank `///` before an extern; tracked parser issue in `doc/08_tracking/bug/doc_comment_extern_parse_2026-05-21.md`.
  ...
  - `test/03_system/feature/scilib/perf_sugar_spec.spl` passes.
...
- Additional bounded process/SFFI/QEMU-risk probes completed without process kill or leaks:
  ...
  - `test/02_integration/sffi/direction_b_import_roundtrip_spec.spl`: normal failure.
  - `test/02_integration/sffi/direction_a_cpp_roundtrip_spec.spl`: normal link failure, undefined `cuModuleLoadData`.
  - `test/02_integration/remote_jit/qemu_rv32_raw_injected_regression_spec.spl`: passed its regression expectation.
...
- Found `test/01_unit/lib/hardware/soc_rtl/soc_top_64_spec.spl` could leave a live `bin/simple test` parent, pegged `simple run` child, and defunct grandchild when the spec used `soc_top_64_init(0x800_0000)` in interpreter mode.
...
- Native/subprocess probes completed without process leaks or new crashed runs:
  ...
  - `test/01_unit/compiler/backend/native` native: failed normally in `isel_aarch64_spec.spl`.
- Target-filtered process leak regression probes:
  ...
  - `test/01_unit/compiler/r2_probe_fail_spec.spl` with targeted parallel execution exited nonzero as expected and left no matching `simple` processes.
- Final process check: `active_simple=0`, `zombie_simple=0`.
- Final crashed-run check remains unchanged: 17 May 20 zero-count crashed runs, no new crashed run.
...
- Re-ran targeted cleanup probes after the baseline:
  ...
  - `test/01_unit/compiler/r2_probe_fail_spec.spl` deliberate targeted parallel failure exited nonzero and left no matching child processes.
- Final process check: `active_simple=0`, `zombie_simple=0`.
- Final crashed-run check remains unchanged: 17 May 20 zero-count crashed runs, no new crashed run.
