...
| Feature ID | Feature | Difficulty | Status | Impl | Doc | S-Test | R-Test |
|------------|---------|------------|--------|------|-----|--------|--------|
| #300 | SIMD vector types | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #301 | Vector arithmetic | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #302 | Vector intrinsics | 4 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #303 | Bounds policy | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #304 | Bounds clause | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #305 | Neighbor accessors | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #306 | Parallel iterators | 4 | ✅ | S+R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`feature_tests_advanced.rs:test_feature_86_thread_pool`](../tests/system/feature_tests_advanced.rs) | `src/runtime/tests/` |
| #307 | GPU kernels | 4 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #308 | Thread blocks | 4 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #309 | Shared memory | 4 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`memory_tests.rs`](../tests/system/memory_tests.rs) | `src/compiler/tests/` |
| #310 | Synchronization | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`runner_tests.rs`](../tests/system/runner_tests.rs) | `src/compiler/tests/` |
| #311 | Atomic operations | 3 | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`runner_tests.rs`](../tests/system/runner_tests.rs) | `src/compiler/tests/` |
...
| #74 | BDD skip | 2 | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | [`std_lib/test/system/spec/spec_framework_spec.spl`](../simple/std_lib/test/system/spec/spec_framework_spec.spl) | `src/compiler/tests/` |
...
| #997 | BDD Spec Integration | 2 | ✅ | - | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | - | - |
