...
| Feature ID | Feature | Status | Impl | Doc | S-Test | R-Test |
|------------|---------|--------|------|-----|--------|--------|
| #300 | SIMD vectors | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #301 | Vector arithmetic | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #302 | Vector intrinsics | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #303 | Bounds policy | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #304 | Bounds clause | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #305 | Neighbor accessors | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #306 | Parallel iterators | ✅ | S+R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`feature_tests_advanced.rs:test_feature_86_thread_pool`](../tests/system/feature_tests_advanced.rs) | `src/runtime/tests/` |
| #307 | GPU kernels | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #308 | Thread blocks | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`execution_tests.rs`](../tests/system/execution_tests.rs) | `src/compiler/tests/` |
| #309 | Shared memory | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`memory_tests.rs`](../tests/system/memory_tests.rs) | `src/compiler/tests/` |
| #310 | Synchronization | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`runner_tests.rs`](../tests/system/runner_tests.rs) | `src/compiler/tests/` |
| #311 | Atomic operations | ✅ | R | [spec/gpu_simd/README.md](spec/gpu_simd/README.md) | [`runner_tests.rs`](../tests/system/runner_tests.rs) | `src/compiler/tests/` |
...
| Feature ID | Feature | Status | Impl | Doc | S-Test | R-Test |
|------------|---------|--------|------|-----|--------|--------|
| #180 | `describe` blocks | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #181 | `context` blocks | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #182 | `it` examples | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #183 | `before_each` hook | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #184 | `after_each` hook | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #185 | `before_all` hook | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #186 | `after_all` hook | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #187 | `expect ... to` matcher | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/matchers/` | - |
| #188 | `expect_raises` | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/matchers/` | - |
| #189 | `shared_examples` | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #190 | `it_behaves_like` | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |
| #191 | `let` memoization | ✅ | S | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/spec/` | - |

### Doctest (#192-#197)

| Feature ID | Feature | Status | Impl | Doc | S-Test | R-Test |
|------------|---------|--------|------|-----|--------|--------|
| #192 | `>>>` prompt | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/doctest/` | `src/driver/tests/` |
| #193 | Expected output | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/doctest/` | `src/driver/tests/` |
| #194 | `...` continuation | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/doctest/` | `src/driver/tests/` |
| #195 | `# doctest: +SKIP` | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/doctest/` | `src/driver/tests/` |
| #196 | `# doctest: +ELLIPSIS` | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/system/doctest/` | `src/driver/tests/` |
| #197 | FFI integration | ✅ | R | [spec/testing/testing_bdd_framework.md](spec/testing/testing_bdd_framework.md) | `std_lib/test/integration/doctest/` | `src/driver/tests/` |
