...
- `bin/simple os test --scenario=x64-desktop-disk` for the disk-backed packaged
  app lane
- `bin/simple test test/03_system/browser_engine_in_qemu_spec.spl` for the direct
  ELF lane
...
See [SimpleOS GUI Development Guide](simpleos_gui_dev_guide.md) for desktop architecture, applications, launch commands, QEMU configuration, policy, and troubleshooting.
