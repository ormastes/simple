...
bin/simple test test/03_system/dynload/

# Individual specs
bin/simple test test/03_system/dynload/dynload_linux_elf_system_spec.spl
bin/simple test test/03_system/dynload/dynload_simpleos_smf_system_spec.spl
bin/simple test test/03_system/dynload/dynload_macos_system_spec.spl
bin/simple test test/03_system/dynload/dynload_windows_pe_system_spec.spl
```
