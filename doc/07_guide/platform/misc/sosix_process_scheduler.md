...
```bash
bin/simple test test/01_unit/os/kernel/scheduler/scheduler_spec.spl
bin/simple test test/01_unit/os/kernel/scheduler/topology_spec.spl
bin/simple test test/01_unit/os/kernel/memory/vmm_copyin_spec.spl
bin/simple test test/01_unit/os/sosix/process_spec.spl
bin/simple test test/01_unit/os/sosix/share_spec.spl
bin/simple test test/01_unit/os/kernel/ipc/syscall_sosix_share_spec.spl
bin/simple test test/01_unit/os/posix/process_async_spec.spl
bin/simple test test/01_unit/os/kernel/ipc/syscall_fd_spec.spl
```
