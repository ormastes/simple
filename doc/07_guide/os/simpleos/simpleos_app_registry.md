...
|-----------|-------|--------|
| `test/01_unit/os/kernel/loader/app_registry_spec.spl` | 22 | Registry parse, lookup, alias, cache, fallback |
| `test/01_unit/os/kernel/loader/app_discovery_spec.spl` | 16 | Dynamic resolution, FAT32 fallback, canonicalization |
| `test/03_system/os/port/x86_64_elf_load_spec.spl` | 1 | ELF load contract |
