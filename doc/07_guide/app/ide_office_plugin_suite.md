...
ordered list lines render as HTML lists with escaped inline content.
...
count. Writer paper HTML renders Markdown headings, paragraphs, ordered and
unordered lists, tables, images, and inline links as document HTML while escaping user text and
...
- Markdown: `task_list=true strike=true link=true list=true ordered_list=true css_doc=true escaped=true metadata=true`
