...
`writer-markdown-replace`, `writer-markdown-insert`, `writer-markdown-outline`,
...
- LLM catalog: Markdown has `render-markdown-preview-html` and `md-edit`; Writer has
  ...
  `writer-markdown-replace`, `writer-markdown-insert`, and
  `writer-markdown-outline` plus Markdown paper
  features for document statistics, source search, source replace, source insert, document outline,
