...
`project-column|column`, and rejects missing, duplicate, or row-width-mismatched columns.
...
rejects missing, duplicate, or row-width-mismatched columns. `db-edit` uses `insert|v1,v2`,
