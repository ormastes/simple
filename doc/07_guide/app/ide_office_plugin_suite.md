...
`project-column|column`, and rejects missing, blank, duplicate, or row-width-mismatched columns.
...
rejects missing, blank, duplicate, or row-width-mismatched columns. `db-edit` uses `insert|v1,v2`,
