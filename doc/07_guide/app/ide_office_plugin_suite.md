...
`sdd-outline-read`, `sdd-weave-summary`, `export-sdd-canonical`. The bridge delegates to the canonical
...
- LLM catalog: Markdown has `render-markdown-preview-html` and `md-edit`; Writer has
  ...
  `sdd-document-summary`, `sdd-outline-read`, `sdd-weave-summary`, `render-sdd-html-with-selection`, `export-sdd-canonical`, `reroute-sdd-connector`, `edit-sdd-style-rule`,
