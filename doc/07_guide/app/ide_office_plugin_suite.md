...
- Draw: `html=true route=true select=true inspect=true edit=true edge_style=true reconnect=true delete=true node_delete=true layout=true canvas=true`
- LLM catalog: Markdown has `render-markdown-preview-html` and `md-edit`; Writer has
  ...
  `delete-sdd-edge`, `delete-sdd-node`,
