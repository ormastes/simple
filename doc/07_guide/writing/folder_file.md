...
**Go here when:**
- Writing tests for new features -> `test/01_unit/`
- Testing integration -> `test/02_integration/`
- End-to-end testing -> `test/03_system/`
- Measuring performance -> `test/05_perf/`
...
-> `src/lib/`, create tests in `test/01_unit/std/`
