...
| Game compatibility platform | SimpleOS production plan and Wine/process-session specs | Wine/process/session tests under `test/unit/lib/common` and `test/unit/os/kernel/wine` |
...
```bash
bin/simple test test/unit/lib/common/wine_process_session_cpu_preflight_spec.spl --mode=interpreter --clean
bin/simple test test/unit/os/kernel/wine/kernel_thread_primitives_spec.spl --mode=interpreter --clean
```
