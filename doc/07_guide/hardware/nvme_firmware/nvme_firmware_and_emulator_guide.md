...
```bash
B=bin/simple
$B run examples/09_embedded/simpleos_nvme_fw/fw/test_fw.spl    # -> ALL FIRMWARE SELF-TESTS PASS  (1022 assertions)
...
- **`test_fw.spl`** — full self-test suite, 1022 `PASS:` assertions across all modules (now
