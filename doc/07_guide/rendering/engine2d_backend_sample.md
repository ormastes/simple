...
- `test/integration/rendering/engine2d_backend_spec.spl` covers backend
  selection, SIMD hit evidence, and strict Metal probe behavior.
- `test/integration/rendering/metal_engine2d_readback_spec.spl` covers Metal
  framebuffer readback for GPU-backed clear and filled-rectangle kernels.
- `test/perf/graphics_2d/metal_readback_proof_spec.spl` covers raw Metal
