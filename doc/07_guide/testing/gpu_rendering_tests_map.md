...
| `test/02_integration/rendering/vulkan_buffer_readback_bytes_spec.spl` | Typed-array Vulkan upload and exact bounded byte readback at a nonzero offset | ✅ 1 test passing on a live Linux Vulkan device; source-matched native receipt remains open |
