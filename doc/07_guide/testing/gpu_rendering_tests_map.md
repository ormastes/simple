...
| `test/03_system/app/simple_2d/native_processing_ir_cuda_vulkan_readback_parity_spec.spl` | Current-emitter CUDA PTX provenance plus CUDA/Vulkan device readback parity | ⚠️ CUDA source/toolchain/device chain passes with zero mismatches; source-matched Simple native Vulkan receipt remains open |
