...
| `test/03_system/app/simple_2d/native_processing_ir_cuda_vulkan_readback_parity_spec.spl` | Current-emitter CUDA PTX provenance plus CUDA/Vulkan device readback parity | ✅ Retained native ProcessingIR candidates pass exact 64-value CUDA/Vulkan device receipts with no fallback; source-matched direct indexing remains open compiler work |
