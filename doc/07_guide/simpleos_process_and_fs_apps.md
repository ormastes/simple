...
| x86_64 exec/spawn | `test/system/compiler/x86_64_fs_exec_spawn_spec.spl` (19 lines) | Basic spawn contract |
| QEMU integration | `test/system/arm_smf_appscan_qemu_spec.spl` (83 lines) | ARM QEMU smoke |
