...
cases. Manifest policies named `track-*` are counted as tracked when they emit
divergent or pass evidence with `blur_or_tolerance=false`; exact rows still
require checksum and pixel-count equality.
