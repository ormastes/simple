...
`test/03_system/compiler/pure_simple_*vhdl*_spec.spl` acceptance spec is runnable.
...
Test: `test/01_unit/compiler/backend/vhdl_abi_spec.spl`.
...
- `test/03_system/compiler/vhdl_mir_backend_multi_output_spec.spl` covers labeled
...
- `test/03_system/compiler/vhdl_mir_backend_call_port_map_spec.spl` covers direct
...
`test/01_unit/compiler/backend/vhdl_type_mapper_spec.spl`,
`test/01_unit/compiler/backend/vhdl_constraints_spec.spl`,
`test/01_unit/compiler/backend/vhdl_memory_templates_spec.spl`,
`test/01_unit/compiler/backend/vhdl_testbench_spec.spl`,
`test/03_system/compiler/vhdl_source_facade_spec.spl`, and
...
- `doc/04_architecture/hardware/vhdl_hardware_subset_contract.md` — Formal subset contract
- `doc/04_architecture/hardware/vhdl_simulation_milestone_decision.md` — Simulation milestone decision
