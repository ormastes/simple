...
- `doc/04_architecture/hardware/vhdl/vhdl_hardware_subset_contract.md` — Formal subset contract
- `doc/04_architecture/hardware/vhdl/vhdl_simulation_milestone_decision.md` — Simulation milestone decision
