...
- `doc/04_architecture/hardware/vhdl_hardware_subset_contract.md` — Supported subset contract
- `doc/04_architecture/hardware/vhdl_support_matrix.md` — Support matrix
