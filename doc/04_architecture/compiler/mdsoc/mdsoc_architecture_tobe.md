...
- **Upfront fs-API contribution from Simple DB → NVFS** — `doc/05_design/nvfs/from_simple_db.md`. Companion to the existing `doc/05_design/nvfs/slang_requirements.md`. Primary channel per memory note `feedback_slang_drives_nvfs_design.md`.
