...
`doc/04_architecture/os/simpleos_multiarch_hal.md`; use that document for the
...
- `doc/04_architecture/infra/overview.md` says shared contracts belong in `src/common/`
