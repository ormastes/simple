...
| --- | --- | --- |
| Async/GC compatibility surfaces depend on no-GC backends where behavior permits | `scripts/audit/runtime_backend_boundaries.py`; `doc/04_architecture/compiler/backend/runtime_backend_completion_audit.md` | `async_compat_direct_runtime_hook_count=0`, `exact_duplicate_runtime_hook_count=0`, `gc_async_runtime_owner_wildcard_facade_count=0`, and `nogc_async_runtime_owner_wildcard_facade_count=0`. |
