...
```
test/01_unit/compiler/backend/native/
  arm_neon/
...
<!-- Sources:
  ...
  - B2 = doc/04_architecture/compiler/simd/simd_backend_strict_emit.md (Round-1 strict-emit)
  - C2 = doc/04_architecture/compiler/simd/simd_unified_architecture_detail.md (Round-2 architecture)
  - Part1 = doc/04_architecture/compiler/simd/simd_backend_strict_emit_evex_detail.md (C3a sibling)
