...
- syscall ABI defined in `doc/04_architecture/os/simpleos_interfaces.md`
- trap/runtime seam defined in `doc/04_architecture/hardware/rv64_user_mode_exec.md`
- Lean verification contract defined in `doc/04_architecture/infra/lean_verification_contract.md`
