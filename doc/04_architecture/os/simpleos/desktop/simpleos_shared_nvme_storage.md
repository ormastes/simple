...
## Verification
- `test/01_unit/os/drivers/nvme/nvme_storage_model_spec.spl` covers system leases,
...
- `test/01_unit/os/drivers/nvme/nvme_namespace_assignment_spec.spl` covers
...
- `test/01_unit/os/drivers/nvme/nvme_performance_contract_spec.spl` covers the
  ...
  serial report lines.
- `test/01_unit/os/drivers/real_device_readiness_spec.spl` covers that pure-Simple
  q35 completion requires the NVMe performance marker and is rejected when the
  evidence line is missing.
- `test/01_unit/os/services/vfs/nvme_block_adapter_spec.spl` covers adapter-visible
...
- `test/01_unit/lib/fs_driver/nvfs_device_backed_spec.spl` covers NVFS opening on
  the same shared `BlockDevice` surface used by FAT32 and DBFS.
- `test/01_unit/os/services/vfs/nvme_filesystem_mounts_spec.spl` covers producing
...
- `test/01_unit/os/services/vfs/vfs_boot_nvme_lease_spec.spl` covers the
...
- `test/01_unit/os/kernel/ipc/dma_alloc_contract_spec.spl` covers the DMA syscall
  result layout used by the pure Simple NVMe driver and VFS adapter.
- `test/01_unit/os/kernel/types/device_mem_types_spec.spl` covers DeviceGrant
...
- `test/01_unit/os/kernel/boot/boot_fs_mount_acceptance_spec.spl` covers the
...
- `test/01_unit/os/services/vfs/vfs_boot_nvme_lease_spec.spl` covers the
  ...
  before mounting.
- `test/01_unit/os/drivers/nvme/nvme_transfer_command_spec.spl` covers shared
  ...
  decoding.
- `test/01_unit/os/drivers/nvme/nvme_driver_probe_contract_spec.spl` covers that
  ...
  submission.
- `test/01_unit/os/drivers/nvme/nvme_queue_boundary_spec.spl` guards that the
  reusable queue submission/polling module does not import hosted syscalls or
  notification waits.
- `test/01_unit/os/drivers/nvme/nvme_queue_resources_spec.spl` covers syscall-free
...
- `test/01_unit/os/drivers/nvme/nvme_admin_command_spec.spl` covers shared
...
- `test/01_unit/os/drivers/nvme/nvme_freestanding_controller_spec.spl` covers
...
- `test/01_unit/os/drivers/nvme/nvme_sector_probe_spec.spl` covers the structured
  reversible-sector probe contract and rejects missing completion, read, write,
  restore, byte count, or shared transfer logic.
- `test/01_unit/os/drivers/nvme/nvme_driver_probe_contract_spec.spl` guards that
