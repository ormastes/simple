...
| `doc/04_architecture/compiler/mdsoc_architecture_tobe.md` | MODIFY — link to this doc |
...
| `doc/04_architecture/compiler/mdsoc_architecture_tobe.md` | Existing | Add link to this doc + note HAL is the kernel's MDSOC outer-edge |
