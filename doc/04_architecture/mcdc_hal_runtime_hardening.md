...
| `src/compiler/90.tools/verify/` | Bounded source parsing, exact ordered native-row binding, and trust-root-authenticated fixed-width external exclusion evidence |
