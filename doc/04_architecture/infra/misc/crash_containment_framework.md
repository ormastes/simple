...
- Bare-metal simplified model: [`doc/04_architecture/hardware/crash_containment_framework_baremetal_simplified.md`](doc/04_architecture/hardware/crash_containment_framework_baremetal_simplified.md)
