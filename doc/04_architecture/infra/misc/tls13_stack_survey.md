...
> **Note:** A feature-request doc (`doc/08_tracking/feature/hkdf_rfc5869_2026-05-01.md`)
...
15. **X25519MLKEM768.** Wire ML-KEM-768 once the PQC primitive lands.
    Design is covered in `doc/04_architecture/lib/pqc_hybrid_kex_design.md`.
...
- `doc/04_architecture/lib/pqc_hybrid_kex_design.md` — PQC roadmap for this repo
- `doc/04_architecture/lib/ssh_algorithm_catalog.md` — SSH sibling implementation
