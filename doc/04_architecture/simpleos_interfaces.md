...
**Spec:** `test/01_unit/os/services/fat32/fat32_spec.spl`
...
- **IF-08 Phase-3 QEMU runner** — `src/os/qemu_runner.spl:1191`, commit `a08fe8f697` —
  ...
  image and returns captured serial output; `test/03_system/os/port/e2e_qemu_smoke_spec.spl:46` dispatches
