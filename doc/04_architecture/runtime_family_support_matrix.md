...
- [ ] Resolve native BDD blockers for map/set branch overwrite/removal, set dedupe/removal, and untyped chained root-facade trie mutation, then clear remaining native type-loader/minimal-runtime-stub warnings
