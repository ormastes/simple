...
- [ ] Resolve native BDD blockers for map/set branch overwrite/removal, set dedupe/removal, and broad root-facade trie imports, then clear remaining native type-loader/minimal-runtime-stub warnings
