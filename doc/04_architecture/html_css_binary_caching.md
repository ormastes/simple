...
1. Shared API layer: request/artifact shape, cache schema version, cache key, optional binary artifact metadata, static-shell profile, dynamic-island count.
