...
Project ownership rows are disjoint. Firmware and RISC-V are overlapping focus tags and are excluded from portfolio summation. Canonical test tier paths win over legacy mirrors using normalized relative identities.
