...
4. **Week 4:** Move originals to `doc/05_design/phases/` for history
...
3. Document dependency hierarchy in `doc/04_architecture/module_dependencies.md`
...
- Week 4: Move originals to `doc/05_design/phases/`
...
- `doc/07_guide/quick_reference/syntax_quick_reference.md` - Language syntax
