...
- For `test/03_system/feature/**` and `test/03_system/**`: `**Requirements:**`, `**Plan:**`, `**Design:**`, `**Research:**` links
...
| Folder | Purpose |
|--------|---------|
| `doc/03_plan/` | Project plans (why, scope, milestones, risks) |
...
| `doc/01_research/` | Research and option analysis |
| `doc/07_guide/` | Developer guides, runbooks |
