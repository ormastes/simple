...
- `src/hardware/fpga_linux/riscv_fpga_linux.spl` is a repo-native generated-core contract/orchestration layer, not yet a proven runnable generated CPU lane.
...
- `generated_rv64_linux` is the repo-native proof target for RV64 Linux.
