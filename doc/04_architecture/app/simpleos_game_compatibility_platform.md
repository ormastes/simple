...
This extends the existing Wine substrate in `doc/04_architecture/os/simpleos_wine_substrate.md`. Wine/Proton is not the first layer; it depends on Linux ABI, dynamic loader, graphics, audio, input, and container work being observable first.
