...
|---|------|---------|---------|
| 1 | [features_1](#features_1) | Features | `Features`, `features`, `Pure` +9 |
| 2 | [calculate](#calculate) | Features | `Calculate`, `calculate`, `process` +5 |
| 3 | [calculate_tax](#calculate_tax) | Features | `CalculateTax`, `calculate_tax`, `calculate` +15 |
| 4 | [auto_inferred](#auto_inferred) | Features | `AutoInferred`, `auto`, `Auto` +9 |
| 5 | [add](#add) | Features | `Add`, `add`, `ERROR` +2 |
| 6 | [double](#double) | Features | `double`, `Double`, `Pure` +6 |
| 7 | [unnamed_test](#unnamed_test) | Features | `unnamed`, `Unnamed`, `processor` +13 |
...
| 10 | [pure_func](#pure_func) | Features | `Func`, `Pure`, `pure` +7 |
| 11 | [features_11](#features_11) | Features | `Features`, `features`, `Error` +3 |
| 12 | [println](#println) | Features | `println`, `Println`, `randint` +13 |
| 13 | [calculate_discount](#calculate_discount) | Examples | `calculate_discount`, `calculate`, `Discount` +8 |
| 14 | [handle_request](#handle_request) | Examples | `HandleRequest`, `handle_request`, `Handle` +7 |
