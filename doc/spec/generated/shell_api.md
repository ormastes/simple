...
|---|------|---------|---------|
| 1 | [execute_command_basic](#execute_command_basic) | Process Execution | `Command`, `command`, `execute` +7 |
| 2 | [read_file_contents](#read_file_contents) | File Operations | `file`, `File`, `read` +14 |
| 3 | [list_directory](#list_directory) | Directory Operations | `List`, `ListDirectory`, `directory` +14 |
| 4 | [join_paths](#join_paths) | Path Operations | `join`, `paths`, `JoinPaths` +10 |
| 5 | [get_environment_variable](#get_environment_variable) | Environment Variables | `get`, `Variable`, `GetEnvironmentVariable` +12 |
| 6 | [command_failure_result](#command_failure_result) | Error Handling | `Failure`, `failure`, `command_failure_result` +13 |
| 7 | [pipe_commands](#pipe_commands) | Piping and Chaining | `pipe_commands`, `Commands`, `pipe` +10 |
| 8 | [find_files_recursive](#find_files_recursive) | Script Utilities | `find_files_recursive`, `files`, `find` +14 |
