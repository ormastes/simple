...
|---|------|---------|---------|
| 1 | [structs_value_types_1](#structs_value_types_1) | Structs (Value Types) | `types`, `Types`, `Structs` +8 |
| 2 | [structs_value_types_2](#structs_value_types_2) | Structs (Value Types) | `types`, `Types`, `Structs` +7 |
| 3 | [classes_reference_types_3](#classes_reference_types_3) | Classes (Reference Types) | `types`, `Types`, `reference` +10 |
| 4 | [classes_reference_types_4](#classes_reference_types_4) | Classes (Reference Types) | `types`, `Types`, `reference` +8 |
| 5 | [classes_reference_types_5](#classes_reference_types_5) | Classes (Reference Types) | `types`, `Types`, `reference` +8 |
| 6 | [auto_forwarding_properties_getsetis_6](#auto_forwarding_properties_getsetis_6) | Auto-Forwarding Properties (get/set/is) | `Properties`, `Getsetis`, `properties` +16 |
| 7 | [auto_forwarding_properties_getsetis_7](#auto_forwarding_properties_getsetis_7) | Auto-Forwarding Properties (get/set/is) | `Properties`, `Getsetis`, `properties` +14 |
| 8 | [auto_forwarding_properties_getsetis_8](#auto_forwarding_properties_getsetis_8) | Auto-Forwarding Properties (get/set/is) | `Properties`, `Getsetis`, `properties` +14 |
| 9 | [enums_algebraic_data_types_9](#enums_algebraic_data_types_9) | Enums (Algebraic Data Types) | `types`, `Types`, `Algebraic` +11 |
| 10 | [handle](#handle) | Enums (Algebraic Data Types) | `handle`, `Handle`, `Error` +3 |
| 11 | [enums_algebraic_data_types_11](#enums_algebraic_data_types_11) | Enums (Algebraic Data Types) | `types`, `Types`, `Algebraic` +17 |
| 12 | [enums_algebraic_data_types_12](#enums_algebraic_data_types_12) | Enums (Algebraic Data Types) | `types`, `Types`, `Algebraic` +23 |
| 13 | [strong_enums_13](#strong_enums_13) | Strong Enums | `StrongEnums`, `enums`, `Enums` +14 |
| 14 | [strong_enums_14](#strong_enums_14) | Strong Enums | `StrongEnums`, `enums`, `Enums` +17 |
| 15 | [strong_enums_15](#strong_enums_15) | Strong Enums | `StrongEnums`, `enums`, `Enums` +9 |
| 16 | [example](#example) | Union Types | `Example`, `example`, `String` +1 |
| 17 | [option_type_17](#option_type_17) | Option Type | `option_type`, `Option`, `Type` +8 |
| 18 | [option_type_18](#option_type_18) | Option Type | `option_type`, `Option`, `Type` +12 |
| 19 | [visibility_and_access_19](#visibility_and_access_19) | Visibility and Access | `access`, `and`, `Access` +15 |
| 20 | [result_type_20](#result_type_20) | Result Type | `Type`, `result_type`, `Result` +10 |
| 21 | [read_config](#read_config) | Result Type | `Read`, `read`, `ReadConfig` +11 |
| 22 | [result_type_22](#result_type_22) | Result Type | `Type`, `result_type`, `Result` +11 |
| 23 | [result_type_23](#result_type_23) | Result Type | `Type`, `result_type`, `Result` +7 |
| 24 | [bitfields_24](#bitfields_24) | Bitfields | `Bitfields`, `bitfields`, `assert_compiles` +1 |
| 25 | [bitfields_25](#bitfields_25) | Bitfields | `Bitfields`, `bitfields`, `Clear` +4 |
...
| 28 | [bitfields_28](#bitfields_28) | Bitfields | `Bitfields`, `bitfields`, `percentage` +4 |
...
| 32 | [bitfields_32](#bitfields_32) | Bitfields | `Bitfields`, `bitfields`, `ClampTest` +7 |
