...
- Replace the compact early identity support window with a real kernel/user TTBR split, then add rollback and fault handling around live address-space activation.
