...
| SA-2 | `test/03_system/compiler/rtl_mdsoc_byte_equal_spec.spl` (vhdl_backend annotation side) |
| SA-3 | `test/03_system/compiler/fpga_linux_split_spec.spl` |
| SA-4 | `test/03_system/compiler/rtl_mdsoc_capsule_boundary_spec.spl`, `test/03_system/compiler/rtl_mdsoc_plugin_stubs_spec.spl`, `test/03_system/compiler/debug_sidecar_json_order_spec.spl` |
