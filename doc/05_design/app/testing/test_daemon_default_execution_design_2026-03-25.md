...
- `simple test test/01_unit/app/`
- `simple test test/01_unit/app/test_daemon/foo_spec.spl`

These may merge under the `test/01_unit/app` scope.

But:

- `simple test test/01_unit/app/`
- `simple test test/03_system/`
...
- `test/` -> `test/`
- `test/01_unit/` -> `test/01_unit/`
- `test/01_unit/app/foo_spec.spl` -> `test/01_unit/app/`
- `test/03_system/test_daemon/` -> `test/03_system/test_daemon/`
...
- `test/01_unit/app/` and `test/01_unit/app/` -> merge allowed
- `test/01_unit/app/foo_spec.spl` and `test/01_unit/app/bar_spec.spl` -> merge allowed only if normalized request shape matches and both resolve to `test/01_unit/app/`
- `test/01_unit/app/` and `test/01_unit/` -> do not merge
- `test/01_unit/` and `test/03_system/` -> do not merge
...
- two terminals run `simple test test/01_unit/app/ --mode=interpreter`
...
- request A: `test/01_unit/app/`
- request B: `test/01_unit/app/foo_spec.spl`
