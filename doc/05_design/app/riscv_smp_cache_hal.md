...
These traits were reserved ("impl deferred") in `doc/04_architecture/os/simpleos_multiarch_hal.md`
...
| `doc/04_architecture/os/simpleos_multiarch_hal.md` | Flip RESERVED → DONE for HalSmp + HalCache | Modified |
