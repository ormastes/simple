...
3. **User Guide Update** (`doc/07_guide/i18n.md`)
   - Document `--lang` flag
...
- **Implementation Status**: `doc/05_design/diagnostics_i18n_complete.md`
- **i18n Spec**: `doc/05_design/i18n_complete_specification.md`
- **Progress Report**: `doc/09_report/i18n_implementation_progress.md`
