...
| ID | Task | File | Est |
|----|------|------|-----|
| 6.1 | E2E: compile → link → run | `test/03_system/features/inference/e2e_spec.spl` | 8h |
| 6.2 | E2E: cross-module generics | `test/03_system/features/inference/cross_module_spec.spl` | 4h |
| 6.3 | E2E: link-time instantiation | `test/03_system/features/inference/link_instantiate_spec.spl` | 4h |
| 6.4 | Performance benchmarks | `test/05_perf/bench/inference_bench.spl` | 4h |
...
```simple
# test/03_system/features/inference/link_instantiate_spec.spl
