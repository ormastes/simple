...
**Prereqs:** `doc/05_design/lib_variant_architecture_plan.md`, `doc/07_guide/sync_async/async/nogc_async_mut_architecture.md`, `doc/05_design/gc_nogc_module_parity.md`
...
| 0.5 Tests: HAMT | **test** | `test/01_unit/lib/persistent_map_spec.spl` | get/set/remove, collision handling, 1000-element stress |
| 0.6 Tests: Atom | **test** | `test/01_unit/lib/atom_spec.spl` | swap, compare_and_set, concurrent contention |
...
| 1.4 Tests: PersistentVec | **test** | `test/01_unit/lib/persistent_vec_spec.spl` | structural sharing verification, concat, 10K elements |
| 1.5 Tests: Builders | **test** | `test/01_unit/lib/persistent_builder_spec.spl` | batch construction, freeze semantics |
...
| 2.5 Tests: SortedMap + Trie | **test** | `test/01_unit/lib/persistent_sorted_map_spec.spl`, `persistent_trie_spec.spl` | Range queries, prefix search, ordering |
...
| 3.5 Tests: Coordination | **test** | `test/01_unit/lib/ref_spec.spl`, `versioned_snapshot_spec.spl` | Validation, MVCC reads, concurrent snapshots |
| 3.6 Tests: Combinators | **test** | `test/01_unit/lib/async_combinators_spec.spl` | Pipeline composition, race semantics |
...
| 4.3 Parity tracking | **docs** | `doc/05_design/gc_nogc_module_parity.md` | Update parity table with new variant |
| 4.4 Architecture doc | **docs** | `doc/07_guide/nogc_async_immut_architecture.md` | Module map, design decisions, usage examples |
| 4.5 Integration tests | **test** | `test/02_integration/persistent_collections_spec.spl` | Cross-module usage, actor+persistent interop |
