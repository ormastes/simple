...
(verified by `test/01_unit/compiler/lint_ui_rules_spec.spl`, 22/22 passing).
...
| Typed actions | `bin/simple test test/01_unit/app/ui/typed_action_spec.spl` | 19/19 |
| Responsive | `bin/simple test test/01_unit/app/ui/responsive_widget_spec.spl` | 22/22 |
| Color codec | `bin/simple test test/01_unit/app/ui/color_spec.spl` | 50/50 |
| Lint logic | `bin/simple test test/01_unit/compiler/lint_ui_rules_spec.spl` | 22/22 |
