...
**Prereqs:** `doc/03_plan/manual_memory_safety_plan.md`, `doc/05_design/baremetal_async_resources_v0.3.md`, `doc/02_requirements/feature/async_implementation_status.md`
...
From `doc/05_design/rust_to_simple_migration_plan.md`, the runtime crate must provide:
...
- `doc/03_plan/manual_memory_safety_plan.md` - Pointer type definitions
- `doc/05_design/baremetal_async_resources_v0.3.md` - Baremetal async resource system
- `doc/02_requirements/feature/async_implementation_status.md` - Current async state (70% infra, 0% executable)
- `doc/05_design/rust_to_simple_migration_plan.md` - Rust runtime FFI plan
- `doc/03_plan/src_refactor_lib_rename_2026-02-19.md` - Previous lib reorganization plan
