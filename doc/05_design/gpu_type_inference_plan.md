...
**Files:**
- `doc/05_design/simplified_gpu_enum.md` - New design doc
...
**Files:**
- `doc/05_design/gpu_type_inference.md` - Inference rules
...
- `doc/07_guide/gpu_type_inference_guide.md` - User guide
