...
See `doc/05_design/type_parameter_syntax_analysis.md` for details.
...
1. **Documentation**:
   - `doc/05_design/GENERIC_SYNTAX_MIGRATION_SUMMARY.md`
   - `doc/05_design/generic_syntax_deprecation_plan.md`
   - This FAQ
