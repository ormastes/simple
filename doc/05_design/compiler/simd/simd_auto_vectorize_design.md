...
Full regression test corpus: `test/01_unit/compiler/mir_opt/auto_vectorize_spec.spl`
...
- ≥12 unit tests in `test/01_unit/compiler/mir_opt/auto_vectorize_spec.spl`
