...
**Spec Test:** `test/03_system/features/control_flow/pass_unit_equivalence_spec.spl`
...
1. **Syntax Reference:** `doc/07_guide/quick_reference/syntax_quick_reference.md`
...
- Spec Test: `test/03_system/features/control_flow/pass_unit_equivalence_spec.spl`
- Documentation: `doc/07_guide/quick_reference/syntax_quick_reference.md`
