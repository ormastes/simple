...
3. `doc/07_guide/deeplearning.md` - Update error handling examples
4. Any other files mentioning try-catch

## Related Design Decisions

- See `doc/05_design/result_type.md` (if exists)
- See `doc/05_design/error_handling.md` (if exists)
- See `doc/07_guide/error_handling.md` (to be created)
