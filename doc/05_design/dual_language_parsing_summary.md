...
2. **`doc/05_design/dual_language_todo_parsing.md`** (400+ lines)
   - Complete technical documentation
   - API usage examples
   - Integration guide
   - Performance considerations

3. **`doc/05_design/dual_language_parsing_summary.md`** (this file)
...
**Technical docs:**
- `doc/05_design/dual_language_todo_parsing.md` - Complete technical guide
- `src/driver/src/todo_parser.rs` - Inline documentation
- `doc/05_design/todo_db_plan.md` - Overall implementation plan

**Reference docs:**
- `.claude/skills/todo.md` - TODO format specification
- `doc/05_design/todo_db_investigation_report.md` - Investigation findings
...
- Investigation Report: `doc/05_design/todo_db_investigation_report.md`
- Technical Guide: `doc/05_design/dual_language_todo_parsing.md`
