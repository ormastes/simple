...
#### 1. User Guide: `doc/07_guide/i18n.md`
```markdown
...
#### 3. Technical Spec: `doc/06_spec/i18n_architecture.md`
```markdown
...
#### 3. Update `doc/04_architecture/overview.md`
```markdown
## I18n Subsystem
...
- [ ] Create `doc/07_guide/i18n.md`
- [ ] Create `doc/contributing/i18n_translation.md`
- [ ] Create `doc/06_spec/i18n_architecture.md`
- [ ] Update `CLAUDE.md`
- [ ] Update `README.md`
- [ ] Update `doc/04_architecture/overview.md`
...
- [ ] `doc/06_spec/i18n_architecture.md` - Technical spec
...
- [ ] `doc/04_architecture/overview.md` - Add i18n subsystem
