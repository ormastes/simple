...
**Related:** `doc/05_design/smf_note_sdn_implementation.md`, `src/compiler/90.tools/api_surface.spl`
...
- `doc/05_design/smf_note_sdn_implementation.md` — SMF note.sdn design
- `doc/05_design/sdn_handler_trait_design.md` — SDN handler traits
