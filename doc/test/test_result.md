...
1. **parser_type_annotations_spec** - parse error: Unexpected token: expected pattern, found Vec
2. **runner_spec** - compile failed: parse: Unexpected token: expected identifier, found Xor
3. **spec_framework_spec** - Test timed out after 30 seconds
4. **tensor_spec** - parse error: Unexpected token: expected expression, found Comma
5. **test_pub_static_spec** - parse error: Unexpected token: expected identifier, found Static

### Priority 3: Stabilize Flaky Tests (44)

Tests with intermittent failures:
- di_injection_spec (38.5% failure rate)
- safe_unwrap_operators_spec (87.5% failure rate)
- value_spec (20.0% failure rate)
- helpers_spec (16.7% failure rate)
- line_continuation_spec (46.2% failure rate)
