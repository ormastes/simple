...
**Category:** System
**Failed:** 2026-01-30T09:47:12.222850663+00:00
**Flaky:** No (100.0% failure rate)
...
### Priority 1: Fix Failing Tests (38)

1. **arg_parsing_spec** - compile failed: parse: in "/home/ormastes/dev/pub/simple/src/lib/std/src/tooling/core/project.spl": Unexpected token: expected expression, found Newline
2. **parser_improvements_spec** - compile failed: semantic: function `skip_it` not found
3. **spatial_hash_spec** - compile failed: parse: in "/home/ormastes/dev/pub/simple/src/lib/std/src/physics/collision/__init__.spl": Unexpected token: expected identifier, found LBrace
4. **aabb_spec** - compile failed: parse: in "/home/ormastes/dev/pub/simple/src/lib/std/src/physics/collision/__init__.spl": Unexpected token: expected identifier, found LBrace
5. **fault_detection_spec** - compile failed: semantic: function `args` not found

### Priority 3: Stabilize Flaky Tests (5)
