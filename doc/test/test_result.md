...
### Priority 1: Fix Failing Tests (86)

1. **spec_framework_spec** - Test timed out after 30 seconds
2. **contact2_spec** - failed to read test/lib/std/unit/physics/collision/contact2_spec.spl: stream did not contain valid UTF-8
3. **test_exact_spec** - parse error: Unexpected token: expected Fn, found Static
4. **spatial_hash_spec** - compile failed: parse: Unexpected token: expected Colon, found LBrace
5. **config_spec** - parse error: Unexpected token: expected expression, found Slash

### Priority 3: Stabilize Flaky Tests (45)

Tests with intermittent failures:
- traits_spec (16.7% failure rate)
- note_sdn_spec (58.8% failure rate)
- class_invariant_spec (33.3% failure rate)
- generics_advanced_spec (60.0% failure rate)
- unit_types_spec (16.7% failure rate)
