...
### Priority 1: Fix Failing Tests (45)

1. **treesitter_tree_real_spec** - parse error: Unexpected token: expected expression, found RBracket
2. **treesitter_lexer_real_spec** - parse error: Unexpected token: expected expression, found RBracket
3. **generic_bytecode_spec** - compile failed: semantic: function `skip_it` not found
4. **fault_detection_spec** - compile failed: semantic: function `args` not found
5. **lexer_ffi_test** - compile failed: semantic: function `args` not found
