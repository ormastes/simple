...
**File:** `test/system/features/loops/loops_spec.spl`
**Category:** System
**Failed:** 2026-01-25T07:08:05.897119459+00:00
**Flaky:** No (100.0% failure rate)

**Error:**
```
parse error: Unexpected token: expected expression, found For
Location: test/system/features/loops/loops_spec.spl
```
...
**Category:** System
**Failed:** 2026-01-25T07:09:05.790153499+00:00
**Flaky:** No (100.0% failure rate)
...
### Priority 1: Fix Failing Tests (35)

1. **traits_spec** - parse error: Unexpected token: expected expression, found Indent
2. **collections_spec** - parse error: Unexpected token: expected expression, found For
3. **union_impl_spec** - parse error: Unexpected token: expected identifier, found String("\n    Simple union with two variants representing application status.\n    ")
4. **collections_spec** - parse error: Unexpected token: expected expression, found For
5. **single_line_functions_spec** - parse error: Unexpected token: expected identifier, found Assign
