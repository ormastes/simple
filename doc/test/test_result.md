...
### Priority 1: Fix Failing Tests (73)

1. **spec_framework_spec** - Test timed out after 30 seconds
2. **set_spec** - failed to read test/lib/std/unit/core/set_spec.spl: No such file or directory (os error 2)
3. **contact2_spec** - failed to read test/lib/std/unit/physics/collision/contact2_spec.spl: stream did not contain valid UTF-8
4. **sys_ffi_spec** - compile failed: parse: Unexpected token: expected Fn, found Pub
5. **shrinking_spec** - compile failed: parse: Unexpected token: expected identifier, found Xor

### Priority 3: Stabilize Flaky Tests (43)

Tests with intermittent failures:
- capture_buffer_vreg_remapping_spec (72.7% failure rate)
- optional_chaining_spec (41.7% failure rate)
- structs_spec (16.7% failure rate)
- arithmetic_spec (61.5% failure rate)
- impl_blocks_spec (66.7% failure rate)
