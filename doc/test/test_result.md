...
2. **tensor_spec** - parse error: Unexpected token: expected expression, found Comma
3. **config_spec** - parse error: Unexpected token: expected expression, found Slash
4. **test_inject_spec** - parse error: Unexpected token: expected Fn, found Static
5. **custom_autograd_spec** - compile failed: parse: Unexpected token: expected expression, found At

### Priority 3: Stabilize Flaky Tests (44)

Tests with intermittent failures:
- treesitter_error_recovery_spec (60.0% failure rate)
- static_fn_spec (41.7% failure rate)
- autograd_spec (81.8% failure rate)
- coverage_ffi_spec (83.3% failure rate)
- symbols_atoms_spec (12.5% failure rate)
