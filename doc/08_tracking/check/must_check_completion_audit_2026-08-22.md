...
|---|---|---|
| Textual SDN ledger with TODO-to-first-PASS promotion | FAIL | All 15 generic external-receipt rows now fail closed after signature authentication and before attachment loading; four other external rows have gate-specific replay. No production reviewer trust root is provisioned, so external TODO-to-PASS promotion remains unavailable until a reviewed key and gate-specific semantic evidence exist; see `../bug/external_receipt_generic_semantic_quarantine_2026-08-25.md` |
...
| Push completes within ten seconds | PASS | Latest retained exact committed-tree production path on 2026-08-24: 4.57s and 227,920 KiB peak RSS after bounding range/ref scans; the focused mutation harness improved from 23.70s to 18.01s at 6,656 KiB. This supersedes the earlier 4.84s measurement; see `../bug/push_gate_mutation_selftests_exceed_budget_2026-08-24.md` |
...
| Runtime benchmark at least Rust/Go | TODO | Requires retained representative benchmark, semantic parity, timing, and memory evidence. Executable header/statistics, outer target identity, and closed reviewer-attested build-origin validation exist; real production evidence remains absent. See `../bug/rust_go_benchmark_receipt_target_origin_binding_2026-08-25.md` |
