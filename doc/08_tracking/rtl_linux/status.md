...
|------|---------|--------|----------------------|
| RV32 | `generated-rv32-ghdl` | `scripts/rtl_riscv32_linux_generated.shs` | PASS means the authoritative generated RV32 Linux lane passed its bounded generated proof gates under the emitted `rv32/rtl` bundle root. |
| RV64 | `generated-rv64-ghdl` | `scripts/rtl_riscv64_linux_generated.shs` | PASS means the authoritative generated RV64 Linux lane passed its bounded generated proof gates under the emitted `rv64/rtl` bundle root. |
