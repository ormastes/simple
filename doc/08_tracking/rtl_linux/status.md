...
|------|---------|--------|----------------------|
| RV32 | `generated-rv32-ghdl` | `scripts/rtl_riscv32_linux_generated.shs` | PASS means the authoritative generated RV32 Linux lane passed its bounded generated proof gates under the emitted `rv32/rtl` bundle root. It does not yet prove a longer generated Linux payload boot in this lane. |
...
- Remaining active acceptance still depends on some transitional template-backed emitted benches. That dependency is narrower than before, but the generated runner path is not yet template-free end-to-end.
