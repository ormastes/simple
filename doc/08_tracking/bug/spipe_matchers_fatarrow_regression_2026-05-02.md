...
```
bin/simple test test/01_unit/os/crypto/ocb3_kat_spec.spl
  FAILED (101ms)
  Error: parse error: Unexpected token: expected expression, found FatArrow

bin/simple test test/01_unit/os/crypto/eax_kat_spec.spl
  FAILED (100ms)
  Error: parse error: Unexpected token: expected expression, found FatArrow
```
...
cp test/01_unit/os/crypto/eax_kat_spec.spl /tmp/eax_full.spl
...
- `test/01_unit/os/crypto/eax_kat_spec.spl` has correct syntax per code review
