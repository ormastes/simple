...
```sh
SIMPLE_NO_STUB_FALLBACK=1 SIMPLE_BIN=src/compiler_rust/target/debug/simple SIMPLE_COLLECTION_BENCH_SAMPLES=1 bash test/05_perf/collections/run_collection_benchmarks.shs
```
...
- `simple test test/01_unit/lib/nogc_sync_mut/hashset_probe_spec.spl --mode=interpreter`
- `simple test test/01_unit/lib/nogc_async_mut/src/collections/src_collections_facade_spec.spl --mode=interpreter`
- `simple test test/01_unit/lib/gc_async_mut/src/collections/src_collections_facade_spec.spl --mode=interpreter`
...
- `simple test test/01_unit/lib/nogc_sync_mut/hashset_probe_spec.spl --mode=interpreter`
- `simple test test/01_unit/lib/nogc_async_mut/src/collections/src_collections_facade_spec.spl --mode=interpreter --no-cache`
- `simple test test/01_unit/lib/gc_async_mut/src/collections/src_collections_facade_spec.spl --mode=interpreter --no-cache`
