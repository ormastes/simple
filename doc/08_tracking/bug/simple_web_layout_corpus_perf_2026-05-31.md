...
## Context
While hardening GUI bitmap evidence, `test/system/wm_compare/famous_site_corpus_spec.spl`
...
Duration: 86222ms
Slowest tests:
86215ms test/system/wm_compare/famous_site_corpus_spec.spl [PERF BUG]
```
