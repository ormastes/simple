...
| C-MIG-0022 utf8_validate | 32.9x | **16.6x** (simple_us=6617326 c_us=398542, 300 reps x 88-vector corpus) | roughly halved, still far over threshold |
| C-MIG-0019 time_utils | 2.01x | **3.18x** (simple_us=265627 c_us=83431, 30 reps x 100-vector corpus) | got WORSE moving to JIT |
