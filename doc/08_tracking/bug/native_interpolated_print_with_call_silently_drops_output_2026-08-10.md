...
## Output-builtin family table (pinned pristine tree, pre-fix)

| builtin | source | interpreter | JIT | native |
|---|---|---|---|---|
| `print` + interpolated direct arg | `print "D={f()}"` | `D=5` | `D=5` | **(nothing), rc=0 — SILENT** |
