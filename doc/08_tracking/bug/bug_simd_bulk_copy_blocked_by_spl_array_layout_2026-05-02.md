...
| Test file | Pass | Fail |
|-----------|------|------|
| `test/01_unit/lib/common/zstd_sequence_rle_spec.spl` | 5 | 1 ("decodes a one-sequence block with a normal offset") |
| `test/01_unit/lib/common/zstd_compressed_block_spec.spl` | 3 | 4 (UnsupportedFeature vs TruncatedInput) |
