...
Start from `test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl`, scenario
...
- `SIMPLE_LIB=src bin/simple test test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl --mode=interpreter`
...
- `SIMPLE_LIB=src bin/simple run test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl`
