...
```
bin/simple run test/03_system/feature/usage/macro_validation_spec.spl 2>&1
...
- 6 tests in `test/03_system/feature/usage/macro_validation_spec.spl` are permanently failing
...
SIMPLE_LIB=src src/compiler_rust/target/debug/simple run test/03_system/feature/usage/macro_validation_spec.spl
SIMPLE_LIB=src src/compiler_rust/target/debug/simple check test/03_system/feature/usage/macro_validation_spec.spl
```
