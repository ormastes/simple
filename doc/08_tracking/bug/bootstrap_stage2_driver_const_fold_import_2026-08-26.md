...
- Stage 2 resolves the const-fold module through the canonical compiler source
  roots, not relative to `80.driver`.
- The focused import-resolution regression test passes.
- The same receipt-free Stage 2 command produces an admitted Stage 2 compiler.
- The fix lands on protected `main` through integration authority and is
