...
- `test/01_unit/lib/crypto/aes128_gcm_nist_vectors_spec.spl`     — 12 / 12 fail
- `test/01_unit/lib/crypto/aes_cmac_rfc4493_kat_spec.spl`        — multiple fail
- `test/01_unit/lib/crypto/aes_xts_ieee1619_kat_spec.spl`        — 15 / 15 fail (W17-B, this file)

`test/01_unit/lib/crypto/sha2_nist_vectors_spec.spl` PASSES (8/8) — it uses
