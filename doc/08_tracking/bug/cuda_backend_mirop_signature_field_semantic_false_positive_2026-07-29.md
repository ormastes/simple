...
| `20.hir/hir_lowering/expressions.spl:895,928`; `30.types/const_keys_phase8b.spl:183`; `30.types/type_infer/inference_control.spl:507`; `30.types/type_infer/inference_effects.spl:175`; `30.types/type_system/effect_pass.spl:381`; `30.types/type_system/_StmtCheck/bindings_check.spl:371`; `35.semantics/narrowing.spl:128`; `35.semantics/visibility_integration.spl:72`; `50.mir/synthetic_driver_registration.spl:116`; `60.mir_opt/mir_opt/loop_detect.spl:139`; `70.backend/backend/common/expression_evaluator.spl:72,75`; `70.backend/backend/interpreter.spl:706`; `70.backend/backend/lean_borrow.spl:135,139`; `70.backend/linker/mold.spl:333` | various | `block`,`args`,`right`,`op`,`left`,`target`,`idx`,`code`,`id`, etc. | various | not yet triaged | flagged in scanner output (`shdw1_pass2_v2.txt` in session scratchpad, not preserved) for a future lane — honest partial, not silently dropped |
