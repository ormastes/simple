...
SIMPLE_LIB=src bin/simple test test/01_unit/lib/immut/persistent_trie_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src bin/simple test test/01_unit/lib/gc_async_immut/map_facade_native_spec.spl --mode=interpreter --clean
```
