...
SIMPLE_RUST_SEED_WARNING=0 timeout 420 bin/simple test \
  test/02_integration/rendering/engine2d_drawing_spec.spl --no-session-daemon
SPEC FILE VERDICT: test/02_integration/rendering/engine2d_drawing_spec.spl outcome=OK declared>=2 executed=2 passed=2 failed=0 skipped=0 dropped=0
```
