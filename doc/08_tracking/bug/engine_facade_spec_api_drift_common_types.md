...
- `test/unit/lib/gc_async_mut/engine/component/engine_component_facade_spec.spl`
- `test/unit/lib/gc_async_mut/engine/input/engine_input_facade_spec.spl`
- `test/unit/lib/gc_async_mut/engine/scene/engine_scene_facade_spec.spl`
- `test/unit/lib/gc_async_mut/engine/sprite/engine_sprite_facade_spec.spl`
- Same 5 specs under `test/unit/lib/nogc_async_mut/engine/` (identical failures)
