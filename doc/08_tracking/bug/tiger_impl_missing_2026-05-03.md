...
**Spec:** `test/01_unit/os/crypto/tiger_kat_spec.spl` — EXISTS (5/5 PASS)
...
- `test/01_unit/os/crypto/tiger_kat_spec.spl` — 5/5 KAT vectors PASS (interpreter mode)
...
`test/01_unit/os/crypto/tiger_kat_spec.spl` following the pattern established by
`test/01_unit/lib/common/crypto/sha1_rfc3174_kat_spec.spl`.
