...
- `bin/simple check src/lib/common/compress/utilities.spl src/lib/common/compress/deflate.spl src/lib/common/compress/__init__.spl src/os/kernel/loader/zstd_decompress.spl test/01_unit/os/kernel/loader/zstd_decompress_spec.spl`
- `bin/simple test test/01_unit/os/kernel/loader/zstd_decompress_spec.spl --mode=interpreter --clean` — 2 passed, 0 failed.
- `bin/simple test test/01_unit/lib/common/zstd_sequence_fse_tables_spec.spl --mode=interpreter --clean` — 3 passed, 0 failed.
