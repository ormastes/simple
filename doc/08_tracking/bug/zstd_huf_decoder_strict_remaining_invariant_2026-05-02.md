...
> Status: RESOLVED (W14-A, 2026-05-02) — see Resolution section below. Original framing falsified by W13-B; en
...
(`test/01_unit/lib/common/zstd_huf_round_trip_probe_spec.spl`, since removed)
...
Round-trip spec at `test/01_unit/lib/common/zstd_huf_round_trip_spec.spl` — 3/3 PASS
