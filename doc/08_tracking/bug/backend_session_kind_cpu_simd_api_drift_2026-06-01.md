...
- `SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/unit/lib/gpu/engine2d/backend_session_contract_spec.spl --mode=interpreter --clean`: 3 passed, 0 failed.
- `SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/unit/lib/gpu/engine2d/cpu_simd_session_contract_spec.spl --mode=interpreter --clean`: 3 passed, 0 failed.
