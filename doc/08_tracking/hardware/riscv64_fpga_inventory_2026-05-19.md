...
| Tool                       | Status    | Notes                                              |
|----------------------------|-----------|----------------------------------------------------|
| openFPGALoader             | CHECK     | `sh scripts/check-riscv64-fpga-simpleos-preflight.shs` |
...
Run `sh scripts/check-riscv64-fpga-simpleos-preflight.shs` for live tool status.
...
```sh
sh scripts/jtag-ftdi-unbind.shs --rebind
```
...
**Workaround:** Run `sh scripts/jtag-ftdi-unbind.shs` before any JTAG operation.
...
| Script                                        | Purpose                                |
|-----------------------------------------------|----------------------------------------|
| `scripts/check-riscv64-fpga-simpleos-preflight.shs` | Hardware preflight checks        |
| `scripts/jtag-ftdi-unbind.shs`                | Unbind/rebind JTAG interface from ftdi_sio |
| `scripts/check-kria-k26-fpga-bringup.shs`     | Reference pattern (Kria K26 variant)   |
