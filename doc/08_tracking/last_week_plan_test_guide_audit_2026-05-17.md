...
| GPU backend sessions and graphics | `doc/04_architecture/compiler/graphics_3d_session_managed_backend.md`, `doc/05_design/graphics_3d_session_managed_backend.md`, GPU design docs, perf tracking | `test/01_unit/gpu`, `test/05_perf/graphics_2d`, WebGPU/Vulkan/Metal/CUDA smoke/perf tests | `doc/07_guide/api/gpu_api.md` exists | Mostly documented; needs one test-command table |
