...
- **Phase 1 status: LANDED 2026-05-02** — 10 ops (xor/and/or/shl/shr × i32x4 + i32x8).
  ...
  - Spec: `test/01_unit/lib/nogc_sync_mut/simd_int_ops_spec.spl` (14 examples, 0 failures
    in interpreter mode).
  - **Update 2026-05-01 (add/sub/mul backfill):** the pre-existing
    ...
    `test/01_unit/lib/nogc_sync_mut/simd_int_arith_dispatch_spec.spl`.
