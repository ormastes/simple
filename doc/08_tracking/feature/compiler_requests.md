...
- **Notes:**
  ...
  `test/03_system/compiler_import_alias_resolution_spec.spl`.
...
- **Notes:**
  ...
  **A2 implementation (2026-04-18, Claude Sonnet 4.6):**
  ...
  Test spec: `test/01_unit/compiler/hir/resolve_import_symbols_spec.spl` (2 `it` blocks).
  ...
  **Completion update (2026-04-22):** FR-COMPILER-004 landed module-scoped HIR
  ...
  `test/03_system/compiler_module_scoped_hir_lowering_spec.spl`,
  `test/03_system/compiler_compile_options_field_access_spec.spl`, and
...
- **Notes:** Blocks pure-Simple end-to-end testing of any new `extern fn`
  ...
  `test/03_system/compiler_compile_options_field_access_spec.spl`, which imports
...
- **Notes:**
  ...
  `test/03_system/compiler_module_scoped_hir_lowering_spec.spl`,
  `test/03_system/compiler_compile_options_field_access_spec.spl`, and
  `test/01_unit/compiler/hir/resolve_import_symbols_spec.spl`. Release-binary
...
- **Notes:**
  ...
  with focused coverage in `test/01_unit/compiler/schema_contract_spec.spl`.
...
- **Notes:**
  ...
  `test/01_unit/common/ui/style_ui_authoring_spec.spl` and asserts typed tokens,
...
- **Notes:**
  ...
  `test/01_unit/common/music_spec.spl`. The validator checks the emitted
...
- **Notes:**
  ...
  `test/01_unit/common/bim_city_spec.spl`. The implementation validates explicit
...
- **Notes:**
  ...
  focused coverage in `test/01_unit/common/cad_spec.spl`. This closes the first
...
- **Notes:**
  ...
  - helper unit coverage:
    `test/01_unit/compiler/loader/metadata_symbols_spec.spl`,
    `test/01_unit/compiler/loader/unload_ownership_spec.spl`
  - loader acceptance coverage:
    `test/01_unit/compiler/loader/module_loader_spec.spl`,
    `test/01_unit/compiler/loader/module_loader_crash_fix_spec.spl`
  - smoke gates:
...
- **Notes:**
  Discovered while fixing `test/03_system/feature/usage/parser_keywords_spec.spl`
  ...
  - Verification passed:
    ...
    and
    `SIMPLE_LIB=/tmp/simple-final-sync/src /tmp/simple-final-sync/src/compiler_rust/target/debug/simple test test/03_system/feature/usage/parser_keywords_spec.spl --mode=interpreter --clean --fail-fast`.
