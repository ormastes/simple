...
- KAT spec landed 2026-05-10:
  - `test/01_unit/lib/crypto/ecc_p384_p521_kat_spec.spl` — NIST CAVP SigVer
...
4. `src/os/crypto/ecdsa_p384.spl` + `ecdsa_p521.spl` with RFC 6979
   ...
   `test/01_unit/lib/crypto/ecdsa_p256_spec.spl` line 18 — P-256 today
...
* Test coverage: `test/01_unit/lib/crypto/ecc_p384_p521_kat_spec.spl`
...
* `doc/08_tracking/feature/p256_scalar_mult_constant_time_2026-05-01.md`
