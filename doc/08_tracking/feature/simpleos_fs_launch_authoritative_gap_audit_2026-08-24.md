...
| x86/ARM/RISC-V 32/64 | The canonical userland catalog names six targets, and a package-private exact-target lookup now exists. | Filesystem-launch evidence is incomplete across the matrix; loader consumers have not integrated the lookup. |
