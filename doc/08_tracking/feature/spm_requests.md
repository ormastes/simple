...
- **Notes:** Implemented 2026-04-22 with explicit `ProcessVmSpace` helpers in
  ...
  `test/01_unit/os/kernel/memory/vmm_copyin_spec.spl`,
  `test/01_unit/os/kernel/ipc/ipc_grants_spec.spl`, and
  `test/03_system/simpleos_spm_pt_walk_copy_spec.spl`.
...
- **Acceptance-criteria:**
  ...
  - [x] No regression in `test/01_unit/os/kernel/ipc/` or privilege_bridge specs
- **Related-upfront:** `doc/04_architecture/os/privilege_id_system.md`
...
- **Related-upfront:** `doc/04_architecture/os/simple_process_manager.md` §§
  lifecycle + bootstrap
