...
- **Progress 2026-05-29:** `std.db.prefix_index` now normalizes lookups through
  ...
  `test/01_unit/lib/db/prefix_index_spec.spl`.
- **Progress 2026-05-29:** DBFS `DentryTable` now maintains the shared prefix
  ...
  `test/01_unit/lib/db/dbfs_dentry_prefix_index_spec.spl` plus
  `test/02_integration/storage/dbfs/dbfs_catalog_schema_spec.spl`.
- **Progress 2026-05-29:** SDN `QueryBuilder` now routes single-filter
  ...
  `test/01_unit/lib/database/database_query_spec.spl` plus
...
- **Progress 2026-05-29:** Representative shared-accel benchmark evidence was
  refreshed in `test/05_perf/bench/simple_db_shared_accel.spl`. The interpreter
...
- **Progress 2026-05-29:** Added pure Simple
  ...
  `test/01_unit/lib/db/learned_index_spec.spl`.
- **Progress 2026-05-29:** `test/05_perf/bench/simple_db_shared_accel.spl` now
...
- **Progress 2026-05-29:** Added pure Simple
  ...
  `test/01_unit/lib/db/cardinality_estimator_spec.spl`.
...
- **Progress 2026-05-29:** Added shared posting-list bitmap primitives to
  ...
  row. Focused coverage: `test/01_unit/lib/db/posting_list_bitmap_spec.spl`.
- **Progress 2026-05-29:** `test/05_perf/bench/simple_db_shared_accel.spl` now
