...
**Plan:** `doc/plan/text_helpers_p1.md`
**Requirement:** `doc/plan/requirement/stdlib_helpers.md` — items T1-T5, T12, T20, T26, T40
**Date:** 2026-03-26
...
|----------|-------------|
| `doc/plan/requirement/stdlib_helpers.md` | Parent requirement (items T1-T5, T12, T20, T26, T40) |
| `doc/plan/text_helpers_p1.md` | Implementation plan (task breakdown, DAG, difficulty) |
