...
Simple's architecture rule is "MDSOC outer + ECS business layer for userland services/apps; kernel/drivers stay MDSOC-only" (`.claude/rules/structure.md`, `doc/04_architecture/compiler/mdsoc_architecture_tobe.md`). The MDSOC outer must declare a table across these axes:
...
- `doc/04_architecture/compiler/mdsoc_architecture_tobe.md` (MDSOC+ userland section)
