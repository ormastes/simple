...
- `doc/01_research/compiler_mdsoc_design.md` — Compiler pipeline MDSoC
- `doc/09_report/compiler_mdsoc_impl_plan.md` — Implementation plan
- `doc/01_research/mdsoc_design.md` — MDSoC dimension system
