...
> see `src/compiler/85.mdsoc/` (symlink: `src/compiler/mdsoc`) and `doc/02_requirements/feature/mdsoc_complete.md`.
...
- `doc/02_requirements/feature/mdsoc_complete.md` — Implementation status (288 tests passing, one-struct-per-file)
- `doc/07_guide/standard_architecture.md` — Application-level architecture guide
...
- Spec authority: `doc/04_architecture/compiler/mdsoc/mdsoc_architecture_tobe.md` §Part 3.
