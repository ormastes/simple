...
**Status:** Check `doc/01_research/startup_optimization.md` for any existing startup library patterns. Not found in MEMORY.md — needs verification whether a startup-phase initialization library already exists.
...
**Verified in:** `test/03_system/feature/parser_control_flow_spec.spl:350-410` — tests for `if val`,
