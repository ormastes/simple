...
multiple source signatures, which is ABI debt rather than harmless duplication.
...
research slice must reconcile the 263 signature variants first, then reduce
