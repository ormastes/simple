...
|------|-----------|--------------|-----------------|-----|
| **ERP Core** | Accounts & ledger, multi-tenant RBAC, session mgmt, audit trail, validation gates | Budget tracking, cost allocation, multi-currency | REQ-017,025,026; src/lib/*/ledger, web_framework auth | Approval workflows, backup/restore, tamper checks (REQ-018,019,025) |
