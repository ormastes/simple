...
| 2026-06-01 | E | Added domain research for PGO/BOLT/profile-data safety using LLVM primary sources; OpenJDK HotSpot source fetch was unavailable, so HotSpot remains prior-art framing only. | `doc/01_research/domain/simple_optimization_architecture_roadmap_2026-06-01.md`. |
