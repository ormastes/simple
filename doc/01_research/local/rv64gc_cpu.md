...
The RV32 emulation has tests at `test/01_unit/hardware/rv32imac/` covering:
...
Integration tests at `test/02_integration/hardware/rv32imac/`:
...
System test: `test/03_system/rv32imac_spec.spl`
...
| `test/01_unit/hardware/rv32imac/rv32_alu_spec.spl` | `test/01_unit/hardware/rv64gc/rv64_alu_spec.spl` |
