...
**Tests:** `test/03_system/feature/function_alias_spec.spl` -- 10/10 passing
...
**Tests:** `test/03_system/feature/method_alias_spec.spl` -- 7/7 passing
**Unit tests:** `test/01_unit/app/desugar/forwarding_spec.spl` Phase 2 section -- 4/4 passing
...
**Tests:**
- `test/03_system/feature/trait_forwarding_spec.spl` -- 8/8 passing (runtime delegation)
- `test/01_unit/app/desugar/trait_scanner_spec.spl` -- 9/9 passing (scanner)
- `test/01_unit/app/desugar/forwarding_spec.spl` Phase 3 section -- 5/5 passing (desugar)
...
**Tests:** `test/01_unit/app/desugar/forwarding_spec.spl` Phase 4 section -- 3/3 passing
...
|-------|-----------|-------|--------|
| Dep. | `test/03_system/feature/function_alias_spec.spl` | 10 | 10/10 PASS |
| 2 | `test/03_system/feature/method_alias_spec.spl` | 7 | 7/7 PASS |
| 3 | `test/03_system/feature/trait_forwarding_spec.spl` | 8 | 8/8 PASS |
| 3 | `test/01_unit/app/desugar/trait_scanner_spec.spl` | 9 | 9/9 PASS |
| All | `test/01_unit/app/desugar/forwarding_spec.spl` | 15 | 15/15 PASS |
| **Total** | | **49** | **49/49 PASS** |
