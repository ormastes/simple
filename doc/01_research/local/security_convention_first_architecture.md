...
- Sandbox manifest generation, backend lowering artifacts, hosted runtime registry installation, hosted capability-handle enforcement, Linux Landlock/seccomp filters, Simple VM host-import filtering, and SimpleOS kernel capability installation exist for declared sandboxes/gates; broader WASI capability table and baremetal MPU isolation remains future work.
