...
- A full scheduler-aware multicore green runtime still needs a carrier bridge into concrete run queues, blocking syscall boundaries, and SimpleOS wakeup/IPI hooks.
