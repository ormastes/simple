...
*Cross-ref: `doc/01_research/compiler/cpu_simd_scheduling.md` — TBB-style work-stealing scheduler design for `@simd` kernels; complements the vectorizer's cost model.*
