...
- `doc/01_research/compiler/compiler_optimization_infra_refactor_2026-05-13.md`
- `doc/01_research/compiler/llvm_optimization_best_practices_2026.md`
- `doc/01_research/compiler/binary_size_optimization_across_languages.md`
- `doc/01_research/compiler/target_instruction_optimization_32bit.md`
- `doc/01_research/compiler/bootstrap_size_optimization_research_2026-01-31.md`
...
### Architecture
- `doc/04_architecture/compiler/mdsoc_architecture_tobe.md` (Part 3: MDSOC+ ECS Business Layer)
...
| 2026-06-01 | E | Added domain research for PGO/BOLT/profile-data safety using LLVM primary sources; OpenJDK HotSpot source fetch was unavailable, so HotSpot remains prior-art framing only. | `doc/01_research/compiler/simple_optimization_architecture_roadmap_2026-06-01.md`. |
