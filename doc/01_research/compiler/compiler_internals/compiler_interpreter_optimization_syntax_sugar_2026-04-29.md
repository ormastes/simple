...
3. **Language-feature inventory already exists**
   - [`doc/01_research/language/types/missing_language_features_2026-02-17.md`](../domain/missing_language_features_2026-02-17.md) says Simple already has a solid baseline including generics, pattern matching, Option/Result, async/await, closures, comprehensions, pipeline operators, effect annotations, and string interpolation.
