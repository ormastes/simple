...
Feature request: `FR-COMPILER-001` in `doc/08_tracking/feature/compiler_requests.md`.
...
- System SPipe: `test/03_system/compiler_compile_options_field_access_spec.spl`
- Related resolver coverage: `test/01_unit/compiler/hir/resolve_import_symbols_spec.spl`
