...
- SDN is already a separate data/config surface, not the universal authoring grammar. See `doc/04_architecture/compiler/parser_file_locations_2026-02-04.md` and SDN parser ownership under `src/lib/std/sdn/`.
