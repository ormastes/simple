...
- Existing test shards: `test/01_unit/compiler/complete/driver_1_complete_spec.spl`
- Existing deep coverage shards: `test/01_unit/compiler/deep/module_resolver_1_spec.spl`
