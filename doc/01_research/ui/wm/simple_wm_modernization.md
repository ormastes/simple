...
- `test/01_unit/app/ui/web_wm_modern_shell_spec.spl` now acts as the focused executable contract for the Web WM modernization surface. It also generates `doc/06_spec/test/01_unit/app/ui/web_wm_modern_shell_spec.md`, which now has manual-quality overview, examples, source links, review checklist, expected evidence, and failure triage.
