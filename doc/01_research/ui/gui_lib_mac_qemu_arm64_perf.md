...
- Architecture context:
  ...
  - `doc/04_architecture/compiler/gui_layer_contract.md` locks `CompositorBackend`, `InputBackend`, and Engine2D boundaries.
  - `doc/04_architecture/hardware/arm32_jit_metal_constraints.md` records that Metal is an AArch64/macOS path, not ARM32.
  - `doc/04_architecture/os/simpleos_arm_qemu_fs_toolchain_verification.md` covers ARM QEMU verification boundaries.
- Prior related research: `doc/01_research/ui/gui_color_image_pipeline_8k.md`, `doc/01_research/ui/gui_color_image_pipeline_8k.md`, and `doc/01_research/compiler/performance_visual_comparison.md`.
