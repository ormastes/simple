...
- `test/01_unit/compiler_core/must_use_spec.spl` - 1/1 passing (5ms)
- `test/01_unit/compiler_core/interpreter/` - 8/8 passing (34ms)
- `test/01_unit/compiler_core/` - 77/77 passing (370ms)
- `test/01_unit/compiler/` - 227/227 passing (956ms)
...
- String Performance Best Practices: `doc/07_guide/quick_reference/syntax_quick_reference.md`
