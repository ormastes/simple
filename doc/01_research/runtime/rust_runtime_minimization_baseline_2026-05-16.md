...
`doc/01_research/runtime/rust_runtime_minimization.md` line 57 references `doc/05_design/rust_to_simple_migration_plan.md` — that file does **not exist**. The actual files are:
...
| `doc/01_research/runtime/rust_runtime_minimization.md` path error | Fixed — stale path reference corrected |
