...
- Vulkan details: `doc/guide/backend/vulkan.md`
- Deep learning: `doc/guide/deep_learning/deep_learning.md`
- GPU config: Uses SDN format (see `doc/guide/quick_reference/syntax_quick_reference.md`)
