...
- Architecture overview: `doc/guide/architecture.md`
- Compiler architecture: `doc/guide/architecture/compiler_architecture.md`
- File structure: `doc/architecture/file_class_structure.md`
