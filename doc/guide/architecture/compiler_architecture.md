...
- Application architecture: `doc/guide/architecture/application_architecture.md`
- Type system design: `doc/design/type_system.md`
- Generic template bytecode: `doc/design/generic_template_bytecode.md`
