...
User-facing guides for the Simple programming language. For specifications see `doc/spec/`, for research see `doc/research/`.
...
| [tooling/shb.md](tooling/shb.md) | SHB binary format — module interface caching, generation, consumers |
