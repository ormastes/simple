...
```c
// In src/runtime/runtime.h, src/runtime/platform/unix_common.h
...
- `src/runtime/runtime.h` - Function declarations
- `src/runtime/platform/unix_common.h` - Unix implementations  
- `src/runtime/platform/platform_win.h` - Windows stubs
- `src/runtime/runtime.c` - `rt_file_copy` helper
