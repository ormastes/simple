...
└── 📁 Supporting Files (seed/, docker/, examples/, etc.)
```
...
│   └── compiler/                        # C code generation (seed)
│
...
**Purpose:** C/C++ seed compiler for bootstrapping the Simple compiler from scratch.
...
Dockerfiles for containerized testing and development.

**Files:**
- `Dockerfile.test-isolation` - Test isolation
- Various platform-specific Dockerfiles
