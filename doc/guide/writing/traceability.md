...
- If a prose doc needs to point to tests, point to generated markdown under `doc/spec/`, not raw `test/..._spec.spl`.
...
```markdown
**Requirements:** doc/plan/requirement/<slug>.md
**Plan:** doc/plan/<slug>.md
**Design:** doc/design/<slug>.md
**Research:** doc/research/<slug>.md
```
