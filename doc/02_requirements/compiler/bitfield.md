...
- Executable regression: `test/01_unit/compiler/native/bitfield_codegen_spec.spl`.
- Legacy interpreter runtime remains on an older parser and can still reject direct bitfield declarations.
