...
|----------|-----------|--------|
| Core lifecycle inventory | `test/03_system/feature/app/mcp_protocol_gap_matrix_spec.spl` | Added |
| Debug and diagnostic feature inventory | `test/03_system/feature/app/mcp_protocol_gap_matrix_spec.spl` | Added |
| Gap inventory lock | `test/03_system/feature/app/mcp_protocol_gap_matrix_spec.spl` | Added |
| Runtime protocol method coverage | `test/03_system/feature/app/mcp_protocol_runtime_spec.spl` | Added |
| Existing debug-log behavior | `test/03_system/feature/app/mcp_debug_log_spec.spl` | Existing |
