...
- REQ-RISCV-SMF-003: The boot path must discover and validate `/SYS/APPS/HELLOSMF.SMF` as the CLI executable fixture.
- REQ-RISCV-SMF-004: The boot path must discover and validate `/SYS/APPS/BROWSMF.SMF` as the GUI app fixture and report the window-manager launch handoff marker.
