...
### When enable/disable stack overflow

- enables detection
- disables detection

### When set_recursion_limit
...
### When recursion with detection enabled

- handles fibonacci computation
- handles multiple sequential recursive calls

### When iterative with detection enabled

- handles iterative loops

### When toggling detection during computation
