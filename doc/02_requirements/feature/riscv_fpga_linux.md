...
- REQ-RFL-008..011 are complete for the bounded helper-proof milestone. The implemented helper set is `decode_writeback`, `decode_branch_immediate`, `decode_store_immediate`, `decode_i_immediate`, `decode_upper_immediate`, `decode_execute_control`, `decode_execute_datapath`, `decode_branch_datapath`, `decode_control_flow_datapath`, `decode_memory_access_control`, and `decode_jump_immediate`, with exact MIR/VHDL/source-map assertions.
