...
- REQ-NVFS-MIG-001: NVFS source must live under the repo-owned SimpleOS tree, not as `src/os/services/nvfs`.
...
- REQ-NVFS-MIG-004: The old `src/os/services/nvfs` working tree and gitlink must be removed.
