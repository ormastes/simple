...
- **REQ-VHDL-PARITY-009:** Payload enum lowering supports tagged-record representation for VHDL ports/results, enum aggregate construction, payload field projection, and tag-based switch matching.
