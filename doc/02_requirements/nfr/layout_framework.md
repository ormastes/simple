...
- NFR-003 Correctness: CPU geometry is the absolute oracle; incremental and accelerated results require structural equality before acceptance.
- NFR-004 Cost honesty: GPU estimates include scheduling, host/device transfer, readback, and synchronization.
...
- NFR-008 Maintainability: shared contracts stay in owner modules and the framework does not duplicate the current browser layout algorithms.
