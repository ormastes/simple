...
- `test/01_unit/std/env_spec.spl`
- `test/01_unit/std/log_spec.spl`
- `test/01_unit/std/mock_phase5_spec.spl`
...
**Evidence:**
```bash
$ timeout 30 bin/simple test test/01_unit/std/env_spec.spl
# Timeout after 2min

$ timeout 30 bin/simple test test/03_system/feature/array_literal_spec.spl
# Timeout after 2min

$ timeout 30 bin/simple test test/01_unit/compiler_core/interpreter/factorial_spec.spl
# Timeout after 2min
```
...
**Missing (required by test/01_unit/std/log_spec.spl):**
...
- `test/01_unit/std/config_spec.spl` - Config structures
- `test/01_unit/std/di_spec.spl` - Dependency injection
- `test/01_unit/std/db_spec.spl` - Database table operations
