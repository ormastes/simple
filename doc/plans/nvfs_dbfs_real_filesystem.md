...
- Gated DBFS-marked FAT32 carrier image smoke passes at `test/os/port/dbfs_disk_boot_spec.spl`
- Hosted DBFS/NVFS rootfs file I/O coverage exists at `test/unit/os/services/vfs/vfs_rootfs_porting_spec.spl`

## Verification

- `bin/simple test test/dbfs/dbfs_engine_wal_spec.spl`
- `bin/simple test test/dbfs/dbfs_nvme_callback_spec.spl`
- `bin/simple test test/dbfs/dbfs_recovery_spec.spl`
- `bin/simple test test/dbfs/samsung_nvme_feature_policy_spec.spl`
...
- `bin/simple test test/kernel/boot_fs_spec.spl`
- `bin/simple test test/kernel/nvfs_elf_load_spec.spl`
- `bin/simple test test/kernel/elf_load_chain_spec.spl`
- `bin/simple test test/os/kernel/loader/executable_source_vfs_spec.spl`
- `SIMPLEOS_DBFS_BOOT=1 bin/simple test test/os/port/dbfs_disk_boot_spec.spl`
