...
| **plan/** | Planning documents | What's being planned |
...
- `feature.md` - Feature list (auto-generated)
- `pending_feature.md` - Upcoming features
...
### For New Features
1. **Design doc:** `doc/design/feature_name.md`
2. **Implementation notes:** Track in design doc
3. **Completion report:** `doc/report/feature_complete_YYYY-MM-DD.md`
4. **User guide:** `doc/guide/feature_usage.md` (if user-facing)
