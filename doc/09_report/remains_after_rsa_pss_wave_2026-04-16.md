...
3. **`qemu-system-x86_64` not installed on dev host.** Blocks `os_tls_spec.spl` and `os_tls_system_spec.spl` end-to-end runs.
   - Ops, not code. Install path documented at `doc/01_research/os/qemu/qemu_install_notes.md`.
...
Cross-reference: `doc/01_research/lib/misc/tls13_phase2_backlog.md`.
...
- `doc/01_research/lib/misc/tls13_phase2_backlog.md` — Phase 2 design backlog.
- `doc/01_research/os/qemu/qemu_install_notes.md` — QEMU install commands per OS.
