...
| [simpleos_multicore_green_evidence_2026-06-07.md](simpleos_multicore_green_evidence_2026-06-07.md) | Pass | Current SimpleOS green-carrier evidence; final live QEMU handoff now emits `HW_HANDOFF_PASS=true`, `USER_ENTRY_PASS=true`, and `USER_SYSCALL_PASS=true` from the real AP ring/user path. |
