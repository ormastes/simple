...
**Enables:** `test/03_system/feature/effect_annotations_spec.spl` (30+ test cases)
...
**Enables:** `test/03_system/feature/parser_error_recovery_spec.spl` (partial - simplified implementation)
...
#### `doc/02_requirements/feature/parser_type_system_status_2026-02-14.md` (283 lines)
...
3. `doc/02_requirements/feature/parser_type_system_status_2026-02-14.md` (283 lines) - Status report
...
- `test/03_system/feature/effect_annotations_spec.spl` (30+ tests)
- `test/03_system/feature/parser_error_recovery_spec.spl` (partial - 40+ tests)
...
1. Run `bin/simple test test/03_system/feature/effect_annotations_spec.spl`
2. Run `bin/simple test test/03_system/feature/parser_error_recovery_spec.spl`
3. Verify implementations work correctly
4. Remove @pending annotations if tests pass
5. Update `doc/02_requirements/feature/feature.md` and `doc/02_requirements/feature/pending_feature.md`
