...
| Test specs (REPL) | `test/03_system/repl/*_spec.spl` (5 files) | 169 |
| Test specs (Jupyter) | `test/03_system/jupyter/*_spec.spl` (5 files) | 274 |
| Test helpers | `test/03_system/jupyter/helpers/*.py` (2 files) | 728 |
| Test fixtures | `test/03_system/jupyter/fixtures/*.ipynb` (2 files) | 113 |
...
| Document | Path |
|----------|------|
| REPL Guide | `doc/07_guide/tooling/repl.md` |
| Jupyter Guide | `doc/07_guide/tooling/jupyter.md` |
| Implementation Report | `doc/09_report/repl_jupyter_implementation_2026-03-11.md` |
| REPL Spec (updated) | `doc/06_spec/tooling/simple_repl.md` |
