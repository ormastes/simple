...
- [vhdl_backend_spec.spl](test/01_unit/compiler/backend/vhdl_backend_spec.spl)
- [remote_interpreter_backend_spec.spl](test/03_system/remote_interpreter_backend_spec.spl)
- [multi_mode_test_runner_spec.spl](test/03_system/multi_mode_test_runner_spec.spl)
- [remote_baremetal_qemu_hello_spec.spl](test/03_system/feature/app/remote_baremetal/remote_baremetal_qemu_hello_spec.spl)
...
- `bin/simple test test/03_system/remote_interpreter_backend_spec.spl`
- `bin/simple test test/03_system/multi_mode_test_runner_spec.spl`
- `bin/simple test test/03_system/feature/app/remote_baremetal/remote_baremetal_qemu_hello_spec.spl`
...
- `bin/simple test test/02_integration/remote_jit/ghdl_rv32_composite_runner_spec.spl`
- `bin/simple test test/02_integration/remote_jit/qemu_rv32_composite_runner_spec.spl`

Broader suites:

- `bin/simple test test/03_system/feature/app/remote_baremetal/`
- `bin/simple test test/02_integration/remote_jit/`
