...
| Benchmark harness created | DONE | `test/05_perf/llvm_lib_ffi_perf_spec.spl` |
...
3. Run `test/05_perf/llvm_lib_ffi_perf_spec.spl` on stage2 to measure actual improvement
...
| `test/05_perf/llvm_lib_ffi_perf_spec.spl` | Created | Benchmark harness |
