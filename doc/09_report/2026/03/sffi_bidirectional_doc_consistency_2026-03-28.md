...
| Fix ID | File | Change |
|--------|------|--------|
| FIX-01 | `test/03_system/sffi_bidirectional_interop_spec.spl` | Changed `Plan:` from nonexistent path to correct plan path |
| FIX-02 | `test/03_system/sffi_bidirectional_interop_spec.spl` | Changed `Requirements:` from `N/A` to actual requirements doc path |
| FIX-03 | `test/03_system/sffi_bidirectional_interop_spec.spl` | Added `Architecture:` link |
