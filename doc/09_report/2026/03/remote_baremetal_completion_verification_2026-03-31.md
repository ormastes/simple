...
- [ch32v307_adapter_spec.spl](test/01_unit/lib/remote_exec/ch32v307_adapter_spec.spl)
- [ch32v307_composite_runner_path_spec.spl](test/02_integration/remote_jit/ch32v307_composite_runner_path_spec.spl)
- [qemu_rv32_raw_injected_regression_spec.spl](test/02_integration/remote_jit/qemu_rv32_raw_injected_regression_spec.spl)
...
- `bin/simple test test/01_unit/lib/remote_exec/ch32v307_adapter_spec.spl`
- `bin/simple test test/01_unit/lib/remote_exec/remote_exec_host_spec.spl`
...
- `bin/simple test test/03_system/feature/app/remote_jit/ch32v307_jit_e2e_spec.spl`
- `bin/simple test test/02_integration/remote_jit/qemu_rv32_composite_runner_spec.spl`
- `bin/simple test test/02_integration/remote_jit/qemu_rv32_raw_injected_regression_spec.spl`
- `bin/simple test test/03_system/feature/app/remote_jit/qemu_rv32_jit_e2e_spec.spl`
- `bin/simple test test/03_system/feature/app/remote_baremetal/remote_baremetal_runtime_spec.spl`
- `bin/simple test test/02_integration/remote_jit/baremetal_library_host_spec.spl`
