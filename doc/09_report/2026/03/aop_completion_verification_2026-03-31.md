...
- [aop_around_advice_spec.spl](test/03_system/features/aop/aop_around_advice_spec.spl)
- [aop_proceed_spec.spl](test/01_unit/compiler/mdsoc/aop_proceed_spec.spl)
...
- `./bin/simple test test/01_unit/compiler/mdsoc/aop_proceed_spec.spl`
- `./bin/simple test test/03_system/features/aop/aop_around_advice_spec.spl`
- `./bin/simple test test/01_unit/compiler/mdsoc/pipeline_integration_spec.spl`
- `./bin/simple test test/03_system/feature/usage/aop_spec.spl`
- `./bin/simple test test/03_system/feature/usage/aop_architecture_rules_spec.spl`
- `./bin/simple test test/03_system/feature/usage/aop_debug_log_spec.spl`
- `./bin/simple test test/03_system/security_aop_spec.spl`
