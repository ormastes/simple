...
| Use Simple code where practical | `scripts/os/simpleos_fat32_image_list.spl` inspects the SD/FAT32 image in Simple. `doc/07_guide/hardware/xilinx_fpga_board_bringup.md` defines the SimpleOS purity boundary. | Done for repo-side inspection. Physical JTAG/UART/Vivado control remains host lab tooling. |
