...
2. Skipped tests requiring unregistered functions:
   ...
   describe "ExecutionManager (SKIPPED - Rust functions not registered)":
       ...
       # See: doc/09_report/jit_integration_status_2026-02-06.md
...
**File:** `doc/09_report/bug_execution_manager_unregistered_2026-02-06.md`
...
3. `doc/09_report/bug_execution_manager_unregistered_2026-02-06.md` - New bug report
4. `doc/09_report/test_fixes_summary_2026-02-06.md` - This file
...
- ✅ `doc/09_report/autograd_global_store_solution_2026-02-06.md` - Documented solution
- ✅ `doc/09_report/jit_integration_status_2026-02-06.md` - Full JIT status
