...
2. Update initialization:
   ```simple
   val fdb = create_feature_database("doc/02_requirements/feature/feature_db.sdn")
...
| Custom API | Unified API | Notes |
|------------|-------------|-------|
| `FeatureDatabase.load()` | `load_feature_database("doc/02_requirements/feature/feature_db.sdn")` | Similar |
