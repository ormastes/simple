...
**File:** `test/01_unit/std/config_parser_test.spl` (159 lines)
...
bin/simple test/01_unit/std/config_parser_test.spl

# Run migrated config tests
bin/simple test/01_unit/app/duplicate_check/config_migrated_test.spl
...
- `test/01_unit/std/config_parser_test.spl` (159 lines)
- `test/lib/std/config_parser.spl` (symlink)
- `test/01_unit/std/cp_test1.spl` (12 lines, simple verification)
- `test/01_unit/app/duplicate_check/config_migrated_test.spl` (33 lines)
