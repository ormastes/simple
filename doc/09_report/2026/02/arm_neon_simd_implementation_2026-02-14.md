...
### 3. Test Suite: `test/01_unit/compiler/arm_neon_spec.spl` (351 lines, 60 tests)
...
- Test reference: `test/01_unit/compiler/x86_64_simd_spec.spl`
...
3. `test/01_unit/compiler/arm_neon_spec.spl` - **NEW** (351 lines, 60 tests)
