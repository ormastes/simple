...
### 4. Implementation Guide (`doc/07_guide/jit_implementation_guide.md`)
...
4. `doc/07_guide/jit_implementation_guide.md` - Implementation guide (650+ lines)
5. `doc/09_report/jit_sffi_wrapper_2026-02-08.md` - This report
...
test/03_system/features/jit/jit_eval_spec.spl
test/03_system/features/jit/jit_compile_spec.spl
test/03_system/features/jit/exec_manager_spec.spl
test/02_integration/repl_spec.spl
test/02_integration/plugin_system_spec.spl
test/02_integration/hot_reload_spec.spl
