...
Updated `doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_expressions.md`:
...
Created `test/03_system/features/parser/parser_dual_argument_syntax_spec.spl` with 50+ tests covering:
...
2. `doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_expressions.md` - Grammar docs (2 updates)

## Files Created

1. `test/03_system/features/parser/parser_dual_argument_syntax_spec.spl` - Comprehensive test suite (50+ tests)
