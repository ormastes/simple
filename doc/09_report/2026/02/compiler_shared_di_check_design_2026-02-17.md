...
**Date:** 2026-02-17
**Status:** IMPLEMENTED
**Relates to:** `doc/09_report/compiler_shared_extraction_plan_2026-02-17.md`
...
**Location:** `test/01_unit/compiler/compiler_shared_di_check_spec.spl`
...
```bash
bin/simple test test/01_unit/compiler/compiler_shared_di_check_spec.spl
```

Run the full compiler test suite to catch regressions:

```bash
bin/simple test test/01_unit/compiler/
```
