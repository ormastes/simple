...
- **Tests:** `test/01_unit/compiler/closure_capture_warning_spec.spl` (177 lines, 25 tests)
  - Status: PASSING
...
- **Tests:** `test/01_unit/compiler_core/ignored_return_warning_spec.spl` (130 lines, 30 tests)
  - Status: PASSING
  - Uses real implementation, not stubs
...
- **Tests:** `test/01_unit/compiler_core/generic_syntax_spec.spl` (191 lines, 28 tests)
  - Status: PASSING
...
- **Tests:** `test/01_unit/runtime/module_closure_spec.spl` (85 lines, 10 tests)
  - Status: PASSING
...
- **Tests:** `test/01_unit/parser/multiline_bool_spec.spl` (143 lines, 18 tests)
  - Status: PASSING
...
- **Tests:** `test/01_unit/app/doc_coverage/sdoctest_coverage_spec.spl` (76 lines)
  - Status: PASSING
...
- `test/01_unit/app/doc_coverage/inline_comment_coverage_spec.spl` (create, ~150 lines)
...
- `test/01_unit/app/doc_coverage/group_comment_detection_spec.spl` (create, ~100 lines)
...
bin/simple test test/01_unit/compiler/closure_capture_warning_spec.spl --verbose

# Test ignored return warnings
bin/simple test test/01_unit/compiler_core/ignored_return_warning_spec.spl --verbose
