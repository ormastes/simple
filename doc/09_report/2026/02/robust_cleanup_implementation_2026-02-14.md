...
- Lines: 268
- Tests: `test/01_unit/app/test_runner_new/process_tracker_spec.spl` (8 tests)
...
- Lines: 216
- Tests: `test/01_unit/app/test_runner_new/checkpoint_spec.spl` (11 tests)
...
- Lines: 100
- Tests: `test/01_unit/app/test_runner_new/shutdown_spec.spl` (5 tests)
...
bin/simple test test/02_integration/graceful_shutdown_spec.spl

# Test resume from checkpoint
bin/simple test test/02_integration/checkpoint_resume_spec.spl

# Test container cleanup
bin/simple test test/02_integration/container_cleanup_spec.spl
```
...
2. **Tests:**
   - `test/01_unit/app/test_runner_new/process_tracker_spec.spl` (55 lines, 8 tests)
   - `test/01_unit/app/test_runner_new/checkpoint_spec.spl` (118 lines, 11 tests)
...
**Tests:**
- `test/01_unit/app/test_runner_new/process_tracker_spec.spl`
- `test/01_unit/app/test_runner_new/checkpoint_spec.spl`
- `test/01_unit/app/test_runner_new/shutdown_spec.spl`
