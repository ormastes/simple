...
4. `test/03_system/collections/hashmap_basic_spec.spl` - Removed @pending
5. `test/03_system/collections/hashset_basic_spec.spl` - Removed @pending
6. `test/03_system/collections/btree_basic_spec.spl` - Removed @pending
