...
- `doc/07_guide/parser_ffi_guide.md` - Usage guide
...
- `doc/03_plan/module_refactoring_2026-02-04.md` - Module structure
- `doc/09_report/simple_module_unfold_2026-02-04.md` - Module unfold work
- `doc/09_report/release_v0.4.0-beta.5_2026-02-04.md` - Latest release
