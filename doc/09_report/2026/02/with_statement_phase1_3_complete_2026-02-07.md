...
**Test file created:** `test/03_system/with_statement_basic_spec.spl`
...
**Test failure:**
```bash
$ bin/simple_runtime test/03_system/with_statement_basic_spec.spl
...
9. `test/03_system/with_statement_basic_spec.spl` - Test suite
