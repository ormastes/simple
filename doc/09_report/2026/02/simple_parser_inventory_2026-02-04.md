...
Located in `test/03_system/parser/`:
...
- **Syntax guide:** `doc/07_guide/quick_reference/syntax_quick_reference.md`
- **Parser API:** `doc/api/parser.md` (TODO)
- **Error codes:** `doc/07_guide/error_codes.md` (TODO)

### Developer Documentation

- **Architecture:** `doc/04_architecture/parser.md` (TODO)
...
# Run parser tests
simple test test/03_system/parser/
...
- **This report:** `doc/09_report/simple_parser_inventory_2026-02-04.md`
- **Rust removal:** `doc/09_report/parser_removal_2026-02-04.md`
- **FFI guide:** `doc/07_guide/parser_ffi_guide.md` (TODO)
- **Migration status:** `doc/03_plan/rust_parser_migration.md` (TODO)
