...
**Location:** `test/03_system/feature/alias_deprecated_spec.spl:99-107`
...
1. **`doc/07_guide/quick_reference/syntax_quick_reference.md`**
...
- Tests (stubs): `test/03_system/feature/alias_deprecated_spec.spl`
