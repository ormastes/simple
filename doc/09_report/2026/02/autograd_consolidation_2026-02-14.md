...
test/01_unit/lib/pure/*.spl:         use lib.pure.autograd (Tensor, ...)
```
...
```bash
# All tests pass
bin/simple test test/01_unit/lib/pure/
# Results: 10 total, 10 passed, 0 failed

# Specific autograd tests
test/01_unit/lib/pure/autograd_spec.spl          ✅ PASS (1 test, 6ms)
test/01_unit/lib/pure/autograd_extended_spec.spl ✅ PASS (1 test, 5ms)
test/01_unit/lib/pure/nn_spec.spl                ✅ PASS (1 test, 6ms)
test/01_unit/lib/pure/nn_extended_spec.spl       ✅ PASS (1 test, 6ms)
test/01_unit/lib/pure/training_spec.spl          ✅ PASS (1 test, 6ms)
test/01_unit/lib/pure/training_extended_spec.spl ✅ PASS (1 test, 4ms)
```
...
- `doc/09_report/autograd_global_store_solution_2026-02-06.md`
