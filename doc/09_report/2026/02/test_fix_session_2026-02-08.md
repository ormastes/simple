...
#### 3. `test/02_integration/cli_dispatch_spec.spl`
...
**Verified:** `test/02_integration/import_syntax_spec.spl` (5/5 tests passing)
...
- `test/02_integration/cli_dispatch_spec.spl` - Fixed imports, enabled tests
