...
**Unit Tests:**
- `test/01_unit/compiler_core/module_loader_spec.spl` - 60 tests
...
**Integration Tests:**
- `test/02_integration/imports_spec.spl` - 40 tests
...
**Tests:**
- `test/01_unit/compiler_core/module_loader_spec.spl` - Loader tests
- `test/02_integration/imports_spec.spl` - Import integration

**Documentation:**
- `doc/07_guide/module_imports.md` - User guide
- `doc/07_guide/module_system.md` - System architecture
...
- Report: `doc/09_report/import_system_update_2026-02-09.md`
