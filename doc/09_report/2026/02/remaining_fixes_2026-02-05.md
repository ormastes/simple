...
#### File 2: `test/02_integration/database_e2e_spec.spl` (2 fixes)
- **Lines fixed:** 133, 134
...
#### File 5: `test/03_system/features/enums/enums_spec.spl` (4 fixes)
...
| `test/02_integration/database_e2e_spec.spl` | Enum | 2 enum fixes |
...
| `test/03_system/features/enums/enums_spec.spl` | Enum | 4 enum fixes |
