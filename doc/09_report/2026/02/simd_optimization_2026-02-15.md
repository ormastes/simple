...
**`test/01_unit/std/simd_spec.spl`** (New, ~300 tests)
...
**`test/05_perf/bench/simd_bench.spl`** (New, ~20 benchmarks)
...
bin/simple test test/01_unit/std/simd_spec.spl --feature=sse
bin/simple test test/01_unit/std/simd_spec.spl --feature=avx2
bin/simple test test/01_unit/std/simd_spec.spl --feature=avx512

# ARM testing
bin/simple test test/01_unit/std/simd_spec.spl --target=aarch64 --feature=neon
```
...
**Tests:**
- `test/01_unit/std/simd_spec.spl` - SIMD intrinsics tests
- `test/05_perf/bench/simd_bench.spl` - Performance benchmarks
