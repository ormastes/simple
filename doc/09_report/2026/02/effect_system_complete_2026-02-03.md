...
- **Plan:** `doc/03_plan/effect_system_implementation_plan.md`
- **Roadmap:** `doc/03_plan/rust_feature_parity_roadmap.md` (Phase 3)
- **Phase 3A Report:** `doc/09_report/effect_system_phase3a_completion_2026-02-03.md`
