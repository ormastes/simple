...
# Run affected tests
bin/simple test test/01_unit/std/repr_spec.spl
bin/simple test test/01_unit/std/process_monitor_spec.spl
bin/simple test test/01_unit/std/spec_framework_spec.spl
```
