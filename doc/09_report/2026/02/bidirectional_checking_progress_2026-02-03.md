...
**File:** `doc/05_design/bidirectional_type_checking_design.md`
...
- ✅ `doc/05_design/bidirectional_type_checking_design.md` - Complete design
- ✅ `doc/03_plan/rust_feature_parity_roadmap.md` - Overall plan
