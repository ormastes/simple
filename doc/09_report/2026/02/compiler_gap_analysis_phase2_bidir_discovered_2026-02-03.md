...
### Original Plan (from doc/03_plan/bidirectional_type_checking_plan.md)
...
Per `doc/09_report/bidirectional_checking_progress_2026-02-03.md`:
...
3. **Original Plan:** `doc/03_plan/bidirectional_type_checking_plan.md` (700 lines)
