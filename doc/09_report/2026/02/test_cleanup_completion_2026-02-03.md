...
**Example locations:**
```
test/03_system/interpreter/sample/python_inspired_sample/*.py
test/03_system/compiler/sample/python_inspired_sample/*.py
```
...
**Distribution:**
```
test/03_system/features/          ~300 files
test/03_system/compiler/          ~200 files
test/03_system/interpreter/       ~150 files
test/01_unit/                     ~50 files
test/02_integration/              ~30 files
