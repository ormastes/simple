...
**Task:** Expand `test/01_unit/compiler/closure_capture_warning_spec.spl`
...
bin/simple test test/01_unit/compiler/     # Closure warnings
bin/simple test test/01_unit/compiler_core/         # Generic + ignored return
bin/simple test test/01_unit/parser/       # Multiline bool
bin/simple test test/01_unit/runtime/      # Module closures
```
...
**Tests:**
- `test/01_unit/compiler/closure_capture_warning_spec.spl` (150+ lines)
- `test/01_unit/compiler_core/ignored_return_warning_spec.spl` (124 lines - done)
- `test/01_unit/compiler_core/generic_syntax_spec.spl` (191 lines - done)
- `test/01_unit/parser/multiline_bool_spec.spl` (143 lines - done)
- `test/01_unit/runtime/module_closure_spec.spl` (85 lines - done)

**Documentation:**
- `doc/09_report/analysis_status_2026-02-14.md` (done)
- `doc/09_report/implementation_plan_2026-02-14.md` (this file)
- `doc/09_report/module_closure_investigation_2026-02-14.md` (done)
- `doc/09_report/module_closure_resolution_2026-02-14.md` (done)
