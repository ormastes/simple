...
6. **`doc/07_guide/sync_async/async/async_runtime_guide.md`** ✅
...
- `doc/07_guide/sync_async/async/async_runtime_guide.md`
- `doc/09_report/async_two_tier_implementation_2026-02-05.md` (this file)
