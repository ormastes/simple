...
### 4. Implementation Guide (`doc/07_guide/http_implementation_guide.md`)
...
4. `doc/07_guide/http_implementation_guide.md` - Implementation guide (550+ lines)
5. `doc/09_report/http_sffi_wrapper_2026-02-08.md` - This report
...
test/02_integration/http_client_spec.spl
test/02_integration/rest_api_spec.spl
test/02_integration/http_server_spec.spl
test/02_integration/websocket_spec.spl
test/02_integration/file_sync_spec.spl
