...
- **Report:** `doc/09_report/ffi_wrapper_audit_2026-02-03.md`
...
**Report:** `doc/09_report/module_export_fixes_2026-02-03.md`
...
#### 3.1 Macro System
- **Test:** `test/03_system/features/parser/parser_functions_spec.spl:255`
...
```bash
$ ./bin/simple test --no-rust-tests test/03_system/features/parser/
✓ Parser tests: 55/55 passing
✓ No undefined symbol warnings
✓ All FFI wrapper imports work

$ ./bin/simple test --no-rust-tests test/03_system/compiler/
