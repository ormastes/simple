...
**Documentation:**
- `doc/09_report/module_export_fixes_2026-02-03.md` (this file)

## Related Fixes

These fixes are related to earlier FFI wrapper export fixes:
- `doc/09_report/ffi_wrapper_audit_2026-02-03.md` - FFI wrapper exports
- `doc/09_report/parser_compiler_test_summary_2026-02-03.md` - Parser/compiler status
