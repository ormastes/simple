...
| File | Tests | Purpose |
|------|-------|---------|
| `test/03_system/collections/set_literal_spec.spl` | 17 tests | Basic set literal functionality |
| `test/compiler/config/literal_config_spec.spl` | 7 tests | Configuration loading |
| `test/03_system/collections/custom_literal_spec.spl` | 2 tests | Custom literal types |
...
| File | Pages | Purpose |
|------|-------|---------|
| `doc/07_guide/collection_literals.md` | ~8 pages | User guide with examples |
| `doc/07_guide/simple.config.example.sdn` | ~1 page | Configuration reference |
...
bin/simple test test/03_system/collections/

# Run config tests
bin/simple test test/compiler/config/

# Run specific set literal tests
bin/simple test test/03_system/collections/set_literal_spec.spl
```
