...
**Deleted**:
- `test/03_system/features/aop/aop_around_advice_spec.spl.skip`
- `test/03_system/features/aop/aop_pointcut_spec.spl.skip`
- `test/03_system/features/aop/aop_spec.spl.skip`
...
bugs |id, severity, status, title, file, line, description, reproducible_by|
    example_001, P1, confirmed, "Short title", "src/app/cli/main.spl", 42, "Detailed description with steps to reproduce", "test/02_integration/example_spec.spl"
```
