...
./bin/simple test test/03_system/collections/hashmap_basic_spec.spl
./bin/simple test test/03_system/collections/hashset_basic_spec.spl
./bin/simple test test/03_system/collections/btree_basic_spec.spl
```
