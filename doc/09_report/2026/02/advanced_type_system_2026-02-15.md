...
**Unit Tests (Planned):**
- `test/01_unit/type/runtime_generics_spec.spl` - 100 tests
...
**Tests:**
- `test/01_unit/type/runtime_generics_spec.spl` - Generic tests (planned)
- `test/01_unit/type/union_types_spec.spl` - Union tests (planned)
- `test/01_unit/type/intersection_types_spec.spl` - Intersection tests (planned)
- `test/01_unit/type/refinement_types_spec.spl` - Refinement tests (planned)

**Documentation:**
- `doc/07_guide/advanced_types.md` - User guide
