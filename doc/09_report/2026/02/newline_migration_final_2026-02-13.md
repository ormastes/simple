...
5. **Agent 5** (test/compiler/ + test/01_unit/) - 110 files, ~350 occurrences ✅
6. **Agent 6** (test/03_system/feature/ + test/02_integration/ + test/lib/) - 52 files, 367 occurrences ✅
...
- `test/01_unit/std/newline_constants_spec.spl` - Tests NL constant behavior
...
```bash
bin/simple test test/01_unit/std/newline_constants_spec.spl
...
- `test/02_integration/e2e/` - 132 files
- `test/compiler_complete/` - 100 files
- `test/03_system/feature/` - 76 files
