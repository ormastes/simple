...
### Documentation
- `doc/05_design/sffi_external_library_pattern.md` - Three-tier pattern
- `doc/07_guide/quick_reference/wrapper_gen_quick_start.md` - Generator usage
- `doc/07_guide/quick_reference/sffi_external_libraries_quick_start.md` - SFFI setup
