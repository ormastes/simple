...
- ✅ `test/01_unit/compiler_core/lexer_spec.spl` - Lexer with shared char functions
- ✅ `test/01_unit/compiler_core/interpreter/` - 8 tests, all passing (eval.spl changes)
- ✅ `test/01_unit/compiler_core/type_subst_spec.spl` - Type substitution still works
