...
**Testing:**
```bash
$ bin/simple test test/01_unit/std/string_spec.spl
Simple Test Runner v0.4.0
Running 1 test file(s) [mode: interpreter]...
  PASS  test/01_unit/std/string_spec.spl (1 passed, 4ms)
All tests passed! ✅

$ bin/simple test test/01_unit/std/
Running 223 test file(s) [mode: interpreter]...
  PASS  test/01_unit/std/actor_body_spec.spl (1 passed, 5ms)
  PASS  test/01_unit/std/algorithm_utils_ext_spec.spl (1 passed, 5ms)
  ... ✅
```
...
# Test with coverage
bin/simple test test/01_unit/std/string_spec.spl --coverage

# Measure load time
time bin/simple test test/01_unit/std/string_spec.spl
```
