...
`test/03_system/error_path/error_path_100_system_spec.spl` exposed unstable loop-control behavior in generated system-test lanes while stabilizing the fail-fast suite.
