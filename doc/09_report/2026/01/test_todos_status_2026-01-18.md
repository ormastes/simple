...
**File:** `simple/std_lib/test/01_unit/compiler_core/collections_spec.spl`
...
./target/debug/simple test simple/std_lib/test/01_unit/verification/regeneration_spec.spl

# Verify collections tests still skip properly
./target/debug/simple test simple/std_lib/test/01_unit/compiler_core/collections_spec.spl
