...
Generates:
- `doc/02_requirements/feature/feature_db.sdn` - Database
- `doc/02_requirements/feature/feature.md` - Category index
- `doc/02_requirements/feature/pending_feature.md` - Incomplete features (NEW!)
- `doc/02_requirements/feature/category/*.md` - Per-category lists
...
**All features?**
```bash
cat doc/02_requirements/feature/feature.md
```
Updated every test run
...
| `doc/02_requirements/feature/pending_feature.md` | `simple test` | **Every test run** |
| `doc/02_requirements/feature/feature.md` | `simple test` | **Every test run** |
...
[test output]
$ ls doc/02_requirements/feature/pending_feature.md
doc/02_requirements/feature/pending_feature.md  ← Generated!
```
...
- Quick view: `doc/02_requirements/feature/pending_feature.md`
...
Full documentation in `doc/09_report/`:
...
simple test
# → doc/02_requirements/feature/*.md including pending_feature.md
