...
**File:** `doc/07_guide/sspec_complete_example.md`
...
cargo run --bin gen-sspec-docs -- \
  simple/test/03_system/features/**/*_spec.spl
```
...
- Examples:
  - `simple/test/03_system/features/weak_pointers/weak_pointers_spec.spl`
  - `simple/test/03_system/features/traits/traits_spec.spl`
  - `simple/test/03_system/features/type_inference/type_inference_spec.spl`
...
**Use for:** Feature specs in `simple/test/03_system/features/`
...
**Command:**
```bash
cargo run --bin gen-sspec-docs -- simple/test/03_system/features/**/*_spec.spl
```
...
3. `doc/07_guide/sspec_complete_example.md` - Complete workflow example
4. `doc/09_report/SSPEC_DOCUMENTATION_IMPROVEMENTS_2026-01-16.md` - This file
