...
**File:** `doc/01_research/statement_container_grammars.md`
**Size:** 668 lines
**Content:**
...
**File:** `doc/01_research/code_shortening_grammar_analysis.md`
**Size:** 1,539 lines
**Content:**
...
Updated files:
- `doc/01_research/README.md` - Added 2 new research documents
- `doc/01_research/statement_container_grammars.md` - Cross-linked to analysis
- `doc/01_research/code_shortening_grammar_analysis.md` - Appended unified design
...
- [`doc/01_research/code_shortening_grammar_analysis.md`](../research/code_shortening_grammar_analysis.md)
- [`doc/01_research/statement_container_grammars.md`](../research/statement_container_grammars.md)
- [`doc/06_spec/syntax.md`](../spec/syntax.md)
- [`doc/06_spec/app/compiler/modules/parser/lexer_parser_grammar_expressions.md`](../spec/parser/lexer_parser_grammar_expressions.md)
