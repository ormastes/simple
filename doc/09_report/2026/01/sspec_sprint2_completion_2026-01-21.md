...
8. **simple/test/02_integration/spec/runner_spec.spl** (6,823 bytes)
   - 60+ integration tests for runner

9. **simple/test/02_integration/spec/formatter_spec.spl** (8,127 bytes)
   - 40+ integration tests for formatters

### Documentation

10. **doc/03_plan/28_bdd_spec.md** (updated)
