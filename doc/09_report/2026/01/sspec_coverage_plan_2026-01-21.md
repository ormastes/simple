...
- ✅ Language features: 87 tests in `simple/test/03_system/features/`
- ✅ Compiler/Interpreter: 13 tests
- ✅ Macros, mixins, SDN: 44 tests in `simple/std_lib/test/03_system/`
...
|-----------|----------|---------|--------|
| **Unit** | `simple/std_lib/test/01_unit/` | Individual function behavior | Good (318 tests) |
| **Feature** | `simple/std_lib/test/features/` | Feature documentation + basic tests | Good (116 tests) |
| **System** | `simple/test/03_system/` | End-to-end workflows | **Gaps identified** |
| **Integration** | `simple/std_lib/test/02_integration/` | Cross-module integration | Needs expansion |

## Phase 1: Collections System Tests (High Priority)

### 1.1 HashMap Integration Workflows
**File:** `simple/test/03_system/collections/hashmap_workflows_spec.spl`
...
**File:** `simple/test/03_system/collections/hashset_workflows_spec.spl`
...
**File:** `simple/test/03_system/collections/btree_workflows_spec.spl`
...
**File:** `simple/test/03_system/process/process_workflows_spec.spl`
...
**File:** `simple/test/03_system/integration/process_file_integration_spec.spl`
...
**File:** `simple/test/03_system/networking/tcp_integration_spec.spl`
...
**File:** `simple/test/03_system/networking/http_integration_spec.spl`
...
**File:** `simple/test/03_system/infrastructure/hash_workflows_spec.spl`
...
**File:** `simple/test/03_system/integration/full_application_spec.spl`
...
**File:** `simple/test/03_system/mixins/mixin_integration_advanced_spec.spl`
