...
```bash
$ ./target/debug/simple_old test test/03_system/features/operators/matrix_multiplication_spec.spl
...
### File: `test/03_system/features/operators/floor_division_fdiv_spec.spl`
...
| File | Tests | Status |
|------|-------|--------|
| `test/03_system/features/operators/matrix_multiplication_spec.spl` | 37 | ✅ All pass |
| `test/03_system/features/operators/floor_division_fdiv_spec.spl` | 55 | ⏳ Pending .fdiv() |
...
- See doc/09_report/parallel_operator_breaking_change_2026-01-30.md
