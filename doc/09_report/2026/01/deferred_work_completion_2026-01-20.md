...
**File:** `doc/09_report/deferred_work_tracking_2026-01-20.md`
**Size:** ~500 lines
...
**File:** `simple/std_lib/test/01_unit/tooling/test_args_spec.spl`
...
**File:** `doc/06_spec/ffi_stubs_needed.md`
**Size:** ~400 lines
...
**File:** `doc/07_guide/migration_pattern_cookbook.md`
**Size:** ~600 lines
