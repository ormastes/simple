...
### 2. Tests
**File:** `simple/std_lib/test/01_unit/tooling/i18n_commands_spec.spl` (238 lines)
...
```bash
$ ./target/debug/simple test simple/std_lib/test/01_unit/tooling/i18n_commands_spec.spl
...
