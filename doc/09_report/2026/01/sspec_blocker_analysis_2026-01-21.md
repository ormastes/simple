...
**Example:** `simple/std_lib/test/01_unit/compiler_core/arithmetic_spec.spl`
```simple
import std.spec
...
```
simple/test/03_system/compiler/
...
### Test Command
```bash
./target/debug/simple test simple/test/03_system/compiler/severity_spec.spl
```
...
### Test Execution
```bash
$ ./target/debug/simple test simple/test/03_system/compiler/effects_core_spec.spl
...
### All 9 Modules
```bash
$ ./target/debug/simple test simple/test/03_system/compiler/
...
$ ./target/debug/simple test simple/test/03_system/math/
...
1. **Fix imports** (2 minutes)
   ```bash
   sed -i 's/^import sspec$/import spec/' simple/test/03_system/compiler/*_spec.spl simple/test/03_system/math/*_spec.spl
   sed -i 's/sspec\.expect/expect/g' simple/test/03_system/compiler/*_spec.spl simple/test/03_system/math/*_spec.spl
   ```
