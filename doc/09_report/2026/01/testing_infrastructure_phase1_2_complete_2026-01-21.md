...
**Related Plan:** `doc/03_plan/testing_infrastructure_implementation_plan.md`
...
**Location:** `doc/07_guide/benchmarking.md` (~250 lines)
...
**Location:** `doc/07_guide/smoke_testing.md` (~200 lines)
...
### 1. Benchmark Spec
**Location:** `simple/std_lib/test/01_unit/testing/benchmark_spec.spl`
...
### 2. Smoke Test Spec
**Location:** `simple/std_lib/test/01_unit/testing/smoke_test_spec.spl`
