...
**Verification**:
```bash
./target/release/simple simple/std_lib/test/01_unit/compiler_core/json_spec.spl
...
4. `simple/std_lib/test/01_unit/concurrency/promise_spec.spl` - Fixed raise→reject

### Tests (1 file)
1. `simple/std_lib/test/01_unit/ui/vulkan_renderer_spec.spl` - Updated sync calls

### Documentation (5 files)
1. `doc/09_report/COMPILATION_FIX_2026-01-05.md` - Compilation fixes
2. `doc/09_report/SKIPPED_TESTS_2026-01-05.md` - Skip inventory
3. `doc/09_report/TEST_RESULTS_2026-01-05.md` - Test run results
4. `doc/09_report/TEST_FIXES_2026-01-05_PART2.md` - Test fixes
5. `doc/09_report/FINAL_TEST_STATUS_2026-01-05.md` - This file
