...
### Feature Database (`doc/02_requirements/feature/pending_feature.md`)
...
**Status:** Designed in `doc/01_research/build_error_database_design_2026-01-21.md`
...
| **Feature** | `simple test` | `doc/02_requirements/feature/feature_db.sdn` | `doc/02_requirements/feature/*.md` | Every test run |
...
- `doc/01_research/test_timing_database_research_2026-01-21.md` - Design research
- `doc/01_research/build_error_database_design_2026-01-21.md` - Build DB design
- `doc/01_research/database_ecosystem_overview_2026-01-21.md` - Unified overview
