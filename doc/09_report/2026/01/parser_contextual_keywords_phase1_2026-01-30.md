...
**Files:**
- `test/03_system/features/parser/parser_skip_keyword_spec.spl`
- `test/03_system/features/parser/parser_default_keyword_spec.spl`
- `test/03_system/features/parser/parser_static_keyword_spec.spl`
...
- **Plan:** `doc/03_plan/parser_treesitter_fixes_plan.md`
- **Test Report:** `doc/09_report/test_failure_report_2026-01-30.md`
