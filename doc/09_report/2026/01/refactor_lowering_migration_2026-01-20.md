...
**Test File**: `simple/std_lib/test/01_unit/tooling/refactor_lowering_spec.spl`
...
2. `simple/std_lib/test/01_unit/tooling/refactor_lowering_spec.spl` (5 lines)
3. `doc/09_report/refactor_lowering_migration_2026-01-20.md` (this file)
