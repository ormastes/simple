...
- ✅ `simple/std_lib/test/01_unit/sdn/lexer_spec.spl` - 25 examples load (all skipped as intended)
...
./target/debug/simple simple/std_lib/test/01_unit/sdn/lexer_spec.spl
