...
### 2. Tests
**File:** `simple/std_lib/test/01_unit/tooling/env_commands_spec.spl` (115 lines)
...
```bash
$ ./target/debug/simple test simple/std_lib/test/01_unit/tooling/env_commands_spec.spl
...
