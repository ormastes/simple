...
**Location:** `test/03_system/features/type_inference/dyn_trait_spec.spl`
...
**Location:** `test/03_system/features/type_inference/transitive_mixin_spec.spl`
...
### SSpec Test Files (2)
- `test/03_system/features/type_inference/dyn_trait_spec.spl` - NEW (11 scenarios)
- `test/03_system/features/type_inference/transitive_mixin_spec.spl` - NEW (12 scenarios)
...
./target/debug/simple_old test test/03_system/features/type_inference/dyn_trait_spec.spl
./target/debug/simple_old test test/03_system/features/type_inference/transitive_mixin_spec.spl
```
