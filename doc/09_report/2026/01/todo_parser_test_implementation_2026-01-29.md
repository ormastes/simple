...
**File:** `test/02_integration/todo_parser_cli_test.spl`
...
./target/debug/simple_old test test/02_integration/todo_parser_cli_test.spl
# Result: 3 passed
```
...
3. `test/02_integration/todo_parser_cli_test.spl` - Integration tests
...
- **Integration:** `test/02_integration/todo_parser_cli_test.spl`
