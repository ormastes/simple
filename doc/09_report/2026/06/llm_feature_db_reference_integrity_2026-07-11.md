...
- required_gates: `all_referenced_paths_exist,stale_slang_generated_spec_paths_absent`
- blocked_gates: `none`
- primary_blocked_gate: `none`
- rows_checked: `11`
- paths_checked: `292`
- missing_count: `0`
- stale_slang_path_count: `0`
...
This evidence verifies that LLM-related feature database rows reference existing local repository paths and that the known Slang generated-spec docs stay on their real `doc/06_spec/test/01_unit/...` locations.
