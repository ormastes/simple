...
| svllm_local | `fail` | `pass` | `124` | `build/llm_goal_evidence/svllm_local.log` |
...
| svllm_local | `native_read_range,pinned_buffer,device_staging` | `lane_timeout` | `lane_timeout_20s` |
