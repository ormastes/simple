...
- widget RenderDoc goal: incomplete (electron-widget-renderdoc-gpu-process-crashed-under-renderdoc; blocked 1)
...
- gui_renderdoc_feature_coverage_reason=electron-widget-renderdoc-gpu-process-crashed-under-renderdoc
...
- native_render_log_platform_matrix_source_revision=@  657d7793032c │ ~
...
- gui_web_2d_evidence_source_revision=@  657d7793032c │ ~
...
- linux_vulkan_render_log_compare_renderdoc_chrome_autocapture_status=not-started
...
- linux_vulkan_render_log_compare_renderdoc_chrome_egl_initialize_return_count=0
- linux_vulkan_render_log_compare_renderdoc_chrome_egl_initialize_success_count=0
...
- linux_vulkan_render_log_compare_renderdoc_chrome_egl_initialize_last_error=-1
...
- linux_vulkan_render_log_compare_renderdoc_chrome_vk_enum_instance_extension_count=1
- linux_vulkan_render_log_compare_renderdoc_chrome_vk_create_instance_count=0
- linux_vulkan_render_log_compare_renderdoc_chrome_vk_create_device_count=0
...
- linux_vulkan_render_log_compare_renderdoc_electron_autocapture_status=not-started
...
- linux_vulkan_render_log_compare_renderdoc_electron_egl_initialize_return_count=0
- linux_vulkan_render_log_compare_renderdoc_electron_egl_initialize_success_count=0
...
- linux_vulkan_render_log_compare_renderdoc_electron_egl_initialize_last_error=-1
...
- linux_vulkan_render_log_compare_renderdoc_electron_vk_enum_instance_extension_count=1
- linux_vulkan_render_log_compare_renderdoc_electron_vk_create_instance_count=0
- linux_vulkan_render_log_compare_renderdoc_electron_vk_create_device_count=0
...
- simple_renderdoc_gate_env=build/gui-renderdoc-feature-coverage-static-cache/renderdoc-goal-status-c4e13286952a34af/simple-gate/evidence.env
...
- macos_portability_evidence_env=build/gui-renderdoc-feature-coverage-static-cache/renderdoc-goal-status-c4e13286952a34af/macos-probe/evidence.env
