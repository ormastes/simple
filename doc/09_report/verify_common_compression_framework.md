...
[PASS] test/01_unit/lib/common/compress_framework_spec.spl:1 — focused facade
tests align with the current checked/fail-fast API surface.
[PASS] test/01_unit/lib/common/lz4_spec.spl:1 — focused LZ4 tests cover
block/frame round-trip behavior, corruption typing, and forced-tier parity.
[PASS] test/01_unit/lib/common/lzma2_range_coded_spec.spl:1 — pure-Simple LZMA
range decode round-trips host `xz -z --check=crc32` outputs across the focused
fixture set.
[PASS] test/01_unit/lib/common/xz_lzma2_spec.spl:1 — focused XZ/LZMA2 tests cover
emitted-stream interoperability, concatenated streams, and host-`xz` fixtures
for the landed subset.
[PASS] test/01_unit/lib/common/zstd_fse_huffman_weight_encode_spec.spl:1 — the
...
design.
[WARN] test/01_unit/lib/common/zstd_frame_variants_spec.spl:1 — this broader Zstd
...
- `bin/simple test test/01_unit/lib/common/lz4_spec.spl` → Passed: 20, Failed: 0
- `bin/simple test test/01_unit/lib/common/lzma2_range_coded_spec.spl` →
  Passed: 4, Failed: 0
- `bin/simple test test/01_unit/lib/common/xz_lzma2_spec.spl` →
  Passed: 20, Failed: 0
- `bin/simple test test/01_unit/lib/common/zstd_fse_huffman_weight_encode_spec.spl`
  → Passed: 7, Failed: 0
