...
- `streebog.spl` now matches the byte-exact known-answer vectors exercised by
  [test/01_unit/os/crypto/streebog_kat_spec.spl](/home/ormastes/dev/pub/simple/test/01_unit/os/crypto/streebog_kat_spec.spl).
- `ocb3.spl` now supports full-block decrypt and passes both RFC-anchored
  ...
  [test/01_unit/os/crypto/ocb3_spec.spl](/home/ormastes/dev/pub/simple/test/01_unit/os/crypto/ocb3_spec.spl).
...
- `bin/simple test test/01_unit/os/crypto/streebog_kat_spec.spl`
- `bin/simple test test/01_unit/os/crypto/ocb3_spec.spl`
- `bin/simple test test/01_unit/os/crypto/crc32_kat_spec.spl`
- `bin/simple test test/01_unit/lib/common/lz4_spec.spl`
