...
- `test/05_perf/net_driver_logic_bench.spl` now benchmarks 11 pure virtqueue and
  layout arithmetic paths.
- `test/05_perf/ipc_l4_logic_bench.spl` compares current IPC queue logic with
...
- `test/05_perf/run_net_driver_logic_parity_bench.shs` builds a C reference with
...
`bin/simple run test/05_perf/net_driver_logic_bench.spl` completed with
`status=0`.
...
`bin/simple run test/05_perf/ipc_l4_logic_bench.spl` completed with `status=0`.
...
test/05_perf/run_net_driver_logic_parity_bench.shs` completed successfully.
...
- `bin/simple check src/compiler/60.mir_opt/mir_opt/loop_strength.spl
  test/01_unit/compiler/mir_opt/strength_reduction_spec.spl
  test/05_perf/net_driver_logic_bench.spl
  test/05_perf/ipc_l4_logic_bench.spl
  test/05_perf/net_driver_logic_native_bench.spl` passed.
- `bin/simple test test/01_unit/compiler/mir_opt/strength_reduction_spec.spl`
  passed: 2 examples, 0 failures.
- `bash -n test/05_perf/run_net_driver_logic_parity_bench.shs
