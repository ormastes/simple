...
```sh
RESOLUTION=4k TIMEOUT_SECS=20 \
BUILD_DIR=build/widget-showcase-4k-200fps-current-20260628 \
  sh scripts/check/check-widget-showcase-4k-200fps.shs

RESOLUTION=8k TIMEOUT_SECS=20 \
BUILD_DIR=build/widget-showcase-8k-perf-current-20260628 \
  sh scripts/check/check-widget-showcase-4k-200fps.shs

GUI_SHOWCASE_4K_PERF_ENV=build/widget-showcase-4k-200fps-current-20260628/status.env \
GUI_SHOWCASE_8K_PERF_ENV=build/widget-showcase-8k-perf-current-20260628/status.env \
BUILD_DIR=build/widget-showcase-current-aggregate-20260628 \
REPORT_PATH=build/widget-showcase-current-aggregate-20260628/report.md \
...
- fallback_state: `none`
- alias_src: `build/widget-showcase-4k-200fps-current-20260628/widget_showcase_4k_perf.spl`
...
- native_build_mode: `aggressive-native`
- fallback_state: `none`
- alias_src: `build/widget-showcase-8k-perf-current-20260628/widget_showcase_8k_perf.spl`
