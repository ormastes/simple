...
- formal_lean_proofs_log: build/simpleos_hardening_evidence_matrix_prereq_gate/lean_proofs.log
- formal_riscv_dual_track: pass
- formal_riscv_dual_track_log: build/simpleos_hardening_evidence_matrix_prereq_gate/riscv_formal_dual_track.log
- formal_critical_concurrency: pass
- formal_critical_concurrency_log: build/simpleos_hardening_evidence_matrix_prereq_gate/critical_concurrency_formal.log
...
- formal_memory_safety_log: build/simpleos_hardening_evidence_matrix_prereq_gate/memory_safety_formal.log
...
- formal_storage_integrity_log: build/simpleos_hardening_evidence_matrix_prereq_gate/storage_integrity_formal.log
...
- formal_boundary_integrity_log: build/simpleos_hardening_evidence_matrix_prereq_gate/boundary_integrity_formal.log
...
- formal_compiler_language_log: build/simpleos_hardening_evidence_matrix_prereq_gate/compiler_language_formal.log
...
- formal_ui_policy_log: build/simpleos_hardening_evidence_matrix_prereq_gate/ui_policy_formal.log
...
- formal_coverage_log: build/simpleos_hardening_evidence_matrix_prereq_gate/formal_coverage.log
...
- byl_sby_artifact_audit_log: build/simpleos_hardening_evidence_matrix_prereq_gate/byl_sby_artifact_audit.log
...
- riscv_rtl_sby_proof_log: build/simpleos_hardening_evidence_matrix_prereq_gate/riscv_rtl_sby_proof.log
