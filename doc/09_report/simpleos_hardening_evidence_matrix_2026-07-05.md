...
- mission_critical_release_blockers: hardening_matrix,riscv_rtl_sby_proof,mission_critical_prereqs
...
- passed: 22/25
- blocked_rows: executable_launch_from_fs,ssh_shell_smf_and_exec,qemu_wm_simple_gui_mdi
...
- formal_lean_proofs_log: build/simpleos_hardening_evidence_matrix/lean_proofs.log
- formal_riscv_dual_track: pass
- formal_riscv_dual_track_log: build/simpleos_hardening_evidence_matrix/riscv_formal_dual_track.log
- formal_critical_concurrency: pass
- formal_critical_concurrency_log: build/simpleos_hardening_evidence_matrix/critical_concurrency_formal.log
...
- formal_memory_safety_log: build/simpleos_hardening_evidence_matrix/memory_safety_formal.log
...
- formal_storage_integrity_log: build/simpleos_hardening_evidence_matrix/storage_integrity_formal.log
...
- formal_boundary_integrity_log: build/simpleos_hardening_evidence_matrix/boundary_integrity_formal.log
...
- formal_process_resource_lifecycle_log: build/simpleos_hardening_evidence_matrix/boundary_integrity_formal.log
...
- formal_coroutine_resource_bounds_log: build/simpleos_hardening_evidence_matrix/critical_concurrency_formal.log
...
- formal_compiler_language_log: build/simpleos_hardening_evidence_matrix/compiler_language_formal.log
...
- formal_ui_policy_log: build/simpleos_hardening_evidence_matrix/ui_policy_formal.log
...
- formal_coverage_log: build/simpleos_hardening_evidence_matrix/formal_coverage.log
...
- byl_sby_artifact_audit_log: build/simpleos_hardening_evidence_matrix/byl_sby_artifact_audit.log
...
- riscv_rtl_sby_proof_log: build/simpleos_hardening_evidence_matrix/riscv_rtl_sby_proof.log
