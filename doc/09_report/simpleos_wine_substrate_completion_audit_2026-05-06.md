...
| Phase 0 capability gate | `src/lib/common/wine_substrate.spl`, `test/lib/common/wine_substrate_spec.spl`; process-backed evidence now requires Browser Demo, Hello World, Editor, Terminal, and File Manager markers | Done |
...
| CPU/dispatch evidence | `src/lib/common/wine_cpu_exec.spl` exposes structured execution evidence for thread context, user stack, entrypoint mapping, import thunks, stdout handle, exit trap, no-native-jump policy, x86_64 decoder, and x86_64 dispatch; `wine_hello_exe_probe_manifest_evidence` accepts this typed evidence on the manifest path. | Verified as modeled precondition |

## Verification Evidence

- `bin/simple test test/lib/common/wine_async_gate_spec.spl --mode=interpreter`: 4 examples, 0 failures.
- `bin/simple test test/lib/common/wine_substrate_spec.spl --mode=interpreter --clean`: 13 examples, 0 failures.
- `bin/simple test doc/06_spec/app/simpleos/feature/simpleos_wine_substrate_spec.spl --mode=interpreter --clean`: 12 examples, 0 failures.
...
- `bin/simple test test/lib/common/wine_image_map_spec.spl --mode=interpreter`: 6 examples, 0 failures.
- `bin/simple test test/lib/common/wine_cpu_exec_spec.spl --mode=interpreter --clean`: 7 examples, 0 failures.
- `bin/simple test test/lib/common/wine_x86_64_decode_spec.spl --mode=interpreter --clean`: 6 examples, 0 failures.
- `bin/simple test test/lib/common/wine_nt_bridge_spec.spl --mode=interpreter --clean`: 9 examples, 0 failures.
- `bin/simple test test/lib/common/wine_hello_dispatch_spec.spl --mode=interpreter --clean`: 9 examples, 0 failures.
- `bin/simple test test/lib/common/wine_hello_exe_spec.spl --mode=interpreter --clean`: 13 examples, 0 failures.
- `bin/simple test test/lib/common/wine_hello_fixture_spec.spl --mode=interpreter --clean`: 1 example, 0 failures.
- `bin/simple test test/lib/common/pe_coff_header_spec.spl --mode=interpreter`: 13 examples, 0 failures.
