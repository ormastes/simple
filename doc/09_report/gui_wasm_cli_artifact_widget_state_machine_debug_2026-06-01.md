...
- output: build/gui_wasm_cli_artifact_widget_state_machine_debug/hello_wasm_gui.wasm
- size bytes: 4380
- magic hex: 0061736d
...
- output: build/gui_wasm_cli_artifact_widget_state_machine_debug/widget_matrix_wasm_gui.wasm
- size bytes: 11152
- magic hex: 0061736d
- version hex: 01000000
- import count: 0
...
- output: build/gui_wasm_cli_artifact_widget_state_machine_debug/builder_matrix_wasm_gui.wasm
- size bytes: 9486
- magic hex: 0061736d
- version hex: 01000000
- import count: 0
...
- Compiled examples/06_io/ui/builder_matrix_wasm_gui.spl -> build/gui_wasm_cli_artifact_widget_state_machine_debug/builder_matrix_wasm_gui.wasm

### hello.compile.out
- Compiled examples/06_io/ui/hello_wasm_gui.spl -> build/gui_wasm_cli_artifact_widget_state_machine_debug/hello_wasm_gui.wasm

### widget_matrix.compile.out
- Compiled examples/06_io/ui/widget_matrix_wasm_gui.spl -> build/gui_wasm_cli_artifact_widget_state_machine_debug/widget_matrix_wasm_gui.wasm
