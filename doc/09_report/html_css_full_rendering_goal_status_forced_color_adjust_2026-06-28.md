# HTML/CSS Full Rendering Goal Status - forced-color-adjust Slice - 2026-06-28

This report records the narrow Simple Web CSS `forced-color-adjust` slice. The
...
```sh
BUILD_DIR=build/html-css-full-rendering-forced-color-adjust \
REPORT_PATH=build/html-css-full-rendering-forced-color-adjust/report.md \
...
- `html_css_full_rendering_goal_implemented_css_total_count=234`
- `html_css_full_rendering_goal_implemented_css_rendered_count=234`
- `html_css_full_rendering_goal_full_css_total_count=394`
- `html_css_full_rendering_goal_full_css_rendered_count=234`
- `html_css_full_rendering_goal_full_css_unrendered_count=160`
- `html_css_full_rendering_goal_unsupported_css_inventory_count=167`
