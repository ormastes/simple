...
- status: fail
- reason: missing-simple-web-font-run-id
- launch policy: unavailable
- proof source artifact:  /  / 
- blur/tolerance used: false

## Raw Evidence
- wm_browser_event_routing_status=fail
- wm_browser_event_routing_reason=missing-simple-web-font-run-id
- wm_browser_event_routing_validation_status=fail
- wm_browser_event_routing_validation_reason=missing-simple-web-font-run-id
- wm_browser_event_routing_launch_mode=fail
- wm_browser_event_routing_renderer_sandboxed=unavailable
- wm_browser_event_routing_gpu_compositing_status=unavailable
- wm_browser_event_routing_webgl_status=unavailable
- wm_browser_event_routing_aetheric_artifact_sha256=
- wm_browser_event_routing_aetheric_readback_source=
- wm_browser_event_routing_aetheric_renderer_producer=
- wm_browser_event_routing_aetheric_pixel_count=
- wm_browser_event_routing_aetheric_pixel_checksum=
...
- wm_browser_event_routing_css_animation_initial_opacity=
- wm_browser_event_routing_css_animation_final_opacity=
- wm_browser_event_routing_css_animation_initial_current_time_ms=
- wm_browser_event_routing_css_animation_final_current_time_ms=
- wm_browser_event_routing_css_animation_motion_observed=
...
- wm_browser_event_routing_font_text=
- wm_browser_event_routing_font_composition_id=
- wm_browser_event_routing_font_identity=
- wm_browser_event_routing_font_family=
- wm_browser_event_routing_font_loaded=
- wm_browser_event_routing_font_frame_event_count=
- wm_browser_event_routing_font_frame_correlation_id=
- wm_browser_event_routing_font_frame_path=
- wm_browser_event_routing_font_frame_width=
- wm_browser_event_routing_font_frame_height=
- wm_browser_event_routing_font_frame_byte_count=
- wm_browser_event_routing_font_frame_actual_size_bytes=
- wm_browser_event_routing_font_frame_pixel_checksum=
- wm_browser_event_routing_font_frame_validated_checksum=
- wm_browser_event_routing_font_frame_nonbackground_pixels=
- wm_browser_event_routing_font_frame_validated_nonbackground_pixels=
- wm_browser_event_routing_font_frame_artifact_status=
- wm_browser_event_routing_simple_composition_receipt_path=
- wm_browser_event_routing_simple_composition_run_id=
- wm_browser_event_routing_simple_composition_artifact_path=
- wm_browser_event_routing_simple_composition_pixel_count=
- wm_browser_event_routing_simple_composition_pixel_checksum=
- wm_browser_event_routing_simple_composition_artifact_size_bytes=
- wm_browser_event_routing_simple_composition_artifact_sha256=
- wm_browser_event_routing_simple_composition_artifact_status=
