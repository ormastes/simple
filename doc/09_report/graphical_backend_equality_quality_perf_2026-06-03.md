...
`test/integration/rendering/graphical_backend_capture_spec.spl`. It records:
...
- `test/system/wm_compare/graphical_backend_equality_spec.spl`: 8 passed, 0 failed.
- `test/integration/rendering/graphical_backend_capture_spec.spl`: 4 passed, 0 failed.
