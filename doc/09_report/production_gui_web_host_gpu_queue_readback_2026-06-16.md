...
- missing device-readback platforms: metal,rocm,directx
...
| webgpu_real | pass | device_readback | device_readback | 0 | handle=1, checksum=1023148974, report=build/production_gui_web_host_gpu_queue_readback/webgpu_real/report.md |
...
| webgpu | pass | pass | same-frame WebGPU device_readback | device_readback/handle=1/checksum=1023148974 |
...
- Runtime backend-handle field roundtrip: pass (synthetic probe handle 7; 72 matching runtime queue handle accessors/fields observed).
...
- BrowserBackend runtime queue handle/payload/perf: pass (backend vulkan, first_render_us 4368358, first_under_budget true, second_render_us 1141, second_under_budget true, pixels 3072, checksum 772887022, nonuniform 2884, handle 1, packet 1, payload_size 12288, payload_hash 782290402, payload_text web-render-frame;backend=vulkan;pixels=3072;checksum=782290402, dispatch dispatched, dispatch_payload_size 512, dispatch_layout_commands 8, dispatch_payload_hash 941781836, dispatch_payload_text draw_ir schema=simple-draw-ir-v2, semantic rect/text/image 4/3/1, gui_ast true, widgets root/copy/action/image true/true/true/true, image_uri true, event_context true/browser-frame-16/gui_ast, cache reset not_requested/0).
...
- Same-frame Vulkan/BrowserBackend device readback receipt: pass (source device_readback; only device_readback is accepted as device proof. BrowserBackend backend handle 1, same-frame checksum 782290402, Vulkan Engine2D child readback pass).
...
- DirectX/WebGPU presentation provenance: DirectX pass source structured_readback_contract; DirectX native gate unavailable, child gate unavailable, wrapper exit 1; WebGPU upload pass source surface_upload; WebGPU real pass source device_readback, handle 1, expected/actual checksum 1023148974/1023148974; provenance guard pass.
...
- browser_first_render_us=4368358
- browser_first_render_under_budget=true
- browser_first_render_dom_layout_us=13156
- browser_first_render_html_us=376
- browser_first_render_pixel_artifact_us=3863987
- browser_first_render_draw_ir_dispatch_us=18004
- browser_first_render_framebuffer_copy_us=38774
- browser_first_render_state_store_us=207
...
- browser_first_backend_handle=1
...
- browser_event_host_gpu_summary=event=browser-input-1;requested=gpu;decision=gpu;queued=true;forwarded=true;backward_completed=true;gpu_batched=true;reason=
- browser_second_render_us=1141
...
- webgpu_real_readback_exit_code=0
- webgpu_real_readback_timeout_seconds=180
- webgpu_real_readback_timed_out=false
- webgpu_real_readback_status=pass
- webgpu_real_readback_reason=webgpu-device-readback-matched
- webgpu_real_readback_source=device_readback
- webgpu_real_readback_backend_handle=1
- webgpu_real_readback_expected_checksum=1023148974
- webgpu_real_readback_actual_checksum=1023148974
...
- queue_concrete_backend_handle_field_count=72
