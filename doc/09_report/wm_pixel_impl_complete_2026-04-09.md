...
- `test/01_unit/lib/common/ppm_decode_spec.spl` -- 20 tests (PPM parsing, error cases)
- `test/01_unit/lib/common/deflate_inflate_spec.spl` -- 16 tests (stored blocks, inflate correctness)
- `test/01_unit/lib/common/png_decode_deflate_spec.spl` -- 14 tests (DEFLATE + filter reconstruction)
- `test/01_unit/os/compositor/electron_capture_ppm_spec.spl` -- 10 tests (PPM path, error handling)
- `test/01_unit/os/compositor/qemu_capture_ppm_spec.spl` -- 14 tests (in-process + VM capture)
- `test/02_integration/rendering/wm_pixel_pipeline_spec.spl` -- 15 tests (end-to-end pipeline)
