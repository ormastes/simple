...
| WPT selector/color subset | partial | `tools/wpt_to_sspec/README.md`; `doc/03_plan/sys_test/wpt_subset_migration.md`; `test/web_platform/css/selector_color_subset_spec.spl` | Adds the first executable 26-case WPT-shaped subset for deterministic selector and color/background pixel behavior. This is a curated subset, not a complete WPT importer or conformance claim. |
