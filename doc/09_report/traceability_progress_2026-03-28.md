...
- Updated the focused spec in [test/01_unit/app/tooling/traceability_spec.spl](/Users/ormastes/simple/test/01_unit/app/tooling/traceability_spec.spl) to use manifest-style inputs instead of direct virtual-file arrays.
- Verified the focused spec passes with the current local binary:
  - `src/compiler_rust/target/bootstrap/simple test test/01_unit/app/tooling/traceability_spec.spl`
...
- Added CLI-facing regression coverage for `traceability-check` in [test/01_unit/app/cli/traceability_command_spec.spl](/Users/ormastes/simple/test/01_unit/app/cli/traceability_command_spec.spl) and updated the static CLI inventory/help specs to include the command.
