...
- kernel: build/clang-23-1-qemu-evidence-sort-fix/simpleos_wm_production_desktop.elf (sha256=a87137c2c3986fdc91cb93d55485d0dcdfea50be4eb386a5e8b9c24a15a2fa24)
- kernel build: current-source-built (wall timeout=900s)
- disk image: build/clang-23-1-qemu-evidence-sort-fix/fat32-x86_64-font.img (pass, provenance=built-from-admitted-kernel, sha256=d5a5e12bf1421b98531a81b7690e43030eb866627482412ac80d20bd5d34cdcf)
...
- host nonce: simpleos-wm-1785825879-11202
...
- serial log: build/clang-23-1-qemu-evidence-sort-fix/serial.log (24520 bytes)
