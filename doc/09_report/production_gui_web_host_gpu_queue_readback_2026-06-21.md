...
- root: /tmp/simple-vulkan-8k
- build_dir: build/production_gui_web_host_gpu_queue_readback
- report_path: doc/09_report/production_gui_web_host_gpu_queue_readback_2026-06-21.md
...
- run_root_dir=/tmp/simple-vulkan-8k
- run_build_dir=build/production_gui_web_host_gpu_queue_readback
- run_report_path=doc/09_report/production_gui_web_host_gpu_queue_readback_2026-06-21.md
- run_simple_bin=src/compiler_rust/target/debug/simple
- run_simple_lib=src
- run_uname_s=Linux
- run_uname_m=x86_64
...
- browser_first_dispatch_target_context_batch_id=browser-frame-20
