...
| Test | Type | Tests |
|------|------|-------|
| `test/01_unit/compiler/backend/vhdl_backend_spec.spl` | Unit | 11 it blocks |
| `test/01_unit/compiler/backend/vhdl_type_mapper_spec.spl` | Unit | Type mapping |
| `test/01_unit/compiler/backend/vhdl_builder_spec.spl` | Unit | Builder API |
| `test/01_unit/compiler/backend/vhdl_constraints_spec.spl` | Unit | Constraints |
| `test/01_unit/compiler/backend/vhdl_dim_constraints_spec.spl` | Unit | Dimension constraints |
