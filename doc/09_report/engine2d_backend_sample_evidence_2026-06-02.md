...
- `src/compiler_rust/target/release/simple check` passed for:
  ...
  - `examples/ui/engine2d_backend_test.spl`
  - `test/integration/rendering/engine2d_backend_spec.spl`
  - `test/integration/rendering/metal_engine2d_readback_spec.spl`
  - `test/perf/graphics_2d/metal_readback_proof_spec.spl`
- `test/integration/rendering/engine2d_backend_spec.spl`: `11/11` passed.
- `test/integration/rendering/metal_engine2d_readback_spec.spl`: `2/2` passed.
- `test/perf/graphics_2d/metal_readback_proof_spec.spl`: `1/1` passed.
