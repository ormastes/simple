...
- **Specs:**
  - `test/01_unit/browser_engine/html_tokenizer_spec.spl`
  - `test/01_unit/browser_engine/html_tree_builder_spec.spl`
  - `test/01_unit/browser_engine/margin_collapse_spec.spl`
  - `test/01_unit/browser_engine/anonymous_block_spec.spl`
  - `test/01_unit/browser_engine/ifc_linebox_spec.spl`
  - `test/01_unit/browser_engine/table_layout_spec.spl`
  - `test/01_unit/browser_engine/html5lib_tokenizer_spec.spl`
- **Implementation (new):**
