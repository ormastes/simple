...
|---|---:|---:|---:|
| `examples/11_advanced/browser` | 304 | 75035 | 2850509 |
| `examples/09_embedded/simple_os/arch/x86_64/boot/baremetal_stubs.c` | 1 | 15095 | 556456 |
| `examples/09_embedded/simple_os/arch/arm64/boot/baremetal_stubs.c` | 1 | 3472 | 141741 |
| `examples/09_embedded/simple_os/arch/arm32/boot/baremetal_stubs.c` | 1 | 1906 | 64107 |
| `examples/09_embedded/simple_os/arch/riscv64/boot/baremetal_stubs.c` | 1 | 1806 | 60723 |
| `examples/09_embedded/simple_os/arch/riscv32/boot/baremetal_stubs.c` | 1 | 628 | 20336 |
| `examples/09_embedded/simple_os/arch/x86_64/boot/baremetal_boot_stdout.c` | 1 | 83 | 2045 |
| `examples/09_embedded/simple_os/arch/arm64/boot/baremetal_uart_stdout.c` | 1 | 7 | 252 |
| `examples/09_embedded/simple_os/arch/arm32/boot/baremetal_uart_stdout.c` | 1 | 7 | 249 |
| `examples/09_embedded/simple_os/arch/common/baremetal_pl011_uart_stdout.c` | 1 | 44 | 1264 |
| `examples/09_embedded/simple_os/arch/common/baremetal_pl011_serial.h` | 1 | 50 | 1380 |
| `examples/09_embedded/simple_os/arch/riscv64/boot/baremetal_uart_stdout.c` | 1 | 1 | 60 |
| `examples/09_embedded/simple_os/arch/riscv32/boot/baremetal_uart_stdout.c` | 1 | 1 | 60 |
| `examples/09_embedded/simple_os/arch/common/baremetal_riscv_16550_uart_stdout.c` | 1 | 31 | 742 |
| `examples/09_embedded/simple_os/arch/common/baremetal_16550_serial.h` | 1 | 27 | 600 |
| `examples/09_embedded/simple_os/arch/common/baremetal_bump_heap.h` | 1 | 26 | 704 |
| `examples/09_embedded/simple_os/arch/common/baremetal_min_stdout.h` | 1 | 43 | 1513 |
| `examples/09_embedded/simple_os/arch/x86_64/boot/baremetal_interrupt_control.c` | 1 | 6 | 411 |
| `examples/09_embedded/simple_os/arch/arm64/boot/baremetal_interrupt_control.S` | 1 | 6 | 305 |
| `examples/09_embedded/simple_os/arch/arm32/boot/baremetal_interrupt_control.S` | 1 | 8 | 310 |
| `examples/09_embedded/simple_os/arch/common/baremetal_arm_interrupt_control.S` | 1 | 14 | 98 |
| `examples/09_embedded/simple_os/arch/riscv64/boot/baremetal_interrupt_control.S` | 1 | 4 | 186 |
| `examples/09_embedded/simple_os/arch/riscv32/boot/baremetal_interrupt_control.S` | 1 | 4 | 186 |
| `examples/09_embedded/simple_os/arch/common/baremetal_riscv_interrupt_control.S` | 1 | 20 | 205 |
| `examples/09_embedded/simple_os/arch/x86_64/boot/baremetal_startup_handoff.c` | 1 | 1 | 52 |
| `examples/09_embedded/simple_os/arch/common/baremetal_startup_handoff.c` | 1 | 8 | 576 |
...
|---|---:|---:|---:|
| `examples/11_advanced/browser/feature/paint` | 18 | 8234 | 289955 |
| `examples/11_advanced/browser/feature/script` | 23 | 8220 | 294191 |
| `examples/11_advanced/browser/feature/net` | 15 | 6671 | 235625 |
| `examples/11_advanced/browser/feature/parser` | 13 | 6829 | 282009 |
| `examples/11_advanced/browser/feature/layout` | 10 | 4526 | 170086 |
| `examples/11_advanced/browser/feature/dom` | 9 | 4854 | 181376 |
| `examples/11_advanced/browser/feature/style` | 13 | 3914 | 150153 |
