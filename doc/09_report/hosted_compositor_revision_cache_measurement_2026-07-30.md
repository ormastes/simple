...
4. Add a separate process/pipe benchmark; the current response-route benchmark
   intentionally excludes request encoding, pipe copies, and process scheduling.
