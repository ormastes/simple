...
|---|---|---:|---:|---:|---|
| Simple web renderer | ok | n/a | 4 | 6431 | render loop via Simple software renderer |
| Simple static cache | ok | n/a | 4 | 1496 | persistent HTML artifact cache hit loop |
| Simple persistent SWBC command plan | ok | n/a | 4 | 579604 | disk-backed compact static-shell plan to retained commands |
| Simple hot SWBC command plan cache | ok | n/a | 4 | 148836 | in-memory encoded SWBC sidecar cache after persistent warmup |
| Simple retained command hot cache | ok | n/a | 4 | 499 | in-memory retained command list after persistent warmup |
| Simple BrowserBackend cached frame | ok | n/a | 4 | 12971 | integrated browser backend unchanged-static-frame cache |
| Simple BrowserBackend no-op frame | ok | n/a | 4 | 51 | explicit event-loop no-change static frame reuse |
| Simple SWBC prepared reuse | ok | n/a | 4 | 119 | decoded compact static-shell plan reuse loop |
| Simple SWBC command plan | ok | n/a | 4 | 65 | decoded command-only static-shell plan, no HTML artifact |
| GTK | ok | 14472 | 200 | 29704 | widget construction loop; uses xvfb-run when available |
...
- simple_static_plan_cache_total_us=148836
...
- simple_static_command_cache_total_us=499
- simple_browser_cached_frame_iterations=4
- simple_browser_cached_frame_total_us=12971
