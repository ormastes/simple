...
| Bootstrap admission | blocked: settled incremental Stage 4 timed out at 1200s with no candidate; 222 MiB/2,713-file cache retained | pre-output phase emitted no diagnostic or timing receipt; stale/seed/debug artifacts can give false confidence | instrument the silent phase before one further cache-preserving replay; then require provenance, exact hash, and bounded essential-tools smoke before deploy |
