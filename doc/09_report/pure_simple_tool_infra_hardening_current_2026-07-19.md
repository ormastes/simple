...
| Native build/cache | monitor command-token classification fixed; focused Rust source and ELF alias-GC checks pass | focused core-C runner link lacks hosted symbols; Stage 4, cache, Mach-O/COFF, and alias qualification remain | use canonical cached Stage 4 replay; keep cache/backend keys and alias sections isolated |
