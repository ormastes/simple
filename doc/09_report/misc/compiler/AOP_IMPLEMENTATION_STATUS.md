...
1. **Complete Specification** (`doc/01_research/aop.md` - 558 lines)
...
AOP is **fully specified** but **not implemented**. The specification in `doc/01_research/aop.md` is comprehensive and implementation-ready. Empty placeholder files exist but contain no code.
