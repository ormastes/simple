...
**Files Referenced:**
- `doc/07_guide/sspec_bulk_migration_workflow.md` - Complete workflow guide
- `doc/07_guide/sspec_assertion_conversion.md` - Assertion conversion patterns
...
- `doc/09_report/sspec_batch1_plan.md` - Original batch plan
