...
**Files Modified:**
- `test/03_system/features/classes/classes_spec.spl` - Removed 6 skip tags
...
**System Features:**
- `test/03_system/features/treesitter/treesitter_cursor_spec.spl` (24 skips)
- `test/03_system/features/treesitter/treesitter_query_spec.spl` (33 skips)
- `test/03_system/features/treesitter/treesitter_tree_spec.spl` (26 skips)
- `test/03_system/features/treesitter/treesitter_error_recovery_spec.spl` (48 skips)
...
1. **test/03_system/features/classes/classes_spec.spl**
   - Removed 6 skip tags
