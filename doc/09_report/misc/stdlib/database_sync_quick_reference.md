...
- `doc/02_requirements/feature/feature_db.sdn` - Feature database
- `doc/task/task_db.sdn` - Task database
- `doc/dashboard/tables/*.sdn` - Dashboard tables (11 files)

### Documentation
- Analysis: `doc/09_report/database_synchronization_analysis_2026-01-21.md`
- Implementation: `doc/05_design/database_synchronization_implementation.md`
- Comparison: `doc/01_research/database_sync_comparison_visual.md`
