...
- `doc/01_research/REPL_BACKSPACE_LIMITATION.md` - rustyline limitation analysis
- `doc/01_research/TERMINAL_SEQUENCE_CAPTURE.md` - PTY testing guide
- `doc/09_report/REPL_BACKSPACE_INVESTIGATION_2025-12-27.md` - Investigation report
