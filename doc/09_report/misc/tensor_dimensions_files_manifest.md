...
### User Guide
```
doc/07_guide/tensor_dimensions_guide.md
  - ~500 lines
...
```
doc/05_design/tensor_dimensions_design.md
  - ~600 lines
...
### Bug Report
```
doc/01_research/module_system_bug_report.md
  - ~400 lines
...
**Documentation**: All docs in `doc/07_guide/`, `doc/05_design/`, `doc/09_report/`
