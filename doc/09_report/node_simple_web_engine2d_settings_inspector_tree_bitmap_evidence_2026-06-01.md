...
- baseline checksum: 26315462482682
- simple weighted checksum: 80855423152673079
- baseline weighted checksum: 80855423152673079
- mismatch count: 0
...
- best baseline frame us: 78
- baseline/simple speedup x1000: 15600
- simple ARGB path: build/node_simple_web_engine2d_settings_inspector_tree_bitmap_evidence/simple-argb.json
- baseline ARGB path: build/node_simple_web_engine2d_settings_inspector_tree_bitmap_evidence/node-argb.json
...
- total_checksum=26315462482682000
- frame_us=5
- backend_name=software
- optimized_path=static-pixel-cache
- cache_hits=1000
- cache_stores=1
- argb_path=build/node_simple_web_engine2d_settings_inspector_tree_bitmap_evidence/simple-argb.json
