...
- `simple/std_lib/test/02_integration/ui/tui/ratatui_backend_spec.spl` (260 lines)
...
Based on `simple/std_lib/test/01_unit/compiler_core/pattern_matching_spec.spl` which compiles and runs:
