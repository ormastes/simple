...
- `simple/std_lib/test/01_unit/compiler_core/arithmetic_spec.spl` - Working test structure
- `simple/std_lib/test/01_unit/compiler_core/pattern_matching_spec.spl` - Working patterns
