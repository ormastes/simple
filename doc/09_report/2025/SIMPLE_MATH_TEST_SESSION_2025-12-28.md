...
- `doc/06_spec/modules.md` - Documented `pub use` and `export use` equivalence
- `doc/features/feature.md` - Updated #1910-#1969 status link
- `doc/09_report/README.md` - Added parser fix entry
...
# ⏸️ Not Attempted Yet
./target/debug/simple simple/std_lib/test/01_unit/ml/torch/simple_math_spec.spl
./target/debug/simple simple/std_lib/test/01_unit/ml/torch/linalg_spec.spl
./target/debug/simple simple/std_lib/test/01_unit/ml/torch/fft_spec.spl
```
...
./target/debug/simple simple/std_lib/test/01_unit/ml/torch/linalg_spec.spl
./target/debug/simple simple/std_lib/test/01_unit/ml/torch/fft_spec.spl
./target/debug/simple simple/std_lib/test/02_integration/ml/simple_math_integration_spec.spl
```
