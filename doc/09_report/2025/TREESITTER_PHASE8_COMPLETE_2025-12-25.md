...
### Test Files
- `simple/std_lib/test/01_unit/parser/treesitter/grammar_rust_spec.spl` - Rust grammar tests
- `simple/std_lib/test/01_unit/parser/treesitter/grammar_python_spec.spl` - Python grammar tests
- `simple/std_lib/test/01_unit/parser/treesitter/grammar_compile_spec.spl` - Compilation tests
- `simple/std_lib/test/01_unit/parser/treesitter/language_detect_spec.spl` - Detection tests
