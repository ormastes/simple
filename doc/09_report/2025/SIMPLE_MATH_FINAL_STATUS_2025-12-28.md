...
1. `doc/06_spec/simple_math.md` - 540 lines (complete specification)
...
1. `doc/06_spec/simple_math.md` (NEW - 540 lines)
2. `doc/tutorials/simple_math_quickstart.md` (NEW - 465 lines)
3. `doc/features/feature.md` (2 lines modified) - status update
4. `doc/09_report/SIMPLE_MATH_PHASE6_COMPLETE_2025-12-28.md` (Phase 6 report)
5. `doc/09_report/SIMPLE_MATH_TENSOR_FUNCTION_2025-12-28.md` (tensor() report)

**Test Files (5 files):**
1. `simple/std_lib/test/01_unit/ml/torch/simple_math_spec.spl` (NEW - 170 lines)
2. `simple/std_lib/test/01_unit/ml/torch/linalg_spec.spl` (NEW - 200 lines)
3. `simple/std_lib/test/01_unit/ml/torch/fft_spec.spl` (NEW - 215 lines)
4. `simple/std_lib/test/02_integration/ml/simple_math_integration_spec.spl` (NEW - 230 lines)
