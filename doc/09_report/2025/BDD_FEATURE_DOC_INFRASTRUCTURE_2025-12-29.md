...
- `simple/std_lib/test/03_system/feature_doc_spec.spl` - System tests for the framework
...
13. `simple/std_lib/test/03_system/feature_doc_spec.spl`
14. `simple/std_lib/test/e2e/feature_generation_spec.spl`
15. `doc/09_report/BDD_FEATURE_DOC_INFRASTRUCTURE_2025-12-29.md` (this file)
