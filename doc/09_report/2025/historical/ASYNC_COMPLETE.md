...
bin/simple compile test/03_system/feature/async_features_spec.spl -o /tmp/async_test
/tmp/async_test

# Or compile and run:
bin/simple test test/03_system/feature/async_features_spec.spl --compile
```

**Expected to work:**
- 70+ async/await tests in test/03_system/feature/
- 10+ async tests in test/01_unit/std/
...
bin/simple test/03_system/feature/async_features_spec.spl
```
