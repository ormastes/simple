...
**New test file:** `test/03_system/io/native_ops_spec.spl`
...
```bash
$ bin/simple test test/03_system/io/native_ops_spec.spl
Simple Test Runner v0.4.0
Running 1 test file(s) [mode: interpreter]...
  PASS  test/03_system/io/native_ops_spec.spl (1 passed, 4ms)
=========================================
...
```bash
$ bin/simple test test/03_system/ffi/syscalls_test.spl
Simple Test Runner v0.4.0
Running 1 test file(s) [mode: interpreter]...
  PASS  test/03_system/ffi/syscalls_test.spl (1 passed, 3ms)
=========================================
Results: 1 total, 1 passed, 0 failed
=========================================
All tests passed!
...
Created:
  test/03_system/io/native_ops_spec.spl  +68 lines
...
- **Tests:** `test/03_system/io/native_ops_spec.spl` - Integration tests
