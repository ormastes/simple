...
**`doc/07_guide/freebsd_workspace_setup.md`** (16KB)
...
**`doc/07_guide/quick_reference/freebsd_quick_reference.md`** (7.4KB)
- Command cheat sheet
...
2. **Detailed Setup** → `doc/07_guide/freebsd_workspace_setup.md` (complete guide)
3. **Command Reference** → `doc/07_guide/quick_reference/freebsd_quick_reference.md` (cheat sheet)
4. **QEMU Setup** → `doc/07_guide/qemu_setup.md` (QEMU installation)
...
- `doc/07_guide/freebsd_workspace_setup.md` (section: Troubleshooting)
...
- **Setup Details:** `doc/07_guide/freebsd_workspace_setup.md`
