...
**Spec:** `doc/06_spec/property_testing.md` (8.5KB)
...
**Spec:** `doc/06_spec/snapshot_testing.md` (10KB)
...
**Can start:** ✅ NOW  
**Dependencies:** Parser only  
**Spec:** `doc/06_spec/formatter.md` (12.5KB)
...
**Spec:** `doc/06_spec/capability_effects.md` (13.5KB)
...
**Dependencies:** Parser only  
**Spec:** `doc/06_spec/semantic_diff.md` (10.5KB)
...
**Step 1:** Read spec
```bash
cat doc/06_spec/snapshot_testing.md
```
...
**All specifications:** `doc/06_spec/`  
**All documentation:** `doc/09_report/`  
