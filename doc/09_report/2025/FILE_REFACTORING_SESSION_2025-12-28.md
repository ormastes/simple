...
### 2. doc/01_research/physics_simulation_integration.md (2,364 lines → 6 docs)
**Status:** ✅ Complete | **Committed:** Yes
...
**Directory:** `doc/01_research/physics/`

---

### 3. doc/06_spec/graphics_3d.md (1,542 lines → 7 docs)
**Status:** ✅ Complete | **Committed:** Yes
...
**Directory:** `doc/06_spec/graphics_3d/`

---

### 4. doc/06_spec/gpu_simd/README.md (1,430 lines → 5 docs)
**Status:** ✅ Complete | **Committed:** Yes
...
**Directory:** `doc/06_spec/gpu_simd/`
...
- `doc/01_research/physics/*.md` (6 files)
- `doc/06_spec/graphics_3d/*.md` (7 files)
- `doc/06_spec/gpu_simd/*.md` (5 files)
