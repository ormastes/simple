...
**Documentation:** `doc/06_spec/capability_effects.md` exists
...
- `doc/06_spec/semantic_diff.md` - Spec for #889
...
**Documentation:** `doc/06_spec/property_testing.md` - Complete specification (320 lines)
...
**Documentation:** `doc/06_spec/snapshot_testing.md` - Complete specification (380 lines)
...
**Documentation:** 
- `doc/06_spec/formatter.md` - Complete specification (480 lines)
...
**Documentation:**
- `doc/06_spec/build_audit.md` - Complete specification (440 lines)
