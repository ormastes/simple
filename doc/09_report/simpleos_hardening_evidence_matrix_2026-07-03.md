...
- kernel_scheduler_resource_formal_scope: bounded ResourcePool acquire/release capacity, zero-capacity denial/emptiness, acquire/release capacity preservation, underflow, and acquire-release no-leak roundtrip invariants
- kernel_scheduler_resource_formal_evidence: src/verification/kernel_scheduler/KernelScheduler/Theorems.lean T10a-T10g plus resource_zero_capacity_acquire_denied + resource_zero_capacity_wf_empty + resource_release_preserves_capacity_bound + resource_acquire_preserves_capacity_bound; `cd src/verification/kernel_scheduler && lake build`
...
- actor_channel_backpressure_formal_evidence: src/verification/actor_channel/ActorChannel/Theorems.lean T2a2 + T2b2 + T2b3 + T3a1 + T3a2 + T3a3 + T3b + T6d + T6e + T7; `cd src/verification/actor_channel && lake build`
