...
- baseline checksum: 26319005838612
- simple weighted checksum: 80868172570164406
- baseline weighted checksum: 80868172570164406
- mismatch count: 0
...
- best baseline frame us: 79
- baseline/simple speedup x1000: 19750
- simple ARGB path: build/node_simple_web_engine2d_form_sidebar_validation_bitmap_evidence/simple-argb.json
- baseline ARGB path: build/node_simple_web_engine2d_form_sidebar_validation_bitmap_evidence/node-argb.json
...
- total_checksum=26319005838612000
- frame_us=5
- backend_name=software
- optimized_path=static-pixel-cache
- cache_hits=1000
- cache_stores=1
- argb_path=build/node_simple_web_engine2d_form_sidebar_validation_bitmap_evidence/simple-argb.json
