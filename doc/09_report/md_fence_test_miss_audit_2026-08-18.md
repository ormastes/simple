...
| (c) unclosed fences | 18 | COUNT (7 in live roots) |
| (c) empty runnable-lang fences | 3 | COUNT |
...
(c) unclosed, live roots — each swallows the rest of its file:
`doc/07_guide/tools/README.md:53`, `doc/07_guide/infra/testing/coverage.md:457`,
`doc/07_guide/lib/misc/markdown_document_decoration.md:222`,
`doc/07_guide/lib/api/sdn_graph.md:154`,
`examples/10_tooling/trace32_tools/README.md:11`,
`examples/10_tooling/trace32_tools/cmm_lsp/README.md:21`,
...
1. 7 unclosed fences in live roots silently eat the remainder of their file — a
   real, uncontroversial defect class (COUNT).
