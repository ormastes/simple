...
| Backend | Required | Status | Reason | Device proof | Expected checksum | Actual checksum | Mismatches |
| --- | --- | --- | --- | --- | --- | --- | --- |
| cuda | true | pass | readback-pixels-matched | submit=true; readback=true; backend=; ops=fill,copy,alpha,scroll; path=CUDA source -> PTX -> CUDA driver module/kernel handles -> launch -> synchronize -> device-to-host readback -> per-op checksums | 274983770116 | 274983770116 | 0 |
| opencl | true | pass | readback-pixels-matched | submit=true; readback=true; backend=; ops=fill,copy,alpha,scroll; path=OpenCL source -> OpenCL program/kernel handles -> enqueue -> finish -> device-to-host readback -> per-op checksums | 274983770116 | 274983770116 | 0 |
| vulkan | true | pass | pass | submit=true; readback=true; backend=vulkan; ops=clear,rect; path=Vulkan strict Engine2D backend -> present/readback exercised -> exact CPU/Vulkan parity specs -> rect checksum | 140781974135910 | 140781974135910 | 0 |
| metal | false | unavailable | missing-primary-tool | submit=false; readback=false; backend=; ops=fill,copy,alpha,scroll; path='Metal source -> metallib -> MTLDevice -> compute pipeline -> command buffer/encoder -> submit -> wait -> buffer readback -> per-op checksums' | 0 | 0 |  |
| rocm | false | unavailable | missing-primary-tool | submit=false; readback=false; backend=; ops=fill,copy,alpha,scroll; path='HIP source -> HSACO -> ROCm loader -> device/module/kernel handles -> launch -> synchronize -> host readback -> per-op checksums' | 0 | 0 |  |
...
- generated_2d_backend_matrix_cuda_submit_attempted=true
- generated_2d_backend_matrix_cuda_readback_available=true
- generated_2d_backend_matrix_cuda_ops=fill,copy,alpha,scroll
- generated_2d_backend_matrix_cuda_backend_name=
- generated_2d_backend_matrix_cuda_required_path=CUDA source -> PTX -> CUDA driver module/kernel handles -> launch -> synchronize -> device-to-host readback -> per-op checksums
...
- generated_2d_backend_matrix_opencl_submit_attempted=true
- generated_2d_backend_matrix_opencl_readback_available=true
- generated_2d_backend_matrix_opencl_ops=fill,copy,alpha,scroll
- generated_2d_backend_matrix_opencl_backend_name=
- generated_2d_backend_matrix_opencl_required_path=OpenCL source -> OpenCL program/kernel handles -> enqueue -> finish -> device-to-host readback -> per-op checksums
...
- generated_2d_backend_matrix_vulkan_submit_attempted=true
- generated_2d_backend_matrix_vulkan_readback_available=true
- generated_2d_backend_matrix_vulkan_ops=clear,rect
- generated_2d_backend_matrix_vulkan_backend_name=vulkan
- generated_2d_backend_matrix_vulkan_required_path=Vulkan strict Engine2D backend -> present/readback exercised -> exact CPU/Vulkan parity specs -> rect checksum
...
- generated_2d_backend_matrix_metal_submit_attempted=false
- generated_2d_backend_matrix_metal_readback_available=false
- generated_2d_backend_matrix_metal_ops=fill,copy,alpha,scroll
- generated_2d_backend_matrix_metal_backend_name=
- generated_2d_backend_matrix_metal_required_path='Metal source -> metallib -> MTLDevice -> compute pipeline -> command buffer/encoder -> submit -> wait -> buffer readback -> per-op checksums'
...
- generated_2d_backend_matrix_rocm_submit_attempted=false
- generated_2d_backend_matrix_rocm_readback_available=false
- generated_2d_backend_matrix_rocm_ops=fill,copy,alpha,scroll
- generated_2d_backend_matrix_rocm_backend_name=
- generated_2d_backend_matrix_rocm_required_path='HIP source -> HSACO -> ROCm loader -> device/module/kernel handles -> launch -> synchronize -> host readback -> per-op checksums'
