...
Maintain process knowledge for the `i18n` layer: owned source, architecture links, expected tests, and boundary rules. Use this skill when a task changes `src/i18n` or depends on its public behavior.
