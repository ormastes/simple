...
Maintain process knowledge for the `type` layer: owned source, architecture links, expected tests, and boundary rules. Use this skill when a task changes `src/type` or depends on its public behavior.
