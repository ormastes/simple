<!-- llm-process-gen: managed source=pipe_design_ui_skill source_sha256=e2e9cf2d72409ecf0d3349e521614b71ebfd55f858f811dba7ab2fdea914b615 content_sha256=e2e9cf2d72409ecf0d3349e521614b71ebfd55f858f811dba7ab2fdea914b615 -->
...
| Design system reference | `doc/05_design/ui/stitch/stitch_design_system.md` | Extract from Stitch MCP |
...
> **[`doc/05_design/ui/stitch/stitch_design_system.md`](doc/05_design/ui/stitch/stitch_design_system.md)**
...
1. **TUI mockups** (box-drawing, ANSI colors): `doc/05_design/ui/<topic>/<feature>_tui.md`
2. **GUI mockups** (web patterns, responsive): `doc/05_design/ui/<topic>/<feature>_gui.md`
3. For Gemini GUI prototyping: start Stitch MCP, then use its tools
4. For theme consistency: read `doc/05_design/ui/stitch/stitch_design_system.md` for tokens, components, and DO/DON'T rules
...
**Guides**:
- `doc/07_guide/platform/mobile/android_dev_guide.md` — Android emulator + WASM path
- `doc/07_guide/platform/mobile/ios_dev_guide.md` — iOS simulator + Tauri
- `doc/07_guide/platform/mobile/wasm_gui_guide.md` — WASM native surface contract
- `doc/07_guide/platform/mobile/tauri_mobile_guide.md` — Tauri shell for both platforms
...
| Artifact | Location |
|----------|----------|
| UI design (TUI) | `doc/05_design/ui/<topic>/<feature>_tui.md` |
| UI design (GUI) | `doc/05_design/ui/<topic>/<feature>_gui.md` |
| Design system ref | `doc/05_design/ui/stitch/stitch_design_system.md` |

---

## Typed Widget Authoring

Phases 1-6 of the typed-core RFC (`doc/05_design/ui/tokens/ui_typed_core_rfc.md`) replaced stringly-typed fields with enums and fluent helpers. Use these when constructing `WidgetNode` in Simple code.
...
Phase 3 of the typed-core RFC (`doc/05_design/ui/tokens/ui_typed_core_rfc.md`) adds 26 fluent methods on `WidgetNode`. These mirror the existing `with_*` free-function helpers.
