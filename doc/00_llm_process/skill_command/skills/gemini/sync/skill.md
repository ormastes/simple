<!-- llm-process-gen: managed source=gemini_sync_skill source_sha256=a40a6b04379861403125079712eb997e415282801dd348f2856d5a12d4a1b21e content_sha256=f8c092d605bcdd0faeaa9e5a7f6070e0a90808c1f477e25b158724754700a702 -->
# sync
...
If HTTPS push fails with `Invalid username or token`, stale `GH_TOKEN` or
`GITHUB_TOKEN` can override the stored GitHub CLI credential. Do not print
tokens or put them in remote URLs. Prefer:
