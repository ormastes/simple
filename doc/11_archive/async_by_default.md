...
- `simple/std_lib/test/01_unit/concurrency/promise_spec.spl` - Test suite (220 lines, 30+ tests)
...
./target/debug/simple simple/std_lib/test/01_unit/concurrency/promise_spec.spl
```
