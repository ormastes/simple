...
|------------|---------|------------|--------|---------------|----------------|
| #916 | Resource limits | 3 | ✅ | [sandboxing.md](../spec/sandboxing.md) | `src/runtime/src/sandbox/limits.rs` |
| #917 | Network isolation | 4 | ✅ | [sandboxing.md](../spec/sandboxing.md) | Platform-specific (Linux/macOS/Windows) |
| #918 | Filesystem isolation | 4 | ✅ | [sandboxing.md](../spec/sandboxing.md) | Platform-specific (Linux/macOS/Windows) |
| #919 | `simple run --sandbox` | 2 | ✅ | [sandboxing.md](../spec/sandboxing.md) | `src/driver/src/main.rs` |
