...
| File | Purpose |
|------|---------|
| `doc/01_research/unified_module_architecture.md` | Migration plan |
| `doc/09_report/sdn_migration_phase1_report.md` | Phase 1 report |
| `doc/09_report/unified_architecture_summary.md` | This summary |
