...
- [ ] Fix match case inline array bug (`test/01_unit/compiler/match_empty_array_bug_spec.spl`)
...
- [ ] Unblock: `test/01_unit/std/async_spec.spl`
...
- [ ] **Set literals** `s{...}` - Rebuild runtime with new parser
  - Unblock: `test/03_system/feature/set_literal_spec.spl`
  - Unblock: `test/03_system/feature/custom_literal_spec.spl`
- [ ] **Bitfield syntax**
  - Unblock: `test/03_system/feature/bitfield_spec.spl`
- [ ] **Union types** (Issue #37)
- [ ] **Static keyword** support
  - Unblock: `test/03_system/feature/parser_static_keyword_spec.spl`
...
- [ ] **Effect inference and annotations**
  - Unblock: `test/03_system/feature/effect_annotations_spec.spl`
  - Unblock: `test/01_unit/compiler/effect_inference_spec.spl`
- [ ] **Advanced generics**
  - Unblock: `test/03_system/feature/generics_advanced_spec.spl`
  - Complex expression type inference in monomorphize
- [ ] **Default trait methods**
- [ ] **Class invariants**
  - Unblock: `test/03_system/feature/class_invariant_spec.spl`
...
- [ ] **Generator state machine codegen**
  - Unblock: `test/03_system/feature/generator_state_machine_codegen_spec.spl`
- [ ] **Linker integration**
  - Unblock: `test/01_unit/compiler/linker_spec.spl`
  - Unblock: `test/01_unit/compiler/linker_context_spec.spl`
  - Unblock: `test/01_unit/compiler/note_sdn_spec.spl`
- [ ] **JIT context improvements**
  - Unblock: `test/01_unit/compiler/jit_context_spec.spl`
...
- [ ] **Complete async/await** - Full syntax support
  - Unblock: `test/03_system/feature/async_features_spec.spl`
  - Unblock: `test/01_unit/std/async_host_spec.spl`
  - Unblock: `test/01_unit/std/async_embedded_spec.spl`
- [ ] **Spawn keyword** - Thread/process support
  - Unblock: `test/01_unit/lib/qemu_spec.spl`
  - Unblock: `test/01_unit/std/console_basic_spec.spl`
  - Unblock: `test/01_unit/std/arc_spec.spl`
- [ ] **Stackless coroutines**
  - Unblock: `test/03_system/feature/stackless_coroutines_spec.spl`
- [ ] **Actor model/system**
  - Unblock: `test/03_system/feature/actors_spec.spl`
  - Unblock: `test/03_system/feature/actor_model_spec.spl`
...
- [ ] **Extended file I/O**
  - Unblock: `test/03_system/feature/file_io_extended_spec.spl`
  - Unblock: `test/03_system/file_io_spec.spl`
  - Unblock: `test/01_unit/std/infra/file_io_spec.spl`
  - Unblock: `test/01_unit/std/file_find_spec.spl`
- [ ] **Environment variables**
  - Unblock: `test/01_unit/std/env_spec.spl`
- [ ] **Process management**
  - Unblock: `test/01_unit/std/process_spec.spl`
- [ ] **System FFI**
  - Unblock: `test/01_unit/std/sys_ffi_spec.spl`
- [ ] **Resource limits**
  - Unblock: `test/01_unit/std/resource_limits_spec.spl`
...
- [ ] **DateTime functionality**
  - Unblock: `test/01_unit/std/datetime_spec.spl`
  - Unblock: `test/01_unit/std/datetime_ffi_spec.spl`
- [ ] **Logging**
  - Unblock: `test/01_unit/std/log_spec.spl`
- [ ] **Configuration**
  - Unblock: `test/01_unit/std/config_spec.spl`
  - Unblock: `test/01_unit/std/infra/config_env_spec.spl`
...
- [ ] **Mock verification**
  - Unblock: `test/01_unit/std/mock_verification_spec.spl`
  - Unblock: `test/01_unit/std/mock_phase5_spec.spl`
  - Unblock: `test/01_unit/std/mock_phase6_spec.spl`
  - Unblock: `test/01_unit/std/mock_phase7_spec.spl`
- [ ] **Contract testing**
  - Unblock: `test/01_unit/std/contract_spec.spl`
- [ ] **Fuzzing support**
  - Unblock: `test/01_unit/std/fuzz_spec.spl`
...
- [ ] **Dependency injection**
  - Unblock: `test/01_unit/std/di_spec.spl`
- [ ] **Database integration**
  - Unblock: `test/01_unit/std/db_spec.spl`
  - Unblock: `test/03_system/feature/database_sync_spec.spl`
  - Unblock: `test/03_system/feature/contract_persistence_feature_spec.spl`
...
- [ ] `test/01_unit/app/lsp/server_lifecycle_spec.spl` - Server startup/shutdown
- [ ] `test/01_unit/app/lsp/message_dispatcher_spec.spl` - Message routing
- [ ] `test/01_unit/app/lsp/document_sync_spec.spl` - Document synchronization

**Week 3: Navigation Features**
- [ ] `test/01_unit/app/lsp/definition_spec.spl` - Go to definition
- [ ] `test/01_unit/app/lsp/references_spec.spl` - Find references
- [ ] `test/01_unit/app/lsp/hover_spec.spl` - Hover information

**Week 4: Code Intelligence**
- [ ] `test/01_unit/app/lsp/completion_spec.spl` - Code completion
- [ ] `test/01_unit/app/lsp/diagnostics_spec.spl` - Error diagnostics
...
- [ ] **Semantic versioning**
  - Unblock: `test/01_unit/app/package/semver_spec.spl`
- [ ] **Package manifests**
  - Unblock: `test/01_unit/app/package/package_spec.spl`
  - Unblock: `test/01_unit/app/package/manifest_spec.spl`
- [ ] **Lock files**
  - Unblock: `test/01_unit/app/package/lockfile_spec.spl`
- [ ] **FFI package support**
  - Unblock: `test/01_unit/app/package/ffi_spec.spl`
...
- [ ] Improve `test/01_unit/app/dap/server_hooks_integration_spec.spl`
...
- [ ] **Arg parsing** - `test/01_unit/app/tooling/arg_parsing_spec.spl`
- [ ] **Regex utils** - `test/01_unit/app/tooling/regex_utils_spec.spl`
- [ ] **JSON utils** - `test/01_unit/app/tooling/json_utils_spec.spl`
- [ ] **HTML utils** - `test/01_unit/app/tooling/html_utils_spec.spl`
- [ ] **Context pack** - `test/01_unit/app/tooling/context_pack_spec.spl`
- [ ] **Brief view** - `test/01_unit/app/tooling/brief_view_spec.spl`
- [ ] **Retry utils** - `test/01_unit/app/tooling/retry_utils_spec.spl`
...
- [ ] **Call flow profiling** - `test/01_unit/app/diagram/call_flow_profiling_spec.spl`
- [ ] **Diagram filtering** - `test/01_unit/app/diagram/filter_spec.spl`
- [ ] **Diagram generation** - `test/01_unit/app/diagram/diagram_gen_spec.spl`
- [ ] **Text formatter** - `test/01_unit/app/diagnostics/text_formatter_spec.spl`
...
- [ ] **Vector3** - `test/03_system/feature/vec3_spec.spl`
- [ ] **Quaternion** - `test/03_system/feature/quat_spec.spl`
- [ ] **Matrix4x4** - `test/03_system/feature/mat4_spec.spl`
- [ ] **Transform** - `test/03_system/feature/transform_spec.spl`
- [ ] **Scene nodes** - `test/03_system/feature/scene_node_spec.spl`
- [ ] **Search/Index (spatial)**
  - `test/03_system/feature/search_spec.spl`
  - `test/03_system/feature/index_spec.spl`
...
- [ ] **Tensor operations**
  - Unblock: `test/03_system/feature/tensor_spec.spl`
  - Unblock: `test/03_system/feature/tensor_interface_spec.spl`
  - Unblock: `test/03_system/feature/tensor_bridge_spec.spl`
  - Implement native backend (factory.spl TODO)
- [ ] **ML features**
  - Unblock: `test/01_unit/lib/ml/test_ffi_operator_spec.spl`
  - Unblock: `test/01_unit/lib/ml/fft_spec.spl`
  - Unblock: `test/01_unit/lib/ml/custom_autograd_spec.spl`
  - Unblock: `test/01_unit/lib/ml/simple_math_spec.spl`
  - Unblock: `test/01_unit/lib/ml/activation_spec.spl`
...
- [ ] **Rigidbody** - `test/01_unit/lib/physics/rigidbody_spec.spl`
- [ ] **Vector** - `test/01_unit/lib/physics/vector_spec.spl`
- [ ] **Materials** - `test/01_unit/lib/physics/materials_spec.spl`
- [ ] **Spatial hash** - `test/01_unit/lib/physics/spatial_hash_spec.spl`
- [ ] **Contact** - `test/01_unit/lib/physics/contact_spec.spl`
- [ ] **AABB** - `test/01_unit/lib/physics/aabb_spec.spl`
- [ ] **Shapes** - `test/01_unit/lib/physics/shapes_spec.spl`
...
- [ ] **Material** - `test/01_unit/lib/game_engine/material_spec.spl`
- [ ] **Actor model** - `test/01_unit/lib/game_engine/actor_model_spec.spl`
- [ ] **Input** - `test/01_unit/lib/game_engine/input_spec.spl`
- [ ] **Assets** - `test/01_unit/lib/game_engine/assets_spec.spl`
- [ ] **Physics integration** - `test/01_unit/lib/game_engine/physics_spec.spl`
- [ ] **Audio** - `test/01_unit/lib/game_engine/audio_spec.spl`
- [ ] **Component system**
  - `test/01_unit/lib/game_engine/component_spec.spl`
  - `test/03_system/feature/component_spec.spl`
...
- [ ] **Generic GPU** (11 tests)
  ...
  - `test/03_system/feature/gpu_basic_spec.spl`

- [ ] **CUDA** (18 tests)
  - `test/03_system/feature/cuda_spec.spl`
  - CUDA toolkit integration

- [ ] **Vulkan** (21 tests)
  - `test/03_system/feature/vulkan_spec.spl`
...
- [ ] **Floor division (fdiv)** - `test/03_system/feature/floor_division_fdiv_spec.spl`
- [ ] **Shell API** - `test/03_system/feature/shell_api_spec.spl`
- [ ] **Fault detection** - `test/03_system/feature/fault_detection_spec.spl`
- [ ] **Experiment tracking**
  - `test/03_system/feature/experiment_tracking_spec.spl`
  - `test/01_unit/std/exp/sweep_spec.spl`
  - `test/01_unit/std/exp/run_spec.spl`
  - `test/01_unit/std/exp/storage_spec.spl`
  - `test/01_unit/std/exp/artifact_spec.spl`
- [ ] **LMS (Learning Management)** - `test/01_unit/lib/lms/server_spec.spl`
...
- `test/03_system/macro_consteval_simple_spec.spl`

### QEMU & Embedded Integration
- **Effort:** 2 weeks
- **Priority:** LOW (embedded use cases)
- `test/01_unit/lib/qemu_spec.spl`
