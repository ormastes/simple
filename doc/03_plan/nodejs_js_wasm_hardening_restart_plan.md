...
1. Phase 5 OS-boundary hardening.
   ...
   - VFS-manager `file_grants` enforcement is implemented and covered by
     `test/01_unit/os/services/vfs/vfs_spec.spl`; do not broaden this claim to
     socket/process boundaries.
   - Socket-layer `network_grants` enforcement is implemented and covered by
     `test/01_unit/os/posix/socket_compat_spec.spl`; do not broaden this claim to
     QEMU guest network evidence.
   - Spawn/exec-layer `process_grants` enforcement is implemented and covered
     by `test/01_unit/os/kernel/ipc/syscall_spec.spl`; do not broaden this claim
...
2. Phase 6 QEMU runtime provisioning.
   ...
   - `test/01_unit/os/port/host_fat32_tree_populator_spec.spl` now proves the
...
3. WebGPU/WASM scope closure.
   ...
   - Capture release-grade evidence for
     `test/03_system/app/browser/feature/webgpu_js_wasm_simple_spec.spl`; the
...
- `SIMPLE_LIB=<worktree>/src /home/ormastes/dev/pub/simple/bin/simple check src/os/services/vfs/vfs.spl test/01_unit/os/services/vfs/vfs_spec.spl`
- `SIMPLE_LIB=<worktree>/src /home/ormastes/dev/pub/simple/bin/simple test test/01_unit/os/services/vfs/vfs_spec.spl --mode=interpreter --clean`
- `SIMPLE_LIB=<worktree>/src /home/ormastes/dev/pub/simple/bin/simple test test/03_system/os/simpleos_ai_cli_js_node_port_spec.spl --mode=interpreter --clean`
...
```sh
SIMPLE_LIB=<worktree>/src /home/ormastes/dev/pub/simple/bin/simple test test/03_system/feature/js/node_api_conformance_spec.spl --mode=interpreter --clean
SIMPLE_LIB=<worktree>/src /home/ormastes/dev/pub/simple/bin/simple test test/03_system/os/simpleos_ai_cli_js_node_port_spec.spl --mode=interpreter --clean
SIMPLE_LIB=<worktree>/src /home/ormastes/dev/pub/simple/bin/simple test test/03_system/app/browser/feature/webgpu_js_wasm_simple_spec.spl --mode=interpreter --clean
```
...
```sh
SIMPLE_LIB=src bin/simple test test/03_system/feature/js/node_api_conformance_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src bin/simple test test/03_system/os/simpleos_ai_cli_js_node_port_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src bin/simple test test/03_system/app/browser/feature/webgpu_js_wasm_simple_spec.spl --mode=interpreter --clean
