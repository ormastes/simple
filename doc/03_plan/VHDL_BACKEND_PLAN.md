...
### M7: Documentation
- `doc/01_research/VHDL_SUPPORT_RESEARCH.md` — Constraint system research, CDC/latch/comb loop sections
- `doc/05_design/VHDL_BACKEND_DESIGN.md` — Full restructure matching GPU design pattern
- `doc/03_plan/VHDL_BACKEND_PLAN.md` — This file, updated milestones
...
- GPU backend design pattern (`doc/05_design/gpu_backend_design.md`) as reference
