...
- `bin/simple test test/01_unit/os/qemu_runner_spec.spl` passed: 52 examples, 0 failed, cached unchanged.
- `bin/simple test test/01_unit/os/services/vfs/vfs_rootfs_porting_spec.spl` passed: 5 examples, 0 failed, cached unchanged.
- `bin/simple test test/01_unit/os/services/launcher/launcher_seeded_metadata_spec.spl` passed: 2 examples, 0 failed, cached unchanged.
