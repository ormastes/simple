...
**Status:** Planning
**Based On:**
- `doc/03_plan/UNIFIED_GPU_INTERFACE_PLAN.md`
- `doc/07_guide/gpu_configuration.md`
- `doc/api/gpu_api.md`
...
- `doc/03_plan/UNIFIED_GPU_INTERFACE_PLAN.md` - Full unified API spec
- `doc/07_guide/gpu_configuration.md` - Config file guide
- `doc/api/gpu_api.md` - Complete API reference
- `doc/05_design/gpu_backend_design.md` - Backend architecture
- `doc/09_report/pytorch_ffi_device_management_2026-02-09.md` - Current device implementation
