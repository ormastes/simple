...
4. Add regression test: `test/01_unit/compiler/jit_typed_integer_spec.spl` --
...
**Files to create:** `test/01_unit/compiler/jit_typed_integer_spec.spl`
...
5. Add regression test: `test/01_unit/compiler/jit_array_repeat_spec.spl`
...
**Files to create:** `test/01_unit/compiler/jit_array_repeat_spec.spl`
