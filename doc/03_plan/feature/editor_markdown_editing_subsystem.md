...
1. Create `test/unit/lib/editor/md_block_model_spec.spl` -- heading/para/code/list/table/callout parsing
2. Create `test/unit/lib/editor/md_command_dispatch_spec.spl` -- enter, tab, delete commands
3. Create `test/unit/lib/editor/md_vim_motions_spec.spl` -- word, heading, paragraph motions
4. Create `test/unit/lib/editor/md_table_ops_spec.spl` -- add/delete row/col, align, tab-nav
5. End-to-end: `bin/simple check src/app/editor/` passes with zero HIR failures

**Files to create:** `test/unit/lib/editor/md_block_model_spec.spl`,
`test/unit/lib/editor/md_command_dispatch_spec.spl`,
`test/unit/lib/editor/md_vim_motions_spec.spl`,
`test/unit/lib/editor/md_table_ops_spec.spl`
