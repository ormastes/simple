...
```sh
bin/simple test --no-cache test/03_system/compiler/pure_simple_vhdl_source_of_truth_spec.spl
bin/simple test --no-cache test/03_system/compiler/vhdl_source_facade_spec.spl
