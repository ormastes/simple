...
| `ST4-R7` | Current-host follow-ons | After x86 admission, run FreeBSD QEMU, SimpleOS AArch64, and scoped AArch64/RISC-V cross gates named in the session plan | Pending R5; platform sidecars, merge owner reviews |
