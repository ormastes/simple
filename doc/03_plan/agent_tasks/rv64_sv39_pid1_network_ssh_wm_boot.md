...
| E — WM | AC-5 | new RV64 WM producer/adapter and canonical compositor/Engine2D path; no `pm_service.spl` edits | PID-correlated first presented frame | TODO809 boot resources/event pump; live proof waits for A | producer source implemented; boot integration blocked |
