...
```bash
bin/simple test test/feature/scilib/perf_sugar_spec.spl --mode=interpreter --clean
...
bin/simple test test/feature/scilib/ndarray_dtype_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/ndarray_error_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/ndarray_shape_ops_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/ndarray_broadcast_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/ndarray_reduction_spec.spl --mode=interpreter --clean
```
...
```bash
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/blas_axpy_spec.spl --mode=interpreter --clean
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/blas_gemm_spec.spl --mode=interpreter --clean
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/linalg_backend_diagnostics_spec.spl --mode=interpreter --clean
```
...
```bash
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/lapack_gesv_spec.spl --mode=interpreter --clean
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/lapack_inv_spec.spl --mode=interpreter --clean
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/lapack_det_spec.spl --mode=interpreter --clean
...
```bash
bin/simple test test/feature/scilib/cuda_provider_smoke_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/cuda_device_buffer_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/fortran_abi_smoke_spec.spl --mode=interpreter --clean
...
```bash
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/math_block_matmul_spec.spl --mode=interpreter --clean
SIMPLE_BLAS_BACKEND=mock bin/simple test test/feature/scilib/math_block_solve_spec.spl --mode=interpreter --clean
```
...
```bash
bin/simple test test/feature/scilib/df_construction_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/df_filter_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/df_groupby_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/df_merge_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/df_missing_values_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/df_value_counts_spec.spl --mode=interpreter --clean
```
...
```bash
bin/simple test test/feature/scilib/ml_linear_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/ml_metrics_spec.spl --mode=interpreter --clean
```
...
```bash
bin/simple test test/feature/scilib/scipy_stats_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/scipy_sparse_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/scipy_optimize_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/scipy_special_spec.spl --mode=interpreter --clean
```
