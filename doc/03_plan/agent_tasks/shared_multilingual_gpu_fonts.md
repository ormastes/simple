...
R0 is the shared executable-evidence dependency. The Web/GUI part of font R2
also follows R1, R2, and R4 in
`doc/03_plan/ui/unified_2d_engine/draw_ir_web_renderer_reconciliation_2026-07-31.md`.
R1–R4 retain evidence before
