...
2. Preserve the completed helper-proof surface: writeback, branch immediate, store immediate, I-type immediate, upper immediate, execute control, and jump immediate.
