...
| `doc/03_plan/agent_tasks/runtime_large_arraybuffer_probe_resume.md` | `needs-evidence` | Runtime Spark | Rerun the focused large-buffer regression after follow-up runtime edits and update the result. |
...
| `doc/03_plan/runtime/loader_shared_core_refactor.md` | `needs-evidence` | Runtime Spark | Accept the helper-level stop boundary or justify a broader seam with evidence, then close Track E verification. |
| `doc/03_plan/runtime/process_safety/plan.md` | `needs-evidence` | Runtime Spark | Complete unresolved matrix/recurrence follow-ups, especially post-deploy recurrence confirmation. |
