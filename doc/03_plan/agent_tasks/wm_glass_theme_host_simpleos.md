...
| Simple Web theme authority | REVIEW REJECTED; UNCOMMITTED; RUNTIME UNVERIFIED; fail-closed | package/compatibility separation and token coverage are prepared, but the canonical candidate emits literal `\\n` separators and omits traffic pseudo-element structure; see the dated Web CSS blocker |
