...
| J: comparator/profile | `src/lib/nogc_sync_mut/test/differential_conformance.spl`, focused specs | semantic projection, handle mapping, GPU profiles | after I |
| K: Mesa/Vulkan SFFI oracle | `src/lib/nogc_sync_mut/gpu/reference_oracle_sffi.spl`, `src/lib/nogc_sync_mut/test/gpu_reference_oracle.spl`, compiled specs | dynload ABI/error/ownership and normalized trace | after I; test-only |
