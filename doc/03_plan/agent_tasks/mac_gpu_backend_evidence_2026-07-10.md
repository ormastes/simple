...
+
+- Merge owner: main workspace owner.
+- Linux Metal-unavailable output is not Metal PASS.
+- Record binary path and timestamp for every report.
+- Higher-model reviewer approval is required before closing the TODO.
