...
- Extend `test/03_system/code_quality/live_kms_security_workflow_spec.spl` to require the operator guide.

Verification:

- `sh scripts/check/check-live-kms-security-workflow.shs`
- `sh scripts/check/check-repo-hygiene.shs`
- `bin/simple test test/03_system/code_quality/live_kms_security_workflow_spec.spl --mode=interpreter`
