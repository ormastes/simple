...
> - 7 Demote pending: DONE — 3 system specs created in `test/system/compiler/`; skip file has no remaining entries
...
- `test/system/compiler/vhdl_testbench_conversion_spec.spl` — combinational spec (W19-4)
- `test/system/compiler/vhdl_clocked_testbench_conversion_spec.spl` — clocked spec (W19-4)
- `test/system/compiler/vhdl_sim_runner_integration_spec.spl` — runner spec (W19-4)
...
- `test/system/compiler/vhdl_testbench_conversion_spec.spl` — combinational converter + source-map shape (text-grep pattern, 6 groups)
- `test/system/compiler/vhdl_clocked_testbench_conversion_spec.spl` — ClockConfig, ResetSequence, CycleAdvance, TimingConstraint, ClockedBench (text-grep pattern, 6 groups)
- `test/system/compiler/vhdl_sim_runner_integration_spec.spl` — GhdlResult phase/pass/fail, SourceMapHook, VhdlTestbenchDiagnostic (text-grep pattern, 7 groups)
