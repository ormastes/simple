...
| `https_sandbox_batch9` | one uncapped HTTPS/sandbox boundary | fail closed with hostile evidence; no provider/runtime shortcut | CRASHED UNCOMMITTED: origin guard duplicate-header and port-range finding retained for a fresh scoped lane |
