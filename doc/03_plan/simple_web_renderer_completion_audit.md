...
- `bin/simple run src/app/wm_compare/site_corpus_compat.spl --only=site_44_the_new_york_times --limit=1 --continue-on-fail --simple-timeout-ms=60000`
  ...
  pixels / SAD `659305`.
- `bin/simple test test/system/wm_compare/famous_site_engine2d_backend_spec.spl --clean`
  ...
  screenshot harness.
- `bin/simple test test/system/wm_compare/emulated_capture_spec.spl --clean`
...
- A 2026-05-28 production-only corpus probe added
  ...
  covers the option in `test/system/wm_compare/famous_site_corpus_spec.spl`.
