...
| **Module System** | `doc/07_guide/module_system.md` | 640 lines | ✅ Documented | 🟢 Clear (8/10) |
...
Start here: `doc/07_guide/quick_reference/stdlib_quick_reference.md`
...
A: `src/lib/src/di.spl` - See `doc/07_guide/dependency_injection_guide.md`

**Q: Where is the mocking framework?**
A: `src/lib/src/testing/mocking*.spl` - See `doc/07_guide/mocking_guide.md`
...
A: `doc/07_guide/module_system.md` - Complete specification
...
### After (Target State)
- ✅ `doc/07_guide/quick_reference/stdlib_quick_reference.md` - One-stop shop
...
- `doc/07_guide/quick_reference/stdlib_quick_reference.md`
- `doc/07_guide/dependency_injection_guide.md`
- `doc/07_guide/mocking_guide.md`
- `doc/07_guide/module_discovery_guide.md`
