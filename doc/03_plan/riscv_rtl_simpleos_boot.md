...
- `bin/simple test test/system/simpleos_tls_baremetal_gate_spec.spl --mode=interpreter`
...
- `bin/simple test test/system/simpleos_tls_embedded_material_spec.spl --mode=interpreter`
...
- `bin/simple test test/system/simpleos_crypto_random_gate_spec.spl --mode=interpreter`
...
- `bin/simple test test/unit/os/tls13/server_accept_spec.spl --mode=interpreter`
  ...
  test/unit/lib/crypto/curve25519_rfc7748_spec.spl
  --mode=interpreter --clean` now passes 7 RFC 7748 examples, and
  `bin/simple test test/unit/lib/crypto/curve25519_smalllimb_probe_spec.spl
