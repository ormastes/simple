...
**Date:** 2026-03-27
**Status:** Complete
**Requirement:** doc/02_requirements/feature/t32_mcp_cli_improvements.md
**Research:** doc/01_research/t32_mcp_cli_async_and_window_ux.md
**Design:** doc/05_design/t32_mcp_cli_improvements.md
...
- Update `doc/07_guide/tools/t32_cli.md`
- Update `doc/07_guide/tools/mcp_t32.md` only if response contracts change
