...
**File:** `doc/07_guide/quick_reference/stdlib_quick_reference.md`

```bash
# Create the file
touch doc/07_guide/quick_reference/stdlib_quick_reference.md
...
cat doc/07_guide/quick_reference/stdlib_quick_reference.md | head -20
```
...
**File:** `doc/07_guide/dependency_injection_guide.md`

```bash
# Create the file
touch doc/07_guide/dependency_injection_guide.md
...
simple test doc/07_guide/dependency_injection_guide.md  # If examples are code
```
...
**File:** `doc/07_guide/mocking_guide.md`

```bash
# Create the file
touch doc/07_guide/mocking_guide.md
...
**File:** `doc/07_guide/module_discovery_guide.md`

```bash
# Create the file
touch doc/07_guide/module_discovery_guide.md
...
grep -o "src/[^)]*" doc/07_guide/module_discovery_guide.md | xargs -I {} ls {}
```
...
ls doc/07_guide/quick_reference/stdlib_quick_reference.md
ls doc/07_guide/dependency_injection_guide.md
ls doc/07_guide/mocking_guide.md
ls doc/07_guide/module_discovery_guide.md
...
$ cat doc/07_guide/dependency_injection_guide.md
...
**Documentation:**
1. `doc/07_guide/quick_reference/stdlib_quick_reference.md`
2. `doc/07_guide/dependency_injection_guide.md`
3. `doc/07_guide/mocking_guide.md`
4. `doc/07_guide/module_discovery_guide.md`
