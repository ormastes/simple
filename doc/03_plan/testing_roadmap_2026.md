...
- `doc/07_guide/mocking_in_simple.md` (user guide)
...
- `doc/07_guide/benchmarking.md` (user guide)
...
- `doc/07_guide/mutation_testing.md` (user guide)
...
**Tasks**:
```simple
# doc/07_guide/property_based_testing.md (new, ~500 lines)
...
**Files**:
- `doc/07_guide/property_based_testing.md` (new)
- `doc/07_guide/snapshot_testing.md` (new)
- `doc/07_guide/architecture_testing.md` (new)
