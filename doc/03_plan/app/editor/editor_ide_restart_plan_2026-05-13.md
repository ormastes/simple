...
bin/simple test test/03_system/editor_md_lsp_code_action_spec.spl --mode=interpreter
...
- `test/03_system/editor_controller_spec.spl`
- `test/03_system/editor_extension_spec.spl`
- `test/03_system/editor_lsp_spec.spl`
- `test/03_system/editor_md_lsp_code_action_spec.spl`
...
bin/simple test test/03_system/editor_lsp_spec.spl --mode=interpreter
bin/simple test test/03_system/editor_md_lsp_code_action_spec.spl --mode=interpreter
bin/simple test test/03_system/editor_markdown_spec.spl --mode=interpreter
bin/simple test test/03_system/dap_protocol_live_spec.spl --mode=interpreter
bin/simple test test/03_system/simple_lsp_protocol_live_spec.spl --mode=interpreter
...
bin/simple test test/03_system/editor_buffer_spec.spl --mode=interpreter --fail-fast
bin/simple test test/03_system/editor_wal_spec.spl --mode=interpreter --fail-fast
bin/simple test test/03_system/editor_gui_spec.spl --mode=interpreter --fail-fast
bin/simple test test/03_system/editor_controller_spec.spl --mode=interpreter --fail-fast
bin/simple check src/app/editor src/lib/editor src/lib/common/markdown test/03_system/editor_buffer_spec.spl test/03_system/editor_controller_spec.spl test/03_system/editor_gui_spec.spl test/03_system/editor_markdown_spec.spl test/03_system/editor_md_wiki_index_spec.spl test/03_system/editor_debug_session_spec.spl test/03_system/editor_keybinding_spec.spl test/03_system/editor_gui_sdl_spec.spl test/03_system/editor_lsp_spec.spl test/03_system/editor_lsp_transport_spec.spl test/03_system/editor_wal_spec.spl
```
...
- Focused regression note resolved for this slice:
  ...
  test/03_system/editor_controller_spec.spl --mode=interpreter --fail-fast`
...
- Keep legacy `test/03_system/dap/dap_stepping_system_spec.spl` in mind: it was
