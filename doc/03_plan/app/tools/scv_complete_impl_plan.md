...
| SCV-IMPL-I-03 | `SymbolEntityId` + declaration extraction (module/type/trait/fn/field/variant/const) from query packs into persistent symbol_entity(+version) rows | I-01, P-06 | `bin/simple test test/integration/app/scv_symbol_entity_spec.spl` | L | scv | done 2026-08-26 (interim .spl structural line scanner — P-06 query-pack hookup is an explicit TODO in `src/lib/scv/symbol_entity.spl`; no multi-language claim) |
