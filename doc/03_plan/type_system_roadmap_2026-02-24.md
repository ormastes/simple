...
|---------|-----------|------|
| Flow-sensitive type narrowing | `doc/05_design/flow_sensitive_narrowing_design.md` | 10-14 days |
| Effect system integration | `doc/05_design/effect_system_integration_design.md` | 12-18 days |

### Planned (plans exist, not implemented)

| Feature | Plan Doc | Est. |
|---------|---------|------|
| Associated types | `doc/03_plan/associated_types_implementation_plan.md` | 8h |
| Higher-rank polymorphism | `doc/03_plan/higher_rank_polymorphism_implementation_plan.md` | 12h |
| Variance inference | `doc/03_plan/rust_feature_parity_roadmap.md` | 8h |
| Macro type checking | `doc/03_plan/macro_type_checking_implementation_plan.md` | 15h |
...
**Design:** `doc/05_design/flow_sensitive_narrowing_design.md`
...
**Plan:** `doc/03_plan/associated_types_implementation_plan.md`
...
**Design:** `doc/05_design/effect_system_integration_design.md`
