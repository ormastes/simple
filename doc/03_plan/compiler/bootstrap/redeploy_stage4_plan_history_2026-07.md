# Stage4 Self-Host Redeploy (#79) — History Appendix (2026-07)

Verbatim archaeology of the Stage-1 wall's diagnosis-and-fix arc across
~2 days of parallel-agent sessions, appended in the order the sections were
originally written. Moved out of the main plan
(`redeploy_stage4_plan_2026-07-08.md`) on 2026-07-10 to keep the main plan
readable — this file is the detailed record, not a plan to act on. For the
current status and next steps, see the main plan.
