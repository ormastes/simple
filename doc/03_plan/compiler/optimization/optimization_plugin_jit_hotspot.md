...
- Added unit coverage in `test/01_unit/compiler/mir_opt/var_reassign_analysis_spec.spl`
...
bin/simple test test/01_unit/compiler/mir_opt/var_reassign_analysis_spec.spl --mode=interpreter --progress none
# PASS: 17 tests

bin/simple test test/03_system/app/compiler/feature/optimization_plugin_jit_hotspot_system_spec.spl --mode=interpreter --progress none
# PASS: 9 tests
...
SIMPLE_LIB=src bin/simple test test/02_integration/app/mcp_stdio_integration_spec.spl --mode=interpreter --progress none
# PASS: status 0, 3 tests

src/compiler_rust/target/debug/simple test test/01_unit/compiler/mir_opt/var_reassign_analysis_spec.spl --mode=interpreter --progress none
# PASS: 17 tests
...
src/compiler_rust/target/debug/simple test test/03_system/app/compiler/feature/optimization_plugin_jit_hotspot_system_spec.spl --mode=interpreter --progress none
# PASS: 9 tests

src/compiler_rust/target/debug/simple run test/05_perf/compiler/jit_hotspot_plan_bench.spl --mode=interpreter
# PASS: checksum-bearing benchmark rows recorded in doc/09_report/verify/optimization_plugin_jit_hotspot_perf_evidence_2026-05-24.md
```
