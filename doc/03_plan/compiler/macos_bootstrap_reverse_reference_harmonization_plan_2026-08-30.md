...
| Concurrency | No shared writable cache until atomic P4 publication exists; later tests cover identical/conflicting writers, pinned readers, crash recovery, and GC. | **PARTIAL:** separate writable lanes and exclusive immutable publication exist; shared-CAS gates remain future scope. |
