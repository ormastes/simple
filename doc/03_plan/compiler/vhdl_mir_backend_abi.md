...
- System spec `test/03_system/compiler/vhdl_mir_backend_multi_output_spec.spl`
...
- `test/01_unit/compiler/vhdl_python_hdl_parity_spec.spl.skip`
- `doc/04_architecture/hardware/vhdl_support_matrix.md`
...
- `test/03_system/compiler/vhdl_mir_backend_multi_output_spec.spl` owns return ABI
...
- `test/03_system/compiler/vhdl_mir_backend_call_port_map_spec.spl` owns direct
...
- `doc/04_architecture/hardware/vhdl_support_matrix.md` names the Rust MIR VHDL backend
...
- `bin/simple test test/03_system/compiler/vhdl_source_facade_spec.spl`
