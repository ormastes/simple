...
| GFO-004 | Manual + wiki + guide | `doc/06_spec/...` (docgen, 0 stubs), `doc/00_llm_process/feature_expert/gpu_frontend_offload/skill.md`, `doc/07_guide/compiler/frontend_offload_switch.md` | DONE 2026-09-05 — 3 manuals `0 stubs` (generated with the main-tree docgen; the committed docgen fails `E1002 spec_kw_line`), guide + tldr, wiki |
