...
**Files:** `src/compiler/60.mir_opt/mir_opt/pattern/rules_clib_parity.spl`, `test/01_unit/compiler/mir_opt/clib_parity_hotspot_spec.spl` (EXCLUSIVE)
**Agent:** Sonnet + Opus advisor
...
**Files:** `test/05_perf/bench/compiled_db_bench_standalone.spl` (EXCLUSIVE)
**Agent:** Sonnet
