...
- 2026-05-26: `src/compiler_rust/target/debug/simple test test/01_unit/compiler/60.mir_opt/general_patterns_spec.spl --mode=interpreter --clean`
  passed with 33 tests.
- 2026-05-26: `bin/simple test test/01_unit/compiler/60.mir_opt/general_patterns_spec.spl`
  passed with 42 tests (7 patterns: 4 original + 3 new general patterns).
- 2026-05-26: `src/compiler_rust/target/debug/simple test test/01_unit/compiler/mir_opt/clib_parity_hotspot_spec.spl --mode=interpreter`
