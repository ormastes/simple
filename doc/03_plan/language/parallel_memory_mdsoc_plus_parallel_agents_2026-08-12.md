...
| WP-13 native transfer codec | partial implementation | strict envelope/inline packet, fail-closed RuntimeValue classification, authority state machine, and all four Rust isolated-thread spawn variants reject unsupported heap inputs before launch; graph sealing/materialization and non-Rust runtime parity remain |
