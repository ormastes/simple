...
| WP-13 native transfer codec | partial implementation | strict 40-byte envelope, 48-byte inline packet, fail-closed RuntimeValue classification, and an opaque region authority state machine with exact receive/rollback generations exist; graph sealing/materialization and production integration remain |
