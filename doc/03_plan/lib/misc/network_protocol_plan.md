...
- SCRAM-SHA-512 (RFC 5802 SHA-512 variant) — `src/os/crypto/scram_sha512.spl`, spec `test/01_unit/os/crypto/scram_sha512_spec.spl`
...
Test scope:   test/01_unit/os/tls13/ or test/01_unit/os/http/
Verify:       bin/simple test test/01_unit/os/tls13/<spec>.spl
