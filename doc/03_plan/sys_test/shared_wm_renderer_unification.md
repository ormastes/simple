...
4. Qt size baseline: `scripts/check-qt-gui-size-baseline.shs` writes a report with `qt_status=unavailable` when Qt is missing and exits successfully.

## Focused Commands

- `sh scripts/check-qt-gui-size-baseline.shs`
