...
| AC-8 | armored child stdout result reaches the bounded parent ingress and owner commit | WP-15, WP-17 | `parent_commit_piped_result_spec.spl`: real pipe, accepted frame, retained-line high-water, and owner receipt; blocked until the self-hosted `test --help` crash is repaired |
