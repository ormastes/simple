...
| REQ-004 | `shared_font_manifest_spec.spl` / `shared_font_manifest_spec.md`, `font_asset_manifest_spec.spl`, `install_font_assets_spec.spl`, `release_archive_layout_spec.spl` | complete license metadata; checksum/table validation; installed-prefix asset/notice resolution; nested portable/full archive runtime discovery; missing field rejection | repository manifest and installed-root/archive-layout source/unit cases present; temp-prefix and package execution remain pending |
