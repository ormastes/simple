...
| REQ-014 | eleven executable/manual pairs | zero-stub manuals; guide/notice freshness; evidence-recipe audit | 10/11 canonical manuals now regenerate with zero stubs and preserve module scope prose, but their executable specs remain unadmitted, so 0/11 pairs are accepted; `gpu_font_emission` remains a dirty noncanonical draft pending checker/source settlement and canonical regeneration |
