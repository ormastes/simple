...
- `test/system/app/ui/feature/accelerated_shared_ui_semantic_contract_spec.spl`
  covers semantic tree and command parity across shell adapters.
- `test/system/app/ui/feature/accelerated_shared_render_pipeline_spec.spl`
  covers pure Simple web renderer to Engine2D capture/equality.
- `test/system/app/compiler/feature/cuda_opencl_offload_contract_spec.spl`
  covers tagged GPU target selection, diagnostics, and artifact metadata.
- `test/perf/backend_compare/accelerated_backend_comparison_spec.spl`
