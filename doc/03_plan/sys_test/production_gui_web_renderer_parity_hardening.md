...
```bash
SIMPLE_LIB=src src/compiler_rust/target/release/simple test test/system/wm_compare/production_gui_web_renderer_parity_hardening_spec.spl --mode=interpreter --clean
```
