...
| Bare-metal probe images | per-arch source/output/linker/compiler/QEMU plan tests; serial evidence field contract tests; generated C source artifact tests for patch/restore/rearm/cleanup/icache/serial evidence; all-arch staging idempotence |
