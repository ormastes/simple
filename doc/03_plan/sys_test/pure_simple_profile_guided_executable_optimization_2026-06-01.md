...
| Spec | Purpose |
|------|---------|
| `test/03_system/app/optimize/feature/sprof_loader_spec.spl` | validate/load/merge profile summaries |
| `test/03_system/app/compile/feature/native_profile_counter_spec.spl` | native counter ABI, disabled-counter behavior, and generated-C function/block/edge/call-path insertion |
| `test/03_system/app/optimize/feature/pure_simple_executable_layout_spec.spl` | layout planner and rejection rules |
| `test/03_system/app/compile/feature/native_layout_section_map_spec.spl` | generated-C section-map parsing and compile-path transform contracts |
| `test/03_system/os/baremetal/feature/breakpoint_counter_profile_spec.spl` | patch/trap/count/restore/auto-disarm state machine |
| `test/03_system/os/baremetal/feature/breakpoint_counter_target_adapter_spec.spl` | x86, ARM/Thumb/AArch64, RISC-V/RVC target adapter resume, QEMU runner planning, and evidence normalization |
| `test/03_system/os/baremetal/feature/breakpoint_counter_probe_image_spec.spl` | per-arch breakpoint probe image planning and serial evidence field contract |
...
| Pure Simple BOLT-like optimizer | metadata-only layout planning tests; native symbol-order/C section-map artifact tests; no external BOLT command dependency; checked native evidence report from `.sprof` through mapped C and measured runtime/size; live generated-C native smoke with baseline and section-mapped binaries |
...
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/app/optimize/feature/sprof_loader_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/app/compile/feature/native_profile_counter_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/app/compile/feature/native_layout_section_map_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/app/optimize/feature/profile_layout_cli_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/app/optimize/feature/pure_simple_executable_layout_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/os/baremetal/feature/breakpoint_counter_profile_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/os/baremetal/feature/breakpoint_counter_target_adapter_spec.spl --mode=interpreter --clean
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/os/baremetal/feature/breakpoint_counter_probe_image_spec.spl --mode=interpreter --clean
