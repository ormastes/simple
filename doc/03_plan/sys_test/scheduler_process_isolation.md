...
- Add unit coverage for per-CPU queue initialization, fair virtual-deadline ordering, scheduler policy update, and schedctl rejection of deadline activation.
