...
- `bin/simple test test/05_perf/graphics_2d/metal_smoke_spec.spl --mode=interpreter`
- `bin/simple run test/05_perf/graphics_2d/perf_2d_runner.spl --mode=interpreter`
