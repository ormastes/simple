...
- Unit: `test/unit/app/ui/web_render_cache_spec.spl` verifies persistent static-shell storage, dynamic-island persistence bypass, in-memory hot cache hits, and compact static-shell binary-plan sizing.
...
- REQ-HCBC-008 through REQ-HCBC-011: render cache unit spec.
