...
fieldset/legend, definition-list, `article`, and blockquote lanes reclassify
those eight named rows into their own fallback rows, leaving 72 in the
...
| Partial remaining | 72 | Tag appears in text/grouped render coverage but lacks isolated end-to-end proof; excludes `hr`,`fieldset`,`legend`,`dl`,`dt`,`dd`,`article`,`blockquote` |
| Bounded selected-profile fallback | 8 | `hr`,`fieldset`,`legend`,`dl`,`dt`,`dd`,`article`,`blockquote`; basic UA/cascade/DrawIR/pixel paths covered, while special formatting and aggregate conformance remain Partial/RED |
...
| REQ-002/004/019/021 | HTML Partial 72 remaining; eight bounded rows split below | Partial | grouped text/tag and bitmap matrices; exact scenario mapping missing | same canonical owners | per-group identity, UA defaults, geometry, DrawIR, pixels | new grouped specs/manuals required | RED |
