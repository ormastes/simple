...
`details`/`summary`, `figure`, `menu`, and `small` lanes reclassify those
fourteen named rows into their own fallback rows, leaving 66 in the
...
| Partial remaining | 66 | Tag appears in text/grouped render coverage but lacks isolated end-to-end proof; excludes `hr`,`fieldset`,`legend`,`dl`,`dt`,`dd`,`article`,`blockquote`,`header`,`details`,`summary`,`figure`,`menu`,`small` |
| Bounded selected-profile fallback | 14 | `hr`,`fieldset`,`legend`,`dl`,`dt`,`dd`,`article`,`blockquote`,`header`,`details`,`summary`,`figure`,`menu`,`small`; basic UA/cascade/DrawIR/pixel paths covered, while special formatting and aggregate conformance remain Partial/RED |
