...
| REQ-002/004/021 | HTML `figure` selected profile | Bounded UA-default behavior | `figure_element_rendering_spec.spl`: `should lower figure UA margins through Draw IR to pixels` | tokenizer/tree, canonical UA defaults/layout, DrawIR, Engine2D | semantic body parent, all four selected UA margins, exact geometry, DrawIR, and component/control pixels | handwritten complete mirror; caption semantics and qualified execution unavailable | Evidence-blocked |
