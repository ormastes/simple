...
- This 2026-06-12 slice rebuilt `src/compiler_rust/target/debug/simple`, passed
  ...
  checked-in fixture contract `checked_in_misuse_fixtures=25`,
  total shell-enforced `total_misuse_fixtures=36`, and
