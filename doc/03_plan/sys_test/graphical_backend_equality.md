...
```bash
SIMPLE_LIB=src src/compiler_rust/target/release/simple test test/system/wm_compare/graphical_backend_equality_spec.spl --mode=interpreter --clean --format json
```
