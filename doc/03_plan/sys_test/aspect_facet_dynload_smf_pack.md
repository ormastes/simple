...
| `test/03_system/app/simple/aspect_catalog_activation_spec.spl` | REQ-AF-003, 006..008; NFR-AF-001..003, 005..007 | Catalog routing, base/aspect load order, cold counters, cache invalidation, shared concurrent transaction, atomic generation |
