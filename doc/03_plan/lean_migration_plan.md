...
1. **Inline Lean Blocks** (`lean{}`)
   ...
   - Documented in `doc/05_design/lean_block_design.md`
...
- `doc/05_design/lean_block_design.md` - Inline blocks and imports
- `doc/07_guide/lean_blocks.md` - User guide
- `doc/03_plan/lean_verification_implementation.md` - Implementation phases
- `simple/std_lib/src/verification/README.md` - Self-hosted verification

### Needs Update

- `doc/07_guide/lean_blocks.md` - Add colocation section
