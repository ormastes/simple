...
- M27 WebGL vector uniform coverage has started: contexts, canvas wrappers, JS lowering, and backend command IR now expose `uniform2f` and `uniform3f` for vec2/vec3 shader parameters used by 3D libraries.
