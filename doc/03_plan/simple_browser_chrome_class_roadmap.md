...
- M26 WebGPU sampler layout validation has started: bind group layouts now distinguish filtering, non-filtering, and comparison sampler bindings and reject incompatible sampler descriptors, covered by `test/web_platform/webgpu/webgpu_resources_spec.spl`.
