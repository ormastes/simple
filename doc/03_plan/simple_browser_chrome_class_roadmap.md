...
- Harden remaining sampler, bind group layout, bind group, render pipeline, compute pipeline, queue submission, error scope, and device-lost edge cases against CTS coverage and native backend integration.
