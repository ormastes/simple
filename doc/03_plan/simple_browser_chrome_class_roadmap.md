...
- Browser script execution now captures transpiled JavaScript console output through the generated script wrapper and `ScriptHost` console buffer, covered by `test/browser_engine/script/script_host_spec.spl`.
