...
```bash
bin/simple test test/01_unit/os/sosix/share_api_spec.spl
```

Run the system feature spec:

```bash
bin/simple test test/03_system/app/os/feature/sosix_process_sharing_spec.spl
```

Run the full SOSIX unit suite before merging with adjacent SOSIX changes:

```bash
bin/simple test test/01_unit/os/sosix
```
...
|-------------|-----------|------------|----------|
| REQ-SOSIX-SHARE-001 | `test/01_unit/os/sosix/share_api_spec.spl`, `test/03_system/app/os/feature/sosix_process_sharing_spec.spl` | create, seal, read, reject post-seal write | Full |
| REQ-SOSIX-SHARE-002 | `test/01_unit/os/sosix/share_api_spec.spl`, `test/03_system/app/os/feature/sosix_process_sharing_spec.spl` | send, receive, payload bytes, readiness restoration | Full |
| REQ-SOSIX-SHARE-003 | `test/01_unit/os/sosix/share_api_spec.spl`, `test/03_system/app/os/feature/sosix_process_sharing_spec.spl` | sealed attachment transfer, attached dataset read, unsealed rejection | Full |
