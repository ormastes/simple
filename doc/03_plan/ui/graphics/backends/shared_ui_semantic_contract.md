...
- Initial `src/lib/common/ui/semantic_contract.spl` facade exists and is covered
  by `test/01_unit/app/ui/semantic_contract_spec.spl`.
...
- Initial helpers exist in `app.ui.web`, `app.ui.tui`, `app.ui.electron`,
  ...
  `test/01_unit/app/ui/semantic_backend_helpers_spec.spl`.
...
- generated/manual mirrored docs under `doc/06_spec/test/03_system/app/ui/feature/`
