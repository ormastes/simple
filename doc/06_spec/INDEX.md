...
| Feature | Status | Difficulty | Tests | Coverage | Details |
|---------|--------|------------|-------|----------|----------|
| [Browser Session Wasm Script Specification](test/01_unit/lib/common/web/browser_session_wasm_script_spec.md) | Auto-generated | N/A | 3 | 0% | 0 lines |
| [Browser Session WASM Fetch Bridge Specification](test/01_unit/lib/common/web/browser_session_wasm_fetch_bridge_spec.md) | Manual | N/A | 2 | 20% | 48 lines |
| [Browser Session Fetch Wasm Chain Specification](unit/lib/common/web/browser_session_fetch_wasm_chain_spec.md) | Manual | N/A | 225 | 20% | Existing broad regression manual |
