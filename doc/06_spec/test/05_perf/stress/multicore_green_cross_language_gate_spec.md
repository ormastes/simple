...
[1/1] test/05_perf/stress/multicore_green_cross_language_gate_spec.spl PASSED
Files: 1
Passed: 3
Failed: 0
```
...
- Verify Simple worker rows stay inside smoke thresholds
...
- Verify Simple fanout rows stay inside smoke thresholds
