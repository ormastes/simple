...
<!-- sdn-diagram:id=compilation_stress_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compilation_stress_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compilation_stress_small_spec -> std
```
...
```ascii generated-from=compilation_stress_small_spec.arch hash=sha256:auto
