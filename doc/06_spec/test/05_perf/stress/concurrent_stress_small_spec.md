...
<!-- sdn-diagram:id=concurrent_stress_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=concurrent_stress_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

concurrent_stress_small_spec -> std
```
...
```ascii generated-from=concurrent_stress_small_spec.arch hash=sha256:auto
