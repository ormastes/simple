...
#### link-click is explicitly recorded as a gap, not silently green

- print "Loaded evidence with {entries len
   - Expected: get_env_value(entries, "link_click_status") equals `skipped_no_navigation_model`
