...
<!-- sdn-diagram:id=collections_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=collections_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

collections_system_spec -> std
```
...
```ascii generated-from=collections_system_spec.arch hash=sha256:auto
...
| Difficulty | 5/5 |
| Status | Implemented |
| Source | `test/03_system/feature/features/collections_system_spec.spl` |
| Updated | 2026-06-01 |
