...
expect(row).to_contain("test/03_system/feature/usage/cooperative_green_smf_mutable_global_blocker_spec.spl")
...
expect(row).to_contain("doc/06_spec/test/03_system/feature/usage/cooperative_green_smf_mutable_global_blocker_spec.md")
