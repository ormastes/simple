...
expect(sys_test_plan).to_contain("f531dbb40312 docs: refresh multicore green report index")
expect(sys_test_plan).to_contain("2026-06-14 report-index slice")
...
expect(agent_plan).to_contain("f531dbb40312 docs: refresh multicore green report index")
expect(agent_plan).to_contain("2026-06-14 report-index slice")
