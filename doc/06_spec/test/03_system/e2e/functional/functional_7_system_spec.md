...
<!-- sdn-diagram:id=functional_7_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=functional_7_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

functional_7_system_spec -> std
```
...
```ascii generated-from=functional_7_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/e2e/functional/functional_7_system_spec.spl` |
| Updated | 2026-06-01 |
