...
- Assert the Electron layout manifest and RenderDoc gates remain visible
   ...
   - Expected: rendering_manifest_css_count equals `160`
   ...
   - Expected: rendering_manifest_css_covered equals `160`
   - Expected: rendering_manifest_css_covered_names.split(",").len() equals `160`
   ...
   - Expected: full_rendering_goal_implemented_css_total equals `160`
   - Expected: full_rendering_goal_implemented_css_rendered equals `160`
   ...
   - Expected: full_rendering_goal_full_css_rendered equals `160`
   ...
   - Expected: traceability_implemented_css_count equals `160`
...
expect(rendering_manifest_css_count).to_equal("160")
...
expect(rendering_manifest_css_covered).to_equal("160")
...
expect(rendering_manifest_css_covered_names.split(",").len()).to_equal(160)
...
expect(rendering_manifest_unrendered_css_count.to_i64()).to_be_greater_than(233)
...
expect(full_rendering_goal_implemented_css_total).to_equal("160")
expect(full_rendering_goal_implemented_css_rendered).to_equal("160")
...
expect(full_rendering_goal_full_css_rendered).to_equal("160")
...
expect(traceability_implemented_css_count).to_equal("160")
expect(traceability_implemented_css_indexed_count.to_i64()).to_be_greater_than(50)
expect(traceability_unsupported_css_count.to_i64()).to_be_greater_than(240)
