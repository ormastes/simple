...
expect(evidence).to_contain("blocked_completion_gate=Electron Chromium/Vulkan RenderDoc .rdc with RDOC magic")
expect(evidence).to_contain("blocked_completion_gates=Electron Chromium/Vulkan RenderDoc .rdc with RDOC magic")
