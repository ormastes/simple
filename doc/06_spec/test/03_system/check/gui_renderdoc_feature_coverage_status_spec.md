...
- The Electron Simple Web layout manifest remains visible with its 37 cases.
...
- Assert the Electron layout manifest and RenderDoc gates remain visible
   - Expected: manifest_cases equals `37`
...
expect(manifest_cases).to_equal("37")
...
expect(report).to_contain("- Electron layout manifest cases: 37")
```
