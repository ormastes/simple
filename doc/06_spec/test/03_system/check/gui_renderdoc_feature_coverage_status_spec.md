...
- The Electron Simple Web layout manifest remains visible with its 33 cases.
...
- Assert the Electron layout manifest and RenderDoc gates remain visible
   - Expected: manifest_cases equals `33`
...
expect(manifest_cases).to_equal("33")
...
expect(report).to_contain("- Electron layout manifest cases: 33")
```
