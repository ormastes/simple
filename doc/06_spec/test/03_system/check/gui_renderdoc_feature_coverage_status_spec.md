...
## 8K Perf Evidence Contract

The retained 8K perf source is generated by:
...
The aggregate forwards these fields:
...
Completion remains blocked until the 8K status is `pass`. A measured RSS row
