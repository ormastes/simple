...
- Assert the Electron layout manifest and RenderDoc gates remain visible
   ...
   - Expected: full_rendering_goal_implemented_css_total equals `131`
   - Expected: full_rendering_goal_implemented_css_rendered equals `131`
   ...
   - Expected: full_rendering_goal_full_css_rendered equals `131`
   ...
   - Expected: traceability_implemented_css_count equals `131`
...
expect(evidence).to_contain("html_css_rendering_manifest_traceability_css_property_count=131")
expect(evidence).to_contain("html_css_rendering_manifest_traceability_css_property_covered_count=131")
...
expect(evidence).to_contain("html_css_implemented_surface_css_total_count=131")
expect(evidence).to_contain("html_css_implemented_surface_css_rendered_count=131")
...
expect(evidence).to_contain("html_css_full_css_completion_rendered_count=131")
...
expect(evidence).to_contain("html_css_traceability_implemented_css_property_count=131")
...
expect(evidence).to_contain("electron_renderdoc_evidence_env=build/renderdoc/electron-display-helper/electron-html/evidence.env")
...
expect(evidence).to_contain("electron_renderdoc_gate_command=RDOC_ELECTRON_HTML_EVIDENCE_ENV=build/renderdoc/electron-display-helper/electron-html/evidence.env sh scripts/check/check-renderdoc-electron-html-gate.shs")
...
expect(full_rendering_goal_implemented_css_total).to_equal("131")
expect(full_rendering_goal_implemented_css_rendered).to_equal("131")
...
expect(full_rendering_goal_full_css_rendered).to_equal("131")
...
expect(traceability_implemented_css_count).to_equal("131")
...
val command = "rm -rf build/test-gui-renderdoc-feature-coverage-status-strict; GUI_RENDERDOC_AGGREGATE_STATIC_CACHE_DIR=build/test-gui-renderdoc-feature-coverage-static-cache BUILD_DIR=build/test-gui-renderdoc-feature-coverage-status-strict REPORT_PATH=build/test-gui-renderdoc-feature-coverage-status-strict/report.md GUI_RENDERDOC_STATUS_STRICT=1 sh scripts/check/check-gui-renderdoc-feature-coverage-status.shs; printf 'strict_exit=%s\\n' \"$?\""
...
expect(evidence).to_contain("gui_showcase_4k_200fps_simple_bin=src/compiler_rust/target/release/simple")
expect(evidence).to_contain("gui_showcase_4k_200fps_simple_bin_source=repo-bin")
...
expect(evidence).to_contain("gui_showcase_8k_perf_simple_bin=src/compiler_rust/target/release/simple")
expect(evidence).to_contain("gui_showcase_8k_perf_simple_bin_source=repo-bin")
...
expect(evidence).to_contain("gui_widget_renderdoc_goal_simple_gate_source_env=build/test-gui-renderdoc-feature-coverage-status-production-required/widget-simple/evidence.env")
expect(evidence).to_contain("gui_widget_renderdoc_goal_simple_gate_capture_command=RDOC_OUTPUT_DIR=build/renderdoc/widget-probe-small RDOC_SIMPLE_PROG=\"$PWD/src/app/test/renderdoc_vulkan_widget_capture.spl\" RDOC_HTML_PATH=\"$PWD/test/fixtures/html_css/generated_gui_vulkan_renderdoc_fixture.html\" scripts/tool/renderdoc-evidence.shs capture-simple")
expect(evidence).to_contain("gui_widget_renderdoc_goal_simple_gate_required_backend=simple")
expect(evidence).to_contain("gui_widget_renderdoc_goal_simple_gate_required_scene=vulkan-engine2d")
expect(evidence).to_contain("gui_widget_renderdoc_goal_simple_gate_required_program=src/app/test/renderdoc_vulkan_widget_capture.spl")
...
val command_with_bad_readback_newline = command_with_pixel_files.replace("vulkan_engine2d_readback_rect_mismatches=0\\n", "vulkan_engine2d_readback_rect_mismatches=7\\n")
val command_with_bad_readback = command_with_bad_readback_newline.replace("vulkan_engine2d_readback_rect_mismatches=0\\\\n", "vulkan_engine2d_readback_rect_mismatches=7\\\\n")
...
expect(evidence).to_contain("blocked_completion_gate=native render-log comparison for Linux Vulkan, macOS Metal, and Windows D3D12")
expect(evidence).to_contain("blocked_completion_gate_count=5")
expect(evidence).to_contain("blocked_completion_gates=native render-log comparison for Linux Vulkan, macOS Metal, and Windows D3D12|production GUI/web font offload readback evidence|production GUI/web raw Metal readback evidence|production GUI/web parity evidence with live Tauri and Chrome captures|full CSS specification rendering coverage beyond implemented Simple Web subset")
expect(evidence).to_contain("gui_renderdoc_feature_coverage_status=incomplete")
