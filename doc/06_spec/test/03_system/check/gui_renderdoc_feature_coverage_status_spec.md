...
- Assert the Electron layout manifest and RenderDoc gates remain visible
   ...
   - Expected: rendering_manifest_css_count equals `105`
   - Expected: rendering_manifest_css_covered equals `105`
   - Expected: rendering_manifest_css_covered_names.split(",").len() equals `105`
   ...
   - Expected: full_rendering_goal_implemented_css_total equals `105`
   - Expected: full_rendering_goal_implemented_css_rendered equals `105`
   ...
   - Expected: full_rendering_goal_full_css_rendered equals `105`
   ...
   - Expected: traceability_implemented_css_count equals `105`
...
expect(evidence).to_contain("html_css_rendering_manifest_traceability_css_property_count=105")
expect(evidence).to_contain("html_css_rendering_manifest_traceability_css_property_covered_count=105")
...
expect(evidence).to_contain("html_css_implemented_surface_css_total_count=105")
expect(evidence).to_contain("html_css_implemented_surface_css_rendered_count=105")
...
expect(evidence).to_contain("html_css_full_css_completion_rendered_count=105")
...
expect(evidence).to_contain("html_css_traceability_implemented_css_property_count=105")
...
expect(rendering_manifest_css_count).to_equal("105")
expect(rendering_manifest_css_covered).to_equal("105")
...
expect(rendering_manifest_css_covered_names.split(",").len()).to_equal(105)
...
expect(full_rendering_goal_implemented_css_total).to_equal("105")
expect(full_rendering_goal_implemented_css_rendered).to_equal("105")
...
expect(full_rendering_goal_full_css_rendered).to_equal("105")
...
expect(traceability_implemented_css_count).to_equal("105")
...
expect(report).to_contain("- HTML/CSS rendered implemented properties: 105/105 (implemented-simple-web-css)")
expect(report).to_contain("- HTML/CSS full CSS spec render gap:")
expect(report).to_contain("- HTML/CSS full rendering goal: incomplete (full-css-rendering-incomplete; full CSS 105/")
...
expect(evidence).to_contain("blocked_completion_gate_count=9")
