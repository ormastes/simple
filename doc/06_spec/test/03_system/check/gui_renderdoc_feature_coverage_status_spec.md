...
- Assert the Electron layout manifest and RenderDoc gates remain visible
   ...
   - Expected: rendering_manifest_css_count equals `130`
   - Expected: rendering_manifest_css_covered equals `130`
   - Expected: rendering_manifest_css_covered_names.split(",").len() equals `130`
   ...
   - Expected: full_rendering_goal_implemented_css_total equals `130`
   - Expected: full_rendering_goal_implemented_css_rendered equals `130`
   ...
   - Expected: full_rendering_goal_full_css_rendered equals `130`
   ...
   - Expected: traceability_implemented_css_count equals `130`
...
expect(evidence).to_contain("html_css_rendering_manifest_traceability_css_property_count=130")
expect(evidence).to_contain("html_css_rendering_manifest_traceability_css_property_covered_count=130")
...
expect(evidence).to_contain("html_css_implemented_surface_css_total_count=130")
expect(evidence).to_contain("html_css_implemented_surface_css_rendered_count=130")
...
expect(evidence).to_contain("html_css_full_css_completion_rendered_count=130")
...
expect(evidence).to_contain("html_css_traceability_implemented_css_property_count=130")
...
expect(rendering_manifest_css_count).to_equal("130")
expect(rendering_manifest_css_covered).to_equal("130")
...
expect(rendering_manifest_css_covered_names.split(",").len()).to_equal(130)
...
expect(rendering_manifest_unrendered_css_count.to_i64()).to_be_greater_than(270)
...
expect(full_rendering_goal_implemented_css_total).to_equal("130")
expect(full_rendering_goal_implemented_css_rendered).to_equal("130")
...
expect(full_rendering_goal_full_css_rendered).to_equal("130")
...
expect(traceability_implemented_css_count).to_equal("130")
expect(traceability_implemented_css_indexed_count.to_i64()).to_be_greater_than(50)
expect(traceability_unsupported_css_count.to_i64()).to_be_greater_than(270)
...
expect(report).to_contain("- HTML/CSS rendered implemented properties: 130/130 (implemented-simple-web-css)")
expect(report).to_contain("- HTML/CSS full CSS spec render gap:")
expect(report).to_contain("- HTML/CSS full rendering goal: incomplete (full-css-rendering-incomplete; full CSS 130/")
...
expect(summary_evidence).to_contain("gui_renderdoc_feature_coverage_reason=browser-backing-pass-missing-proof:")
