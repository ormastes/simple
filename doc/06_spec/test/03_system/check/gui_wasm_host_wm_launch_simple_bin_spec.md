...
<!-- sdn-diagram:id=gui_wasm_host_wm_launch_simple_bin_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=gui_wasm_host_wm_launch_simple_bin_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

gui_wasm_host_wm_launch_simple_bin_spec -> std
```
...
```ascii generated-from=gui_wasm_host_wm_launch_simple_bin_spec.arch hash=sha256:auto
...
- **Plan:** [doc/03_plan/ui/mobile_wasm_gui/mobile_simple_wasm_gui_plan.md](doc/03_plan/ui/mobile_wasm_gui/mobile_simple_wasm_gui_plan.md)
