...
<!-- sdn-diagram:id=macos_wm_fullscreen_metal_evidence_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=macos_wm_fullscreen_metal_evidence_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

macos_wm_fullscreen_metal_evidence_spec -> std
```
...
```ascii generated-from=macos_wm_fullscreen_metal_evidence_spec.arch hash=sha256:auto
