...
<!-- sdn-diagram:id=gui_showcase_perf_nonzero_contract_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=gui_showcase_perf_nonzero_contract_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

gui_showcase_perf_nonzero_contract_spec -> std
```
...
```ascii generated-from=gui_showcase_perf_nonzero_contract_spec.arch hash=sha256:auto
