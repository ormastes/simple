...
<!-- sdn-diagram:id=cpu_simd_gpu_scheduling_parity_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=cpu_simd_gpu_scheduling_parity_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

cpu_simd_gpu_scheduling_parity_spec -> std
```
...
```ascii generated-from=cpu_simd_gpu_scheduling_parity_spec.arch hash=sha256:auto
...
- **Plan:** [doc/08_tracking/bug/cpu_simd_gpu_scheduling_parity_gate_missing_2026-07-09.md](doc/08_tracking/bug/cpu_simd_gpu_scheduling_parity_gate_missing_2026-07-09.md)
