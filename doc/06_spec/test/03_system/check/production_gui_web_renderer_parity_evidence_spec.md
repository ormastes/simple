...
expect(script).to_contain("elif [ -x \"bin/simple\" ]; then")
...
expect(script.index_of("elif [ -x \"bin/simple\" ]; then")).to_be_less_than(script.index_of("elif [ -x \"src/compiler_rust/target/release/simple\" ]; then"))
```
...
#### records the default subcheck timeout budget for full wrapper fixtures
...
```simple
val root = "build/test-production-gui-web-renderer-parity-default-timeout"
val command = "rm -rf " + root + " && mkdir -p " + root + "/fixture && " +
    ...
    "printf '#!/bin/sh\\nmkdir -p \"$BUILD_DIR\"\\nprintf \"production_gui_font_offload_status=pass\\\\nproduction_gui_font_offload_reason=pass\\\\nproduction_gui_font_offload_metal_payload_status=pass\\\\nproduction_gui_font_offload_metal_payload_reason=metal-font-glyph-payload-readback-matched\\\\nproduction_gui_font_offload_vector_backend=metal\\\\nproduction_gui_font_offload_vector_status=gpu-glyph-returned\\\\nproduction_gui_font_offload_vector_accel_attempts=1\\\\nproduction_gui_font_offload_vector_metal_hits=1\\\\nproduction_gui_font_offload_vector_cuda_hits=0\\\\nproduction_gui_font_offload_vector_opencl_hits=0\\\\nproduction_gui_font_offload_vector_cpu_fallback_hits=0\\\\nproduction_gui_font_offload_vector_gpu_returned_glyphs=1\\\\nproduction_gui_font_offload_vector_gpu_returned_glyph_pixels=6\\\\nproduction_gui_font_offload_vector_readback_status=vector-font-glyph-readback-matched\\\\nproduction_gui_font_offload_vector_production_ready=true\\\\nproduction_gui_font_offload_bitmap_backend=metal\\\\nproduction_gui_font_offload_bitmap_status=gpu-raster-plan-without-readback\\\\nproduction_gui_font_offload_bitmap_accel_attempts=1\\\\nproduction_gui_font_offload_bitmap_metal_hits=1\\\\nproduction_gui_font_offload_bitmap_cuda_hits=0\\\\nproduction_gui_font_offload_bitmap_opencl_hits=0\\\\nproduction_gui_font_offload_bitmap_cpu_fallback_hits=0\\\\nproduction_gui_font_offload_bitmap_gpu_returned_glyphs=1\\\\nproduction_gui_font_offload_bitmap_gpu_returned_glyph_pixels=6\\\\nproduction_gui_font_offload_bitmap_readback_status=gpu-glyph-raster-readback-matched\\\\nproduction_gui_font_offload_bitmap_production_ready=true\\\\n\" > \"$BUILD_DIR/evidence.env\"\\n' > " + root + "/fixture/font.sh && " +
...
expect(evidence).to_contain("production_gui_web_renderer_parity_matrix_timeout_secs=300")
expect(evidence).to_contain("production_gui_web_renderer_parity_layout_manifest_timeout_secs=300")
expect(evidence).to_contain("production_gui_web_renderer_parity_surface_manifest_timeout_secs=300")
expect(evidence).to_contain("production_gui_web_renderer_parity_backend_timeout_secs=300")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_timeout_secs=300")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_metal_payload_status=pass")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_metal_payload_reason=metal-font-glyph-payload-readback-matched")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_vector_accel_attempts=1")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_vector_metal_hits=1")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_vector_cpu_fallback_hits=0")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_vector_gpu_returned_glyph_pixels=6")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_bitmap_accel_attempts=1")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_bitmap_metal_hits=1")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_bitmap_cpu_fallback_hits=0")
expect(evidence).to_contain("production_gui_web_renderer_parity_font_offload_bitmap_gpu_returned_glyph_pixels=6")
expect(evidence).to_contain("production_gui_web_renderer_parity_metal_readback_timeout_secs=300")
```
