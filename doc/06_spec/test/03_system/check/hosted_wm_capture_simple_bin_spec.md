...
<!-- sdn-diagram:id=hosted_wm_capture_simple_bin_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=hosted_wm_capture_simple_bin_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

hosted_wm_capture_simple_bin_spec -> std
```
...
```ascii generated-from=hosted_wm_capture_simple_bin_spec.arch hash=sha256:auto
