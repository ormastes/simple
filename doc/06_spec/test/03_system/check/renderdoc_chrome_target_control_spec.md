...
<!-- sdn-diagram:id=renderdoc_chrome_target_control_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=renderdoc_chrome_target_control_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

renderdoc_chrome_target_control_spec -> std
```
...
```ascii generated-from=renderdoc_chrome_target_control_spec.arch hash=sha256:auto
