...
- All 232 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 162 still
  unrendered and 169 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `232`
   - Expected: full_css_unrendered equals `162`
   - Expected: unsupported_inventory equals `169`
   - Expected: full_css_unrendered_properties.split(",").len() equals `162`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=232")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=232")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=232")
...
expect(full_css_rendered).to_equal("232")
expect(full_css_unrendered).to_equal("162")
expect(unsupported_inventory).to_equal("169")
expect(full_css_unrendered_properties.split(",").len()).to_equal(162)
...
expect(report).to_contain("- implemented CSS rendered: 232/232")
