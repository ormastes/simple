...
- All 188 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 206 still
  unrendered and 213 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `188`
   - Expected: full_css_unrendered equals `206`
   - Expected: unsupported_inventory equals `213`
   - Expected: full_css_unrendered_properties.split(",").len() equals `206`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=188")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=188")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=188")
...
expect(full_css_rendered).to_equal("188")
expect(full_css_unrendered).to_equal("206")
expect(unsupported_inventory).to_equal("213")
expect(full_css_unrendered_properties.split(",").len()).to_equal(206)
...
expect(report).to_contain("- implemented CSS rendered: 188/188")
