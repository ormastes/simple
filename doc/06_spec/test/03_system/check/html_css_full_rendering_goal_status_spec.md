...
- All 131 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 263 still
  unrendered and 270 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `131`
   - Expected: full_css_unrendered equals `263`
   - Expected: unsupported_inventory equals `270`
   - Expected: full_css_unrendered_properties.split(",").len() equals `263`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=131")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=131")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=131")
...
expect(report).to_contain("- implemented CSS rendered: 131/131")
