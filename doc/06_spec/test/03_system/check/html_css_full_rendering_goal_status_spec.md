...
- All 236 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 158 still
  unrendered and 165 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `236`
   - Expected: full_css_unrendered equals `158`
   - Expected: unsupported_inventory equals `165`
   - Expected: full_css_unrendered_properties.split(",").len() equals `158`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=236")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=236")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=236")
...
expect(full_css_rendered).to_equal("236")
expect(full_css_unrendered).to_equal("158")
expect(unsupported_inventory).to_equal("165")
expect(full_css_unrendered_properties.split(",").len()).to_equal(158)
...
expect(report).to_contain("- implemented CSS rendered: 236/236")
