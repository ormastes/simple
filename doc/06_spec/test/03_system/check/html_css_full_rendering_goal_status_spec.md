...
- All 122 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 272 still
  unrendered and 279 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `122`
   - Expected: full_css_unrendered equals `277`
   - Expected: unsupported_inventory equals `279`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=122")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=122")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=122")
...
expect(full_css_rendered).to_equal("122")
expect(full_css_unrendered).to_equal("277")
expect(unsupported_inventory).to_equal("279")
...
expect(report).to_contain("- implemented CSS rendered: 122/122")
