...
- All 233 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 161 still
  unrendered and 168 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: unsupported_inventory equals `168`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=233")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=233")
...
expect(unsupported_inventory).to_equal("168")
...
expect(report).to_contain("- implemented CSS rendered: 233/233")
