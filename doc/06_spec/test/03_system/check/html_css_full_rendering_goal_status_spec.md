...
- All 237 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 157 still
  unrendered and 164 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `237`
   - Expected: full_css_unrendered equals `157`
   - Expected: unsupported_inventory equals `164`
   - Expected: full_css_unrendered_properties.split(",").len() equals `157`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=237")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=237")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=237")
...
expect(full_css_rendered).to_equal("237")
expect(full_css_unrendered).to_equal("157")
expect(unsupported_inventory).to_equal("164")
expect(full_css_unrendered_properties.split(",").len()).to_equal(157)
...
expect(report).to_contain("- implemented CSS rendered: 237/237")
