...
- All 184 implemented Simple Web CSS properties are rendered in fixture CSS.
- The current full CSS inventory is tested as 394 properties, with 210 still
  unrendered and 217 held in unsupported-inventory ownership.
...
- Read the full rendering goal evidence
   ...
   - Expected: full_css_rendered equals `184`
   - Expected: full_css_unrendered equals `210`
   - Expected: unsupported_inventory equals `217`
   - Expected: full_css_unrendered_properties.split(",").len() equals `210`
...
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_total_count=184")
expect(evidence).to_contain("html_css_full_rendering_goal_implemented_css_rendered_count=184")
...
expect(evidence).to_contain("html_css_full_rendering_goal_full_css_rendered_count=184")
...
expect(full_css_rendered).to_equal("184")
expect(full_css_unrendered).to_equal("210")
expect(unsupported_inventory).to_equal("217")
expect(full_css_unrendered_properties.split(",").len()).to_equal(210)
...
expect(report).to_contain("- implemented CSS rendered: 184/184")
