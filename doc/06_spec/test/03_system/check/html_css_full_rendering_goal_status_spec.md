...
expect(full_css_rendered).to_equal("131")
expect(full_css_unrendered).to_equal("263")
expect(unsupported_inventory).to_equal("270")
expect(full_css_unrendered_properties.split(",").len()).to_equal(263)
