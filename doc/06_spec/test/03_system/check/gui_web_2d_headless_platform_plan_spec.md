...
> This source-only SSpec protects the headless preparation contract for the active GUI/Web/2D hardening lane. It intentionally does not launch Chrome, Electron, RenderDoc, Xcode GPU Frame Capture, PIX, or any GUI wrapper.
