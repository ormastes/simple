...
#### rejects checksum rows that do not match captured Electron ARGB

-  proof command
-  proof command
   - Expected: code equals `1`
- Confirm internally matching proof checksums must still match captured Electron ARGB
