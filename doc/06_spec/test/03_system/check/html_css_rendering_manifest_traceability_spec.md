...
- All 66 implemented Simple Web CSS properties appear in actual rendered
  fixture CSS.
...
- Read the emitted evidence contract
   ...
   - Expected: css_count equals `66`
   - Expected: css_covered equals `66`
   - Expected: css_covered_names contains `"align-content"`
   - Expected: css_covered_names contains `"align-items"`
   - Expected: css_covered_names contains `"align-self"`
   - Expected: css_covered_names.split(",").len() equals `66`
...
expect(css_count).to_equal("66")
expect(css_covered).to_equal("66")
...
expect(css_covered_names.split(",").len()).to_equal(66)
...
expect(report).to_contain("- implemented CSS properties: 66/66")
```
