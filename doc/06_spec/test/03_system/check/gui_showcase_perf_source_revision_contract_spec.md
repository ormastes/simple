...
<!-- sdn-diagram:id=gui_showcase_perf_source_revision_contract_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=gui_showcase_perf_source_revision_contract_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

gui_showcase_perf_source_revision_contract_spec -> std
```
...
```ascii generated-from=gui_showcase_perf_source_revision_contract_spec.arch hash=sha256:auto
...
Each test uses explicit `GUI_RENDERDOC_AGGREGATE_FIXTURE_MODE=1` with
`GUI_SHOWCASE_CURRENT_SOURCE_REVISION=current123` and a synthetic
