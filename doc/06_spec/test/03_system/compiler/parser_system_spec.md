...
<!-- sdn-diagram:id=parser_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=parser_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

parser_system_spec -> std
```
...
```ascii generated-from=parser_system_spec.arch hash=sha256:auto
