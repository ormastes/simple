...
<!-- sdn-diagram:id=compiler_driver_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compiler_driver_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compiler_driver_system_spec -> std
```
...
```ascii generated-from=compiler_driver_system_spec.arch hash=sha256:auto
