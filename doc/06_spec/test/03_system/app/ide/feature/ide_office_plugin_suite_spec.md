...
expect(tui_report).to_contain("counter: Counter")
expect(tui_report).to_contain("counter: app.office.counter increment=true decrement=true fail_closed=true")
expect(tui_report).to_contain("launcher: Office Launcher")
expect(tui_report).to_contain("launcher: app.office.launcher actions=9 cards=9 fail_closed=true")
...
expect(registry_checks).to_contain("fail_closed=true")
expect(registry_checks).to_contain("actions=true")
...
expect(lines[21]).to_start_with("counter:")
expect(lines[22]).to_start_with("  check:")
expect(lines[23]).to_start_with("launcher:")
expect(lines[24]).to_start_with("  check:")
expect(lines[25]).to_start_with("sheets:")
expect(lines[27]).to_start_with("  edit-command:")
expect(lines[29]).to_start_with("agent-dashboard:")
expect(lines[31]).to_start_with("db-admin:")
...
expect(capture).to_contain("counter: Counter")
expect(capture).to_contain("launcher: Office Launcher")
...
expect(probe.connector_handle_metadata).to_be(true)
...
expect(ide_draw_sanity_summary()).to_contain("handle_meta=true")
...
expect(guide).to_contain("value|counter_increment|counter_decrement|counter_reset")
```
...
expect(catalog.len()).to_equal(12)
...
expect(catalog[3].source_format).to_equal("slides")
expect(catalog[4].source_format).to_equal("sdd")
expect(catalog[5].source_format).to_equal("html-ui")
expect(catalog[6].source_format).to_equal("table")
expect(catalog[7].source_format).to_equal("math")
expect(catalog[8].source_format).to_equal("mail")
expect(catalog[9].source_format).to_equal("planner")
expect(catalog[10].source_format).to_equal("counter")
expect(catalog[11].source_format).to_equal("launcher")
val dispatch_probe = office_catalog_dispatch_probe()
expect(dispatch_probe.advertised_count).to_equal(137)
expect(dispatch_probe.recognized_count).to_equal(137)
...
expect(catalog[1].features.join(",")).to_contain("document-range-read")
expect(catalog[1].features.join(",")).to_contain("document-replace")
expect(catalog[1].features.join(",")).to_contain("document-insert")
...
expect(catalog[4].features.join(",")).to_contain("edge-label-readback")
...
expect(catalog[4].features.join(",")).to_contain("canvas-readback")
...
expect(catalog[4].features.join(",")).to_contain("outline-readback")
expect(catalog[4].features.join(",")).to_contain("style-rules-readback")
...
expect(catalog[4].actions.join(",")).to_contain("sdd-outline-read")
expect(catalog[4].actions.join(",")).to_contain("sdd-style-rules-read")
...
expect(catalog[4].features.join(",")).to_contain("style-extends-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-style-extends-read")
expect(catalog[4].features.join(",")).to_contain("style-target-readback")
...
expect(catalog[4].features.join(",")).to_contain("node-resolved-style-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-node-resolved-style-read")
expect(catalog[4].features.join(",")).to_contain("node-resolved-style-value-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-node-resolved-style-value-read")
...
expect(catalog[4].features.join(",")).to_contain("edge-route-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-edge-route-read")
expect(catalog[4].features.join(",")).to_contain("edge-path-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-edge-path-read")
expect(catalog[4].features.join(",")).to_contain("edge-segments-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-edge-segments-read")
expect(catalog[4].features.join(",")).to_contain("edge-resolved-style-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-edge-resolved-style-read")
expect(catalog[4].features.join(",")).to_contain("edge-resolved-style-value-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-edge-resolved-style-value-read")
expect(catalog[4].features.join(",")).to_contain("edge-endpoints-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-edge-endpoints-read")
...
expect(catalog[4].features.join(",")).to_contain("node-child-count-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-node-child-count-read")
...
expect(catalog[4].features.join(",")).to_contain("node-layer-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-node-layer-read")
expect(catalog[4].actions.join(",")).to_contain("order-sdd-node")
expect(catalog[4].features.join(",")).to_contain("node-order-readback")
expect(catalog[4].actions.join(",")).to_contain("sdd-node-order-read")
...
val md_escape_action = office_action_dispatch("render-markdown-preview-html", "# <script>alert(1)</script>")
...
val short_md_edit_action = office_action_dispatch("md-edit", "1|old\n# Markdown\nold")
val writer_action = office_action_dispatch("render-writer-markdown-html", "# Writer")
val writer_escape_action = office_action_dispatch("render-writer-markdown-html", "# <script>alert(1)</script>")
...
val ppt_escape_action = office_action_dispatch("render-ppt-markdown-html", "# Deck\n\n## <script>alert(1)</script>")
...
val short_sheet_format_action = office_action_dispatch("format-cell-value", "1234.5")
...
val short_sheet_edit_action = office_action_dispatch("sheet-edit", "A1|old\nA1=old")
...
val short_slide_edit_action = office_action_dispatch("slide-edit", "title|Old\ntitle=Old")
...
val invalid_ui_auto_layout_action = office_action_dispatch("ui-auto-layout-edit", "frame bad|off|0|0,0,0,0|vertical|8|4,4,4,4\ndesign: Feature\nnode frame|Panel|frame|0|0|200|120|surface|1|container")
...
val short_sdd_style_rule_inspect_action = office_action_dispatch("inspect-sdd-style-rule", "accent\ncss |name, extends, target|\n    accent, none, node\nstyles |css, key, value|\n    accent, fill, #eeeeee")
val sdd_style_extends_read_action = office_action_dispatch("sdd-style-extends-read", "accent|fill\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    accent, fill, #eeeeee")
val short_sdd_style_extends_read_action = office_action_dispatch("sdd-style-extends-read", "accent\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    accent, fill, #eeeeee")
...
val short_sdd_style_resolved_read_action = office_action_dispatch("sdd-style-resolved-read", "accent\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    base, stroke, #111111\n    accent, fill, #eeeeee")
val sdd_style_resolved_value_read_action = office_action_dispatch("sdd-style-resolved-value-read", "accent|node|stroke\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    base, stroke, #111111\n    accent, fill, #eeeeee")
val short_sdd_style_resolved_value_read_action = office_action_dispatch("sdd-style-resolved-value-read", "accent|node\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    base, stroke, #111111\n    accent, fill, #eeeeee")
val sdd_node_resolved_style_read_action = office_action_dispatch("sdd-node-resolved-style-read", "A\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    base, stroke, #111111\n    accent, fill, #eeeeee\nnodes |id, label, css|\n    A, Alpha, accent")
val sdd_node_resolved_style_value_read_action = office_action_dispatch("sdd-node-resolved-style-value-read", "A|stroke\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    base, stroke, #111111\n    accent, fill, #eeeeee\nnodes |id, label, css|\n    A, Alpha, accent")
val short_sdd_node_resolved_style_value_read_action = office_action_dispatch("sdd-node-resolved-style-value-read", "A\ncss |name, extends, target|\n    base, none, node\n    accent, base, node\nstyles |css, key, value|\n    base, stroke, #111111\n    accent, fill, #eeeeee\nnodes |id, label, css|\n    A, Alpha, accent")
...
val short_sdd_add_node_action = office_action_dispatch("add-sdd-node", "C|Choice|accent|decision|diamond|80\ngraph: Node Add\nA: Alpha")
...
val invalid_sdd_duplicate_id_action = office_action_dispatch("duplicate-sdd-node", "A bad|A_copy|20|10\ngraph: Feature\nA: Alpha x: 0 y: 0 width: 80 height: 20")
val short_sdd_duplicate_action = office_action_dispatch("duplicate-sdd-node", "A|A_copy|20\ngraph: Feature\nA: Alpha x: 0 y: 0 width: 80 height: 20")
val ui_align_action = office_action_dispatch("ui-align-selection", "left|a,b\ndesign: Align\nnode a|A|button|0|0|20|20|primary|1|action\nnode b|B|button|40|20|20|20|secondary|2|action")
val sdd_selection_geometry_action = office_action_dispatch("sdd-selection-geometry", "A,B\ngraph: Align\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 40 y: 20 width: 20 height: 20")
val invalid_sdd_selection_geometry_action = office_action_dispatch("sdd-selection-geometry", "A,B bad\ngraph: Align\nA: A x: 0 y: 0 width: 20 height: 20")
val missing_sdd_selection_geometry_action = office_action_dispatch("sdd-selection-geometry", "Nope\ngraph: Align\nA: A x: 0 y: 0 width: 20 height: 20")
...
val short_ui_align_action = office_action_dispatch("ui-align-selection", "left\ndesign: Align\nnode a|A|button|0|0|20|20|primary|1|action")
val invalid_sdd_distribute_action = office_action_dispatch("distribute-sdd-selection", "horizontal|A,B bad,C\ngraph: Dist\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 40 y: 0 width: 20 height: 20\nC: C x: 100 y: 0 width: 20 height: 20")
val short_sdd_distribute_action = office_action_dispatch("distribute-sdd-selection", "horizontal\ngraph: Dist\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 40 y: 0 width: 20 height: 20")
...
val sdd_shape_read_action = office_action_dispatch("sdd-node-shape-read", "A\ngraph: Shape\nA: A shape: diamond x: 0 y: 0 width: 20 height: 20")
...
val sdd_child_count_read_action = office_action_dispatch("sdd-node-child-count-read", "A\ngraph: Parent\nA: A x: 0 y: 0 width: 80 height: 80\nB: B x: 10 y: 10 width: 20 height: 20 parent: A\nC: C x: 50 y: 5 width: 10 height: 10 parent: A")
...
val sdd_canvas_read_action = office_action_dispatch("sdd-canvas-read", "graph: Canvas\ncanvas: width: 640 height: 480 grid: 16 snap: true zoom: 125 background: #ffffff\nA: A")
...
val invalid_sdd_add_edge_waypoint_action = office_action_dispatch("add-sdd-edge", "B|A|return|secondary|reply|orthogonal|60xbad|left|right\ngraph: Edge Add\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 100 y: 0 width: 20 height: 20")
...
val short_sdd_edge_label_action = office_action_dispatch("edit-sdd-edge-label", "0\ngraph: Edge Label\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 100 y: 0 width: 20 height: 20\nA -> B: link")
...
val sdd_edge_resolved_style_read_action = office_action_dispatch("sdd-edge-resolved-style-read", "0\ncss |name, extends, target|\n    base, none, edge\n    critical, base, edge\nstyles |css, key, value|\n    base, stroke, #111111\n    critical, fill, #eeeeee\nnodes |id, label|\n    A, Alpha\n    B, Beta\nedges |from, to, label, css|\n    A, B, link, critical")
val sdd_edge_resolved_style_value_read_action = office_action_dispatch("sdd-edge-resolved-style-value-read", "0|stroke\ncss |name, extends, target|\n    base, none, edge\n    critical, base, edge\nstyles |css, key, value|\n    base, stroke, #111111\n    critical, fill, #eeeeee\nnodes |id, label|\n    A, Alpha\n    B, Beta\nedges |from, to, label, css|\n    A, B, link, critical")
val short_sdd_edge_resolved_style_value_read_action = office_action_dispatch("sdd-edge-resolved-style-value-read", "0\ncss |name, extends, target|\n    base, none, edge\n    critical, base, edge\nstyles |css, key, value|\n    base, stroke, #111111\n    critical, fill, #eeeeee\nnodes |id, label|\n    A, Alpha\n    B, Beta\nedges |from, to, label, css|\n    A, B, link, critical")
val invalid_sdd_edge_style_action = office_action_dispatch("edit-sdd-edge-style", "0|warning,bad\ngraph: Edge Style\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 100 y: 0 width: 20 height: 20\nA -> B: link route: simple start: right end: left")
val short_sdd_edge_style_action = office_action_dispatch("edit-sdd-edge-style", "0\ngraph: Edge Style\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 100 y: 0 width: 20 height: 20\nA -> B: link")
...
val short_sdd_edge_kind_action = office_action_dispatch("edit-sdd-edge-kind", "0\ngraph: Edge Kind\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 100 y: 0 width: 20 height: 20\nA -> B: link")
val sdd_edge_route_read_action = office_action_dispatch("sdd-edge-route-read", "0\ngraph: Edge Route\nA: A\nB: B\nA -> B: link route: orthogonal waypoints: 40x10 start: right end: left")
val sdd_edge_path_read_action = office_action_dispatch("sdd-edge-path-read", "0\ngraph: Edge Path\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 80 y: 0 width: 20 height: 20\nA -> B: link route: orthogonal waypoints: 40x10 start: right end: left")
val sdd_edge_segments_read_action = office_action_dispatch("sdd-edge-segments-read", "0\ngraph: Edge Segments\nA: A x: 0 y: 0 width: 20 height: 20\nB: B x: 80 y: 0 width: 20 height: 20\nA -> B: link route: orthogonal waypoints: 40x10 start: right end: left")
val sdd_edge_endpoints_read_action = office_action_dispatch("sdd-edge-endpoints-read", "0\ngraph: Edge Endpoints\nA: A\nB: B\nA -> B: link")
...
val invalid_sdd_edge_endpoint_action = office_action_dispatch("edit-sdd-edge-endpoints", "0|B|A bad\ngraph: Edge Endpoints\nA: A\nB: B\nA -> B: link")
val short_sdd_edge_endpoint_action = office_action_dispatch("edit-sdd-edge-endpoints", "0|B\ngraph: Edge Endpoints\nA: A\nB: B\nA -> B: link")
...
expect(md_escape_action.output).to_contain("&lt;script&gt;alert(1)&lt;/script&gt;")
...
expect(short_md_edit_action.reason).to_equal("invalid-args")
...
expect(short_sheet_format_action.reason).to_equal("invalid-args")
...
expect(comma_ui_sdd_action.output).to_contain("button, \"Play,Pause\",")
expect(comma_ui_sdd_graph.nodes[0].label).to_equal("Play,Pause")
...
expect(selected_sdd_edge_action.output).to_contain("data-connector-handle=\"start\" data-edit-action=\"reconnect-start\" data-handle-index=\"0\" data-edge-index=\"0\" data-label=\"Link\" data-kind=\"\" data-route=\"orthogonal\" data-anchor=\"right\" data-x=\"80\" data-y=\"10\"")
expect(selected_sdd_edge_action.output).to_contain("data-connector-handle=\"end\" data-edit-action=\"reconnect-end\" data-handle-index=\"1\" data-edge-index=\"0\" data-label=\"Link\" data-kind=\"\" data-route=\"orthogonal\" data-anchor=\"left\"")
expect(selected_sdd_edge_action.output).to_contain("data-connector-handle=\"label\" data-edit-action=\"move-label\" data-handle-index=\"2\"")
expect(selected_sdd_edge_action.output).to_contain("data-connector-handle=\"waypoint\" data-edit-action=\"move-waypoint\" data-handle-index=\"3\" data-waypoint-index=\"0\" data-edge-index=\"0\" data-label=\"Link\" data-kind=\"\" data-route=\"orthogonal\" data-x=\"80\" data-y=\"10\"")
...
expect(selected_sdd_edge_action.output).to_contain("data-node=\"A\" data-opposite-node=\"B\"")
...
expect(invalid_ui_auto_layout_action.reason).to_equal("invalid-args")
...
expect(ui_resolved_layout_read_action.output).to_contain("data-node=\"button\"")
expect(ui_resolved_layout_read_action.output).to_contain("left: 4px")
expect(ui_resolved_layout_read_action.output).to_contain("top: 4px")
expect(stale_ui_resolve_layout_action.reason).to_equal("stale-layout")
expect(blank_ui_resolve_layout_action.reason).to_equal("invalid-args")
...
expect(sdd_outline_action.output).to_contain("node 0:A|Alpha|actor|diamond|")
expect(sdd_outline_action.output).to_contain("node 1:B|Beta|||A")
expect(sdd_outline_action.output).to_contain("edge 0:A->B|Link|async")
expect(sdd_style_rules_action.output).to_contain("css_rules=2")
expect(sdd_style_rules_action.output).to_contain("css accent extends=base target=edge")
expect(sdd_style_rules_action.output).to_contain("style accent.fill=#eeeeee")
...
expect(short_sdd_style_extends_read_action.reason).to_equal("invalid-args")
...
expect(short_sdd_style_resolved_read_action.reason).to_equal("invalid-args")
...
expect(short_sdd_style_resolved_value_read_action.reason).to_equal("invalid-args")
expect(sdd_node_resolved_style_read_action.output).to_contain("border-color:#111111")
expect(sdd_node_resolved_style_read_action.output).to_contain("background-color:#eeeeee")
expect(sdd_node_resolved_style_read_action.reason).to_equal("selected")
expect(sdd_node_resolved_style_value_read_action.output).to_equal("#111111")
expect(short_sdd_node_resolved_style_value_read_action.reason).to_equal("invalid-args")
expect(sdd_node_resolved_style_value_read_action.reason).to_equal("selected")
expect(missing_sdd_style_rule_inspect_action.reason).to_equal("missing-style-rule")
expect(short_sdd_style_rule_inspect_action.reason).to_equal("invalid-args")
...
expect(short_sdd_add_node_action.reason).to_equal("invalid-args")
...
expect(invalid_sdd_duplicate_id_action.reason).to_equal("invalid-args")
expect(short_sdd_duplicate_action.reason).to_equal("invalid-args")
expect(ui_align_action.output).to_contain("data-id=\"b\"")
expect(ui_align_action.output).to_contain("left: 0px")
expect(sdd_selection_geometry_action.output).to_equal("A:0,0,20,20;B:40,20,20,20")
expect(invalid_sdd_selection_geometry_action.reason).to_equal("invalid-args")
expect(missing_sdd_selection_geometry_action.reason).to_equal("missing-node")
...
expect(short_ui_align_action.reason).to_equal("invalid-args")
expect(invalid_sdd_distribute_action.reason).to_equal("invalid-args")
expect(short_sdd_distribute_action.reason).to_equal("invalid-args")
...
expect(sdd_shape_read_action.output).to_equal("diamond")
expect(sdd_shape_read_action.reason).to_equal("selected")
...
expect(sdd_order_read_action.output).to_equal("1")
...
expect(sdd_child_count_read_action.output).to_equal("2")
expect(sdd_child_count_read_action.reason).to_equal("selected")
...
expect(sdd_canvas_read_action.output).to_equal("width=640 height=480 grid=16 snap=true zoom=125 background=#ffffff")
...
expect(invalid_sdd_add_edge_action.reason).to_equal("invalid-args")
expect(invalid_sdd_add_edge_waypoint_action.reason).to_equal("invalid-args")
...
expect(short_sdd_edge_label_action.reason).to_equal("invalid-args")
...
expect(sdd_edge_style_read_action.output).to_equal("warning dashed")
expect(sdd_edge_style_read_action.reason).to_equal("selected")
expect(sdd_edge_resolved_style_read_action.output).to_contain("stroke:#111111")
expect(sdd_edge_resolved_style_read_action.output).to_contain("fill:#eeeeee")
expect(sdd_edge_resolved_style_read_action.reason).to_equal("selected")
expect(sdd_edge_resolved_style_value_read_action.output).to_equal("#111111")
expect(sdd_edge_resolved_style_value_read_action.reason).to_equal("selected")
expect(short_sdd_edge_resolved_style_value_read_action.reason).to_equal("invalid-args")
expect(invalid_sdd_edge_style_action.reason).to_equal("invalid-style-token")
expect(short_sdd_edge_style_action.reason).to_equal("invalid-args")
...
expect(short_sdd_edge_kind_action.reason).to_equal("invalid-args")
expect(sdd_edge_route_read_action.output).to_equal("orthogonal|40x10|right|left")
expect(sdd_edge_route_read_action.reason).to_equal("selected")
expect(sdd_edge_path_read_action.output).to_contain("M")
expect(sdd_edge_path_read_action.output).to_contain("|20,10,80,10|2")
expect(sdd_edge_path_read_action.reason).to_equal("selected")
expect(sdd_edge_segments_read_action.output).to_equal("20,10-40,10;40,10-80,10|30,10;60,10|h;h")
expect(sdd_edge_segments_read_action.reason).to_equal("selected")
expect(sdd_edge_endpoints_read_action.output).to_equal("A,B")
expect(sdd_edge_endpoints_read_action.reason).to_equal("selected")
...
expect(invalid_sdd_edge_endpoint_action.reason).to_equal("invalid-args")
expect(short_sdd_edge_endpoint_action.reason).to_equal("invalid-args")
...
expect(catalog[5].features.join(",")).to_contain("name-edit")
expect(catalog[5].features.join(",")).to_contain("canvas-edit")
expect(catalog[5].features.join(",")).to_contain("canvas-readback")
...
expect(catalog[5].features.join(",")).to_contain("resolved-layout-read")
...
expect(catalog[5].features.join(",")).to_contain("node-create")
expect(catalog[5].features.join(",")).to_contain("node-order-edit")
...
expect(catalog[5].features.join(",")).to_contain("css-edit")
...
expect(catalog[5].actions.join(",")).to_contain("ui-name-edit")
expect(catalog[5].actions.join(",")).to_contain("ui-kind-edit")
expect(catalog[5].actions.join(",")).to_contain("ui-canvas-edit")
expect(catalog[5].actions.join(",")).to_contain("ui-canvas-read")
...
expect(catalog[5].actions.join(",")).to_contain("ui-resolved-layout-read")
...
val field_node = office_ui_node("field", "Field", "input", "320", "24", "100", "28")
field_node.css = "secondary"
field_node.layer = "controls"
field_node.component = "input"
val added_ui = office_ui_design_add_node_checked(ui_design, field_node)
val reordered_ui = office_ui_design_reorder_node_checked(ui_design, "button", "front")
...
val ui_layers = office_ui_design_layers_summary(ui_design)
...
expect(ui_layers).to_contain("index=0 id=button")
expect(ui_layers).to_contain("component=action")
expect(added_ui.reason).to_equal("updated")
expect(added_ui.design.nodes[3].id).to_equal("field")
expect(reordered_ui.reason).to_equal("updated")
expect(reordered_ui.design.nodes[2].id).to_equal("button")
...
expect(ui_select_action.reason).to_equal("selected")
expect(ui_select_action.output).to_contain("aria-selected=\"true\"")
expect(invalid_ui_select_action.reason).to_equal("invalid-args")
expect(missing_ui_select_action.reason).to_equal("missing-node")
...
expect(catalog[6].features.join(",")).to_contain("table-summary")
expect(catalog[6].features.join(",")).to_contain("schema-validation")
expect(catalog[6].features.join(",")).to_contain("html-render")
expect(catalog[6].features.join(",")).to_contain("html-cell-coordinates")
expect(catalog[6].features.join(",")).to_contain("duplicate-column-reject")
expect(catalog[6].features.join(",")).to_contain("missing-column-errors")
...
expect(catalog[6].actions.join(",")).to_contain("base-table-summary")
...
val base_summary_action = office_action_dispatch("base-table-summary", "table: Feature\ncolumns: id,status\nrow: 1,open\nrow: 2,done")
...
expect(base_summary_action.output).to_equal("table=Feature\ncolumns=id,status\nrows=2")
expect(base_summary_action.reason).to_equal("summarized")
...
expect(catalog[7].features.join(",")).to_contain("xml-escape")
expect(catalog[7].features.join(",")).to_contain("fraction")
expect(catalog[7].features.join(",")).to_contain("slash-fraction")
expect(catalog[7].features.join(",")).to_contain("subscript")
expect(catalog[7].features.join(",")).to_contain("sqrt-shorthand")
expect(catalog[7].features.join(",")).to_contain("fenced-group")
expect(catalog[7].features.join(",")).to_contain("precedence-parser")
expect(catalog[7].features.join(",")).to_contain("malformed-fallback")
...
val launcher_word_action = office_action_dispatch("open_word", "")
val launcher_sheets_action = office_action_dispatch("open_sheets", "")
val launcher_slides_action = office_action_dispatch("open_slides", "")
val launcher_draw_action = office_action_dispatch("open_draw", "")
val launcher_db_action = office_action_dispatch("open_db", "")
val launcher_math_action = office_action_dispatch("open_math", "")
val launcher_mail_action = office_action_dispatch("open_mail", "")
...
assert_true(probe.contains_strikethrough)
...
assert_true(probe.contains_code_block)
...
expect(summary).to_contain("strike=true")
...
expect(summary).to_contain("code=true")
...
expect(probe.names.join(",")).to_contain("ide.counter")
expect(probe.names.join(",")).to_contain("ide.launcher")
...
expect(probe.manifest_text).to_contain("builtin:app.office.counter")
expect(probe.manifest_text).to_contain("builtin:app.office.launcher")
expect(probe.manifest_text).to_contain("ide_capability_draw")
expect(probe.manifest_text).to_contain("ide_feature_check_draw")
expect(summary).to_contain("roundtrip=13")
