...
markdown: Markdown Preview [document-renderer] -> std.editor.render.md_renderer (md, markdown)
  check: markdown: std.editor.render.md_renderer blocks=3 lines=6 preview=6 heading=true table=true task_list=true strike=true link=true list=true css_doc=true escaped=true metadata=true
...
db-admin: Database Admin [database] -> std.editor.core.session_db (embedded-db, simple-db, portal-db)
  ...
  llm-catalog: apps=9 features=101 actions=60
...
expect(office_llm_catalog_summary()).to_equal("llm-catalog: apps=9 features=101 actions=60")
