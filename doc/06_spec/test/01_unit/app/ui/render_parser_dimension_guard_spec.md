...
<!-- sdn-diagram:id=render_parser_dimension_guard_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=render_parser_dimension_guard_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

render_parser_dimension_guard_spec
```
...
```ascii generated-from=render_parser_dimension_guard_spec.arch hash=sha256:auto
