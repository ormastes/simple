...
expect(html).to_contain("data-resize-handle=\"nw\" data-node=\"action\" data-node-index=\"1\"")
expect(html).to_contain("data-resize-handle=\"se\" data-node=\"action\" data-node-index=\"1\"")
