...
#### fails closed for unknown components and counter routes
...
expect(is_office_component("counter")).to_equal(false)
...
#### resolves launcher actions without accepting unknown counter actions
