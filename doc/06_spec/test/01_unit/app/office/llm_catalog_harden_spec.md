...
expect(office_llm_action_input_schema("sdd-weave-summary")).to_equal("sdd_source")
...
expect(office_llm_action_input_schema("sdd-node-resolved-style-read")).to_equal("node_id\\nsdd_source")
expect(office_llm_action_input_schema("sdd-node-resolved-style-value-read")).to_equal("node_id|key\\nsdd_source")
...
expect(office_llm_action_input_schema("sdd-edge-resolved-style-read")).to_equal("edge_index\\nsdd_source")
expect(office_llm_action_input_schema("sdd-edge-resolved-style-value-read")).to_equal("edge_index|key\\nsdd_source")
...
expect(office_llm_action_input_schema("writer-markdown-tables")).to_equal("markdown_source")
...
expect(office_llm_action_input_schema("open_word")).to_equal("no_input")
```
