# Macro Import Specification

> 1. expect exports is well formed

<!-- sdn-diagram:id=macro_import_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=macro_import_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

macro_import_spec -> compiler
```
...
```ascii generated-from=macro_import_spec.arch hash=sha256:auto
...
| Category | Compiler |
| Status | Active |
| Source | `test/01_unit/compiler/dependency/macro_import_spec.spl` |
| Updated | 2026-06-01 |
