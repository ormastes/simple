...
<!-- sdn-diagram:id=tiered_jit_hotspot_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=tiered_jit_hotspot_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

tiered_jit_hotspot_spec -> compiler
```
...
```ascii generated-from=tiered_jit_hotspot_spec.arch hash=sha256:auto
