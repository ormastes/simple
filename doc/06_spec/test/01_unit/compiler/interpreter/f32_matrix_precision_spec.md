...
<!-- sdn-diagram:id=f32_matrix_precision_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=f32_matrix_precision_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

f32_matrix_precision_spec -> std
```
...
```ascii generated-from=f32_matrix_precision_spec.arch hash=sha256:auto
