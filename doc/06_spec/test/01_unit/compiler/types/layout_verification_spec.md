...
expect(def).to_contain("uint8_t mode : 4;")
expect(def).to_contain("uint8_t output : 1;")
expect(def).to_contain("uint8_t input : 1;")
expect(def).to_contain("uint8_t speed : 2;")
```
