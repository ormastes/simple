...
<!-- sdn-diagram:id=.sspec_wrapped_entry_target_spec_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=.sspec_wrapped_entry_target_spec_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

.sspec_wrapped_entry_target_spec_spec -> std
```
...
```ascii generated-from=.sspec_wrapped_entry_target_spec_spec.arch hash=sha256:auto
