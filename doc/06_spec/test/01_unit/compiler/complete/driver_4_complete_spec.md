...
<!-- sdn-diagram:id=driver_4_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=driver_4_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

driver_4_complete_spec -> std
```
...
```ascii generated-from=driver_4_complete_spec.arch hash=sha256:auto
