...
<!-- sdn-diagram:id=desugar_4_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=desugar_4_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

desugar_4_complete_spec -> std
```
...
```ascii generated-from=desugar_4_complete_spec.arch hash=sha256:auto
