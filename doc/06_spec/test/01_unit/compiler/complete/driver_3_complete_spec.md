...
<!-- sdn-diagram:id=driver_3_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=driver_3_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

driver_3_complete_spec -> std
```
...
```ascii generated-from=driver_3_complete_spec.arch hash=sha256:auto
...
| Category | Compiler |
| Status | Active |
| Source | `test/01_unit/compiler/complete/driver_3_complete_spec.spl` |
| Updated | 2026-06-01 |
