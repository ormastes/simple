...
<!-- sdn-diagram:id=mir_opt_2_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=mir_opt_2_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

mir_opt_2_complete_spec -> std
```
...
```ascii generated-from=mir_opt_2_complete_spec.arch hash=sha256:auto
