...
<!-- sdn-diagram:id=codegen_1_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=codegen_1_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

codegen_1_complete_spec -> std
```
...
```ascii generated-from=codegen_1_complete_spec.arch hash=sha256:auto
