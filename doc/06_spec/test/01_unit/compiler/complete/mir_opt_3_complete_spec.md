...
<!-- sdn-diagram:id=mir_opt_3_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=mir_opt_3_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

mir_opt_3_complete_spec -> std
```
...
```ascii generated-from=mir_opt_3_complete_spec.arch hash=sha256:auto
...
| Category | Compiler |
| Status | Active |
| Source | `test/01_unit/compiler/complete/mir_opt_3_complete_spec.spl` |
| Updated | 2026-06-01 |
