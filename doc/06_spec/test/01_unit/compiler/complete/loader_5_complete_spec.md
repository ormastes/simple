...
<!-- sdn-diagram:id=loader_5_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=loader_5_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

loader_5_complete_spec -> std
```
...
```ascii generated-from=loader_5_complete_spec.arch hash=sha256:auto
