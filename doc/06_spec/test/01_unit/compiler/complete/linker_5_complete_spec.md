...
<!-- sdn-diagram:id=linker_5_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=linker_5_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

linker_5_complete_spec -> std
```
...
```ascii generated-from=linker_5_complete_spec.arch hash=sha256:auto
...
| Category | Compiler |
| Status | Active |
| Source | `test/01_unit/compiler/complete/linker_5_complete_spec.spl` |
| Updated | 2026-06-01 |
