...
<!-- sdn-diagram:id=codegen_3_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=codegen_3_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

codegen_3_complete_spec -> std
```
...
```ascii generated-from=codegen_3_complete_spec.arch hash=sha256:auto
