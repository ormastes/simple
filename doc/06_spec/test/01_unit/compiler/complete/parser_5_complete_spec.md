...
<!-- sdn-diagram:id=parser_5_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=parser_5_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

parser_5_complete_spec -> std
```
...
```ascii generated-from=parser_5_complete_spec.arch hash=sha256:auto
