...
<!-- sdn-diagram:id=linker_1_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=linker_1_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

linker_1_complete_spec -> std
```
...
```ascii generated-from=linker_1_complete_spec.arch hash=sha256:auto
