...
1. bitfield ControlReg
2. fn enter unprivileged
3. check
4. check
5. check
...
1. bitfield DmaConfig
2. psize: u2        # Peripheral size
3. var dma cfg = DmaConfig
4. check
5. check
6. check
