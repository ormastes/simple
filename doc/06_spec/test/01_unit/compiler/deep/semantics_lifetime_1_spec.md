...
<!-- sdn-diagram:id=semantics_lifetime_1_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=semantics_lifetime_1_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

semantics_lifetime_1_spec -> std
```
...
```ascii generated-from=semantics_lifetime_1_spec.arch hash=sha256:auto
