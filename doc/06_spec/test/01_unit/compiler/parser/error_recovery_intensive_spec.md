...
1. expect new error len
2. expect new error contains
3. expect new error contains
...
1. expect location contains
2. expect location contains
3. expect location contains
...
1. expect diff header contains
2. expect diff header contains
