...
<!-- sdn-diagram:id=branch_coverage_23_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=branch_coverage_23_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

branch_coverage_23_spec
```
...
```ascii generated-from=branch_coverage_23_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/01_unit/compiler_core/branch_coverage_23_spec.spl` |
| Updated | 2026-06-01 |
