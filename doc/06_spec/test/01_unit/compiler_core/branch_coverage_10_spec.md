...
<!-- sdn-diagram:id=branch_coverage_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=branch_coverage_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

branch_coverage_10_spec
```
...
```ascii generated-from=branch_coverage_10_spec.arch hash=sha256:auto
