...
<!-- sdn-diagram:id=aop_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=aop_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

aop_complete_spec -> std
```
...
```ascii generated-from=aop_complete_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/01_unit/core/complete/aop_complete_spec.spl` |
| Updated | 2026-06-01 |
