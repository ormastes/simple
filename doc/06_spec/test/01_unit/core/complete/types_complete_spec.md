...
<!-- sdn-diagram:id=types_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=types_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

types_complete_spec -> std
```
...
```ascii generated-from=types_complete_spec.arch hash=sha256:auto
