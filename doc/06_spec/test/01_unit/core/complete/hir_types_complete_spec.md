...
<!-- sdn-diagram:id=hir_types_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=hir_types_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

hir_types_complete_spec -> std
```
...
```ascii generated-from=hir_types_complete_spec.arch hash=sha256:auto
