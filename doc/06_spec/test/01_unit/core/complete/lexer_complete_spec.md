...
<!-- sdn-diagram:id=lexer_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lexer_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lexer_complete_spec -> std
```
...
```ascii generated-from=lexer_complete_spec.arch hash=sha256:auto
