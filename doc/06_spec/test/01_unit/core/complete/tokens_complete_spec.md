...
<!-- sdn-diagram:id=tokens_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=tokens_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

tokens_complete_spec -> std
```
...
```ascii generated-from=tokens_complete_spec.arch hash=sha256:auto
