...
<!-- sdn-diagram:id=error_complete_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=error_complete_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

error_complete_spec -> std
```
...
```ascii generated-from=error_complete_spec.arch hash=sha256:auto
