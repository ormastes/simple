...
<!-- sdn-diagram:id=string_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=string_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

string_unit_spec -> std
```
...
```ascii generated-from=string_unit_spec.arch hash=sha256:auto
