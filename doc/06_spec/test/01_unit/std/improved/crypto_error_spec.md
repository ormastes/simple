...
<!-- sdn-diagram:id=crypto_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=crypto_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

crypto_error_spec -> std
```
...
```ascii generated-from=crypto_error_spec.arch hash=sha256:auto
