...
<!-- sdn-diagram:id=regex_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=regex_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

regex_error_spec -> std
```
...
```ascii generated-from=regex_error_spec.arch hash=sha256:auto
