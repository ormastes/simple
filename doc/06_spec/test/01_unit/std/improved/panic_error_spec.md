...
<!-- sdn-diagram:id=panic_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=panic_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

panic_error_spec -> std
```
...
```ascii generated-from=panic_error_spec.arch hash=sha256:auto
