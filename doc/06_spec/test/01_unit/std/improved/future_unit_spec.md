...
<!-- sdn-diagram:id=future_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=future_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

future_unit_spec -> std
```
...
```ascii generated-from=future_unit_spec.arch hash=sha256:auto
