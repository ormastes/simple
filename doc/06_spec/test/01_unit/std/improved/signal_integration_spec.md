...
<!-- sdn-diagram:id=signal_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=signal_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

signal_integration_spec -> std
```
...
```ascii generated-from=signal_integration_spec.arch hash=sha256:auto
