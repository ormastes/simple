...
<!-- sdn-diagram:id=reduce_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reduce_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reduce_edge_spec -> std
```
...
```ascii generated-from=reduce_edge_spec.arch hash=sha256:auto
