...
<!-- sdn-diagram:id=duration_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=duration_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

duration_integration_spec -> std
```
...
```ascii generated-from=duration_integration_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/duration_integration_spec.spl` |
| Updated | 2026-06-01 |
