...
<!-- sdn-diagram:id=profile_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=profile_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

profile_error_spec -> std
```
...
```ascii generated-from=profile_error_spec.arch hash=sha256:auto
