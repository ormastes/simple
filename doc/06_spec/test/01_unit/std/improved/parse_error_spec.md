...
<!-- sdn-diagram:id=parse_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=parse_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

parse_error_spec -> std
```
...
```ascii generated-from=parse_error_spec.arch hash=sha256:auto
