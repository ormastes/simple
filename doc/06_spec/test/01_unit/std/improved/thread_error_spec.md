...
<!-- sdn-diagram:id=thread_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=thread_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

thread_error_spec -> std
```
...
```ascii generated-from=thread_error_spec.arch hash=sha256:auto
