...
<!-- sdn-diagram:id=bool_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=bool_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

bool_integration_spec -> std
```
...
```ascii generated-from=bool_integration_spec.arch hash=sha256:auto
