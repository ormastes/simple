...
<!-- sdn-diagram:id=uri_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=uri_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

uri_integration_spec -> std
```
...
```ascii generated-from=uri_integration_spec.arch hash=sha256:auto
