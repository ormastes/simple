...
<!-- sdn-diagram:id=result_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=result_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

result_edge_spec -> std
```
...
```ascii generated-from=result_edge_spec.arch hash=sha256:auto
