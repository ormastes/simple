...
<!-- sdn-diagram:id=dir_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=dir_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=dir_edge_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/dir_edge_spec.spl` |
| Updated | 2026-06-01 |
