...
<!-- sdn-diagram:id=benchmark_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=benchmark_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

benchmark_unit_spec -> std
```
...
```ascii generated-from=benchmark_unit_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/benchmark_unit_spec.spl` |
| Updated | 2026-06-01 |
