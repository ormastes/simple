...
<!-- sdn-diagram:id=buffer_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=buffer_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

buffer_edge_spec -> std
```
...
```ascii generated-from=buffer_edge_spec.arch hash=sha256:auto
