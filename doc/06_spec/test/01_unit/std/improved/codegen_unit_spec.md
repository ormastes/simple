...
<!-- sdn-diagram:id=codegen_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=codegen_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

codegen_unit_spec -> std
```
...
```ascii generated-from=codegen_unit_spec.arch hash=sha256:auto
