...
<!-- sdn-diagram:id=float_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=float_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

float_error_spec -> std
```
...
```ascii generated-from=float_error_spec.arch hash=sha256:auto
