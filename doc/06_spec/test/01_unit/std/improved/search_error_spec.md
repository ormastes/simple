...
<!-- sdn-diagram:id=search_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=search_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

search_error_spec -> std
```
...
```ascii generated-from=search_error_spec.arch hash=sha256:auto
