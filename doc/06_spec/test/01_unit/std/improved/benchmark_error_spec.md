...
<!-- sdn-diagram:id=benchmark_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=benchmark_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

benchmark_error_spec -> std
```
...
```ascii generated-from=benchmark_error_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/benchmark_error_spec.spl` |
| Updated | 2026-06-01 |
