...
<!-- sdn-diagram:id=convert_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=convert_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

convert_edge_spec -> std
```
...
```ascii generated-from=convert_edge_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/convert_edge_spec.spl` |
| Updated | 2026-06-01 |
