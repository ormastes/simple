...
<!-- sdn-diagram:id=promise_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=promise_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

promise_error_spec -> std
```
...
```ascii generated-from=promise_error_spec.arch hash=sha256:auto
