...
<!-- sdn-diagram:id=option_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=option_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

option_edge_spec -> std
```
...
```ascii generated-from=option_edge_spec.arch hash=sha256:auto
