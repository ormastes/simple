...
<!-- sdn-diagram:id=duration_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=duration_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

duration_error_spec -> std
```
...
```ascii generated-from=duration_error_spec.arch hash=sha256:auto
