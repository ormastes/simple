...
<!-- sdn-diagram:id=random_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=random_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

random_unit_spec -> std
```
...
```ascii generated-from=random_unit_spec.arch hash=sha256:auto
