...
<!-- sdn-diagram:id=semaphore_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=semaphore_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

semaphore_edge_spec -> std
```
...
```ascii generated-from=semaphore_edge_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/semaphore_edge_spec.spl` |
| Updated | 2026-06-01 |
