...
<!-- sdn-diagram:id=stream_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stream_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stream_error_spec -> std
```
...
```ascii generated-from=stream_error_spec.arch hash=sha256:auto
