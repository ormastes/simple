...
<!-- sdn-diagram:id=search_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=search_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

search_integration_spec -> std
```
...
```ascii generated-from=search_integration_spec.arch hash=sha256:auto
