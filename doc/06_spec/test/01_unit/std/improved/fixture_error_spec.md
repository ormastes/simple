...
<!-- sdn-diagram:id=fixture_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=fixture_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

fixture_error_spec -> std
```
...
```ascii generated-from=fixture_error_spec.arch hash=sha256:auto
