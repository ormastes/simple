...
<!-- sdn-diagram:id=buffer_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=buffer_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

buffer_error_spec -> std
```
...
```ascii generated-from=buffer_error_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/buffer_error_spec.spl` |
| Updated | 2026-06-01 |
