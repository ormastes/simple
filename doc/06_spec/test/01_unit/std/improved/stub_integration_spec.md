...
<!-- sdn-diagram:id=stub_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stub_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stub_integration_spec -> std
```
...
```ascii generated-from=stub_integration_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/stub_integration_spec.spl` |
| Updated | 2026-06-01 |
