...
<!-- sdn-diagram:id=assert_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=assert_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

assert_error_spec -> std
```
...
```ascii generated-from=assert_error_spec.arch hash=sha256:auto
