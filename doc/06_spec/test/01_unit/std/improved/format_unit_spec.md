...
<!-- sdn-diagram:id=format_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=format_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

format_unit_spec -> std
```
...
```ascii generated-from=format_unit_spec.arch hash=sha256:auto
