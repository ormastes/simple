...
<!-- sdn-diagram:id=profile_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=profile_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

profile_integration_spec -> std
```
...
```ascii generated-from=profile_integration_spec.arch hash=sha256:auto
