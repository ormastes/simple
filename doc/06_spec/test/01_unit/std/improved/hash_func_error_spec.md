...
<!-- sdn-diagram:id=hash_func_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=hash_func_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

hash_func_error_spec -> std
```
...
```ascii generated-from=hash_func_error_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/hash_func_error_spec.spl` |
| Updated | 2026-06-01 |
