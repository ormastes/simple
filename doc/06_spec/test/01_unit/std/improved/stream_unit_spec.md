...
<!-- sdn-diagram:id=stream_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stream_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stream_unit_spec -> std
```
...
```ascii generated-from=stream_unit_spec.arch hash=sha256:auto
