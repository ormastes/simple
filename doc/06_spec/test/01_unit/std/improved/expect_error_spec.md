...
<!-- sdn-diagram:id=expect_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=expect_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

expect_error_spec -> std
```
...
```ascii generated-from=expect_error_spec.arch hash=sha256:auto
