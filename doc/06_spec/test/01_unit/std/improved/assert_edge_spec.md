...
<!-- sdn-diagram:id=assert_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=assert_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

assert_edge_spec -> std
```
...
```ascii generated-from=assert_edge_spec.arch hash=sha256:auto
