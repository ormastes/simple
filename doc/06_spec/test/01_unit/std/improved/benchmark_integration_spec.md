...
<!-- sdn-diagram:id=benchmark_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=benchmark_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

benchmark_integration_spec -> std
```
...
```ascii generated-from=benchmark_integration_spec.arch hash=sha256:auto
