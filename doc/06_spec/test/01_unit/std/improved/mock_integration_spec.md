...
<!-- sdn-diagram:id=mock_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=mock_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

mock_integration_spec -> std
```
...
```ascii generated-from=mock_integration_spec.arch hash=sha256:auto
