...
<!-- sdn-diagram:id=hash_func_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=hash_func_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

hash_func_integration_spec -> std
```
...
```ascii generated-from=hash_func_integration_spec.arch hash=sha256:auto
