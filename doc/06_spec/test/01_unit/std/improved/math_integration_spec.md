...
<!-- sdn-diagram:id=math_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=math_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

math_integration_spec -> std
```
...
```ascii generated-from=math_integration_spec.arch hash=sha256:auto
