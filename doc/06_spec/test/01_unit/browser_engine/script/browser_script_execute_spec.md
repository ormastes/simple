...
<!-- sdn-diagram:id=browser_script_execute_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=browser_script_execute_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

browser_script_execute_spec -> std
```
...
```ascii generated-from=browser_script_execute_spec.arch hash=sha256:auto
...
| Category | Other |
| Status | Active |
| Source | `test/01_unit/browser_engine/script/browser_script_execute_spec.spl` |
| Updated | 2026-06-01 |
