...
- var compositor = Compositor with backends
- assert true
...
- var compositor = Compositor with backends
- compositor = apply wm action to compositor
- compositor = apply wm action to compositor
