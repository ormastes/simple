...
<!-- sdn-diagram:id=nvme_namespace_assignment_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=nvme_namespace_assignment_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

nvme_namespace_assignment_spec -> std
nvme_namespace_assignment_spec -> os
```
...
```ascii generated-from=nvme_namespace_assignment_spec.arch hash=sha256:auto
