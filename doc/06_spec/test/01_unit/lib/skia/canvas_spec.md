...
<!-- sdn-diagram:id=canvas_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=canvas_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=canvas_spec.arch hash=sha256:auto
...
| Difficulty | 2/5 |
| Status | Implemented |
| Source | `test/01_unit/lib/skia/canvas_spec.spl` |
| Updated | 2026-06-01 |
