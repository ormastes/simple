...
<!-- sdn-diagram:id=parsers_sdn_coverage_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=parsers_sdn_coverage_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

parsers_sdn_coverage_spec -> lib
parsers_sdn_coverage_spec -> std
```
...
```ascii generated-from=parsers_sdn_coverage_spec.arch hash=sha256:auto
...
| Design | N/A |
| Research | N/A |
| Source | `test/01_unit/lib/common/parsers_sdn_coverage_spec.spl` |
| Updated | 2026-06-01 |
