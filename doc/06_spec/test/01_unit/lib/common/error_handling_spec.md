...
2. expect not ok result is err
3. expect err result is err
4. expect not err result is ok
...
1. expect some val is some
2. expect not some val is none
3. expect none val is none
4. expect not none val is some
...
1. expect filtered is some
2. expect rejected is none
