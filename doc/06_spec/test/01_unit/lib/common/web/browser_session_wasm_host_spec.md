...
<!-- sdn-diagram:id=browser_session_wasm_host_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=browser_session_wasm_host_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

browser_session_wasm_host_spec -> std
```
...
```ascii generated-from=browser_session_wasm_host_spec.arch hash=sha256:auto
...
#### executes a bounded signed i32.const function export body
...
#### executes bounded i32 local.set function export body
...
#### executes bounded i32 local.tee function export body
...
#### executes bounded i32 global.get function export body

1. var interp =  new interpreter
   - Expected: _object_property_text(interp, module, "validated") equals `true`
   - Expected: _object_property_text(interp, module, "functionExportName0") equals `run`
   - Expected: _object_property_text(interp, module, "globalValue") equals `40`
2. JsValue Object
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `42`
...
#### executes bounded mutable i32 global.set function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `42`
   - Expected: _object_property_text(interp, module, "runtimeGlobalValue0") equals `42`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `44`
   - Expected: _object_property_text(interp, module, "runtimeGlobalValue0") equals `44`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### fails closed on bounded i32.load out-of-bounds memory traps
...
#### fails closed on bounded i32.store out-of-bounds memory traps
...
#### executes bounded i32.store8 and i32.load8_u function export body
...
#### executes bounded i32.load8_s function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `-86`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32.store16 and i32.load16_u function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `4660`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32.load16_s function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `-128`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded internal function call export body
...
#### executes bounded internal function call export body with arguments
...
#### executes bounded early return function export body
...
#### executes bounded drop function export body
...
#### executes bounded select function export body
...
#### executes bounded if else function export body
...
#### executes bounded if else false branch function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `7`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded br_if block function export body
...
#### executes bounded br_if fallthrough block function export body
...
<details>
<summary>Advanced: executes bounded loop br_if function export body</summary>

#### executes bounded loop br_if function export body
...
#### wraps bounded i32 arithmetic overflow to signed i32 results

1. var interp =  new interpreter
   - Expected: _object_property_text(interp, add_module, "validated") equals `true`
   - Expected: _object_property_text(interp, sub_module, "validated") equals `true`
   - Expected: _object_property_text(interp, mul_module, "validated") equals `true`
2. JsValue Object
3. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `-2147483648`
   - Expected: "missing add exports" equals ``
   - Expected: "missing add instance" equals ``
4. JsValue Object
5. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `2147483647`
   - Expected: "missing sub exports" equals ``
   - Expected: "missing sub instance" equals ``
6. JsValue Object
7. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `0`
   - Expected: "missing mul exports" equals ``
   - Expected: "missing mul instance" equals ``
...
#### executes bounded i32.div_u function export body with unsigned operands
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `2147483647`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32.rem_u function export body
...
#### fails closed on bounded i32.div_s integer overflow traps
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `wasm-trap:integer-overflow`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### fails closed on bounded i32.rem_u divide by zero traps
...
#### executes bounded i32 count-leading-zero function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `27`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32 count-trailing-zero function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `4`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32 population-count function export body
...
#### executes bounded i32.shl function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `40`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### wraps bounded i32 shift and rotate overflow to signed i32 results

1. var interp =  new interpreter
   - Expected: _object_property_text(interp, shl_module, "validated") equals `true`
   - Expected: _object_property_text(interp, rotl_module, "validated") equals `true`
2. JsValue Object
3. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `-2147483648`
   - Expected: "missing shl exports" equals ``
   - Expected: "missing shl instance" equals ``
4. JsValue Object
5. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `-2147483648`
   - Expected: "missing rotl exports" equals ``
   - Expected: "missing rotl instance" equals ``
...
#### executes bounded i32.shr_u function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `5`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32.shr_s function export body
...
#### executes bounded i32.rotl function export body
...
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `8`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
...
#### executes bounded i32.rotr function export body
...
#### executes bounded i32 sign-extension function export bodies

1. var interp =  new interpreter
   - Expected: _object_property_text(interp, extend8, "validated") equals `true`
   - Expected: _object_property_text(interp, extend8, "functionExportName0") equals `run`
2. JsValue Object
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `-1`
   - Expected: "missing exports" equals ``
   - Expected: "missing instance" equals ``
   - Expected: _object_property_text(interp, extend16, "validated") equals `true`
   - Expected: _object_property_text(interp, extend16, "functionExportName0") equals `run`
4. JsValue Object
5. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `-1`
...
#### executes bounded i32 unsigned comparisons with unsigned ordering

1. var interp =  new interpreter
   - Expected: _object_property_text(interp, lt_module, "validated") equals `true`
   - Expected: _object_property_text(interp, gt_module, "validated") equals `true`
   - Expected: _object_property_text(interp, le_module, "validated") equals `true`
   - Expected: _object_property_text(interp, ge_module, "validated") equals `true`
2. JsValue Object
3. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `0`
   - Expected: "missing lt exports" equals ``
   - Expected: "missing lt instance" equals ``
4. JsValue Object
5. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `1`
   - Expected: "missing gt exports" equals ``
   - Expected: "missing gt instance" equals ``
6. JsValue Object
7. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `1`
   - Expected: "missing le exports" equals ``
   - Expected: "missing le instance" equals ``
8. JsValue Object
9. JsValue Object
   - Expected: _display_js(interp._native_webassembly_export_function(interp.get_object_property(exports_id, "run"), [], -1)) equals `1`
   - Expected: "missing ge exports" equals ``
   - Expected: "missing ge instance" equals ``
...
#### executes bounded i32.div_u with unsigned negative operands
...
#### executes bounded i32.gt_u with unsigned negative operands
...
#### rejects memory.grow beyond declared module maximum

1. var interp =  new interpreter
   - Expected: _object_property_text(interp, module, "validated") equals `true`
   - Expected: _object_property_text(interp, module, "hasMemorySection") equals `true`
   - Expected: _object_property_text(interp, module, "memoryMinPages") equals `1`
   - Expected: _object_property_text(interp, module, "memoryMaxPages") equals `2`
2. JsValue Object
3. JsValue Object
   - Expected: _display_js(run_value) equals `[Function]`
   - Expected: _display_js(interp._native_webassembly_export_function(run_value, [], -1)) equals `-1`
...
#### executes bounded memory.fill function export body
...
#### fails closed on bounded memory.fill out-of-bounds traps
...
#### executes bounded memory.copy function export body
...
#### fails closed on bounded memory.copy out-of-bounds traps
...
#### executes bounded data.drop with zero-length memory.init
...
#### fails closed on memory.init after data.drop
...
#### windows WebAssembly.Memory buffer bytes through Uint8Array subarray views
...
6. interp set object property
7. JsValue Object
   - Expected: _object_property_text(interp, sub, "byteOffset") equals `1`
   - Expected: _object_property_text(interp, sub, "length") equals `2`
   - Expected: _display_js(interp.get_object_property(sub_id, "0")) equals `42`
8. interp set object property
   - Expected: _display_js(interp.get_object_property(view_id, "2")) equals `77`
   - Expected: "missing subview" equals ``
   - Expected: "missing view" equals ``
   - Expected: "missing buffer" equals ``
   - Expected: "missing memory" equals ``
...
#### sets Uint8Array view bytes into WebAssembly.Memory buffer windows
...
10. Ok
   - Expected: _display_js(interp.get_object_property(buffer_id, "3")) equals `7`
   - Expected: _display_js(interp.get_object_property(buffer_id, "4")) equals `8`
11. Err
...
#### sets Uint8Array view bytes through computed set member calls
...
5. JsValue Object
6. interp set object property
7. interp define global value
8. interp define global value
9. Ok
   - Expected: _display_js(interp.get_object_property(buffer_id, "5")) equals `9`
10. Err
   - Expected: "unexpected js error: {err}" equals ``
   - Expected: "missing source" equals ``
   - Expected: "missing buffer" equals ``
...
| Status | Active |
| Source | `test/01_unit/lib/common/web/browser_session_wasm_host_spec.spl` |
| Updated | 2026-06-01 |
