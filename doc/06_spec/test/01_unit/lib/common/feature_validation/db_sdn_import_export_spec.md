...
| Status | Fixed |
| Source | `test/01_unit/lib/common/feature_validation/db_sdn_import_export_spec.spl` |
| Updated | 2026-06-01 |
...
- var table = SdnTable new
- var row1 = SdnTable empty row
- table add row
- var exported = table to sdn
