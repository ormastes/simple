...
#### escapes html in inline text and marker interiors
...
```simple
expect(markdown_inline_text("<script>x</script> `a<b` **c&d** *\"q\"*")).to_equal("&lt;script&gt;x&lt;/script&gt; <code>a&lt;b</code> <strong>c&amp;d</strong> <em>&quot;q&quot;</em>")
```
