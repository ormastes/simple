...
<!-- sdn-diagram:id=wine_process_session_import_descriptor_vma_vm_write_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=wine_process_session_import_descriptor_vma_vm_write_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

wine_process_session_import_descriptor_vma_vm_write_spec -> common
```
...
```ascii generated-from=wine_process_session_import_descriptor_vma_vm_write_spec.arch hash=sha256:auto
