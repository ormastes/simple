...
<!-- sdn-diagram:id=wine_process_session_import_transaction_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=wine_process_session_import_transaction_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

wine_process_session_import_transaction_spec -> common
```
...
```ascii generated-from=wine_process_session_import_transaction_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/lib/common/wine_process_session_import_transaction_spec.spl` |
| Updated | 2026-06-01 |
