...
<!-- sdn-diagram:id=wine_process_session_known_console_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=wine_process_session_known_console_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

wine_process_session_known_console_spec -> common
```
...
```ascii generated-from=wine_process_session_known_console_spec.arch hash=sha256:auto
