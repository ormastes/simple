...
<!-- sdn-diagram:id=custom_literals_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=custom_literals_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

custom_literals_spec
```
...
```ascii generated-from=custom_literals_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/lib/common/custom_literals_spec.spl` |
| Updated | 2026-06-01 |
