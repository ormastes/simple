...
<!-- sdn-diagram:id=js_runtime_node_fast_path_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=js_runtime_node_fast_path_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

js_runtime_node_fast_path_spec -> std
```
...
```ascii generated-from=js_runtime_node_fast_path_spec.arch hash=sha256:auto
