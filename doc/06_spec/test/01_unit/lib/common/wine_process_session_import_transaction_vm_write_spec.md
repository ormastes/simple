# Wine Process Session Import Transaction Vm Write Specification

> <details>

<!-- sdn-diagram:id=wine_process_session_import_transaction_vm_write_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=wine_process_session_import_transaction_vm_write_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

wine_process_session_import_transaction_vm_write_spec -> common
```
...
```ascii generated-from=wine_process_session_import_transaction_vm_write_spec.arch hash=sha256:auto
...
### Wine process import-loader transaction VM writes

#### applies import-loader transaction only after PEB/TEB VM byte-write readback
...
| Status | Active |
| Source | `test/01_unit/lib/common/wine_process_session_import_transaction_vm_write_spec.spl` |
| Updated | 2026-06-01 |
