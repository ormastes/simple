...
1. var result = first day of month
...
1. var result = last day of month
...
1. var result = first day of year
   - Expected: result[1] equals `1`
   - Expected: result[2] equals `1`
...
1. var result = first day of quarter
   - Expected: result[1] equals `1`
   - Expected: result[2] equals `1`
...
1. var result = last day of quarter
   - Expected: result[1] equals `3`
   - Expected: result[2] equals `31`
