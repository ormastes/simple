...
<!-- sdn-diagram:id=pure_gui_release_lane_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=pure_gui_release_lane_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

pure_gui_release_lane_spec -> std
```
...
```ascii generated-from=pure_gui_release_lane_spec.arch hash=sha256:auto
