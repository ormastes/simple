...
<!-- sdn-diagram:id=pure_smf_dynlib_perf_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=pure_smf_dynlib_perf_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

pure_smf_dynlib_perf_spec -> std
```
...
```ascii generated-from=pure_smf_dynlib_perf_spec.arch hash=sha256:auto
