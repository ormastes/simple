...
### gc_async_mut DBFS meta store facade
...
```simple
var store = MetaStore.create("/tmp/simple_dbfs_meta_facade_gc")
val row = InodeRow(
...
| Status | Active |
| Source | `test/01_unit/lib/gc_async_mut/db/dbfs_engine/dbfs_meta_store_facade_spec.spl` |
| Updated | 2026-06-01 |
