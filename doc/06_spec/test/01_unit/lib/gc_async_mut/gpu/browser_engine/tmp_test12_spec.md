# Tmp Test12 Specification

> <details>

<!-- sdn-diagram:id=tmp_test12_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=tmp_test12_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=tmp_test12_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/lib/gc_async_mut/gpu/browser_engine/tmp_test12_spec.spl` |
| Updated | 2026-06-01 |
