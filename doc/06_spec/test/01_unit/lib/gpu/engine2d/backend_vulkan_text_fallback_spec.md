# Backend Vulkan Text Fallback Specification

> <details>

<!-- sdn-diagram:id=backend_vulkan_text_fallback_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=backend_vulkan_text_fallback_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

backend_vulkan_text_fallback_spec -> std
```
...
```ascii generated-from=backend_vulkan_text_fallback_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/lib/gpu/engine2d/backend_vulkan_text_fallback_spec.spl` |
| Updated | 2026-06-01 |
