...
> Verifies the OpenCL compute session contract, including fail-closed behavior without valid FFI handles, retain/release lifecycle rules, buffer and kernel argument guards, generated kernel dispatch naming, and launch argument binding.
