...
1. var pool = ResourcePool3D create
...
1. var pool = ResourcePool3D create
2. pool advance frame
3. pool touch texture
4. pool advance frame
5. pool advance frame
...
1. var pool = ResourcePool3D create
2. pool allocate texture
3. pool allocate buffer
4. pool advance frame
5. pool advance frame
6. pool advance frame
...
2. pool allocate texture
3. pool allocate buffer
4. pool allocate shader
5. pool allocate pipeline
