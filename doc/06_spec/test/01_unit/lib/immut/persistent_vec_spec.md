...
1. fn run push stress
2. var v = PersistentVec empty
3. v = v push
4. v len
...
| Status | Active |
| Source | `test/01_unit/lib/immut/persistent_vec_spec.spl` |
| Updated | 2026-06-01 |
