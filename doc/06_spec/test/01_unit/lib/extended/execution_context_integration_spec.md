...
<!-- sdn-diagram:id=execution_context_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=execution_context_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

execution_context_integration_spec -> std
```
...
```ascii generated-from=execution_context_integration_spec.arch hash=sha256:auto
