...
<!-- sdn-diagram:id=ast_mir_integration_1_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=ast_mir_integration_1_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

ast_mir_integration_1_spec -> std
```
...
```ascii generated-from=ast_mir_integration_1_spec.arch hash=sha256:auto
