...
expect(env_prefix).to_contain("SIMPLE_BOOTSTRAP=1")
expect(env_prefix).to_contain("SIMPLE_LIB=\"$(pwd)/src\"")
expect(env_prefix).to_contain("SIMPLE_NO_STUB_FALLBACK=1")
expect(env_prefix.contains("SIMPLE_ALLOW_FREESTANDING_STUBS=1")).to_equal(false)
```

</details>

#### keeps the ARM64 Engine2D desktop build fail-closed on unresolved symbols

- Verify: keeps the ARM64 Engine2D desktop build fail-closed on unresolved symbols
   - Expected: env_prefix does not contain `SIMPLE_ALLOW_FREESTANDING_STUBS=1`
...
```simple
# @req: REQ-OS-001
step("Verify: keeps the ARM64 Engine2D desktop build fail-closed on unresolved symbols")
val target = scenario_target(scenario_arm64_desktop_engine2d())
val env_prefix = os_native_build_env_prefix(target, "")
expect(env_prefix).to_contain("SIMPLE_NO_STUB_FALLBACK=1")
expect(env_prefix.contains("SIMPLE_ALLOW_FREESTANDING_STUBS=1")).to_equal(false)
```
...
- Verify: accepts ARM64 WM ramfb marker completion even when QEMU remains live
   ...
   - Expected: qemu_scenario_serial_accepts_completion(scenario, "", fallback_serial) is false
...
#### requires registered font completion for ARM64 Engine2D desktop

- Verify: requires registered font completion for ARM64 Engine2D desktop
   - Expected: qemu_scenario_serial_accepts_completion(scenario, "", serial) is true
   - Expected: qemu_scenario_serial_accepts_completion(scenario, "", fallback_serial) is false
...
```simple
# @req: REQ-OS-001
step("Verify: requires registered font completion for ARM64 Engine2D desktop")
...
- Verify: materializes the desktop disk lane at the platform image path
   - Expected: args[0] equals `scripts/os/make_os_disk.shs`
...
- Verify: materializes representative board bundle outputs through deterministic host-side shims
   ...
   - Expected: arm64_cmd equals `["/bin/sh", "scripts/os/make_os_disk.shs", "64", arm64_output, "", "arm64"]`
...
- Canonical SPipe generation for source `3cc0a67da3a5e0927693fc9caf8336515ebca5ca08f5e15af7f624bb54ab5b3c`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `3cc0a67da3a5e0927693fc9caf8336515ebca5ca08f5e15af7f624bb54ab5b3c`.
...
source: test/01_unit/os/qemu_runner_extended_spec.spl
mirror: doc/06_spec/01_unit/os/qemu_runner_extended_spec.md (current)
...
doc/06_spec/01_unit/os/qemu_runner_extended_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/os/qemu_runner_extended_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, evidence, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/os/qemu_runner_extended_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 4 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/os/qemu_runner_extended_spec.spl:1:1: blocker SSDOC-TRC-003 [traceability] (-40): 1 declared requirement(s) have no scenario binding
  why: A requirement list without scenario evidence is inventory, not traceability.
  improve: Bind the stable requirement ID inside its executable scenario or explicit blocked case.
test/01_unit/os/qemu_runner_extended_spec.spl:223:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'passes entry closure for the x86_64 OS entry build' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/os/qemu_runner_extended_spec.spl:246:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'defaults RISC-V OS targets to LLVM native-build backend' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/os/qemu_runner_extended_spec.spl:254:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'explains when the selected compiler lacks the LLVM backend' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
