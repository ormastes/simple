...
```simple
# @req REQ-SSPEC-OS
step("should round-trip binary DBFS bytes with overwrite and sparse extension")
...
```simple
# @req REQ-SSPEC-OS
step("should round-trip binary NVFS bytes without changing read position")
step("Exercise NVFS and DBFS positioned owners")
...
```simple
# @req REQ-SSPEC-OS
step("should reject cross-filesystem and retired object identities")
...
```simple
# @req REQ-SSPEC-OS
step("should reject raw and overflowing object requests before driver dispatch")
step("Validate positioned filesystem source contracts")
val backend = SosixDbfsPositionedVfsBackendV1()
...
```simple
# @req REQ-SSPEC-OS
step("should keep colliding raw driver handles distinct behind virtual objects")
step("Validate positioned filesystem source contracts")
...
```simple
# @req REQ-SSPEC-OS
step("should publish a complete FAT32 NVFS DBFS and durable-sync routing matrix")
...
- Canonical SPipe generation for source `228666d0f0503b381a13e64bc9da434afaac16c01d0027a774d91f8cc8788ba8`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `228666d0f0503b381a13e64bc9da434afaac16c01d0027a774d91f8cc8788ba8`.
...
doc/06_spec/01_unit/os/sosix/positioned_filesystem_backends_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:48:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should round-trip binary DBFS bytes with overwrite and sparse extension' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:48:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should round-trip binary DBFS bytes with overwrite and sparse extension' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:61:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should round-trip binary NVFS bytes without changing read position' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:61:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should round-trip binary NVFS bytes without changing read position' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:72:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should reject cross-filesystem and retired object identities' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:72:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should reject cross-filesystem and retired object identities' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:84:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should reject raw and overflowing object requests before driver dispatch' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:93:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should keep colliding raw driver handles distinct behind virtual objects' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/os/sosix/positioned_filesystem_backends_spec.spl:122:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should publish a complete FAT32 NVFS DBFS and durable-sync routing matrix' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
