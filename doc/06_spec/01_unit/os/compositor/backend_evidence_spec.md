...
<!-- sdn-diagram:id=backend_evidence_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=backend_evidence_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

backend_evidence_spec -> std
backend_evidence_spec -> os
```
...
```ascii generated-from=backend_evidence_spec.arch hash=sha256:auto
