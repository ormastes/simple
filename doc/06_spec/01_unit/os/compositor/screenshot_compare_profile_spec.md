...
<!-- sdn-diagram:id=screenshot_compare_profile_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=screenshot_compare_profile_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

screenshot_compare_profile_spec -> std
screenshot_compare_profile_spec -> os
```
...
```ascii generated-from=screenshot_compare_profile_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/os/compositor/screenshot_compare_profile_spec.spl` |
| Updated | 2026-06-01 |
