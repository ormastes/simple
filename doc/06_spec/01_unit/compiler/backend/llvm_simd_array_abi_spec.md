...
- selects hosted cross compilers without entering the SimpleOS RV64 path
   - Expected: native_link does not contain `"obj`
   - Expected: builder does not contain `self.target.datalayout()`
   - Expected: core does not contain `case MirInstKind.Const(dest, value, ty):`
   - Expected: core does not contain `case Const(dest, _, _) | Copy(dest, _)`
   - Expected: core does not contain `self.ptr_locals.has(id)`
   - Expected: core does not contain `self.bool_locals.has(id)`
...
expect(core.contains("case MirInstKind.Const(dest, value, ty):")).to_equal(false)
...
- Canonical SPipe generation for source `73fb3ab6de66db88cccd7e0b59359379dcf696a7f2621c0b9099990a278e682a`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `73fb3ab6de66db88cccd7e0b59359379dcf696a7f2621c0b9099990a278e682a`.
...
doc/06_spec/01_unit/compiler/backend/llvm_simd_array_abi_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/compiler/backend/llvm_simd_array_abi_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/compiler/backend/llvm_simd_array_abi_spec.spl:17:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'uses the runtime array ABI for packed pixel rows' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/backend/llvm_simd_array_abi_spec.spl:33:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'keeps the public Simple wrapper narrow and typed' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/backend/llvm_simd_array_abi_spec.spl:41:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'selects hosted cross compilers without entering the SimpleOS RV64 path' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
