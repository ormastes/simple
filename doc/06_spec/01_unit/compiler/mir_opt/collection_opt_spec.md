...
#### identifies text pointers without nested enum pattern binding
...
- identifies text pointers without nested enum pattern binding
- Verify: identifies text pointers without nested enum pattern binding
   - Expected: mir_type_is_text(MirType.ptr(MirType(kind: MirTypeKind.I8), false)) is true
   - Expected: mir_type_is_text(MirType.ptr(MirType.i64(), false)) is false
   - Expected: mir_type_is_text(MirType.i64()) is false
...
step("Verify: identifies text pointers without nested enum pattern binding")
...
- Canonical SPipe generation for source `ac0157760e3bd741840a0905ee18e1fb4cb8a6044f2130f330035a94e5767bd3`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `ac0157760e3bd741840a0905ee18e1fb4cb8a6044f2130f330035a94e5767bd3`.
...
source: test/01_unit/compiler/mir_opt/collection_opt_spec.spl
mirror: doc/06_spec/01_unit/compiler/mir_opt/collection_opt_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/compiler/mir_opt/collection_opt_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/compiler/mir_opt/collection_opt_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/compiler/mir_opt/collection_opt_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 30 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/compiler/mir_opt/collection_opt_spec.spl:166:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'identifies text pointers without nested enum pattern binding' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/mir_opt/collection_opt_spec.spl:175:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'treats set membership tests as pure hoistable collection queries' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/mir_opt/collection_opt_spec.spl:190:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'reuses repeated pure set relationship query results in a block' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
