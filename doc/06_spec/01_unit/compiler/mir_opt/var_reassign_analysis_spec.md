...
3. terminator: MirTerminator Goto

4. id: BlockId new

5. instructions: [inst

6. terminator: MirTerminator Ret
...
2. terminator: MirTerminator If

3. id: BlockId new

4. instructions: [inst

5. terminator: MirTerminator Goto

6. id: BlockId new

7. instructions: [inst

8. terminator: MirTerminator Goto

9. id: BlockId new

10. instructions: [inst

11. terminator: MirTerminator Ret
   - Expected: result.applied is true
...
10. terminator: MirTerminator Ret
   - Expected: result.applied is true
   - Expected: result.reason equals `ready`
...
7. terminator: MirTerminator Goto

8. id: BlockId new

9. instructions: [inst

10. terminator: MirTerminator Goto

11. id: BlockId new

12. instructions: [inst

13. terminator: MirTerminator Ret
   - Expected: result.applied is false
