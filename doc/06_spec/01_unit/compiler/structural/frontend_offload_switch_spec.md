...
#### refuses resident under require-requested

- Refuse to demote under require-requested
   - Expected: d.is_err() is true
   - Expected: d.unwrap_err() equals `frontend_offload_required_mode_unavailable: resident_gpu`
...
#### reports an unknown switch value as one error row, not as four rows
...
#### spells auto in the rows the same way the driver receipt does
...
#### emits canonical warm-receipt rows from one env reading
...
Source SHA-256: `dd2c1aa5fc055b6730bc55c7c825a62f0c3b9d229043c5b491438a9b331793aa`
