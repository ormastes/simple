...
- Canonical SPipe generation for source `183afac3a2c1b833e354b741bd99194f991813c6b4fb66617077a60934258a38`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `183afac3a2c1b833e354b741bd99194f991813c6b4fb66617077a60934258a38`.
...
source: test/01_unit/compiler/common/export_attr_spec.spl
mirror: doc/06_spec/01_unit/compiler/common/export_attr_spec.md (current)
findings: 7 blockers: 0
  narrative=100 structure=90 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/compiler/common/export_attr_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/compiler/common/export_attr_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, evidence, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/compiler/common/export_attr_spec.spl:115:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'returns nil when no @export attribute' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/common/export_attr_spec.spl:122:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'returns nil for empty attribute list' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/common/export_attr_spec.spl:129:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'parses @export('C') correctly' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/common/export_attr_spec.spl:187:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'can be constructed with default values' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/compiler/common/export_attr_spec.spl:194:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'can be constructed with export enabled' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
