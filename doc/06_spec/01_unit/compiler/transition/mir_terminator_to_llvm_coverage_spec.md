# MirTerminator -> the LLVM text backend (MIR -> .ll emitter) is a totally declared boundary

> `spec/compiler_schema/transitions/mir_terminator_to_llvm.sdn` records the control-flow boundary of `MirToLlvm.translate_terminator_at`. All seven
...
| Source | `test/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.spl` |
| Updated | 2026-08-26 |
...
### mir_terminator_to_llvm transition table
...
- loads without a single parse error
   ...
   - Expected: table.name equals `mir_terminator_to_llvm`
...
expect(table.name).to_equal("mir_terminator_to_llvm")
...
- Canonical SPipe generation for source `7479b681d27e3489d211f4f26166b22918d9fcf80fa48ec94ff348ade0b75f88`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `7479b681d27e3489d211f4f26166b22918d9fcf80fa48ec94ff348ade0b75f88`.
...
source: test/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.spl
mirror: doc/06_spec/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 7 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.spl:47:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'loads without a single parse error' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.spl:55:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'declares all 7 MirTerminator variants — Missing is empty' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/compiler/transition/mir_terminator_to_llvm_coverage_spec.spl:66:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'names the variants this boundary is built around' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
