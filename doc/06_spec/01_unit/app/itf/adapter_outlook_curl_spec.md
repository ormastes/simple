...
<!-- sdn-diagram:id=adapter_outlook_curl_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=adapter_outlook_curl_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

adapter_outlook_curl_spec -> app
```
...
```ascii generated-from=adapter_outlook_curl_spec.arch hash=sha256:auto
