...
<!-- sdn-diagram:id=rtl_command_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=rtl_command_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

rtl_command_spec -> app
```
...
```ascii generated-from=rtl_command_spec.arch hash=sha256:auto
