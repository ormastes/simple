...
all public flags and their order are preserved. The decoded value retains the
parent's typed collection receipt, including selected target-source provenance.
