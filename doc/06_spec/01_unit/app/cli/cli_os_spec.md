...
- Verify: dispatches os targets successfully
   - Expected: handle_os_inline(["targets"]) equals `0`
...
- Verify: accepts os help aliases
   - Expected: handle_os_inline(["help"]) equals `0`
   - Expected: handle_os_inline(["--help"]) equals `0`
...
- Verify: rejects unknown os subcommands with a non-zero exit code
   - Expected: handle_os_inline(["unknown-subcommand"]) equals `1`
...
- Verify: keeps the last valid --log occurrence across mixed forms
   - Expected: handle_os_inline(["build", "--log=off", "--log", "on", "--arch=bogus"]) equals `1`
...
- Verify: rejects bare --arch followed by another option
   - Expected: handle_os_inline(["build", "--arch", "--log=off"]) equals `1`
...
- Verify: rejects bare --target followed by another option
   - Expected: handle_os_inline(["build", "--target", "--log=off"]) equals `1`
...
- Verify: rejects bare --scenario followed by another option
   - Expected: handle_os_inline(["build", "--scenario", "--arch=x86_64"]) equals `1`
...
- Canonical SPipe generation for source `4e52dad36e44ccb9606aad3d9c6fe3d08a903e27eb805151528a693aa7e26861`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `4e52dad36e44ccb9606aad3d9c6fe3d08a903e27eb805151528a693aa7e26861`.
...
source: test/01_unit/app/cli/cli_os_spec.spl
mirror: doc/06_spec/01_unit/app/cli/cli_os_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/app/cli/cli_os_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/app/cli/cli_os_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/app/cli/cli_os_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 8 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/app/cli/cli_os_spec.spl:28:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'dispatches os targets successfully' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/app/cli/cli_os_spec.spl:35:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'accepts os help aliases' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/app/cli/cli_os_spec.spl:42:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects unknown os subcommands with a non-zero exit code' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
