...
<!-- sdn-diagram:id=slide_outline_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=slide_outline_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

slide_outline_spec -> std
slide_outline_spec -> app
```
...
```ascii generated-from=slide_outline_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/app/office/slide_outline_spec.spl` |
| Updated | 2026-06-01 |
