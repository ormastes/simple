...
<!-- sdn-diagram:id=smf_dynlib_probe_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=smf_dynlib_probe_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

smf_dynlib_probe_spec -> std
smf_dynlib_probe_spec -> app
```
...
```ascii generated-from=smf_dynlib_probe_spec.arch hash=sha256:auto
