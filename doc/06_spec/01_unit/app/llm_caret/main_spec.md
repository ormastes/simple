...
val zero_set = env_set("LLM_CARET_ENABLE_HIDDEN_COMMANDS", "0")
val zero_disabled = _hidden_commands_enabled()
val false_set = env_set(
    "LLM_CARET_ENABLE_HIDDEN_COMMANDS", "false"
)
val false_disabled = _hidden_commands_enabled()
val yes_set = env_set("LLM_CARET_ENABLE_HIDDEN_COMMANDS", "yes")
val yes_disabled = _hidden_commands_enabled()
val whitespace_set = env_set(
    "LLM_CARET_ENABLE_HIDDEN_COMMANDS", " true "
)
val whitespace_disabled = _hidden_commands_enabled()
...
expect(empty_set).to_be(true)
expect(zero_set).to_be(true)
expect(false_set).to_be(true)
expect(yes_set).to_be(true)
expect(whitespace_set).to_be(true)
expect(one_set).to_be(true)
expect(true_set).to_be(true)
expect(restored).to_be(true)
expect(empty_disabled).to_be(false)
expect(zero_disabled).to_be(false)
expect(false_disabled).to_be(false)
expect(yes_disabled).to_be(false)
expect(whitespace_disabled).to_be(false)
