...
<!-- sdn-diagram:id=reduce_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reduce_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reduce_integration_spec -> std
```
...
```ascii generated-from=reduce_integration_spec.arch hash=sha256:auto
