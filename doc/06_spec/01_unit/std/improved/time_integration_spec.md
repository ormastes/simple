...
<!-- sdn-diagram:id=time_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=time_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

time_integration_spec -> std
```
...
```ascii generated-from=time_integration_spec.arch hash=sha256:auto
