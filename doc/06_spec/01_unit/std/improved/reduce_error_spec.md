...
<!-- sdn-diagram:id=reduce_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reduce_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reduce_error_spec -> std
```
...
```ascii generated-from=reduce_error_spec.arch hash=sha256:auto
