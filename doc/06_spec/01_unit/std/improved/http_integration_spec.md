...
<!-- sdn-diagram:id=http_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=http_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

http_integration_spec -> std
```
...
```ascii generated-from=http_integration_spec.arch hash=sha256:auto
