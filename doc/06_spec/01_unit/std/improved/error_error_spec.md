...
<!-- sdn-diagram:id=error_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=error_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

error_error_spec -> std
```
...
```ascii generated-from=error_error_spec.arch hash=sha256:auto
