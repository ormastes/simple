...
<!-- sdn-diagram:id=spec_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=spec_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

spec_integration_spec -> std
```
...
```ascii generated-from=spec_integration_spec.arch hash=sha256:auto
