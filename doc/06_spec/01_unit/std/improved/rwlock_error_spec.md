...
<!-- sdn-diagram:id=rwlock_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=rwlock_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

rwlock_error_spec -> std
```
...
```ascii generated-from=rwlock_error_spec.arch hash=sha256:auto
