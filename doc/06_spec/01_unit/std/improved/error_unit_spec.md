...
<!-- sdn-diagram:id=error_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=error_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=error_unit_spec.arch hash=sha256:auto
