...
<!-- sdn-diagram:id=spawn_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=spawn_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

spawn_integration_spec -> std
```
...
```ascii generated-from=spawn_integration_spec.arch hash=sha256:auto
