...
<!-- sdn-diagram:id=macro_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=macro_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

macro_error_spec -> std
```
...
```ascii generated-from=macro_error_spec.arch hash=sha256:auto
