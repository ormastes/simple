...
<!-- sdn-diagram:id=channel_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=channel_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

channel_integration_spec -> std
```
...
```ascii generated-from=channel_integration_spec.arch hash=sha256:auto
