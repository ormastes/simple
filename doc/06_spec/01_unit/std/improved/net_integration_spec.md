...
<!-- sdn-diagram:id=net_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=net_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

net_integration_spec -> std
```
...
```ascii generated-from=net_integration_spec.arch hash=sha256:auto
