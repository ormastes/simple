...
<!-- sdn-diagram:id=vector_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=vector_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

vector_unit_spec -> std
```
...
```ascii generated-from=vector_unit_spec.arch hash=sha256:auto
