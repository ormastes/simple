...
<!-- sdn-diagram:id=join_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=join_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=join_error_spec.arch hash=sha256:auto
