...
<!-- sdn-diagram:id=rwlock_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=rwlock_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

rwlock_integration_spec -> std
```
...
```ascii generated-from=rwlock_integration_spec.arch hash=sha256:auto
