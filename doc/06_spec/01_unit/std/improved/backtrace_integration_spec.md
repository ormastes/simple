...
<!-- sdn-diagram:id=backtrace_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=backtrace_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

backtrace_integration_spec -> std
```
...
```ascii generated-from=backtrace_integration_spec.arch hash=sha256:auto
