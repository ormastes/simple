...
<!-- sdn-diagram:id=stream_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stream_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stream_integration_spec -> std
```
...
```ascii generated-from=stream_integration_spec.arch hash=sha256:auto
