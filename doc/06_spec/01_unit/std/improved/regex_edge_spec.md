...
<!-- sdn-diagram:id=regex_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=regex_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=regex_edge_spec.arch hash=sha256:auto
