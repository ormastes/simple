...
<!-- sdn-diagram:id=expect_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=expect_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

expect_integration_spec -> std
```
...
```ascii generated-from=expect_integration_spec.arch hash=sha256:auto
