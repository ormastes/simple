...
<!-- sdn-diagram:id=check_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=check_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=check_edge_spec.arch hash=sha256:auto
