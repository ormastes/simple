...
<!-- sdn-diagram:id=args_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=args_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

args_integration_spec -> std
```
...
```ascii generated-from=args_integration_spec.arch hash=sha256:auto
