...
<!-- sdn-diagram:id=flags_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=flags_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

flags_error_spec -> std
```
...
```ascii generated-from=flags_error_spec.arch hash=sha256:auto
