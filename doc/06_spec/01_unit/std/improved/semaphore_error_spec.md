...
<!-- sdn-diagram:id=semaphore_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=semaphore_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

semaphore_error_spec -> std
```
...
```ascii generated-from=semaphore_error_spec.arch hash=sha256:auto
