...
<!-- sdn-diagram:id=parse_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=parse_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

parse_integration_spec -> std
```
...
```ascii generated-from=parse_integration_spec.arch hash=sha256:auto
