...
<!-- sdn-diagram:id=reflect_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reflect_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reflect_unit_spec -> std
```
...
```ascii generated-from=reflect_unit_spec.arch hash=sha256:auto
