...
<!-- sdn-diagram:id=channel_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=channel_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

channel_edge_spec -> std
```
...
```ascii generated-from=channel_edge_spec.arch hash=sha256:auto
