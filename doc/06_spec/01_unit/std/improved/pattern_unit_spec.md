...
<!-- sdn-diagram:id=pattern_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=pattern_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

pattern_unit_spec -> std
```
...
```ascii generated-from=pattern_unit_spec.arch hash=sha256:auto
