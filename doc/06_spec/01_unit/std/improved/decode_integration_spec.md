...
<!-- sdn-diagram:id=decode_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=decode_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

decode_integration_spec -> std
```
...
```ascii generated-from=decode_integration_spec.arch hash=sha256:auto
