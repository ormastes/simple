...
<!-- sdn-diagram:id=match_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=match_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

match_integration_spec -> std
```
...
```ascii generated-from=match_integration_spec.arch hash=sha256:auto
