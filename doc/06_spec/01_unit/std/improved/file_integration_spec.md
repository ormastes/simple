...
<!-- sdn-diagram:id=file_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=file_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

file_integration_spec -> std
```
...
```ascii generated-from=file_integration_spec.arch hash=sha256:auto
