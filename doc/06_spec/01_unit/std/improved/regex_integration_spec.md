...
<!-- sdn-diagram:id=regex_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=regex_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

regex_integration_spec -> std
```
...
```ascii generated-from=regex_integration_spec.arch hash=sha256:auto
