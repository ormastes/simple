...
<!-- sdn-diagram:id=dir_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=dir_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

dir_integration_spec -> std
```
...
```ascii generated-from=dir_integration_spec.arch hash=sha256:auto
