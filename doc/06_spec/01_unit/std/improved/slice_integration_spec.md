...
<!-- sdn-diagram:id=slice_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=slice_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

slice_integration_spec -> std
```
...
```ascii generated-from=slice_integration_spec.arch hash=sha256:auto
