...
<!-- sdn-diagram:id=serialize_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=serialize_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

serialize_edge_spec -> std
```
...
```ascii generated-from=serialize_edge_spec.arch hash=sha256:auto
