...
<!-- sdn-diagram:id=codegen_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=codegen_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

codegen_error_spec -> std
```
...
```ascii generated-from=codegen_error_spec.arch hash=sha256:auto
