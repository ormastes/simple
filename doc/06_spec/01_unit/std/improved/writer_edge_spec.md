...
<!-- sdn-diagram:id=writer_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=writer_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

writer_edge_spec -> std
```
...
```ascii generated-from=writer_edge_spec.arch hash=sha256:auto
