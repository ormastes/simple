...
<!-- sdn-diagram:id=result_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=result_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

result_error_spec -> std
```
...
```ascii generated-from=result_error_spec.arch hash=sha256:auto
