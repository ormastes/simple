...
<!-- sdn-diagram:id=socket_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=socket_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

socket_unit_spec -> std
```
...
```ascii generated-from=socket_unit_spec.arch hash=sha256:auto
