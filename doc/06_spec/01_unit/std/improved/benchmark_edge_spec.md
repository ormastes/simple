...
<!-- sdn-diagram:id=benchmark_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=benchmark_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

benchmark_edge_spec -> std
```
...
```ascii generated-from=benchmark_edge_spec.arch hash=sha256:auto
