...
<!-- sdn-diagram:id=rwlock_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=rwlock_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

rwlock_unit_spec -> std
```
...
```ascii generated-from=rwlock_unit_spec.arch hash=sha256:auto
