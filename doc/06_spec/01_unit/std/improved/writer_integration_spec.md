...
<!-- sdn-diagram:id=writer_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=writer_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

writer_integration_spec -> std
```
...
```ascii generated-from=writer_integration_spec.arch hash=sha256:auto
