...
<!-- sdn-diagram:id=crypto_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=crypto_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

crypto_edge_spec -> std
```
...
```ascii generated-from=crypto_edge_spec.arch hash=sha256:auto
