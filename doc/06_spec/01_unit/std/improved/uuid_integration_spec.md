...
<!-- sdn-diagram:id=uuid_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=uuid_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

uuid_integration_spec -> std
```
...
```ascii generated-from=uuid_integration_spec.arch hash=sha256:auto
