...
<!-- sdn-diagram:id=option_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=option_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

option_error_spec -> std
```
...
```ascii generated-from=option_error_spec.arch hash=sha256:auto
