...
<!-- sdn-diagram:id=fs_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=fs_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

fs_integration_spec -> std
```
...
```ascii generated-from=fs_integration_spec.arch hash=sha256:auto
