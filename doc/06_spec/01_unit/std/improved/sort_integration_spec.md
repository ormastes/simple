...
<!-- sdn-diagram:id=sort_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=sort_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

sort_integration_spec -> std
```
...
```ascii generated-from=sort_integration_spec.arch hash=sha256:auto
