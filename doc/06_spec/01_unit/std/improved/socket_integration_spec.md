...
<!-- sdn-diagram:id=socket_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=socket_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

socket_integration_spec -> std
```
...
```ascii generated-from=socket_integration_spec.arch hash=sha256:auto
