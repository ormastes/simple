...
<!-- sdn-diagram:id=stdio_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stdio_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stdio_integration_spec -> std
```
...
```ascii generated-from=stdio_integration_spec.arch hash=sha256:auto
