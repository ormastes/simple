...
<!-- sdn-diagram:id=stack_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stack_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stack_integration_spec -> std
```
...
```ascii generated-from=stack_integration_spec.arch hash=sha256:auto
