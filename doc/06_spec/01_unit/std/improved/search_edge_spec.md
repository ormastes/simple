...
<!-- sdn-diagram:id=search_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=search_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

search_edge_spec -> std
```
...
```ascii generated-from=search_edge_spec.arch hash=sha256:auto
