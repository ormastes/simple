...
<!-- sdn-diagram:id=map_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=map_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

map_integration_spec -> std
```
...
```ascii generated-from=map_integration_spec.arch hash=sha256:auto
