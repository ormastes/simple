...
<!-- sdn-diagram:id=udp_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=udp_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

udp_integration_spec -> std
```
...
```ascii generated-from=udp_integration_spec.arch hash=sha256:auto
