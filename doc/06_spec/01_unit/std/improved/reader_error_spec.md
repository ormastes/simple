...
<!-- sdn-diagram:id=reader_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reader_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reader_error_spec -> std
```
...
```ascii generated-from=reader_error_spec.arch hash=sha256:auto
