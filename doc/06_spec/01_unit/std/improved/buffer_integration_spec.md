...
<!-- sdn-diagram:id=buffer_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=buffer_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

buffer_integration_spec -> std
```
...
```ascii generated-from=buffer_integration_spec.arch hash=sha256:auto
