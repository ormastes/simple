...
<!-- sdn-diagram:id=writer_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=writer_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

writer_error_spec -> std
```
...
```ascii generated-from=writer_error_spec.arch hash=sha256:auto
