...
<!-- sdn-diagram:id=expect_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=expect_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

expect_edge_spec -> std
```
...
```ascii generated-from=expect_edge_spec.arch hash=sha256:auto
