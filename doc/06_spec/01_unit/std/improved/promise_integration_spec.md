...
<!-- sdn-diagram:id=promise_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=promise_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

promise_integration_spec -> std
```
...
```ascii generated-from=promise_integration_spec.arch hash=sha256:auto
