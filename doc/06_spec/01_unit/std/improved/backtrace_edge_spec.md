...
<!-- sdn-diagram:id=backtrace_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=backtrace_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

backtrace_edge_spec -> std
```
...
```ascii generated-from=backtrace_edge_spec.arch hash=sha256:auto
