...
<!-- sdn-diagram:id=signal_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=signal_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

signal_edge_spec -> std
```
...
```ascii generated-from=signal_edge_spec.arch hash=sha256:auto
