...
<!-- sdn-diagram:id=instant_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=instant_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

instant_unit_spec -> std
```
...
```ascii generated-from=instant_unit_spec.arch hash=sha256:auto
