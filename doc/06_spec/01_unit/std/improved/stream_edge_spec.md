...
<!-- sdn-diagram:id=stream_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stream_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stream_edge_spec -> std
```
...
```ascii generated-from=stream_edge_spec.arch hash=sha256:auto
