...
<!-- sdn-diagram:id=result_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=result_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

result_integration_spec -> std
```
...
```ascii generated-from=result_integration_spec.arch hash=sha256:auto
