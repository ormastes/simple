...
<!-- sdn-diagram:id=decode_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=decode_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

decode_unit_spec -> std
```
...
```ascii generated-from=decode_unit_spec.arch hash=sha256:auto
