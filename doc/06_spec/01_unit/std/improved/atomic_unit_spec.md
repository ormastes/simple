...
<!-- sdn-diagram:id=atomic_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=atomic_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

atomic_unit_spec -> std
```
...
```ascii generated-from=atomic_unit_spec.arch hash=sha256:auto
