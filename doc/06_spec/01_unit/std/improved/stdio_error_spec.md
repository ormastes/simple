...
<!-- sdn-diagram:id=stdio_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stdio_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stdio_error_spec -> std
```
...
```ascii generated-from=stdio_error_spec.arch hash=sha256:auto
