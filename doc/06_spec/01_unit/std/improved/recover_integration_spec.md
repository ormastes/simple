...
<!-- sdn-diagram:id=recover_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=recover_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

recover_integration_spec -> std
```
...
```ascii generated-from=recover_integration_spec.arch hash=sha256:auto
