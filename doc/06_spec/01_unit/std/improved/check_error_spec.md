...
<!-- sdn-diagram:id=check_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=check_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

check_error_spec -> std
```
...
```ascii generated-from=check_error_spec.arch hash=sha256:auto
