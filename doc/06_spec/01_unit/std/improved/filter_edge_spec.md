...
<!-- sdn-diagram:id=filter_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=filter_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

filter_edge_spec -> std
```
...
```ascii generated-from=filter_edge_spec.arch hash=sha256:auto
