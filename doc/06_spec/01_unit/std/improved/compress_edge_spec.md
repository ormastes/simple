...
<!-- sdn-diagram:id=compress_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compress_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compress_edge_spec -> std
```
...
```ascii generated-from=compress_edge_spec.arch hash=sha256:auto
