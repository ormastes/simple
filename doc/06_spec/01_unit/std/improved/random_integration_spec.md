...
<!-- sdn-diagram:id=random_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=random_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

random_integration_spec -> std
```
...
```ascii generated-from=random_integration_spec.arch hash=sha256:auto
