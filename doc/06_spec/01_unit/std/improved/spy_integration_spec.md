...
<!-- sdn-diagram:id=spy_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=spy_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

spy_integration_spec -> std
```
...
```ascii generated-from=spy_integration_spec.arch hash=sha256:auto
