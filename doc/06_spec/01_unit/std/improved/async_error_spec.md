...
<!-- sdn-diagram:id=async_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=async_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

async_error_spec -> std
```
...
```ascii generated-from=async_error_spec.arch hash=sha256:auto
