...
<!-- sdn-diagram:id=rwlock_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=rwlock_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

rwlock_edge_spec -> std
```
...
```ascii generated-from=rwlock_edge_spec.arch hash=sha256:auto
