...
<!-- sdn-diagram:id=match_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=match_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

match_error_spec -> std
```
...
```ascii generated-from=match_error_spec.arch hash=sha256:auto
