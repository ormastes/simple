...
<!-- sdn-diagram:id=process_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=process_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

process_unit_spec -> std
```
...
```ascii generated-from=process_unit_spec.arch hash=sha256:auto
