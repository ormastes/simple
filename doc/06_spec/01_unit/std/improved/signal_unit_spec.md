...
<!-- sdn-diagram:id=signal_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=signal_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

signal_unit_spec -> std
```
...
```ascii generated-from=signal_unit_spec.arch hash=sha256:auto
