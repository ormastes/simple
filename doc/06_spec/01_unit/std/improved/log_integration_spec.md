...
<!-- sdn-diagram:id=log_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=log_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

log_integration_spec -> std
```
...
```ascii generated-from=log_integration_spec.arch hash=sha256:auto
