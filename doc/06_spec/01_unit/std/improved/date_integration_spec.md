...
<!-- sdn-diagram:id=date_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=date_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

date_integration_spec -> std
```
...
```ascii generated-from=date_integration_spec.arch hash=sha256:auto
