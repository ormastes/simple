...
<!-- sdn-diagram:id=crypto_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=crypto_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

crypto_unit_spec -> std
```
...
```ascii generated-from=crypto_unit_spec.arch hash=sha256:auto
