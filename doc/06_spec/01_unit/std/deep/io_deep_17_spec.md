...
<!-- sdn-diagram:id=io_deep_17_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=io_deep_17_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=io_deep_17_spec.arch hash=sha256:auto
