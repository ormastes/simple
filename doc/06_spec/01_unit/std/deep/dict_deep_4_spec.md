...
<!-- sdn-diagram:id=dict_deep_4_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=dict_deep_4_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

dict_deep_4_spec -> std
```
...
```ascii generated-from=dict_deep_4_spec.arch hash=sha256:auto
