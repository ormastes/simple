...
<!-- sdn-diagram:id=option_deep_15_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=option_deep_15_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

option_deep_15_spec -> std
```
...
```ascii generated-from=option_deep_15_spec.arch hash=sha256:auto
