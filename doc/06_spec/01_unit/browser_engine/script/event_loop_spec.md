...
describe "EventLoop":
    ...
    describe "AC-3: rAF scheduling":
        ...
        it "should saturate an unrepresentable browser clock boundary":
            step("Convert and schedule at the maximum browser clock")
            ...
            expect(el.next_due_micros()).to_equal(maximum)
            expect(el.drain_raf(maximum).len()).to_equal(1)
