...
| Status | Active |
| Source | `test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `d62e0514331b365854df1012ee0fe7164319ae4d7edb465b84a8bb16ae7c2d6b`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `d62e0514331b365854df1012ee0fe7164319ae4d7edb465b84a8bb16ae7c2d6b`.
...
source: test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl
mirror: doc/06_spec/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.md (current)
...
doc/06_spec/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, evidence, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:1:1: advice SSDOC-MNT-001 [maintainability] (-15): multiple scenarios form a flat, unfolded presentation
  why: Long flat dumps obscure the primary workflow.
  improve: Group secondary detail and keep the primary workflow visible.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:1:1: blocker SSDOC-ORA-001 [oracle] (-50): unconditional pending or fail-fast scaffold remains
  why: A passing-looking document without an oracle is not conformance evidence.
  improve: Replace placeholders with an observable production assertion.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 3 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:79:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'returns 32 bytes for the default 32-byte tag length' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:88:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'returns 16 bytes when tag_len=16' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:94:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'returns 64 bytes when tag_len=64 (single-BLAKE2b-call H' branch)' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
test/01_unit/lib/crypto/argon2id_rfc9106_kat_spec.spl:100:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'returns 96 bytes when tag_len=96 (multi-block H' branch)' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
