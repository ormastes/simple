# Metal Msl Backend Specification

> Tests covering deterministic Metal MSL ProcessingIR backend, Metal-to-Metal drawing access generation.
...
```simple
# @req REQ-SSPEC-LIB
step("should invalidate semantic changes and reject unsupported IR without source")
...
```simple
# @req REQ-SSPEC-LIB
step("should reject mutated source and entry before any Metal device operation")
...
```simple
# @req REQ-SSPEC-LIB
step("should lower shared drawing ProcessingIR without losing stride or bindings")
...
```simple
# @req REQ-SSPEC-LIB
step("should preserve resource bindings coordinate rules and pixel semantics")
...
```simple
# @req REQ-SSPEC-LIB
step("should fail closed for unsupported and lossy drawing translations")
...
- Canonical SPipe generation for source `cd44c3373686809fbead8df9f584099de66cb7077c2c6c30d40d25d6695d33b4`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `cd44c3373686809fbead8df9f584099de66cb7077c2c6c30d40d25d6695d33b4`.
...
doc/06_spec/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
...
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:1:1: blocker SSDOC-TRC-003 [traceability] (-40): 6 declared requirement(s) have no scenario binding
  why: A requirement list without scenario evidence is inventory, not traceability.
  improve: Bind the stable requirement ID inside its executable scenario or explicit blocked case.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:23:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should emit the shared artifact and fixed buffer ABI deterministically' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:23:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should emit the shared artifact and fixed buffer ABI deterministically' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:43:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should invalidate semantic changes and reject unsupported IR without source' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:43:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should invalidate semantic changes and reject unsupported IR without source' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:58:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should reject mutated source and entry before any Metal device operation' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:58:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should reject mutated source and entry before any Metal device operation' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:76:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should lower shared drawing ProcessingIR without losing stride or bindings' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:97:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should preserve resource bindings coordinate rules and pixel semantics' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/01_unit/lib/gc_async_mut/processing/metal_msl_backend_spec.spl:116:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should fail closed for unsupported and lossy drawing translations' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
