...
- Keep the full implemented Simple Web CSS subset tied to renderer behavior
   - Expected: implemented.split(" ").len() equals `284`
...
```simple
# @req REQ-SSPEC-LIB
step("assigns implemented CSS properties to functional renderer SSpecs")
...
expect(implemented).to_contain("backface-visibility")
expect(implemented).to_contain("border-collapse")
expect(implemented).to_contain("border-spacing")
expect(implemented).to_contain("caption-side")
expect(implemented).to_contain("column-count")
expect(implemented).to_contain("column-width")
expect(implemented).to_contain("columns")
expect(implemented).to_contain("column-rule")
expect(implemented).to_contain("column-rule-color")
expect(implemented).to_contain("column-rule-style")
expect(implemented).to_contain("column-rule-width")
...
expect(implemented).to_contain("background-blend-mode")
...
expect(implemented).to_contain("clip-path")
...
expect(implemented).to_contain("grid")
expect(implemented).to_contain("grid-area")
expect(implemented).to_contain("grid-auto-flow")
expect(implemented).to_contain("grid-column")
expect(implemented).to_contain("grid-column-gap")
expect(implemented).to_contain("grid-column-start")
expect(implemented).to_contain("grid-gap")
expect(implemented).to_contain("grid-row")
expect(implemented).to_contain("grid-row-gap")
expect(implemented).to_contain("grid-row-start")
expect(implemented).to_contain("grid-template")
expect(implemented).to_contain("grid-template-areas")
expect(implemented).to_contain("grid-template-columns")
expect(implemented).to_contain("grid-template-rows")
...
expect(implemented).to_contain("justify-items")
expect(implemented).to_contain("justify-self")
expect(implemented).to_contain("list-style")
expect(implemented).to_contain("list-style-image")
expect(implemented).to_contain("list-style-position")
expect(implemented).to_contain("list-style-type")
expect(implemented).to_contain("quotes")
expect(implemented).to_contain("text-emphasis")
expect(implemented).to_contain("text-emphasis-color")
expect(implemented).to_contain("text-emphasis-position")
expect(implemented).to_contain("text-emphasis-style")
...
- Keep the complete current unsupported W3C property inventory visible without claiming renderer support
   - Expected: unsupported_cases.len() equals `117`
   - Expected: unsupported_words does not contain ` accent-color `
   - Expected: unsupported_words does not contain ` color-adjust `
   - Expected: unsupported_words does not contain ` backface-visibility `
   - Expected: unsupported_words does not contain ` border-collapse `
   - Expected: unsupported_words does not contain ` border-spacing `
   - Expected: unsupported_words does not contain ` caption-side `
   - Expected: unsupported_words does not contain ` column-count `
   - Expected: unsupported_words does not contain ` column-width `
   - Expected: unsupported_words does not contain ` columns `
   - Expected: unsupported_words does not contain ` column-rule `
   - Expected: unsupported_words does not contain ` column-rule-color `
   - Expected: unsupported_words does not contain ` column-rule-style `
   - Expected: unsupported_words does not contain ` column-rule-width `
   - Expected: unsupported_words does not contain ` justify-items `
   - Expected: unsupported_words does not contain ` justify-self `
   - Expected: unsupported_words does not contain ` text-emphasis `
   - Expected: unsupported_words does not contain ` text-emphasis-color `
   - Expected: unsupported_words does not contain ` text-emphasis-position `
   - Expected: unsupported_words does not contain ` text-emphasis-style `
   - Expected: unsupported_words does not contain ` quotes `
   ...
   - Expected: unsupported_words does not contain ` background-blend-mode `
   - Expected: unsupported_words does not contain ` clip `
   - Expected: unsupported_words does not contain ` clip-path `
   ...
   - Expected: unsupported_words does not contain ` grid `
   - Expected: unsupported_words does not contain ` grid-area `
   - Expected: unsupported_words does not contain ` grid-auto-flow `
   - Expected: unsupported_words does not contain ` grid-column `
   - Expected: unsupported_words does not contain ` grid-column-start `
   - Expected: unsupported_words does not contain ` grid-template `
   - Expected: unsupported_words does not contain ` grid-template-columns `
   - Expected: unsupported_words does not contain ` grid-template-rows `
   - Expected: unsupported_words does not contain ` grid-column-gap `
   - Expected: unsupported_words does not contain ` grid-gap `
   - Expected: unsupported_words does not contain ` grid-row `
   - Expected: unsupported_words does not contain ` grid-row-gap `
   - Expected: unsupported_words does not contain ` grid-row-start `
   - Expected: unsupported_words does not contain ` grid-template-areas `
   ...
   - Expected: unsupported_words does not contain ` list-style-image `
   - Expected: unsupported_words does not contain ` list-style-position `
...
```simple
# @req REQ-SSPEC-LIB
step("assigns unsupported W3C CSS properties to inventory traceability until implemented")
...
expect(unsupported_cases.len()).to_equal(117)
...
expect(unsupported_words.contains(" backface-visibility ")).to_equal(false)
expect(unsupported_words.contains(" border-collapse ")).to_equal(false)
expect(unsupported_words.contains(" border-spacing ")).to_equal(false)
expect(unsupported_words.contains(" caption-side ")).to_equal(false)
expect(unsupported_words.contains(" column-count ")).to_equal(false)
expect(unsupported_words.contains(" column-width ")).to_equal(false)
expect(unsupported_words.contains(" columns ")).to_equal(false)
expect(unsupported_words.contains(" column-rule ")).to_equal(false)
expect(unsupported_words.contains(" column-rule-color ")).to_equal(false)
expect(unsupported_words.contains(" column-rule-style ")).to_equal(false)
expect(unsupported_words.contains(" column-rule-width ")).to_equal(false)
expect(unsupported_words.contains(" justify-items ")).to_equal(false)
expect(unsupported_words.contains(" justify-self ")).to_equal(false)
expect(unsupported_words.contains(" text-emphasis ")).to_equal(false)
expect(unsupported_words.contains(" text-emphasis-color ")).to_equal(false)
expect(unsupported_words.contains(" text-emphasis-position ")).to_equal(false)
expect(unsupported_words.contains(" text-emphasis-style ")).to_equal(false)
expect(unsupported_words.contains(" quotes ")).to_equal(false)
...
expect(unsupported_words.contains(" background-blend-mode ")).to_equal(false)
expect(unsupported).to_contain("border-image-source")
expect(unsupported_words.contains(" clip ")).to_equal(false)
expect(unsupported_words.contains(" clip-path ")).to_equal(false)
...
expect(unsupported_words.contains(" grid ")).to_equal(false)
expect(unsupported_words.contains(" grid-area ")).to_equal(false)
expect(unsupported_words.contains(" grid-auto-flow ")).to_equal(false)
expect(unsupported_words.contains(" grid-column ")).to_equal(false)
expect(unsupported_words.contains(" grid-column-start ")).to_equal(false)
expect(unsupported_words.contains(" grid-template ")).to_equal(false)
expect(unsupported_words.contains(" grid-template-columns ")).to_equal(false)
expect(unsupported_words.contains(" grid-template-rows ")).to_equal(false)
expect(unsupported_words.contains(" grid-column-gap ")).to_equal(false)
expect(unsupported_words.contains(" grid-gap ")).to_equal(false)
expect(unsupported_words.contains(" grid-row ")).to_equal(false)
expect(unsupported_words.contains(" grid-row-gap ")).to_equal(false)
expect(unsupported_words.contains(" grid-row-start ")).to_equal(false)
expect(unsupported_words.contains(" grid-template-areas ")).to_equal(false)
...
expect(unsupported_words.contains(" list-style-image ")).to_equal(false)
expect(unsupported_words.contains(" list-style-position ")).to_equal(false)
...
- Canonical SPipe generation for source `2c37be789734fb99a442260dd5eb529c8417456d6c87feb1877dd90dd0c229ca`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `2c37be789734fb99a442260dd5eb529c8417456d6c87feb1877dd90dd0c229ca`.
...
source: test/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.spl
mirror: doc/06_spec/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=80
  traceability=100 evidence=80 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-20): 2 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.spl:51:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'assigns implemented CSS properties to functional renderer SSpecs' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/gc_async_mut/gpu/browser_engine/simple_web_css_inventory_traceability_spec.spl:237:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'assigns unsupported W3C CSS properties to inventory traceability until implemented' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
