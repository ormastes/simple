# Spec: Slang Tensor-Pack Manifest Loader
...
- Slang manifest parsing and model-pack loading must be explicit, non-throwing,
...
- Tensor byte range extraction. Covered separately by
  `doc/06_spec/01_unit/lib/gc_async_mut/slang/model_loader_tensor_bytes_spec.md`.
