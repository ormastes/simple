...
doc/06_spec/01_unit/lib/host_cpu_variant_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/lib/host_cpu_variant_spec.spl:307:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'all 20 host CPU variant checks pass (tier ranking, clamping, dispatch, probing, manifest, fallback)' has no retained capture or evidence
