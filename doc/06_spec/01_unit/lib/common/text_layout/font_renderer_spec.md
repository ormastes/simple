...
2. Prepare bitmap, vector, and shaped runs through one renderer.
...
The executable assertions are authoritative. Regenerate this manual with SPipe
docgen when the pure-Simple runner is available and require zero stubs.
