...
| Design | N/A |
| Research | N/A |
| Source | `test/01_unit/lib/common/yaml_coverage_spec.spl` |
| Updated | 2026-08-26 |
...
#### quotes a string with double style

- quotes a string with double style
- Verify: quotes a string with double style
...
```simple
# @req REQ-SSPEC-LIB
step("quotes a string with double style")
step("Verify: quotes a string with double style")
...
#### quotes a string with single style

- quotes a string with single style
- Verify: quotes a string with single style
...
```simple
# @req REQ-SSPEC-LIB
step("quotes a string with single style")
step("Verify: quotes a string with single style")
...
#### rejects mismatched type

- rejects mismatched type
- Verify: rejects mismatched type
...
```simple
# @req REQ-SSPEC-LIB
step("rejects mismatched type")
step("Verify: rejects mismatched type")
...
- Canonical SPipe generation for source `f6db38a0a2d570a5433c917edd02ebd23d6e7c89ca6a317f4f0ef2855504cc45`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `f6db38a0a2d570a5433c917edd02ebd23d6e7c89ca6a317f4f0ef2855504cc45`.
...
source: test/01_unit/lib/common/yaml_coverage_spec.spl
mirror: doc/06_spec/01_unit/lib/common/yaml_coverage_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/lib/common/yaml_coverage_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/lib/common/yaml_coverage_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, evidence, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/lib/common/yaml_coverage_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 4 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/lib/common/yaml_coverage_spec.spl:75:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'creates null' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/common/yaml_coverage_spec.spl:83:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'creates boolean true' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/common/yaml_coverage_spec.spl:90:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'creates boolean false' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
