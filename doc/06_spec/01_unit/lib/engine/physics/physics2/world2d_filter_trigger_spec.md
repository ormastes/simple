...
```simple
# @req REQ-SSPEC-LIB
step("backward compat: default filters/no-trigger produce the same contact as unfiltered behavior")
...
```simple
# @req REQ-SSPEC-LIB
step("masks-reject-pair: an incompatible category/mask pair produces NO contact")
...
```simple
# @req REQ-SSPEC-LIB
step("trigger-pair: an is_sensor collider emits a trigger event and does not push bodies apart")
...
```simple
# @req REQ-SSPEC-LIB
step("BVH broadphase path (>4 colliders) applies the same filter/trigger wiring")
...
- Canonical SPipe generation for source `f3202db89132f707d399b2b09142a634c7cca0021db7c884619f06d38f9e4ac4`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `f3202db89132f707d399b2b09142a634c7cca0021db7c884619f06d38f9e4ac4`.
...
source: test/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.spl
mirror: doc/06_spec/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 7 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.spl:69:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'backward compat: default filters/no-trigger produce the same contact as unfiltered behavior' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.spl:86:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'masks-reject-pair: an incompatible category/mask pair produces NO contact' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/lib/engine/physics/physics2/world2d_filter_trigger_spec.spl:112:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'trigger-pair: an is_sensor collider emits a trigger event and does not push bodies apart' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
