...
- Canonical SPipe generation for source `533b22bae1430de2ca32808a58692d76fae767c4b18c56feb4a97a19da939023`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `533b22bae1430de2ca32808a58692d76fae767c4b18c56feb4a97a19da939023`.
...
test/system/app/simpleos/feature/simpleos_wine_process_tls_dispatch_spec.spl:1:1: blocker SSDOC-TRC-003 [traceability] (-40): 1 declared requirement(s) have no scenario binding
  why: A requirement list without scenario evidence is inventory, not traceability.
  improve: Bind the stable requirement ID inside its executable scenario or explicit blocked case.
test/system/app/simpleos/feature/simpleos_wine_process_tls_dispatch_spec.spl:53:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'should record a mapped TLS callback dispatch after relocation without executing PE code' has no visible step flow
...
test/system/app/simpleos/feature/simpleos_wine_process_tls_dispatch_spec.spl:69:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should require PEB/TEB VM byte-write readback before TLS callback dispatch record' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/system/app/simpleos/feature/simpleos_wine_process_tls_dispatch_spec.spl:69:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should require PEB/TEB VM byte-write readback before TLS callback dispatch record' has no retained capture or evidence
