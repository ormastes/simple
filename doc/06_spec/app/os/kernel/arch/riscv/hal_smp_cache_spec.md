...
|-----------|-------|-------|-------------|
| `test/01_unit/lib/baremetal/riscv/sbi_ipi_spec.spl` | SBI IPI Extension | 9 | AC-1 |
| `test/01_unit/lib/baremetal/riscv/dtb_cpu_walker_spec.spl` | DTB CPU Walker | 12 | AC-1, AC-3, AC-5 |
| `test/01_unit/os/kernel/arch/riscv/hal_smp_spec.spl` | HalSmp | 10 | AC-1, AC-5 |
| `test/01_unit/os/kernel/arch/riscv/hal_cache_spec.spl` | HalCache | 13 | AC-2, AC-3, AC-5 |
| `test/01_unit/os/kernel/arch/riscv/per_cpu_tp_spec.spl` | Per-CPU tp Register | 7 | AC-4 |
| `test/02_integration/os/kernel/arch/riscv/hal_smp_cache_integration_spec.spl` | Integration | 10 | AC-1..AC-5 |
