...
- `doc/01_research/statistics_library.md` - Research findings
- `doc/03_plan/statistics_library_implementation.md` - Implementation plan
- `doc/07_guide/quick_reference/custom_blocks_quick_reference.md` - Custom block API quick reference
