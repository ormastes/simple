...
test -f test/03_system/app/compiler/feature/simple_optimization_plugin_spec.md
...
```bash
bin/simple test test/01_unit/compiler/mir_opt/cipher/pattern_engine_spec.spl --mode=interpreter
bin/simple test test/01_unit/compiler/interpreter/tiered_jit_hotspot_spec.spl --mode=interpreter
...
- JIT hotspot system test: `test/03_system/app/compiler/feature/optimization_plugin_jit_hotspot_system_spec.spl`
