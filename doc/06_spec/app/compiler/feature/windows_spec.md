...
| Field | Value |
|-------|-------|
| Gate spec | `test/03_system/wm_compare/golden_gate_spec.spl` |
| Gate runner | `src/app/wm_compare/golden_gate.spl` |
| Goldens | `test/03_system/wm_compare/goldens/<scene>.ppm` |
...
```bash
REGEN_GOLDENS=1 bin/simple test test/03_system/wm_compare/golden_gate_spec.spl
```
