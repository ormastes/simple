...
## Language Features (`test/feature/usage/` → `doc/06_spec/app/compiler/feature/usage/`)
...
## Application (`test/feature/app/` → `doc/06_spec/app/compiler/feature/app/`)
...
## Compiler (`test/feature/compiler/` → `doc/06_spec/app/compiler/feature/compiler/`)
...
## Developer Tools / DAP (`test/feature/dap/` → `doc/06_spec/app/compiler/feature/dap/`)
...
## Runtime / Interpreter (`test/feature/interpreter/` → `doc/06_spec/app/compiler/feature/interpreter/`)
...
## Baremetal (`test/feature/baremetal/` → `doc/06_spec/app/compiler/feature/baremetal/`)
...
## Standard Library (`test/feature/lib/` → `doc/06_spec/app/compiler/feature/lib/`)
...
## I/O (`test/feature/io/` → `doc/06_spec/app/compiler/feature/io/`)
...
## Platform (`test/feature/platform/` → `doc/06_spec/app/compiler/feature/platform/`)
...
## Tooling / Watcher (`test/feature/watcher/` → `doc/06_spec/app/compiler/feature/watcher/`)
