...
> **Core tier**: The Simple-in-Simple compiler (`src/compiler/`). The unified compiler
> with numbered layers for self-hosting.

*Generated by `bin/simple grammar-doc` from `doc/06_spec/app/compiler/modules/grammar/tier_keywords.sdn`.*
