...
See `simple/std_lib/test/01_unit/ml/torch/` and `simple/std_lib/test/02_integration/ml/`.
...
- **Implementation Report:** `doc/09_report/SIMPLE_MATH_PHASE6_COMPLETE_2025-12-28.md`
