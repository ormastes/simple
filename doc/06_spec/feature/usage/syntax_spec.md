...
| 3 | [syntax_overview_3](#syntax_overview_3) | Syntax Overview | `syntax_overview`, `overview`, `SyntaxOverview` +4 |
| 4 | [syntax_overview_4](#syntax_overview_4) | Syntax Overview | `syntax_overview`, `overview`, `SyntaxOverview` +8 |
...
| 7 | [literals_7](#literals_7) | Literals | `Literals`, `literals`, `f32` +2 |
| 8 | [literals_8](#literals_8) | Literals | `Literals`, `literals`, `assert_compiles` +8 |
| 9 | [string_literals_9](#string_literals_9) | String Literals | `string_literals`, `string`, `Literals` +7 |
| 10 | [string_literals_10](#string_literals_10) | String Literals | `string_literals`, `string`, `Literals` +7 |
| 11 | [string_literals_11](#string_literals_11) | String Literals | `string_literals`, `string`, `Literals` +6 |
| 12 | [string_literals_12](#string_literals_12) | String Literals | `string_literals`, `string`, `Literals` +10 |
| 13 | [string_literals_13](#string_literals_13) | String Literals | `string_literals`, `string`, `Literals` +7 |
| 14 | [operators_14](#operators_14) | Operators | `operators`, `Operators`, `done` +7 |
| 15 | [functional_update_syntax___15](#functional_update_syntax___15) | Functional Update Syntax (`->`) | `Functional`, `FunctionalUpdateSyntax`, `functional` +10 |
| 16 | [functional_update_syntax___16](#functional_update_syntax___16) | Functional Update Syntax (`->`) | `Functional`, `FunctionalUpdateSyntax`, `functional` +9 |
| 17 | [functional_update_syntax___17](#functional_update_syntax___17) | Functional Update Syntax (`->`) | `Functional`, `FunctionalUpdateSyntax`, `functional` +9 |
| 18 | [functional_update_syntax___18](#functional_update_syntax___18) | Functional Update Syntax (`->`) | `Functional`, `FunctionalUpdateSyntax`, `functional` +11 |
| 19 | [functional_update_syntax___19](#functional_update_syntax___19) | Functional Update Syntax (`->`) | `Functional`, `FunctionalUpdateSyntax`, `functional` +11 |
| 20 | [parsing_design_rationale_20](#parsing_design_rationale_20) | Parsing Design Rationale | `design`, `Design`, `Rationale` +11 |
| 21 | [parsing_design_rationale_21](#parsing_design_rationale_21) | Parsing Design Rationale | `design`, `Design`, `Rationale` +8 |
...
**View full specification:** [syntax_spec.spl](../../test/03_system/feature/usage/syntax_spec.spl)
