...
<!-- sdn-diagram:id=http_baremetal_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=http_baremetal_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=http_baremetal_spec.arch hash=sha256:auto
...
1. expect script default mode remains http gate
...
1. expect script has http only boundary
...
1. expect script has deferred boundary
