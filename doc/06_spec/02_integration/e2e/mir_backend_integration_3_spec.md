...
<!-- sdn-diagram:id=mir_backend_integration_3_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=mir_backend_integration_3_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

mir_backend_integration_3_spec -> std
```
...
```ascii generated-from=mir_backend_integration_3_spec.arch hash=sha256:auto
