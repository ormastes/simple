...
<!-- sdn-diagram:id=package_publish_integration_1_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=package_publish_integration_1_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

package_publish_integration_1_spec -> std
```
...
```ascii generated-from=package_publish_integration_1_spec.arch hash=sha256:auto
