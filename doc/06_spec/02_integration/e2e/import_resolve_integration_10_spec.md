...
<!-- sdn-diagram:id=import_resolve_integration_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=import_resolve_integration_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

import_resolve_integration_10_spec -> std
```
...
```ascii generated-from=import_resolve_integration_10_spec.arch hash=sha256:auto
