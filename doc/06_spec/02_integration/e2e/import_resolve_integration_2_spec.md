...
<!-- sdn-diagram:id=import_resolve_integration_2_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=import_resolve_integration_2_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

import_resolve_integration_2_spec -> std
```
...
```ascii generated-from=import_resolve_integration_2_spec.arch hash=sha256:auto
