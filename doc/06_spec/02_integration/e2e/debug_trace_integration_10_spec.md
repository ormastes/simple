...
<!-- sdn-diagram:id=debug_trace_integration_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=debug_trace_integration_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

debug_trace_integration_10_spec -> std
```
...
```ascii generated-from=debug_trace_integration_10_spec.arch hash=sha256:auto
