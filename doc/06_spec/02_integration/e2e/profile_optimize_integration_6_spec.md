...
<!-- sdn-diagram:id=profile_optimize_integration_6_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=profile_optimize_integration_6_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

profile_optimize_integration_6_spec -> std
```
...
```ascii generated-from=profile_optimize_integration_6_spec.arch hash=sha256:auto
