...
<!-- sdn-diagram:id=lint_fix_integration_10_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lint_fix_integration_10_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lint_fix_integration_10_spec -> std
```
...
```ascii generated-from=lint_fix_integration_10_spec.arch hash=sha256:auto
