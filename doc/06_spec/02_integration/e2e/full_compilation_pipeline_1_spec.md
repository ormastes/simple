...
<!-- sdn-diagram:id=full_compilation_pipeline_1_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=full_compilation_pipeline_1_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

full_compilation_pipeline_1_spec -> std
```
...
```ascii generated-from=full_compilation_pipeline_1_spec.arch hash=sha256:auto
