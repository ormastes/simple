...
<!-- sdn-diagram:id=parser_ast_integration_2_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=parser_ast_integration_2_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

parser_ast_integration_2_spec -> std
```
...
```ascii generated-from=parser_ast_integration_2_spec.arch hash=sha256:auto
