...
<!-- sdn-diagram:id=package_publish_integration_9_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=package_publish_integration_9_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

package_publish_integration_9_spec -> std
```
...
```ascii generated-from=package_publish_integration_9_spec.arch hash=sha256:auto
