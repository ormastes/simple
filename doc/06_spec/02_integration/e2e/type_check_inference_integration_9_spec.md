...
<!-- sdn-diagram:id=type_check_inference_integration_9_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=type_check_inference_integration_9_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

type_check_inference_integration_9_spec -> std
```
...
```ascii generated-from=type_check_inference_integration_9_spec.arch hash=sha256:auto
