...
<!-- sdn-diagram:id=scv_storage_safety_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=scv_storage_safety_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

scv_storage_safety_spec -> app
```
...
```ascii generated-from=scv_storage_safety_spec.arch hash=sha256:auto
