...
step("prints the node tree, counts, materials and bounds for a valid scene")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects an SDN file that is not a scene, without crashing")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects a scene with an unsupported node shape, naming the node")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("fails with exit 1 when the scene file does not exist")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 when render is missing --out")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 on out-of-range render dimensions")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 on a malformed camera override")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("renders the scene to a PPM with exact header and pixel colors")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("renders the same scene byte-identically twice")
...
- Canonical SPipe generation for source `a5e326e17e334f898f8ec242bf077e0f604c675899468081093ba8711e0aafb9`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `a5e326e17e334f898f8ec242bf077e0f604c675899468081093ba8711e0aafb9`.
...
source: test/02_integration/app/model3d/model3d_cli_spec.spl
mirror: doc/06_spec/02_integration/app/model3d/model3d_cli_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/02_integration/app/model3d/model3d_cli_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/02_integration/app/model3d/model3d_cli_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/02_integration/app/model3d/model3d_cli_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 10 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/02_integration/app/model3d/model3d_cli_spec.spl:69:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'prints the node tree, counts, materials and bounds for a valid scene' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/model3d/model3d_cli_spec.spl:90:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects an SDN file that is not a scene, without crashing' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/model3d/model3d_cli_spec.spl:98:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects a scene with an unsupported node shape, naming the node' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
