...
step("packs 2 fixture PNGs into one atlas.png with pixel-exact rects")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("is byte-identical across two pack runs over the same inputs")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects a directory containing a non-PNG file with a path-qualified error, exit 1")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("rejects a missing input path, exit 1")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 when --out is missing")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 when --manifest is missing")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 when no input is given")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("exits 2 on an unknown option")
...
- Canonical SPipe generation for source `a9a93c2cddc4e44f02dfee8eaa0fae0b4f66dcdccf254c5be1490942f40f19b4`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `a9a93c2cddc4e44f02dfee8eaa0fae0b4f66dcdccf254c5be1490942f40f19b4`.
...
source: test/02_integration/app/spritesheet/spritesheet_cli_spec.spl
mirror: doc/06_spec/02_integration/app/spritesheet/spritesheet_cli_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/02_integration/app/spritesheet/spritesheet_cli_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/02_integration/app/spritesheet/spritesheet_cli_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/02_integration/app/spritesheet/spritesheet_cli_spec.spl:94:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'packs 2 fixture PNGs into one atlas.png with pixel-exact rects' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/spritesheet/spritesheet_cli_spec.spl:137:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'is byte-identical across two pack runs over the same inputs' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/spritesheet/spritesheet_cli_spec.spl:159:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects a directory containing a non-PNG file with a path-qualified error, exit 1' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
