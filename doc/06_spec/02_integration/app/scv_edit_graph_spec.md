...
| Status | Active |
| Source | `test/02_integration/app/scv_edit_graph_spec.spl` |
| Updated | 2026-08-26 |
...
step("splits a change into anchored hunks with old/new ranges")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("links hunks to entities and entities to the inferred refactoring op")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("carries a cross-file move as a many-to-many op over both files")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("is exposed as `diff --view graph` over the repository comparison")
val root = _repo("view")
...
- Canonical SPipe generation for source `4d70ed7d448b9bcc7cb8a876e93011871ae9a157f62a632ed42151fe549fb7c8`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `4d70ed7d448b9bcc7cb8a876e93011871ae9a157f62a632ed42151fe549fb7c8`.
...
source: test/02_integration/app/scv_edit_graph_spec.spl
mirror: doc/06_spec/02_integration/app/scv_edit_graph_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/02_integration/app/scv_edit_graph_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/02_integration/app/scv_edit_graph_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/02_integration/app/scv_edit_graph_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 9 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/02_integration/app/scv_edit_graph_spec.spl:36:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'splits a change into anchored hunks with old/new ranges' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/scv_edit_graph_spec.spl:55:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'links hunks to entities and entities to the inferred refactoring op' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/scv_edit_graph_spec.spl:72:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'carries a cross-file move as a many-to-many op over both files' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
