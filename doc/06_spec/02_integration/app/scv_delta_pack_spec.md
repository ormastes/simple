...
<!-- sdn-diagram:id=scv_delta_pack_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=scv_delta_pack_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

scv_delta_pack_spec -> app
```
...
```ascii generated-from=scv_delta_pack_spec.arch hash=sha256:auto
