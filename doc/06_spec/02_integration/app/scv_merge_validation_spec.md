...
| Status | Active |
| Source | `test/02_integration/app/scv_merge_validation_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `6bde9c18c0cb475559a52a30b55bc594b1e4d98148937909bbbff6da5decf5f8`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `6bde9c18c0cb475559a52a30b55bc594b1e4d98148937909bbbff6da5decf5f8`.
...
source: test/02_integration/app/scv_merge_validation_spec.spl
mirror: doc/06_spec/02_integration/app/scv_merge_validation_spec.md (current)
findings: 8 blockers: 0
  narrative=100 structure=60 oracle=90
  traceability=100 evidence=90 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/02_integration/app/scv_merge_validation_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/02_integration/app/scv_merge_validation_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, evidence, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/02_integration/app/scv_merge_validation_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-10): 1 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/02_integration/app/scv_merge_validation_spec.spl:34:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'declares the six rungs in order' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
test/02_integration/app/scv_merge_validation_spec.spl:47:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'runs the always-available rungs on real text' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
test/02_integration/app/scv_merge_validation_spec.spl:58:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'never claims clean when compile/tests are unavailable — the claim downgrades, honestly labeled' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/scv_merge_validation_spec.spl:72:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'claims clean only when every rung passes, and rejects on any failed rung' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
test/02_integration/app/scv_merge_validation_spec.spl:87:1: warning SSDOC-BEH-001 [structure] (-10): scenario 'acceptance gate for aggressive merge stages passes good text and rejects imbalance and duplicates' has no visible step flow
  why: Ordered visible actions make the manual operable.
  improve: Add ordered step("...") calls for meaningful actions.
