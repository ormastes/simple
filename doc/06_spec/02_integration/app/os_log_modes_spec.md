# Os Log Modes Specification

> <details>

<!-- sdn-diagram:id=os_log_modes_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=os_log_modes_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

os_log_modes_spec -> std
```
...
```ascii generated-from=os_log_modes_spec.arch hash=sha256:auto
