# Task Daemon Log Modes Specification

> <details>

<!-- sdn-diagram:id=task_daemon_log_modes_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=task_daemon_log_modes_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

task_daemon_log_modes_spec -> std
```
...
```ascii generated-from=task_daemon_log_modes_spec.arch hash=sha256:auto
