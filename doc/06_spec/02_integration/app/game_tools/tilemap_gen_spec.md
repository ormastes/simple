...
step("reaches a fixpoint: extra iteration changes 0 cells")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("has no isolated single-cell wall or floor")
step("Generate the pinned reference cave")
val cave = ca_generate(SEED, COLS, ROWS, FILL_PROB, MAX_ITERS)
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("keeps all floor reachable")
step("Generate the pinned reference cave")
val cave = ca_generate(SEED, COLS, ROWS, FILL_PROB, MAX_ITERS)
...
- Canonical SPipe generation for source `74b1b10c0b9dc09b492a6afaed658e63f010265f4a7251c2f4ba269abaea82b3`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `74b1b10c0b9dc09b492a6afaed658e63f010265f4a7251c2f4ba269abaea82b3`.
...
source: test/02_integration/app/game_tools/tilemap_gen_spec.spl
mirror: doc/06_spec/02_integration/app/game_tools/tilemap_gen_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/02_integration/app/game_tools/tilemap_gen_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/02_integration/app/game_tools/tilemap_gen_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/02_integration/app/game_tools/tilemap_gen_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 5 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/02_integration/app/game_tools/tilemap_gen_spec.spl:98:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'reaches a fixpoint: extra iteration changes 0 cells' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/game_tools/tilemap_gen_spec.spl:108:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'has no isolated single-cell wall or floor' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/game_tools/tilemap_gen_spec.spl:117:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'keeps all floor reachable' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
