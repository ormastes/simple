...
- Simple Script creates the initial DOM/CSS frame, then JavaScript
  `requestAnimationFrame` mutates the DOM and Engine2D renders a distinct frame.
...
Requirement trace: REQ-WEB-BROWSER-003, REQ-WEB-BROWSER-006,
REQ-WEB-BROWSER-017.
