...
<!-- sdn-diagram:id=types_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=types_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

types_system_spec -> std
```
...
```ascii generated-from=types_system_spec.arch hash=sha256:auto
