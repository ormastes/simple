...
<!-- sdn-diagram:id=import_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=import_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

import_system_spec -> std
```
...
```ascii generated-from=import_system_spec.arch hash=sha256:auto
