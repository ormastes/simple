...
<!-- sdn-diagram:id=type_checker_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=type_checker_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

type_checker_system_spec -> std
```
...
```ascii generated-from=type_checker_system_spec.arch hash=sha256:auto
