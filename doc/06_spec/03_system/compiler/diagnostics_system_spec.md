...
<!-- sdn-diagram:id=diagnostics_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=diagnostics_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

diagnostics_system_spec -> std
```
...
```ascii generated-from=diagnostics_system_spec.arch hash=sha256:auto
