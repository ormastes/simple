...
<!-- sdn-diagram:id=symbol_table_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=symbol_table_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

symbol_table_system_spec -> std
```
...
```ascii generated-from=symbol_table_system_spec.arch hash=sha256:auto
