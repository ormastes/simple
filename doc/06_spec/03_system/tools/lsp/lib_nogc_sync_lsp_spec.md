...
<!-- sdn-diagram:id=lib_nogc_sync_lsp_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lib_nogc_sync_lsp_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lib_nogc_sync_lsp_spec
```
...
```ascii generated-from=lib_nogc_sync_lsp_spec.arch hash=sha256:auto
