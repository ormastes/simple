...
<!-- sdn-diagram:id=compiler_00_15_lsp_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compiler_00_15_lsp_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compiler_00_15_lsp_spec -> app
```
...
```ascii generated-from=compiler_00_15_lsp_spec.arch hash=sha256:auto
