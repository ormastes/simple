...
<!-- sdn-diagram:id=mcp_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=mcp_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=mcp_system_spec.arch hash=sha256:auto
