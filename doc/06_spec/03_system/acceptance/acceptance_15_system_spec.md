...
<!-- sdn-diagram:id=acceptance_15_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=acceptance_15_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

acceptance_15_system_spec -> std
```
...
```ascii generated-from=acceptance_15_system_spec.arch hash=sha256:auto
