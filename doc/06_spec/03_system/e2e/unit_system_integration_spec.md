...
step("AC-8: `speed(60_kmph)` returns text containing '60 kmph'")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("AC-8: 100_km / 2_h flows into speed() and renders '50 kmph'")
val d = 100_km
val t = 2_h
val v: kmph = d / t
val out = speed(v)
...
```simple
# @req REQ-SSPEC-SYSTEM
step("AC-8: sample compiles and runs under the Rust seed")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("AC-8: sample compiles and runs under the self-hosted compiler")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("AC-8: both compilers produce the same rendered output")
val rust_seed   = "src/compiler_rust/target/bootstrap/simple"
val self_hosted = "bin/simple"
...
- Canonical SPipe generation for source `78be8fd4c60761aef3940017b2c36dee06b0245bae85e12cc78177b59a882ded`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `78be8fd4c60761aef3940017b2c36dee06b0245bae85e12cc78177b59a882ded`.
...
source: test/03_system/e2e/unit_system_integration_spec.spl
mirror: doc/06_spec/03_system/e2e/unit_system_integration_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/e2e/unit_system_integration_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/e2e/unit_system_integration_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/e2e/unit_system_integration_spec.spl:37:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'AC-8: `speed(60_kmph)` returns text containing '60 kmph'' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/e2e/unit_system_integration_spec.spl:43:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'AC-8: 100_km / 2_h flows into speed() and renders '50 kmph'' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/e2e/unit_system_integration_spec.spl:95:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'AC-8: sample compiles and runs under the Rust seed' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
