...
<!-- sdn-diagram:id=e2e_16_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=e2e_16_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

e2e_16_system_spec -> std
```
...
```ascii generated-from=e2e_16_system_spec.arch hash=sha256:auto
