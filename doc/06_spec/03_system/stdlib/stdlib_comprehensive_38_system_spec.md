...
<!-- sdn-diagram:id=stdlib_comprehensive_38_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stdlib_comprehensive_38_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stdlib_comprehensive_38_system_spec -> std
```
...
```ascii generated-from=stdlib_comprehensive_38_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/stdlib/stdlib_comprehensive_38_system_spec.spl` |
| Updated | 2026-06-01 |
