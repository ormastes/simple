...
<!-- sdn-diagram:id=batch_9_test_36_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=batch_9_test_36_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

batch_9_test_36_system_spec -> std
```
...
```ascii generated-from=batch_9_test_36_system_spec.arch hash=sha256:auto
