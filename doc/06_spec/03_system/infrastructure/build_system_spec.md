...
<!-- sdn-diagram:id=build_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=build_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

build_system_spec -> std
```
...
```ascii generated-from=build_system_spec.arch hash=sha256:auto
