...
<!-- sdn-diagram:id=profiling_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=profiling_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

profiling_system_spec -> std
```
...
```ascii generated-from=profiling_system_spec.arch hash=sha256:auto
