...
<!-- sdn-diagram:id=debugging_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=debugging_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

debugging_system_spec -> std
```
...
```ascii generated-from=debugging_system_spec.arch hash=sha256:auto
