...
<!-- sdn-diagram:id=sanity_13_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=sanity_13_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

sanity_13_system_spec -> std
```
...
```ascii generated-from=sanity_13_system_spec.arch hash=sha256:auto
