...
<!-- sdn-diagram:id=sanity_20_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=sanity_20_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

sanity_20_system_spec -> std
```
...
```ascii generated-from=sanity_20_system_spec.arch hash=sha256:auto
