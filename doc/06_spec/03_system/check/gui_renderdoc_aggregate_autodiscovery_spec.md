...
step("uses current refresh evidence dirs by default")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("uses current production parity refresh evidence by default")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("prefers newer canonical showcase rows over stale current refresh rows")
...
- Canonical SPipe generation for source `87b9248c86b13e9542f172945093746024553e786036cb30004e2d2955d0bad2`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `87b9248c86b13e9542f172945093746024553e786036cb30004e2d2955d0bad2`.
...
source: test/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.spl
mirror: doc/06_spec/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 6 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.spl:57:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'uses current refresh evidence dirs by default' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.spl:81:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'uses current production parity refresh evidence by default' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/gui_renderdoc_aggregate_autodiscovery_spec.spl:106:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'prefers newer canonical showcase rows over stale current refresh rows' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
