...
```simple
# @req REQ-SSPEC-SYSTEM
step("launches the bundled MDI smoke entry for live renderer proof")
val script = file_read("scripts/check/check-tauri-ios-mobile-renderer-evidence.shs")
...
- rejects explicit Rust seed before iOS renderer platform work
   ...
   - Expected: dev_code equals `0`
   - Expected: stream_code equals `0`
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects explicit Rust seed before iOS renderer platform work")
...
- `REQ-SSPEC-SYSTEM`
- `REQ-TAURI-IOS-RENDERER-BIN-001:`
- `REQ-TAURI-IOS-RENDERER-BIN-002:`
- `REQ-TAURI-IOS-RENDERER-BIN-003:`
- `REQ-TAURI-IOS-RENDERER-BIN-004:`
<!-- sspec-maintain:traceability:end -->

<!-- sspec-maintain:provenance:start -->
## Generation history

- Canonical SPipe generation for source `f07bb027891ea3f593b1fd948d25f68a8ca5af2cf22a5db035061db0da7cf23c`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `f07bb027891ea3f593b1fd948d25f68a8ca5af2cf22a5db035061db0da7cf23c`.
...
source: test/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.spl
mirror: doc/06_spec/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=80 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 3 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.spl:71:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'selects self hosted Simple and records launcher provenance' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/tauri_ios_mobile_renderer_simple_bin_spec.spl:107:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects explicit Rust seed before iOS renderer platform work' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
