...
step("documents aggregate consumption of produced retained perf env files")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("includes Simple Web and retained 8K render sources in perf freshness fingerprints")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained perf rows that point at missing native artifacts")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained perf rows whose explicit native artifact pass claims contradict the file bytes")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects stale 4K and 8K retained perf rows when strict source freshness is required")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained 4K perf rows with zero frame timing")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained 8K perf rows with nonnumeric readback checksum")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained perf rows whose explicit readback mode is not ARGB checksum")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained perf rows with missing producer readback mode")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained 4K and 8K perf rows whose native alias sources still use raw rt calls")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained 4K and 8K perf rows produced by the Rust seed binary")
...
- Canonical SPipe generation for source `d25f2cc71bddb2d6ecd1952fa6fb3009222575531baf02f9e8ff13064acf2837`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `d25f2cc71bddb2d6ecd1952fa6fb3009222575531baf02f9e8ff13064acf2837`.
...
source: test/03_system/check/gui_retained_perf_source_freshness_spec.spl
mirror: doc/06_spec/03_system/check/gui_retained_perf_source_freshness_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/check/gui_retained_perf_source_freshness_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/check/gui_retained_perf_source_freshness_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/check/gui_retained_perf_source_freshness_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 10 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/03_system/check/gui_retained_perf_source_freshness_spec.spl:125:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'documents aggregate consumption of produced retained perf env files' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/gui_retained_perf_source_freshness_spec.spl:142:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'includes Simple Web and retained 8K render sources in perf freshness fingerprints' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/gui_retained_perf_source_freshness_spec.spl:176:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects retained perf rows that point at missing native artifacts' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
