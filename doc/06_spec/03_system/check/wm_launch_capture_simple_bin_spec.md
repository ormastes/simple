...
- rejects explicit Rust seed before contract specs or child evidence
   ...
   - Expected: contract_code equals `0`
   - Expected: spec_code equals `0`
   - Expected: electron_code equals `0`
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects explicit Rust seed before contract specs or child evidence")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects Electron live smoke pass markers when validator proof provenance fails")
...
- `REQ-SSPEC-SYSTEM`
- `REQ-WM-LAUNCH-CAPTURE-BIN-001:`
- `REQ-WM-LAUNCH-CAPTURE-BIN-002:`
- `REQ-WM-LAUNCH-CAPTURE-BIN-003:`
- `REQ-WM-LAUNCH-CAPTURE-BIN-004:`
- `REQ-WM-LAUNCH-CAPTURE-BIN-005:`
<!-- sspec-maintain:traceability:end -->

<!-- sspec-maintain:provenance:start -->
## Generation history

- Canonical SPipe generation for source `607867bcd690b4ff771aea5e07335f6b9d269590275c0d3c19827c2f77cf63cd`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `607867bcd690b4ff771aea5e07335f6b9d269590275c0d3c19827c2f77cf63cd`.
...
source: test/03_system/check/wm_launch_capture_simple_bin_spec.spl
mirror: doc/06_spec/03_system/check/wm_launch_capture_simple_bin_spec.md (current)
findings: 3 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=100 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/check/wm_launch_capture_simple_bin_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/check/wm_launch_capture_simple_bin_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/check/wm_launch_capture_simple_bin_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 5 unexplained numeric expected value(s)
