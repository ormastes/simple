...
- The platform matrix reports missing/failed platforms for those invalid rows.
...
expect(evidence).to_contain("native_render_log_platform_matrix_missing_platforms=linux-vulkan,windows-d3d12")
