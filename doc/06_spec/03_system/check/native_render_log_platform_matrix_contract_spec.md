...
step("rejects pass rows with missing gate proof or the wrong native API")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("keeps absent platform rows in the missing list only")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects pass rows that omit native RenderDoc artifact capture and debugger proof")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects Windows D3D12 rows whose PIX file-byte proof is missing")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects Windows D3D12 rows that omit structured blocked-gate proof")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects Windows D3D12 rows whose GPU debugger artifact file-status proof is missing")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects macOS Metal rows whose GPU capture artifact file-status proof is missing")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("accepts properly shaped macOS Metal Xcode capture rows in the platform matrix")
...
- Canonical SPipe generation for source `316e73cb84d7428977541a074a694dc50055e2279d6bbec35879714e105e30ec`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `316e73cb84d7428977541a074a694dc50055e2279d6bbec35879714e105e30ec`.
...
source: test/03_system/check/native_render_log_platform_matrix_contract_spec.spl
mirror: doc/06_spec/03_system/check/native_render_log_platform_matrix_contract_spec.md (current)
findings: 3 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=100 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/check/native_render_log_platform_matrix_contract_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/check/native_render_log_platform_matrix_contract_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/check/native_render_log_platform_matrix_contract_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 8 unexplained numeric expected value(s)
