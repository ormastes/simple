...
2. Admit the checked-in 1×1 decoder fixture plus the 1024×1536 synthetic
   Korean table/multi-chart and rotated CJK/log-chart fixtures. Verify decoded
   dimensions and source hashes before any model call. Extract the highlighted
   table while preserving handwriting identity, topology, confidence, and
