...
- Show pending Home preserve commit and retain state on rejection
   ...
   - Expected: rejected_session.history.len() equals `1`
   - Expected: rejected_down.reason equals `chrome-pressed`
   - Expected: rejected_up.callback_count equals `0`
   - Expected: rejected_up.reason equals `home-unconfigured`
   - Expected: busy_home.callback_count equals `0`
...
Runnable source: 234 lines folded for reproduction.
Reproduction: this block contains the complete executable scenario source.

```simple
# @req REQ-SSPEC-SYSTEM
step("should publish only an admitted Home target without committing early")
...
- Canonical SPipe generation for source `a17b7b49425a6d40a6bfda9acc15c4022573ef4797be2c9811620dff9ad8cb9e`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `a17b7b49425a6d40a6bfda9acc15c4022573ef4797be2c9811620dff9ad8cb9e`.
...
doc/06_spec/03_system/app/browser/feature/browser_home_pending_address_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, evidence, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/app/browser/feature/browser_home_pending_address_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 4 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/03_system/app/browser/feature/browser_home_pending_address_spec.spl:80:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should publish only an admitted Home target without committing early' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/03_system/app/browser/feature/browser_home_pending_address_spec.spl:80:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should publish only an admitted Home target without committing early' has no retained capture or evidence
