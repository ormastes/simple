...
Runnable source: 298 lines folded for reproduction.
Reproduction: this block contains the complete executable scenario source.

```simple
# @req REQ-SSPEC-SYSTEM
step("should render live checked state through canonical Draw IR")
...
- Canonical SPipe generation for source `fd7ce457856bd3317390b321d9e9e432eee80b0e407ae8f1c43a92619f554d28`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `fd7ce457856bd3317390b321d9e9e432eee80b0e407ae8f1c43a92619f554d28`.
...
doc/06_spec/03_system/app/browser/feature/browser_checkable_control_rendering_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/app/browser/feature/browser_checkable_control_rendering_spec.spl:1:1: blocker SSDOC-TRC-003 [traceability] (-40): 5 declared requirement(s) have no scenario binding
  why: A requirement list without scenario evidence is inventory, not traceability.
  improve: Bind the stable requirement ID inside its executable scenario or explicit blocked case.
test/03_system/app/browser/feature/browser_checkable_control_rendering_spec.spl:151:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'should render live checked state through canonical Draw IR' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/03_system/app/browser/feature/browser_checkable_control_rendering_spec.spl:151:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'should render live checked state through canonical Draw IR' has no retained capture or evidence
