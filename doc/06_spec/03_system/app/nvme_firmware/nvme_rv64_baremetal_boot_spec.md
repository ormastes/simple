...
step("has an explicit RV64 firmware ELF build recipe")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("boots the RV64 NVMe firmware ELF on QEMU and reports subsystem health")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("boots the RV64 target-core firmware probe on QEMU")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("boots the RV64 target logic firmware probe on QEMU")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("runs the rv64 boot wrapper fail-closed self-test")
...
- Canonical SPipe generation for source `29ddbb32c055c2d8b5e5fac32f5c42a712631953d17278e6a2f5a67285f1ab89`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `29ddbb32c055c2d8b5e5fac32f5c42a712631953d17278e6a2f5a67285f1ab89`.
...
source: test/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.spl
mirror: doc/06_spec/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 23 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.spl:28:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'has an explicit RV64 firmware ELF build recipe' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.spl:74:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'boots the RV64 NVMe firmware ELF on QEMU and reports subsystem health' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/app/nvme_firmware/nvme_rv64_baremetal_boot_spec.spl:101:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'boots the RV64 target-core firmware probe on QEMU' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
