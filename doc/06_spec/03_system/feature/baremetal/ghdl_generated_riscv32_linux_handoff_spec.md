...
<!-- sdn-diagram:id=ghdl_generated_riscv32_linux_handoff_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=ghdl_generated_riscv32_linux_handoff_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

ghdl_generated_riscv32_linux_handoff_spec -> std
```
...
```ascii generated-from=ghdl_generated_riscv32_linux_handoff_spec.arch hash=sha256:auto
...
<details>
<summary>Advanced: runs the generated RV32 Linux handoff smoke program</summary>

#### runs the generated RV32 Linux handoff smoke program _(slow)_
...
expect(result[2]).to_equal(0)
expect(output).to_contain("GENERATED_RV32_LINUX_HANDOFF: PASS")
expect(output).to_contain("PASS_WORD: 42")
expect(output).to_contain("A1_LOW32:")
```
