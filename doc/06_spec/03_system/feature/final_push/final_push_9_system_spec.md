...
<!-- sdn-diagram:id=final_push_9_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=final_push_9_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

final_push_9_system_spec -> std
```
...
```ascii generated-from=final_push_9_system_spec.arch hash=sha256:auto
