...
<!-- sdn-diagram:id=math_blocks_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=math_blocks_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=math_blocks_spec.arch hash=sha256:auto
