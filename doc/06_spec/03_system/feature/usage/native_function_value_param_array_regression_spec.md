...
<!-- sdn-diagram:id=native_function_value_param_array_regression_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=native_function_value_param_array_regression_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

native_function_value_param_array_regression_spec -> std
```
...
```ascii generated-from=native_function_value_param_array_regression_spec.arch hash=sha256:auto
