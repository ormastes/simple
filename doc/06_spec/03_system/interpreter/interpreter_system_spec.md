...
<!-- sdn-diagram:id=interpreter_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=interpreter_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

interpreter_system_spec -> std
```
...
```ascii generated-from=interpreter_system_spec.arch hash=sha256:auto
