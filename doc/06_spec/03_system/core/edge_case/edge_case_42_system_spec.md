...
<!-- sdn-diagram:id=edge_case_42_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=edge_case_42_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

edge_case_42_system_spec -> std
```
...
```ascii generated-from=edge_case_42_system_spec.arch hash=sha256:auto
