...
<!-- sdn-diagram:id=error_path_8_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=error_path_8_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

error_path_8_system_spec -> std
```
...
```ascii generated-from=error_path_8_system_spec.arch hash=sha256:auto
