...
<!-- sdn-diagram:id=regression_14_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=regression_14_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

regression_14_system_spec -> std
```
...
```ascii generated-from=regression_14_system_spec.arch hash=sha256:auto
