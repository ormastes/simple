...
<!-- sdn-diagram:id=compatibility_11_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compatibility_11_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compatibility_11_system_spec -> std
```
...
```ascii generated-from=compatibility_11_system_spec.arch hash=sha256:auto
