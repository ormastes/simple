...
- Observe guest-owned device receipt sequences
   - Artifact capture: after_step
- Require distinct press and release state/frame correlations
   - Artifact capture: after_step
- Correlate handled input with WM state and later framebuffer revisions
   - Artifact capture: after_step
