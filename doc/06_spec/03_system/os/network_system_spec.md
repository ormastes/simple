...
<!-- sdn-diagram:id=network_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=network_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

network_system_spec -> std
```
...
```ascii generated-from=network_system_spec.arch hash=sha256:auto
