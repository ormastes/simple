# Scheduler Cross Qemu Specification

> <details>

<!-- sdn-diagram:id=scheduler_cross_qemu_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=scheduler_cross_qemu_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

scheduler_cross_qemu_spec -> os
```
...
```ascii generated-from=scheduler_cross_qemu_spec.arch hash=sha256:auto
...
<details>
<summary>Advanced: all architectures report task creation</summary>

#### all architectures report task creation _(slow)_
...
| Status | Active |
| Source | `test/03_system/os/qemu/os/scheduler/scheduler_cross_qemu_spec.spl` |
| Updated | 2026-06-01 |
