...
<!-- sdn-diagram:id=filesystem_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=filesystem_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

filesystem_system_spec -> std
```
...
```ascii generated-from=filesystem_system_spec.arch hash=sha256:auto
