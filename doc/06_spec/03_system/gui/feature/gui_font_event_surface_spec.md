...
> Production GUI widget-tree font, Draw IR, framebuffer, and correlated input-event evidence.
...
This scenario proves that one visible GUI widget tree:
...
2. produces a glyph-bearing framebuffer that differs from an otherwise
...
5. **Build the production surface composition**
...
7. **Deliver correlated focus keyboard and pointer events**
...
8. **Capture backend and framebuffer evidence**
...
9. **Prove native submission and device readback**
...
| `build/test-artifacts/03_system/gui/feature/gui_font_event_surface/gui_font_event.txt` | `status=pass`, composition/source/bounds/event targets, and all three paths | BLOCKED |
