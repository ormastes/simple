...
expect(catalog.len()).to_equal(91)
...
expect(_catalog_has("62_flex_column_gap_space_around")).to_equal(true)
expect(_catalog_has("63_flex_wrap_gap_align_content_space_between")).to_equal(true)
expect(_catalog_has("64_flex_wrap_gap_align_content_space_around")).to_equal(true)
expect(_catalog_has("65_flex_wrap_gap_align_content_space_evenly")).to_equal(true)
expect(_catalog_has("66_flex_wrap_gap_align_content_flex_end")).to_equal(true)
expect(_catalog_has("67_flex_wrap_gap_align_content_center")).to_equal(true)
expect(_catalog_has("68_flex_wrap_gap_align_content_stretch")).to_equal(true)
expect(_catalog_has("69_flex_wrap_gap_align_content_flex_start")).to_equal(true)
expect(_catalog_has("70_flex_wrap_gap_align_content_normal")).to_equal(true)
expect(_catalog_has("71_flex_wrap_gap_align_content_end")).to_equal(true)
expect(_catalog_has("72_flex_wrap_gap_align_content_start")).to_equal(true)
expect(_catalog_has("73_flex_wrap_gap_align_content_unsafe_center")).to_equal(true)
expect(_catalog_has("74_flex_gap_justify_unsafe_center")).to_equal(true)
expect(_catalog_has("75_flex_gap_justify_unsafe_center_overflow")).to_equal(true)
expect(_catalog_has("76_flex_gap_justify_unsafe_center_no_shrink_overflow")).to_equal(true)
expect(_catalog_has("77_flex_gap_justify_safe_center_no_shrink_overflow")).to_equal(true)
expect(_catalog_has("78_flex_column_gap_justify_unsafe_center_no_shrink_overflow")).to_equal(true)
expect(_catalog_has("79_flex_column_gap_justify_safe_center_no_shrink_overflow")).to_equal(true)
expect(_catalog_has("80_flex_gap_justify_end")).to_equal(true)
expect(_catalog_has("81_flex_column_gap_justify_end")).to_equal(true)
expect(_catalog_has("82_flex_gap_align_items_end")).to_equal(true)
expect(_catalog_has("83_flex_auto_margin_align_center")).to_equal(true)
...
expect(_catalog_has("88_flex_order_basic")).to_equal(true)
expect(_catalog_has("89_percent_content_box_padding")).to_equal(true)
expect(_catalog_has("90_absolute_inset_stretch")).to_equal(true)
expect(_catalog_has("91_percent_margin_basic")).to_equal(true)
expect(_catalog_has("92_percent_height_definite_parent")).to_equal(true)
expect(_catalog_has("93_flex_percent_height_cross_axis")).to_equal(true)
expect(_catalog_has("94_flex_column_percent_height_main_axis")).to_equal(true)
expect(_catalog_has("95_absolute_percent_height_basic")).to_equal(true)
expect(_catalog_has("96_absolute_percent_height_bottom")).to_equal(true)
```
...
expect(wrapper).to_contain("62_flex_column_gap_space_around")
expect(wrapper).to_contain("63_flex_wrap_gap_align_content_space_between")
expect(wrapper).to_contain("64_flex_wrap_gap_align_content_space_around")
expect(wrapper).to_contain("65_flex_wrap_gap_align_content_space_evenly")
expect(wrapper).to_contain("66_flex_wrap_gap_align_content_flex_end")
expect(wrapper).to_contain("67_flex_wrap_gap_align_content_center")
expect(wrapper).to_contain("68_flex_wrap_gap_align_content_stretch")
expect(wrapper).to_contain("69_flex_wrap_gap_align_content_flex_start")
expect(wrapper).to_contain("70_flex_wrap_gap_align_content_normal")
expect(wrapper).to_contain("71_flex_wrap_gap_align_content_end")
expect(wrapper).to_contain("72_flex_wrap_gap_align_content_start")
expect(wrapper).to_contain("73_flex_wrap_gap_align_content_unsafe_center")
expect(wrapper).to_contain("74_flex_gap_justify_unsafe_center")
expect(wrapper).to_contain("75_flex_gap_justify_unsafe_center_overflow")
expect(wrapper).to_contain("76_flex_gap_justify_unsafe_center_no_shrink_overflow")
expect(wrapper).to_contain("77_flex_gap_justify_safe_center_no_shrink_overflow")
expect(wrapper).to_contain("78_flex_column_gap_justify_unsafe_center_no_shrink_overflow")
expect(wrapper).to_contain("79_flex_column_gap_justify_safe_center_no_shrink_overflow")
expect(wrapper).to_contain("80_flex_gap_justify_end")
expect(wrapper).to_contain("81_flex_column_gap_justify_end")
expect(wrapper).to_contain("82_flex_gap_align_items_end")
expect(wrapper).to_contain("83_flex_auto_margin_align_center")
...
expect(wrapper).to_contain("88_flex_order_basic")
expect(wrapper).to_contain("89_percent_content_box_padding")
expect(wrapper).to_contain("90_absolute_inset_stretch")
expect(wrapper).to_contain("91_percent_margin_basic")
expect(wrapper).to_contain("92_percent_height_definite_parent")
expect(wrapper).to_contain("93_flex_percent_height_cross_axis")
expect(wrapper).to_contain("94_flex_column_percent_height_main_axis")
expect(wrapper).to_contain("95_absolute_percent_height_basic")
expect(wrapper).to_contain("96_absolute_percent_height_bottom")
...
expect(report).to_contain("- fixtures: 93")
expect(report).to_contain("- pass count: 93")
