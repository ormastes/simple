...
- keeps QEMU-side perf as a structured guest release blocker
...
step("keeps QEMU-side perf as a structured guest release blocker")
val run_id = _run_id()
...
- does not promote host GTK timing when live QEMU bitmap evidence passes
   - Expected: code equals `1`
...
```simple
# @req REQ-SSPEC-SYSTEM
step("does not promote host GTK timing when live QEMU bitmap evidence passes")
val run_id = _run_id()
...
- preserves real guest perf marker while QMP remains missing
   - Expected: code equals `1`
...
```simple
# @req REQ-SSPEC-SYSTEM
step("preserves real guest perf marker while QMP remains missing")
val run_id = _run_id()
...
- does not accept forced live guest perf markers by default
   - Expected: code equals `1`
...
```simple
# @req REQ-SSPEC-SYSTEM
step("does not accept forced live guest perf markers by default")
val run_id = _run_id()
...
- does not accept forced live guest perf markers as release evidence
   - Expected: code equals `1`
...
```simple
# @req REQ-SSPEC-SYSTEM
step("does not accept forced live guest perf markers as release evidence")
val run_id = _run_id()
...
- Canonical SPipe generation for source `43ffe4a0257d942b43b5361aae6080503cbb533e44c039c1ef93df1dcee0f95f`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `43ffe4a0257d942b43b5361aae6080503cbb533e44c039c1ef93df1dcee0f95f`.
...
source: test/03_system/gui/qemu_gtk_wm_capture_evidence_spec.spl
mirror: doc/06_spec/03_system/gui/qemu_gtk_wm_capture_evidence_spec.md (current)
findings: 3 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=100 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/gui/qemu_gtk_wm_capture_evidence_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/gui/qemu_gtk_wm_capture_evidence_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/gui/qemu_gtk_wm_capture_evidence_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 5 unexplained numeric expected value(s)
