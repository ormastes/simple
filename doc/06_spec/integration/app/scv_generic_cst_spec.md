...
| Status | Active |
| Source | `test/integration/app/scv_generic_cst_spec.spl` |
| Updated | 2026-08-26 |
...
- the IR names its version
- each kind constructs with the declared kind tag
...
- the document header carries scv/cst/v1
- round-trip: the document node is the serialized root
- a wrong version is rejected
- an unknown node kind is rejected
- a list ordering outside ordered|commutative is rejected
...
- commutative: reordering children keeps the hash
- ordered: reordering children changes the hash
- different content changes a commutative hash too
...
- the root key combines revision and ContentId
- store then load round-trips by the same key
- a different revision of the same content is a distinct root slot
- an invalid document is refused, never stored
...
- Canonical SPipe generation for source `1fa7364cf7c119682b83a779db8c5aa873c14df3c7682ba094b953cc79322fc2`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `1fa7364cf7c119682b83a779db8c5aa873c14df3c7682ba094b953cc79322fc2`.
...
source: test/integration/app/scv_generic_cst_spec.spl
mirror: doc/06_spec/integration/app/scv_generic_cst_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/integration/app/scv_generic_cst_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/integration/app/scv_generic_cst_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/integration/app/scv_generic_cst_spec.spl:31:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'is versioned and exposes every node kind' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/integration/app/scv_generic_cst_spec.spl:52:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'documents carry the version and validate fail-closed' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/integration/app/scv_generic_cst_spec.spl:71:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'commutative lists hash order-insensitively; ordered lists do not' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
