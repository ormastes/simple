...
| Status | Active |
| Source | `test/integration/app/scv_hir_fingerprint_spec.spl` |
| Updated | 2026-08-26 |
...
- the fingerprint format names its version and the digest domain it wraps
- the syntactic interface id equals compile_interface_digest over the same surface built by hand
...
- body-only change: same interface id, different normalized impl hash
- comment/formatting-only change: same interface id AND same impl hash
- signature change: different interface id
- a field type change inside a struct changes the interface id (fields are part of the surface)
...
- the record carries version, syntactic interface id and normalized impl hash
- the guarantee line says what the id proves — declared surface as text, not types
- typed_hir_hash is reported unavailable, never fabricated
   - Expected: rec does not contain `semantic_hash`
...
- Canonical SPipe generation for source `f80609d32ca6178f7b91d3709bed64a07e535f19dec9259dce6fc0729d6157a1`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `f80609d32ca6178f7b91d3709bed64a07e535f19dec9259dce6fc0729d6157a1`.
...
source: test/integration/app/scv_hir_fingerprint_spec.spl
mirror: doc/06_spec/integration/app/scv_hir_fingerprint_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/integration/app/scv_hir_fingerprint_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/integration/app/scv_hir_fingerprint_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/integration/app/scv_hir_fingerprint_spec.spl:40:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'reuses the compiler frontend's canonical compile-interface digest' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/integration/app/scv_hir_fingerprint_spec.spl:50:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'body-only and comment-only changes keep the interface id; a signature change does not' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/integration/app/scv_hir_fingerprint_spec.spl:68:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'states its guarantee: no typed-HIR hash is claimed while the frontend has no extractor' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
