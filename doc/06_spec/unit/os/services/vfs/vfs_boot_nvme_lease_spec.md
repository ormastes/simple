...
- packages the C FAT baseline artifact into the q35 FAT image contract
   - Expected: script contains `SIMPLEOS_CFAT4K_BASELINE`
   - Expected: script contains `build", "os", "perf", "CFAT4K.TXT`
   - Expected: script contains `sys_entries.append(dir_entry("PERF       "`
   - Expected: script contains `perf_entries.append(dir_entry("CFAT4K  TXT"`
   - Expected: script contains `SIMPLEOS_FAT32_DIRECT_IO_4K_FIXTURE`
   - Expected: script contains `perf_entries.append(dir_entry("FAT4K   BIN"`
   - Expected: script contains `spc = 8`
...
- Canonical SPipe generation for source `4be54f2e5170039eb481c5b24005076f8367e6f7aeb79fb486aab915fa04f01a`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `4be54f2e5170039eb481c5b24005076f8367e6f7aeb79fb486aab915fa04f01a`.
...
test/unit/os/services/vfs/vfs_boot_nvme_lease_spec.spl:1:1: blocker SSDOC-ORA-002 [oracle] (-50): scenario relies on source-text inspection as system evidence
