...
| Status | Active |
| Source | `test/unit/lib/common/wine_process_session_thunk_load_bind_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `bc80715def8fd8545a8ba9a306d85a8dfb1331fbb1a1ae8a8bf02ef65f2ccda0`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `bc80715def8fd8545a8ba9a306d85a8dfb1331fbb1a1ae8a8bf02ef65f2ccda0`.
...
source: test/unit/lib/common/wine_process_session_thunk_load_bind_spec.spl
mirror: doc/06_spec/unit/lib/common/wine_process_session_thunk_load_bind_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=80
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/unit/lib/common/wine_process_session_thunk_load_bind_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/unit/lib/common/wine_process_session_thunk_load_bind_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/unit/lib/common/wine_process_session_thunk_load_bind_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-20): 2 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/unit/lib/common/wine_process_session_thunk_load_bind_spec.spl:39:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'requires module-load evidence before planning import thunk patches' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/lib/common/wine_process_session_thunk_load_bind_spec.spl:54:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'propagates load-and-bind rejection before thunk planning' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/lib/common/wine_process_session_thunk_load_bind_spec.spl:63:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'plans import thunk patches only after PEB/TEB VM byte-write readback' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
