...
| Status | Active |
| Source | `test/unit/lib/std/concurrency/concurrency_spec.spl` |
| Updated | 2026-08-26 |
...
- Verify: futures execute in background
   - Expected: future.is_background() is true
   - Expected: future.is_ready() is true
...
expect(future.is_background()).to_equal(true)
expect(future.is_ready()).to_equal(true)
```
...
- Verify: creates thread handle
   - Expected: handle.is_joined() is false
...
expect(handle.is_joined()).to_equal(false)
```
...
- Canonical SPipe generation for source `ac4fe8a0c55545e714293ceb17f88fdf6061c4dbdae7873461c2bd30d4938cbd`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `ac4fe8a0c55545e714293ceb17f88fdf6061c4dbdae7873461c2bd30d4938cbd`.
...
source: test/unit/lib/std/concurrency/concurrency_spec.spl
mirror: doc/06_spec/unit/lib/std/concurrency/concurrency_spec.md (current)
...
doc/06_spec/unit/lib/std/concurrency/concurrency_spec.md:1:1: warning SSDOC-EVD-003 [evidence] (-15): source captures are not rendered as manual evidence
...
doc/06_spec/unit/lib/std/concurrency/concurrency_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/unit/lib/std/concurrency/concurrency_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/unit/lib/std/concurrency/concurrency_spec.spl:238:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'creates and yields single value' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/lib/std/concurrency/concurrency_spec.spl:248:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'yields multiple values in sequence' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/lib/std/concurrency/concurrency_spec.spl:263:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'returns exhausted when finished' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/lib/std/concurrency/concurrency_spec.spl:556:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'can check and await' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/unit/lib/std/concurrency/concurrency_spec.spl:567:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'can configure worker count' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/unit/lib/std/concurrency/concurrency_spec.spl:587:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'can sleep thread' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
test/unit/lib/std/concurrency/concurrency_spec.spl:595:1: advice SSDOC-BEH-002 [structure] (-5): scenario name 'can yield thread' describes the test rather than its outcome
  why: Outcome names describe product behavior rather than test mechanics.
  improve: Rename it to the observable product outcome.
