...
| Source | `test/unit/app/stats/benchmark_ledger_spec.spl` |
| Updated | 2026-08-26 |
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: enum has all five required categories")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: returns BenchmarkStats for memcpy category")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: returns BenchmarkStats for string ops category")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: returns C baseline stats for memcpy")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: computes ratio as c_baseline / pure_simple")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: writes ledger report to specified path")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: ledger contains all five category rows")
...
```simple
# @req REQ-SSPEC-UNIT
step("AC-2: ledger contains ratio column")
...
- Canonical SPipe generation for source `a6840a860a560d9fee6982581cb7ad7108f504099028d6bbce3a3a56362097eb`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `a6840a860a560d9fee6982581cb7ad7108f504099028d6bbce3a3a56362097eb`.
...
source: test/unit/app/stats/benchmark_ledger_spec.spl
mirror: doc/06_spec/unit/app/stats/benchmark_ledger_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/unit/app/stats/benchmark_ledger_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/unit/app/stats/benchmark_ledger_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, evidence, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/unit/app/stats/benchmark_ledger_spec.spl:46:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'AC-2: enum has all five required categories' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/app/stats/benchmark_ledger_spec.spl:60:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'AC-2: returns BenchmarkStats for memcpy category' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/app/stats/benchmark_ledger_spec.spl:69:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'AC-2: returns BenchmarkStats for string ops category' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
