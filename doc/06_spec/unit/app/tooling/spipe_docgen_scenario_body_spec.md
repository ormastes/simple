...
- renders scenario bodies as dedented Simple code fences
   - Expected: structure does not contain `### evaluates addition`
...
expect(structure).to_contain("<summary>Executable SPipe</summary>")
...
> expect(structure).to_contain("<summary>Executable SPipe</summary>")<br>
...
- does not emit a code fence for single-line pass scenarios
   ...
   - Expected: structure does not contain `<summary>Executable SPipe</summary>`
...
expect(structure.contains("<summary>Executable SPipe</summary>")).to_equal(false)
...
```simple
# @req REQ-SSPEC-UNIT
step("renders checker-style calls as readable manual steps")
val source = "describe \"Manual steps\":\n" +
...
- mirrors the source spec folder under the output directory
   - Expected: e equals ``
   - Expected: e equals ``
   - Expected: path equals `/tmp/feature/usage/math_blocks_spec.md`
...
| Category | Application |
| Status | Active |
| Source | `test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `a8acbc7e6197ffb92d7f5591f37d32ce9b8e8468136a6fb6e4b23545e42bc2ef`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `a8acbc7e6197ffb92d7f5591f37d32ce9b8e8468136a6fb6e4b23545e42bc2ef`.
...
source: test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl
mirror: doc/06_spec/unit/app/tooling/spipe_docgen_scenario_body_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/unit/app/tooling/spipe_docgen_scenario_body_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/unit/app/tooling/spipe_docgen_scenario_body_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl:16:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'renders scenario bodies as dedented Simple code fences' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl:39:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'strips leading scenario docstrings from rendered code' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/app/tooling/spipe_docgen_scenario_body_spec.spl:56:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'does not emit a code fence for single-line pass scenarios' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
