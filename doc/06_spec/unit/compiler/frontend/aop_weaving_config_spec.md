...
Source: `test/unit/compiler/frontend/aop_weaving_config_spec.spl`
...
```bash
bin/release/x86_64-unknown-linux-gnu/simple test test/unit/compiler/frontend/aop_weaving_config_spec.spl --mode=interpreter --no-cover-check
```
