...
Source: `test/unit/compiler/frontend/aop_log_policy_spec.spl`
...
```bash
bin/release/x86_64-unknown-linux-gnu/simple test test/unit/compiler/frontend/aop_log_policy_spec.spl --mode=interpreter --no-cover-check
```
