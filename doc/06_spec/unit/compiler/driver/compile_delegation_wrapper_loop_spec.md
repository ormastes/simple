...
test/unit/compiler/driver/compile_delegation_wrapper_loop_spec.spl:70:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'blocks spawning the bin/release/simple wrapper from a deployed release runtime with no marker set' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/compiler/driver/compile_delegation_wrapper_loop_spec.spl:84:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'blocks the wrapper by absolute path and from bootstrap-stage binaries too' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/compiler/driver/compile_delegation_wrapper_loop_spec.spl:94:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'still allows genuinely external binaries and unknown identities' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
