...
Source: `test/unit/compiler/mir/aop_injection_spec.spl`
...
```bash
bin/release/x86_64-unknown-linux-gnu/simple test test/unit/compiler/mir/aop_injection_spec.spl --mode=interpreter --no-cover-check
```
