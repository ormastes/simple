...
<!-- sdn-diagram:id=recursive_depth_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=recursive_depth_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

recursive_depth_small_spec -> std
```
...
```ascii generated-from=recursive_depth_small_spec.arch hash=sha256:auto
