...
<!-- sdn-diagram:id=cpu_stress_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=cpu_stress_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

cpu_stress_small_spec -> std
```
...
```ascii generated-from=cpu_stress_small_spec.arch hash=sha256:auto
