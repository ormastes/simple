...
<!-- sdn-diagram:id=deep_nesting_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=deep_nesting_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

deep_nesting_small_spec -> std
```
...
```ascii generated-from=deep_nesting_small_spec.arch hash=sha256:auto
