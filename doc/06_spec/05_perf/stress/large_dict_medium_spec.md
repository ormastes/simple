...
<!-- sdn-diagram:id=large_dict_medium_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=large_dict_medium_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

large_dict_medium_spec -> std
```
...
```ascii generated-from=large_dict_medium_spec.arch hash=sha256:auto
