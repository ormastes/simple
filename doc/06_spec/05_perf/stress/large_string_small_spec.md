...
<!-- sdn-diagram:id=large_string_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=large_string_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

large_string_small_spec -> std
```
...
```ascii generated-from=large_string_small_spec.arch hash=sha256:auto
