...
<!-- sdn-diagram:id=wm_pixel_pipeline_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=wm_pixel_pipeline_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

wm_pixel_pipeline_spec -> std
wm_pixel_pipeline_spec -> os
```
...
```ascii generated-from=wm_pixel_pipeline_spec.arch hash=sha256:auto
