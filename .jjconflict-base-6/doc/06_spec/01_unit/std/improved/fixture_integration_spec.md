...
<!-- sdn-diagram:id=fixture_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=fixture_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

fixture_integration_spec -> std
```
...
```ascii generated-from=fixture_integration_spec.arch hash=sha256:auto
