...
<!-- sdn-diagram:id=linux_smf_dynlib_e2e_gate_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=linux_smf_dynlib_e2e_gate_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

linux_smf_dynlib_e2e_gate_spec -> std
linux_smf_dynlib_e2e_gate_spec -> app
```
...
```ascii generated-from=linux_smf_dynlib_e2e_gate_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/app/gui_perf/linux_smf_dynlib_e2e_gate_spec.spl` |
| Updated | 2026-06-01 |
