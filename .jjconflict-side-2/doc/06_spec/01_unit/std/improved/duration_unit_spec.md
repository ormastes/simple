...
<!-- sdn-diagram:id=duration_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=duration_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

duration_unit_spec -> std
```
...
```ascii generated-from=duration_unit_spec.arch hash=sha256:auto
