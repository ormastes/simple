...
<!-- sdn-diagram:id=encode_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=encode_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

encode_integration_spec -> std
```
...
```ascii generated-from=encode_integration_spec.arch hash=sha256:auto
