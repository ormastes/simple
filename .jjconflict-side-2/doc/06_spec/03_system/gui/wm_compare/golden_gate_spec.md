...
<!-- sdn-diagram:id=golden_gate_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=golden_gate_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

golden_gate_spec -> std
golden_gate_spec -> app
```
...
```ascii generated-from=golden_gate_spec.arch hash=sha256:auto
