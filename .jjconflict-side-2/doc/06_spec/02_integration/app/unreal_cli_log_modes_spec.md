# Unreal Cli Log Modes Specification

> <details>

<!-- sdn-diagram:id=unreal_cli_log_modes_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=unreal_cli_log_modes_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

unreal_cli_log_modes_spec -> std
```
...
```ascii generated-from=unreal_cli_log_modes_spec.arch hash=sha256:auto
