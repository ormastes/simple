...
**Hardware subset rules** (full reference: `doc/04_architecture/hardware/vhdl/vhdl_hardware_subset_contract.md`):
...
See `doc/07_guide/hardware/riscv/simple_generated_fpga_rtl.md` for bundle details.
...
| `doc/07_guide/hardware/riscv/simple_generated_fpga_rtl.md` | FPGA bundle generation |
| `doc/07_guide/hardware/fpga/xilinx_fpga_board_bringup.md` | Board bringup workflow |
| `doc/04_architecture/hardware/vhdl/vhdl_hardware_subset_contract.md` | Full hardware subset spec |
| `doc/04_architecture/hardware/riscv/riscv_architecture.md` | RISC-V system architecture |
