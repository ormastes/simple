...
- linux GUI/web queue integration reason: same-frame BrowserBackend queue, Draw IR dispatch, BrowserBackend device readback receipt, host-native metal readback proof, Engine2D readback proof predicate, and compiler HostGpuLane cleanup probes proven
- legacy compatibility status key: production_gui_web_host_gpu_queue_readback_status=pass
- legacy compatibility reason key: production_gui_web_host_gpu_queue_readback_reason=same-frame BrowserBackend queue, Draw IR dispatch, BrowserBackend device readback receipt, host-native metal readback proof, Engine2D readback proof predicate, and compiler HostGpuLane cleanup probes proven
...
- report_path: doc/09_report/production_gui_web_host_gpu_queue_readback_2026-07-11.md
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| vulkan | fail | fail | n/a | n/a | false | 240 | evidence-program-failed | build/production_gui_web_host_gpu_queue_readback/vulkan/report.md |
| cuda | unavailable | host-unavailable | false | false | false | 240 | missing-verified-ptx | build/production_gui_web_host_gpu_queue_readback/cuda/report.md |
| opencl | unavailable | unavailable | false | false | false | 240 | missing-opencl-runtime-loader | build/production_gui_web_host_gpu_queue_readback/opencl/report.md |
| metal | pass | pass | true | true | false | 240 | gpu-readback-verified | build/production_gui_web_host_gpu_queue_readback/metal/report.md |
...
| --- | --- | --- | --- | --- |
| linux_gui_web | pass | pass | same-frame Vulkan BrowserBackend device_readback plus event/queue correlation | event=browser-input-1; packet=1; source=device_readback; checksum=1353595249 |
...
- BrowserBackend runtime queue handle/payload/perf: pass (backend vulkan, first_render_us 107307, first_under_budget true, second_render_us 126, second_under_budget true, pixels 3072, checksum 1344191869, nonuniform 2240, handle 7, packet 1, payload_size 12288, payload_hash 1353595249, payload_text web-render-frame;backend=vulkan;pixels=3072;checksum=1353595249, dispatch dispatched, dispatch_payload_size 512, dispatch_layout_commands 8, dispatch_payload_hash 941781836, dispatch_payload_text draw_ir schema=simple-draw-ir-v2, semantic rect/text/image 4/3/1, gui_ast true, widgets root/copy/action/image true/true/true/true, image_uri true, event_context true/browser-frame-16/gui_ast, cache reset not_requested/0).
- Same-frame GUI/web Engine2D pixel readback receipt: pass (backend vulkan, pixels 3072, checksum 1353595249, reason same-frame Engine2D read_pixels, cache reset not_requested).
- Same-frame Vulkan/BrowserBackend device readback receipt: pass (source device_readback; only device_readback is accepted as device proof. BrowserBackend backend handle 7, same-frame checksum 1353595249, Vulkan Engine2D child readback fail).
- Browser input event to queued frame/readback correlation: pass (status event_frame_readback_correlated, event browser-input-1, summary event=browser-input-1;frame_packet=1;readback_source=device_readback;checksum=1353595249, cache reset not_requested).
...
- run_report_path=doc/09_report/production_gui_web_host_gpu_queue_readback_2026-07-11.md
...
- browser_first_render_us=107307
- browser_first_render_under_budget=true
- browser_first_render_dom_layout_us=2145
- browser_first_render_html_us=131
- browser_first_render_pixel_artifact_us=32622
- browser_first_render_draw_ir_dispatch_us=3275
- browser_first_render_framebuffer_copy_us=5833
- browser_first_render_state_store_us=47
- browser_first_pixel_count=3072
- browser_first_checksum=1344191869
- browser_first_nonuniform_count=2240
...
- browser_first_payload_hash=1353595249
- browser_first_payload_text=web-render-frame;backend=vulkan;pixels=3072;checksum=1353595249
...
- browser_first_readback_checksum=1353595249
...
- browser_first_event_correlation_summary=event=browser-input-1;frame_packet=1;readback_source=device_readback;checksum=1353595249
- browser_first_event_correlation_queue_packet=1
- browser_first_event_correlation_readback_source=device_readback
- browser_first_event_correlation_readback_checksum=1353595249
...
- host_native_device_readback_reason=Metal native readback evidence passed
- production_runtime_queue_integration_status=pass
- production_runtime_queue_integration_reason=same-frame BrowserBackend queue, Draw IR dispatch, BrowserBackend device readback receipt, host-native metal readback proof, Engine2D readback proof predicate, and compiler HostGpuLane cleanup probes proven
...
- linux_gui_web_queue_integration_reason=same-frame BrowserBackend queue, Draw IR dispatch, BrowserBackend device readback receipt, host-native metal readback proof, Engine2D readback proof predicate, and compiler HostGpuLane cleanup probes proven
...
- production_gui_web_host_gpu_queue_readback_reason=same-frame BrowserBackend queue, Draw IR dispatch, BrowserBackend device readback receipt, host-native metal readback proof, Engine2D readback proof predicate, and compiler HostGpuLane cleanup probes proven
