...
**Location:** `test/01_unit/std/thread_pool_spec.spl` (45 tests)
...
**Location:** `test/02_integration/thread_pool_async_spec.spl` (20 tests)
...
2. **Run Thread Pool Tests**
   ```bash
   bin/simple test test/01_unit/std/thread_pool_spec.spl        # 45 tests
   bin/simple test test/02_integration/thread_pool_async_spec.spl  # 20 tests
   ```
