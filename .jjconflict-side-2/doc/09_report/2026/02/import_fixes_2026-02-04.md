...
### 5. test/03_system/features/treesitter/treesitter_error_recovery_spec.spl
...
✅ `test/03_system/features/treesitter/treesitter_error_recovery_spec.spl` - Commented test code

### LOW PRIORITY - Not Fixed (1 file)
⏸️ `test/03_system/features/basic_types_integer_literals/basic_types_integer_literals_spec.spl`
