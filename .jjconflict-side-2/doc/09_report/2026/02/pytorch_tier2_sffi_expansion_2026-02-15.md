...
Based on `doc/01_research/pytorch_integration.md`:
...
```simple
# test/01_unit/lib/torch/ffi_declarations_spec.spl
...
```simple
# test/02_integration/torch/basic_ops_spec.spl
...
- **Research:** `doc/01_research/pytorch_integration.md`
- **SFFI Pattern:** `doc/09_report/sffi_three_tier_pattern_complete_2026-02-08.md`
- **Naming Fix:** `doc/09_report/pytorch_sffi_naming_fix_2026-02-09.md`
