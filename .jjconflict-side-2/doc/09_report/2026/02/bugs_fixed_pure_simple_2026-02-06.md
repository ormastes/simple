...
- Test file `test/03_system/features/baremetal/static_assert_spec.spl` enabled
...
- Test file `test/03_system/features/baremetal/const_fn_spec.spl` enabled
- No Rust changes needed
...
2. `test/03_system/features/baremetal/static_assert_spec.spl` - Enabled tests
3. `test/03_system/features/baremetal/const_fn_spec.spl` - Enabled tests
