...
**File:** `test/02_integration/baremetal_build_spec.spl` (117 lines)
...
**File:** `doc/07_guide/quick_reference/baremetal_quick_start.md` (467 lines)
...
```
Test Suite: test/02_integration/baremetal_build_spec.spl
...
- `test/02_integration/baremetal_build_spec.spl` (117 lines)
- `doc/07_guide/quick_reference/baremetal_quick_start.md` (467 lines)
