...
4. **Test Suites:**
   - `test/01_unit/std/process_monitor_spec.spl` (6 tests)
   - `test/01_unit/std/resource_tracker_spec.spl` (11 tests)
   - `test/01_unit/app/test_runner_new/test_runner_resources_spec.spl` (10 tests)
...
```sdn
resource_usage {
  test_file "test/01_unit/std/string_spec.spl"
...
```
[RESOURCE VIOLATION] test/02_integration/heavy_spec.spl
