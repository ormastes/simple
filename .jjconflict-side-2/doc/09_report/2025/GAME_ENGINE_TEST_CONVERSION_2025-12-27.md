...
All test files in `simple/std_lib/test/01_unit/game_engine/`:
...
```bash
./target/debug/simple simple/std_lib/test/01_unit/game_engine/*.spl
```
...
All in `simple/std_lib/test/01_unit/game_engine/`:
...
### Documentation
- This report: `doc/09_report/GAME_ENGINE_TEST_CONVERSION_2025-12-27.md`
