...
- `doc/06_spec/simple_math.md` (540 lines)
- `doc/tutorials/simple_math_quickstart.md` (465 lines)

### Test Files (Already created in Phase 6)
- `simple/std_lib/test/01_unit/ml/torch/simple_math_spec.spl` (170 lines)
- `simple/std_lib/test/01_unit/ml/torch/linalg_spec.spl` (200 lines)
- `simple/std_lib/test/01_unit/ml/torch/fft_spec.spl` (215 lines)
- `simple/std_lib/test/02_integration/ml/simple_math_integration_spec.spl` (230 lines)
