...
- Required verification:
  ...
  - `bin/simple test test/01_unit/compiler/loader/module_loader_crash_fix_spec.spl`
...
- Done:
  ...
  - lifecycle-aware loader regression coverage added in
    `test/01_unit/compiler/loader/module_loader_spec.spl` proving unload removes
...
- Still open for spawned-agent execution:
  ...
  3. Separate but relevant repo health item: the SSH transport spec path still
     ...
     `test/03_system/os_ssh_host_key_loader_spec.spl` remains green.
