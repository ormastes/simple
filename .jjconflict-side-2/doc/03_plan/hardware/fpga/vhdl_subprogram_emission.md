...
> Status: COMPLETE — W18-7 verified
...
`test/01_unit/compiler/vhdl_python_hdl_parity_spec.spl.skip` until the
...
```sh
bin/simple test test/03_system/compiler/vhdl_subprogram_spec.spl
