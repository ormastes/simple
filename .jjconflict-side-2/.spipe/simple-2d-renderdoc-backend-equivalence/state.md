...
- Setup/checker helpers: existing `scripts/setup/setup-gui-web-2d-vulkan-env.shs`, `scripts/tool/renderdoc-evidence.shs`, and `scripts/lib/renderdoc-evidence-common.shs`; the owner-level checker is `scripts/check/check-simple-2d-renderdoc-backend-equivalence.shs`.
