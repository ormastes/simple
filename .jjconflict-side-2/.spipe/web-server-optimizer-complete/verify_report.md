...
### Spec 1 — h2_hpack
**File:** `test/unit/lib/nogc_async_mut/http/h2/h2_hpack_spec.spl`
**Status:** PASS (5/5 tests)
**Fixes:** None required.

### Spec 2 — h2_stream
**File:** `test/unit/lib/nogc_async_mut/http/h2/h2_stream_spec.spl`
**Status:** PASS (6/6 tests)
**Fixes:** None required.

### Spec 3 — h2_connection
**File:** `test/unit/lib/nogc_async_mut/http/h2/h2_connection_spec.spl`
**Status:** PASS (5/5 tests)
**Fixes:** None required.

### Spec 4 — static_file_etag
**File:** `test/unit/lib/nogc_async_mut/http_server/static_file_etag_spec.spl`
**Status:** PASS (6/6 tests)
**Fixes:** None required.

### Spec 5 — protocol_handler
**File:** `test/unit/lib/nogc_async_mut/http_server/protocol_handler_spec.spl`
