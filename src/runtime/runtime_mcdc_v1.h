...
_Static_assert(sizeof(SimpleMcdcVectorV1) == 48, "SimpleMcdcVectorV1 ABI");
_Static_assert(offsetof(SimpleMcdcVectorV1, evaluated_mask) == 8, "evaluated mask ABI");
_Static_assert(offsetof(SimpleMcdcVectorV1, owner_id) == 24, "owner id ABI");
_Static_assert(offsetof(SimpleMcdcVectorV1, outcome) == 40, "outcome ABI");
