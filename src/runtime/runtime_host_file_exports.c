...
/* Standalone syntax gate: self-instantiate the owner macro exactly as
 * runtime_native.c does. The freestanding/profile #error checks below stay
 * authoritative for real builds. */
#define SIMPLE_RUNTIME_HOST_FILE_EXPORTS_OWNER_V2 1
#define RT_HOST_FILE_EXPORTS_STANDALONE_SYNTAX_SELF_INSTANTIATE 1
#endif
