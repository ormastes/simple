...
int8_t   rt_array_set(SplArray* array, int64_t idx, int64_t value);
...
int8_t   rt_io_udp_join_multicast(int64_t fd, int64_t multicast_addr);
int8_t   rt_io_udp_leave_multicast(int64_t fd, int64_t multicast_addr);
...
int64_t  rt_string_is_digit(int64_t value);
int64_t  rt_string_is_alpha(int64_t value);
int64_t  rt_string_is_alnum(int64_t value);
int64_t  rt_string_is_whitespace(int64_t value);
