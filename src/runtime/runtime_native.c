 ...
 *
 * CROSS-PLATFORM: this is a correctness fix on every target, not a Windows
 * workaround -- Windows MSVC Stage 2 was merely the first lane to execute the
 * miscompiled comparison. */
