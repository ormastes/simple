...
/* Debug enum to_string methods are owned by the Simple modules
 * nogc_sync_mut/debug/remote/{session_model,types}.spl. Defining their
 * mangled lib__ symbols here duplicates generated code in native MCP links.
 * The runtime bridge owns rt_* ABI functions, not library enum methods. */
