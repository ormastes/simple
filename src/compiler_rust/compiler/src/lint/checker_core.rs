//! Core lint checker infrastructure: struct definition, constructors, emit helpers,
//! directive scanning, module entry point, and function collection.
//!
//! #![skip_todo]
...
impl LintChecker {
    ...
    pub(super) fn apply_file_level_lint_directives(&mut self) {
    ...
    pub(super) fn collect_functions(&mut self, items: &[Node]) {
