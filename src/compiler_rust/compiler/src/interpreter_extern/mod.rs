...
pub(crate) fn call_extern_function(
    ...
    // Slow path: complex externs that need env/functions/classes/enums/impl_methods
    match name {
        ...
        "rt_io_tcp_drain_line" => interpreter_native_net::rt_io_tcp_drain_line_interp(&evaluated),
        ...
        "rt_file_fsync_cached" => file_io::rt_file_fsync_cached(&evaluated),
