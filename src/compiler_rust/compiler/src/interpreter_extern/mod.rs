...
pub(crate) fn call_extern_function(
    ...
    match name {
        ...
        "rt_ecdsa_p384_sign" => signatures::rt_ecdsa_p384_sign(&evaluated),
        "rt_ecdsa_p384_verify" => signatures::rt_ecdsa_p384_verify(&evaluated),
        "rt_ecdsa_p521_sign" => signatures::rt_ecdsa_p521_sign(&evaluated),
        "rt_ecdsa_p521_verify" => signatures::rt_ecdsa_p521_verify(&evaluated),
        ...
        "serial_println" => host_wm_bridge::serial_println(&evaluated),
        "rt_host_wm_server_start" => host_wm_bridge::rt_host_wm_server_start(&evaluated),
        "rt_host_wm_server_cleanup" => host_wm_bridge::rt_host_wm_server_cleanup(&evaluated),
        ...
        "rt_term_get_size" => system::rt_term_get_size(&evaluated),
        ...
        "rt_cuda_f64_sum_axis" => gpu::rt_cuda_f64_sum_axis_fn(&evaluated),
        "rt_cuda_f64_scalar_div" => gpu::rt_cuda_f64_scalar_div_fn(&evaluated),
        "rt_cuda_f64_slice_1d" => gpu::rt_cuda_f64_slice_1d_fn(&evaluated),
        "rt_cuda_f64_slice_2d" => gpu::rt_cuda_f64_slice_2d_fn(&evaluated),
        ...
        "rt_simd_add_f32x4" => simd::rt_simd_add_f32x4(&evaluated),
        "rt_simd_sub_f32x4" => simd::rt_simd_sub_f32x4(&evaluated),
        "rt_simd_mul_f32x4" => simd::rt_simd_mul_f32x4(&evaluated),
        "rt_simd_div_f32x4" => simd::rt_simd_div_f32x4(&evaluated),
        "rt_simd_fma_f32x4" => simd::rt_simd_fma_f32x4(&evaluated),
        "rt_simd_add_f32x8" => simd::rt_simd_add_f32x8(&evaluated),
        "rt_simd_sub_f32x8" => simd::rt_simd_sub_f32x8(&evaluated),
        "rt_simd_mul_f32x8" => simd::rt_simd_mul_f32x8(&evaluated),
        "rt_simd_div_f32x8" => simd::rt_simd_div_f32x8(&evaluated),
        "rt_simd_fma_f32x8" => simd::rt_simd_fma_f32x8(&evaluated),
        "rt_simd_add_f64x4" => simd::rt_simd_add_f64x4(&evaluated),
        "rt_simd_sub_f64x4" => simd::rt_simd_sub_f64x4(&evaluated),
        "rt_simd_mul_f64x4" => simd::rt_simd_mul_f64x4(&evaluated),
        "rt_simd_div_f64x4" => simd::rt_simd_div_f64x4(&evaluated),
        "rt_simd_fma_f64x4" => simd::rt_simd_fma_f64x4(&evaluated),
        ...
        "rt_cli_run_spipe_docgen" => cli::rt_cli_run_spipe_docgen(&evaluated),
        ...
        "rt_coverage_decision_probe" => coverage::rt_coverage_decision_probe_fn(&evaluated),
