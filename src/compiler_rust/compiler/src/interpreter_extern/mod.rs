...
pub(crate) fn call_extern_function(
    ...
    match name {
        ...
        "rt_f64_array_alloc" => file_io::rt_f64_array_alloc(&evaluated),
        "rt_f32_array_alloc" => file_io::rt_f32_array_alloc(&evaluated),
        "rt_i64_array_alloc" => file_io::rt_i64_array_alloc(&evaluated),
        "rt_i32_array_alloc" => file_io::rt_i32_array_alloc(&evaluated),
