...
pub static RUNTIME_FUNCS: &[RuntimeFuncSpec] = &[
    ...
    RuntimeFuncSpec::new("rt_vulkan_selected_device_is_physical", &[], &[I64]),
    RuntimeFuncSpec::new("rt_vulkan_runtime_acquire", &[], &[I64]),
    RuntimeFuncSpec::new("rt_vulkan_runtime_release", &[], &[I64]),
