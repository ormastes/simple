...
pub static RUNTIME_FUNCS: &[RuntimeFuncSpec] = &[
    ...
    // =========================================================================
    // Atomic RuntimeValue and opaque-handle families
    // =========================================================================
    RuntimeFuncSpec::new("rt_atomic_new", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_load", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_store", &[I64, I64], &[]),
    RuntimeFuncSpec::new("rt_atomic_swap", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_compare_exchange", &[I64, I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_fetch_add", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_fetch_sub", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_fetch_and", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_fetch_or", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_free", &[I64], &[]),
    RuntimeFuncSpec::new("rt_atomic_bool_new", &[I8], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_atomic_bool_fetch_and", &[I64, I8], &[I8]),
    RuntimeFuncSpec::new("rt_atomic_bool_fetch_or", &[I64, I8], &[I8]),
    RuntimeFuncSpec::new("rt_atomic_bool_fetch_not", &[I64], &[I8]),
    ...
    RuntimeFuncSpec::new("rt_atomic_int_store", &[I64, I64], &[]),
    RuntimeFuncSpec::new("rt_atomic_int_swap", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_int_compare_exchange", &[I64, I64, I64], &[I8]),
    RuntimeFuncSpec::new("rt_atomic_int_fetch_add", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_int_fetch_sub", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_int_fetch_and", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_int_fetch_or", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_atomic_int_fetch_xor", &[I64, I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_mmap_raw", &[I64, I64, I64, I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_munmap_raw", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_mprotect", &[I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_madvise_raw", &[I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_msync_flags", &[I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_mlock", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_munlock", &[I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_open_fd", &[I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_close_fd", &[I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_char_from_code", &[I64], &[I64]),
    ...
    // Two-arg text index_of(needle, start): byte-offset search from start.
    RuntimeFuncSpec::new("rt_text_find", &[I64, I64, I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_ptr_write_bytes_raw", &[I64, I64, I64, I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_pool_state_create_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_try_submit_i64_v1", &[I64, I64, I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_task_status_i64_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_task_join_i64_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_task_release_i64_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_close_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_join_idle_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_outstanding_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_pending_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_running_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_completed_v1", &[I64], &[I64]),
    RuntimeFuncSpec::new("rt_pool_state_destroy_v1", &[I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_cranelift_declare_global_data_v2", &[I64, I64, I64, I64, I64, I64, I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_hosted_safe_artifact_bundle_begin_v1", &[I64,I64,I64,I64,I64,I64,I64,I64,I64,I64], &[I64]),
    ...
    RuntimeFuncSpec::new("rt_cli_command_v1_call", &[I64, I64, I64, I64, I64, I64, I64], &[I32]),
    RuntimeFuncSpec::new("rt_host_dynlib_open", &[I64, I64, I64], &[I64]),
...
mod tests {
    ...
    fn tcp_connect_signatures_are_registered() {
        let connect = RUNTIME_FUNCS
            .iter()
            .find(|spec| spec.name == "rt_io_tcp_connect")
            .expect("TCP connect must be registered for native codegen");
        assert_eq!(connect.params, [I64]);
        assert_eq!(connect.returns, [I64]);

        let timeout = RUNTIME_FUNCS
            .iter()
            .find(|spec| spec.name == "rt_io_tcp_connect_timeout")
    ...
    fn udp_close_uses_boolean_abi() {
        let spec = RUNTIME_FUNCS
            .iter()
            .find(|spec| spec.name == "rt_io_udp_close")
    ...
    #[test]
    fn udp_options_use_scalar_boolean_abi() {
        let expected = [
            ("rt_io_udp_connect", &[I64, I64][..]),
            ("rt_io_udp_set_broadcast", &[I64, I8][..]),
            ("rt_io_udp_set_read_timeout", &[I64, I64][..]),
            ("rt_io_udp_set_nonblocking", &[I64, I8][..]),
        ];
        for (name, params) in expected {
            let spec = RUNTIME_FUNCS
                .iter()
