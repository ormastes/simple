        ...
        if runtime_integer_cast_requires_decode(*from_type, *to_type) {
            ...
            let narrowed = match *to_type {
                crate::hir::TypeId::I8 | crate::hir::TypeId::U8 => builder
                    .build_int_truncate(raw_i64, self.context_ref().i8_type(), "value_to_i8")
                    .map_err(|e| crate::error::factory::llvm_build_failed("trunc value->i8", &e))?
                    .into(),
                crate::hir::TypeId::I16 | crate::hir::TypeId::U16 => builder
                    .build_int_truncate(raw_i64, self.context_ref().i16_type(), "value_to_i16")
                    .map_err(|e| crate::error::factory::llvm_build_failed("trunc value->i16", &e))?
                    .into(),
                crate::hir::TypeId::I32 | crate::hir::TypeId::U32 => builder
                    .build_int_truncate(raw_i64, self.context_ref().i32_type(), "value_to_i32")
                    .map_err(|e| crate::error::factory::llvm_build_failed("trunc value->i32", &e))?
                    .into(),
                _ => raw_i64.into(),
            };
            return Ok(narrowed);
