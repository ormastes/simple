//! Mold linker SFFI for Simple language.
//!
//! This module provides SFFI functions for the Simple linker to detect and
...
#[no_mangle]
pub extern "C" fn mold_sffi_find_mold() -> *const c_char {
...
#[no_mangle]
pub extern "C" fn mold_sffi_find_lld() -> *const c_char {
...
#[no_mangle]
pub extern "C" fn mold_sffi_find_ld() -> *const c_char {
...
#[no_mangle]
pub unsafe extern "C" fn mold_sffi_execute(
...
#[no_mangle]
pub unsafe extern "C" fn mold_sffi_write_elf_object(
    code: *const u8,
    code_len: usize,
    name: *const c_char,
...
#[no_mangle]
pub unsafe extern "C" fn mold_sffi_get_file_size(path: *const c_char) -> i64 {
    if path.is_null() {
        return -1;
    }
...
#[no_mangle]
pub unsafe extern "C" fn mold_sffi_free_string(ptr: *mut c_char) {
    if !ptr.is_null() {
...
#[no_mangle]
pub extern "C" fn mold_sffi_create_temp_dir() -> *const c_char {
...
/// `path` must be a valid null-terminated C string.
#[no_mangle]
pub unsafe extern "C" fn mold_sffi_cleanup_temp_dir(path: *const c_char) -> i32 {
    if path.is_null() {
        return -1;
    }
