...
pub(crate) use interpreter_state::{
    ...
    DEFERRED_MODULES, EXTERN_FUNCTIONS, GENERATOR_YIELDS, IMMUTABLE_VARS, IN_IMMUTABLE_FN_METHOD,
    INTERFACE_BINDINGS, INTERPRETER_ARGS, INTERRUPT_REQUESTED, MACRO_DEFINITION_ORDER, MODULE_GLOBALS,
    MOVED_VARS, SI_BASE_UNITS, TIMEOUT_EXCEEDED, TRAIT_IMPLS, TRAITS, MIXINS, UNIT_FAMILY_ARITHMETIC,
    UNIT_FAMILY_CONVERSIONS, UNIT_SUFFIX_TO_FAMILY, USER_MACROS,
};
pub(crate) use interpreter_state::DeferredModule;
