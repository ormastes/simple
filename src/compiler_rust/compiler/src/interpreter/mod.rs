...
pub(crate) use interpreter_state::{
    ...
    EXTERN_FUNCTIONS, GENERATOR_YIELDS, GLOBAL_ENUMS, GLOBAL_IMPL_METHODS, IMMUTABLE_VARS,
    IN_IMMUTABLE_FN_METHOD, INTERFACE_BINDINGS,
    INTERPRETER_ARGS, INTERRUPT_REQUESTED, MACRO_DEFINITION_ORDER, MODULE_GLOBALS, MOVED_VARS, SI_BASE_UNITS,
...
pub use coverage_helpers::{set_coverage_file, push_coverage_file, pop_coverage_file, register_function_source_file, get_function_source_file, clear_function_source_files};
