//! Parser for extracting documentation from SPipe files
...
/// Parse spipe file and extract documentation blocks
pub fn parse_spipe_file(path: &Path) -> Result<SspecDoc, Box<dyn std::error::Error>> {
