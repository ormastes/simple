...
fn compile_c_runtime_sources() {
    ...
    let c_sources = ["runtime_math.c", "runtime_memory.c", "runtime_time.c", "runtime_ctype.c", "runtime_random.c", "runtime_hash.c", "runtime_value.c", "runtime_equality.c", "runtime_config.c", "runtime_crypto.c", "runtime_contracts.c", "runtime_env.c", "runtime_base64.c", "runtime_format.c"];
