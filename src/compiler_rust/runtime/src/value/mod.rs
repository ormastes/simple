...
pub use collections::{
    ...
    rt_array_set_len_known_text, rt_array_set_text, rt_byte_array_new, rt_bytes_u32_le_at, rt_bytes_u64_le_at,
    rt_bytes_u8_at, rt_bytes_u8_set, rt_contains, rt_cstring_to_text, rt_hash_text, rt_index_get, rt_index_set, rt_len,
    rt_range, rt_range_inclusive, rt_slice, rt_string_char_at, rt_string_char_code_at, rt_string_concat,
