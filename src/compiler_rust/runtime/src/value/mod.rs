...
pub use collections::{
    ...
    rt_array_len, rt_array_new, rt_array_new_with_cap_u64, rt_array_pop, rt_array_push, rt_array_set,
    rt_array_set_len_known, rt_byte_array_new, rt_bytes_u32_le_at, rt_bytes_u64_le_at, rt_bytes_u8_at, rt_bytes_u8_set,
    rt_contains, rt_cstring_to_text, rt_hash_text, rt_index_get, rt_index_set, rt_len, rt_range, rt_range_inclusive,
    rt_slice, rt_string_char_at, rt_string_char_code_at, rt_string_concat, rt_string_data, rt_string_ends_with,
