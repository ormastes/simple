//! Graphics SFFI functions for Vulkan
//!
//! Provides SFFI functions for render pass, shader module, graphics pipeline, and framebuffer management.
