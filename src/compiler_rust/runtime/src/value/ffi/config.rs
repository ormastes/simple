...
pub fn rt_set_macro_trace(enabled: bool) {
    unsafe { c_ffi::rt_set_macro_trace(enabled) }
}
#[inline(always)]
pub fn rt_is_macro_trace_enabled() -> bool {
    unsafe { c_ffi::rt_is_macro_trace_enabled() }
}
#[inline(always)]
pub fn rt_set_debug_mode(enabled: bool) {
    unsafe { c_ffi::rt_set_debug_mode(enabled) }
}
#[inline(always)]
pub fn rt_is_debug_mode_enabled() -> bool {
    unsafe { c_ffi::rt_is_debug_mode_enabled() }
}
