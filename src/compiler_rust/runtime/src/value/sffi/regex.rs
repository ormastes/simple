//! Regular expression SFFI bindings for Simple language
//!
//! This module provides SFFI functions to expose Rust's regex crate to Simple.
//! It handles:
...
//!
//! ## Design
//! SFFI functions return simple types (bool, string, array) that the Simple
...
///
/// SFFI signature: regex_is_match(pattern: text, text: text) -> bool
#[no_mangle]
pub extern "C" fn sffi_regex_is_match(pattern: RuntimeValue, text: RuntimeValue) -> RuntimeValue {
...
/// SFFI signature: regex_find_internal(pattern: text, text: text) -> [text, i64, i64] or []
#[no_mangle]
pub extern "C" fn sffi_regex_find(pattern: RuntimeValue, text: RuntimeValue) -> RuntimeValue {
    let Some(pattern_str) = get_string(&pattern) else {
...
/// SFFI signature: regex_find_all_internal(pattern: text, text: text) -> [[text, i64, i64], ...]
#[no_mangle]
pub extern "C" fn sffi_regex_find_all(pattern: RuntimeValue, text: RuntimeValue) -> RuntimeValue {
    let Some(pattern_str) = get_string(&pattern) else {
        return rt_array_new(0);
    };
...
/// SFFI signature: regex_captures_internal(pattern: text, text: text) -> [text, ...]
#[no_mangle]
pub extern "C" fn sffi_regex_captures(pattern: RuntimeValue, text: RuntimeValue) -> RuntimeValue {
    let Some(pattern_str) = get_string(&pattern) else {
        return rt_array_new(0);
    };
...
/// Replace first match
///
/// SFFI signature: regex_replace(pattern: text, text: text, replacement: text) -> text
#[no_mangle]
...
/// Replace all matches
///
/// SFFI signature: regex_replace_all(pattern: text, text: text, replacement: text) -> text
#[no_mangle]
...
///
/// SFFI signature: regex_split(pattern: text, text: text) -> [text, ...]
#[no_mangle]
pub extern "C" fn sffi_regex_split(pattern: RuntimeValue, text: RuntimeValue) -> RuntimeValue {
    let Some(pattern_str) = get_string(&pattern) else {
...
///
/// SFFI signature: regex_split_n(pattern: text, text: text, limit: i64) -> [text, ...]
#[no_mangle]
pub extern "C" fn sffi_regex_split_n(pattern: RuntimeValue, text: RuntimeValue, limit: RuntimeValue) -> RuntimeValue {
    let Some(pattern_str) = get_string(&pattern) else {
        let result = rt_array_new(1);
        rt_array_push(result, text);
        return result;
...
mod tests {
    ...
    fn test_regex_is_match() {
        ...
        let result = sffi_regex_is_match(pattern, text);
        assert_eq!(result, RuntimeValue::TRUE);

        let text_no_match = create_string("Hello");
        let result_no_match = sffi_regex_is_match(pattern, text_no_match);
    ...
    fn test_regex_find() {
        ...
        let result = sffi_regex_find(pattern, text);
    ...
    fn test_regex_replace_all() {
        ...
        let result = sffi_regex_replace_all(pattern, text, replacement);
    ...
    fn test_regex_split() {
        ...
        let result = sffi_regex_split(pattern, text);
