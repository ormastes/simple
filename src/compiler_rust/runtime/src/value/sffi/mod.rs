//! SFFI (Foreign Function Interface) for RuntimeValue operations.
//!
//! This module provides C-compatible SFFI functions for interacting with the Simple
...
//! All SFFI functions have been extracted from sffi_legacy.rs into organized, tested modules.
//!
...
// Phase 10B: PyTorch/ML integration
//
// The legacy RuntimeValue-based PyTorch SFFI exports overlapping `rt_torch_*`
