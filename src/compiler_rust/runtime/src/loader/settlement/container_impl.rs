impl Settlement {
    ...
    pub fn add_module_with_linking(
        ...
        for sym in module.symbols.exports() {
            if sym.sym_type == super::super::smf::SymbolType::Function {
    ...
    pub fn func_table_slice(&self) -> &[super::super::smf::settlement::FuncTableEntry] {
        self.func_table.as_slice()
    }

    /// Get global table entries as slice.
    pub fn global_table_slice(&self) -> &[super::super::smf::settlement::GlobalTableEntry] {
        self.global_table.as_slice()
    }

    /// Get type table entries as slice.
    pub fn type_table_slice(&self) -> &[super::super::smf::settlement::TypeTableEntry] {
