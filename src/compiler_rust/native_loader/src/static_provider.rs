...
impl RuntimeSymbolProvider for StaticSymbolProvider {
    fn get_symbol(&self, name: &str) -> Option<*const u8> {
        ...
        use simple_runtime::value::{
            ...
            rt_cli_run_fmt, rt_cli_run_gen_lean, rt_cli_run_lex, rt_cli_run_lint, rt_cli_run_migrate,
            rt_cli_run_query, rt_cli_run_repl, rt_cli_run_tests, rt_cli_run_verify, rt_cli_version, rt_cli_watch_file,
            rt_compile_to_llvm_ir, rt_compile_to_native, rt_condition_probe, rt_contains, rt_decision_probe, rt_dict_clear, rt_dict_keys, rt_dict_remove,
            rt_dict_values, rt_env_all, rt_env_cwd, rt_env_exists, rt_env_get, rt_env_home, rt_env_remove, rt_env_set,
            rt_env_temp, rt_env_vars, rt_eprint_str, rt_eprint_value, rt_eprintln_str, rt_eprintln_value, rt_exit,
            rt_function_not_found, rt_get_env, rt_interp_call, rt_interp_eval, rt_is_debug_mode_enabled,
            ...
            rt_process_spawn_async, rt_process_wait, rt_set_debug_mode, rt_set_env, rt_set_macro_trace, rt_stdout_flush,
            rt_stdout_write, rt_to_string, rt_unwrap_or_self, rt_value_compare, rt_value_eq, rt_value_to_string,
        };
        // File I/O operations
        use simple_runtime::value::{
            rt_file_exists, rt_file_stat, rt_file_canonicalize, rt_file_read_text, rt_file_read_text_rv,
            rt_file_write_text, rt_file_copy, rt_file_remove, rt_file_size, rt_file_hash_sha256, rt_file_rename,
            rt_file_read_lines, rt_file_append_text, rt_file_read_bytes, rt_bytes_from_raw, rt_bytes_to_text,
            rt_text_to_bytes, rt_file_write_bytes, rt_file_move, rt_file_lock, rt_file_unlock, rt_file_mmap_read_text,
            rt_file_mmap_read_bytes, rt_file_read_text_at, rt_file_write_text_at, rt_mmap, rt_munmap, rt_madvise,
            rt_msync, rt_getpid, rt_dir_create, rt_dir_list, rt_dir_remove, rt_file_find, rt_dir_glob,
