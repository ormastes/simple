 ...
 * LLVM_ENABLE_THREADS=OFF. Thread creation and synchronization return
 * ENOSYS until a kernel-owned atomic mutex/futex handoff exists: reporting a
 * no-op lock as acquired would authorize unsynchronized shared-state access.
 *
...
/* ====================================================================
 * 2. Mutexes — fail closed until synchronization is real
 * ==================================================================== */
...
int pthread_mutex_lock(pthread_mutex_t *mutex)    { return mutex ? ENOSYS : EINVAL; }
int pthread_mutex_trylock(pthread_mutex_t *mutex) { return mutex ? ENOSYS : EINVAL; }
int pthread_mutex_unlock(pthread_mutex_t *mutex)  { return mutex ? ENOSYS : EINVAL; }
...
int pthread_attr_init(pthread_attr_t *attr)    { return attr ? ENOSYS : EINVAL; }
int pthread_attr_destroy(pthread_attr_t *attr) { return attr ? ENOSYS : EINVAL; }
