...
fn param_type_name(param: &simple_parser::ast::Parameter) -> Option<String> {
    use simple_parser::ast::Type;
...
struct ProceedContext {
    ...
    classes: Arc<HashMap<String, ClassDef>>,
    enums: Arc<Enums>,
    impl_methods: Arc<ImplMethods>,
}
