use super::{
    ...
    instructions::{BlockId, ContractKind, GpuAtomicOp, GpuMemoryScope, MirInst, VReg},
};
use crate::hir::{GpuIntrinsicKind, HirContract, HirExpr, HirExprKind, HirFunction, HirModule, HirStmt, NeighborDirection, TypeId};
