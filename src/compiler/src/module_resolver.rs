...
// DirectoryManifest implementation - extracted to module_resolver_directory_manifest.rs
include!("module_resolver_directory_manifest.rs");

// DirectoryManifest methods are in the included file above
