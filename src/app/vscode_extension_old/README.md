# Simple Language Old Extension for VSCode
...
1. Download `simple-language-old-0.1.0.vsix` from releases
2. Install via VSCode:
   ```bash
   code --install-extension simple-language-old-0.1.0.vsix
   ```
...
2. Select **Simple Language Old Server** from dropdown
...
2. **Check output panel:**
   - View → Output → Simple Language Old Server
...
View in Output panel: Simple Language Old Server
