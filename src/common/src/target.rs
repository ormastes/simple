...
impl TargetArch {
    ...
    pub const fn pointer_size(&self) -> PointerSize {
        match self {
            TargetArch::X86_64 | TargetArch::Aarch64 | TargetArch::Riscv64 => PointerSize::Bits64,
            TargetArch::X86 | TargetArch::Arm | TargetArch::Riscv32 => PointerSize::Bits32,
        }
    }
...
/// Full target specification (architecture + OS).
#[derive(Debug, Clone, Copy, PartialEq, Eq, Hash)]
pub struct Target {
    pub arch: TargetArch,
    pub os: TargetOS,
...
impl Target {
    ...
    /// Parse a target triple string (e.g., "x86_64-linux", "aarch64-macos").
