...
clang++ -std=c++20 -O2 -I../seed output.cpp \
  -L../build/seed -lspl_runtime -lm -lpthread -ldl \
  -o binary
...
Step 0: Pre-built binary (bin/release/simple)
  ↓
Step 1: Seed compiler (build/seed/seed_cpp) ← YOU ARE HERE
  ↓
...
See `../scripts/bootstrap/bootstrap-from-scratch.sh` for the complete bootstrap process.
