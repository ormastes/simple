...
const char* greet(const char* name) {
    return simple_str_concat("Hello, ", simple_str_concat(name, "!"));
}
...
int main(void) {
    puts("Simple Language Bootstrap Compiler v0.1");
    printf("%lld\n",(long long)greet("World"));
    long long fib10 = fibonacci(10);
    printf("fibonacci(10) = %lld\n", (long long)(fib10));
    puts("Bootstrap chain: Simple -> C -> Native Binary");
    return 0;
    return 0;
}
