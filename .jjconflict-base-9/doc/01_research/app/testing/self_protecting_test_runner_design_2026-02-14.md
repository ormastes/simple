...
```
$ simple test test/02_integration/ --self-protect
...
Running test/02_integration/database_spec.spl... PASS
Running test/02_integration/compiler_spec.spl... PASS
...
Running test/02_integration/heavy_spec.spl...
...
Running test/02_integration/network_spec.spl... PASS
...
```
