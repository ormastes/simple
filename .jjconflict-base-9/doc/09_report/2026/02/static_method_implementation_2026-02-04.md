...
**HashMap Basic Operations:** `test/03_system/collections/hashmap_basic_spec.spl`
- 8 examples, 1 failure (unrelated to static methods)
- All `HashMap.new()` calls work correctly ✓

**BTreeMap Basic Operations:** `test/03_system/collections/btree_basic_spec.spl`
...
./bin/simple_runtime test/03_system/collections/hashmap_basic_spec.spl
# Output: 8 examples, 1 failure (unrelated)

# Test BTreeMap with static methods
./bin/simple_runtime test/03_system/collections/btree_basic_spec.spl
