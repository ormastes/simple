...
8. `simple/std_lib/test/01_unit/parser/treesitter_lexer_spec.spl` (10 tests)
9. `simple/std_lib/test/01_unit/parser/treesitter_parser_spec.spl` (16 tests)
10. `simple/std_lib/test/01_unit/parser/treesitter_incremental_spec.spl` (20 tests)
11. `simple/std_lib/test/01_unit/parser/treesitter_error_recovery_spec.spl` (25 tests)
12. `simple/std_lib/test/01_unit/parser/treesitter_query_spec.spl` (18 tests) ← Phase 4

### Modified Files (2)
1. `doc/features/feature.md` - Updated progress to 71% (17/24)
2. `doc/09_report/README.md` - Added Phase 1 completion entry
