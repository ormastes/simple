...
|------|---------|----------|--------|--------|--------|
| `test/02_integration/app/scv_wasm_executor_spec.spl` | PROD-001: WASM Executor | 6 | 4 | 2 | FAIL |
| `test/02_integration/app/scv_parser_rebuild_spec.spl` | PROD-002: Parser Rebuild | 5 | 5 | 0 | PASS |
| `test/02_integration/app/scv_structural_match_spec.spl` | PROD-003: Structural Match | 8 | 8 | 0 | PASS |
| `test/02_integration/app/scv_git_full_interop_spec.spl` | PROD-004: Git Full Interop | 3 | 3 | 0 | PASS |
| `test/02_integration/app/scv_network_remote_spec.spl` | PROD-005: Network Remote | 5 | 5 | 0 | PASS |
| `test/02_integration/app/scv_delta_pack_spec.spl` | PROD-006: Delta Pack | 8 | 8 | 0 | PASS |
