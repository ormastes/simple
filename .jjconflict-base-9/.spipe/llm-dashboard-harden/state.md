...
- `test/01_unit/app/dashboard/dashboard_serve_spec.spl` — run_serve/run_gui/run_agents no longer print "unavailable"
- `test/01_unit/app/ui/detect_spec.spl` — has_tauri_shell() returns bool, false on CI/SimpleOS
- `test/01_unit/app/llm_dashboard/collectors/task_daemon_collector_spec.spl` — _parse_task_file key=value parsing, collect_task_daemon_tasks list return
- `test/01_unit/app/llm_dashboard/data/types_taskkind_spec.spl` — TaskKind.Job variant + task_kind_name "job" + regression for existing arms
- `test/01_unit/app/mcp/tool_table_generators_spec.spl` — feature_gen/task_gen no name param; todo_gen read_only=true; spec_gen has path param
- `test/01_unit/app/mcp/cli_passthrough_spec.spl` — feature_gen/task_gen do not passthrough name; spec_gen still passes path
...
- `_run_serve_result`, `_run_gui_result`, `_run_agents_result` helpers: used by `test/01_unit/app/dashboard/dashboard_serve_spec.spl` — kept as-is.
...
|-----------|-------|--------|
| test/01_unit/app/dashboard/dashboard_serve_spec.spl | 6 | PASS |
| test/01_unit/app/ui/detect_spec.spl | 3 | PASS |
| test/01_unit/app/llm_dashboard/collectors/task_daemon_collector_spec.spl | 11 | PASS |
| test/01_unit/app/llm_dashboard/data/types_taskkind_spec.spl | 6 | PASS |
| test/01_unit/app/mcp/tool_table_generators_spec.spl | 8 | PASS |
| test/01_unit/app/mcp/cli_passthrough_spec.spl | 5 | PASS |
