...
- var block = LeanBlock create
- block = block with namespace
   - Expected: block.lean_ns equals `Some("MyModule.Proofs")`
...
- "theorem my theorem
- cgen = cgen add lean block
- cgen = cgen add namespace
- cgen = cgen end namespace
