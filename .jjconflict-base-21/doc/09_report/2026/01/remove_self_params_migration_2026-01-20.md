...
**Test File**: `simple/std_lib/test/01_unit/tooling/remove_self_params_spec.spl`
...
2. `simple/std_lib/test/01_unit/tooling/remove_self_params_spec.spl` (5 lines)
3. `doc/09_report/remove_self_params_migration_2026-01-20.md` (this file)
