...
### 4. Created Tests: `test/01_unit/std/string_core_spec.spl` (170 lines)
...
| `test/01_unit/std/string_core_spec.spl` | 0 | 170 | +170 (new) |
...
- **Created:** `test/01_unit/std/string_core_spec.spl` (170 lines)
- **Created:** `doc/09_report/string_utilities_consolidation_2026-02-14.md` (this file)
...
bin/simple test test/01_unit/std/string_core_spec.spl
