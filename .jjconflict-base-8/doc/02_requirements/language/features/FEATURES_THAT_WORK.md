...
- ✅ `test/03_system/feature/async_features_spec.spl` - PASS (7ms)
- ✅ `test/03_system/feature/stackless_coroutines_spec.spl` - PASS (5ms)
- ✅ `test/03_system/feature/actor_model_spec.spl` - PASS (5ms)
- ✅ `test/01_unit/std/async_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/std/async_host_spec.spl` - PASS (5ms)
- ✅ `test/01_unit/std/async_embedded_spec.spl` - PASS (5ms)

### Usage Guide

**See:** [doc/07_guide/sync_async/async/async_guide.md](guide/sync_async/async/async_guide.md) for complete async/await programming guide.
...
All LSP tests pass:
- ✅ `test/01_unit/app/lsp/references_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/app/lsp/hover_spec.spl` - PASS (7ms)
- ✅ `test/01_unit/app/lsp/definition_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/app/lsp/document_sync_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/app/lsp/message_dispatcher_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/app/lsp/server_lifecycle_spec.spl` - PASS (7ms)
- ✅ `test/01_unit/app/lsp/diagnostics_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/app/lsp/completion_spec.spl` - PASS (6ms)
...
**See:** [doc/07_guide/lsp_integration.md](guide/lsp_integration.md) for LSP setup and configuration.
...
- ✅ `test/01_unit/compiler/backend/native_ffi_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/compiler/backend/backend_capability_spec.spl` - PASS (7ms)
- ✅ `test/01_unit/compiler/backend/instruction_coverage_spec.spl` - PASS (7ms)
- ✅ `test/01_unit/compiler/backend/exhaustiveness_validator_spec.spl` - PASS (7ms)
- ✅ `test/01_unit/compiler/backend/differential_testing_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/compiler/linker_spec.spl` - PASS (7ms)
- ✅ `test/01_unit/compiler/linker_context_spec.spl` - PASS (5ms)
- ✅ `test/01_unit/compiler/jit_context_spec.spl` - PASS (7ms)
...
**See:** [doc/07_guide/backend_capabilities.md](guide/backend_capabilities.md) for backend selection and usage.
...
- ✅ **Status:** FIXED
- ✅ **Test:** `test/01_unit/compiler/match_empty_array_bug_spec.spl` - PASS (6ms)
...
- ✅ **Status:** FIXED
- ✅ **Test:** `test/03_system/print_return_spec.spl` - PASS (5ms)
...
- ✅ **Status:** FIXED
- ✅ **Test:** `test/01_unit/std/runtime_value_spec.spl` - PASS (6ms)
...
- ✅ **Test:** `test/03_system/feature/set_literal_spec.spl` - PASS (6ms)
...
- ✅ **Test:** `test/03_system/feature/bitfield_spec.spl` - PASS (5ms)
...
- ✅ **Test:** `test/01_unit/compiler/effect_inference_spec.spl` - PASS (7ms)
...
- ✅ **Test:** `test/01_unit/lib/qemu_spec.spl` - PASS (6ms)
...
- ✅ Test: `test/03_system/interpreter_bugs_spec.spl` - PASS
...
**Test Evidence:**
- `test/01_unit/compiler/mdsoc/types_spec.spl` - 40+ tests PASS
- `test/01_unit/compiler/mdsoc/config_spec.spl` - 30+ tests PASS
- `test/01_unit/compiler/mdsoc/layer_checker_spec.spl` - 25+ tests PASS
- `test/01_unit/compiler/mdsoc/doc_validation_spec.spl` - 10+ tests PASS
...
- **Research & Design:** [doc/01_research/mdsoc_design.md](../research/mdsoc_design.md) - Theoretical foundation, design rationale
- **User Guide:** [doc/07_guide/mdsoc_guide.md](../guide/mdsoc_guide.md) - Quick start, configuration, patterns
- **Feature Status:** [doc/02_requirements/feature/mdsoc_complete.md](mdsoc_complete.md) - Test coverage, integration guide
...
**Tests:**
- `test/01_unit/app/doc/public_check/statistics_spec.spl` - PASS
- `test/01_unit/app/doc/public_check/warnings_spec.spl` - PASS
...
**Tests:** `test/03_system/feature/trait_forwarding_spec.spl` (8/8), `test/01_unit/app/desugar/trait_scanner_spec.spl` (9/9)
...
- ✅ [doc/07_guide/sync_async/async/async_guide.md](guide/sync_async/async/async_guide.md) - Async/await programming
- ✅ [doc/07_guide/lsp_integration.md](guide/lsp_integration.md) - LSP editor setup
- ✅ [doc/07_guide/backend_capabilities.md](guide/backend_capabilities.md) - Backend selection
...
```bash
# Test async features
bin/simple test test/03_system/feature/async_features_spec.spl

# Test LSP
bin/simple test test/01_unit/app/lsp/

# Test backend
bin/simple test test/01_unit/compiler/backend/

# Test parser fixes
bin/simple test test/01_unit/compiler/match_empty_array_bug_spec.spl
```
...
- [doc/07_guide/sync_async/async/async_guide.md](guide/sync_async/async/async_guide.md)
- [doc/07_guide/lsp_integration.md](guide/lsp_integration.md)
- [doc/07_guide/backend_capabilities.md](guide/backend_capabilities.md)
