...
- pure spec coverage in `test/03_system/app/os/feature/kernel_mvp_spec.spl`
- runnable system smoke coverage in `test/03_system/kernel_mvp_spec.spl`
- kernel log ring-buffer coverage in `test/01_unit/os/kernel/logging/kernel_log_spec.spl`

## Gates

### Gate MVP-1: Ring-3 context setup stays correct

- run `test/03_system/app/os/feature/kernel_mvp_spec.spl`
- expect:
...
- run `test/01_unit/os/kernel/logging/kernel_log_spec.spl`
- expect:
...
```sh
bin/simple test test/03_system/app/os/feature/kernel_mvp_spec.spl
bin/simple test test/03_system/kernel_mvp_spec.spl
bin/simple test test/01_unit/os/kernel/logging/kernel_log_spec.spl
```
