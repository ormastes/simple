...
<!-- sdn-diagram:id=dylib_async_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=dylib_async_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

dylib_async_spec -> std
dylib_async_spec -> os
```
...
```ascii generated-from=dylib_async_spec.arch hash=sha256:auto
