...
- **Context docs fresh:** `simple_context`, SPipe MCP language-neutral
  context/parser, or context-mode changes must update the MCP/tooling guide,
  ...
  shape, embedded SQLite facade boundary, explicit absence statuses, SPipe
  parser/raw parent-chain behavior, and public-absence guard.
