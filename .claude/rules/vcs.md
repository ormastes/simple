...
| `check-no-unresolved-runtime-symbols.shs` | verdict depends on which lane last wrote the archive path — see the bullet below; runs on macOS as of 2026-08-24 | binary half still has no artifact to judge (stage blobs untracked) |
