...
|---|------|---------|---------|
| 1 | [inference_rules_1](#inference_rules_1) | Inference Rules | `inference`, `InferenceRules`, `Inference` +9 |
| 2 | [inference_rules_2](#inference_rules_2) | Inference Rules | `inference`, `InferenceRules`, `Inference` +5 |
| 3 | [inference_rules_3](#inference_rules_3) | Inference Rules | `inference`, `InferenceRules`, `Inference` +4 |
| 4 | [inference_rules_4](#inference_rules_4) | Inference Rules | `inference`, `InferenceRules`, `Inference` +4 |
| 5 | [inference_rules_5](#inference_rules_5) | Inference Rules | `inference`, `InferenceRules`, `Inference` +4 |
| 6 | [inference_rules_6](#inference_rules_6) | Inference Rules | `inference`, `InferenceRules`, `Inference` +6 |
| 7 | [inference_rules_7](#inference_rules_7) | Inference Rules | `inference`, `InferenceRules`, `Inference` +4 |
| 8 | [inference_rules_8](#inference_rules_8) | Inference Rules | `inference`, `InferenceRules`, `Inference` +4 |
| 9 | [add](#add) | Inference Rules | `Add`, `add`, `Infers` +3 |
| 10 | [inference_rules_10](#inference_rules_10) | Inference Rules | `inference`, `InferenceRules`, `Inference` +5 |
| 11 | [apply](#apply) | Inference Rules | `Apply`, `apply`, `inc` |
| 12 | [inference_rules_12](#inference_rules_12) | Inference Rules | `inference`, `InferenceRules`, `Inference` +10 |
| 13 | [inference_rules_13](#inference_rules_13) | Inference Rules | `inference`, `InferenceRules`, `Inference` +9 |
| 14 | [inference_rules_14](#inference_rules_14) | Inference Rules | `inference`, `InferenceRules`, `Inference` +7 |
| 15 | [inference_rules_15](#inference_rules_15) | Inference Rules | `inference`, `InferenceRules`, `Inference` +8 |
| 16 | [type_unification_16](#type_unification_16) | Type Unification | `Unification`, `Type`, `TypeUnification` +7 |
| 17 | [type_unification_17](#type_unification_17) | Type Unification | `Unification`, `Type`, `TypeUnification` +6 |
| 18 | [examples_18](#examples_18) | Examples | `examples`, `Examples`, `Array` +2 |
| 19 | [map](#map) | Examples | `map`, `Map`, `Array` +2 |
| 20 | [unwrap_or](#unwrap_or) | Examples | `unwrap`, `unwrap_or`, `Unwrap` +5 |
| 21 | [fetch_data](#fetch_data) | Examples | `Fetch`, `FetchData`, `data` +10 |
| 22 | [error_messages_22](#error_messages_22) | Error Messages | `error_messages`, `messages`, `Error` +7 |
| 23 | [error_messages_23](#error_messages_23) | Error Messages | `error_messages`, `messages`, `Error` +5 |
| 24 | [error_messages_24](#error_messages_24) | Error Messages | `error_messages`, `messages`, `Error` +9 |
