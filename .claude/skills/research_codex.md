...
- Reads Claude Step 1 output from `doc/01_research/<domain>/`
...
## Output
- `doc/01_research/<domain>/<feature>.md` — consolidated Codex research
- `doc/02_requirements/<domain>/<feature>_options.md` — 2-3 requirement option sets for user selection
