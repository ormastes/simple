...
**Generated Files:**
1. `doc/archive/todo/todo_db.sdn` - TODO database (SDN format)
...
#   Removed: 1 TODOs
#   Total:   71 TODOs
# Database saved to doc/archive/todo/todo_db.sdn
...
|--------|---------|----------|------|---------|
| **TODO** | `simple todo-scan` | `doc/archive/todo/todo_db.sdn` | `doc/TODO.md` | Manual command |
