...
- `SCREEN=INVISIBLE` (needs Xvfb), `PBI=USB`, `RCL=NETASSIST PORT=20000`
- `SCREEN=OFF` NOT supported in this build
...
## Key Files
- Config: `config/t32/t32_stm_headless.t32`, `stm32wb_*.cmm`
- Scripts: `scripts/t32_host_setup.shs`, `t32_start_stm.shs`, `t32_check_ready.shs`
