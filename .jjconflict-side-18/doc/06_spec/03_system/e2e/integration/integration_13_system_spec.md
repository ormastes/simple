...
<!-- sdn-diagram:id=integration_13_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=integration_13_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

integration_13_system_spec -> std
```
...
```ascii generated-from=integration_13_system_spec.arch hash=sha256:auto
