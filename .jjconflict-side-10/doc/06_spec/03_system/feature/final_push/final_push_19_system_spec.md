...
<!-- sdn-diagram:id=final_push_19_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=final_push_19_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

final_push_19_system_spec -> std
```
...
```ascii generated-from=final_push_19_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/feature/final_push/final_push_19_system_spec.spl` |
| Updated | 2026-06-01 |
