...
- **Test:** `test/03_system/feature/effect_annotations_spec.spl`
...
- **Test:** `test/03_system/feature/parser_error_recovery_spec.spl`
...
- **Test:** `test/03_system/feature/generics_advanced_spec.spl`
...
### Test Files
- `test/03_system/feature/effect_annotations_spec.spl` (301 lines) - Ready to test
- `test/03_system/feature/parser_error_recovery_spec.spl` (343 lines) - Needs std.parser
- `test/03_system/feature/generics_advanced_spec.spl` (216 lines) - Needs verification
...
4. Update doc/02_requirements/feature/feature.md
