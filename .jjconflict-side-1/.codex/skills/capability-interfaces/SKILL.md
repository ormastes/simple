...
description: "Writing or extending a capability trait pair/group (debug/profile worked example). Value-semantics hazards, CapLevel honesty, critical mode, and falsifiable-spec rules. Reference: doc/07_guide/language/capability_library_authoring.md."
---

# Capability Interfaces — writing/extending a capability library
