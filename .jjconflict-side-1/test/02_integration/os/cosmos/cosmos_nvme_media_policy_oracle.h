#ifndef SIMPLE_COSMOS_NVME_MEDIA_POLICY_ORACLE_H
#define SIMPLE_COSMOS_NVME_MEDIA_POLICY_ORACLE_H

/* Independent frozen-C names; never alias the production policy ABI. */
#define COSMOS_NVME_MEDIA_ORACLE_PAGE_FULL_WRITE 0U
#define COSMOS_NVME_MEDIA_ORACLE_PAGE_READ_MAPPED 1U
#define COSMOS_NVME_MEDIA_ORACLE_PAGE_ZERO_UNMAPPED 2U
#define COSMOS_NVME_MEDIA_ORACLE_PAGE_PROPAGATE 3U
