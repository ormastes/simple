...
`bin/simple test test/01_unit/lib/crypto/ed448_rfc8032_kat_spec.spl` exceeds the
...
and rerun `test/01_unit/lib/crypto/ed448_rfc8032_kat_spec.spl`. Expected runtime
...
- `test/01_unit/lib/crypto/ed448_rfc8032_kat_spec.spl` — 8 specs over 2 RFC §7.4
...
- [ ] `bin/simple test test/01_unit/lib/crypto/ed448_rfc8032_kat_spec.spl` passes
