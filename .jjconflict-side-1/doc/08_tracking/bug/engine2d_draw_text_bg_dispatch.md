...
`test/01_unit/lib/gc_async_mut/gpu/engine2d/draw_text_bg_spec.spl`: pixels stayed at
...
```bash
bin/simple test test/01_unit/lib/gc_async_mut/gpu/engine2d/draw_text_bg_spec.spl --clean
```
...
- `bin/simple check src/lib/gc_async_mut/gpu/engine2d/backend_cpu.spl src/lib/gc_async_mut/gpu/engine2d/engine.spl test/01_unit/lib/gc_async_mut/gpu/engine2d/draw_text_bg_spec.spl`
- `bin/simple test test/01_unit/lib/gc_async_mut/gpu/engine2d/draw_text_bg_spec.spl --clean`
