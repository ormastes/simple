...
- `SIMPLE_BLAS_BACKEND=mock bin/simple test test/03_system/feature/scilib/linalg_torch_backend_spec.spl --mode=interpreter --no-cache` passed: 22 examples, 0 failures.
- `SIMPLE_SFFI_PATH=build/scilib SIMPLE_BLAS_BACKEND=pytorch bin/simple test test/03_system/feature/scilib/linalg_torch_backend_spec.spl --mode=interpreter --no-cache` passed: 22 examples, 0 failures.
