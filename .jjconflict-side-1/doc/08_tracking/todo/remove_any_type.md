...
- **Type Safety:** `doc/05_design/type_system_design.md`
- **Runtime FFI:** `src/lib/runtime/value.spl`
- **Generic System:** `doc/07_guide/generics_guide.md`
- **This Report:** `doc/09_report/debug_dap_complete_session_2026-02-08.md` (DAP `Any` limitation)
