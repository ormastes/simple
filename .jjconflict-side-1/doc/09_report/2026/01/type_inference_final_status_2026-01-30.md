...
- **Files:**
  - `test/03_system/features/type_inference/dyn_trait_spec.spl` (11 scenarios)
  - `test/03_system/features/type_inference/transitive_mixin_spec.spl` (12 scenarios)
...
3. Follow patterns from `test/03_system/features/array_types/array_types_spec.spl`
...
| `test/03_system/features/type_inference/dyn_trait_spec.spl` | 280 | 📝 Needs conversion |
| `test/03_system/features/type_inference/transitive_mixin_spec.spl` | 320 | 📝 Needs conversion |
