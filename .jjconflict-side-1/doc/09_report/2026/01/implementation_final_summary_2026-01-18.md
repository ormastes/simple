...
### Current State
```bash
$ ./target/release/simple test simple/std_lib/test/01_unit/verification/regeneration_spec.spl
...
simple/std_lib/test/01_unit/verification/regeneration_spec.spl
