...
**Priority Files:**
- `test/03_system/features/classes/classes_spec.spl` - Class features
- `test/03_system/features/contracts/class_invariant_spec.spl` - Contracts
...
1. `doc/03_plan/test_revival_plan_2026-01-29.md` - Comprehensive revival plan
2. `doc/09_report/test_revival_session_2026-01-29.md` - This report
