...
- `simple/test/01_unit/spec/` - New directory for unit tests
...
### New Files
1. `simple/test/01_unit/spec/registry_spec.spl` - Registry unit tests
2. `simple/test/01_unit/spec/dsl_spec.spl` - DSL unit tests
3. `simple/test/01_unit/spec/matchers_spec.spl` - Matcher unit tests
4. `simple/test/01_unit/spec/expect_spec.spl` - Expect unit tests

### Modified Files
1. `doc/03_plan/28_bdd_spec.md` - Updated Sprint 1 status to complete

## Sprint 1 Completion Checklist

- ✅ Create test/01_unit/spec directory structure
