...
1. **test/02_integration/spec/runner_spec.spl** (contains 2 ignored tests)
   - Status: `failed`
   - Error: `semantic: variable 'hook_order' not found`
   - Database entry: Recorded as 1 failed file, individual tests not parsed

2. **test/01_unit/spec/dsl_spec.spl** (contains 2 ignored tests)
...
tests |test_id, test_name, test_file, category, status, ...|
    test/02_integration/spec/runner_spec.spl, runner_spec, ..., Integration, failed, ...
```
...
|------|------|-----------|--------|
| test/01_unit/spec/dsl_spec.spl | 115 | "registers a slow example" | NOT in DB |
| test/01_unit/spec/dsl_spec.spl | 124 | "skips slow test when RUN_SLOW_TESTS is not set" | NOT in DB |
| test/02_integration/spec/runner_spec.spl | 189 | "skips slow tests by default" | NOT in DB |
| test/02_integration/spec/runner_spec.spl | 202 | "runs slow tests when enabled" | NOT in DB |
...
```sdn
tests |test_id, test_name, test_file, category, status, ...|
    test/02_integration/spec/runner_spec.spl, runner_spec, ..., Integration, ignored, ...
    test/01_unit/spec/dsl_spec.spl, dsl_spec, ..., Unit, ignored, ...
```
