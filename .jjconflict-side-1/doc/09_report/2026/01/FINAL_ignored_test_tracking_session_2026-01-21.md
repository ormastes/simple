...
| # | File | Line | Test Name |
|---|------|------|-----------|
| 1 | `test/01_unit/spec/dsl_spec.spl` | 115 | `ignore_it "registers a slow example"` |
| 2 | `test/01_unit/spec/dsl_spec.spl` | 124 | `ignore_it "skips slow test when RUN_SLOW_TESTS is not set"` |
| 3 | `test/02_integration/spec/runner_spec.spl` | 189 | `ignore_it "skips slow tests by default"` |
| 4 | `test/02_integration/spec/runner_spec.spl` | 202 | `ignore_it "runs slow tests when enabled"` |
...
tests |test_id, test_name, ..., status, ...|
    test/01_unit/spec/dsl_spec.spl::registers a slow example, registers a slow example, ..., ignored, ...
    test/01_unit/spec/dsl_spec.spl::skips slow test when RUN_SLOW_TESTS is not set, skips slow test when RUN_SLOW_TESTS is not set, ..., ignored, ...
    test/02_integration/spec/runner_spec.spl::skips slow tests by default, skips slow tests by default, ..., ignored, ...
    test/02_integration/spec/runner_spec.spl::runs slow tests when enabled, runs slow tests when enabled, ..., ignored, ...
```
...
- test/01_unit/spec/dsl_spec.spl::registers a slow example
- test/01_unit/spec/dsl_spec.spl::skips slow test when RUN_SLOW_TESTS is not set
- test/02_integration/spec/runner_spec.spl::skips slow tests by default
- test/02_integration/spec/runner_spec.spl::runs slow tests when enabled
```
