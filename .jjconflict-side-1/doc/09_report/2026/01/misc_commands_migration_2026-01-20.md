...
### 2. Tests
**File:** `simple/std_lib/test/01_unit/tooling/misc_commands_spec.spl` (164 lines)
...
```bash
$ ./target/debug/simple test simple/std_lib/test/01_unit/tooling/misc_commands_spec.spl
...
