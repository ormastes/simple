...
- `doc/07_guide/constructors_updated.md` - Updated to emphasize Python-style and implicit static
- `doc/07_guide/constructors_comparison.md` - Already comprehensive, no changes needed
- `doc/07_guide/constructor_implementation_status.md` - **NEW** - Detailed implementation status and limitations
