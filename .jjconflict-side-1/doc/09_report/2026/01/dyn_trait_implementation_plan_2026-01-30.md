...
Create `test/03_system/features/dyn_traits/dyn_traits_spec.spl`:
...
- [ ] Document findings in `doc/09_report/runtime_type_integration.md`
- [ ] Estimated Time: 2 hours
...
### File: `test/03_system/features/dyn_traits/dyn_traits_spec.spl`
...
**File:** `test/02_integration/dyn_trait_runtime_spec.spl`
...
mkdir -p test/03_system/features/dyn_traits
vim test/03_system/features/dyn_traits/dyn_traits_spec.spl
./target/debug/simple_old test test/03_system/features/dyn_traits/
...
### A.2 SSpec Test Template (`test/03_system/features/dyn_traits/dyn_traits_spec.spl`)
