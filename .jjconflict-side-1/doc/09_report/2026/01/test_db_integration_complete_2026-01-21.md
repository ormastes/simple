...
```bash
./target/debug/simple test test/01_unit/spec/dsl_spec.spl
```
...
- Implementation Summary: `doc/09_report/test_bug_db_implementation_2026-01-21.md`
- Research: `doc/01_research/test_timing_database_research_2026-01-21.md`
- Build DB Design: `doc/01_research/build_error_database_design_2026-01-21.md`
- Ecosystem Overview: `doc/01_research/database_ecosystem_overview_2026-01-21.md`
