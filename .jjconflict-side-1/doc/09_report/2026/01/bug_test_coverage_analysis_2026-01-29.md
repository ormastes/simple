...
- ⚠️  `test/03_system/features/codegen_parity_completion/codegen_parity_completion_spec.spl` - Tests codegen but not `print()` formatting
...
- ⚠️  `test/03_system/features/codegen_parity_completion/codegen_parity_completion_spec.spl` - Tests MIR codegen but only for simple values, not full module compilation
...
- `test/03_system/features/codegen_parity_completion/codegen_parity_completion_spec.spl` - Codegen parity
