...
1. `test/03_system/features/operators_arithmetic/operators_arithmetic_spec.spl` (4 uses)
2. `test/03_system/features/parser/parser_expressions_spec.spl` (1 use)
3. `test/03_system/features/parser/parser_operators_spec.spl` (1 use)
4. `test/03_system/features/operators/operators_advanced_spec.spl` (4 uses)
...
4. **Write parallel operator tests**
   - Create `test/03_system/features/operators/parallel_operator_spec.spl`
   - Test function execution, error cases
   - Document usage patterns

5. **Update documentation**
   - CLAUDE.md - Update operator reference
   - `doc/07_guide/quick_reference/syntax_quick_reference.md` - Show new syntax
