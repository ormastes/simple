...
- `slow_it "takes a long time"` in `test/01_unit/spec/dsl_spec.spl`
...
|---|------------------|------|-------------|
| 1 | **"takes a long time"** | test/01_unit/spec/dsl_spec.spl | ✅ **YES** |
| 2 | "takes forever" | test/01_unit/spec/dsl_spec.spl | ❌ No |
| 3 | "slow test" | test/02_integration/spec/runner_spec.spl | ❌ No |
| 4 | "slow test" | test/02_integration/spec/runner_spec.spl | ❌ No |
...
| # | Test Description | File | Has "long"? |
|---|------------------|------|-------------|
| 1 | "registers a slow example" | test/01_unit/spec/dsl_spec.spl | ❌ No |
| 2 | "skips slow test when RUN_SLOW_TESTS is not set" | test/01_unit/spec/dsl_spec.spl | ❌ No |
| 3 | "skips slow tests by default" | test/02_integration/spec/runner_spec.spl | ❌ No |
| 4 | "runs slow tests when enabled" | test/02_integration/spec/runner_spec.spl | ❌ No |

---

## Code Locations

### test/01_unit/spec/dsl_spec.spl (4 total: 2 slow_it, 2 ignore_it)
...
### test/02_integration/spec/runner_spec.spl (4 total: 2 slow_it, 2 ignore_it)
...
tests |test_id, test_name, ..., status, ...|
    test/01_unit/spec/dsl_spec.spl, dsl_spec, ..., ignored, ...
    test/02_integration/spec/runner_spec.spl, runner_spec, ..., ignored, ...
...
# Output: test/01_unit/spec/dsl_spec.spl:                slow_it "takes a long time":
