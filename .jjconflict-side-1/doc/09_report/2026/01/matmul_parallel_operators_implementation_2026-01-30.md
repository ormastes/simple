...
**Plan:**
- Create `test/03_system/features/operators/matrix_multiplication_spec.spl`
...
- **Design:** `doc/05_design/pipeline_operators_design.md`
- **Error Guide:** `doc/07_guide/dimension_errors_guide.md`
- **Test Template:** `.claude/templates/sspec_template.spl`
- **Feature Tracker:** `doc/02_requirements/feature/feature_db.sdn`
