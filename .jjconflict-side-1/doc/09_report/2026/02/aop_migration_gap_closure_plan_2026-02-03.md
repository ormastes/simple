...
3. `test/03_system/features/aop/di_spec.spl` (new, ~150 lines)
...
```simple
# test/03_system/features/aop/di_spec.spl
...
- ✅ `test/03_system/features/aop/di_spec.spl` (150 lines)
...
2. `test/03_system/features/aop/mock_spec.spl` (new, ~200 lines)
...
```simple
# test/03_system/features/aop/mock_spec.spl
...
- ✅ `test/03_system/features/aop/mock_spec.spl` (200 lines)
...
3. `test/03_system/features/aop/aop_architecture_rules_spec.spl` (expand)
...
```simple
# test/03_system/features/aop/aop_architecture_rules_spec.spl (expand)
...
- ✅ Expanded `test/03_system/features/aop/aop_architecture_rules_spec.spl` (+50 lines)
...
2. `test/03_system/features/aop/di_validation_spec.spl` (new, ~100 lines)
...
```simple
# test/03_system/features/aop/di_validation_spec.spl
...
- ✅ `test/03_system/features/aop/di_validation_spec.spl` (100 lines)
...
| `test/03_system/features/aop/di_spec.spl` | 150 | DI tests |
| `test/03_system/features/aop/mock_spec.spl` | 200 | Mock tests |
| `test/03_system/features/aop/di_validation_spec.spl` | 100 | Validation tests |
...
| `test/03_system/features/aop/aop_architecture_rules_spec.spl` | ~200 | +50 | Expanded tests |
