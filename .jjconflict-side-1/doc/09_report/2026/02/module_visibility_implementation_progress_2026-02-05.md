...
| **7. SSpec Tests** | 🔵 Pending | Activate tests in `test/03_system/features/module_visibility/` |
...
🔵 **`test/03_system/features/module_visibility/module_visibility_spec.spl`**
...
- 🔵 `test/03_system/features/module_visibility/module_visibility_spec.spl` - Integration tests (28 cases, pending)
