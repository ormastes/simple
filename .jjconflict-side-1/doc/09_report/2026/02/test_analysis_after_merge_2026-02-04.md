...
**File:** `test/03_system/db_sdn_spec.spl`
...
**Files:**
- `test/03_system/features/treesitter/treesitter_incremental_spec.spl`
- `test/03_system/features/treesitter/treesitter_lexer_spec.spl`
...
**Files:**
- `test/03_system/features/parser/parser_error_recovery_spec.spl`
- `test/03_system/features/parser/parser_functions_spec.spl`
...
**Recommendation:** Add test file `test/03_system/features/treesitter/treesitter_heuristic_spec.spl`
...
1. **Add Heuristic Mode Tests**
   ```simple
   # test/03_system/features/treesitter/treesitter_heuristic_spec.spl
...
2. **Verify Parser Tests**
   - Run: `bin/simple test test/03_system/features/parser/`
   - Run: `bin/simple test test/03_system/features/treesitter/`
   - Confirm all pass
