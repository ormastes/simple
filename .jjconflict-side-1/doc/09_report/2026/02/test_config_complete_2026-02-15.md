...
**Created `test/01_unit/app/test_runner_new/test_config_spec.spl`:**
- 12 tests for TestConfig loading and CI mode detection
- Tests for default values, parsing, and multi-level config search

**Created `test/01_unit/app/test_runner_new/test_runner_args_ci_spec.spl`:**
...
bin/simple test --ci test/01_unit/
```
...
$ bin/simple build test/01_unit/app/test_runner_new/test_config_spec.spl
Build succeeded in 0ms

$ bin/simple build test/01_unit/app/test_runner_new/test_runner_args_ci_spec.spl
Build succeeded in 0ms
```
...
bin/simple test test/01_unit/my_spec.spl
...
- **Original Plan:** `doc/09_report/test_config_implementation_2026-02-15.md`
...
A test/01_unit/app/test_runner_new/test_config_spec.spl (45 lines)
A test/01_unit/app/test_runner_new/test_runner_args_ci_spec.spl (52 lines)
```
