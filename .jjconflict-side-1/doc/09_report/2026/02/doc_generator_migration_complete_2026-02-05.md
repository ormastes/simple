...
fn generate_all_docs(db: TestDatabase, fdb: FeatureDatabase):
    ...
    file_atomic_write("doc/02_requirements/feature/feature.md", feature_md)
...
- ✅ `doc/02_requirements/feature/feature.md` - Feature index
- ✅ `doc/02_requirements/feature/pending_feature.md` - Incomplete features
- ✅ `doc/02_requirements/feature/category/*.md` - Per-category details
...
2. Update initialization:
   ```simple
   val fdb_opt = load_feature_database("doc/02_requirements/feature/feature_db.sdn")
   val fdb = if fdb_opt.?: fdb_opt? else: create_feature_database("doc/02_requirements/feature/feature_db.sdn")
   ```
...
cat doc/02_requirements/feature/feature.md           # Should still work
cat doc/02_requirements/feature/pending_feature.md   # Should still work
```
