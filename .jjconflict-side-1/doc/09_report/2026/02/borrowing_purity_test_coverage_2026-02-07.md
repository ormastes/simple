...
**Date**: 2026-02-07
**Design Doc**: `doc/05_design/borrowing_and_type_inference.md`
...
The design document `doc/05_design/borrowing_and_type_inference.md` describes a comprehensive system for:
...
### 3. Effect System (`test/03_system/features/effects/effect_system_spec.spl`)
...
### 4. Borrowing Feature Spec (`test/03_system/features/borrowing/borrowing_spec.spl`)
...
**Expected test file**: `test/03_system/features/borrowing_purity_examples_spec.spl` (does not exist)
...
| Examples | Comprehensive | `test/03_system/features/borrowing_purity_examples_spec.spl` | ❌ Missing |
