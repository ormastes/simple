...
1. **test/01_unit/app/test_runner_new/test_config_spec.spl**
   - 12 tests for TestConfig loading

2. **test/01_unit/app/test_runner_new/test_runner_args_ci_spec.spl**
   - 11 tests for --ci flag behavior

3. **test/01_unit/app/test_runner_new/integration_test_config_spec.spl**
...
# Test specs
$ bin/simple build test/01_unit/app/test_runner_new/*_spec.spl
Build succeeded in 0ms ✅
```
...
# Specific path
bin/simple test test/01_unit/compiler_core/
...
1. **Run integration tests:**
   ```bash
   bin/simple test test/01_unit/app/test_runner_new/integration_test_config_spec.spl
   ```
...
3. **Test CI mode:**
   ...
   CI=true bin/simple test test/01_unit/
   ```
