...
**File:** `doc/07_guide/backend_selection.md`
- Quick start guide
...
TODO: Add backend switching tests to `test/01_unit/compiler_core_legacy/backend/`:
...
```
doc/07_guide/backend_selection.md               # 300+ lines (user guide)
examples/backend_switching.spl                # 250+ lines (examples)
doc/09_report/backend_switching_implementation_2026-02-14.md  # This file
```
