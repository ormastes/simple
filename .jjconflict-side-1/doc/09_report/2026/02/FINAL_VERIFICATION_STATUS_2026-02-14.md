...
**Test:** `test/01_unit/compiler/closure_capture_warning_spec.spl`
```bash
✅ 1 passed, 4ms
```
...
**Test:** `test/01_unit/runtime/module_closure_spec.spl`
```bash
✅ 1 passed
```
...
**Test:** `test/01_unit/parser/multiline_bool_spec.spl`
```bash
✅ 1 passed
```
...
**Test:** `test/01_unit/compiler_core/generic_syntax_spec.spl`
```bash
✅ 1 passed
```
...
**Test File:** `test/01_unit/compiler_core/ignored_return_warning_spec.spl`
...
Files: test/01_unit/compiler_core/ignored_return_warning_spec.spl, src/compiler_core/interpreter/eval.spl
...
Files: test/01_unit/app/doc_coverage/*_spec.spl
```
...
bin/simple test test/01_unit/app/doc_coverage/
