...
| `doc/05_design/` | 3 | Design documents and API specifications |
...
| `doc/02_requirements/feature/` | 3 | Feature requests and analysis |
| `doc/09_report/` | 3 | Analysis summaries and error reports |
| `doc/integration/` | 1 | Integration documentation (torch/FFI) |
| `doc/06_spec/` | 1 | DSL specifications |
| `doc/07_guide/` | 1 | Build guides |
...
1. **Plan:** `doc/03_plan/doc_folder_cleanup_2026-02-16.md`
