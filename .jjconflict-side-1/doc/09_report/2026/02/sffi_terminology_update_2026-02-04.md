...
**Renamed File:**
- `doc/07_guide/ffi_gen_guide.md` → `doc/07_guide/sffi_gen_guide.md`
...
**New Documentation:**
- `doc/07_guide/sffi_terminology.md` - Complete terminology reference
...
- `doc/07_guide/quick_reference/ffi_syscalls_quick_reference.md` - Low-level syscalls
- `doc/07_guide/ffi_syscalls_phase3_guide.md` - Syscall implementation
- `doc/07_guide/ffi_phase4_execution_plan.md` - FFI execution plan
...
3. `doc/07_guide/ffi_gen_guide.md` → `doc/07_guide/sffi_gen_guide.md` (renamed + updated)

### New Files

1. `doc/07_guide/sffi_terminology.md` - Complete terminology guide
2. `doc/09_report/sffi_terminology_update_2026-02-04.md` - This report
...
ls -la doc/07_guide/sffi_gen_guide.md     # ✅ Exists
ls -la doc/07_guide/sffi_terminology.md   # ✅ Exists

# Verify old files removed
ls -la .claude/skills/ffi.md           # ❌ Not found (renamed)
ls -la doc/07_guide/ffi_gen_guide.md      # ❌ Not found (renamed)
```
...
✅ **Created reference** in `doc/07_guide/sffi_terminology.md`
