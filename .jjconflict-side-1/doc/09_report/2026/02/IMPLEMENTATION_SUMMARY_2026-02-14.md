...
| **By file/dir** | ✅ Yes | Positional arg | `bin/simple test test/01_unit/spec.spl` |
...
bin/simple test --container-seq test/02_integration/database_spec.spl
```
...
# By file/directory
bin/simple test test/01_unit/std/            # Specific directory
bin/simple test test/01_unit/std/spec.spl   # Single file

# Combined
bin/simple test --integration --tag=database --only-slow test/02_integration/
```
...
- Test dependencies (`# @DependsOn test/01_unit/db_spec.spl`)
...
```bash
bin/simple test test/01_unit/app/test_runner_new/process_tracker_spec.spl  # 8 tests
bin/simple test test/01_unit/app/test_runner_new/checkpoint_spec.spl       # 11 tests
```

### Integration Tests (TODO):
```bash
# Parallel execution
bin/simple test test/02_integration/parallel_execution_spec.spl

# Container tracking
bin/simple test test/02_integration/container_tracking_spec.spl
