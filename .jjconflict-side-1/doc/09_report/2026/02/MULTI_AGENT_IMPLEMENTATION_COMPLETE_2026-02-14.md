...
- ✅ `test/01_unit/type/runtime_type_check_spec.spl` (~800 lines, 60 tests)
- ✅ `test/01_unit/type/basic_type_check_spec.spl` (~200 lines, 24 tests)
...
- ✅ `test/01_unit/compiler/x86_64_simd_spec.spl` (344 lines, 80+ tests)
...
- ✅ `test/01_unit/std/thread_safe_queue_spec.spl` (40 tests)
...
**Deliverables:**
- ✅ `test/02_integration/advanced_types_spec.spl` (40 tests, 237 lines)
- ✅ `test/02_integration/simd_stdlib_spec.spl` (30 tests, 201 lines)
- ✅ `test/02_integration/baremetal_full_spec.spl` (40 tests, 311 lines)
- ✅ `test/02_integration/thread_pool_async_spec.spl` (20 tests, 164 lines)
- ✅ `test/03_system/compiler_full_spec.spl` (60 tests, 355 lines)
