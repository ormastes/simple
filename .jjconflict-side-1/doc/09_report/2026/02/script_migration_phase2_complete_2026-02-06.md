...
- Output: `doc/09_report/missing_ffi_wrappers.md`
...
```bash
# Single file
./src/app/test/extract.spl doc/06_spec/functions.md tests/specs/functions_spec.spl
...
- **doc/09_report/script_migration_phase1_complete_2026-02-06.md** - Phase 1 summary
- **doc/07_guide/script_migration.md** - Migration guide
