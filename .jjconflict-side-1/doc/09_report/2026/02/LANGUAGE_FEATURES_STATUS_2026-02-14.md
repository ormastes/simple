...
### Tests
- **File:** `test/01_unit/parser/multiline_bool_spec.spl`
...
### Tests
- **File:** `test/01_unit/compiler/closure_capture_warning_spec.spl`
...
### Tests
- **File:** `test/01_unit/compiler_core/ignored_return_warning_spec.spl`
...
### Tests
- **File:** `test/01_unit/runtime/module_closure_spec.spl`
...
### Tests
- **File:** `test/01_unit/compiler_core/generic_syntax_spec.spl`
...
```bash
$ bin/simple test test/01_unit/compiler/closure_capture_warning_spec.spl
  PASS  (1 passed, 4ms) ✅

$ bin/simple test test/01_unit/compiler_core/ignored_return_warning_spec.spl
  PASS  (1 passed, 5ms) ✅

$ bin/simple test test/01_unit/runtime/module_closure_spec.spl
  PASS  (1 passed, 3ms) ✅

$ bin/simple test test/01_unit/compiler_core/generic_syntax_spec.spl
  PASS  (1 passed, 4ms) ✅

$ bin/simple test test/01_unit/parser/multiline_bool_spec.spl
  PASS  (1 passed, 3ms) ✅
```
...
- Add warning examples to `doc/07_guide/quick_reference/syntax_quick_reference.md`
- Create `doc/07_guide/warnings.md` explaining all warning types
...
### Test Files
- `test/01_unit/compiler/closure_capture_warning_spec.spl` (177 lines, 22 tests)
- `test/01_unit/compiler_core/ignored_return_warning_spec.spl` (143 lines, 18 tests)
- `test/01_unit/runtime/module_closure_spec.spl` (85 lines, 10 tests)
- `test/01_unit/compiler_core/generic_syntax_spec.spl` (191 lines, 30 tests)
- `test/01_unit/parser/multiline_bool_spec.spl` (143 lines, 18 tests)
