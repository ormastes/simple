...
- ✅ `doc/02_requirements/feature/feature_db.sdn` - Feature tracking (using unified `lib.database.feature`)
...
- `test/02_integration/mcp_bugdb_spec.spl` (234 lines)
- `test/03_system/features/mcp/database_resource_spec.spl` (254 lines)
...
ls -lh doc/bug/bug_db.sdn doc/02_requirements/feature/feature_db.sdn doc/test/test_db.sdn
