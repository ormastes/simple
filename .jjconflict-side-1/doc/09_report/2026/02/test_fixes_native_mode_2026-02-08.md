...
| `test/02_integration/cli_dispatch_spec.spl` | 25/25 | ✅ PASS | 295ms |
...
- **System feature tests:** Most tests in `test/03_system/features/` marked `# @pending`
- **Slow tests:** Integration tests marked with `slow_it` (run with `--only-slow`)

**Example Skipped Directories:**
- `test/03_system/features/actors/`
- `test/03_system/features/async_effects/`
- `test/03_system/features/generics/`
- `test/03_system/features/futures_promises/`
