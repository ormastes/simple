...
2. `doc/09_report/script_cleanup_2026-02-06.md` - Cleanup report
3. `doc/07_guide/script_migration.md` - Migration guide (400+ lines)
...
- **doc/07_guide/script_migration.md** - How to migrate scripts
- **archive/scripts/README.md** - What's archived and why
- **doc/09_report/script_cleanup_2026-02-06.md** - Cleanup details
