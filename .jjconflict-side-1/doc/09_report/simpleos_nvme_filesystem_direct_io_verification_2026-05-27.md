...
```bash
src/compiler_rust/target/debug/simple test test/01_unit/os/drivers/nvme/nvme_storage_model_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/drivers/nvme/nvme_namespace_assignment_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/drivers/nvme/nvme_driver_probe_contract_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/drivers/nvme/nvme_performance_contract_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/services/vfs/nvme_block_adapter_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/services/vfs/nvme_filesystem_mounts_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/services/vfs/vfs_boot_nvme_lease_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/kernel/boot/boot_fs_mount_acceptance_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/03_system/kernel/boot_fs_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/drivers/real_device_readiness_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/app/simpleos_nvme_serial_check_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/qemu_runner_spec.spl --mode=interpreter --clean
src/compiler_rust/target/debug/simple test test/01_unit/os/port/simpleos_multiplatform_build_spec.spl --mode=interpreter --clean
...
- Pure Simple path faster than C FAT/NVMe baseline: proven by q35 same-device
  ...
  path, `allocation_per_io=false`, `c_baseline_device=same-nvme`,
