...
- Affected 6 test files in `simple/std_lib/test/01_unit/ui/`

**Test Relocation:**
- Moved tests from `test/03_system/ui/` to `test/01_unit/ui/` per CLAUDE.md guidelines
...
### Unit Tests (`simple/std_lib/test/01_unit/ui/`)
...
- Tests moved from `test/03_system/ui/` to `test/01_unit/ui/`
...
### Test Coverage
- **Unit Test Files:** 12 files in `test/01_unit/ui/`
