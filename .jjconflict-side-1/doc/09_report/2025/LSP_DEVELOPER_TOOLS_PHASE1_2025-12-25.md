...
|------|-------|-------|-------------|
| `simple/std_lib/test/01_unit/lsp/semantic_tokens_spec.spl` | 130 | 14 | Token encoding, highlighting |
| `simple/std_lib/test/01_unit/lsp/diagnostics_spec.spl` | 160 | 12 | Error detection, reporting |
| `simple/std_lib/test/01_unit/lsp/hover_spec.spl` | 210 | 20 | Node finding, content generation |
| `simple/std_lib/test/01_unit/lsp/references_spec.spl` | 210 | 18 | Reference finding, context detection |
