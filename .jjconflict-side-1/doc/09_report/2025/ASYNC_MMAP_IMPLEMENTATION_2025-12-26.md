...
| `doc/06_spec/file_io.md` | Module section | Clarified sync/async separation |
...
- **Research:** `doc/01_research/async_mmap_file_api.md`
- **Specification:** `doc/06_spec/file_io.md`
