...
| File | Tests | Coverage |
|------|-------|----------|
| `test/03_system/feature/usage/math_blocks_spec.spl` | 28 | m{} evaluation, operator precedence, nested blocks |
| `test/03_system/feature/usage/loss_nograd_blocks_spec.spl` | 27 | loss{}/nograd{} parsing, lowering, rendering parity |
| `test/03_system/feature/usage/math_autograd_runtime_spec.spl` | 9 | Real autograd semantics: backward, gradient flow, detached negative case, no_grad escape cleanup |
