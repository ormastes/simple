...
### New Test Files
- `test/02_integration/compiler/llvm_i686_closure_spec.spl`
- `test/02_integration/compiler/llvm_aarch64_closure_spec.spl`
- `test/02_integration/compiler/llvm_armv7_closure_spec.spl`
- `test/02_integration/compiler/llvm_riscv_closure_spec.spl`
...
| 4 | Native Parity Tests | Done | `test/02_integration/compiler/llvm_parity_spec.spl` |
| 5 | Cross-Target Descriptors | Done | `src/compiler/70.backend/backend/llvm_cross_target.spl` |
| 6 | Compiled Proof Tests | Done | `test/02_integration/compiler/llvm_compiled_proof_spec.spl` |
...
### Tests (2 spec files)
- `test/02_integration/compiler/llvm_parity_spec.spl` — Backend parity: llvm-lib vs llvm comparison
- `test/02_integration/compiler/llvm_compiled_proof_spec.spl` — All proof classes: capability, version, cross-target, matrix, negative cases
