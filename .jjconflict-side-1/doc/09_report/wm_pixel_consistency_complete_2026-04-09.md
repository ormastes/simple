...
### Spec Files (11)
- `test/01_unit/os/compositor/perceptual_compare_spec.spl` -- 17 specs (AC-4)
- `test/01_unit/os/compositor/tolerance_profile_spec.spl` -- 19 specs (AC-4)
- `test/01_unit/os/compositor/wm_scene_spec.spl` -- 15 specs (AC-2, AC-3)
- `test/01_unit/os/compositor/electron_capture_spec.spl` -- 6 specs (AC-2)
- `test/01_unit/os/compositor/qemu_capture_spec.spl` -- 9 specs (AC-3)
- `test/01_unit/os/compositor/wm_consistency_runner_spec.spl` -- 15 specs (AC-1, AC-4, AC-5, AC-7)
- `test/01_unit/os/compositor/diff_export_spec.spl` -- 5 specs (AC-6)
- `test/01_unit/lib/common/png_decode_spec.spl` -- 8 specs (AC-2)
- `test/01_unit/os/compositor/screenshot_compare_profile_spec.spl` -- 8 specs (AC-4)
- `test/03_system/qemu/qmp_screendump_spec.spl` -- 5 specs (AC-3)
- `test/03_system/gui/wm_pixel_consistency_spec.spl` -- 19 specs (AC-1 through AC-7, unified capture model)
