...
| `test/03_system/feature/baremetal/ghdl_riscv32_mailbox_spec.spl` | Authoritative proof spec |

## Tests

| Spec File | Tests | Scope |
|-----------|-------|-------|
| `test/03_system/feature/baremetal/ghdl_riscv32_mailbox_spec.spl` | 9 | Smoke, hello world, negative cases, protocol contract |
