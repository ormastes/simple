...
Running 1 test file(s) [mode: interpreter]...
  ...
  PASS  test/01_unit/app/mcp/prompts_spec.spl (1 passed, 6ms)
...
Running 1 test file(s) [mode: interpreter]...
  ...
  PASS  test/01_unit/std/env_spec.spl (1 passed, 6ms)
...
Running 1 test file(s) [mode: interpreter]...
  ...
  PASS  test/01_unit/app/diagram/call_flow_profiling_spec.spl (1 passed, 4ms)
...
**Usage:** `test/01_unit/app/diagram/call_flow_profiling_spec.spl`
...
**Usage:** `test/01_unit/app/mcp/prompts_spec.spl`
...
1. **test/01_unit/app/mcp/prompts_spec.spl** - Line 6
   - Changed: `import app.mcp.prompts` → `use app.mcp.prompts.{PromptManager}`

2. **test/01_unit/app/diagram/call_flow_profiling_spec.spl** - Lines 12-19
