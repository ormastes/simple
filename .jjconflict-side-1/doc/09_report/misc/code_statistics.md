...
| Type | Count | Location |
|------|-------|----------|
| **Auto-generated docs** | 12 files | `doc/02_requirements/feature/`, `doc/test/`, `doc/build/` |
| **Design docs** | 50+ | `doc/05_design/` |
| **Research docs** | 80+ | `doc/01_research/` |
| **Guides** | 30+ | `doc/07_guide/` |
| **Reports** | 200+ | `doc/09_report/` |
