...
**User Guide** (`doc/07_guide/tensor_dimensions_guide.md`):
...
**Design Documentation** (`doc/05_design/tensor_dimensions_design.md`):
...
**Integration Tests** (`simple/std_lib/test/02_integration/ml/tensor_inference_integration.spl`):
...
**Module System Bug Report** (`doc/01_research/module_system_bug_report.md`):
...
### Integration Tests
```bash
./target/debug/simple simple/std_lib/test/02_integration/ml/tensor_inference_integration.spl
```
**Output:**
```
============================================================
...
| `test/02_integration/ml/tensor_inference_integration.spl` | 300 | Complete, all tests pass |
...
| `doc/07_guide/tensor_dimensions_guide.md` | 500 | Complete |
| `doc/05_design/tensor_dimensions_design.md` | 600 | Complete |
| `doc/01_research/module_system_bug_report.md` | 400 | Complete |
...
**Status**: Documented in `doc/01_research/module_system_bug_report.md`
...
### Documentation
- User Guide: `doc/07_guide/tensor_dimensions_guide.md`
- Design Doc: `doc/05_design/tensor_dimensions_design.md`
- Bug Report: `doc/01_research/module_system_bug_report.md`
