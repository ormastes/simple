...
3. **New Documentation:**
   - `doc/07_guide/compiler_warnings.md` - All warning types, suppression
   - `doc/07_guide/doc_coverage.md` - Using doc coverage tools
   - `doc/07_guide/code_quality.md` - Best practices for comments, docs

4. **Feature Tracking:**
   - Add to `doc/02_requirements/feature/feature.md` when complete
   - Update `doc/02_requirements/feature/feature_db.sdn` with new features
