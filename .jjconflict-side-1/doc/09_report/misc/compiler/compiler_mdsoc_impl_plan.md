...
>
> Design: `doc/01_research/compiler_mdsoc_design.md`
...
- See `doc/09_report/compiler_mdsoc_migration.md` for current status
...
See `doc/09_report/compiler_mdsoc_migration.md` for detailed current status.
