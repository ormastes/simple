...
- `doc/01_research/aop.md` (558 lines - NEW)
- `doc/01_research/aop_di_framework.md` (DELETED)
- `doc/01_research/sdn_self_hosting.md` (315 lines - NEW)

**Status in Current Main:** ✅ All present
- `doc/01_research/aop.md` exists (11K)
- `doc/01_research/sdn_self_hosting.md` exists (9.3K)
...
- `doc/06_spec/language_enhancement.md`
...
```bash
# Check for AOP spec
ls -lh doc/01_research/aop.md

# Check for SDN self-hosting spec  
ls -lh doc/01_research/sdn_self_hosting.md

# Check for concurrency modes in spec
grep "Concurrency Modes" doc/06_spec/language_enhancement.md
