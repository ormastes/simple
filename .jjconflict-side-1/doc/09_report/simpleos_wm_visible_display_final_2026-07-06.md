...
- PPM: build/simpleos_wm_visible_display_final_2026_07_06/qmp-visible-display.ppm 1024x768, nonblack=778426, unique_colors=20
- taskbar/item pixels: colored=18312, runs=7, sampled_regions=5
- cleanup: pass (pass; qemu=terminated, qmp_socket=absent)
- serial log: build/simpleos_wm_visible_display_final_2026_07_06/serial.log
- QEMU stderr: build/simpleos_wm_visible_display_final_2026_07_06/qemu.stderr.log
- command: `qemu-system-x86_64 -no-user-config -monitor none -net none -machine q35 -cpu qemu64 -m 2G -serial file:build/simpleos_wm_visible_display_final_2026_07_06/serial.log -display cocoa -no-reboot -kernel build/os/simpleos_wm_simple_web_check_32.elf -vga std -device isa-debug-exit,iobase=0xf4,iosize=0x04 -qmp unix:/tmp/simpleos_wm_visible_27534_qmp.sock,server,nowait`
