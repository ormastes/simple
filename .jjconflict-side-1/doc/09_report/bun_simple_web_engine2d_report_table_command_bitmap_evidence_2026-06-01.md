...
- best baseline frame us: 403
- baseline/simple speedup x1000: 80600
- simple ARGB path: build/bun_simple_web_engine2d_report_table_command_bitmap_evidence/simple-argb.json
- baseline ARGB path: build/bun_simple_web_engine2d_report_table_command_bitmap_evidence/bun-argb.json
...
- cache_hits=1000
- cache_stores=1
- argb_path=build/bun_simple_web_engine2d_report_table_command_bitmap_evidence/simple-argb.json
