...
- [ ] Write specs: `test/01_unit/testing/fuzz_spec.spl`
...
- [ ] Generate reports
- [ ] Write specs: `test/01_unit/testing/mutate_spec.spl`
...
```simple
# simple/std_lib/test/01_unit/compiler_core/list_fuzz_spec.spl
import std.fuzz
import std.spec
