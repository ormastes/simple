...
`doc/04_architecture/ui/shared_ui_contract.md` already defines `/api/test/*`,
...
- `src/os/services/llm/mcp_os_server.spl`
- `src/os/services/llm/tool_registry.spl`
- `test/01_unit/app/ui/access_spec.spl`
- `test/01_unit/os/services/llm/tool_registry_spec.spl`
