...
- `test/03_system/feature/baremetal/inline_asm_integration_spec.spl`
- `test/01_unit/compiler/backend/riscv32_asm_spec.spl`
- `test/01_unit/compiler/semantics/safety_checker_spec.spl`
- `test/03_system/features/baremetal/unsafe_spec.spl`
