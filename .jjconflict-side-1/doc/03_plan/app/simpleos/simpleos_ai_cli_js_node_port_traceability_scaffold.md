...
| AC-6 | SPipe specs/manuals | `test/03_system/..._spec.spl` and generated `doc/06_spec/...` scenario manual contain real assertions and no placeholder passes |
...
4. Add architecture:
   `doc/04_architecture/app/simpleos/simpleos_ai_cli_js_node_port.md`.
5. Add detail design:
