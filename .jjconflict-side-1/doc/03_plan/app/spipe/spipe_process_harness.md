...
|-------------|-----------|------------|
| REQ-001 | `test/01_unit/lib/spipe_process_harness/spipe_process_harness_spec.spl` | provider normalization and provider hook event lists |
| REQ-002 | `test/01_unit/lib/spipe_process_harness/spipe_process_harness_spec.spl` | JSONL hook envelope contains provider, event, session, model, and escaped raw payload |
| REQ-003 | `test/01_unit/lib/spipe_process_harness/spipe_process_harness_spec.spl` | deploy snippets exist for Claude, Codex, and Gemini with expected paths |
| REQ-004 | `test/03_system/app/spipe_process_harness/feature/spipe_process_harness_spec.spl` | HUD renders model, jj, commit, hr, week, and goal fields |
| REQ-005 | `test/01_unit/lib/spipe_process_harness/spipe_process_harness_spec.spl` | default and feature-specific state/event paths |
...
```bash
bin/release/simple test test/01_unit/lib/spipe_process_harness/spipe_process_harness_spec.spl --fail-fast
bin/release/simple test test/03_system/app/spipe_process_harness/feature/spipe_process_harness_spec.spl --fail-fast
```
