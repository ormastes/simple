...
**Related:** `doc/01_research/testing_infrastructure_comprehensive_2026.md`
...
- [ ] Documentation: `doc/07_guide/benchmarking.md`
...
- [ ] Documentation: `doc/07_guide/smoke_testing.md`
...
- [ ] Reset functionality
- [ ] Documentation: `doc/07_guide/mocking.md`
...
**For Each Feature:**
1. **Quick Start Guide** (`doc/07_guide/<feature>.md`)
   - Installation (if any)
   - Basic usage example
   - Common patterns
   - Troubleshooting
...
**For Each Feature:**
1. **Architecture Doc** (`doc/05_design/<feature>_architecture.md`)
   - Design decisions
   - Trade-offs
...
### Weekly Updates
**Format:** Markdown document in `doc/09_report/`
...
### Research Documents
- `doc/01_research/testing_infrastructure_comprehensive_2026.md` - Full analysis
- `doc/01_research/fuzzing_mutation_testing_2026.md` - Fuzzing/mutation research
- `doc/01_research/simple_fuzzing_mutation_design.md` - Simple-specific design
