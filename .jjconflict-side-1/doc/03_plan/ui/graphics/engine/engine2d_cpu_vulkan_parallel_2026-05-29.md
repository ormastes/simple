...
- Inspected `src/lib/gc_async_mut/gpu/engine2d/backend_cpu.spl`, `src/lib/gc_async_mut/gpu/engine2d/backend_vulkan.spl`, `src/lib/gc_async_mut/gpu/engine2d/engine.spl`, and focused `test/02_integration/rendering/engine2d_*_spec.spl` files.
...
- Added `test/02_integration/rendering/engine2d_cpu_vulkan_parity_spec.spl`.
...
- `timeout 120s bin/simple test test/02_integration/rendering/engine2d_drawing_spec.spl --mode=interpreter`
  - PASS: 2 passed, 0 failed, duration 945ms.
- `timeout 90s bin/simple test test/02_integration/rendering/engine2d_clip_spec.spl --mode=interpreter`
  - PASS: 3 passed, 0 failed, duration 687ms.
- `timeout 90s bin/simple test test/02_integration/rendering/engine2d_mask_spec.spl --mode=interpreter`
  - PASS: 3 passed, 0 failed, duration 692ms.
- `timeout 90s bin/simple test test/02_integration/rendering/engine2d_text_spec.spl --mode=interpreter`
  - PASS: 3 passed, 0 failed, duration 1051ms.
- `timeout 180s bin/simple test test/02_integration/rendering/engine2d_primitives_spec.spl --mode=interpreter`
