...
- `doc/05_design/parser_architecture_unified_2026-02-04.md` - Unified architecture design
...
Related:
- doc/01_research/parser_duplication_analysis_2026-02-04.md
- doc/05_design/parser_architecture_unified_2026-02-04.md
- doc/03_plan/parser_merge_plan_2026-02-04.md
EOF
...
- doc/04_architecture/parser_lexer_structure.md
EOF
...
**Check if exists:**
```bash
ls doc/04_architecture/file_tree.md
```
...
# - doc/04_architecture/parser_lexer_structure.md - Architecture guide
```
...
**Create:** `doc/07_guide/parser_migration_guide.md`
...
See:
- `doc/01_research/parser_duplication_analysis_2026-02-04.md` - Full analysis
- `doc/05_design/parser_architecture_unified_2026-02-04.md` - Architecture
```
...
**Check:**
- [ ] `doc/01_research/parser_duplication_analysis_2026-02-04.md` - Created ✅
- [ ] `doc/05_design/parser_architecture_unified_2026-02-04.md` - Created ✅
- [ ] `doc/03_plan/parser_merge_plan_2026-02-04.md` - Created ✅ (this file)
- [ ] `doc/04_architecture/parser_lexer_structure.md` - To be created
- [ ] `doc/07_guide/parser_migration_guide.md` - To be created
- [ ] `doc/04_architecture/file_tree.md` - To be updated (if exists)
...
- ✅ `doc/03_plan/parser_merge_plan_2026-02-04.md`
- [ ] `doc/04_architecture/parser_lexer_structure.md`
- [ ] `doc/07_guide/parser_migration_guide.md`
