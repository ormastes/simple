...
5. Run `sh scripts/check/check-riscv-rtl-linux-smoke.shs --check-tools`.
6. Run `sh scripts/check/check-riscv-rtl-linux-smoke.shs --rv32-only`.
7. Run `sh scripts/check/check-riscv-rtl-linux-smoke.shs --rv64-only`.
