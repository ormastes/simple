...
- `test/system/wm_compare/html_compat_spec.spl` checks manifest contents, fixture resolution, Chromium golden loading, and viewport mismatch diagnostics.
...
- `bin/simple test test/system/wm_compare/html_compat_spec.spl`
- `bin/simple test test/system/wm_compare/golden_gate_spec.spl`
