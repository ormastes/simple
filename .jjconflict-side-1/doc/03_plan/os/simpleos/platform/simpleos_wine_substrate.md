...
- `bin/simple test test/03_system/app/simpleos/feature/simpleos_wine_substrate_spec.spl`
- `bin/simple test test/01_unit/lib/common/wine_vm_adapter_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_posix_adapter_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_thread_adapter_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_dynload_adapter_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_service_adapter_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_precondition_manifest_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_precondition_fixture_builder_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_nt_api_catalog_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_nt_virtual_memory_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_nt_file_io_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_nt_thread_wait_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_nt_process_env_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_nt_heap_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/wine_ntdll_bridge_spec.spl --mode=interpreter --clean`
- `bin/simple test test/01_unit/lib/common/ui/wine_x11_adapter_spec.spl --mode=interpreter --clean`
