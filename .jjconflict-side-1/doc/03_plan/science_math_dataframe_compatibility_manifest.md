...
**Specs:** `test/03_system/feature/scilib/df_*_spec.spl`
...
Phase D changes must update this manifest and add or extend a `test/03_system/feature/scilib/df_*_spec.spl` file with:
