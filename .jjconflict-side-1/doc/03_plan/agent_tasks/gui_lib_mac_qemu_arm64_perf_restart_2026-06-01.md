...
- `src/app/gui_perf/linux_smf_dynlib_e2e_gate.spl` and
  `test/03_system/gui/linux_smf_dynlib_e2e_gate_system_spec.spl` now provide a
...
- `test/03_system/gui/macos_smf_dynlib_release_gate_system_spec.spl` runs the
...
SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/03_system/gui/linux_smf_dynlib_e2e_gate_system_spec.spl --mode=interpreter --no-cache --fail-fast
SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/03_system/gui/macos_smf_dynlib_release_gate_system_spec.spl --mode=interpreter --no-cache --fail-fast
...
SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/01_unit/os/posix/dynlib_spec.spl --mode=interpreter --no-cache
SIMPLE_LIB=src src/compiler_rust/target/debug/simple test test/01_unit/os/smf_runtime_spec.spl --mode=interpreter --no-cache
