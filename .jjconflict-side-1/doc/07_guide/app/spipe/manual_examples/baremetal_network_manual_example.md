...
<!-- Regenerate after Retry 15 admission: `bin/simple spipe-docgen --audience=qa test/03_system/app/nvme_firmware/nvme_nand_capture_spec.spl` -->
...
> emulated NAND write/read data and FTL block migration; it does not claim live
> device or wire captures. Retry 15 must complete before regenerating this file.
...
This manual is awaiting regeneration by `bin/simple spipe-docgen --audience=qa`
from `test/03_system/app/nvme_firmware/nvme_nand_capture_spec.spl` after Retry 15
admission. The executable spec captures emulated NAND state and FTL migration,
not live device/wire bytes.
