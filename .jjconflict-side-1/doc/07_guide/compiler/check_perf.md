...
| Simple `channel_new` | Bounded native compatibility channel | Capacity is 256 validated inline transfer packets; full, closed, and non-transferable sends fail. It is not evidence for heap-graph transfer or actor/process isolation. |
