...
2. A system variant entry in `test/03_system/os_filesystem_variants_spec.spl`.
...
- Add a new `FsSystemVariant` row in `test/03_system/os_filesystem_variants_spec.spl`.
...
| `test/03_system/os_filesystem_variants_spec.spl` | SPipe system matrix for FAT32 and NVFS variants |
