...
**Impact:** Fixes `test/01_unit/std/log_spec.spl` timeout
...
**Impact:** Fixes `test/01_unit/app/package/semver_spec.spl` timeout
...
**Impact:** Fixes `test/01_unit/app/mcp/prompts_spec.spl` timeout
...
|-----------|-------|-----|--------|
| test/01_unit/std/log_spec.spl | FFI at module init | Lazy initialization | ✅ Should pass* |
| test/01_unit/app/package/semver_spec.spl | Generic types | Tuples | ✅ Should pass* |
| test/01_unit/app/mcp/prompts_spec.spl | Type names | text/bool | ✅ Should pass* |
...
# bin/simple test test/01_unit/app/package/semver_spec.spl
