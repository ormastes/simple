...
<!-- sdn-diagram:id=memory_stress_small_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=memory_stress_small_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

memory_stress_small_spec -> std
```
...
```ascii generated-from=memory_stress_small_spec.arch hash=sha256:auto
