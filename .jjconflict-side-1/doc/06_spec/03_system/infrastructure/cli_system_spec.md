...
<!-- sdn-diagram:id=cli_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=cli_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=cli_system_spec.arch hash=sha256:auto
