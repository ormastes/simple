...
<!-- sdn-diagram:id=formatter_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=formatter_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

formatter_system_spec -> std
```
...
```ascii generated-from=formatter_system_spec.arch hash=sha256:auto
