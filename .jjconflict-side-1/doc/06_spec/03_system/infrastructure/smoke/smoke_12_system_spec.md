...
<!-- sdn-diagram:id=smoke_12_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=smoke_12_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

smoke_12_system_spec -> std
```
...
```ascii generated-from=smoke_12_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/infrastructure/smoke/smoke_12_system_spec.spl` |
| Updated | 2026-06-01 |
