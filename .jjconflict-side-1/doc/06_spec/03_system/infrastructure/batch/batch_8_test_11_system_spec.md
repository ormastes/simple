...
<!-- sdn-diagram:id=batch_8_test_11_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=batch_8_test_11_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

batch_8_test_11_system_spec -> std
```
...
```ascii generated-from=batch_8_test_11_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/infrastructure/batch/batch_8_test_11_system_spec.spl` |
| Updated | 2026-06-01 |
