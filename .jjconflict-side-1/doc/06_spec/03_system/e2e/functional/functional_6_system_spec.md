...
<!-- sdn-diagram:id=functional_6_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=functional_6_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

functional_6_system_spec -> std
```
...
```ascii generated-from=functional_6_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/e2e/functional/functional_6_system_spec.spl` |
| Updated | 2026-06-01 |
