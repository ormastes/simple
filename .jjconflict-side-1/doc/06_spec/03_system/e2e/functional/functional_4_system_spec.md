...
<!-- sdn-diagram:id=functional_4_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=functional_4_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

functional_4_system_spec -> std
```
...
```ascii generated-from=functional_4_system_spec.arch hash=sha256:auto
