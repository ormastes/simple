...
<!-- sdn-diagram:id=compiler_20_35_lsp_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compiler_20_35_lsp_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compiler_20_35_lsp_spec -> app
```
...
```ascii generated-from=compiler_20_35_lsp_spec.arch hash=sha256:auto
