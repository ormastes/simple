...
<!-- sdn-diagram:id=loss_nograd_blocks_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=loss_nograd_blocks_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

loss_nograd_blocks_spec -> std
```
...
```ascii generated-from=loss_nograd_blocks_spec.arch hash=sha256:auto
