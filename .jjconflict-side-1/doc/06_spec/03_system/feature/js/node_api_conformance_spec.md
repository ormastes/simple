...
<!-- sdn-diagram:id=node_api_conformance_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=node_api_conformance_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

node_api_conformance_spec -> std
```
...
```ascii generated-from=node_api_conformance_spec.arch hash=sha256:auto
...
| Category | Other |
| Status | Active |
| Source | `test/03_system/feature/js/node_api_conformance_spec.spl` |
| Updated | 2026-06-01 |
