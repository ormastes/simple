...
<!-- sdn-diagram:id=config_env_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=config_env_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=config_env_spec.arch hash=sha256:auto
