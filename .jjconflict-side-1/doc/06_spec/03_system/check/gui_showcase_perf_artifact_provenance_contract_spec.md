...
step("rejects symlinked retained showcase artifact paths")
...
# etc.) is incomplete -- which every synthetic single-row fixture in
# this spec always leaves incomplete. That is correct behavior of the
# aggregate gate, not a defect; the contract each case tests is
# captured entirely in evidence.env below, which the wrapper writes
# before it exits non-zero. See
...
```simple
# @req REQ-SSPEC-SYSTEM
step("keeps the aggregate wired to regular showcase artifact checks")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("prefers release self-hosted binaries before repo-bin shims for retained perf producer evidence")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects complete retained rows missing simple binary status")
...
val (_stdout, _stderr, code) = process_run("/bin/sh", ["-c", command])
# See the note above (line ~208) for why the wrapper's overall exit
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained rows using the Rust seed as the Simple binary")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained rows using repo-bin launcher provenance")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects forged release source labels on repo launcher paths")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects retained rows with truncated source revision file sets")
...
```simple
# @req REQ-SSPEC-SYSTEM
step("rejects hardlinked retained showcase artifact paths")
...
- Canonical SPipe generation for source `8ef467df94c3609b0fc0e886ae06393288001be9786739bd8828cc01cac740fb`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `8ef467df94c3609b0fc0e886ae06393288001be9786739bd8828cc01cac740fb`.
...
source: test/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.spl
mirror: doc/06_spec/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.md (current)
findings: 5 blockers: 0
  narrative=100 structure=100 oracle=100
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.spl:202:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'rejects symlinked retained showcase artifact paths' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.spl:247:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'keeps the aggregate wired to regular showcase artifact checks' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/03_system/check/gui_showcase_perf_artifact_provenance_contract_spec.spl:265:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'prefers release self-hosted binaries before repo-bin shims for retained perf producer evidence' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
