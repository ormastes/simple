...
- var cache = make empty cache
- cache store test
- new hashes["modified fn"] = make scope hash
- cache invalidate file test
   - Expected: result.? is false
...
- cache store test
- cache store test
- new hashes["changed fn"] = make scope hash
- cache invalidate file test
   - Expected: result.? is true
...
- cache store test
- cache store test
- new hashes a["fn a"] = make scope hash
- cache invalidate file test
...
expect(combined_ab).to_not_equal(combined_ba)
```
