...
<!-- sdn-diagram:id=electron_mdi_simple_bin_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=electron_mdi_simple_bin_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

electron_mdi_simple_bin_spec -> std
```
...
```ascii generated-from=electron_mdi_simple_bin_spec.arch hash=sha256:auto
