...
<!-- sdn-diagram:id=env_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=env_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

env_integration_spec -> std
```
...
```ascii generated-from=env_integration_spec.arch hash=sha256:auto
