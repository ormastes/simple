...
<!-- sdn-diagram:id=spawn_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=spawn_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=spawn_edge_spec.arch hash=sha256:auto
