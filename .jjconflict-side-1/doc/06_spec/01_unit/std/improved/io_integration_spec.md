...
<!-- sdn-diagram:id=io_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=io_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

io_integration_spec -> std
```
...
```ascii generated-from=io_integration_spec.arch hash=sha256:auto
