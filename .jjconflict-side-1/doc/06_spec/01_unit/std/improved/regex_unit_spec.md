...
<!-- sdn-diagram:id=regex_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=regex_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=regex_unit_spec.arch hash=sha256:auto
