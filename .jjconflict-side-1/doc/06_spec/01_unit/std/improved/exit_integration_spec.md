...
<!-- sdn-diagram:id=exit_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=exit_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

exit_integration_spec -> std
```
...
```ascii generated-from=exit_integration_spec.arch hash=sha256:auto
