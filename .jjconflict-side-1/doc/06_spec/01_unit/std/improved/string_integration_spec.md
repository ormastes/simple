...
<!-- sdn-diagram:id=string_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=string_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

string_integration_spec -> std
```
...
```ascii generated-from=string_integration_spec.arch hash=sha256:auto
