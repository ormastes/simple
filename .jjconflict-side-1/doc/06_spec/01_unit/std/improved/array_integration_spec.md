...
<!-- sdn-diagram:id=array_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=array_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

array_integration_spec -> std
```
...
```ascii generated-from=array_integration_spec.arch hash=sha256:auto
