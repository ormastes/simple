...
<!-- sdn-diagram:id=error_deep_12_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=error_deep_12_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

error_deep_12_spec -> std
```
...
```ascii generated-from=error_deep_12_spec.arch hash=sha256:auto
