...
<!-- sdn-diagram:id=macos_smf_dynlib_evidence_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=macos_smf_dynlib_evidence_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

macos_smf_dynlib_evidence_spec -> std
macos_smf_dynlib_evidence_spec -> app
```
...
```ascii generated-from=macos_smf_dynlib_evidence_spec.arch hash=sha256:auto
