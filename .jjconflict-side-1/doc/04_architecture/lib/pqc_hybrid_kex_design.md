...
Per `doc/04_architecture/lib/ssh_algorithm_catalog.md`, this entry should appear before
...
- `doc/04_architecture/lib/ssh_algorithm_catalog.md` — SSH algorithm catalog; PQC entry belongs here
