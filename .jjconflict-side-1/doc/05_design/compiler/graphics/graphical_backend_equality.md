...
`test/03_system/wm_compare/graphical_backend_equality_spec.spl` covers selector
...
`test/02_integration/rendering/graphical_backend_capture_spec.spl` covers the
