...
| ID | Task | File | Language |
|----|------|------|----------|
| 6.1 | End-to-end integration tests | `test/03_system/features/inference/link_inference_spec.spl` | Simple |
| 6.2 | Performance benchmarks | `test/05_perf/bench/inference_bench.spl` | Simple |
...
- Type Inference Design: `doc/05_design/type_inference.md`
