...
All test files live under `test/03_system/coverage/`. Each file targets one or
more source files from the coverage subsystem.

```
test/03_system/coverage/
...
Test fixture files live in `test/03_system/coverage/fixtures/`:
