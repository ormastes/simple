...
42 | fn str_len(s: text) -> i64:
   ...
   |
   = help: Add an sdoctest block in README.md or doc/07_guide/*.md
   = help: Example:
           ```simple
...
3. Add sdoctests to README.md or doc/07_guide/compiler.md
```
...
**Files to Create:**
- `test/01_unit/app/doc_coverage/export_parser_spec.spl`
- `test/01_unit/app/doc_coverage/compiler_warnings_spec.spl`
- `test/01_unit/app/doc_coverage/thresholds_spec.spl`
- `doc/07_guide/doc_coverage_thresholds.md`
