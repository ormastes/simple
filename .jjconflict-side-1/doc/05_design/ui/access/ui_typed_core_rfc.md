...
Audited:
- `test/01_unit/app/ui/gui_widgets_spec.spl` — placeholder tests only; no raw kind/layout/variant assertions
- `test/01_unit/app/ui/backend_matrix_spec.spl` — exactly **one** raw assertion at line 36: `expect(main.layout).to_equal("hbox")`
...
- `test/01_unit/app/ui/backend_matrix_spec.spl:36` — single raw layout string assertion
