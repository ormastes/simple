...
- Add [examples/09_embedded/simple_os/arch/riscv64/hosted_entry.spl](/home/ormastes/dev/pub/simple/examples/09_embedded/simple_os/arch/riscv64/hosted_entry.spl:1) as a dedicated preflight guest. It requires RV64 disk/media readability, prints explicit preflight markers, then prints explicit guest-network unavailability markers and stays alive for host probes.
