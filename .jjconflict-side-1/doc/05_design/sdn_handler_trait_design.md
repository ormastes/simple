...
**Security motivation:** See `doc/01_research/data_format_parser_security_2026-01-31.md` for attack vectors that trait separation mitigates.
...
See `doc/01_research/data_format_parser_security_2026-01-31.md` for full test cases:
...
**Next Steps:** See implementation plan in `doc/03_plan/sdn_handler_impl_plan.md`
