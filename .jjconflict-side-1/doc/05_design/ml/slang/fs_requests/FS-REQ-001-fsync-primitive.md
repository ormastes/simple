...
- **Date:** 2026-04-18
- **slang phase:** A2
- **Triggering code:** `src/lib/gc_async_mut/slang/nvfs_client/std_fs.spl:sync`,
  `src/app/slang_pack/main.spl:_do_pack`
...
- **Proposed mapping:** `fs_sync(obj, SyncScope.MediaDurable)` + a directory
  sync variant; see `doc/05_design/nvfs/slang_requirements.md` §R4.
