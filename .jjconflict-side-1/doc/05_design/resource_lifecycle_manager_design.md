...
21. **Test spec:** `test/01_unit/compiler/loader/generation_sweeper_spec.spl` — sweeper epoch advancement, mark used tracking, stale detection, stats, reset, lifecycle integration delegation. **DONE**
...
- **Loader lifecycle:** `test/01_unit/compiler/loader/resource_lifecycle_spec.spl`
...
- **Interpreter tracker:** `test/01_unit/compiler_core/interpreter/interp_resource_tracker_spec.spl`
...
- **Integration tests:** `test/01_unit/compiler/loader/leak_check_spec.spl`
