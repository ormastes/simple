...
| Spec File | Covers |
|-----------|--------|
| `test/integration/app/scv_wasm_executor_spec.spl` | PROD-001 AC-1 (a–e) + edge cases |
| `test/integration/app/scv_parser_rebuild_spec.spl` | PROD-002 AC-2 (a–c) + edge cases |
