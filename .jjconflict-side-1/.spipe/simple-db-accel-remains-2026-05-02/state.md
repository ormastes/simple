...
### Tests
- `test/05_perf/bench/db_accel_index/db_accel_index_spec.spl` — 20 regression tests for Phase 2
- `test/05_perf/bench/db_accel_planner/db_accel_planner_spec.spl` — 33 regression tests for Phase 3 (CostModel, PlanCost, estimate_cost, plan_query, pick_best, choose_plan)
