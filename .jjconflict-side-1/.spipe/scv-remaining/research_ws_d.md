...
- `test/02_integration/app/scv_mvp_spec.spl:8` — test title: "snapshots, detects
...
- `test/02_integration/app/scv_parser_binary_spec.spl:8` — "writes fallback binary
...
- `test/02_integration/app/scv_delta_pack_spec.spl:32` — "delta decoding reconstructs
...
- `test/02_integration/app/scv_mvp_spec.spl:8` — text file restore-op asserts
...
**Recommended action:** Add a test in `test/02_integration/app/scv_parser_binary_spec.spl`
...
- `test/02_integration/app/scv_wasm_executor_spec.spl:37` — "AC-1d: parser failures
  ...
  (lines 37–46)
- `test/02_integration/app/scv_gates_spec.spl:19` — "exposes parsed_error and rejects
...
- `test/02_integration/app/scv_network_remote_spec.spl` — describe "scv network remote
...
- `test/02_integration/app/scv_gates_spec.spl:37` — "exports public artifacts only
...
- `test/02_integration/app/scv_gates_spec.spl:94` — "pushes public artifacts to a
  filesystem remote only after public_ready"
- `test/02_integration/app/scv_public_remote_spec.spl` — 7 examples covering public
...
Add to `test/02_integration/app/scv_storage_spec.spl`:
...
Add to `test/02_integration/app/scv_parser_binary_spec.spl`:
