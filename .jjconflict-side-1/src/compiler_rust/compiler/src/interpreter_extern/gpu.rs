...
use simple_runtime::cuda_runtime::{
    ...
    rt_cuda_get_error_string, rt_cuda_init, rt_cuda_launch_kernel, rt_cuda_mem_alloc, rt_cuda_mem_free,
    rt_cuda_memcpy_dtoh, rt_cuda_memcpy_dtod, rt_cuda_memcpy_htod, rt_cuda_memset, rt_cuda_module_get_function,
    rt_cuda_module_load, rt_cuda_module_load_data, rt_cuda_module_unload, rt_cuda_sync,
};
