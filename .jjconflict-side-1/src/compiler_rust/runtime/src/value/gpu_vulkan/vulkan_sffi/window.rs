//! Vulkan window management SFFI
//!
//! Provides SFFI functions for creating and managing Vulkan windows with surface support.
...
/// This function is called by all window management SFFI functions.
///
/// # Safety
/// Safe to call from SFFI context. Uses thread-safe globals with proper locking.
#[cfg(feature = "vulkan")]
...
/// Serialize a WindowEvent into SFFI-compatible format
///
/// Converts window events into output parameters suitable for SFFI consumption.
...
///
/// # Safety
/// Safe to call from SFFI. The title pointer must be valid UTF-8 if non-null.
#[no_mangle]
...
///
/// # Safety
/// Safe to call from SFFI. Handle should be valid and not previously destroyed.
#[no_mangle]
...
///
/// # Safety
/// Safe to call from SFFI. May trigger window state changes and event notifications.
#[no_mangle]
...
///
/// # Safety
/// Safe to call from SFFI. Output pointers must be valid. Data buffer must be large enough
