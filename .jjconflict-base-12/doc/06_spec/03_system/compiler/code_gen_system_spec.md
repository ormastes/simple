...
<!-- sdn-diagram:id=code_gen_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=code_gen_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

code_gen_system_spec -> std
```
...
```ascii generated-from=code_gen_system_spec.arch hash=sha256:auto
