...
### Test Files
```
simple/std_lib/test/01_unit/ui/
├── README.md                    # Test documentation
├── tui_renderer_spec.spl       # TUI renderer tests (20 test cases)
└── vulkan_renderer_spec.spl    # Vulkan renderer tests (20 test cases)
```

**Note:** Tests were initially created in `test/03_system/ui/` but moved to `test/01_unit/ui/` following CLAUDE.md test structure guidelines:
...
```bash
# TUI renderer tests
./target/debug/simple simple/std_lib/test/01_unit/ui/tui_renderer_spec.spl

# Vulkan renderer tests
./target/debug/simple simple/std_lib/test/01_unit/ui/vulkan_renderer_spec.spl
```
...
- `simple/std_lib/test/03_system/ui/README.md` (290 lines)
  - Test overview
...
- TUI tests: `simple/std_lib/test/01_unit/ui/tui_renderer_spec.spl`
- Vulkan tests: `simple/std_lib/test/01_unit/ui/vulkan_renderer_spec.spl`
- Test docs: `simple/std_lib/test/01_unit/ui/README.md`
