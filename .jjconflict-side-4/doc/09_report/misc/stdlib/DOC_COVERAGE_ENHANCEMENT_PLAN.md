...
2. Create user guide: `doc/07_guide/doc_coverage.md`
...
**Deliverables:**
- `doc/05_design/doc_coverage_complete_design.md`
- `doc/07_guide/doc_coverage_user_guide.md`
- Updated `CLAUDE.md`
...
**Deliverables:**
- Test files in `test/01_unit/app/doc_coverage/`
- Test files in `test/01_unit/app/stats/`
- All tests passing
