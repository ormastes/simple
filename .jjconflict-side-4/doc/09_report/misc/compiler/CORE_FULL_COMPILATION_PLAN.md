...
simple test test/01_unit/compiler/lexer_spec.spl
```
...
- **Architecture:** [doc/05_design/core_full_unified_architecture.md](doc/05_design/core_full_unified_architecture.md)
