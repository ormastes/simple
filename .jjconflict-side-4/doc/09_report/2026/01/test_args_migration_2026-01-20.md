...
### 2. Tests
**File:** `simple/std_lib/test/01_unit/tooling/test_args_spec.spl` (5 lines - basic)
...
### ✅ Basic Test
```bash
$ ./target/debug/simple test simple/std_lib/test/01_unit/tooling/test_args_spec.spl
test_args module
