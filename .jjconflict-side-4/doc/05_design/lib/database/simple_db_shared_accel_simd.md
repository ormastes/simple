...
- `test/05_perf/bench/simple_db_shared_accel.spl` records current perf evidence.
...
- Perf baseline script: `test/05_perf/bench/simple_db_shared_accel.spl`
- Perf evidence: `doc/09_report/verify/simple_db_shared_accel_perf_2026-05-02.md`

## Deferred

Tracked separately in `doc/08_tracking/feature/simple_db_requests.md`:
