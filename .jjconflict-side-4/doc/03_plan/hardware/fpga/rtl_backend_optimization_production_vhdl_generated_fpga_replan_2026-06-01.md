...
```bash
bin/simple test test/01_unit/hardware/fpga_linux/riscv_fpga_linux_spec.spl
bin/simple test test/03_system/app/hardware/feature/riscv_fpga_linux_spec.spl
bin/simple test test/03_system/app/hardware/feature/rv64_linux_rtl_pipeline_spec.spl
bin/simple test test/01_unit/compiler/lint/riscv_rtl_debuggability_spec.spl
...
- Update `doc/07_guide/hardware/riscv/simple_generated_fpga_rtl.md` whenever generated lane semantics change.
- Update `doc/07_guide/hardware/fpga/kv260_rv64gc_fpga_boot.md` after each physical KV260 run.
- Keep `.spipe/rtl-backend-optimization-production-vhdl/state.md` evidence current.
- Before release/push, rerun:

```bash
bin/simple test test/01_unit/hardware/fpga_linux/check_riscv_rtl_linux_smoke_spec.spl
bin/simple test test/01_unit/hardware/fpga_linux/riscv_fpga_linux_spec.spl
bin/simple test test/03_system/app/hardware/feature/riscv_fpga_linux_spec.spl
bin/simple test test/03_system/app/hardware/feature/rv64_linux_rtl_pipeline_spec.spl
bin/simple test test/01_unit/compiler/lint/riscv_rtl_debuggability_spec.spl
