...
| `test/02_integration/rendering/engine2d_backend_provenance_matrix_spec.spl` | REQ-005,007,008 | Facade-only translation labels, native/emulated naming, strict fallback rejection |
| `test/02_integration/rendering/engine2d_render_surface_matrix_spec.spl` | REQ-011 | Frozen 4x3 absolute oracle across 100 presented/read-back frames |
...
| Aggregate external row `simpleos_guest` | REQ-016,018 | Blocked until strict x86 VirtIO plus retained x86/RV64/ARM64 guest receipts and exact captures exist |
...
| Aggregate external row `simpleos_simd` | REQ-020,021 | Blocked until 3-arch x10-boot fill/copy/alpha/scroll native receipts and exact scalar/QMP pixels exist |
...
- Generated manuals mirror all thirteen executable specs and report zero stubs.
