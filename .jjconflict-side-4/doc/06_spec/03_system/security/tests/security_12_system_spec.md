...
<!-- sdn-diagram:id=security_12_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=security_12_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

security_12_system_spec -> std
```
...
```ascii generated-from=security_12_system_spec.arch hash=sha256:auto
