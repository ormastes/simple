...
- See `doc/02_requirements/feature/mdsoc_complete.md` and `doc/09_report/compiler_mdsoc_migration.md` for current state
...
- [ ] Create migration tracking in `doc/09_report/compiler_mdsoc_migration.md`
...
```simple
# test/01_unit/compiler/entity/ast/expr_spec.spl
...
```simple
# test/01_unit/compiler/feature/type_checking/type_checker_spec.spl
...
```simple
# test/01_unit/compiler/transform/typing_to_hir/TypedAstView_spec.spl
...
```simple
# test/02_integration/compiler/pipeline/
...
- `doc/01_research/mdsoc_design.md` — MDSoC dimension system design
- `doc/07_guide/standard_architecture.md` — Standard Simple architecture
- `doc/07_guide/dimension_transform_examples.md` — Transform pattern examples
- `doc/07_guide/transform_init_examples.md` — `__init__.spl` configuration examples
- `doc/02_requirements/feature/mdsoc_complete.md` — Implementation status (288 tests passing)
- `doc/09_report/compiler_mdsoc_migration.md` — Migration tracking
- `doc/09_report/compiler_mdsoc_impl_plan.md` — Implementation plan with phase status
