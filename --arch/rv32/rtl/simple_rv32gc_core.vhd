                                        ...
                                        if decode_execute_alu_op = "1111" then
                                            case instr_word_v(14 downto 12) is
                                                ...
                                                when "100" =>
                                                    ...
                                                    elsif regs(rs1_i) = x"80000000" and regs(rs2_i) = x"FFFFFFFF" then
                            ...
                            when "1011" =>
                                if instr_word_v(14 downto 12) = "000" then
                                    ...
                                    case instr_word_v(31 downto 20) is
                                        when x"100" => csr_old_val := csr_mstatus_reg and x"800DE133";
                                        when x"301" => csr_old_val := x"40141105";
                                    ...
                                    if trap_reg = '0' then
                                        ...
                                        case instr_word_v(14 downto 12) is
                                            when "001" | "010" | "011" | "101" | "110" | "111" =>
                                                case instr_word_v(31 downto 20) is
                                                    when x"100" => csr_mstatus_reg <= (csr_mstatus_reg and (not x"800DE133")) or (csr_new_val and x"800DE133");
