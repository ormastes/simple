...
architecture sim of tb_generated_rv64_boot_banner is
    ...
    begin
        return bytes(0) = x"53" and bytes(1) = x"69" and bytes(2) = x"6D" and
            bytes(3) = x"70" and bytes(4) = x"6C" and bytes(5) = x"65" and
            bytes(6) = x"4F" and bytes(7) = x"53" and bytes(8) = x"20" and
            bytes(9) = x"52" and bytes(10) = x"56" and bytes(11) = x"36" and
            bytes(12) = x"34" and bytes(13) = x"0D" and bytes(14) = x"0A";
    end function;
