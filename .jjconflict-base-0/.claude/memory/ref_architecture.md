...
and then copied to `bin/simple`. See `scripts/setup/setup.shs` `preferred_runtime`
...
Doc authority: `doc/04_architecture/compiler/mdsoc/mdsoc_architecture_tobe.md` §Part 3 and `doc/glossary.md` (MDSOC+ / ECS terms).
