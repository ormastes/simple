...
Tech Lead -- Refactor for quality: deduplication, file splitting, clean code.
...
- `/refactor` -- Incremental quality refactoring
...
```
Read tools/claude-plugin/sstack-refactor/agents/refactor.md and use its rules to refactor <feature>
```
