...
See `doc/07_guide/directory_structure.md` for full script content.
...
1. Write comprehensive testing guide (`doc/07_guide/testing.md`)
2. Create directory structure quick reference (`doc/07_guide/directory_structure.md`)
