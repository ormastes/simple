...
- `test/01_unit/os/qemu_runner_spec.spl` covers selected mode in command/catalog
  construction.
...
- `test/01_unit/os/drivers/real_device_readiness_spec.spl` proves model/SFFI RDMA
