...
and path-based read/write helpers. `test/01_unit/os/services/vfs/vfs_spec.spl`
...
`test/01_unit/os/port/host_fat32_tree_populator_spec.spl`, which proves the AI CLI
