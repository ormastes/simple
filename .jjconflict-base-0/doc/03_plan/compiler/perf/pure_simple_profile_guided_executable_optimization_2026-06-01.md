...
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple check \
  src/app/optimize/sprof_loader.spl \
  src/app/optimize/profile_layout_cli.spl \
  test/03_system/app/optimize/feature/sprof_loader_spec.spl \
  test/03_system/app/optimize/feature/profile_layout_cli_spec.spl

SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test \
  test/03_system/app/optimize/feature/sprof_loader_spec.spl --fail-fast

SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test \
  test/03_system/app/optimize/feature/profile_layout_cli_spec.spl --fail-fast

SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test \
  test/03_system/app/compile/feature/native_profile_counter_spec.spl --fail-fast

SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test \
  test/03_system/app/optimize/feature/pure_simple_executable_layout_spec.spl --fail-fast

SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test \
  test/03_system/os/baremetal/feature/breakpoint_counter_profile_spec.spl --fail-fast
...
- `test/03_system/app/compile/feature/native_profile_counter_spec.spl`
...
- `test/03_system/app/compile/feature/native_layout_section_map_spec.spl`
...
- `src/app/optimize/profile_layout_cli.spl`
  ...
  - rejects native evidence when the optimized binary does not prove
    ...
    counter symbols.
- `test/03_system/app/optimize/feature/profile_layout_native_smoke_spec.spl`
...
- `test/03_system/os/baremetal/feature/breakpoint_counter_target_adapter_spec.spl`
...
- `test/03_system/os/baremetal/feature/breakpoint_counter_probe_image_spec.spl`
...
git status --short -- \
  ...
  test/03_system/app/optimize/feature/sprof_loader_spec.spl \
  test/03_system/app/optimize/feature/profile_layout_cli_spec.spl \
  test/03_system/app/optimize/feature/pure_simple_executable_layout_spec.spl \
  test/03_system/app/compile/feature/native_profile_counter_spec.spl \
  test/03_system/os/baremetal/feature/breakpoint_counter_profile_spec.spl
```
...
`test/03_system/app/optimize/feature/sprof_loader_spec.spl`. Native metadata plus
...
Contract coverage exists at
`test/03_system/app/compile/feature/native_profile_counter_spec.spl`. Command-level
...
`test/03_system/app/optimize/feature/profile_layout_native_smoke_spec.spl` and
...
`test/03_system/os/baremetal/feature/breakpoint_counter_profile_spec.spl`. The
...
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple check test/03_system/app/optimize/feature/sprof_loader_spec.spl test/03_system/app/compile/feature/native_profile_counter_spec.spl test/03_system/app/optimize/feature/pure_simple_executable_layout_spec.spl test/03_system/os/baremetal/feature/breakpoint_counter_profile_spec.spl
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/03_system/os/baremetal/feature/breakpoint_counter_target_adapter_spec.spl --fail-fast
SIMPLE_LIB=src src/compiler_rust/target/bootstrap/simple test test/01_unit/compiler/interpreter/tiered_jit_hotspot_spec.spl --mode=interpreter --clean
find doc/06_spec -name '*_spec.spl' | wc -l
git diff --check
```
