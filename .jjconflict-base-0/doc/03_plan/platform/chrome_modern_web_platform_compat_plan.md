...
- Executable SPipe acceptance tests: `test/03_system/app/lib/feature/chrome_modern_web_platform_compat_spec.spl`
...
- `test/03_system/feature/web_platform/`
...
- `test/09_baselines/web_platform_subset/`
