...
- `doc/04_architecture/science_math_lib_set.md`
...
4. Inspect `test/feature/scilib/` to map existing spec names to plan phases.
...
3. Add error paths for rank mismatch, shape mismatch, out-of-bounds access, and
   unsupported dtype.
4. Run all NDArray specs under `test/feature/scilib/ndarray_*_spec.spl`.
...
- `test/feature/scilib/blas_axpy_spec.spl`
- `test/feature/scilib/blas_gemm_spec.spl`
- `test/feature/scilib/linalg_backend_diagnostics_spec.spl`
- `test/feature/scilib/linalg_openblas_backend_spec.spl` when backend exists
...
- `test/feature/scilib/lapack_gesv_spec.spl`
- `test/feature/scilib/lapack_inv_spec.spl`
- `test/feature/scilib/lapack_det_spec.spl`
- `test/feature/scilib/linalg_norm_spec.spl`
...
- `test/feature/scilib/cuda_device_buffer_spec.spl`
- `test/feature/scilib/linalg_cuda_backend_spec.spl`
- existing CUDA unit/integration tests under `test/unit/lib/extended/`
...
4. Run `test/feature/scilib/math_block_matmul_spec.spl`.
...
bin/simple test test/feature/scilib/ndarray_create_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/blas_axpy_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/blas_gemm_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/lapack_gesv_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/lapack_inv_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/linalg_backend_diagnostics_spec.spl --mode=interpreter --clean
...
```bash
bin/simple test test/feature/scilib/linalg_openblas_backend_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/linalg_cuda_backend_spec.spl --mode=interpreter --clean
bin/simple test test/feature/scilib/cuda_device_buffer_spec.spl --mode=interpreter --clean
```
