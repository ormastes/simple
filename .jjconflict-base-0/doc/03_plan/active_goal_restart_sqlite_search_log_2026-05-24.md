...
- Still missing: broader app entrypoint rollout and replacement of broader skipped app-level log specs.
 ...
 - The legacy `simple vscode-extension-old` path and its dedicated log-mode spec were retired when `src/app/vscode_extension_old` was removed; old-only VS Code extension follow-ups now live in `doc/02_requirements/feature/vscode_extension_old_feature_requests.md`.
