...
```bash
./src/compiler_rust/target/debug/simple test test/02_integration/debug/hardware/t32_native_spec.spl --leak=off
./src/compiler_rust/target/debug/simple test test/02_integration/debug/hardware/t32_gdb_bridge_spec.spl --leak=off
./src/compiler_rust/target/debug/simple test test/02_integration/debug/hardware/t32_semihost_hello_spec.spl --leak=off
./src/compiler_rust/target/debug/simple test test/02_integration/debug/hardware/hardware_check_spec.spl --leak=off
```
