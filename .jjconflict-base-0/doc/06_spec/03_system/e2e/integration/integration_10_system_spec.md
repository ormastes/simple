...
<!-- sdn-diagram:id=integration_10_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=integration_10_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

integration_10_system_spec -> std
```
...
```ascii generated-from=integration_10_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/e2e/integration/integration_10_system_spec.spl` |
| Updated | 2026-06-01 |
