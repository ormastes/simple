...
<!-- sdn-diagram:id=ast_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=ast_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=ast_system_spec.arch hash=sha256:auto
...
| Difficulty | 5/5 |
| Status | Implemented |
| Source | `test/03_system/compiler/ast_system_spec.spl` |
| Updated | 2026-06-01 |
