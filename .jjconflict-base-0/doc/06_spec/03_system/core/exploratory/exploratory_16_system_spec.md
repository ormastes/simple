...
<!-- sdn-diagram:id=exploratory_16_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=exploratory_16_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

exploratory_16_system_spec -> std
```
...
```ascii generated-from=exploratory_16_system_spec.arch hash=sha256:auto
