...
<!-- sdn-diagram:id=path_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=path_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

path_system_spec -> std
```
...
```ascii generated-from=path_system_spec.arch hash=sha256:auto
