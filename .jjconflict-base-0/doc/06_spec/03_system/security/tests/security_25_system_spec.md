...
<!-- sdn-diagram:id=security_25_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=security_25_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

security_25_system_spec -> std
```
...
```ascii generated-from=security_25_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/security/tests/security_25_system_spec.spl` |
| Updated | 2026-06-01 |
