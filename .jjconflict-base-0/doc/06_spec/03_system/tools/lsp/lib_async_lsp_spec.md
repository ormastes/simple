...
<!-- sdn-diagram:id=lib_async_lsp_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=lib_async_lsp_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

lib_async_lsp_spec -> app
```
...
```ascii generated-from=lib_async_lsp_spec.arch hash=sha256:auto
