...
<!-- sdn-diagram:id=arm64_wm_qemu_contract_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=arm64_wm_qemu_contract_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

arm64_wm_qemu_contract_spec -> std
arm64_wm_qemu_contract_spec -> os
```
...
```ascii generated-from=arm64_wm_qemu_contract_spec.arch hash=sha256:auto
...
expect(scenario_opt != nil).to_equal(true)
if scenario_opt == nil:
    return
