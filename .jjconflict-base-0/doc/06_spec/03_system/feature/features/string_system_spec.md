...
<!-- sdn-diagram:id=string_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=string_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

string_system_spec -> std
```
...
```ascii generated-from=string_system_spec.arch hash=sha256:auto
...
| Difficulty | 5/5 |
| Status | Implemented |
| Source | `test/03_system/feature/features/string_system_spec.spl` |
| Updated | 2026-06-01 |
