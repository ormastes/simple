...
<!-- sdn-diagram:id=batch_10_test_4_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=batch_10_test_4_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

batch_10_test_4_system_spec -> std
```
...
```ascii generated-from=batch_10_test_4_system_spec.arch hash=sha256:auto
