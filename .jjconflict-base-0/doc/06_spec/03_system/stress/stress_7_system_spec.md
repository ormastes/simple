...
<!-- sdn-diagram:id=stress_7_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=stress_7_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

stress_7_system_spec -> std
```
...
```ascii generated-from=stress_7_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/stress/stress_7_system_spec.spl` |
| Updated | 2026-06-01 |
