...
<!-- sdn-diagram:id=simpleos_wine_process_thunk_apply_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=simpleos_wine_process_thunk_apply_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

simpleos_wine_process_thunk_apply_spec -> common
```
...
```ascii generated-from=simpleos_wine_process_thunk_apply_spec.arch hash=sha256:auto
...
#### should write modeled KERNEL32 procedure addresses into known thunk slots
...
#### should reject thunk byte patching before record planning passes
...
#### should prepare patched image bytes before known-console dispatch
...
#### should block patched image preflight without image bytes before CPU evidence is complete
...
#### should block patched image preflight without image bytes when record planning rejects
