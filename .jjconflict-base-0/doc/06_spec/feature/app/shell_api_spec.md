...
> ```bash
> bin/simple spipe-docgen test/03_system/feature/app/shell_api_spec.spl
> ```
...
**View full specification:** [shell_api_spec.spl](../../test/03_system/feature/app/shell_api_spec.spl)
