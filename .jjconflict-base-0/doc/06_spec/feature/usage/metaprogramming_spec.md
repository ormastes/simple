...
> ```bash
> bin/simple spipe-docgen test/03_system/feature/usage/metaprogramming_spec.spl
> ```
...
**Note:** This is a test extraction file. For complete specification text,
design rationale, and architecture, see doc/06_spec/feature/usage/metaprogramming_spec.md
...
|---|------|---------|---------|
| 1 | [dsl_features_1](#dsl_features_1) | DSL Features | `Features`, `features`, `DslFeatures` +16 |
| 2 | [dsl_features_2](#dsl_features_2) | DSL Features | `Features`, `features`, `DslFeatures` +11 |
| 3 | [decorators_and_attributes_3](#decorators_and_attributes_3) | Decorators and Attributes | `decorators`, `DecoratorsAndAttributes`, `and` +13 |
| 4 | [decorators_and_attributes_4](#decorators_and_attributes_4) | Decorators and Attributes | `decorators`, `DecoratorsAndAttributes`, `and` +16 |
| 5 | [decorators_and_attributes_5](#decorators_and_attributes_5) | Decorators and Attributes | `decorators`, `DecoratorsAndAttributes`, `and` +14 |
| 6 | [comprehensions_6](#comprehensions_6) | Comprehensions | `Comprehensions`, `comprehensions`, `Nested` +5 |
| 7 | [comprehensions_7](#comprehensions_7) | Comprehensions | `Comprehensions`, `comprehensions`, `assert_compiles` |
| 8 | [slicing_and_indexing_8](#slicing_and_indexing_8) | Slicing and Indexing | `SlicingAndIndexing`, `and`, `slicing_and_indexing` +6 |
| 9 | [slicing_and_indexing_9](#slicing_and_indexing_9) | Slicing and Indexing | `SlicingAndIndexing`, `and`, `slicing_and_indexing` +6 |
| 10 | [slicing_and_indexing_10](#slicing_and_indexing_10) | Slicing and Indexing | `SlicingAndIndexing`, `and`, `slicing_and_indexing` +7 |
| 11 | [slicing_and_indexing_11](#slicing_and_indexing_11) | Slicing and Indexing | `SlicingAndIndexing`, `and`, `slicing_and_indexing` +6 |
| 12 | [enhanced_pattern_matching_12](#enhanced_pattern_matching_12) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +6 |
| 13 | [enhanced_pattern_matching_13](#enhanced_pattern_matching_13) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +8 |
| 14 | [enhanced_pattern_matching_14](#enhanced_pattern_matching_14) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +6 |
| 15 | [enhanced_pattern_matching_15](#enhanced_pattern_matching_15) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +8 |
| 16 | [enhanced_pattern_matching_16](#enhanced_pattern_matching_16) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +15 |
| 17 | [enhanced_pattern_matching_17](#enhanced_pattern_matching_17) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +12 |
| 18 | [enhanced_pattern_matching_18](#enhanced_pattern_matching_18) | Enhanced Pattern Matching | `enhanced_pattern_matching`, `Enhanced`, `pattern` +6 |
| 19 | [context_managers_19](#context_managers_19) | Context Managers | `context_managers`, `Context`, `Managers` +8 |
| 20 | [context_managers_20](#context_managers_20) | Context Managers | `context_managers`, `Context`, `Managers` +11 |
| 21 | [create_counter](#create_counter) | Move Closures | `Counter`, `CreateCounter`, `Create` +3 |
| 22 | [move_closures_22](#move_closures_22) | Move Closures | `Move`, `closures`, `move` +8 |
| 23 | [error_handling_23](#error_handling_23) | Error Handling | `handling`, `Error`, `ErrorHandling` +7 |
| 24 | [process_file](#process_file) | Error Handling | `process`, `process_file`, `file` +11 |
...
**View full specification:** [metaprogramming_spec.spl](../../test/03_system/feature/usage/metaprogramming_spec.spl)
