...
| Source | `test/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.spl` |
| Updated | 2026-08-26 |
...
- Canonical SPipe generation for source `2dbf673e0c65602e8f2b3cc126b01031b6e3cdb0a0ddcb3cc86f8a0df9577aeb`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `2dbf673e0c65602e8f2b3cc126b01031b6e3cdb0a0ddcb3cc86f8a0df9577aeb`.
...
source: test/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.spl
mirror: doc/06_spec/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: audience, scope, assumptions/preconditions, primary workflow, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 7 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.spl:43:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'loads without a single parse error' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.spl:51:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'declares all 7 MirTerminator variants — Missing is empty' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/unit/compiler/transition/mir_terminator_to_interp_coverage_spec.spl:62:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'names every terminator the interpreter executes' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
