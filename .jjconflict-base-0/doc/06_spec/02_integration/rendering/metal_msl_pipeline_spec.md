...
<!-- sdn-diagram:id=metal_msl_pipeline_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=metal_msl_pipeline_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

metal_msl_pipeline_spec -> std
```
...
```ascii generated-from=metal_msl_pipeline_spec.arch hash=sha256:auto
...
| Category | Other |
| Status | Active |
| Source | `test/02_integration/rendering/metal_msl_pipeline_spec.spl` |
| Updated | 2026-06-01 |
