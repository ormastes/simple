...
| Status | Active |
| Source | `test/02_integration/app/scv_editor_ipc_spec.spl` |
| Updated | 2026-08-26 |
...
step("opens a buffer whose bytes override the disk read")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("applies edits to the open buffer, including tabs and newlines")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("brackets saves: save_begin marks the path expected until save_end")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("renames a path and moves the buffer with it")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("groups refactor entities into one transaction")
...
```simple
# @req REQ-SSPEC-INTEGRATION
step("flush drains pending events and closes buffers deliberately")
...
- Canonical SPipe generation for source `b3ced563a59dc203d082b63a955c78f1c22b946941f6237b90294d5adf110a9e`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `b3ced563a59dc203d082b63a955c78f1c22b946941f6237b90294d5adf110a9e`.
...
source: test/02_integration/app/scv_editor_ipc_spec.spl
mirror: doc/06_spec/02_integration/app/scv_editor_ipc_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=70
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/02_integration/app/scv_editor_ipc_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/02_integration/app/scv_editor_ipc_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/02_integration/app/scv_editor_ipc_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-30): 6 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/02_integration/app/scv_editor_ipc_spec.spl:37:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'opens a buffer whose bytes override the disk read' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/scv_editor_ipc_spec.spl:53:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'applies edits to the open buffer, including tabs and newlines' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/02_integration/app/scv_editor_ipc_spec.spl:66:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'brackets saves: save_begin marks the path expected until save_end' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
