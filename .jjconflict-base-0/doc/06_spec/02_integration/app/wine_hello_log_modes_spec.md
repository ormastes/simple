# Wine Hello Log Modes Specification

> <details>

<!-- sdn-diagram:id=wine_hello_log_modes_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=wine_hello_log_modes_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

wine_hello_log_modes_spec -> std
```
...
```ascii generated-from=wine_hello_log_modes_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/02_integration/app/wine_hello_log_modes_spec.spl` |
| Updated | 2026-06-01 |
