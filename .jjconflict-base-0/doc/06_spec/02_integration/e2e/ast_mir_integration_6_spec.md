...
<!-- sdn-diagram:id=ast_mir_integration_6_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=ast_mir_integration_6_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

ast_mir_integration_6_spec -> std
```
...
```ascii generated-from=ast_mir_integration_6_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/02_integration/e2e/ast_mir_integration_6_spec.spl` |
| Updated | 2026-06-01 |
