...
<!-- sdn-diagram:id=compilation_stress_medium_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compilation_stress_medium_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compilation_stress_medium_spec -> std
```
...
```ascii generated-from=compilation_stress_medium_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/05_perf/stress/compilation_stress_medium_spec.spl` |
| Updated | 2026-06-01 |
