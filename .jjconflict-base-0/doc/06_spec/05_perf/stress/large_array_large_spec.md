...
<!-- sdn-diagram:id=large_array_large_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=large_array_large_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

large_array_large_spec -> std
```
...
```ascii generated-from=large_array_large_spec.arch hash=sha256:auto
