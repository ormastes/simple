...
<!-- sdn-diagram:id=file_stress_medium_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=file_stress_medium_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

file_stress_medium_spec -> std
```
...
```ascii generated-from=file_stress_medium_spec.arch hash=sha256:auto
