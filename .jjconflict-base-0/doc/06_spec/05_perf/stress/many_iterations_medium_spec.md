...
<!-- sdn-diagram:id=many_iterations_medium_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=many_iterations_medium_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

many_iterations_medium_spec -> std
```
...
```ascii generated-from=many_iterations_medium_spec.arch hash=sha256:auto
