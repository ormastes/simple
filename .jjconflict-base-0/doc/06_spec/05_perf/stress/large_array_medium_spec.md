...
<!-- sdn-diagram:id=large_array_medium_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=large_array_medium_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

large_array_medium_spec -> std
```
...
```ascii generated-from=large_array_medium_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/05_perf/stress/large_array_medium_spec.spl` |
| Updated | 2026-06-01 |
