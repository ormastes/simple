...
- expect policy is open
- expect not policy is boundary
- expect not policy is bypass
...
- expect not policy is open
- expect policy is boundary
- expect not policy is bypass
...
- expect AccessPolicy Open to string
...
- expect AccessPolicy Boundary to string
...
- expect AccessPolicy Bypass to string
...
- var outer = DirManifest new
- outer add export
- var inner = DirManifest new
- inner add child
- expect check access
- expect not check access
...
- expect effective access policy
