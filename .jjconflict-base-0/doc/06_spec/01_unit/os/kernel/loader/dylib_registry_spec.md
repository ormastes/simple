...
<!-- sdn-diagram:id=dylib_registry_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=dylib_registry_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

dylib_registry_spec -> std
dylib_registry_spec -> os
```
...
```ascii generated-from=dylib_registry_spec.arch hash=sha256:auto
...
| Status | Active |
| Source | `test/01_unit/os/kernel/loader/dylib_registry_spec.spl` |
| Updated | 2026-06-01 |
