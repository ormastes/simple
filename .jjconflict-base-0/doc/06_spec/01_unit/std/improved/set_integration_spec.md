...
<!-- sdn-diagram:id=set_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=set_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

set_integration_spec -> std
```
...
```ascii generated-from=set_integration_spec.arch hash=sha256:auto
