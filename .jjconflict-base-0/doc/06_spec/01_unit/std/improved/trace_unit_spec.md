...
<!-- sdn-diagram:id=trace_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=trace_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR
...
```ascii generated-from=trace_unit_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/trace_unit_spec.spl` |
| Updated | 2026-06-01 |
