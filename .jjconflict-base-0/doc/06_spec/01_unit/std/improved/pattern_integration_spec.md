...
<!-- sdn-diagram:id=pattern_integration_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=pattern_integration_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

pattern_integration_spec -> std
```
...
```ascii generated-from=pattern_integration_spec.arch hash=sha256:auto
