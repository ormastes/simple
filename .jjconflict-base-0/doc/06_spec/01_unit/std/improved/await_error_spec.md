...
<!-- sdn-diagram:id=await_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=await_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

await_error_spec -> std
```
...
```ascii generated-from=await_error_spec.arch hash=sha256:auto
