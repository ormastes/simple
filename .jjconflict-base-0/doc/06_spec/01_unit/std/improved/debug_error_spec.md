...
<!-- sdn-diagram:id=debug_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=debug_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

debug_error_spec -> std
```
...
```ascii generated-from=debug_error_spec.arch hash=sha256:auto
