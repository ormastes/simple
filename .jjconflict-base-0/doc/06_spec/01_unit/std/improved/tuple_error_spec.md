...
<!-- sdn-diagram:id=tuple_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=tuple_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

tuple_error_spec -> std
```
...
```ascii generated-from=tuple_error_spec.arch hash=sha256:auto
