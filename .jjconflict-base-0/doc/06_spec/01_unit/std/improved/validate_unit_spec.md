...
<!-- sdn-diagram:id=validate_unit_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=validate_unit_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

validate_unit_spec -> std
```
...
```ascii generated-from=validate_unit_spec.arch hash=sha256:auto
...
| Status | Implemented |
| Source | `test/01_unit/std/improved/validate_unit_spec.spl` |
| Updated | 2026-06-01 |
