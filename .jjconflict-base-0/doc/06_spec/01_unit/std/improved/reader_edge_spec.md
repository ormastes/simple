...
<!-- sdn-diagram:id=reader_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=reader_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

reader_edge_spec -> std
```
...
```ascii generated-from=reader_edge_spec.arch hash=sha256:auto
