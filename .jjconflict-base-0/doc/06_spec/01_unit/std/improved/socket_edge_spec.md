...
<!-- sdn-diagram:id=socket_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=socket_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

socket_edge_spec -> std
```
...
```ascii generated-from=socket_edge_spec.arch hash=sha256:auto
