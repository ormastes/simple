...
<!-- sdn-diagram:id=signal_error_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=signal_error_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

signal_error_spec -> std
```
...
```ascii generated-from=signal_error_spec.arch hash=sha256:auto
