...
- 120bpm/4 steps-per-beat gives an exact 125ms step duration (single hit at step index 1 lands on frame 125, not 124/126)
- Write a 2-step pattern ".X" — the only (accented) hit is step index 1
...
```simple
# @req REQ-SSPEC-APP
step("120bpm/4 steps-per-beat gives an exact 125ms step duration (single hit at step index 1 lands on frame 125, not 124/126)")
...
- steps \
- Write a 4-step pattern "x..x" (hits at step 0 and step 3)
   - Expected: _write_clips() is true
...
- accent 'X' lowers to gain 1.0 versus 'x' gain 0.7 — exact quantized amplitudes
- Render single-step patterns "x" and "X" from the same 0.5-amplitude clip
   - Expected: _write_clips() is true
...
```simple
# @req REQ-SSPEC-APP
step("accent 'X' lowers to gain 1.0 versus 'x' gain 0.7 — exact quantized amplitudes")
...
- repeat:2 duplicates the pattern's events offset by exactly the pattern length (4 steps * 125ms = 500ms)
- Write the same "x..x" pattern with repeat: 2
   - Expected: _write_clips() is true
...
```simple
# @req REQ-SSPEC-APP
step("repeat:2 duplicates the pattern's events offset by exactly the pattern length (4 steps * 125ms = 500ms)")
...
```simple
# @req REQ-SSPEC-APP
step("two tracks triggering the same step mix to the exact summed sample")
...
```simple
# @req REQ-SSPEC-APP
step("produces byte-identical WAV output across two separate pattern render invocations")
...
```simple
# @req REQ-SSPEC-APP
step("exits 1 when tracks have mismatched step-string lengths")
...
- Canonical SPipe generation for source `7bdf77072f799e0c89c3e20fc735064ab0f3437d192a2f95a52e6099596ce93a`; maintenance tool `1`, rules `ssdoc-rules/1`.

Source SHA-256: `7bdf77072f799e0c89c3e20fc735064ab0f3437d192a2f95a52e6099596ce93a`.
...
source: test/01_unit/app/cli/sound_cmd_pattern_spec.spl
mirror: doc/06_spec/01_unit/app/cli/sound_cmd_pattern_spec.md (current)
findings: 6 blockers: 0
  narrative=100 structure=100 oracle=90
  traceability=100 evidence=70 coverage=100 maintainability=70
  cache=not-used suppressed=0
  lint-owned related rules=SPIPE001,SPIPE002,SPIPE003,SPIPE004,SPIPE005,SPIPE006,SPIPE007
doc/06_spec/01_unit/app/cli/sound_cmd_pattern_spec.md:1:1: advice SSDOC-MNT-005 [maintainability] (-10): generated manual lacks verification or troubleshooting guidance
  why: Operators need recovery and evidence interpretation guidance.
  improve: Author verification and recovery facts in SSpec and regenerate.
doc/06_spec/01_unit/app/cli/sound_cmd_pattern_spec.md:1:1: warning SSDOC-MNT-008 [maintainability] (-20): manual is missing: purpose, audience, scope, assumptions/preconditions, primary workflow, unsupported/limitations, recovery/troubleshooting
  why: A test dump is not a complete professional specification manual.
  improve: Author the missing facts in SSpec and regenerate through canonical SPipe docgen.
test/01_unit/app/cli/sound_cmd_pattern_spec.spl:1:1: advice SSDOC-ORA-003 [oracle] (-10): 1 unexplained numeric expected value(s)
  why: Reviewers need to know why a magic expected value is authoritative.
  improve: Name the authoritative expected value or add a '# oracle:' explanation.
test/01_unit/app/cli/sound_cmd_pattern_spec.spl:105:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario '120bpm/4 steps-per-beat gives an exact 125ms step duration (single hit at step index 1 lands on frame 125, not 124/126)' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/app/cli/sound_cmd_pattern_spec.spl:122:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'steps \' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
test/01_unit/app/cli/sound_cmd_pattern_spec.spl:140:1: warning SSDOC-EVD-001 [evidence] (-10): visible scenario 'accent 'X' lowers to gain 1.0 versus 'x' gain 0.7 — exact quantized amplitudes' has no retained capture or evidence
  why: Professional manuals need retained observable evidence.
  improve: Capture typed user/operator-facing evidence or explain why the oracle is complete.
