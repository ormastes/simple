...
_Source: `test/01_unit/compiler/portable_numeric_capabilities_spec.spl`_
...
_Source: `test/01_unit/compiler/portable_numeric_capabilities_spec.spl` (extended), `test/01_unit/compiler/portable_numeric_plan_threading_spec.spl` (new), `test/01_unit/compiler/scalable_vec_mir_scaffolding_spec.spl` (new)_
