...
- `test/03_system/feature/baremetal/ghdl_riscv32_semihost_spec.spl` passes end to end with `ghdl`
- `test/02_integration/debug/hardware/stm32wb_openocd_spec.spl` passes as a repo-readiness spec
- `test/02_integration/debug/hardware/stm32h7_openocd_spec.spl` passes as a repo-readiness spec
- `test/02_integration/debug/hardware/stm32wb_stlink_spec.spl` passes as a checked-config spec
- `test/02_integration/debug/hardware/stm32h7_stlink_spec.spl` passes as a checked-config spec
- `test/02_integration/debug/hardware/hardware_check_spec.spl` passes and confirms local tool presence
- `test/03_system/feature/app/remote_baremetal/remote_baremetal_runtime_spec.spl` is green for runtime/readiness checks
- `test/02_integration/remote_jit/ch32v307_composite_runner_path_spec.spl` is green and verifies the CH32 composite path no longer short-circuits
- `test/02_integration/remote_jit/qemu_rv32_raw_injected_regression_spec.spl` is green and isolates the raw RV32 injected path
...
simple_test test/01_unit/             # Run tests in directory
...
bin/simple test test/02_integration/remote_jit/qemu_rv32_library_semihost_spec.spl

# Raw RV32 injected regression lane
bin/simple test test/02_integration/remote_jit/qemu_rv32_raw_injected_regression_spec.spl

# CH32 composite-runner regression lane
bin/simple test test/02_integration/remote_jit/ch32v307_composite_runner_path_spec.spl

# CH32 direct-probe readiness and SDI-output probe
bin/simple test test/02_integration/remote_jit/ch32v307_composite_runner_spec.spl

# RTL RV32I emulator path that works on this host today
bin/simple test test/03_system/feature/baremetal/ghdl_riscv32_semihost_spec.spl

# OpenOCD STM readiness lanes
bin/simple test test/02_integration/debug/hardware/stm32wb_openocd_spec.spl
bin/simple test test/02_integration/debug/hardware/stm32h7_openocd_spec.spl

# ST-Link metadata/config lanes
bin/simple test test/02_integration/debug/hardware/stm32wb_stlink_spec.spl
bin/simple test test/02_integration/debug/hardware/stm32h7_stlink_spec.spl

# TRACE32 STM readiness lanes
bin/simple test test/02_integration/debug/hardware/t32_native_spec.spl
bin/simple test test/02_integration/debug/hardware/t32_gdb_bridge_spec.spl
```
...
`test/03_system/feature/baremetal/ghdl_riscv32_semihost_spec.spl` is currently the most
...
- composite-runner regression:
  - `test/02_integration/remote_jit/ch32v307_composite_runner_path_spec.spl`
- direct probe readiness and workload-output probe:
  - `test/02_integration/remote_jit/ch32v307_composite_runner_spec.spl`
  - `test/03_system/feature/app/remote_jit/ch32v307_jit_e2e_spec.spl`
