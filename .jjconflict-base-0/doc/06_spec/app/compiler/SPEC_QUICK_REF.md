...
```bash
# Dry run (preview)
python scripts/migrate_spec_to_spl.py --dry-run doc/06_spec/types.md tests/specs/types_spec.spl

# Actual migration
python scripts/migrate_spec_to_spl.py doc/06_spec/types.md tests/specs/types_spec.spl
