...
20 unit tests in `test/unit/compiler/custom_primitive_sffi_spec.spl` covering metadata, ABI mapping, bitfield backing/fields, and classification/domain wrappers.
