...
| Round-trip test (compile .so → gen header → compile C consumer → link → execute) | Implemented | `test/02_integration/sffi/direction_a_c_roundtrip_spec.spl` |
| C++ round-trip | Implemented | `test/02_integration/sffi/direction_a_cpp_roundtrip_spec.spl` |
...
| Direction B round-trip test | Implemented | `test/02_integration/sffi/direction_b_import_roundtrip_spec.spl` |
| Callback round-trip test | Implemented | `test/02_integration/sffi/callback_roundtrip_spec.spl` |
