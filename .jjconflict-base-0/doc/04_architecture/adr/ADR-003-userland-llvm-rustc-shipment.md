...
research note `doc/01_research/compiler/bootstrap/bootstrap_strategy_research_2026-02-23.md`.
...
- Frozen contracts: `doc/04_architecture/os/simpleos/kernel/simpleos_interfaces.md`
- Bootstrap requirement (amended in this cycle):
  `doc/02_requirements/feature/app/bootstrap.md`
- Prior ADR (still in effect): `doc/04_architecture/compiler/misc/adr_rust_llvm_exclusion.md`
