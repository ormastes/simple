...
Related: `doc/04_architecture/platform/cross_platform_wm.md`, `doc/03_plan/gui_drawing_layer_variations.md`
...
- Add a `test/01_unit/os/compositor/trait_conformance_spec.spl` that
...
- `doc/04_architecture/platform/cross_platform_wm.md` — target architecture
