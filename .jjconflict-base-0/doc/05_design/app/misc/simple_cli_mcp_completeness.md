...
**Date:** 2026-03-27
**Status:** Draft
**Requirement:** [doc/02_requirements/feature/simple_cli_mcp_completeness.md](../plan/requirement/simple_cli_mcp_completeness.md)
**Plan:** [doc/03_plan/simple_cli_mcp_completeness_plan_2026-03-27.md](../plan/simple_cli_mcp_completeness_plan_2026-03-27.md)
**Research:** [doc/01_research/simple_cli_mcp_completeness.md](../research/simple_cli_mcp_completeness.md)
...
| `test/01_unit/app/cli_command_inventory_spec.spl` | Inventory drift detection test |
| `test/01_unit/app/cli_help_alignment_spec.spl` | Help text vs dispatch alignment test |
| `test/01_unit/app/mcp_inventory_alignment_spec.spl` | MCP tool list vs dispatch alignment test |
| `test/01_unit/app/cli_mcp_alignment_spec.spl` | CLI/MCP capability matrix test |
| `test/01_unit/app/mcp_wrapper_contract_spec.spl` | Wrapper timeout/exit-code contract test |
...
**File:** `test/01_unit/app/cli_command_inventory_spec.spl`
...
**File:** `test/01_unit/app/cli_help_alignment_spec.spl`
...
**File:** `test/01_unit/app/mcp_inventory_alignment_spec.spl`
...
**File:** `test/01_unit/app/cli_mcp_alignment_spec.spl`
...
**File:** `test/01_unit/app/mcp_wrapper_contract_spec.spl`
...
2. Create `test/01_unit/app/cli_command_inventory_spec.spl`
3. Create `test/01_unit/app/mcp_inventory_alignment_spec.spl`
...
4. Add `--help-all` flag
5. Create `test/01_unit/app/cli_help_alignment_spec.spl`

### Wave 3: MCP Hardening

1. Add wrapper contract documentation to tool family files
2. Create `test/01_unit/app/mcp_wrapper_contract_spec.spl`
3. Create `test/01_unit/app/cli_mcp_alignment_spec.spl`
