...
- Mark the repo-native RV64 lane as `generated_rv64_linux` with the same Linux handoff contract surface used repo-wide: `FW_JUMP` support plus `a0`/`a1` boot-contract metadata.
