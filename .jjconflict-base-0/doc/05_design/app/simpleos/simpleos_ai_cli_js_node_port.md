...
`test/03_system/os/simpleos_ai_cli_js_node_port_spec.spl` covers:
...
- generated-WASM hello GUI import/export evidence in
  `test/01_unit/lib/common/ui/wasm_hello_gui_spec.spl`;
- hardened browser script execution and denial coverage in
  `test/01_unit/browser_engine/script/browser_script_execute_spec.spl`;
