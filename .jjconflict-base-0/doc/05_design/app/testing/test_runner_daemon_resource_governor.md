...
`test/01_unit/app/test_daemon/test_daemon_resource_policy_spec.spl` covers the pure
policy without launching daemon or QEMU processes.

`test/01_unit/app/test_daemon/test_daemon_session_scheduler_spec.spl` covers the
