...
- **Date:** 2026-04-18
- **slang phase:** A2
- **Triggering code:** `src/lib/gc_async_mut/slang/model_executor/model_loader/tensor_pack.spl:sha256_chunk`,
...
- **Current workaround:** `slang_pack` shells out to `sha256sum <path>` via
