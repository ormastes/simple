...
**Companion research:** [`doc/01_research/missing_language_features_2026-02-17.md`](../research/missing_language_features_2026-02-17.md)
...
All new features respect the JSF AV C++ / NASA Power of Ten constraints from `doc/01_research/missing_language_features_2026-02-17.md`.
...
- **Phantom types** — separate research in `doc/01_research/introspection_phantom_types_2026-02-17.md`
- **Mapped types** — separate feature; `doc/01_research/missing_language_features_2026-02-17.md` section 30
...
- `doc/01_research/missing_language_features_2026-02-17.md` **section 15** (Process Supervision Trees) — extended with `receive:` block (the missing core Erlang primitive)
