...
- the checked-in GHDL RV32I semihost lane works as a real simulator-backed
  baremetal execution path via `test/03_system/feature/baremetal/ghdl_riscv32_semihost_spec.spl`
...
- simulator-backed target execution:
  - `test/03_system/feature/baremetal/ghdl_riscv32_semihost_spec.spl`
...
- `src/baremetal/test/03_system/qemu_semihost_test.elf`
- `src/baremetal/test/03_system/qemu_protocol_test.elf`
