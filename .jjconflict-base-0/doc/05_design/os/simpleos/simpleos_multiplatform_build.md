...
`test/01_unit/os/port/simpleos_multiplatform_build_spec.spl` verifies supported target exposure, alias resolution, i686 C/ASM flags, x86_32 boot source paths, and native build helper delegation.
