...
**Test Results:**
- ✅ `test/02_integration/import_syntax_spec.spl` - PASS (6ms)
...
- `test/01_unit/app/package/semver_spec.spl` - 206+ lines
- `test/01_unit/app/package/manifest_spec.spl` - 336+ lines
- `test/01_unit/app/package/lockfile_spec.spl` - 363+ lines
- `test/01_unit/app/package/package_spec.spl` - 100+ lines
- `test/01_unit/app/package/ffi_spec.spl` - 100+ lines
...
**Test Results:**
- ✅ `test/01_unit/std/process_spec.spl` - PASS (4ms)
- ✅ `test/01_unit/app/io/process_ops_ext_spec.spl` - PASS (27+ tests)
- ✅ `test/03_system/process_system_spec.spl` - Full integration tests
...
**Test Results:**
- ✅ `test/03_system/feature/file_io_extended_spec.spl` - PASS (6ms)
- ✅ `test/03_system/file_io_spec.spl` - PASS (6ms)
- ✅ `test/01_unit/std/infra/file_io_spec.spl` - PASS (4ms)
- `test/01_unit/std/file_find_spec.spl` - @skip (glob operations)
