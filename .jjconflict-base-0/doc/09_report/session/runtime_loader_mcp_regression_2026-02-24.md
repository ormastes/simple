...
File: `test/01_unit/compiler/loader/module_loader_spec.spl`
...
Verification:
```bash
SIMPLE_LIB=src bin/simple test test/01_unit/compiler/loader/module_loader_spec.spl --mode=interpreter
# Result: PASS (68 passed)
```

### 2) MCP stdio runtime contract (stable wrapper path)

File: `test/02_integration/app/mcp_stdio_integration_spec.spl`
...
File: `test/02_integration/app/mcp_debug_log_tree_stdio_spec.spl`
...
File updated:
- `doc/07_guide/HOW_TO_USE_MCP.md`
