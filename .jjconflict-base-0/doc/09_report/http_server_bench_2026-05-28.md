...
- TCP static benchmark: `test/05_perf/bench/http_server/bench_raw_tcp_static.spl`
- UDP sink benchmark: `test/05_perf/bench/http_server/bench_udp_echo.spl`
- HTTPS benchmark: `test/05_perf/bench/http_server/bench_server_https.spl`
- nginx HTTP config: `test/05_perf/bench/http_server/nginx_bench.conf`
- nginx HTTPS+H2 config: `test/05_perf/bench/http_server/nginx_bench_https.conf`
