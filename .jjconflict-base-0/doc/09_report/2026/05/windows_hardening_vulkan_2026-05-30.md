...
- Replaced the stale `test/01_unit/app/ui/vulkan_renderer_spec.spl` import of
...
- Updated `test/05_perf/graphics_2d/bench_2d_vulkan.spl` to compile the same
...
- `simple check` passed for:
  ...
  - `test/01_unit/app/ui/vulkan_renderer_spec.spl`
  - `test/01_unit/app/ui/vulkan_window_spec.spl`
  - `test/05_perf/graphics_2d/bench_2d_vulkan.spl`
- `simple run test/01_unit/app/ui/vulkan_renderer_spec.spl`
  - 4 examples, 0 failures
- `simple run test/02_integration/rendering/vulkan_strict_spec.spl`
  - 18 examples, 0 failures
- `simple run test/05_perf/graphics_2d/bench_2d_vulkan.spl`
