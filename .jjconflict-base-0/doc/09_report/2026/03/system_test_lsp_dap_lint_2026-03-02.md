...
```bash
# Run individual spec
bin/simple test test/03_system/lint/app_lint_spec.spl

# Run all lint system tests (fast, ~30s)
bin/simple test test/03_system/lint/

# Run all DAP system tests (fast, ~5s)
bin/simple test test/03_system/dap/

# Run single LSP spec (~7-25 min depending on file count)
bin/simple test test/03_system/lsp/compiler_70_lsp_spec.spl

# Run ALL system tests (~2 hours)
bin/simple test test/03_system/lsp/ test/03_system/lint/ test/03_system/dap/
```
