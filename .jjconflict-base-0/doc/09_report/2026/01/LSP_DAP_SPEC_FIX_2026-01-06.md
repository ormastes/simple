...
**File:** `simple/std_lib/test/03_system/tools/lsp_spec.spl`
...
1. **simple/std_lib/test/03_system/tools/lsp_spec.spl** - Completely rewritten (511 lines)
...
2. **simple/std_lib/test/03_system/tools/dap_spec.spl** - Completely rewritten (584 lines)
...
**File:** `simple/std_lib/test/03_system/tools/dap_spec.spl`
...
**Files Modified:**
- Modified: `simple/std_lib/test/03_system/tools/lsp_spec.spl` (520 lines, +9 from fixes)
- Modified: `simple/std_lib/test/03_system/tools/dap_spec.spl` (593 lines, +9 from fixes)
