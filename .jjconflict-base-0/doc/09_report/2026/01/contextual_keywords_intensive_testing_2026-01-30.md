...
**File:** `test/03_system/features/parser/parser_contextual_keywords_simple_spec.spl`
...
```bash
./target/release/simple_old test/03_system/features/parser/parser_contextual_keywords_simple_spec.spl
```
...
- `test/03_system/features/parser/parser_contextual_keywords_simple_spec.spl` - 13 SSpec tests (150 lines)
- `test/03_system/features/parser/parser_contextual_keywords_spec.spl` - Full specification (350 lines)
