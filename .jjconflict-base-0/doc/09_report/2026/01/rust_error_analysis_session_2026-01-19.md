...
### 1. Rust-to-Simple Error Mapping (`doc/05_design/rust_to_simple_error_mapping.md`)
...
### 2. Expanded Implementation Plan (`doc/05_design/diagnostics_i18n_expanded_plan.md`)
