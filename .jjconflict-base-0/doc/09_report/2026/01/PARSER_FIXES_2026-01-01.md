...
**Files Modified:**
- `simple/std_lib/test/01_unit/compiler_core/collections_spec.spl`
...
### Test Code
- `simple/std_lib/test/01_unit/compiler_core/collections_spec.spl` - Array slice syntax
- `simple/std_lib/test/01_unit/cli_spec.spl` - Use spec.* import fix
