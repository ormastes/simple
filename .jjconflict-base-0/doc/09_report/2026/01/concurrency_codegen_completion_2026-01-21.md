...
### Changes Made to `doc/02_requirements/feature/feature_db.sdn`
...
**Async/Await Tests:**
- ✅ `test/03_system/features/async_effects/async_effects_spec.spl`
...
**Native Binary Tests:**
```bash
# Create test/03_system/codegen/native_binary_spec.spl
