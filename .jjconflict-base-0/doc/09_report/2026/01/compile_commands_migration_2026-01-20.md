...
### 2. Tests
**File:** `simple/std_lib/test/01_unit/tooling/compile_commands_spec.spl` (223 lines)
...
```bash
$ ./target/debug/simple test simple/std_lib/test/01_unit/tooling/compile_commands_spec.spl
...
