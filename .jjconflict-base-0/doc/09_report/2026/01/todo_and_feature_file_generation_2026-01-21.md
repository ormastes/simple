...
| **Feature** | `simple test` | Test files (`*_spec.spl`) | `doc/02_requirements/feature/feature_db.sdn`<br>`doc/02_requirements/feature/feature.md`<br>`doc/02_requirements/feature/category/*.md` | **Every test run** |
...
### A. Feature Database: `doc/02_requirements/feature/feature_db.sdn`
...
For each _spec.spl file:
  ...
  - Determine status:
    ...
    ↓
Save to doc/02_requirements/feature/feature_db.sdn
    ↓
...
features |id, category, name, description, spec, mode_interpreter, mode_jit, mode_smf_cranelift, mode_smf_llvm, platforms, status, valid|
    1, Infrastructure, Lexer, "Tokenizes source code...", doc/06_spec/lexer_parser.md, supported, supported, supported, supported, , complete, true
    2, Infrastructure, Parser, "Transforms tokens...", doc/06_spec/lexer_parser.md, supported, supported, supported, supported, , complete, true
    40, Concurrency, Actors, "Actor-based concurrency...", doc/06_spec/concurrency.md, supported, supported, supported, supported, , planned, true
```
...
### B. Feature Index: `doc/02_requirements/feature/feature.md`
...
Generate markdown table with links to category docs
    ↓
Write to doc/02_requirements/feature/feature.md
```
...
**File:** `doc/02_requirements/feature/feature.md`
...
### C. Category Docs: `doc/02_requirements/feature/category/*.md`
...
```
doc/02_requirements/feature/category/
├── Codegen.md
├── Concurrency.md
├── Control_Flow.md
├── Data_Structures.md
...
For each category:
  ...
  - Generate feature table:
      ...
      * Status
    ↓
Write to doc/02_requirements/feature/category/{Category}.md
```
...
**File:** `doc/02_requirements/feature/category/Infrastructure.md` (example)
...
AUTOMATIC: update_feature_database() called
    ↓
doc/02_requirements/feature/feature_db.sdn updated
    ↓
AUTOMATIC: generate_feature_docs() called
    ↓
doc/02_requirements/feature/feature.md generated
doc/02_requirements/feature/category/*.md generated
```

**Frequency:** **Every test run** (automatic)

**Files:**
- `doc/02_requirements/feature/feature_db.sdn` - Updated **every test run**
- `doc/02_requirements/feature/feature.md` - Updated **every test run**
- `doc/02_requirements/feature/category/*.md` - Updated **every test run**
...
| File | Purpose | Generated By | When |
|------|---------|--------------|------|
| `doc/02_requirements/feature/feature_db.sdn` | Feature database (SDN format) | `simple test` | **Every test run** |
| `doc/02_requirements/feature/feature.md` | Feature category index | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Codegen.md` | Codegen features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Concurrency.md` | Concurrency features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Control_Flow.md` | Control flow features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Data_Structures.md` | Data structure features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Infrastructure.md` | Infrastructure features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Language.md` | Language features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Testing_Framework.md` | Test framework features | `simple test` | **Every test run** |
| `doc/02_requirements/feature/category/Types.md` | Type system features | `simple test` | **Every test run** |
...
| **Database file** | `doc/todo/todo_db.sdn` | `doc/02_requirements/feature/feature_db.sdn` |
| **Doc files** | `doc/TODO.md` (1 file) | `doc/02_requirements/feature/feature.md`<br>`doc/02_requirements/feature/category/*.md` (9+ files) |
...
#   - doc/02_requirements/feature/category/Concurrency.md

# 3. Check generated files
cat doc/02_requirements/feature/feature_db.sdn | grep "40,"
# 40, Concurrency, Actors, "Actor-based...", ..., planned, true

cat doc/02_requirements/feature/category/Concurrency.md
