...
- ~~test/03_system/compiler/severity_spec.spl~~
- ~~test/03_system/compiler/symbol_analysis_spec.spl~~
- ~~test/03_system/infrastructure/coverage_system_spec.spl~~
- ~~test/03_system/math/tensor_broadcast_spec.spl~~
...
- ~~test/03_system/compiler/string_escape_spec.spl~~
- ~~test/03_system/compiler/effects_core_spec.spl~~
- ~~test/03_system/compiler/mir_types_spec.spl~~
- ~~test/03_system/compiler/symbol_hash_spec.spl~~
- ~~test/03_system/compiler/lean_auto_gen_spec.spl~~

### Timeout/Hang or Missing FFI
- ~~test/01_unit/spec/matchers_spec.spl~~
