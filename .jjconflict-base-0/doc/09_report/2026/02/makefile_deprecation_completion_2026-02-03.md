...
Completed **Phase 1** of the Makefile cleanup as outlined in `doc/09_report/makefile_cleanup_2026-02-03.md`. Added deprecation warnings to all migrated targets that were missing them.
...
- `doc/09_report/makefile_cleanup_2026-02-03.md` - Original analysis
- `doc/09_report/rust_to_simple_migration_2026-02-03.md` - Overall migration plan
