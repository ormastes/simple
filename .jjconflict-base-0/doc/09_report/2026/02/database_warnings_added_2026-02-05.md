...
# ⚠️ Do NOT edit doc/02_requirements/feature/feature_db.sdn manually
...
#   2. Load: var db = create_feature_database("doc/02_requirements/feature/feature_db.sdn")
...
#
# See: doc/05_design/database_access_enforcement_design.md (Phase 2)
# See: doc/09_report/database_enforcement_research_2026-02-05.md
```
...
| `doc/02_requirements/feature/feature_db.sdn` | Database file | ⚠️ Do not edit manually |
...
**Files**: `doc/bug/bug_db.sdn`, `doc/test/test_db.sdn`, `doc/02_requirements/feature/feature_db.sdn`
