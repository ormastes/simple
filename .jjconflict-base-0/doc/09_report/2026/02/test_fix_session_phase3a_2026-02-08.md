...
```bash
bin/simple test test/03_system/features/treesitter/treesitter_lexer_spec.spl
...
- `test/03_system/features/treesitter/treesitter_lexer_spec.spl` - Fixed imports, converted skip_it
