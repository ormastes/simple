...
- `test/01_unit/compiler_core/generic_syntax_spec.spl`: Parser tests (30 tests) - tests don't run
...
- `test/01_unit/std/thread_pool_spec.spl`: Tests exist (80+ tests)
- `test/01_unit/std/thread_sffi_spec.spl`: Tests exist (60+ tests)

**What DOES NOT WORK:**
- ❌ Tests get killed (infinite loop or crash): `bin/simple test test/01_unit/std/thread_pool_spec.spl` → Killed
- ❌ Tests get killed: `bin/simple test test/01_unit/std/thread_sffi_spec.spl` → Killed
...
$ bin/simple test test/01_unit/std/thread_pool_spec.spl
bin/simple: line 101: 96633 Killed
# (Process killed - likely infinite loop or segfault)

# Thread SFFI tests crash
$ bin/simple test test/01_unit/std/thread_sffi_spec.spl
