...
4. `doc/09_report/driver_migration_implementation_2026-02-04.md` - Phase 1A report
5. `doc/09_report/parser_replacement_status_2026-02-04.md` - Parser status
6. `doc/09_report/ffi_wrapper_complete_status_2026-02-04.md` - FFI coverage
