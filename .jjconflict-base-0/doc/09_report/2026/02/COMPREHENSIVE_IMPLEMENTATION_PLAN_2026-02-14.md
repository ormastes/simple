...
**Current State:**
- ✅ Generic syntax parsing (test/01_unit/compiler_core/generic_syntax_spec.spl - 30/30 passing)
...
1. **Runtime Type Checking** (2 days)
   ...
   - Tests: test/01_unit/type/runtime_type_check_spec.spl (60 tests)
...
- test/01_unit/type/ (250 tests)
- doc/07_guide/advanced_types.md
...
1. **x86_64 AVX2 Code Generation** (4 days)
   ...
   - Tests: test/01_unit/compiler/x86_64_simd_spec.spl (80 tests)
...
2. **ARM NEON Code Generation** (3 days)
   ...
   - Tests: test/01_unit/compiler/arm_neon_spec.spl (60 tests)
...
3. **Auto-Vectorization Pass** (5 days)
   ...
   - Tests: test/01_unit/compiler/auto_vectorize_spec.spl (100 tests)
...
4. **Integration & Benchmarks** (2 days)
   ...
   - Tests: test/05_perf/bench/simd_bench.spl (20 benchmarks)
...
- test/01_unit/compiler/simd/ (240 tests)
- test/05_perf/bench/simd_bench.spl (20 benchmarks)
...
5. **Integration** (2 days)
   ...
   - Tests: test/02_integration/baremetal_build_spec.spl (20 tests)
...
- doc/07_guide/baremetal_programming.md
...
2. **Write Tests** (3 days)
   - test/01_unit/std/thread_pool_spec.spl (80 tests)
   - test/01_unit/std/thread_sffi_spec.spl (60 tests)
