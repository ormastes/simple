...
|------|-------|------------|
| `test/02_integration/mcp_bugdb_spec.spl` | 7 | MCP + Bug Database integration |
| `test/02_integration/database_atomic_spec.spl` | 13 | Atomic operations and locking |
| `test/02_integration/database_query_spec.spl` | 13 | Query builder and fluent API |
| `test/02_integration/database_e2e_spec.spl` | 8 | End-to-end workflows |
| `test/02_integration/database_core_spec.spl` | 40+ | Core components (Interner, Row, Table, Database) |
...
**File:** `test/02_integration/mcp_bugdb_spec.spl`
...
**File:** `test/02_integration/database_atomic_spec.spl`
...
**File:** `test/02_integration/database_query_spec.spl`
...
**File:** `test/02_integration/database_e2e_spec.spl`
...
**File:** `test/02_integration/database_core_spec.spl`
...
./bin/simple test test/02_integration/mcp_bugdb_spec.spl
...
2. **Run Tests:** Execute test suite with `./bin/simple_runtime test/02_integration/`
...
### Test Files Created
3. `test/02_integration/mcp_bugdb_spec.spl` (220 lines) - MCP integration tests
4. `test/02_integration/database_atomic_spec.spl` (250 lines) - Atomic operation tests
5. `test/02_integration/database_query_spec.spl` (350 lines) - Query builder tests
6. `test/02_integration/database_e2e_spec.spl` (400 lines) - End-to-end workflow tests
7. `test/02_integration/database_core_spec.spl` (420 lines) - Core component tests

### Documentation
8. `doc/09_report/mcp_fixes_and_tests_2026-02-05.md` (this file)
