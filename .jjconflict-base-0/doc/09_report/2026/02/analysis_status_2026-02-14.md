...
**Files:**
- Test: `test/01_unit/parser/multiline_bool_spec.spl` (143 lines, 18 tests)
...
**Files:**
- Investigation: `doc/09_report/module_closure_investigation_2026-02-14.md` (245 lines)
- Resolution: `doc/09_report/module_closure_resolution_2026-02-14.md` (236 lines)
- Tests: `test/01_unit/runtime/module_closure_spec.spl` (10/10 passing)
...
- Tests: `test/01_unit/compiler/closure_capture_warning_spec.spl` (33 lines - INCOMPLETE)
...
**Files:**
- Tests: `test/01_unit/compiler_core/generic_syntax_spec.spl` (191 lines, 52 tests)
...
**Files:**
- Tests: `test/01_unit/compiler_core/ignored_return_warning_spec.spl` (124 lines, 20+ tests)
...
**Files to modify:**
- `test/01_unit/compiler/closure_capture_warning_spec.spl` (expand tests)
...
- `test/01_unit/compiler_core/ignored_return_warning_spec.spl` (verify tests pass)
...
- `test/01_unit/compiler_core/generic_syntax_spec.spl` (verify real parsing)
...
Consider creating:
- `doc/07_guide/closure_patterns.md` - Safe closure patterns, workarounds
- `doc/07_guide/generics.md` - Generic syntax, limitations, type erasure
- `doc/07_guide/warnings.md` - All compiler warnings, how to suppress
