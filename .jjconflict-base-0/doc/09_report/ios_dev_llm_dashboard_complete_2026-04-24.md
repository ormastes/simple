...
- **Specs:**
  - `test/03_system/llm_dashboard_ios_smoke.spl` (4 it blocks — AC-6)
  - `test/01_unit/app/llm_dashboard/ios_css_spec.spl` (4 it blocks — AC-5)
  - `test/01_unit/app/llm_dashboard/ios_mode_spec.spl` (4 it blocks — AC-3)
