...
- evidence_log_bytes: 2740
- evidence_log_cksum: 2645689851
...
- cpu_simd_evidence_log_bytes=2740
- cpu_simd_evidence_log_cksum=2645689851
...
- cpu_simd_x86_diag=requested=cpu_simd_x86;selected=cpu_simd_x86;status=Unavailable;api=cpu_simd_x86;gate=cpu_simd_x86_runtime;shader=none;compute=false;graphics=false;present=false;reason=cpu_simd_x86 not available: runtime SSE4.2/AVX2 not detected on this host
- cpu_simd_arm_diag=requested=cpu_simd_arm;selected=cpu_simd_arm;status=Initialized;api=cpu_simd_arm;gate=cpu_simd_arm_runtime;shader=none;compute=true;graphics=true;present=true;reason=aarch64 NEON runtime kernels confirmed
