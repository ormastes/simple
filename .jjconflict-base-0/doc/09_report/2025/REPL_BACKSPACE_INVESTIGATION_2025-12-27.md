...
**Created:** `doc/01_research/TERMINAL_SEQUENCE_CAPTURE.md`
...
**Created:** `doc/01_research/REPL_BACKSPACE_LIMITATION.md`
...
| `doc/01_research/TERMINAL_SEQUENCE_CAPTURE.md` | Created | 197 | PTY testing guide |
| `doc/01_research/REPL_BACKSPACE_LIMITATION.md` | Created | 173 | Limitation documentation |
| `doc/09_report/REPL_BACKSPACE_INVESTIGATION_2025-12-27.md` | Created | (this) | Completion report |
