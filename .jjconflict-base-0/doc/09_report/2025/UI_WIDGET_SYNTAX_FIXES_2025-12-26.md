...
**Test Relocation:**
- Moved UI tests from `test/03_system/ui/` → `test/01_unit/ui/` per CLAUDE.md structure
...
- **Documentation:** Created `doc/09_report/UI_TESTS_RELOCATED.md`
...
- **Test Files:** `simple/std_lib/test/01_unit/ui/`
- **Documentation:** `doc/01_research/ui_framework_unified.md`
- **Related Reports:**
  - `doc/09_report/UI_TESTS_RELOCATED.md`
