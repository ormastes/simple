...
| `simple/std_lib/test/01_unit/parser/treesitter_lexer_spec.spl` | 150 | Lexer unit tests (10 tests) |
| `simple/std_lib/test/01_unit/parser/treesitter_parser_spec.spl` | 200 | Parser unit tests (16 tests) |
| **Total** | **~1300** | **7 files** |
...
- Tests: `simple/std_lib/test/01_unit/parser/`
