...
**File:** `simple/std_lib/test/01_unit/lsp/semantic_tokens_integration_spec.spl` (~350 lines)
...
**File:** `simple/std_lib/test/01_unit/parser/treesitter_highlights_spec.spl` (~420 lines)
...
./target/release/simple simple/std_lib/test/01_unit/lsp/semantic_tokens_integration_spec.spl

# Run highlight query tests
./target/release/simple simple/std_lib/test/01_unit/parser/treesitter_highlights_spec.spl
