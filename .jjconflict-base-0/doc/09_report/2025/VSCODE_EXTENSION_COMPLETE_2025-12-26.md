...
- `test/01_unit/vscode/manifest_spec.spl` - Test manifest generation
- `test/01_unit/vscode/webview_spec.spl` - Test webview WASM loading
- `test/01_unit/vscode/dap_spec.spl` - Test debug adapter
- `test/01_unit/vscode/wasm_lsp_spec.spl` - Test language server

### Integration Tests
- `test/02_integration/vscode/build_integration_spec.spl` - Test full build pipeline
- `test/02_integration/vscode/extension_lifecycle_spec.spl` - Test activate/deactivate
