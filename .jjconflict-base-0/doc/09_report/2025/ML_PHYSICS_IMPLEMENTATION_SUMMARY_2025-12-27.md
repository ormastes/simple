...
**Test Files Created:**
- `test/01_unit/ml/torch/tensor_spec.spl` - Tensor operations (128 lines)
- `test/01_unit/ml/torch/nn/activation_spec.spl` - Neural network tests
...
**Test Files Created:**
- `test/01_unit/physics/core/vector_spec.spl` - Vector math tests (154 lines)
- `test/01_unit/physics/collision/aabb_spec.spl` - Collision detection tests
- `test/01_unit/physics/dynamics/rigidbody_spec.spl` - Rigid body dynamics tests
...
**Test Files Updated:**
- ✅ `test/01_unit/physics/core/vector_spec.spl` - Updated syntax
- ✅ `test/01_unit/physics/collision/aabb_spec.spl` - Updated syntax
- ✅ `test/01_unit/physics/dynamics/rigidbody_spec.spl` - Updated syntax
- ✅ `test/01_unit/ml/torch/tensor_spec.spl` - Updated syntax
- ✅ `test/01_unit/ml/torch/nn/activation_spec.spl` - Updated syntax
...
simple/std_lib/test/01_unit/ml/torch/tensor_spec.spl      # Tensor tests
simple/std_lib/test/01_unit/ml/torch/nn/activation_spec.spl # NN tests
simple/std_lib/test/01_unit/physics/core/vector_spec.spl  # Vector tests
simple/std_lib/test/01_unit/physics/collision/aabb_spec.spl # Collision tests
simple/std_lib/test/01_unit/physics/dynamics/rigidbody_spec.spl # Dynamics tests
```
