...
- proof path: build/gui_wasm_host_wm_launch_widget_state_machine_debug/host-wm-launch-proof.json
...
- gui_wasm_host_wm_launch_proof_path=build/gui_wasm_host_wm_launch_widget_state_machine_debug/host-wm-launch-proof.json

## Client Output
- [window-client] Connected to hosted WM bridge (client 1218765)
