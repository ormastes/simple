...
1. `doc/07_guide/common_mistakes.md`
2. `doc/07_guide/coding_style.md`
3. `doc/07_guide/sspec_writing.md`
4. `doc/07_guide/sspec_complete_example.md`
5. `simple/bug_report.md`
6. `simple/improve_request.md`

**Specs (user-facing):**
7. `doc/06_spec/stdlib.md`
8. `doc/06_spec/sspec_manual.md`
9. `doc/06_spec/doctest_readme.md`
...
- `doc/05_design/GENERIC_SYNTAX_MIGRATION_SUMMARY.md` - Keep both syntaxes
- `doc/05_design/GENERIC_SYNTAX_MIGRATION_FAQ.md` - Keep both syntaxes
- `doc/05_design/type_parameter_syntax_analysis.md` - Keep both syntaxes

### Low Priority (Session 4+)

**Research Documents (144 files):**
- `doc/01_research/*.md` - Historical research, update as encountered
- `doc/09_report/*.md` - Session reports, update only recent ones
- `doc/03_plan/*.md` - Implementation plans, update active ones
...
find doc -name "*.md" -not -path "doc/archive/*" \
  -not -path "doc/05_design/*generic*" \
...
2. **`doc/05_design/*GENERIC_SYNTAX_MIGRATION*.md`** - Educational documentation about the migration
