...
1. `test/03_system/features/classes/classes_spec.spl` - 6 skip tags removed
...
1. `doc/03_plan/test_revival_plan_2026-01-29.md` - Strategy
2. `doc/09_report/test_revival_complete_inventory_2026-01-29.md` - Full inventory
3. `doc/09_report/test_revival_phase2_progress.md` - Progress tracking
4. `doc/09_report/test_revival_phase2_complete.md` - Detailed results
5. `doc/09_report/test_revival_final_summary_2026-01-29.md` - Executive summary
6. `doc/09_report/test_revival_before_after_2026-01-29.md` - Before/after comparison
