...
**Test:** `test/01_unit/app/doc_coverage/init_parser_spec.spl`
...
**Test:** `test/01_unit/app/doc_coverage/group_sdoctest_spec.spl`
...
**Test:** `test/01_unit/app/doc_coverage/coverage_rules_spec.spl`
...
#   Groups: 2/2 (100%)
#     - String constants (NL, CR, CRLF) ✅ sdoctest at doc/07_guide/string.md:45
#     - Case conversion (to_upper, to_lower) ✅ sdoctest at doc/07_guide/string.md:78
#   Individual: 3/5 (60%)
#     ✅ trim - sdoctest at doc/07_guide/string.md:12
#     ✅ split - sdoctest at doc/07_guide/string.md:23
#     ✅ join - sdoctest at doc/07_guide/string.md:34
