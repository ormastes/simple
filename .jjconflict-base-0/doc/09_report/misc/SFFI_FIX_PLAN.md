...
- [ ] Updated tests
- [ ] Documentation: `doc/07_guide/sffi_two_tier.md`
...
- `doc/07_guide/sffi_gen_guide.md` - Wrapper generation
- `doc/05_design/sffi_external_library_pattern.md` - Three-tier design
