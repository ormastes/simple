...
Running 5 test file(s) [mode: interpreter]...
  ...
  PASS  test/01_unit/std/platform/config_spec.spl (1 passed, 5ms)
  PASS  test/01_unit/std/platform/convert_spec.spl (1 passed, 4ms)
...
| File | Tests | Coverage |
|------|-------|----------|
| `test/01_unit/std/platform/config_spec.spl` | 16 | Platform detection, comparison, factories |
| `test/01_unit/std/platform/convert_spec.spl` | 34 | Endian swap, newlines, byte arrays, round-trips |
| `test/01_unit/std/platform/newline_spec.spl` | 6 | TextMode translation in all modes |
| `test/01_unit/std/platform/wire_spec.spl` | 15 | Wire format write/read, round-trips |
| `test/01_unit/std/platform/text_io_spec.spl` | 9 | File I/O with platform newlines |
