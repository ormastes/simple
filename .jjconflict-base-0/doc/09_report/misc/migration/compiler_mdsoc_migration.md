...
13 test files in `test/01_unit/compiler/mdsoc/`:
...
- Theory: `doc/01_research/mdsoc_design.md`
- Compiler design: `doc/01_research/compiler_mdsoc_design.md`
...
- Feature status: `doc/02_requirements/feature/mdsoc_complete.md`
