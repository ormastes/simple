...
| File | Purpose |
|------|---------|
| `test/05_perf/rust_vs_simple_comparison_spec.spl` | Benchmark suite (23 benchmarks) |
| `test/05_perf/run_comparison.shs` | Runner script for side-by-side comparison |
