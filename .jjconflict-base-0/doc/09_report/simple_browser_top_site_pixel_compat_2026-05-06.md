...
Ranking basis: Semrush “Most Visited Websites in the World, Updated March 2026” (last updated 2026-04-13). Local renderer basis: checked-in `test/fixtures/famous_site_corpus/manifest.sdn` and matching Chrome/Simple PPM comparison reports under `test/09_baselines/famous_site_corpus/`.
