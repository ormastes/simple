...
Feature request: `FR-COMPILER-002` in `doc/08_tracking/feature/compiler_requests.md`.
...
- Unit SPipe: `test/01_unit/compiler/hir/resolve_import_symbols_spec.spl`
- System SPipe: `test/03_system/compiler_import_alias_resolution_spec.spl`
