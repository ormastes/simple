...
### Tests Affected
- `test/01_unit/std/algorithm_utils_spec.spl` - add cases for re-exported functions
- `test/01_unit/std/search_utils_spec.spl` - update to use canonical versions
- `test/01_unit/std/list_utils_spec.spl` - update to use canonical versions
...
- **Implementation Plan:** `doc/05_design/stdlib_consolidation_plan.md` (to be created)
