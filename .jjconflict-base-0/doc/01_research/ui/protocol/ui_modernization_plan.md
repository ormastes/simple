...
- `doc/04_architecture/compiler/mdsoc/mdsoc_architecture_tobe.md` (MDSOC+ section) — add UI worked example showing `WidgetNode`-as-component, `UISession`-as-world, lifecycle-as-system mapping
