...
Tests exist in `test/01_unit/compiler/semantics/lint/required_comment_lint_spec.spl`
for the AST lint, and tests in
`test/01_unit/compiler/frontend/required_comment_parse_spec.spl` simulate parser
warning behavior.
