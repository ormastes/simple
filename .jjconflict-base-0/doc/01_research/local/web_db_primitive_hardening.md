...
- `app.ui.web` uses `BoundedChannel` for event/render backpressure. Its `close()` was a no-op, and `test/integration/app/ui.web/backpressure_test.spl` documented that sends after close still succeeded.
