...
- `doc/04_architecture/shared_wm_stack.md` already states the desired architecture: host UI shells and SimpleOS run the same headless `WmService` + `Compositor` with no duplication.
