...
- `doc/07_guide/quick_reference/syntax_quick_reference.md` -- Current alias/type syntax
- `doc/09_report/alias_feature_investigation_2026-02-16.md` -- Function alias investigation
