...
| **test** | Write LSP protocol integration tests | `test/02_integration/lsp/lsp_protocol_spec.spl` |
...
| **test** | Verify MCP server works with 50 tools | `test/01_unit/app/mcp_unit/` |
...
| **test** | Tree-sitter handler unit tests | `test/01_unit/lsp/` |
