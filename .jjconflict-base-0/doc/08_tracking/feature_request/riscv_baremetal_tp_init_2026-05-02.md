...
and are verified by `test/01_unit/os/kernel/arch/riscv/per_cpu_tp_spec.spl`.
...
Cross-link: `src/os/kernel/arch/riscv64/per_cpu.spl` (helpers), `test/01_unit/os/kernel/arch/riscv/per_cpu_tp_spec.spl` (specs).
