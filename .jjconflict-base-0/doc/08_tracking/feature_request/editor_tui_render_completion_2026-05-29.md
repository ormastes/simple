...
- `SIMPLE_LIB=src bin/simple test test/03_system/editor_palette_spec.spl --mode=interpreter --clean` (`11/11`)
...
controller and TUI palette renderer. `test/03_system/editor_palette_spec.spl`
passes 11/11.
