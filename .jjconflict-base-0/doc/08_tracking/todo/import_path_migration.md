...
- `doc/07_guide/quick_reference/syntax_quick_reference.md` - Import syntax section
- `doc/05_design/import_path_design.md` - Already created
- `.claude/skills/coding.md` - Import guidelines
- README examples
- Tutorial files

**Deliverable:** `doc/09_report/import_migration_complete_2026-02-XX.md`
...
- Design: `doc/05_design/import_path_design.md`
