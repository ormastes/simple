 ...
 **Not yet shipped (SIMD versions):**
 ...
 |-----------|-----|---------|------|-------------|
 | `avx512_emit_spec.spl` | `test/01_unit/compiler/backend/` | 21 | G4 | Original AVX-512 goldens |
 | `avx512_mask_emit_spec.spl` | `test/01_unit/compiler/backend/` | 29 | H1 | Mask/blend/compare emit |
 | `neon_emit_spec.spl` | `test/01_unit/compiler/backend/` | 28 | H2 | NEON baseline emit |
 | `neon_load_store_spec.spl` | `test/01_unit/compiler/backend/` | 36 | N4 | NEON ld1/st1 and variants |
 | `neon_arith_extras_spec.spl` | `test/01_unit/compiler/backend/` | 38 | O2 | NEON broadening arith (in-progress) |
 | `sve2_emit_spec.spl` | `test/01_unit/compiler/backend/` | 48 | N5 | SVE2 predicated ops |
 | `avx512_gather_scatter_spec.spl` | `test/01_unit/compiler/backend/` | 10 | O5 | VSIB gather/scatter (in-progress) |
 ...
 **Note:** `test/01_unit/compiler/native/arm_neon_spec.spl` exists but contains 40 tests all marked
...
The SIMD unit lib count (116 it-blocks across 8 spec files under `test/01_unit/lib/simd/`) was
obtained by grepping `it(` in those files; the backend golden count (210) is a direct sum of the
per-file `it(` counts in `test/01_unit/compiler/backend/` for the seven spec files listed in §4.1.
