# hardware Layer Expert

## Role

Maintain process knowledge for the `hardware` layer: owned source, architecture links, expected tests, and boundary rules. Use this skill when a task changes `src/hardware` or depends on its public behavior.
