...
### Testing
- ✅ SPipe tests (`test/03_system/feature/pass_variants_spec.spl`)
- ✅ SPipe tests (`test/03_system/feature/walrus_operator_spec.spl`)
...
See [`doc/07_guide/tooling/lint.md`](../guide/tooling/lint.md) for full details, examples, and fix instructions.

## References

- Implementation Plan: `~/.claude/plans/expressive-spinning-ember.md`
- Test Files: `test/03_system/feature/pass_variants_spec.spl`, `test/03_system/feature/walrus_operator_spec.spl`
