...
- `doc/01_research/python_helper_methods_inventory.md` — Python 404 methods
- `doc/01_research/ruby_methods_inventory.md` — Ruby 769 methods
- `doc/01_research/go_helper_functions_inventory.md` — Go 430 methods
- `doc/01_research/js_ts_method_inventory.md` — TypeScript 322 methods
