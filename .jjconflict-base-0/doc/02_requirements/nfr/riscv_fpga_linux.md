...
- NFR-RFL-004: The historical slice must not regress existing VHDL backend and targeted RISC-V hardware/compiler/QEMU tests while dual-arch Linux pipeline work advances elsewhere.
...
Canonical active NFRs for dual-arch Linux-platform truth now live in `doc/02_requirements/nfr/rv64_linux_rtl_pipeline.md`.
