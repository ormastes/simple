...
- **Specs to add**: `test/02_integration/app/scv_structural_match_spec.spl` — function moved to different file, function renamed in place, unnamed statement reordering, low-confidence → conflict fallback.
