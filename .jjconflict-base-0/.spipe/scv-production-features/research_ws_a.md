...
### `test/integration/app/scv_parser_wasm_spec.spl`
...
### `test/integration/app/scv_parser_incremental_spec.spl`
Covers:
...
- `test/integration/app/scv_parser_wasm_spec.spl` — WASM registry + parse-gate spec
- `test/integration/app/scv_parser_incremental_spec.spl` — incremental line-node reuse spec
