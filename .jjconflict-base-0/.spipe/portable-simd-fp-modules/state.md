...
Spec file: `test/01_unit/lib/simd/portable_simd_fp_spec.spl`
All classes replicated inline (self-contained, no imports from src/ modules).
Verified 2026-05-19: 23/23 pass via `bin/release/linux-x86_64/simple test/01_unit/lib/simd/portable_simd_fp_spec.spl`.
...
- test/01_unit/lib/simd/portable_simd_fp_spec.spl — 20 self-contained tests

### 7-verify
All 20 tests pass: 6 NumericCaps + 3 TargetFamily + 5 CapRegistryEntry + 5 LoweringSelection + 4 FpProfile.
Run: bin/simple run test/01_unit/lib/simd/portable_simd_fp_spec.spl
