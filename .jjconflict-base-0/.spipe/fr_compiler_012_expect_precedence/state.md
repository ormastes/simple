...
- verify: PASS `SIMPLE_LIB=/tmp/simple-final-sync/src /tmp/simple-final-sync/src/compiler_rust/target/debug/simple test test/03_system/feature/usage/parser_keywords_spec.spl --mode=interpreter --clean --fail-fast`.
