...
- verify: `bin/simple test test/01_unit/os/compositor/hosted_backend_cocoa_spec.spl` passed 7 examples.
- verify: `bin/simple test test/01_unit/os/compositor/hosted_backend_win32_spec.spl` passed 6 examples.
