...
- PASS `SIMPLE_LIB=src bin/simple test test/01_unit/app/interpreter/perf_spec.spl --mode=interpreter --clean` (10 scenarios)
- PASS `SIMPLE_LIB=src bin/simple test test/01_unit/compiler/interpreter/tiered_jit_hotspot_spec.spl --mode=interpreter --clean` (51 scenarios)
...
- PASS `SIMPLE_LIB=src bin/simple test test/03_system/features/string_system_spec.spl --mode=interpreter --clean` (33 scenarios)
- PASS `SIMPLE_LIB=src bin/simple test test/01_unit/app/interpreter/perf_spec.spl --mode=interpreter --clean` (10 scenarios)
- PASS `SIMPLE_LIB=src bin/simple test test/01_unit/compiler/interpreter/tiered_jit_hotspot_spec.spl --mode=interpreter --clean` (51 scenarios)
...
Verification:
- PASS `SIMPLE_LIB=src bin/simple check test/01_unit/lib/common/string_spec.spl`
- PASS `SIMPLE_LIB=src bin/simple test test/01_unit/lib/common/string_spec.spl --mode=interpreter --clean` (47 scenarios)
