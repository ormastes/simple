...
| `test/perf/bench/db_accel_index/db_accel_index_spec.spl` | Self-contained regression tests for PrefixIndex, TextIndex, PageSummary, FilterIn (inline struct definitions) |
...
| db_benchmark_gates_spec | `test/perf/bench/db_benchmark_gates_spec.spl` | New: latency/throughput gates for point lookup, prefix, contains, FTS, reopen | New |
...
- `test/perf/bench/db_benchmark_gates_spec.spl` — 7 specs covering AC-8 (point lookup, prefix, contains, FTS5, invalidation, reopen gates)
...
| `test/perf/bench/db_benchmark_gates_spec.spl` | 163 |
...
| `test/perf/bench/db_benchmark_gates_spec.spl` | 6 | 0 | 6 | PASS |
