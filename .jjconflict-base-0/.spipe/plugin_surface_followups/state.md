...
- implement: Added pure-Simple FR-PLUG-0004 source-marker assertions to `test/03_system/feature/plugin/sugar_plugin_spec.spl`.
- verify: `SIMPLE_LIB=src bin/simple test test/03_system/feature/plugin/sugar_plugin_spec.spl --mode=interpreter --clean` passed (`12/12`).
...
- verify: `SIMPLE_LIB=/tmp/simple-fr-plug-0004/src /home/ormastes/dev/pub/simple/bin/simple check test/03_system/feature/plugin/sugar_plugin_spec.spl` passed.
- verify: `SIMPLE_LIB=/tmp/simple-fr-plug-0004/src /home/ormastes/dev/pub/simple/bin/simple test test/03_system/feature/plugin/sugar_plugin_spec.spl --mode=interpreter --clean` passed (`13/13`).
