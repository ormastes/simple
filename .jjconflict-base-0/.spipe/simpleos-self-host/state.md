...
**Stream D: QEMU self-host test** (`test/02_integration/simpleos_self_host_spec.spl`)
...
- Created `test/02_integration/simpleos_self_host_spec.spl` — 5 test groups, 14 cases
