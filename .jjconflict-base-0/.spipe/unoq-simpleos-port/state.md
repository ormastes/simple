...
### Spec Files
- `test/01_unit/compiler/backend/target_presets_m33_spec.spl` — 7 specs covering AC-1 (preset fields + discovery)
- `test/01_unit/lib/debug/remote/target/stm32u5_target_spec.spl` — 11 specs covering AC-2 (target def, memory layout, core delegation, probe config)
- `test/01_unit/lib/debug/remote/exec/adapter_uno_q_spec.spl` — 14 specs covering AC-3 (port defaults, OpenOCD args, adapter construction, MemoryMap.uno_q)
