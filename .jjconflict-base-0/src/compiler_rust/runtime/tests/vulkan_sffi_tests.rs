//! Vulkan SFFI unit tests
//!
//! Tests the C-compatible SFFI functions that bridge Simple runtime to Vulkan.
...
fn test_kernel_compile_minimal() {
    ...
    // Note: This may fail if SPIR-V is invalid, but tests SFFI layer
