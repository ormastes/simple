...
pub fn handle_array_methods(
    ...
    let result = match method {
        ...
        "map" => {
            ...
            return Ok(Some(eval_array_map(arr, func, functions, classes, enums, impl_methods)?));
        }
        "filter" => {
            let func = eval_arg(args, 0, Value::Nil, env, functions, classes, enums, impl_methods)?;
            return Ok(Some(eval_array_filter(arr, func, functions, classes, enums, impl_methods)?));
        }
        "reduce" | "fold" => {
            ...
            return Ok(Some(eval_array_reduce(arr, init, func, functions, classes, enums, impl_methods)?));
        }
        "find" => {
            let func = eval_arg(args, 0, Value::Nil, env, functions, classes, enums, impl_methods)?;
            return Ok(Some(eval_array_find(arr, func, functions, classes, enums, impl_methods)?));
        }
        "any" => {
            let func = eval_arg(args, 0, Value::Nil, env, functions, classes, enums, impl_methods)?;
            return Ok(Some(eval_array_any(arr, func, functions, classes, enums, impl_methods)?));
        }
        "all" => {
            let func = eval_arg(args, 0, Value::Nil, env, functions, classes, enums, impl_methods)?;
            return Ok(Some(eval_array_all(arr, func, functions, classes, enums, impl_methods)?));
        }
        "join" => {
...
pub fn handle_dict_methods(
    ...
    let result = match method {
        ...
        "map_values" => {
            let func = eval_arg(args, 0, Value::Nil, env, functions, classes, enums, impl_methods)?;
            return Ok(Some(eval_dict_map_values(map, func, functions, classes, enums, impl_methods)?));
        }
        "filter" => {
            let func = eval_arg(args, 0, Value::Nil, env, functions, classes, enums, impl_methods)?;
