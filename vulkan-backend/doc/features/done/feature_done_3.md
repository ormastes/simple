...
**Vulkan/SPIR-V Backend** (2025-12-26): Cross-platform GPU compute backend implemented
- SPIR-V 1.3 bytecode generation for Vulkan 1.1+
- Full type system (i32, i64, u32, u64, f32, f64, bool, void)
- Control flow, buffer parameters, array indexing
- GPU built-ins, synchronization, atomic operations
- See [VULKAN_BACKEND_IMPLEMENTATION_2025-12-26.md](../report/VULKAN_BACKEND_IMPLEMENTATION_2025-12-26.md)
