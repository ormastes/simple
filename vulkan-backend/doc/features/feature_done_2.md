...
| Feature ID | Feature | Difficulty | Status | Impl | Doc | S-Test | R-Test |
|------------|---------|------------|--------|------|-----|--------|--------|
| #189 | `shared_examples` | 2 | ✅ | S | [spec/bdd_spec.md](spec/bdd_spec.md) | [`std_lib/test/system/spec/spec_framework_spec.spl`](../simple/std_lib/test/system/spec/spec_framework_spec.spl) | - |
| #190 | `it_behaves_like` | 2 | ✅ | S | [spec/bdd_spec.md](spec/bdd_spec.md) | [`std_lib/test/system/spec/spec_framework_spec.spl`](../simple/std_lib/test/system/spec/spec_framework_spec.spl) | - |
| #191 | `let` memoization | 2 | ✅ | S | [spec/bdd_spec.md](spec/bdd_spec.md) | [`std_lib/test/system/spec/spec_framework_spec.spl`](../simple/std_lib/test/system/spec/spec_framework_spec.spl) | - |
