...
**Category:** Unit
**Failed:** 2026-02-01T18:50:48.223197355+00:00
**Flaky:** No (100.0% failure rate)

**Error:**
```
failed to read test/lib/std/unit/tooling/import_test.spl: No such file or directory (os error 2)
...
**File:** `test/specs/*_spec.spl`
**Category:** Unknown
**Failed:** 2026-02-01T19:03:30.919914539+00:00
**Flaky:** No (100.0% failure rate)

**Error:**
```
failed to read test/specs/*_spec.spl: No such file or directory (os error 2)
Location: test/specs/*_spec.spl
```
...
**File:** `test/lib/std/unit/set_spec.spl`
**Category:** Unit
**Failed:** 2026-02-01T17:44:42.381362771+00:00
**Flaky:** No (100.0% failure rate)

**Error:**
```
failed to read test/lib/std/unit/set_spec.spl: No such file or directory (os error 2)
Location: test/lib/std/unit/set_spec.spl
```
...
**Category:** Unit
**Failed:** 2026-02-01T18:29:52.290074070+00:00
**Flaky:** No (100.0% failure rate)

**Error:**
```
failed to read test/lib/std/unit/tooling/test_db_integrity_spec.spl: No such file or directory (os error 2)
...
### Priority 1: Fix Failing Tests (253)

1. **export_syntax_spec** - compile failed: lint: error: export statement not allowed in regular .spl files (found in ../test/lib/std/unit/mcp/export_syntax_spec.spl) [export_outside_init]
2. **static_method_spec** - compile failed: semantic: function `feature` not found
3. **decorators_spec** - compile failed: lint: error: export statement not allowed in regular .spl files (found in /home/ormastes/dev/pub/simple/test/lib/std/unit/core/decorators_spec.spl) [export_outside_init]
4. **db_sdn_spec** - parse error: Unexpected token: expected fn, struct, class, enum, union, impl, mod, extern, or pub after attributes, found Identifier { name: "describe", pattern: Immutable }
5. **modules_spec** - compile failed: semantic: function `test` not found
