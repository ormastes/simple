...
1. **fixed_size_arrays_spec** - parse error: Unexpected token: expected indented block after ':', found Context
2. **symbol_table_spec** - compile failed: lint: error: export statement not allowed in regular .spl files (found in /home/ormastes/dev/pub/simple/test/lib/std/unit/mcp/symbol_table_spec.spl) [export_outside_init]
3. **memory_spec** - parse error: Unexpected token: expected expression, found RParen
4. **lexer_ffi_test** - compile failed: parse: in "/home/ormastes/dev/pub/simple/rust/lib/std/src/core/traits.spl": Unexpected token: expected identifier, found Into
5. **types_spec** - parse error: Unexpected token: expected Let, found Struct
