...
impl CommonMistake {
    ...
    pub fn message(&self) -> String {
        match self {
            // Python
            Self::PythonDef => "Use 'fn' to define functions in Simple, not 'def'.\n\
                 \n\
                 Python:  def add(a, b):\n\
                 Simple:  fn add(a, b):"
                .to_string(),
            ...
            Self::PythonTrue | Self::PythonFalse => "Use lowercase 'true' and 'false' in Simple.\n\
                 ...
                 Simple:  if true:"
                .to_string(),
            Self::PythonElif => "'elif' is the correct syntax in Simple (not 'else if').\n\
                 \n\
                 Python:  elif x > 0:\n\
            ...
            // Rust
            Self::RustLetMut => "Use 'var' for mutable variables, 'val' for immutable.\n\
                 \n\
                 Rust:    let mut x = 5;\n\
                 Simple:  var x = 5     # mutable\n\
                          val y = 10    # immutable (preferred)"
                .to_string(),
            Self::RustFnMut => "Use 'me' keyword for mutable methods, 'self' is implicit.\n\
                 \n\
                 Rust:    fn update(&mut self) {}\n\
                 Simple:  me update():  # 'me' keyword, self implicit"
                .to_string(),
            Self::RustLifetime => "Simple doesn't use Rust-style lifetime annotations.\n\
                 Reference capabilities (mut/iso) handle memory safety instead."
                .to_string(),
            Self::RustTurbofish => "Use <T> syntax directly, not ::<T>.\n\
                 \n\
                 Rust:    vec.collect::<Vec<_>>()\n\
                 Simple:  vec.collect<Vec<T>>()"
                .to_string(),
            Self::RustMacro => "Simple uses '@' for macros, not '!'.\n\
                 \n\
                 Rust:    println!(\"hello\");\n\
            ...
            // Java/C++
            Self::JavaPublicClass => "Use 'pub class' or 'pub struct' in Simple.\n\
                 \n\
                 Java:    public class Point {}\n\
                 Simple:  pub class Point:  # or 'pub struct Point:'"
                .to_string(),
            Self::JavaVoid => "Omit return type for void functions in Simple.\n\
                 \n\
                 Java:    void print(String s) {}\n\
                 Simple:  fn print(s: String):  # no return type"
                .to_string(),
            Self::JavaNew => "Use struct literal syntax instead of 'new'.\n\
                 \n\
            ...
            Self::CppTemplate => "Generic parameters come after the name in Simple.\n\
                 ...
                 Simple:  struct Vec<T>:"
                .to_string(),
            Self::CppNamespace => "Use 'mod' for modules instead of 'namespace'.\n\
                 \n\
                 C++:     namespace math {}\n\
                 Simple:  mod math:"
                .to_string(),
            ...
            // TypeScript/JavaScript
            Self::TsFunction => "Use 'fn' to define functions in Simple.\n\
                 \n\
                 TypeScript:  function add(a, b) {}\n\
                 Simple:      fn add(a, b):"
                .to_string(),
            Self::TsConst => "Use 'val' for immutable variables in Simple.\n\
                 \n\
                 TypeScript:  const x = 5;\n\
                 Simple:      val x = 5"
                .to_string(),
            Self::TsLet => "Use 'val' for immutable or 'var' for mutable variables.\n\
                 \n\
                 TypeScript:  let x = 5;  // could be reassigned\n\
                 Simple:      val x = 5   // immutable (preferred)\n\
                              var y = 5   // mutable"
                .to_string(),
            Self::TsInterface => "Use 'trait' instead of 'interface' in Simple.\n\
                 \n\
                 TypeScript:  interface Named {}\n\
                 Simple:      trait Named:"
                .to_string(),
            Self::TsArrowFunction => "Use ':' for function bodies, '=>' is for lambdas.\n\
                 \n\
            ...
            // Generic
            Self::MissingColon => "Function and block definitions require ':' before the body.\n\
                 \n\
                 Missing: fn foo()\n\
                 Correct: fn foo():"
                .to_string(),
...
pub fn detect_common_mistake(current: &Token, previous: &Token, next: Option<&Token>) -> Option<CommonMistake> {
    ...
    if matches!(current.kind, TokenKind::Lt) && matches!(previous.kind, TokenKind::DoubleColon) {
