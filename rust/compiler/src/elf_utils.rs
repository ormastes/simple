...
fn resolve_runtime_symbol(name: &str) -> Option<usize> {
    ...
    let addr: usize = match name {
        ...
        "rt_cranelift_finalize_module" => crate::codegen::cranelift_ffi::rt_cranelift_finalize_module as *const () as usize,
        ...
        "rt_cranelift_sig_set_return" => crate::codegen::cranelift_ffi::rt_cranelift_sig_set_return as *const () as usize,
        "rt_cranelift_begin_function" => crate::codegen::cranelift_ffi::rt_cranelift_begin_function as *const () as usize,
        "rt_cranelift_end_function" => crate::codegen::cranelift_ffi::rt_cranelift_end_function as *const () as usize,
        "rt_cranelift_define_function" => crate::codegen::cranelift_ffi::rt_cranelift_define_function as *const () as usize,
        "rt_cranelift_create_block" => crate::codegen::cranelift_ffi::rt_cranelift_create_block as *const () as usize,
        "rt_cranelift_switch_to_block" => crate::codegen::cranelift_ffi::rt_cranelift_switch_to_block as *const () as usize,
        "rt_cranelift_seal_block" => crate::codegen::cranelift_ffi::rt_cranelift_seal_block as *const () as usize,
        "rt_cranelift_seal_all_blocks" => crate::codegen::cranelift_ffi::rt_cranelift_seal_all_blocks as *const () as usize,
