...
use super::api_scanner::{scan_directory, write_yaml};
use super::coverage::{load_llvm_cov_export, LlvmCovExport};
use super::coverage_extended::{print_coverage_summary, CoverageAnalyzer, ExtendedCoverageReport};
...
pub extern "C" fn coverage_report(
    ...
    use super::coverage::{compute_class_coverage, load_public_api_spec, print_class_coverage_table};
...
pub extern "C" fn coverage_check(coverage_ptr: *const c_char, threshold: f64) -> i64 {
    use super::coverage_extended::CoverageType;
