...
use super::super::coverage::{LlvmCovExport, PublicApiSpec};
...
impl CoverageAnalyzer {
    ...
    pub fn from_files<P1: AsRef<Path>, P2: AsRef<Path>>(llvm_cov_path: P1, api_spec_path: P2) -> anyhow::Result<Self> {
        let llvm_cov = super::super::coverage::load_llvm_cov_export(&llvm_cov_path)?;
        let api_spec = super::super::coverage::load_public_api_spec(&api_spec_path)?;
        Ok(Self::new(
            llvm_cov,
            api_spec,
