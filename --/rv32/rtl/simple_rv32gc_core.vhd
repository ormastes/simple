...
end entity simple_rv32gc_core;

architecture rtl of simple_rv32gc_core is
    type reg_file_t is array (0 to 31) of xword_t;
    signal pc_reg : xword_t := RESET_VECTOR;
    signal regs : reg_file_t := (2 => x"00000FFC", others => (others => '0'));
...
begin
    ...
    begin
        if reset_n = '0' then
            pc_reg <= RESET_VECTOR;
            regs <= (2 => x"00000FFC", others => (others => '0'));
