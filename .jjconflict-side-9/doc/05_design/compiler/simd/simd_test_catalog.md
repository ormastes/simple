...
|------|------|-----------|-------------------|--------|---------------|
| T1 | Unit | `test/01_unit/compiler/` | `<module>_spec.spl` | `bin/simple test test/01_unit/` | Blocks T2; must be green before integration |
| T2 | Integration | `test/03_system/feature/simd/` | `<kernel>/<target>_<mode>_spec.spl` | `bin/simple test test/03_system/feature/simd/` | Blocks T3 on host |
...
| T5 | Fuzz | `test/03_system/feature/language/fuzz/simd/` | `<dimension>_fuzz_spec.spl` | `bin/simple test test/03_system/feature/language/fuzz/` (nightly CI) | Nightly, not per-PR |
| T6 | Perf gates | `test/05_perf/simd/` | `<target>_<kernel>_gate_spec.spl` | `bin/simple test test/05_perf/` (weekly + on-demand) | Weekly + blocks release |
...
**Path scheme:** `test/01_unit/compiler/backend/native/<target>/<helper_name>_spec.spl`
...
live in `test/01_unit/compiler/backend/native/x86_64/k0_reservation_spec.spl`:
...
**Path scheme:** `test/01_unit/compiler/mir_opt/<pass_name>_spec.spl`
**Runner:** `bin/simple test test/01_unit/compiler/mir_opt/ --mode=compiled`
...
**Path scheme:** `test/01_unit/compiler/semantics/simd_diagnostics_spec.spl`
...
**Path scheme:** `test/03_system/feature/simd/<kernel>/<target>_<mode>_spec.spl`
**Runner:** `bin/simple test test/03_system/feature/simd/ --mode=compiled`
...
**File path example:**
`test/03_system/feature/simd/saxpy/aarch64_neon_compile_debug_spec.spl`
...
**Path scheme:** `test/03_system/feature/language/fuzz/simd/<dimension>_fuzz_spec.spl`
**Runner:** `bin/simple test test/03_system/feature/language/fuzz/simd/ --mode=compiled` (nightly CI only)
...
```
test/03_system/feature/language/fuzz/simd/random_kernel_fuzz_spec.spl
test/03_system/feature/language/fuzz/simd/nan_injection_fuzz_spec.spl
test/03_system/feature/language/fuzz/simd/scalable_vec_fuzz_spec.spl
```
...
**Path scheme:** `test/05_perf/simd/<target>_<kernel>_gate_spec.spl`
**Runner:** `bin/simple test test/05_perf/simd/ --mode=compiled` (weekly + on-demand)
...
|------|-----------|-------|
| T1 (all unit) | `bin/simple test test/01_unit/compiler/ --mode=compiled` | Runs encoder, MIR-pass, and diagnostic specs |
| T2 (integration) | `bin/simple test test/03_system/feature/simd/ --mode=compiled` | Uses host target by default; pass `--target=<triple>` for cross |
...
| T5 (fuzz) | `bin/simple test test/03_system/feature/language/fuzz/simd/ --mode=compiled` (nightly only) | `SIMD_FUZZ_ITERS=100000` default |
| T6 (perf) | `bin/simple test test/05_perf/simd/ --mode=compiled` (weekly) | Requires `--perf` flag to enable; skipped by default |
...
|-------|---------------|--------------|
| M0 exit | T1 (MIR+diagnostic only) | All `test/01_unit/compiler/` green |
