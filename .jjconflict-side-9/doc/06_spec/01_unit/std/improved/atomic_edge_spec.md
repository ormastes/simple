...
<!-- sdn-diagram:id=atomic_edge_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=atomic_edge_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

atomic_edge_spec -> std
```
...
```ascii generated-from=atomic_edge_spec.arch hash=sha256:auto
