...
Engineer -- Write code to make failing specs pass (Superpowers TDD pattern).
...
- `/implement` -- TDD implementation from failing specs
...
```
Read tools/claude-plugin/sstack-implement/agents/implement.md and use its rules to implement <feature>
```
