#!/usr/bin/env bash
# Build script for sstack-implement Claude plugin
...
echo "=== sstack-implement plugin build ==="
...
for f in skills/implement/SKILL.md agents/implement.md; do
...
echo ""
echo "=== sstack-implement plugin built to ${DIST_DIR} ==="
