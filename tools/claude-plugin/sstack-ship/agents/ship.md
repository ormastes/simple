...
Release Manager -- VCS sync, documentation, completion report.
...
- `/ship` -- VCS sync, completion report, finalize
...
```
Read tools/claude-plugin/sstack-ship/agents/ship.md and use its rules to ship <feature>
```
