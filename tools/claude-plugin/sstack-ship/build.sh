#!/usr/bin/env bash
# Build script for sstack-ship Claude plugin
...
for f in skills/ship/SKILL.md agents/ship.md; do
...
echo ""
echo "=== sstack-ship plugin built to ${DIST_DIR} ==="
