#!/usr/bin/env bash
# Build script for sstack-verify Claude plugin
...
echo "=== sstack-verify plugin build ==="
...
for f in skills/verify/SKILL.md agents/verify.md; do
...
echo ""
echo "=== sstack-verify plugin built to ${DIST_DIR} ==="
