...
<!-- sdn-diagram:id=compiler_40_60_lsp_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=compiler_40_60_lsp_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

compiler_40_60_lsp_spec -> app
```
...
```ascii generated-from=compiler_40_60_lsp_spec.arch hash=sha256:auto
