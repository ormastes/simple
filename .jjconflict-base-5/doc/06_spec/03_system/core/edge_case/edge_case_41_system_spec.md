...
<!-- sdn-diagram:id=edge_case_41_system_spec.arch -->
<details class="sdn-source">
<summary>SDN source</summary>

```sdn id=edge_case_41_system_spec.arch hash=sha256:auto render=ascii
@layout dag
@direction LR

edge_case_41_system_spec -> std
```
...
```ascii generated-from=edge_case_41_system_spec.arch hash=sha256:auto
...
| Category | Testing |
| Status | Implemented |
| Source | `test/03_system/core/edge_case/edge_case_41_system_spec.spl` |
| Updated | 2026-06-01 |
