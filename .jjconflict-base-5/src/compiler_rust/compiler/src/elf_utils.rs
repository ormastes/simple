...
pub(crate) fn resolve_runtime_symbol(name: &str) -> Option<usize> {
    ...
    let addr: usize = match name {
        ...
        "rt_typed_bytes_u8_data_at" => value::rt_typed_bytes_u8_data_at as *const () as usize,
        "rt_typed_bytes_u8_push" => value::rt_typed_bytes_u8_push as *const () as usize,
        "rt_typed_words_u32_at" => value::rt_typed_words_u32_at as *const () as usize,
        "rt_typed_words_u32_data_at" => value::rt_typed_words_u32_data_at as *const () as usize,
        "rt_typed_words_u32_unchecked" => value::rt_typed_words_u32_unchecked as *const () as usize,
        "rt_typed_words_u32_push" => value::rt_typed_words_u32_push as *const () as usize,
        "rt_typed_words_u32_push_known_at" => value::rt_typed_words_u32_push_known_at as *const () as usize,
        "rt_typed_words_u32_push_known_data_at" => value::rt_typed_words_u32_push_known_data_at as *const () as usize,
        "rt_typed_words_u32_store_known_data_at" => value::rt_typed_words_u32_store_known_data_at as *const () as usize,
        "rt_typed_words_u32_set" => value::rt_typed_words_u32_set as *const () as usize,
        "rt_typed_words_u64_at" => value::rt_typed_words_u64_at as *const () as usize,
        "rt_typed_words_u64_data_at" => value::rt_typed_words_u64_data_at as *const () as usize,
        "rt_typed_words_u64_data_at_checked" => value::rt_typed_words_u64_data_at_checked as *const () as usize,
        "rt_typed_words_u64_raw_data_at" => value::rt_typed_words_u64_raw_data_at as *const () as usize,
        "rt_typed_words_u64_unchecked" => value::rt_typed_words_u64_unchecked as *const () as usize,
        "rt_typed_words_u64_push" => value::rt_typed_words_u64_push as *const () as usize,
        "rt_typed_words_u64_push_known_at" => value::rt_typed_words_u64_push_known_at as *const () as usize,
        "rt_typed_words_u64_push_known_data_at" => value::rt_typed_words_u64_push_known_data_at as *const () as usize,
        "rt_typed_words_u64_store_known_data_at" => value::rt_typed_words_u64_store_known_data_at as *const () as usize,
        ...
        "rt_pool_safepoint" => simple_runtime::rt_pool_safepoint as *const () as usize,
