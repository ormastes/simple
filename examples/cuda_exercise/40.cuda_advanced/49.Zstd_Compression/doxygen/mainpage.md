# Module 49: 49.Zstd_Compression

## Overview

This module implements Brief description for 49.Zstd_Compression
...
```bash
ninja doxygen_49_Zstd_Compression
```

The generated HTML documentation will be available at:
```
build/40.cuda_advanced/49.Zstd_Compression/doxygen/html/index.html
```
