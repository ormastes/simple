# Module 44: 44.CUDA_Graphs

## Overview

This module implements Brief description for 44.CUDA_Graphs
...
```bash
ninja doxygen_44_CUDA_Graphs
```

The generated HTML documentation will be available at:
```
build/40.cuda_advanced/44.CUDA_Graphs/doxygen/html/index.html
```
