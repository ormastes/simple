# Module 48: 48.Tile_Based_Programming

## Overview

This module implements Brief description for 48.Tile_Based_Programming
...
```bash
ninja doxygen_48_Tile_Based_Programming
```

The generated HTML documentation will be available at:
```
build/40.cuda_advanced/48.Tile_Based_Programming/doxygen/html/index.html
```
