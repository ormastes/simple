# Module 41: 41.Advanced_PTX_Assembly

## Overview

This module implements Brief description for 41.Advanced_PTX_Assembly
...
```bash
ninja doxygen_41_Advanced_PTX_Assembly
```

The generated HTML documentation will be available at:
```
build/40.cuda_advanced/41.Advanced_PTX_Assembly/doxygen/html/index.html
```
