# Module 45: 45.CUDA_IPC

## Overview

This module implements Brief description for 45.CUDA_IPC
...
```bash
ninja doxygen_45_CUDA_IPC
```

The generated HTML documentation will be available at:
```
build/40.cuda_advanced/45.CUDA_IPC/doxygen/html/index.html
```
