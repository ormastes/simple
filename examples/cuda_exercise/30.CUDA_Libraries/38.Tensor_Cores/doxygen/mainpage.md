# Module 38: 38.Tensor_Cores

## Overview

This module implements Brief description for 38.Tensor_Cores
...
```bash
ninja doxygen_38_Tensor_Cores
```

The generated HTML documentation will be available at:
```
build/30.CUDA_Libraries/38.Tensor_Cores/doxygen/html/index.html
```
