# Module 34: 34.cuSPARSE

## Overview

This module implements Brief description for 34.cuSPARSE
...
```bash
ninja doxygen_34_cuSPARSE
```

The generated HTML documentation will be available at:
```
build/30.CUDA_Libraries/34.cuSPARSE/doxygen/html/index.html
```
