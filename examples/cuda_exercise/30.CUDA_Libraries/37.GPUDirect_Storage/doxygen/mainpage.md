# Module 37: 37.GPUDirect_Storage

## Overview

This module implements Brief description for 37.GPUDirect_Storage
...
```bash
ninja doxygen_37_GPUDirect_Storage
```

The generated HTML documentation will be available at:
```
build/30.CUDA_Libraries/37.GPUDirect_Storage/doxygen/html/index.html
```
