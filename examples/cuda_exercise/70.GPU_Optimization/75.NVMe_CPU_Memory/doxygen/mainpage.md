# Module 75: 75.NVMe_CPU_Memory

## Overview

This module implements Brief description for 75.NVMe_CPU_Memory
...
```bash
ninja doxygen_75_NVMe_CPU_Memory
```

The generated HTML documentation will be available at:
```
build/70.GPU_Optimization/75.NVMe_CPU_Memory/doxygen/html/index.html
```
