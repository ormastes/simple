# Module 71: 71.MatMul_CPU_PyCUDA

## Overview

This module implements Brief description for 71.MatMul_CPU_PyCUDA
...
```bash
ninja doxygen_71_MatMul_CPU_PyCUDA
```

The generated HTML documentation will be available at:
```
build/70.GPU_Optimization/71.MatMul_CPU_PyCUDA/doxygen/html/index.html
```
