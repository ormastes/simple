# Module 24: 24.Memory_Coalescing_and_Bank_Conflicts

## Overview

This module implements Brief description for 24.Memory_Coalescing_and_Bank_Conflicts
...
```bash
ninja doxygen_24_Memory_Coalescing_and_Bank_Conflicts
```

The generated HTML documentation will be available at:
```
build/20.cuda_intermediate/24.Memory_Coalescing_and_Bank_Conflicts/doxygen/html/index.html
```
