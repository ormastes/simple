# Module 23: 23.Shared_Memory

## Overview

This module implements Brief description for 23.Shared_Memory
...
```bash
ninja doxygen_23_Shared_Memory
```

The generated HTML documentation will be available at:
```
build/20.cuda_intermediate/23.Shared_Memory/doxygen/html/index.html
```
