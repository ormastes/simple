# Module 26: 26.Cooperative_Groups

## Overview

This module implements Brief description for 26.Cooperative_Groups
...
```bash
ninja doxygen_26_Cooperative_Groups
```

The generated HTML documentation will be available at:
```
build/20.cuda_intermediate/26.Cooperative_Groups/doxygen/html/index.html
```
