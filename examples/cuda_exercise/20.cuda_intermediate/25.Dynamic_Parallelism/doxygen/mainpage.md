# Module 25: 25.Dynamic_Parallelism

## Overview

This module implements Brief description for 25.Dynamic_Parallelism
...
```bash
ninja doxygen_25_Dynamic_Parallelism
```

The generated HTML documentation will be available at:
```
build/20.cuda_intermediate/25.Dynamic_Parallelism/doxygen/html/index.html
```
