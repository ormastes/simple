# Module 21: 21.Synchronization_and_Atomics

## Overview

This module implements Brief description for 21.Synchronization_and_Atomics
...
```bash
ninja doxygen_21_Synchronization_and_Atomics
```

The generated HTML documentation will be available at:
```
build/20.cuda_intermediate/21.Synchronization_and_Atomics/doxygen/html/index.html
```
