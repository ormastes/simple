# Module 19: 19.CUDA_Memory_API

## Overview

This module implements Brief description for 19.CUDA_Memory_API
...
```bash
ninja doxygen_19_CUDA_Memory_API
```

The generated HTML documentation will be available at:
```
build/10.cuda_basic/19.CUDA_Memory_API/doxygen/html/index.html
```
