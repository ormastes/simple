# Module 18: 18.Thread_Hierarchy_Practice

## Overview

This module implements Brief description for 18.Thread_Hierarchy_Practice
...
```bash
ninja doxygen_18_Thread_Hierarchy_Practice
```

The generated HTML documentation will be available at:
```
build/10.cuda_basic/18.Thread_Hierarchy_Practice/doxygen/html/index.html
```
