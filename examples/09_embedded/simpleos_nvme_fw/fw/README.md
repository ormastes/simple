...
bin/simple run examples/09_embedded/simpleos_nvme_fw/fw/test_fw.spl    # full self-test suite (1170 checks)
...
| Tests | `test_fw` (all self-tests, 1170 checks), `sim_main` (single-queue e2e), `nvme_main` (controller e2e) |
