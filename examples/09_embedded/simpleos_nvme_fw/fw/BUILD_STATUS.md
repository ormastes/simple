...
re-expression of the RAIN reconstruct, SECDED ECC floor, fixed map cache, fixed band allocator, and fixed journal ring, `bin/simple check`-clean, host-verified, and wired through
