...
re-expression of the RAIN reconstruct, SECDED ECC floor, fixed scheduler, fixed power/thermal model, fixed map cache, fixed band allocator, and fixed journal ring, `bin/simple check`-clean, host-verified, and wired through
