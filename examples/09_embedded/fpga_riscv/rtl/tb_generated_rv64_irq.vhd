...
entity tb_generated_rv64_irq is
    generic (
        MAX_CYCLES : integer := 200000
    );
end entity tb_generated_rv64_irq;

architecture sim of tb_generated_rv64_irq is
...
begin
    ...
    begin
        ...
        if halt = '1' and pass_value = 42 and fail_value = 0 then
            report "GENERATED_RV64_IRQ: PASS";
        else
            report "GENERATED_RV64_IRQ: FAIL";
        end if;
        done <= true;
        wait;
    end process;
